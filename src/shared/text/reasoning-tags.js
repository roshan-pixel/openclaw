...
function findCodeRegions(text) {
    ...
    var _loop_1 = function (match) {
        ...
        var insideFenced = regions.some(function (r) { return start >= r.start && end <= r.end; });
        if (!insideFenced) {
...
function stripReasoningTagsFromText(text, options) {
    ...
    if (!QUICK_TAG_RE.test(text))
        return text;
    var mode = (_a = options === null || options === void 0 ? void 0 : options.mode) !== null && _a !== void 0 ? _a : "strict";
    var trimMode = (_b = options === null || options === void 0 ? void 0 : options.trim) !== null && _b !== void 0 ? _b : "both";
    var cleaned = text;
