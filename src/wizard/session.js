...
var WizardSessionPrompter = /** @class */ (function () {
    ...
    WizardSessionPrompter.prototype.note = function (message, title) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.prompt({ type: "note", title: title, message: message, executor: "client" })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.prompt({
                            ...
                            options: params.options.map(function (opt) { return ({
                                value: opt.value,
                                label: opt.label,
                                hint: opt.hint,
                            }); }),
                        ...
                        value = res === null || res === undefined
                            ...
                            : typeof res === "string"
                                ...
                                : typeof res === "number" || typeof res === "boolean" || typeof res === "bigint"
                                    ? String(res)
                                    : "";
                        error = (_a = params.validate) === null || _a === void 0 ? void 0 : _a.call(params, value);
                        if (error) {
    ...
    WizardSessionPrompter.prototype.prompt = function (step) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.session.awaitAnswer(__assign(__assign({}, step), { id: (0, node_crypto_1.randomUUID)() }))];
