...
function mergeProviderModels(implicit, explicit) {
    ...
    var mergedModels = __spreadArray(__spreadArray([], explicitModels, true), implicitModels.filter(function (model) {
        var id = getId(model);
        if (!id)
            return false;
        if (seen.has(id))
...
function mergeProviders(params) {
    ...
    for (var _i = 0, _b = Object.entries((_a = params.explicit) !== null && _a !== void 0 ? _a : {}); _i < _b.length; _i++) {
        var _c = _b[_i], key = _c[0], explicit = _c[1];
...
function ensureOpenClawModelsJson(config, agentDirOverride) {
    return __awaiter(this, void 0, void 0, function () {
        var cfg, agentDir, explicitProviders, implicitProviders, providers, implicitBedrock, existing, implicitCopilot, mode, targetPath, mergedProviders, existingRaw, existing, existingProviders, normalizedProviders, next, _a;
        var _b, _c, _d, _e;
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                    cfg = config !== null && config !== void 0 ? config : (0, config_js_1.loadConfig)();
                    agentDir = (agentDirOverride === null || agentDirOverride === void 0 ? void 0 : agentDirOverride.trim()) ? agentDirOverride.trim() : (0, agent_paths_js_1.resolveOpenClawAgentDir)();
                    explicitProviders = ((_c = (_b = cfg.models) === null || _b === void 0 ? void 0 : _b.providers) !== null && _c !== void 0 ? _c : {});
                    return [4 /*yield*/, (0, models_config_providers_js_1.resolveImplicitProviders)({ agentDir: agentDir })];
                case 1:
                    ...
                    return [4 /*yield*/, (0, models_config_providers_js_1.resolveImplicitBedrockProvider)({ agentDir: agentDir, config: cfg })];
                case 2:
                    ...
                    return [4 /*yield*/, (0, models_config_providers_js_1.resolveImplicitCopilotProvider)({ agentDir: agentDir })];
                case 3:
                    ...
                    mode = (_e = (_d = cfg.models) === null || _d === void 0 ? void 0 : _d.mode) !== null && _e !== void 0 ? _e : DEFAULT_MODE;
                    targetPath = node_path_1.default.join(agentDir, "models.json");
                    mergedProviders = providers;
                    existingRaw = "";
                    if (!(mode === "merge")) return [3 /*break*/, 5];
