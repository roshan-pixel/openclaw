...
function readDockerPort(containerName, port) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, execDocker(["port", containerName, "".concat(port, "/tcp")], {
                        allowFailure: true,
                    })];
                case 1:
                    result = _c.sent();
...
function dockerImageExists(image) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, execDocker(["image", "inspect", image], {
                        allowFailure: true,
                    })];
                case 1:
                    result = _a.sent();
...
function ensureDockerImage(image) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, dockerImageExists(image)];
                case 1:
                    exists = _a.sent();
                    if (exists)
                        return [2 /*return*/];
                    if (!(image === constants_js_1.DEFAULT_SANDBOX_IMAGE)) return [3 /*break*/, 4];
                    return [4 /*yield*/, execDocker(["pull", "debian:bookworm-slim"])];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, execDocker(["tag", "debian:bookworm-slim", constants_js_1.DEFAULT_SANDBOX_IMAGE])];
                case 3:
                    _a.sent();
                    return [2 /*return*/];
                case 4: throw new Error("Sandbox image not found: ".concat(image, ". Build or pull it first."));
            }
        });
    });
}
function dockerContainerState(name) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, execDocker(["inspect", "-f", "{{.State.Running}}", name], {
                        allowFailure: true,
                    })];
                case 1:
                    result = _a.sent();
...
function buildSandboxCreateArgs(params) {
    ...
    for (var _i = 0, _g = Object.entries((_b = params.labels) !== null && _b !== void 0 ? _b : {}); _i < _g.length; _i++) {
    ...
    for (var _o = 0, _p = (_c = params.cfg.dns) !== null && _c !== void 0 ? _c : []; _o < _p.length; _o++) {
        var entry = _p[_o];
        if (entry.trim())
            args.push("--dns", entry);
    }
    for (var _q = 0, _r = (_d = params.cfg.extraHosts) !== null && _d !== void 0 ? _d : []; _q < _r.length; _q++) {
        var entry = _r[_q];
        if (entry.trim())
    ...
    for (var _s = 0, _t = Object.entries((_e = params.cfg.ulimits) !== null && _e !== void 0 ? _e : {}); _s < _t.length; _s++) {
        var _u = _t[_s], name_1 = _u[0], value = _u[1];
...
function createSandboxContainer(params) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    name = params.name, cfg = params.cfg, workspaceDir = params.workspaceDir, scopeKey = params.scopeKey;
                ...
                case 1:
                    ...
                    mainMountSuffix = params.workspaceAccess === "ro" && workspaceDir === params.agentWorkspaceDir ? ":ro" : "";
                    ...
                    if (params.workspaceAccess !== "none" && workspaceDir !== params.agentWorkspaceDir) {
                        ...
                        args.push("-v", "".concat(params.agentWorkspaceDir, ":").concat(constants_js_1.SANDBOX_AGENT_WORKSPACE_MOUNT).concat(agentMountSuffix));
                    }
                ...
                case 3:
                    _b.sent();
                    if (!((_a = cfg.setupCommand) === null || _a === void 0 ? void 0 : _a.trim())) return [3 /*break*/, 5];
...
function readContainerConfigHash(containerName) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    readLabel = function (label) { return __awaiter(_this, void 0, void 0, function () {
                        var result, raw;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, execDocker(["inspect", "-f", "{{ index .Config.Labels \"".concat(label, "\" }}"), containerName], { allowFailure: true })];
                                case 1:
                                    result = _a.sent();
                                    if (result.code !== 0)
                                        return [2 /*return*/, null];
...
function formatSandboxRecreateHint(params) {
    ...
    if (params.scope === "session") {
        return (0, command_format_js_1.formatCliCommand)("openclaw sandbox recreate --session ".concat(params.sessionKey));
    }
    if (params.scope === "agent") {
        var agentId = (_a = (0, shared_js_1.resolveSandboxAgentId)(params.sessionKey)) !== null && _a !== void 0 ? _a : "main";
        return (0, command_format_js_1.formatCliCommand)("openclaw sandbox recreate --agent ".concat(agentId));
    }
    return (0, command_format_js_1.formatCliCommand)("openclaw sandbox recreate --all");
}
function ensureSandboxContainer(params) {
    return __awaiter(this, void 0, void 0, function () {
        var scopeKey, slug, name, containerName, expectedHash, now, state, hasContainer, running, currentHash, hashMismatch, registryEntry, registry, lastUsedAtMs, isHot, hint;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    scopeKey = (0, shared_js_1.resolveSandboxScopeKey)(params.cfg.scope, params.sessionKey);
                    slug = params.cfg.scope === "shared" ? "shared" : (0, shared_js_1.slugifySessionKey)(scopeKey);
                ...
                case 1:
                    ...
                    currentHash = null;
                    hashMismatch = false;
                    if (!hasContainer) return [3 /*break*/, 6];
                    return [4 /*yield*/, (0, registry_js_1.readRegistry)()];
                case 2:
                    registry = _b.sent();
                    registryEntry = registry.entries.find(function (entry) { return entry.containerName === containerName; });
                    return [4 /*yield*/, readContainerConfigHash(containerName)];
                case 3:
                    currentHash = _b.sent();
                    if (!currentHash) {
                        currentHash = (_a = registryEntry === null || registryEntry === void 0 ? void 0 : registryEntry.configHash) !== null && _a !== void 0 ? _a : null;
                    }
                    hashMismatch = !currentHash || currentHash !== expectedHash;
                    if (!hashMismatch) return [3 /*break*/, 6];
                    lastUsedAtMs = registryEntry === null || registryEntry === void 0 ? void 0 : registryEntry.lastUsedAtMs;
                    isHot = running &&
                        (typeof lastUsedAtMs !== "number" || now - lastUsedAtMs < HOT_CONTAINER_WINDOW_MS);
                    if (!isHot) return [3 /*break*/, 4];
                    hint = formatSandboxRecreateHint({ scope: params.cfg.scope, sessionKey: scopeKey });
                    runtime_js_1.defaultRuntime.log("Sandbox config changed for ".concat(containerName, " (recently used). Recreate to apply: ").concat(hint));
                    return [3 /*break*/, 6];
                case 4: return [4 /*yield*/, execDocker(["rm", "-f", containerName], { allowFailure: true })];
                case 5:
                    _b.sent();
                    hasContainer = false;
                    running = false;
                    _b.label = 6;
                case 6:
                    if (!!hasContainer) return [3 /*break*/, 8];
                    return [4 /*yield*/, createSandboxContainer({
                            name: containerName,
                ...
                case 9:
                    _b.sent();
                    _b.label = 10;
                case 10: return [4 /*yield*/, (0, registry_js_1.updateRegistry)({
                        containerName: containerName,
                        sessionKey: scopeKey,
                        createdAtMs: now,
                        lastUsedAtMs: now,
                        image: params.cfg.docker.image,
                        configHash: hashMismatch && running ? (currentHash !== null && currentHash !== void 0 ? currentHash : undefined) : expectedHash,
                    })];
                case 11:
                    _b.sent();
