...
function resolveMainSessionKeyForSandbox(params) {
    var _a, _b;
    if (((_b = (_a = params.cfg) === null || _a === void 0 ? void 0 : _a.session) === null || _b === void 0 ? void 0 : _b.scope) === "global")
        return "global";
...
function resolveSandboxRuntimeStatus(params) {
    var _a, _b;
    var sessionKey = (_b = (_a = params.sessionKey) === null || _a === void 0 ? void 0 : _a.trim()) !== null && _b !== void 0 ? _b : "";
    ...
    var sandboxed = sessionKey
        ? shouldSandboxSession(sandboxCfg, resolveComparableSessionKeyForSandbox({ cfg: cfg, agentId: agentId, sessionKey: sessionKey }), mainSessionKey)
        : false;
    return {
        agentId: agentId,
        sessionKey: sessionKey,
...
function formatSandboxToolPolicyBlockedMessage(params) {
    ...
    if (blockedByAllow) {
        ...
        fixes.push("Add \"".concat(tool, "\" to ").concat(runtime.toolPolicy.sources.allow.key, " (or set it to [] to allow all)."));
    }
    var lines = [];
    lines.push("Tool \"".concat(tool, "\" blocked by sandbox tool policy (mode=").concat(runtime.mode, ")."));
    ...
    lines.push("- See: ".concat((0, command_format_js_1.formatCliCommand)("openclaw sandbox explain --session ".concat(runtime.sessionKey))));
    return lines.join("\n");
}
