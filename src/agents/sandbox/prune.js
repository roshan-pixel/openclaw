            ...
            switch (_c.label) {
                ...
                case 2:
                    ...
                    if (!((idleHours > 0 && idleMs > idleHours * 60 * 60 * 1000) ||
                        (maxAgeDays > 0 && ageMs > maxAgeDays * 24 * 60 * 60 * 1000))) return [3 /*break*/, 8];
                    _c.label = 3;
                case 3:
                    _c.trys.push([3, 5, 6, 8]);
                    return [4 /*yield*/, (0, docker_js_1.execDocker)(["rm", "-f", entry.containerName], {
                            allowFailure: true,
                        })];
                case 4:
                    _c.sent();
                ...
                case 5:
                    _b = _c.sent();
                    return [3 /*break*/, 8];
                case 6: return [4 /*yield*/, (0, registry_js_1.removeRegistryEntry)(entry.containerName)];
                case 7:
                    _c.sent();
                    return [7 /*endfinally*/];
                case 8:
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    ageMs = now - entry.createdAtMs;
                    if (!((idleHours > 0 && idleMs > idleHours * 60 * 60 * 1000) ||
                        (maxAgeDays > 0 && ageMs > maxAgeDays * 24 * 60 * 60 * 1000))) return [3 /*break*/, 10];
                    _c.label = 3;
                case 3:
                ...
                case 5:
                    _b = _c.sent();
                    return [3 /*break*/, 10];
                case 6: return [4 /*yield*/, (0, registry_js_1.removeBrowserRegistryEntry)(entry.containerName)];
                case 7:
                    _c.sent();
                    bridge = browser_bridges_js_1.BROWSER_BRIDGES.get(entry.sessionKey);
                    if (!((bridge === null || bridge === void 0 ? void 0 : bridge.containerName) === entry.containerName)) return [3 /*break*/, 9];
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 4:
                    ...
                    (_a = runtime_js_1.defaultRuntime.error) === null || _a === void 0 ? void 0 : _a.call(runtime_js_1.defaultRuntime, "Sandbox prune failed: ".concat(message !== null && message !== void 0 ? message : "unknown error"));
                    return [3 /*break*/, 5];
