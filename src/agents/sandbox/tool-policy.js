...
function resolveSandboxToolPolicyForAgent(cfg, agentId) {
    ...
    var agentAllow = (_c = (_b = (_a = agentConfig === null || agentConfig === void 0 ? void 0 : agentConfig.tools) === null || _a === void 0 ? void 0 : _a.sandbox) === null || _b === void 0 ? void 0 : _b.tools) === null || _c === void 0 ? void 0 : _c.allow;
    var agentDeny = (_f = (_e = (_d = agentConfig === null || agentConfig === void 0 ? void 0 : agentConfig.tools) === null || _d === void 0 ? void 0 : _d.sandbox) === null || _e === void 0 ? void 0 : _e.tools) === null || _f === void 0 ? void 0 : _f.deny;
    var globalAllow = (_j = (_h = (_g = cfg === null || cfg === void 0 ? void 0 : cfg.tools) === null || _g === void 0 ? void 0 : _g.sandbox) === null || _h === void 0 ? void 0 : _h.tools) === null || _j === void 0 ? void 0 : _j.allow;
    var globalDeny = (_m = (_l = (_k = cfg === null || cfg === void 0 ? void 0 : cfg.tools) === null || _k === void 0 ? void 0 : _k.sandbox) === null || _l === void 0 ? void 0 : _l.tools) === null || _m === void 0 ? void 0 : _m.deny;
    ...
    if (!expandedDeny.map(function (v) { return v.toLowerCase(); }).includes("image") &&
        !expandedAllow.map(function (v) { return v.toLowerCase(); }).includes("image")) {
