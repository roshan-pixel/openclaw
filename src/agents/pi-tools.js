...
function isOpenAIProvider(provider) {
    var normalized = provider === null || provider === void 0 ? void 0 : provider.trim().toLowerCase();
...
function isApplyPatchAllowedForModel(params) {
    ...
    var provider = (_b = params.modelProvider) === null || _b === void 0 ? void 0 : _b.trim().toLowerCase();
    var normalizedFull = provider && !normalizedModelId.includes("/")
...
function resolveExecConfig(cfg) {
    ...
    return {
        ...
        approvalRunningNoticeMs: globalExec === null || globalExec === void 0 ? void 0 : globalExec.approvalRunningNoticeMs,
...
function createOpenClawCodingTools(options) {
    ...
    var sandbox = ((_a = options === null || options === void 0 ? void 0 : options.sandbox) === null || _a === void 0 ? void 0 : _a.enabled) ? options.sandbox : undefined;
    ...
    }), agentId = _8.agentId, globalPolicy = _8.globalPolicy, globalProviderPolicy = _8.globalProviderPolicy, agentPolicy = _8.agentPolicy, agentProviderPolicy = _8.agentProviderPolicy, profile = _8.profile, providerProfile = _8.providerProfile, profileAlsoAllow = _8.profileAlsoAllow, providerProfileAlsoAllow = _8.providerProfileAlsoAllow;
    ...
    var providerProfilePolicyWithAlsoAllow = mergeAlsoAllow(providerProfilePolicy, providerProfileAlsoAllow);
    var scopeKey = (_c = (_b = options === null || options === void 0 ? void 0 : options.exec) === null || _b === void 0 ? void 0 : _b.scopeKey) !== null && _c !== void 0 ? _c : (agentId ? "agent:".concat(agentId) : undefined);
    var subagentPolicy = (0, session_key_js_1.isSubagentSessionKey)(options === null || options === void 0 ? void 0 : options.sessionKey) && (options === null || options === void 0 ? void 0 : options.sessionKey)
    ...
    var execConfig = resolveExecConfig(options === null || options === void 0 ? void 0 : options.config);
    var sandboxRoot = sandbox === null || sandbox === void 0 ? void 0 : sandbox.workspaceDir;
    var allowWorkspaceWrites = (sandbox === null || sandbox === void 0 ? void 0 : sandbox.workspaceAccess) !== "ro";
    var workspaceRoot = (_d = options === null || options === void 0 ? void 0 : options.workspaceDir) !== null && _d !== void 0 ? _d : process.cwd();
    var applyPatchConfig = (_g = (_f = (_e = options === null || options === void 0 ? void 0 : options.config) === null || _e === void 0 ? void 0 : _e.tools) === null || _f === void 0 ? void 0 : _f.exec) === null || _g === void 0 ? void 0 : _g.applyPatch;
    var applyPatchEnabled = !!(applyPatchConfig === null || applyPatchConfig === void 0 ? void 0 : applyPatchConfig.enabled) &&
        isOpenAIProvider(options === null || options === void 0 ? void 0 : options.modelProvider) &&
        isApplyPatchAllowedForModel({
            modelProvider: options === null || options === void 0 ? void 0 : options.modelProvider,
            modelId: options === null || options === void 0 ? void 0 : options.modelId,
            allowModels: applyPatchConfig === null || applyPatchConfig === void 0 ? void 0 : applyPatchConfig.allowModels,
        });
    var base = pi_coding_agent_1.codingTools.flatMap(function (tool) {
        ...
        if (tool.name === "write") {
            ...
            return [
                (0, pi_tools_read_js_1.wrapToolParamNormalization)((0, pi_coding_agent_1.createWriteTool)(workspaceRoot), pi_tools_read_js_1.CLAUDE_PARAM_GROUPS.write),
            ];
        }
        if (tool.name === "edit") {
            if (sandboxRoot)
                return [];
            // Wrap with param normalization for Claude Code compatibility
            return [(0, pi_tools_read_js_1.wrapToolParamNormalization)((0, pi_coding_agent_1.createEditTool)(workspaceRoot), pi_tools_read_js_1.CLAUDE_PARAM_GROUPS.edit)];
        }
        return [tool];
    });
    var _9 = (_h = options === null || options === void 0 ? void 0 : options.exec) !== null && _h !== void 0 ? _h : {}, cleanupMsOverride = _9.cleanupMs, execDefaults = __rest(_9, ["cleanupMs"]);
    var execTool = (0, bash_tools_js_1.createExecTool)(__assign(__assign({}, execDefaults), { host: (_k = (_j = options === null || options === void 0 ? void 0 : options.exec) === null || _j === void 0 ? void 0 : _j.host) !== null && _k !== void 0 ? _k : execConfig.host, security: (_m = (_l = options === null || options === void 0 ? void 0 : options.exec) === null || _l === void 0 ? void 0 : _l.security) !== null && _m !== void 0 ? _m : execConfig.security, ask: (_p = (_o = options === null || options === void 0 ? void 0 : options.exec) === null || _o === void 0 ? void 0 : _o.ask) !== null && _p !== void 0 ? _p : execConfig.ask, node: (_r = (_q = options === null || options === void 0 ? void 0 : options.exec) === null || _q === void 0 ? void 0 : _q.node) !== null && _r !== void 0 ? _r : execConfig.node, pathPrepend: (_t = (_s = options === null || options === void 0 ? void 0 : options.exec) === null || _s === void 0 ? void 0 : _s.pathPrepend) !== null && _t !== void 0 ? _t : execConfig.pathPrepend, safeBins: (_v = (_u = options === null || options === void 0 ? void 0 : options.exec) === null || _u === void 0 ? void 0 : _u.safeBins) !== null && _v !== void 0 ? _v : execConfig.safeBins, agentId: agentId, cwd: options === null || options === void 0 ? void 0 : options.workspaceDir, allowBackground: allowBackground, scopeKey: scopeKey, sessionKey: options === null || options === void 0 ? void 0 : options.sessionKey, messageProvider: options === null || options === void 0 ? void 0 : options.messageProvider, backgroundMs: (_x = (_w = options === null || options === void 0 ? void 0 : options.exec) === null || _w === void 0 ? void 0 : _w.backgroundMs) !== null && _x !== void 0 ? _x : execConfig.backgroundMs, timeoutSec: (_z = (_y = options === null || options === void 0 ? void 0 : options.exec) === null || _y === void 0 ? void 0 : _y.timeoutSec) !== null && _z !== void 0 ? _z : execConfig.timeoutSec, approvalRunningNoticeMs: (_1 = (_0 = options === null || options === void 0 ? void 0 : options.exec) === null || _0 === void 0 ? void 0 : _0.approvalRunningNoticeMs) !== null && _1 !== void 0 ? _1 : execConfig.approvalRunningNoticeMs, notifyOnExit: (_3 = (_2 = options === null || options === void 0 ? void 0 : options.exec) === null || _2 === void 0 ? void 0 : _2.notifyOnExit) !== null && _3 !== void 0 ? _3 : execConfig.notifyOnExit, sandbox: sandbox
            ? {
    ...
    var processTool = (0, bash_tools_js_1.createProcessTool)({
        cleanupMs: cleanupMsOverride !== null && cleanupMsOverride !== void 0 ? cleanupMsOverride : execConfig.cleanupMs,
        scopeKey: scopeKey,
    });
    var applyPatchTool = !applyPatchEnabled || (sandboxRoot && !allowWorkspaceWrites)
        ? null
    ...
    var tools = __spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray([], base, true), (sandboxRoot
        ? allowWorkspaceWrites
            ? [(0, pi_tools_read_js_1.createSandboxedEditTool)(sandboxRoot), (0, pi_tools_read_js_1.createSandboxedWriteTool)(sandboxRoot)]
            : []
        : []), true), (applyPatchTool ? [applyPatchTool] : []), true), [
        execTool,
        processTool
    ], false), (0, channel_tools_js_1.listChannelAgentTools)({ cfg: options === null || options === void 0 ? void 0 : options.config }), true), (0, openclaw_tools_js_1.createOpenClawTools)({
        sandboxBrowserBridgeUrl: (_4 = sandbox === null || sandbox === void 0 ? void 0 : sandbox.browser) === null || _4 === void 0 ? void 0 : _4.bridgeUrl,
        allowHostBrowserControl: sandbox ? sandbox.browserAllowHostControl : true,
        agentSessionKey: options === null || options === void 0 ? void 0 : options.sessionKey,
        agentChannel: (0, message_channel_js_1.resolveGatewayMessageChannel)(options === null || options === void 0 ? void 0 : options.messageProvider),
        ...
        agentGroupId: (_5 = options === null || options === void 0 ? void 0 : options.groupId) !== null && _5 !== void 0 ? _5 : null,
        agentGroupChannel: (_6 = options === null || options === void 0 ? void 0 : options.groupChannel) !== null && _6 !== void 0 ? _6 : null,
        agentGroupSpace: (_7 = options === null || options === void 0 ? void 0 : options.groupSpace) !== null && _7 !== void 0 ? _7 : null,
    ...
    var coreToolNames = new Set(tools
    ...
    var profilePolicyExpanded = resolvePolicy(profilePolicyWithAlsoAllow, profile ? "tools.profile (".concat(profile, ")") : "tools.profile");
    var providerProfileExpanded = resolvePolicy(providerProfilePolicyWithAlsoAllow, providerProfile ? "tools.byProvider.profile (".concat(providerProfile, ")") : "tools.byProvider.profile");
    ...
    var agentPolicyExpanded = resolvePolicy(agentPolicy, agentId ? "agents.".concat(agentId, ".tools.allow") : "agent tools.allow");
    var agentProviderExpanded = resolvePolicy(agentProviderPolicy, agentId ? "agents.".concat(agentId, ".tools.byProvider.allow") : "agent tools.byProvider.allow");
    var groupPolicyExpanded = resolvePolicy(groupPolicy, "group tools.allow");
    var sandboxPolicyExpanded = (0, tool_policy_js_1.expandPolicyWithPluginGroups)(sandbox === null || sandbox === void 0 ? void 0 : sandbox.tools, pluginGroups);
    var subagentPolicyExpanded = (0, tool_policy_js_1.expandPolicyWithPluginGroups)(subagentPolicy, pluginGroups);
    ...
    var withAbort = (options === null || options === void 0 ? void 0 : options.abortSignal)
        ? normalized.map(function (tool) { return (0, pi_tools_abort_js_1.wrapToolWithAbortSignal)(tool, options.abortSignal); })
        : normalized;
