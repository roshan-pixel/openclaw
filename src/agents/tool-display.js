...
function defaultTitle(name) {
    ...
    return cleaned
        ...
        return part.length <= 2 && part.toUpperCase() === part
            ? part
            : "".concat((_b = (_a = part.at(0)) === null || _a === void 0 ? void 0 : _a.toUpperCase()) !== null && _b !== void 0 ? _b : "").concat(part.slice(1));
    })
        .join(" ");
}
...
function coerceDisplayValue(value) {
    ...
    if (Array.isArray(value)) {
        var values = value
            .map(function (item) { return coerceDisplayValue(item); })
...
function resolveDetailFromKeys(args, keys) {
    ...
    return unique
        ...
        .map(function (entry) { return "".concat(entry.label, " ").concat(entry.value); })
        .join(" · ");
}
function resolveReadDetail(args) {
    ...
    if (offset !== undefined && limit !== undefined) {
        return "".concat(path, ":").concat(offset, "-").concat(offset + limit);
    }
    return path;
}
...
function resolveActionSpec(spec, action) {
    ...
    if (!spec || !action)
        return undefined;
    return (_b = (_a = spec.actions) === null || _a === void 0 ? void 0 : _a[action]) !== null && _b !== void 0 ? _b : undefined;
}
function resolveToolDisplay(params) {
    ...
    var emoji = (_b = (_a = spec === null || spec === void 0 ? void 0 : spec.emoji) !== null && _a !== void 0 ? _a : FALLBACK.emoji) !== null && _b !== void 0 ? _b : "🧩";
    var title = (_c = spec === null || spec === void 0 ? void 0 : spec.title) !== null && _c !== void 0 ? _c : defaultTitle(name);
    var label = (_d = spec === null || spec === void 0 ? void 0 : spec.label) !== null && _d !== void 0 ? _d : title;
    var actionRaw = params.args && typeof params.args === "object"
        ? params.args.action
        : undefined;
    var action = typeof actionRaw === "string" ? actionRaw.trim() : undefined;
    var actionSpec = resolveActionSpec(spec, action);
    var verb = normalizeVerb((_e = actionSpec === null || actionSpec === void 0 ? void 0 : actionSpec.label) !== null && _e !== void 0 ? _e : action);
    var detail;
    if (key === "read")
    ...
    var detailKeys = (_h = (_g = (_f = actionSpec === null || actionSpec === void 0 ? void 0 : actionSpec.detailKeys) !== null && _f !== void 0 ? _f : spec === null || spec === void 0 ? void 0 : spec.detailKeys) !== null && _g !== void 0 ? _g : FALLBACK.detailKeys) !== null && _h !== void 0 ? _h : [];
