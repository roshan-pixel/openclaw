...
function coerceApiHost(params) {
    ...
    var raw = ((_b = params.apiHost) === null || _b === void 0 ? void 0 : _b.trim()) ||
...
function minimaxUnderstandImage(params) {
    return __awaiter(this, void 0, void 0, function () {
        var apiKey, prompt, imageDataUrl, host, url, res, traceId, body, trace, json, trace, baseResp, code, msg, trace, content, trace;
        var _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    throw new Error("MiniMax VLM request failed (".concat(res.status, " ").concat(res.statusText, ").").concat(trace).concat(body ? " Body: ".concat(body.slice(0, 400)) : ""));
                case 3: return [4 /*yield*/, res.json().catch(function () { return null; })];
                case 4:
                    json = (_c.sent());
                    if (!isRecord(json)) {
                        trace = traceId ? " Trace-Id: ".concat(traceId) : "";
                    ...
                    if (code !== 0) {
                        ...
                        trace = traceId ? " Trace-Id: ".concat(traceId) : "";
                        throw new Error("MiniMax VLM API error (".concat(code, ")").concat(msg ? ": ".concat(msg) : "", ".").concat(trace));
                    }
