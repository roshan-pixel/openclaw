...
function isBase64Signature(value) {
    ...
    try {
        ...
        var normalize = function (input) { return input.replace(/=+$/g, ""); };
...
function stripThoughtSignatures(content, options) {
    ...
    if (!Array.isArray(content))
        return content;
    var allowBase64Only = (_a = options === null || options === void 0 ? void 0 : options.allowBase64Only) !== null && _a !== void 0 ? _a : false;
    var includeCamelCase = (_b = options === null || options === void 0 ? void 0 : options.includeCamelCase) !== null && _b !== void 0 ? _b : false;
...
function resolveBootstrapMaxChars(cfg) {
    var _a, _b;
    var raw = (_b = (_a = cfg === null || cfg === void 0 ? void 0 : cfg.agents) === null || _a === void 0 ? void 0 : _a.defaults) === null || _b === void 0 ? void 0 : _b.bootstrapMaxChars;
...
function trimBootstrapContent(content, fileName, maxChars) {
    ...
    var marker = [
        ...
        "\u2026(truncated ".concat(fileName, ": kept ").concat(headChars, "+").concat(tailChars, " chars of ").concat(trimmed.length, ")\u2026"),
        "",
    ].join("\n");
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    _a = _b.sent();
                    return [3 /*break*/, 4];
                case 4: return [4 /*yield*/, promises_1.default.mkdir(node_path_1.default.dirname(file), { recursive: true })];
                case 5:
                    _b.sent();
                    sessionVersion = 2;
                    entry = {
                    ...
                    return [4 /*yield*/, promises_1.default.writeFile(file, "".concat(JSON.stringify(entry), "\n"), "utf-8")];
                case 6:
                    _b.sent();
                    return [2 /*return*/];
            }
...
function buildBootstrapContextFiles(files, opts) {
    var _a, _b, _c;
    var maxChars = (_a = opts === null || opts === void 0 ? void 0 : opts.maxChars) !== null && _a !== void 0 ? _a : exports.DEFAULT_BOOTSTRAP_MAX_CHARS;
    var result = [];
    for (var _i = 0, files_1 = files; _i < files_1.length; _i++) {
        ...
        var trimmed = trimBootstrapContent((_b = file.content) !== null && _b !== void 0 ? _b : "", file.name, maxChars);
        if (!trimmed.content)
            continue;
        if (trimmed.truncated) {
            (_c = opts === null || opts === void 0 ? void 0 : opts.warn) === null || _c === void 0 ? void 0 : _c.call(opts, "workspace bootstrap file ".concat(file.name, " is ").concat(trimmed.originalLength, " chars (limit ").concat(trimmed.maxChars, "); truncating in injected context"));
        }
        result.push({
            path: file.name,
