...
Object.defineProperty(exports, "sanitizeGoogleTurnOrdering", { enumerable: true, get: function () { return bootstrap_js_1.sanitizeGoogleTurnOrdering; } });
...
function isAntigravityClaude(params) {
    ...
    if (provider !== "google-antigravity" && api !== "google-antigravity")
        return false;
    return (_d = (_c = params.modelId) === null || _c === void 0 ? void 0 : _c.toLowerCase().includes("claude")) !== null && _d !== void 0 ? _d : false;
}
