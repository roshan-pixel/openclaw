...
function buildAllowedModelKeys(cfg, defaultProvider) {
    var rawAllowlist = (function () {
        var _a, _b, _c;
        var modelMap = (_c = (_b = (_a = cfg === null || cfg === void 0 ? void 0 : cfg.agents) === null || _a === void 0 ? void 0 : _a.defaults) === null || _b === void 0 ? void 0 : _b.models) !== null && _c !== void 0 ? _c : {};
    ...
    for (var _i = 0, rawAllowlist_1 = rawAllowlist; _i < rawAllowlist_1.length; _i++) {
        ...
        var parsed = (0, model_selection_js_1.parseModelRef)(String(raw !== null && raw !== void 0 ? raw : ""), defaultProvider);
        if (!parsed)
            continue;
...
function resolveImageFallbackCandidates(params) {
    ...
    if ((_b = params.modelOverride) === null || _b === void 0 ? void 0 : _b.trim()) {
        ...
        var imageModel = (_e = (_d = (_c = params.cfg) === null || _c === void 0 ? void 0 : _c.agents) === null || _d === void 0 ? void 0 : _d.defaults) === null || _e === void 0 ? void 0 : _e.imageModel;
        var primary = typeof imageModel === "string" ? imageModel.trim() : imageModel === null || imageModel === void 0 ? void 0 : imageModel.primary;
        if (primary === null || primary === void 0 ? void 0 : primary.trim())
            addRaw(primary, false);
    }
    var imageFallbacks = (function () {
        var _a, _b, _c, _d;
        var imageModel = (_c = (_b = (_a = params.cfg) === null || _a === void 0 ? void 0 : _a.agents) === null || _b === void 0 ? void 0 : _b.defaults) === null || _c === void 0 ? void 0 : _c.imageModel;
...
function resolveFallbackCandidates(params) {
    ...
    var primary = params.cfg
        ...
        : null;
    var defaultProvider = (_a = primary === null || primary === void 0 ? void 0 : primary.provider) !== null && _a !== void 0 ? _a : defaults_js_1.DEFAULT_PROVIDER;
    var defaultModel = (_b = primary === null || primary === void 0 ? void 0 : primary.model) !== null && _b !== void 0 ? _b : defaults_js_1.DEFAULT_MODEL;
    var provider = String((_c = params.provider) !== null && _c !== void 0 ? _c : "").trim() || defaultProvider;
    var model = String((_d = params.model) !== null && _d !== void 0 ? _d : "").trim() || defaultModel;
    var aliasIndex = (0, model_selection_js_1.buildModelAliasIndex)({
    ...
    var modelFallbacks = (function () {
        ...
        var model = (_c = (_b = (_a = params.cfg) === null || _a === void 0 ? void 0 : _a.agents) === null || _b === void 0 ? void 0 : _b.defaults) === null || _c === void 0 ? void 0 : _c.model;
    ...
    if (params.fallbacksOverride === undefined && (primary === null || primary === void 0 ? void 0 : primary.provider) && primary.model) {
...
function runWithModelFallback(params) {
    return __awaiter(this, void 0, void 0, function () {
        var candidates, authStore, attempts, lastError, i, candidate, profileIds, isAnyProfileAvailable, result, err_1, normalized, described, summary;
        var _a, _b;
            ...
            switch (_c.label) {
                case 0:
                    ...
                    authStore = params.cfg
                        ? (0, auth_profiles_js_1.ensureAuthProfileStore)(params.agentDir, { allowKeychainPrompt: false })
                        : null;
                    attempts = [];
                    i = 0;
                    _c.label = 1;
                case 1:
                    if (!(i < candidates.length)) return [3 /*break*/, 7];
                    ...
                    if (authStore) {
                        ...
                        isAnyProfileAvailable = profileIds.some(function (id) { return !(0, auth_profiles_js_1.isProfileInCooldown)(authStore, id); });
                        if (profileIds.length > 0 && !isAnyProfileAvailable) {
                            // All profiles for this provider are in cooldown; skip without attempting
                            attempts.push({
                                provider: candidate.provider,
                                model: candidate.model,
                                error: "Provider ".concat(candidate.provider, " is in cooldown (all profiles unavailable)"),
                                reason: "rate_limit",
                            });
                            return [3 /*break*/, 6];
                        }
                ...
                case 4:
                    ...
                    if (shouldRethrowAbort(err_1))
                        throw err_1;
                    normalized = (_a = (0, failover_error_js_1.coerceToFailoverError)(err_1, {
                        provider: candidate.provider,
                        model: candidate.model,
                    })) !== null && _a !== void 0 ? _a : err_1;
                    ...
                    return [4 /*yield*/, ((_b = params.onError) === null || _b === void 0 ? void 0 : _b.call(params, {
                            provider: candidate.provider,
                            model: candidate.model,
                            error: normalized,
                            attempt: i + 1,
                ...
                case 7:
                    ...
                    summary = attempts.length > 0
                        ? attempts
                            ...
                            return "".concat(attempt.provider, "/").concat(attempt.model, ": ").concat(attempt.error).concat(attempt.reason ? " (".concat(attempt.reason, ")") : "");
                        })
                            .join(" | ")
                        : "unknown";
                    throw new Error("All models failed (".concat(attempts.length || candidates.length, "): ").concat(summary), {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 4:
                    ...
                    return [4 /*yield*/, ((_a = params.onError) === null || _a === void 0 ? void 0 : _a.call(params, {
                            provider: candidate.provider,
                            model: candidate.model,
                            error: err_2,
                            attempt: i + 1,
                ...
                case 7:
                    ...
                    summary = attempts.length > 0
                        ? attempts
                            .map(function (attempt) { return "".concat(attempt.provider, "/").concat(attempt.model, ": ").concat(attempt.error); })
                            .join(" | ")
                        : "unknown";
                    throw new Error("All image models failed (".concat(attempts.length || candidates.length, "): ").concat(summary), {
                        cause: lastError instanceof Error ? lastError : undefined,
                    });
            }
        });
