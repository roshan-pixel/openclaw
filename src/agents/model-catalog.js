...
var defaultImportPiSdk = function () { return Promise.resolve().then(function () { return require("@mariozechner/pi-coding-agent"); }); };
...
function loadModelCatalog(params) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            modelCatalogPromise = (function () { return __awaiter(_this, void 0, void 0, function () {
                var models, sortModels, cfg, piSdk, agentDir, authStorage, registry, entries, _i, entries_1, entry, id, provider, name_1, contextWindow, reasoning, input, error_1;
                var _a, _b, _c, _d;
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        ...
                        case 1:
                            _e.trys.push([1, 4, , 5]);
                            cfg = (_a = params === null || params === void 0 ? void 0 : params.config) !== null && _a !== void 0 ? _a : (0, config_js_1.loadConfig)();
                        ...
                        case 3:
                            ...
                            for (_i = 0, entries_1 = entries; _i < entries_1.length; _i++) {
                                entry = entries_1[_i];
                                id = String((_b = entry === null || entry === void 0 ? void 0 : entry.id) !== null && _b !== void 0 ? _b : "").trim();
                                if (!id)
                                    continue;
                                provider = String((_c = entry === null || entry === void 0 ? void 0 : entry.provider) !== null && _c !== void 0 ? _c : "").trim();
                                if (!provider)
                                    continue;
                                name_1 = String((_d = entry === null || entry === void 0 ? void 0 : entry.name) !== null && _d !== void 0 ? _d : id).trim() || id;
                                contextWindow = typeof (entry === null || entry === void 0 ? void 0 : entry.contextWindow) === "number" && entry.contextWindow > 0
                                    ? entry.contextWindow
                                    : undefined;
                                reasoning = typeof (entry === null || entry === void 0 ? void 0 : entry.reasoning) === "boolean" ? entry.reasoning : undefined;
                                input = Array.isArray(entry === null || entry === void 0 ? void 0 : entry.input)
                                    ? entry.input
                                    : undefined;
                                models.push({ id: id, name: name_1, provider: provider, contextWindow: contextWindow, reasoning: reasoning, input: input });
                            }
                            if (models.length === 0) {
                        ...
                        case 4:
                            ...
                            if (!hasLoggedModelCatalogError) {
                                ...
                                console.warn("[model-catalog] Failed to load model catalog: ".concat(String(error_1)));
                            }
...
function modelSupportsVision(entry) {
    var _a, _b;
    return (_b = (_a = entry === null || entry === void 0 ? void 0 : entry.input) === null || _a === void 0 ? void 0 : _a.includes("image")) !== null && _b !== void 0 ? _b : false;
}
/**
...
function findModelInCatalog(catalog, provider, modelId) {
    ...
    return catalog.find(function (entry) {
        return entry.provider.toLowerCase() === normalizedProvider &&
