...
function guardSessionManager(sessionManager, opts) {
    ...
    var transform = (hookRunner === null || hookRunner === void 0 ? void 0 : hookRunner.hasHooks("tool_result_persist"))
        ? function (message, meta) {
            ...
            return (_a = out === null || out === void 0 ? void 0 : out.message) !== null && _a !== void 0 ? _a : message;
        }
        : undefined;
    var guard = (0, session_tool_result_guard_js_1.installSessionToolResultGuard)(sessionManager, {
        transformToolResultForPersistence: transform,
        allowSyntheticToolResults: opts === null || opts === void 0 ? void 0 : opts.allowSyntheticToolResults,
    });
