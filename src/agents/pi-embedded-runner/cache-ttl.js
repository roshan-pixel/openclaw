...
function readLastCacheTtlTimestamp(sessionManager) {
    ...
    try {
        ...
        for (var i = entries.length - 1; i >= 0; i--) {
            var entry = entries[i];
            if ((entry === null || entry === void 0 ? void 0 : entry.type) !== "custom" || (entry === null || entry === void 0 ? void 0 : entry.customType) !== exports.CACHE_TTL_CUSTOM_TYPE)
                continue;
            var data = entry === null || entry === void 0 ? void 0 : entry.data;
            var ts = typeof (data === null || data === void 0 ? void 0 : data.timestamp) === "number" ? data.timestamp : null;
