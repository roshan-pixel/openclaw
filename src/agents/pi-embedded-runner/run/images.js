...
function sanitizeImagesWithLog(images, label) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, (0, tool_images_js_1.sanitizeImageBlocks)(images, label)];
                case 1:
                    _a = _b.sent(), sanitized = _a.images, dropped = _a.dropped;
                    if (dropped > 0) {
                        logger_js_1.log.warn("Native image: dropped ".concat(dropped, " image(s) after sanitization (").concat(label, ")."));
                    }
...
function detectImageReferences(prompt) {
    ...
    while ((match = mediaAttachedPattern.exec(prompt)) !== null) {
        ...
        var pathMatch = content.match(/^\s*(.+?\.(?:png|jpe?g|gif|webp|bmp|tiff?|heic|heif))\s*(?:\(|$|\|)/i);
    ...
    var messageImagePattern = /\[Image:\s*source:\s*([^\]]+\.(?:png|jpe?g|gif|webp|bmp|tiff?|heic|heif))\]/gi;
    ...
    // - ../parent/path.ext
    // - ~/home/path.ext
    var pathPattern = /(?:^|\s|["'`(])((\.\.?\/|[~/])[^\s"'`()[\]]*\.(?:png|jpe?g|gif|webp|bmp|tiff?|heic|heif))/gi;
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    if (ref.type === "url") {
                        logger_js_1.log.debug("Native image: rejecting remote URL (local-only): ".concat(ref.resolved));
                    ...
                    if (ref.type === "path" && !node_path_1.default.isAbsolute(targetPath)) {
                        resolveRoot = (_b = options === null || options === void 0 ? void 0 : options.sandboxRoot) !== null && _b !== void 0 ? _b : workspaceDir;
                        targetPath = node_path_1.default.resolve(resolveRoot, targetPath);
                    }
                    if (!(ref.type === "path" && (options === null || options === void 0 ? void 0 : options.sandboxRoot))) return [3 /*break*/, 4];
                    _d.label = 1;
                case 1:
                    _d.trys.push([1, 3, , 4]);
                ...
                case 3:
                    ...
                    logger_js_1.log.debug("Native image: sandbox validation failed for ".concat(ref.resolved, ": ").concat(err_1 instanceof Error ? err_1.message : String(err_1)));
                    return [2 /*return*/, null];
                case 4:
                    if (!(ref.type === "path")) return [3 /*break*/, 8];
                    _d.label = 5;
                case 5:
                    _d.trys.push([5, 7, , 8]);
                ...
                case 7:
                    ...
                    return [2 /*return*/, null];
                case 8: return [4 /*yield*/, (0, media_js_1.loadWebMedia)(targetPath, options === null || options === void 0 ? void 0 : options.maxBytes)];
                case 9:
                    media = _d.sent();
                    if (media.kind !== "image") {
                        logger_js_1.log.debug("Native image: not an image file: ".concat(targetPath, " (got ").concat(media.kind, ")"));
                        return [2 /*return*/, null];
                    }
                ...
                case 10:
                    ...
                    logger_js_1.log.debug("Native image: failed to load ".concat(ref.resolved, ": ").concat(err_2 instanceof Error ? err_2.message : String(err_2)));
                    return [2 /*return*/, null];
...
function modelSupportsImages(model) {
    var _a, _b;
    return (_b = (_a = model.input) === null || _a === void 0 ? void 0 : _a.includes("image")) !== null && _b !== void 0 ? _b : false;
}
/**
...
function detectAndLoadPromptImages(params) {
    return __awaiter(this, void 0, void 0, function () {
        var promptRefs, historyRefs, seenPaths, uniqueHistoryRefs, allRefs, promptImages, historyImagesByIndex, loadedCount, skippedCount, _i, allRefs_1, ref, image, existing, sanitizedPromptImages, sanitizedHistoryImagesByIndex, _a, historyImagesByIndex_1, _b, index, images, sanitized;
        var _c, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    ...
                    historyRefs = params.historyMessages ? detectImagesFromHistory(params.historyMessages) : [];
                    seenPaths = new Set(promptRefs.map(function (r) { return r.resolved.toLowerCase(); }));
                    uniqueHistoryRefs = historyRefs.filter(function (r) { return !seenPaths.has(r.resolved.toLowerCase()); });
                    ...
                    logger_js_1.log.debug("Native image: detected ".concat(allRefs.length, " image refs (").concat(promptRefs.length, " in prompt, ").concat(uniqueHistoryRefs.length, " in history)"));
                    promptImages = __spreadArray([], ((_d = params.existingImages) !== null && _d !== void 0 ? _d : []), true);
                    historyImagesByIndex = new Map();
                    loadedCount = 0;
                    skippedCount = 0;
                    ...
                    _e.label = 1;
                case 1:
                    if (!(_i < allRefs_1.length)) return [3 /*break*/, 4];
                    ref = allRefs_1[_i];
                    return [4 /*yield*/, loadImageFromRef(ref, params.workspaceDir, {
                ...
                case 2:
                    ...
                    if (image) {
                        ...
                        loadedCount++;
                        logger_js_1.log.debug("Native image: loaded ".concat(ref.type, " ").concat(ref.resolved));
                    }
                    else {
                        skippedCount++;
                    }
                ...
                case 3:
                    _i++;
                    return [3 /*break*/, 1];
                case 4: return [4 /*yield*/, sanitizeImagesWithLog(promptImages, "prompt:images")];
                case 5:
                    ...
                    _e.label = 6;
                case 6:
                    if (!(_a < historyImagesByIndex_1.length)) return [3 /*break*/, 9];
