...
function compactEmbeddedPiSessionDirect(params) {
    return __awaiter(this, void 0, void 0, function () {
        var resolvedWorkspace, prevCwd, provider, modelId, agentDir, _a, model, error, authStorage, modelRegistry, apiKeyInfo, resolveCopilotApiToken, copilotToken, err_1, sandboxSessionKey, sandbox, effectiveWorkspace, restoreSkillEnv, shouldLoadSkillEntries, skillEntries, skillsPrompt, sessionLabel, contextFiles, runAbortController, toolsRaw, tools, machineName, runtimeChannel_1, runtimeCapabilities, inlineButtonsScope, reactionGuidance, channelActions, messageToolHints, runtimeInfo, sandboxInfo, reasoningTagHint, userTimezone, userTimeFormat, userTime, _b, defaultAgentId, sessionAgentId, isDefaultAgent, promptMode, docsPath, ttsHint, appendPrompt, systemPrompt, sessionLock, transcriptPolicy, sessionManager, settingsManager, additionalExtensionPaths, _c, builtInTools, customTools, session, prior, validatedGemini, validated, limited, result, tokensAfter, _i, _d, message, err_2;
        ...
        return __generator(this, function (_2) {
            switch (_2.label) {
                case 0:
                    ...
                    prevCwd = process.cwd();
                    provider = ((_e = params.provider) !== null && _e !== void 0 ? _e : defaults_js_1.DEFAULT_PROVIDER).trim() || defaults_js_1.DEFAULT_PROVIDER;
                    modelId = ((_f = params.model) !== null && _f !== void 0 ? _f : defaults_js_1.DEFAULT_MODEL).trim() || defaults_js_1.DEFAULT_MODEL;
                    agentDir = (_g = params.agentDir) !== null && _g !== void 0 ? _g : (0, agent_paths_js_1.resolveOpenClawAgentDir)();
                ...
                case 1:
                    ...
                    if (!model) {
                        return [2 /*return*/, {
                                ok: false,
                                compacted: false,
                                reason: error !== null && error !== void 0 ? error : "Unknown model: ".concat(provider, "/").concat(modelId),
                            }];
                    }
                    _2.label = 2;
                case 2:
                ...
                case 10: return [4 /*yield*/, promises_1.default.mkdir(resolvedWorkspace, { recursive: true })];
                case 11:
                    _2.sent();
                    sandboxSessionKey = ((_h = params.sessionKey) === null || _h === void 0 ? void 0 : _h.trim()) || params.sessionId;
                ...
                case 13:
                    _2.sent();
                    return [4 /*yield*/, (0, pi_embedded_helpers_js_1.ensureSessionHeader)({
                ...
                case 16:
                    ...
                    toolsRaw = (0, pi_tools_js_1.createOpenClawCodingTools)({
                        exec: __assign(__assign({}, (0, utils_js_2.resolveExecToolDefaults)(params.config)), { elevated: params.bashElevated }),
                        sandbox: sandbox,
                        messageProvider: (_k = params.messageChannel) !== null && _k !== void 0 ? _k : params.messageProvider,
                ...
                case 17:
                    machineName = _2.sent();
                    runtimeChannel_1 = (0, message_channel_js_1.normalizeMessageChannel)((_m = params.messageChannel) !== null && _m !== void 0 ? _m : params.messageProvider);
                    ...
                    userTimezone = (0, date_time_js_1.resolveUserTimezone)((_s = (_r = (_q = params.config) === null || _q === void 0 ? void 0 : _q.agents) === null || _r === void 0 ? void 0 : _r.defaults) === null || _s === void 0 ? void 0 : _s.userTimezone);
                    userTimeFormat = (0, date_time_js_1.resolveUserTimeFormat)((_v = (_u = (_t = params.config) === null || _t === void 0 ? void 0 : _t.agents) === null || _u === void 0 ? void 0 : _u.defaults) === null || _v === void 0 ? void 0 : _v.timeFormat);
                ...
                case 18:
                    ...
                    appendPrompt = (0, system_prompt_js_1.buildEmbeddedSystemPrompt)({
                        ...
                        heartbeatPrompt: isDefaultAgent
                            ? (0, heartbeat_js_1.resolveHeartbeatPrompt)((_0 = (_z = (_y = (_x = params.config) === null || _x === void 0 ? void 0 : _x.agents) === null || _y === void 0 ? void 0 : _y.defaults) === null || _z === void 0 ? void 0 : _z.heartbeat) === null || _0 === void 0 ? void 0 : _0.prompt)
                            : undefined,
                ...
                case 21:
                    ...
                    }), builtInTools = _c.builtInTools, customTools = _c.customTools;
                    session = void 0;
                ...
                case 26:
                    (_1 = sessionManager.flushPendingToolResults) === null || _1 === void 0 ? void 0 : _1.call(sessionManager);
                    session.dispose();
                    return [7 /*endfinally*/];
                case 27: return [3 /*break*/, 30];
                case 28: return [4 /*yield*/, sessionLock.release()];
                case 29:
                    _2.sent();
                    return [7 /*endfinally*/];
...
function compactEmbeddedPiSession(params) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            ...
            return [2 /*return*/, (0, command_queue_js_1.enqueueCommandInLane)(sessionLane, function () {
                    return enqueueGlobal(function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
