...
Object.defineProperty(exports, "ensurePiCompactionReserveTokens", { enumerable: true, get: function () { return pi_settings_js_1.ensurePiCompactionReserveTokens; } });
...
function buildContextPruningExtension(params) {
    var _a, _b, _c;
    var raw = (_c = (_b = (_a = params.cfg) === null || _a === void 0 ? void 0 : _a.agents) === null || _b === void 0 ? void 0 : _b.defaults) === null || _c === void 0 ? void 0 : _c.contextPruning;
...
function resolveCompactionMode(cfg) {
    var _a, _b, _c;
    return ((_c = (_b = (_a = cfg === null || cfg === void 0 ? void 0 : cfg.agents) === null || _a === void 0 ? void 0 : _a.defaults) === null || _b === void 0 ? void 0 : _b.compaction) === null || _c === void 0 ? void 0 : _c.mode) === "safeguard" ? "safeguard" : "default";
}
function buildEmbeddedExtensionPaths(params) {
    var _a, _b, _c;
    var paths = [];
    if (resolveCompactionMode(params.cfg) === "safeguard") {
        var compactionCfg = (_c = (_b = (_a = params.cfg) === null || _a === void 0 ? void 0 : _a.agents) === null || _b === void 0 ? void 0 : _b.defaults) === null || _c === void 0 ? void 0 : _c.compaction;
        (0, compaction_safeguard_runtime_js_1.setCompactionSafeguardRuntime)(params.sessionManager, {
            maxHistoryShare: compactionCfg === null || compactionCfg === void 0 ? void 0 : compactionCfg.maxHistoryShare,
        });
