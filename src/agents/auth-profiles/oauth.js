        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, proper_lockfile_1.default.lock(authPath, __assign({}, constants_js_1.AUTH_STORE_LOCK_OPTIONS))];
                case 2:
                    release = _e.sent();
                    ...
                    oauthCreds = (_d = {},
                        _d[cred_1.provider] = cred_1,
                        _d);
                    if (!(String(cred_1.provider) === "chutes")) return [3 /*break*/, 4];
                    return [4 /*yield*/, (function () { return __awaiter(_this, void 0, void 0, function () {
                            var newCredentials;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, (0, chutes_oauth_js_1.refreshChutesTokens)({
                                            credential: cred_1,
                                        })];
                                    case 1:
                                        newCredentials = _a.sent();
                                        return [2 /*return*/, { apiKey: newCredentials.access, newCredentials: newCredentials }];
                                }
                            });
                        }); })()];
                case 3:
                    ...
                    return [3 /*break*/, 9];
                case 4:
                    if (!(String(cred_1.provider) === "qwen-portal")) return [3 /*break*/, 6];
                    return [4 /*yield*/, (function () { return __awaiter(_this, void 0, void 0, function () {
                            var newCredentials;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, (0, qwen_portal_oauth_js_1.refreshQwenPortalCredentials)(cred_1)];
                                    case 1:
                                        newCredentials = _a.sent();
                                        return [2 /*return*/, { apiKey: newCredentials.access, newCredentials: newCredentials }];
                                }
                ...
                case 5:
                    _b = _e.sent();
                    return [3 /*break*/, 8];
                case 6: return [4 /*yield*/, (0, pi_ai_1.getOAuthApiKey)(cred_1.provider, oauthCreds)];
                case 7:
                    _b = _e.sent();
                    _e.label = 8;
                case 8:
                ...
                case 9:
                    ...
                    if (!result)
                        return [2 /*return*/, null];
                    store.profiles[params.profileId] = __assign(__assign(__assign({}, cred_1), result.newCredentials), { type: "oauth" });
            ...
            switch (_c.label) {
                case 0:
                    ...
                    if (!cred || cred.type !== "oauth")
                        return [2 /*return*/, null];
                    profileConfig = (_b = (_a = cfg === null || cfg === void 0 ? void 0 : cfg.auth) === null || _a === void 0 ? void 0 : _a.profiles) === null || _b === void 0 ? void 0 : _b[profileId];
                    ...
                    return [4 /*yield*/, refreshOAuthTokenWithLock({
                            profileId: profileId,
...
function resolveApiKeyForProfile(params) {
    return __awaiter(this, void 0, void 0, function () {
        var cfg, store, profileId, cred, profileConfig, token, result, error_1, refreshedStore, refreshed, fallbackProfileId, fallbackResolved, _a, mainStore, mainCred, message, hint;
        var _b, _c, _d, _e;
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                    ...
                    if (!cred)
                        return [2 /*return*/, null];
                    profileConfig = (_c = (_b = cfg === null || cfg === void 0 ? void 0 : cfg.auth) === null || _b === void 0 ? void 0 : _b.profiles) === null || _c === void 0 ? void 0 : _c[profileId];
                    if (profileConfig && profileConfig.provider !== cred.provider)
                        return [2 /*return*/, null];
                    if (profileConfig && profileConfig.mode !== cred.type) {
                ...
                case 3:
                    ...
                    if ((refreshed === null || refreshed === void 0 ? void 0 : refreshed.type) === "oauth" && Date.now() < refreshed.expires) {
                        return [2 /*return*/, {
                    ...
                    if (!(fallbackProfileId && fallbackProfileId !== profileId)) return [3 /*break*/, 7];
                    _f.label = 4;
                case 4:
                    _f.trys.push([4, 6, , 7]);
                    return [4 /*yield*/, tryResolveOAuthProfile({
                            cfg: cfg,
                            store: refreshedStore,
                ...
                case 7:
                    ...
                    if (params.agentDir) {
                        try {
                            ...
                            if ((mainCred === null || mainCred === void 0 ? void 0 : mainCred.type) === "oauth" && Date.now() < mainCred.expires) {
                    ...
                    throw new Error("OAuth token refresh failed for ".concat(cred.provider, ": ").concat(message, ". ") +
