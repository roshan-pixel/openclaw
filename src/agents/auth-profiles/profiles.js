        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    sanitized = params.order && Array.isArray(params.order)
                        ? params.order.map(function (entry) { return String(entry).trim(); }).filter(Boolean)
                        : [];
                    deduped = [];
...
function markAuthProfileGood(params) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    store = params.store, provider = params.provider, profileId = params.profileId, agentDir = params.agentDir;
                    return [4 /*yield*/, (0, store_js_1.updateAuthProfileStoreWithLock)({
                            agentDir: agentDir,
                            updater: function (freshStore) {
                                ...
                                if (!profile || profile.provider !== provider)
                                    return false;
                                freshStore.lastGood = __assign(__assign({}, freshStore.lastGood), (_a = {}, _a[provider] = profileId, _a));
                                return true;
                            },
                        })];
                case 1:
                    ...
                    if (!profile || profile.provider !== provider)
                        return [2 /*return*/];
                    store.lastGood = __assign(__assign({}, store.lastGood), (_a = {}, _a[provider] = profileId, _a));
