...
function resolveAuthProfileOrder(params) {
    var _a, _b, _c, _d;
    var cfg = params.cfg, store = params.store, provider = params.provider, preferredProfile = params.preferredProfile;
    ...
    var configuredOrder = (function () {
        var _a;
        var order = (_a = cfg === null || cfg === void 0 ? void 0 : cfg.auth) === null || _a === void 0 ? void 0 : _a.order;
        if (!order)
            return undefined;
    ...
    var explicitOrder = storedOrder !== null && storedOrder !== void 0 ? storedOrder : configuredOrder;
    var explicitProfiles = ((_a = cfg === null || cfg === void 0 ? void 0 : cfg.auth) === null || _a === void 0 ? void 0 : _a.profiles)
        ...
        : [];
    var baseOrder = explicitOrder !== null && explicitOrder !== void 0 ? explicitOrder : (explicitProfiles.length > 0 ? explicitProfiles : (0, profiles_js_1.listProfilesForProvider)(store, providerKey));
    ...
    var filtered = baseOrder.filter(function (profileId) {
        ...
        if ((0, model_selection_js_1.normalizeProviderId)(cred.provider) !== providerKey)
            return false;
        var profileConfig = (_b = (_a = cfg === null || cfg === void 0 ? void 0 : cfg.auth) === null || _a === void 0 ? void 0 : _a.profiles) === null || _b === void 0 ? void 0 : _b[profileId];
        if (profileConfig) {
        ...
        if (cred.type === "oauth") {
            return Boolean(((_e = cred.access) === null || _e === void 0 ? void 0 : _e.trim()) || ((_f = cred.refresh) === null || _f === void 0 ? void 0 : _f.trim()));
        }
        return false;
    });
    var deduped = [];
    ...
    if (explicitOrder && explicitOrder.length > 0) {
        ...
        for (var _e = 0, deduped_1 = deduped; _e < deduped_1.length; _e++) {
            ...
            var cooldownUntil = (_d = resolveProfileUnusableUntil((_c = (_b = store.usageStats) === null || _b === void 0 ? void 0 : _b[profileId]) !== null && _c !== void 0 ? _c : {})) !== null && _d !== void 0 ? _d : 0;
        ...
        var cooldownSorted = inCooldown
            .sort(function (a, b) { return a.cooldownUntil - b.cooldownUntil; })
            .map(function (entry) { return entry.profileId; });
        var ordered = __spreadArray(__spreadArray([], available, true), cooldownSorted, true);
        // Still put preferredProfile first if specified
        if (preferredProfile && ordered.includes(preferredProfile)) {
            return __spreadArray([preferredProfile], ordered.filter(function (e) { return e !== preferredProfile; }), true);
        }
        return ordered;
    }
    ...
    if (preferredProfile && sorted.includes(preferredProfile)) {
        return __spreadArray([preferredProfile], sorted.filter(function (e) { return e !== preferredProfile; }), true);
    }
    return sorted;
}
function orderProfilesByMode(order, store) {
    ...
    var scored = available.map(function (profileId) {
        ...
        var lastUsed = (_d = (_c = (_b = store.usageStats) === null || _b === void 0 ? void 0 : _b[profileId]) === null || _c === void 0 ? void 0 : _c.lastUsed) !== null && _d !== void 0 ? _d : 0;
    ...
    var cooldownSorted = inCooldown
        ...
        return ({
            profileId: profileId,
            cooldownUntil: (_c = resolveProfileUnusableUntil((_b = (_a = store.usageStats) === null || _a === void 0 ? void 0 : _a[profileId]) !== null && _b !== void 0 ? _b : {})) !== null && _c !== void 0 ? _c : now,
        });
    })
        .sort(function (a, b) { return a.cooldownUntil - b.cooldownUntil; })
        .map(function (entry) { return entry.profileId; });
