                    ...
                    return [4 /*yield*/, (0, store_js_1.updateAuthProfileStoreWithLock)({
                            ...
                            updater: function (freshStore) {
                                ...
                                if (!freshStore.profiles[profileId])
                                    return false;
                                freshStore.usageStats = (_a = freshStore.usageStats) !== null && _a !== void 0 ? _a : {};
                                freshStore.usageStats[profileId] = __assign(__assign({}, freshStore.usageStats[profileId]), { lastUsed: Date.now(), errorCount: 0, cooldownUntil: undefined, disabledUntil: undefined, disabledReason: undefined, failureCounts: undefined });
                                return true;
                            },
                        })];
                case 1:
                    ...
                    store.usageStats[profileId] = __assign(__assign({}, store.usageStats[profileId]), { lastUsed: Date.now(), errorCount: 0, cooldownUntil: undefined, disabledUntil: undefined, disabledReason: undefined, failureCounts: undefined });
...
function resolveAuthCooldownConfig(params) {
    ...
    var cooldowns = (_b = (_a = params.cfg) === null || _a === void 0 ? void 0 : _a.auth) === null || _b === void 0 ? void 0 : _b.cooldowns;
    var billingOverride = (function () {
        var map = cooldowns === null || cooldowns === void 0 ? void 0 : cooldowns.billingBackoffHoursByProvider;
        if (!map)
            return undefined;
    ...
    var billingBackoffHours = resolveHours(billingOverride !== null && billingOverride !== void 0 ? billingOverride : cooldowns === null || cooldowns === void 0 ? void 0 : cooldowns.billingBackoffHours, defaults.billingBackoffHours);
    var billingMaxHours = resolveHours(cooldowns === null || cooldowns === void 0 ? void 0 : cooldowns.billingMaxHours, defaults.billingMaxHours);
    var failureWindowHours = resolveHours(cooldowns === null || cooldowns === void 0 ? void 0 : cooldowns.failureWindowHours, defaults.failureWindowHours);
    return {
...
function computeNextProfileUsageStats(params) {
    ...
    var windowExpired = typeof params.existing.lastFailureAt === "number" &&
        params.existing.lastFailureAt > 0 &&
        params.now - params.existing.lastFailureAt > windowMs;
    var baseErrorCount = windowExpired ? 0 : ((_a = params.existing.errorCount) !== null && _a !== void 0 ? _a : 0);
    var nextErrorCount = baseErrorCount + 1;
    var failureCounts = windowExpired ? {} : __assign({}, params.existing.failureCounts);
    failureCounts[params.reason] = ((_b = failureCounts[params.reason]) !== null && _b !== void 0 ? _b : 0) + 1;
    var updatedStats = __assign(__assign({}, params.existing), { errorCount: nextErrorCount, failureCounts: failureCounts, lastFailureAt: params.now });
...
function markAuthProfileFailure(params) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    store = params.store, profileId = params.profileId, reason = params.reason, agentDir = params.agentDir, cfg = params.cfg;
                    return [4 /*yield*/, (0, store_js_1.updateAuthProfileStoreWithLock)({
                            agentDir: agentDir,
                            updater: function (freshStore) {
                                var _a, _b;
                                ...
                                if (!profile)
                                    return false;
                                freshStore.usageStats = (_a = freshStore.usageStats) !== null && _a !== void 0 ? _a : {};
                                var existing = (_b = freshStore.usageStats[profileId]) !== null && _b !== void 0 ? _b : {};
                                var now = Date.now();
                ...
                case 1:
                    ...
                    now = Date.now();
                    providerKey = (0, model_selection_js_1.normalizeProviderId)((_d = (_c = store.profiles[profileId]) === null || _c === void 0 ? void 0 : _c.provider) !== null && _d !== void 0 ? _d : "");
...
function markAuthProfileCooldown(params) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, markAuthProfileFailure({
                        store: params.store,
            ...
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, store_js_1.updateAuthProfileStoreWithLock)({
                            ...
                            updater: function (freshStore) {
                                var _a;
                                if (!((_a = freshStore.usageStats) === null || _a === void 0 ? void 0 : _a[profileId]))
                                    return false;
                                freshStore.usageStats[profileId] = __assign(__assign({}, freshStore.usageStats[profileId]), { errorCount: 0, cooldownUntil: undefined });
                                return true;
                            },
                        })];
                case 1:
                    ...
                    if (!((_a = store.usageStats) === null || _a === void 0 ? void 0 : _a[profileId]))
                        return [2 /*return*/];
                    store.usageStats[profileId] = __assign(__assign({}, store.usageStats[profileId]), { errorCount: 0, cooldownUntil: undefined });
                    (0, store_js_1.saveAuthProfileStore)(store, agentDir);
                    return [2 /*return*/];
            }
        });
