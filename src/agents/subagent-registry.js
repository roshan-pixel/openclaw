...
function resumeSubagentRun(runId) {
    ...
    if (typeof entry.endedAt === "number" && entry.endedAt > 0) {
        if (!beginSubagentCleanup(runId))
            return;
        var requesterOrigin = (0, delivery_context_js_1.normalizeDeliveryContext)(entry.requesterOrigin);
...
function restoreSubagentRunsOnce() {
    ...
    try {
        ...
        for (var _i = 0, _a = restored.entries(); _i < _a.length; _i++) {
            var _b = _a[_i], runId = _b[0], entry = _b[1];
            if (!runId || !entry)
                continue;
        ...
        // Resume pending work.
        ensureListener();
        if (__spreadArray([], subagentRuns.values(), true).some(function (entry) { return entry.archiveAtMs; })) {
            startSweeper();
        }
...
function resolveArchiveAfterMs(cfg) {
    ...
    var minutes = (_d = (_c = (_b = (_a = config.agents) === null || _a === void 0 ? void 0 : _a.defaults) === null || _b === void 0 ? void 0 : _b.subagents) === null || _c === void 0 ? void 0 : _c.archiveAfterMinutes) !== null && _d !== void 0 ? _d : 60;
...
function ensureListener() {
    ...
    listenerStop = (0, agent_events_js_1.onAgentEvent)(function (evt) {
        ...
        if (phase === "start") {
            var startedAt = typeof ((_b = evt.data) === null || _b === void 0 ? void 0 : _b.startedAt) === "number" ? evt.data.startedAt : undefined;
            if (startedAt) {
        ...
        if (phase !== "end" && phase !== "error")
            return;
        var endedAt = typeof ((_c = evt.data) === null || _c === void 0 ? void 0 : _c.endedAt) === "number" ? evt.data.endedAt : Date.now();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    wait = (_b.sent());
                    if ((wait === null || wait === void 0 ? void 0 : wait.status) !== "ok" && (wait === null || wait === void 0 ? void 0 : wait.status) !== "error")
                        return [2 /*return*/];
                    ...
                    if (!beginSubagentCleanup(runId))
                        return [2 /*return*/];
                    requesterOrigin = (0, delivery_context_js_1.normalizeDeliveryContext)(entry_1.requesterOrigin);
                    void (0, subagent_announce_js_1.runSubagentAnnounceFlow)({
...
function listSubagentRunsForRequester(requesterSessionKey) {
    ...
    if (!key)
        return [];
    return __spreadArray([], subagentRuns.values(), true).filter(function (entry) { return entry.requesterSessionKey === key; });
}
