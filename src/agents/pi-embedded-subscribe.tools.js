...
function truncateToolText(text) {
    if (text.length <= TOOL_RESULT_MAX_CHARS)
        return text;
    return "".concat((0, utils_js_1.truncateUtf16Safe)(text, TOOL_RESULT_MAX_CHARS), "\n\u2026(truncated)\u2026");
}
...
function extractErrorField(value) {
    ...
    if (!value || typeof value !== "object")
        return undefined;
    var record = value;
    var direct = (_b = (_a = readErrorCandidate(record.error)) !== null && _a !== void 0 ? _a : readErrorCandidate(record.message)) !== null && _b !== void 0 ? _b : readErrorCandidate(record.reason);
    if (direct)
        return direct;
...
function extractMessagingToolSend(toolName, args) {
    ...
    if (toolName === "message") {
        ...
        var provider = providerId_1 !== null && providerId_1 !== void 0 ? providerId_1 : (providerHint ? providerHint.toLowerCase() : "message");
        var to_1 = (0, target_normalization_js_1.normalizeTargetForProvider)(provider, toRaw);
        return to_1 ? { tool: toolName, provider: provider, accountId: accountId, to: to_1 } : undefined;
    }
    var providerId = (0, index_js_1.normalizeChannelId)(toolName);
    if (!providerId)
        return undefined;
    var plugin = (0, index_js_1.getChannelPlugin)(providerId);
    var extracted = (_b = (_a = plugin === null || plugin === void 0 ? void 0 : plugin.actions) === null || _a === void 0 ? void 0 : _a.extractToolSend) === null || _b === void 0 ? void 0 : _b.call(_a, { args: args });
