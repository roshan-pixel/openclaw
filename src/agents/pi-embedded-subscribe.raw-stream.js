...
var RAW_STREAM_PATH = ((_a = process.env.OPENCLAW_RAW_STREAM_PATH) === null || _a === void 0 ? void 0 : _a.trim()) ||
...
function appendRawStream(payload) {
    ...
    if (!rawStreamReady) {
        rawStreamReady = true;
        try {
            node_fs_1.default.mkdirSync(node_path_1.default.dirname(RAW_STREAM_PATH), { recursive: true });
        }
        catch (_a) {
    ...
    try {
        void node_fs_1.default.promises.appendFile(RAW_STREAM_PATH, "".concat(JSON.stringify(payload), "\n"));
    }
    catch (_b) {
