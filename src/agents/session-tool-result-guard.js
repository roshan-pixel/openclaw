...
function installSessionToolResultGuard(sessionManager, opts) {
    ...
    var persistToolResult = function (message, meta) {
        var transformer = opts === null || opts === void 0 ? void 0 : opts.transformToolResultForPersistence;
        return transformer ? transformer(message, meta) : message;
    };
    var allowSyntheticToolResults = (_a = opts === null || opts === void 0 ? void 0 : opts.allowSyntheticToolResults) !== null && _a !== void 0 ? _a : true;
    var flushPendingToolResults = function () {
        if (pending.size === 0)
            return;
        if (allowSyntheticToolResults) {
            for (var _i = 0, _a = pending.entries(); _i < _a.length; _i++) {
                var _b = _a[_i], id = _b[0], name_1 = _b[1];
                var synthetic = (0, session_transcript_repair_js_1.makeMissingToolResult)({ toolCallId: id, toolName: name_1 });
    ...
    var guardedAppend = function (message) {
        ...
        var sessionFile = (_b = (_a = sessionManager).getSessionFile) === null || _b === void 0 ? void 0 : _b.call(_a);
        if (sessionFile) {
    ...
    return {
        ...
        getPendingIds: function () { return Array.from(pending.keys()); },
    };
}
