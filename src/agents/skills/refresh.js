...
function resolveWatchPaths(workspaceDir, config) {
    ...
    var extraDirsRaw = (_c = (_b = (_a = config === null || config === void 0 ? void 0 : config.skills) === null || _a === void 0 ? void 0 : _a.load) === null || _b === void 0 ? void 0 : _b.extraDirs) !== null && _c !== void 0 ? _c : [];
    var extraDirs = extraDirsRaw
        .map(function (d) { return (typeof d === "string" ? d.trim() : ""); })
        .filter(Boolean)
        .map(function (dir) { return (0, utils_js_1.resolveUserPath)(dir); });
    paths.push.apply(paths, extraDirs);
    var pluginSkillDirs = (0, plugin_skills_js_1.resolvePluginSkillDirs)({ workspaceDir: workspaceDir, config: config });
...
function bumpSkillsSnapshotVersion(params) {
    var _a, _b;
    var reason = (_a = params === null || params === void 0 ? void 0 : params.reason) !== null && _a !== void 0 ? _a : "manual";
    ...
    if (params === null || params === void 0 ? void 0 : params.workspaceDir) {
        var current = (_b = workspaceVersions.get(params.workspaceDir)) !== null && _b !== void 0 ? _b : 0;
...
function ensureSkillsWatcher(params) {
    ...
    if (!workspaceDir)
        return;
    var watchEnabled = ((_c = (_b = (_a = params.config) === null || _a === void 0 ? void 0 : _a.skills) === null || _b === void 0 ? void 0 : _b.load) === null || _c === void 0 ? void 0 : _c.watch) !== false;
    var debounceMsRaw = (_f = (_e = (_d = params.config) === null || _d === void 0 ? void 0 : _d.skills) === null || _e === void 0 ? void 0 : _e.load) === null || _f === void 0 ? void 0 : _f.watchDebounceMs;
    var debounceMs = typeof debounceMsRaw === "number" && Number.isFinite(debounceMsRaw)
    ...
    var schedule = function (changedPath) {
        state.pendingPath = changedPath !== null && changedPath !== void 0 ? changedPath : state.pendingPath;
        if (state.timer)
    ...
    watcher.on("add", function (p) { return schedule(p); });
    watcher.on("change", function (p) { return schedule(p); });
    watcher.on("unlink", function (p) { return schedule(p); });
