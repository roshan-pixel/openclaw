...
function resolvePluginSkillDirs(params) {
    ...
    if (registry.plugins.length === 0)
        return [];
    var normalizedPlugins = (0, config_state_js_1.normalizePluginsConfig)((_a = params.config) === null || _a === void 0 ? void 0 : _a.plugins);
    ...
    for (var _i = 0, _b = registry.plugins; _i < _b.length; _i++) {
        ...
        if (!record.skills || record.skills.length === 0)
            continue;
        var enableState = (0, config_state_js_1.resolveEnableState)(record.id, record.origin, normalizedPlugins);
