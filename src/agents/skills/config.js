...
function resolveSkillConfig(config, skillKey) {
    var _a;
    var skills = (_a = config === null || config === void 0 ? void 0 : config.skills) === null || _a === void 0 ? void 0 : _a.entries;
...
function normalizeAllowlist(input) {
    ...
    if (!Array.isArray(input))
        return undefined;
    var normalized = input.map(function (entry) { return String(entry).trim(); }).filter(Boolean);
...
function resolveBundledAllowlist(config) {
    var _a;
    return normalizeAllowlist((_a = config === null || config === void 0 ? void 0 : config.skills) === null || _a === void 0 ? void 0 : _a.allowBundled);
}
...
function shouldIncludeSkill(params) {
    ...
    var allowBundled = normalizeAllowlist((_a = config === null || config === void 0 ? void 0 : config.skills) === null || _a === void 0 ? void 0 : _a.allowBundled);
    var osList = (_c = (_b = entry.metadata) === null || _b === void 0 ? void 0 : _b.os) !== null && _c !== void 0 ? _c : [];
    var remotePlatforms = (_e = (_d = eligibility === null || eligibility === void 0 ? void 0 : eligibility.remote) === null || _d === void 0 ? void 0 : _d.platforms) !== null && _e !== void 0 ? _e : [];
    ...
    var requiredBins = (_j = (_h = (_g = entry.metadata) === null || _g === void 0 ? void 0 : _g.requires) === null || _h === void 0 ? void 0 : _h.bins) !== null && _j !== void 0 ? _j : [];
    if (requiredBins.length > 0) {
        for (var _i = 0, requiredBins_1 = requiredBins; _i < requiredBins_1.length; _i++) {
            var bin = requiredBins_1[_i];
            if (hasBinary(bin))
                continue;
            if ((_l = (_k = eligibility === null || eligibility === void 0 ? void 0 : eligibility.remote) === null || _k === void 0 ? void 0 : _k.hasBin) === null || _l === void 0 ? void 0 : _l.call(_k, bin))
                continue;
            return false;
        }
    }
    var requiredAnyBins = (_p = (_o = (_m = entry.metadata) === null || _m === void 0 ? void 0 : _m.requires) === null || _o === void 0 ? void 0 : _o.anyBins) !== null && _p !== void 0 ? _p : [];
    if (requiredAnyBins.length > 0) {
        var anyFound = requiredAnyBins.some(function (bin) { return hasBinary(bin); }) ||
            ((_r = (_q = eligibility === null || eligibility === void 0 ? void 0 : eligibility.remote) === null || _q === void 0 ? void 0 : _q.hasAnyBin) === null || _r === void 0 ? void 0 : _r.call(_q, requiredAnyBins));
        if (!anyFound)
            return false;
    }
    var requiredEnv = (_u = (_t = (_s = entry.metadata) === null || _s === void 0 ? void 0 : _s.requires) === null || _t === void 0 ? void 0 : _t.env) !== null && _u !== void 0 ? _u : [];
    if (requiredEnv.length > 0) {
        for (var _0 = 0, requiredEnv_1 = requiredEnv; _0 < requiredEnv_1.length; _0++) {
            var envName = requiredEnv_1[_0];
            if (process.env[envName])
                continue;
            if ((_v = skillConfig === null || skillConfig === void 0 ? void 0 : skillConfig.env) === null || _v === void 0 ? void 0 : _v[envName])
                continue;
            if ((skillConfig === null || skillConfig === void 0 ? void 0 : skillConfig.apiKey) && ((_w = entry.metadata) === null || _w === void 0 ? void 0 : _w.primaryEnv) === envName) {
                continue;
            }
            return false;
        }
    }
    var requiredConfig = (_z = (_y = (_x = entry.metadata) === null || _x === void 0 ? void 0 : _x.requires) === null || _y === void 0 ? void 0 : _y.config) !== null && _z !== void 0 ? _z : [];
