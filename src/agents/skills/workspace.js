...
function filterSkillEntries(entries, config, skillFilter, eligibility) {
    var filtered = entries.filter(function (entry) { return (0, config_js_1.shouldIncludeSkill)({ entry: entry, config: config, eligibility: eligibility }); });
    // If skillFilter is provided, only include skills in the filter list.
    if (skillFilter !== undefined) {
        var normalized_1 = skillFilter.map(function (entry) { return String(entry).trim(); }).filter(Boolean);
        ...
        filtered =
            normalized_1.length > 0
                ? filtered.filter(function (entry) { return normalized_1.includes(entry.skill.name); })
                : [];
        console.log("[skills] After filter: ".concat(filtered.map(function (entry) { return entry.skill.name; }).join(", ")));
    }
    return filtered;
}
...
function loadSkillEntries(workspaceDir, opts) {
    ...
    var bundledSkillsDir = (_b = opts === null || opts === void 0 ? void 0 : opts.bundledSkillsDir) !== null && _b !== void 0 ? _b : (0, bundled_dir_js_1.resolveBundledSkillsDir)();
    var extraDirsRaw = (_f = (_e = (_d = (_c = opts === null || opts === void 0 ? void 0 : opts.config) === null || _c === void 0 ? void 0 : _c.skills) === null || _d === void 0 ? void 0 : _d.load) === null || _e === void 0 ? void 0 : _e.extraDirs) !== null && _f !== void 0 ? _f : [];
...
function buildWorkspaceSkillSnapshot(workspaceDir, opts) {
    var _a, _b, _c, _d;
    var skillEntries = (_a = opts === null || opts === void 0 ? void 0 : opts.entries) !== null && _a !== void 0 ? _a : loadSkillEntries(workspaceDir, opts);
    var eligible = filterSkillEntries(skillEntries, opts === null || opts === void 0 ? void 0 : opts.config, opts === null || opts === void 0 ? void 0 : opts.skillFilter, opts === null || opts === void 0 ? void 0 : opts.eligibility);
    var promptEntries = eligible.filter(function (entry) { var _a; return ((_a = entry.invocation) === null || _a === void 0 ? void 0 : _a.disableModelInvocation) !== true; });
    var resolvedSkills = promptEntries.map(function (entry) { return entry.skill; });
    var remoteNote = (_d = (_c = (_b = opts === null || opts === void 0 ? void 0 : opts.eligibility) === null || _b === void 0 ? void 0 : _b.remote) === null || _c === void 0 ? void 0 : _c.note) === null || _d === void 0 ? void 0 : _d.trim();
    var prompt = [remoteNote, (0, pi_coding_agent_1.formatSkillsForPrompt)(resolvedSkills)].filter(Boolean).join("\n");
    return {
        prompt: prompt,
...
function buildWorkspaceSkillsPrompt(workspaceDir, opts) {
    ...
    var promptEntries = eligible.filter(function (entry) { var _a; return ((_a = entry.invocation) === null || _a === void 0 ? void 0 : _a.disableModelInvocation) !== true; });
    var remoteNote = (_d = (_c = (_b = opts === null || opts === void 0 ? void 0 : opts.eligibility) === null || _b === void 0 ? void 0 : _b.remote) === null || _c === void 0 ? void 0 : _c.note) === null || _d === void 0 ? void 0 : _d.trim();
    return [remoteNote, (0, pi_coding_agent_1.formatSkillsForPrompt)(promptEntries.map(function (entry) { return entry.skill; }))]
        .filter(Boolean)
        .join("\n");
}
function resolveSkillsPromptForRun(params) {
    var _a, _b;
    var snapshotPrompt = (_b = (_a = params.skillsSnapshot) === null || _a === void 0 ? void 0 : _a.prompt) === null || _b === void 0 ? void 0 : _b.trim();
    if (snapshotPrompt)
            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (sourceDir === targetDir)
                        return [2 /*return*/];
                    return [4 /*yield*/, (0, serialize_js_1.serializeByKey)("syncSkills:".concat(targetDir), function () { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, fsp.rm(targetSkillsDir, { recursive: true, force: true })];
                                    case 1:
                                        _a.sent();
                                    ...
                                    case 4:
                                        _a.trys.push([4, 6, , 7]);
                                        return [4 /*yield*/, fsp.cp(entry.skill.baseDir, dest, {
                                                recursive: true,
                                                force: true,
                                            })];
                                    case 5:
                                    ...
                                    case 6:
                                        ...
                                        console.warn("[skills] Failed to copy ".concat(entry.skill.name, " to sandbox: ").concat(message));
                                        return [3 /*break*/, 7];
                                    case 7:
                                        _i++;
                                        return [3 /*break*/, 3];
...
function buildWorkspaceSkillCommandSpecs(workspaceDir, opts) {
    ...
    var skillEntries = (_a = opts === null || opts === void 0 ? void 0 : opts.entries) !== null && _a !== void 0 ? _a : loadSkillEntries(workspaceDir, opts);
    var eligible = filterSkillEntries(skillEntries, opts === null || opts === void 0 ? void 0 : opts.config, opts === null || opts === void 0 ? void 0 : opts.skillFilter, opts === null || opts === void 0 ? void 0 : opts.eligibility);
    var userInvocable = eligible.filter(function (entry) { var _a; return ((_a = entry.invocation) === null || _a === void 0 ? void 0 : _a.userInvocable) !== false; });
    var used = new Set();
    for (var _i = 0, _d = (_b = opts === null || opts === void 0 ? void 0 : opts.reservedNames) !== null && _b !== void 0 ? _b : []; _i < _d.length; _i++) {
        var reserved = _d[_i];
    ...
    var _loop_1 = function (entry) {
        ...
        if (base !== rawName) {
            debugSkillCommandOnce("sanitize:".concat(rawName, ":").concat(base), "Sanitized skill command name \"".concat(rawName, "\" to \"/").concat(base, "\"."), { rawName: rawName, sanitized: "/".concat(base) });
        }
        var unique = resolveUniqueSkillCommandName(base, used);
        if (unique !== base) {
            debugSkillCommandOnce("dedupe:".concat(rawName, ":").concat(unique), "De-duplicated skill command name for \"".concat(rawName, "\" to \"/").concat(unique, "\"."), { rawName: rawName, deduped: "/".concat(unique) });
        }
        used.add(unique.toLowerCase());
        var rawDescription = ((_c = entry.skill.description) === null || _c === void 0 ? void 0 : _c.trim()) || rawName;
        var description = rawDescription.length > SKILL_COMMAND_DESCRIPTION_MAX_LENGTH
            ? rawDescription.slice(0, SKILL_COMMAND_DESCRIPTION_MAX_LENGTH - 1) + "…"
            : rawDescription;
        var dispatch = (function () {
            var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m;
            var kindRaw = ((_d = (_b = (_a = entry.frontmatter) === null || _a === void 0 ? void 0 : _a["command-dispatch"]) !== null && _b !== void 0 ? _b : (_c = entry.frontmatter) === null || _c === void 0 ? void 0 : _c["command_dispatch"]) !== null && _d !== void 0 ? _d : "")
                .trim()
                .toLowerCase();
            if (!kindRaw)
                return undefined;
            if (kindRaw !== "tool")
                return undefined;
            var toolName = ((_h = (_f = (_e = entry.frontmatter) === null || _e === void 0 ? void 0 : _e["command-tool"]) !== null && _f !== void 0 ? _f : (_g = entry.frontmatter) === null || _g === void 0 ? void 0 : _g["command_tool"]) !== null && _h !== void 0 ? _h : "").trim();
            if (!toolName) {
                debugSkillCommandOnce("dispatch:missingTool:".concat(rawName), "Skill command \"/".concat(unique, "\" requested tool dispatch but did not provide command-tool. Ignoring dispatch."), { skillName: rawName, command: unique });
                return undefined;
            }
            var argModeRaw = ((_m = (_k = (_j = entry.frontmatter) === null || _j === void 0 ? void 0 : _j["command-arg-mode"]) !== null && _k !== void 0 ? _k : (_l = entry.frontmatter) === null || _l === void 0 ? void 0 : _l["command_arg_mode"]) !== null && _m !== void 0 ? _m : "")
                .trim()
                .toLowerCase();
            var argMode = !argModeRaw || argModeRaw === "raw" ? "raw" : null;
            if (!argMode) {
                debugSkillCommandOnce("dispatch:badArgMode:".concat(rawName, ":").concat(argModeRaw), "Skill command \"/".concat(unique, "\" requested tool dispatch but has unknown command-arg-mode. Falling back to raw."), { skillName: rawName, command: unique, argMode: argModeRaw });
            }
            return { kind: "tool", toolName: toolName, argMode: "raw" };
        })();
        specs.push(__assign({ name: unique, skillName: rawName, description: description }, (dispatch ? { dispatch: dispatch } : {})));
    };
