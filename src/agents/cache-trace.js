...
function resolveCacheTraceConfig(params) {
    ...
    var config = (_c = (_b = params.cfg) === null || _b === void 0 ? void 0 : _b.diagnostics) === null || _c === void 0 ? void 0 : _c.cacheTrace;
    var envEnabled = (0, boolean_js_1.parseBooleanValue)(env.OPENCLAW_CACHE_TRACE);
    var enabled = (_d = envEnabled !== null && envEnabled !== void 0 ? envEnabled : config === null || config === void 0 ? void 0 : config.enabled) !== null && _d !== void 0 ? _d : false;
    var fileOverride = ((_e = config === null || config === void 0 ? void 0 : config.filePath) === null || _e === void 0 ? void 0 : _e.trim()) || ((_f = env.OPENCLAW_CACHE_TRACE_FILE) === null || _f === void 0 ? void 0 : _f.trim());
    ...
    var includeMessages = (_g = (0, boolean_js_1.parseBooleanValue)(env.OPENCLAW_CACHE_TRACE_MESSAGES)) !== null && _g !== void 0 ? _g : config === null || config === void 0 ? void 0 : config.includeMessages;
    var includePrompt = (_h = (0, boolean_js_1.parseBooleanValue)(env.OPENCLAW_CACHE_TRACE_PROMPT)) !== null && _h !== void 0 ? _h : config === null || config === void 0 ? void 0 : config.includePrompt;
    var includeSystem = (_j = (0, boolean_js_1.parseBooleanValue)(env.OPENCLAW_CACHE_TRACE_SYSTEM)) !== null && _j !== void 0 ? _j : config === null || config === void 0 ? void 0 : config.includeSystem;
    return {
        enabled: enabled,
        filePath: filePath,
        includeMessages: includeMessages !== null && includeMessages !== void 0 ? includeMessages : true,
...
function getWriter(filePath) {
    ...
    var ready = promises_1.default.mkdir(dir, { recursive: true }).catch(function () { return undefined; });
    ...
    var writer = {
        ...
        write: function (line) {
            queue = queue
                ...
                .then(function () { return promises_1.default.appendFile(filePath, line, "utf8"); })
...
function stableStringify(value) {
    ...
    if (Array.isArray(value)) {
        return "[".concat(value.map(function (entry) { return stableStringify(entry); }).join(","), "]");
    }
    var record = value;
    var keys = Object.keys(record).sort();
    var entries = keys.map(function (key) { return "".concat(JSON.stringify(key), ":").concat(stableStringify(record[key])); });
...
function summarizeMessages(messages) {
    var messageFingerprints = messages.map(function (msg) { return digest(msg); });
    return {
        messageCount: messages.length,
        messageRoles: messages.map(function (msg) { return msg.role; }),
...
function createCacheTrace(params) {
    ...
    var recordStage = function (stage, payload) {
        ...
        var event = __assign(__assign({}, base), { ts: new Date().toISOString(), seq: (seq += 1), stage: stage });
