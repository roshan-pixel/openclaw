...
function resizeImageBase64IfNeeded(params) {
    return __awaiter(this, void 0, void 0, function () {
        var buf, meta, width, height, overBytes, hasDimensions, qualities, maxDim, sideStart, sideGrid, smallest, _i, sideGrid_1, side, _a, qualities_1, quality, out, best, maxMb, gotMb;
        var _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    maxDim = hasDimensions ? Math.max(width !== null && width !== void 0 ? width : 0, height !== null && height !== void 0 ? height : 0) : params.maxDimensionPx;
                    ...
                    sideGrid = [sideStart, 1800, 1600, 1400, 1200, 1000, 800]
                        .map(function (v) { return Math.min(params.maxDimensionPx, v); })
                    ...
                    _c.label = 2;
                case 2:
                    if (!(_i < sideGrid_1.length)) return [3 /*break*/, 7];
                    side = sideGrid_1[_i];
                    _a = 0, qualities_1 = qualities;
                    _c.label = 3;
                case 3:
                    if (!(_a < qualities_1.length)) return [3 /*break*/, 6];
                ...
                case 6:
                    ...
                    return [3 /*break*/, 2];
                case 7:
                    best = (_b = smallest === null || smallest === void 0 ? void 0 : smallest.buffer) !== null && _b !== void 0 ? _b : buf;
                    maxMb = (params.maxBytes / (1024 * 1024)).toFixed(0);
                    gotMb = (best.byteLength / (1024 * 1024)).toFixed(2);
                    throw new Error("Image could not be reduced below ".concat(maxMb, "MB (got ").concat(gotMb, "MB)"));
            }
        });
    });
}
function sanitizeContentBlocksImages(blocks_1, label_1) {
    return __awaiter(this, arguments, void 0, function (blocks, label, opts) {
        var maxDimensionPx, maxBytes, out, _i, blocks_2, block, data, inferredMimeType, mimeType, resized, err_1;
        var _a, _b;
        if (opts === void 0) { opts = {}; }
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    maxDimensionPx = Math.max((_a = opts.maxDimensionPx) !== null && _a !== void 0 ? _a : MAX_IMAGE_DIMENSION_PX, 1);
                    maxBytes = Math.max((_b = opts.maxBytes) !== null && _b !== void 0 ? _b : MAX_IMAGE_BYTES, 1);
                    out = [];
                ...
                case 2:
                    ...
                    mimeType = inferredMimeType !== null && inferredMimeType !== void 0 ? inferredMimeType : block.mimeType;
                    return [4 /*yield*/, resizeImageBase64IfNeeded({
                            base64: data,
                            mimeType: mimeType,
                ...
                case 3:
                    resized = _c.sent();
                    out.push(__assign(__assign({}, block), { data: resized.base64, mimeType: resized.resized ? resized.mimeType : mimeType }));
                    return [3 /*break*/, 5];
                case 4:
                    err_1 = _c.sent();
                    out.push({
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, { images: next, dropped: Math.max(0, images.length - next.length) }];
            }
        });
    });
}
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!content.some(function (b) { return isImageBlock(b) || isTextBlock(b); }))
