...
function mergeBackendConfig(base, override) {
    ...
    return __assign(__assign(__assign({}, base), override), { args: (_a = override.args) !== null && _a !== void 0 ? _a : base.args, env: __assign(__assign({}, base.env), override.env), modelAliases: __assign(__assign({}, base.modelAliases), override.modelAliases), clearEnv: Array.from(new Set(__spreadArray(__spreadArray([], ((_b = base.clearEnv) !== null && _b !== void 0 ? _b : []), true), ((_c = override.clearEnv) !== null && _c !== void 0 ? _c : []), true))), sessionIdFields: (_d = override.sessionIdFields) !== null && _d !== void 0 ? _d : base.sessionIdFields, sessionArgs: (_e = override.sessionArgs) !== null && _e !== void 0 ? _e : base.sessionArgs, resumeArgs: (_f = override.resumeArgs) !== null && _f !== void 0 ? _f : base.resumeArgs });
}
function resolveCliBackendIds(cfg) {
    ...
    var configured = (_c = (_b = (_a = cfg === null || cfg === void 0 ? void 0 : cfg.agents) === null || _a === void 0 ? void 0 : _a.defaults) === null || _b === void 0 ? void 0 : _b.cliBackends) !== null && _c !== void 0 ? _c : {};
