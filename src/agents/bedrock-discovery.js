...
function normalizeProviderFilter(filter) {
    if (!filter || filter.length === 0)
        return [];
    var normalized = new Set(filter.map(function (entry) { return entry.trim().toLowerCase(); }).filter(function (entry) { return entry.length > 0; }));
...
function includesTextModalities(modalities) {
    return (modalities !== null && modalities !== void 0 ? modalities : []).some(function (entry) { return entry.toLowerCase() === "text"; });
}
...
function inferReasoningSupport(summary) {
    var _a, _b;
    var haystack = "".concat((_a = summary.modelId) !== null && _a !== void 0 ? _a : "", " ").concat((_b = summary.modelName) !== null && _b !== void 0 ? _b : "").toLowerCase();
    return haystack.includes("reasoning") || haystack.includes("thinking");
}
function resolveDefaultContextWindow(config) {
    var _a;
    var value = Math.floor((_a = config === null || config === void 0 ? void 0 : config.defaultContextWindow) !== null && _a !== void 0 ? _a : DEFAULT_CONTEXT_WINDOW);
    return value > 0 ? value : DEFAULT_CONTEXT_WINDOW;
}
function resolveDefaultMaxTokens(config) {
    var _a;
    var value = Math.floor((_a = config === null || config === void 0 ? void 0 : config.defaultMaxTokens) !== null && _a !== void 0 ? _a : DEFAULT_MAX_TOKENS);
...
function matchesProviderFilter(summary, filter) {
    ...
    if (filter.length === 0)
        return true;
    var providerName = (_a = summary.providerName) !== null && _a !== void 0 ? _a : (typeof summary.modelId === "string" ? summary.modelId.split(".")[0] : undefined);
    var normalized = providerName === null || providerName === void 0 ? void 0 : providerName.trim().toLowerCase();
    if (!normalized)
        return false;
...
function toModelDefinition(summary, defaults) {
    var _a, _b, _c;
    var id = (_b = (_a = summary.modelId) === null || _a === void 0 ? void 0 : _a.trim()) !== null && _b !== void 0 ? _b : "";
    return {
        id: id,
...
function discoverBedrockModels(params) {
    return __awaiter(this, void 0, void 0, function () {
        var refreshIntervalSeconds, providerFilter, defaultContextWindow, defaultMaxTokens, cacheKey, now, cached, clientFactory, client, discoveryPromise, value, error_1;
        var _this = this;
        var _a, _b, _c, _d, _e, _f;
        return __generator(this, function (_g) {
            switch (_g.label) {
                case 0:
                    refreshIntervalSeconds = Math.max(0, Math.floor((_b = (_a = params.config) === null || _a === void 0 ? void 0 : _a.refreshInterval) !== null && _b !== void 0 ? _b : DEFAULT_REFRESH_INTERVAL_SECONDS));
                    providerFilter = normalizeProviderFilter((_c = params.config) === null || _c === void 0 ? void 0 : _c.providerFilter);
                    ...
                    now = (_e = (_d = params.now) === null || _d === void 0 ? void 0 : _d.call(params)) !== null && _e !== void 0 ? _e : Date.now();
                    ...
                    clientFactory = (_f = params.clientFactory) !== null && _f !== void 0 ? _f : (function (region) { return new client_bedrock_1.BedrockClient({ region: region }); });
                    ...
                    discoveryPromise = (function () { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                case 0: return [4 /*yield*/, client.send(new client_bedrock_1.ListFoundationModelsCommand({}))];
                                case 1:
                                    response = _c.sent();
                                    discovered = [];
                                    for (_i = 0, _a = (_b = response.modelSummaries) !== null && _b !== void 0 ? _b : []; _i < _a.length; _i++) {
                                        summary = _a[_i];
                                    ...
                                    return [2 /*return*/, discovered.sort(function (a, b) { return a.name.localeCompare(b.name); })];
                            }
                        });
                    }); })();
                    if (refreshIntervalSeconds > 0) {
