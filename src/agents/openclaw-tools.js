...
function createOpenClawTools(options) {
    var _a;
    var imageTool = ((_a = options === null || options === void 0 ? void 0 : options.agentDir) === null || _a === void 0 ? void 0 : _a.trim())
    ...
    var tools = __spreadArray(__spreadArray(__spreadArray([
        (0, browser_tool_js_1.createBrowserTool)({
            sandboxBridgeUrl: options === null || options === void 0 ? void 0 : options.sandboxBrowserBridgeUrl,
            allowHostControl: options === null || options === void 0 ? void 0 : options.allowHostBrowserControl,
        }),
        (0, canvas_tool_js_1.createCanvasTool)(),
        (0, nodes_tool_js_1.createNodesTool)({
            agentSessionKey: options === null || options === void 0 ? void 0 : options.agentSessionKey,
            config: options === null || options === void 0 ? void 0 : options.config,
        }),
        ...
        (0, message_tool_js_1.createMessageTool)({
            ...
            currentChannelProvider: options === null || options === void 0 ? void 0 : options.agentChannel,
        ...
        (0, agents_list_tool_js_1.createAgentsListTool)({
            agentSessionKey: options === null || options === void 0 ? void 0 : options.agentSessionKey,
            requesterAgentIdOverride: options === null || options === void 0 ? void 0 : options.requesterAgentIdOverride,
        }),
        ...
        (0, sessions_spawn_tool_js_1.createSessionsSpawnTool)({
            ...
            agentGroupChannel: options === null || options === void 0 ? void 0 : options.agentGroupChannel,
            agentGroupSpace: options === null || options === void 0 ? void 0 : options.agentGroupSpace,
            sandboxed: options === null || options === void 0 ? void 0 : options.sandboxed,
            requesterAgentIdOverride: options === null || options === void 0 ? void 0 : options.requesterAgentIdOverride,
        }),
    ...
    ], (webSearchTool ? [webSearchTool] : []), true), (webFetchTool ? [webFetchTool] : []), true), (imageTool ? [imageTool] : []), true);
    var pluginTools = (0, tools_js_1.resolvePluginTools)({
        ...
        existingToolNames: new Set(tools.map(function (tool) { return tool.name; })),
