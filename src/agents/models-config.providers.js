    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 4, , 5]);
                    return [4 /*yield*/, fetch("".concat(OLLAMA_API_BASE_URL, "/api/tags"), {
                ...
                case 3:
                    ...
                    return [2 /*return*/, data.models.map(function (model) {
                            var modelId = model.name;
                            var isReasoning = modelId.toLowerCase().includes("r1") || modelId.toLowerCase().includes("reasoning");
                            return {
                                id: modelId,
                                name: modelId,
...
function resolveAwsSdkApiKeyVarName() {
    var _a;
    return (_a = (0, model_auth_js_1.resolveAwsSdkEnvVarName)()) !== null && _a !== void 0 ? _a : "AWS_PROFILE";
}
...
function normalizeProviders(params) {
    ...
    for (var _i = 0, _c = Object.entries(providers); _i < _c.length; _i++) {
        var _d = _c[_i], key = _d[0], provider = _d[1];
        ...
        if (normalizedProvider.apiKey &&
            ...
            mutated = true;
            normalizedProvider = __assign(__assign({}, normalizedProvider), { apiKey: normalizeApiKeyConfig(normalizedProvider.apiKey) });
        }
        // If a provider defines models, pi's ModelRegistry requires apiKey to be set.
        // Fill it from the environment or auth profiles when possible.
        var hasModels = Array.isArray(normalizedProvider.models) && normalizedProvider.models.length > 0;
        if (hasModels && !((_a = normalizedProvider.apiKey) === null || _a === void 0 ? void 0 : _a.trim())) {
            var authMode = (_b = normalizedProvider.auth) !== null && _b !== void 0 ? _b : (normalizedKey === "amazon-bedrock" ? "aws-sdk" : undefined);
            if (authMode === "aws-sdk") {
...
function buildSyntheticProvider() {
    return {
        ...
        models: synthetic_models_js_1.SYNTHETIC_MODEL_CATALOG.map(synthetic_models_js_1.buildSyntheticModelDefinition),
    };
}
...
function buildVeniceProvider() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, venice_models_js_1.discoverVeniceModels)()];
                case 1:
                    models = _a.sent();
                    return [2 /*return*/, {
...
function buildOllamaProvider() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, discoverOllamaModels()];
                case 1:
                    models = _a.sent();
                    return [2 /*return*/, {
...
function resolveImplicitProviders(params) {
    return __awaiter(this, void 0, void 0, function () {
        var providers, authStore, minimaxKey, moonshotKey, kimiCodeKey, syntheticKey, veniceKey, _a, _b, qwenProfiles, xiaomiKey, ollamaKey, _c, _d;
        ...
        return __generator(this, function (_m) {
            switch (_m.label) {
                case 0:
                    ...
                    minimaxKey = (_e = resolveEnvApiKeyVarName("minimax")) !== null && _e !== void 0 ? _e : resolveApiKeyFromProfiles({ provider: "minimax", store: authStore });
                    if (minimaxKey) {
                        providers.minimax = __assign(__assign({}, buildMinimaxProvider()), { apiKey: minimaxKey });
                    }
                    moonshotKey = (_f = resolveEnvApiKeyVarName("moonshot")) !== null && _f !== void 0 ? _f : resolveApiKeyFromProfiles({ provider: "moonshot", store: authStore });
                    if (moonshotKey) {
                        providers.moonshot = __assign(__assign({}, buildMoonshotProvider()), { apiKey: moonshotKey });
                    }
                    kimiCodeKey = (_g = resolveEnvApiKeyVarName("kimi-code")) !== null && _g !== void 0 ? _g : resolveApiKeyFromProfiles({ provider: "kimi-code", store: authStore });
                    if (kimiCodeKey) {
                        providers["kimi-code"] = __assign(__assign({}, buildKimiCodeProvider()), { apiKey: kimiCodeKey });
                    }
                    syntheticKey = (_h = resolveEnvApiKeyVarName("synthetic")) !== null && _h !== void 0 ? _h : resolveApiKeyFromProfiles({ provider: "synthetic", store: authStore });
                    if (syntheticKey) {
                        providers.synthetic = __assign(__assign({}, buildSyntheticProvider()), { apiKey: syntheticKey });
                    }
                    veniceKey = (_j = resolveEnvApiKeyVarName("venice")) !== null && _j !== void 0 ? _j : resolveApiKeyFromProfiles({ provider: "venice", store: authStore });
                    if (!veniceKey) return [3 /*break*/, 2];
                    _a = providers;
                    _b = [{}];
                    return [4 /*yield*/, buildVeniceProvider()];
                case 1:
                    _a.venice = __assign.apply(void 0, [__assign.apply(void 0, _b.concat([(_m.sent())])), { apiKey: veniceKey }]);
                    _m.label = 2;
                case 2:
                    qwenProfiles = (0, auth_profiles_js_1.listProfilesForProvider)(authStore, "qwen-portal");
                    if (qwenProfiles.length > 0) {
                        providers["qwen-portal"] = __assign(__assign({}, buildQwenPortalProvider()), { apiKey: QWEN_PORTAL_OAUTH_PLACEHOLDER });
                    }
                    xiaomiKey = (_k = resolveEnvApiKeyVarName("xiaomi")) !== null && _k !== void 0 ? _k : resolveApiKeyFromProfiles({ provider: "xiaomi", store: authStore });
                    if (xiaomiKey) {
                        providers.xiaomi = __assign(__assign({}, buildXiaomiProvider()), { apiKey: xiaomiKey });
                    }
                    ollamaKey = (_l = resolveEnvApiKeyVarName("ollama")) !== null && _l !== void 0 ? _l : resolveApiKeyFromProfiles({ provider: "ollama", store: authStore });
                    if (!ollamaKey) return [3 /*break*/, 4];
                    _c = providers;
                    _d = [{}];
                    return [4 /*yield*/, buildOllamaProvider()];
                case 3:
                    _c.ollama = __assign.apply(void 0, [__assign.apply(void 0, _d.concat([(_m.sent())])), { apiKey: ollamaKey }]);
                    _m.label = 4;
                case 4: return [2 /*return*/, providers];
            }
        });
    });
}
function resolveImplicitCopilotProvider(params) {
    return __awaiter(this, void 0, void 0, function () {
        var env, authStore, hasProfile, envToken, githubToken, selectedGithubToken, profileId, profile, baseUrl, token, _a;
        var _b, _c, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    env = (_b = params.env) !== null && _b !== void 0 ? _b : process.env;
                    authStore = (0, auth_profiles_js_1.ensureAuthProfileStore)(params.agentDir, { allowKeychainPrompt: false });
                    hasProfile = (0, auth_profiles_js_1.listProfilesForProvider)(authStore, "github-copilot").length > 0;
                    envToken = (_d = (_c = env.COPILOT_GITHUB_TOKEN) !== null && _c !== void 0 ? _c : env.GH_TOKEN) !== null && _d !== void 0 ? _d : env.GITHUB_TOKEN;
                    githubToken = (envToken !== null && envToken !== void 0 ? envToken : "").trim();
                    if (!hasProfile && !githubToken)
                        return [2 /*return*/, null];
                    selectedGithubToken = githubToken;
                    if (!selectedGithubToken && hasProfile) {
                        profileId = (0, auth_profiles_js_1.listProfilesForProvider)(authStore, "github-copilot")[0];
                    ...
                    if (!selectedGithubToken) return [3 /*break*/, 4];
                    _e.label = 1;
                case 1:
                    _e.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, (0, github_copilot_token_js_1.resolveCopilotApiToken)({
        ...
        return __generator(this, function (_g) {
            switch (_g.label) {
                case 0:
                    ...
                    discoveryConfig = (_c = (_b = params.config) === null || _b === void 0 ? void 0 : _b.models) === null || _c === void 0 ? void 0 : _c.bedrockDiscovery;
                    enabled = discoveryConfig === null || discoveryConfig === void 0 ? void 0 : discoveryConfig.enabled;
                    hasAwsCreds = (0, model_auth_js_1.resolveAwsSdkEnvVarName)(env) !== undefined;
                    if (enabled === false)
                        return [2 /*return*/, null];
                    if (enabled !== true && !hasAwsCreds)
                        return [2 /*return*/, null];
                    region = (_f = (_e = (_d = discoveryConfig === null || discoveryConfig === void 0 ? void 0 : discoveryConfig.region) !== null && _d !== void 0 ? _d : env.AWS_REGION) !== null && _e !== void 0 ? _e : env.AWS_DEFAULT_REGION) !== null && _f !== void 0 ? _f : "us-east-1";
                    return [4 /*yield*/, (0, bedrock_discovery_js_1.discoverBedrockModels)({ region: region, config: discoveryConfig })];
                case 1:
                    models = _g.sent();
                    if (models.length === 0)
                        return [2 /*return*/, null];
