...
exports.CHUTES_USERINFO_ENDPOINT = exports.CHUTES_TOKEN_ENDPOINT = exports.CHUTES_AUTHORIZE_ENDPOINT = exports.CHUTES_OAUTH_ISSUER = void 0;
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetchFn(exports.CHUTES_USERINFO_ENDPOINT, {
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetchFn(exports.CHUTES_TOKEN_ENDPOINT, {
                            method: "POST",
...
function refreshChutesTokens(params) {
    return __awaiter(this, void 0, void 0, function () {
        var fetchFn, now, refreshToken, clientId, clientSecret, body, response, text, data, access, newRefresh, expiresIn;
        ...
        return __generator(this, function (_l) {
            switch (_l.label) {
                case 0:
                    fetchFn = (_a = params.fetchFn) !== null && _a !== void 0 ? _a : fetch;
                    now = (_b = params.now) !== null && _b !== void 0 ? _b : Date.now();
                    refreshToken = (_c = params.credential.refresh) === null || _c === void 0 ? void 0 : _c.trim();
                    if (!refreshToken) {
                        throw new Error("Chutes OAuth credential is missing refresh token");
                    }
                    clientId = (_e = (_d = params.credential.clientId) === null || _d === void 0 ? void 0 : _d.trim()) !== null && _e !== void 0 ? _e : (_f = process.env.CHUTES_CLIENT_ID) === null || _f === void 0 ? void 0 : _f.trim();
                    if (!clientId) {
                ...
                case 4:
                    ...
                    return [2 /*return*/, __assign(__assign({}, params.credential), { access: access, refresh: newRefresh || refreshToken, expires: coerceExpiresAt(expiresIn, now), clientId: clientId })];
            }
        });
    });
}
