...
function isCliProvider(provider, cfg) {
    ...
    if (normalized === "codex-cli")
        return true;
    var backends = (_c = (_b = (_a = cfg === null || cfg === void 0 ? void 0 : cfg.agents) === null || _a === void 0 ? void 0 : _a.defaults) === null || _b === void 0 ? void 0 : _b.cliBackends) !== null && _c !== void 0 ? _c : {};
    return Object.keys(backends).some(function (key) { return normalizeProviderId(key) === normalized; });
}
...
function buildModelAliasIndex(params) {
    ...
    var byAlias = new Map();
    var byKey = new Map();
    var rawModels = (_c = (_b = (_a = params.cfg.agents) === null || _a === void 0 ? void 0 : _a.defaults) === null || _b === void 0 ? void 0 : _b.models) !== null && _c !== void 0 ? _c : {};
    for (var _i = 0, _f = Object.entries(rawModels); _i < _f.length; _i++) {
        var _g = _f[_i], keyRaw = _g[0], entryRaw = _g[1];
        var parsed = parseModelRef(String(keyRaw !== null && keyRaw !== void 0 ? keyRaw : ""), params.defaultProvider);
        if (!parsed)
            continue;
        var alias = String((_d = entryRaw === null || entryRaw === void 0 ? void 0 : entryRaw.alias) !== null && _d !== void 0 ? _d : "").trim();
        if (!alias)
            continue;
...
function resolveModelRefFromString(params) {
    ...
    if (!trimmed.includes("/")) {
        ...
        var aliasMatch = (_a = params.aliasIndex) === null || _a === void 0 ? void 0 : _a.byAlias.get(aliasKey);
        if (aliasMatch) {
...
function resolveConfiguredModelRef(params) {
    var rawModel = (function () {
        var _a, _b, _c, _d;
        var raw = (_b = (_a = params.cfg.agents) === null || _a === void 0 ? void 0 : _a.defaults) === null || _b === void 0 ? void 0 : _b.model;
    ...
    if (rawModel) {
        ...
        if (!trimmed.includes("/")) {
            ...
            console.warn("[openclaw] Model \"".concat(trimmed, "\" specified without provider. Falling back to \"anthropic/").concat(trimmed, "\". Please use \"anthropic/").concat(trimmed, "\" in your config."));
...
function resolveDefaultModelForAgent(params) {
    ...
    var agentModelOverride = params.agentId
        ...
        : undefined;
    var cfg = agentModelOverride && agentModelOverride.length > 0
        ? __assign(__assign({}, params.cfg), { agents: __assign(__assign({}, params.cfg.agents), { defaults: __assign(__assign({}, (_a = params.cfg.agents) === null || _a === void 0 ? void 0 : _a.defaults), { model: __assign(__assign({}, (typeof ((_c = (_b = params.cfg.agents) === null || _b === void 0 ? void 0 : _b.defaults) === null || _c === void 0 ? void 0 : _c.model) === "object"
                        ? params.cfg.agents.defaults.model
                        : undefined)), { primary: agentModelOverride }) }) }) }) : params.cfg;
...
function buildAllowedModelSet(params) {
    ...
    var rawAllowlist = (function () {
        var _a, _b, _c;
        var modelMap = (_c = (_b = (_a = params.cfg.agents) === null || _a === void 0 ? void 0 : _a.defaults) === null || _b === void 0 ? void 0 : _b.models) !== null && _c !== void 0 ? _c : {};
        return Object.keys(modelMap);
    })();
    var allowAny = rawAllowlist.length === 0;
    var defaultModel = (_a = params.defaultModel) === null || _a === void 0 ? void 0 : _a.trim();
    var defaultKey = defaultModel && params.defaultProvider
        ? modelKey(params.defaultProvider, defaultModel)
        : undefined;
    var catalogKeys = new Set(params.catalog.map(function (entry) { return modelKey(entry.provider, entry.id); }));
    if (allowAny) {
        if (defaultKey)
    ...
    var configuredProviders = ((_c = (_b = params.cfg.models) === null || _b === void 0 ? void 0 : _b.providers) !== null && _c !== void 0 ? _c : {});
...
function getModelRefStatus(params) {
    ...
    return {
        key: key,
        inCatalog: params.catalog.some(function (entry) { return modelKey(entry.provider, entry.id) === key; }),
...
function resolveThinkingDefault(params) {
    var _a, _b, _c;
    var configured = (_b = (_a = params.cfg.agents) === null || _a === void 0 ? void 0 : _a.defaults) === null || _b === void 0 ? void 0 : _b.thinkingDefault;
    if (configured)
        return configured;
    var candidate = (_c = params.catalog) === null || _c === void 0 ? void 0 : _c.find(function (entry) { return entry.provider === params.provider && entry.id === params.model; });
...
function resolveHooksGmailModel(params) {
    var _a, _b, _c;
    var hooksModel = (_b = (_a = params.cfg.hooks) === null || _a === void 0 ? void 0 : _a.gmail) === null || _b === void 0 ? void 0 : _b.model;
    ...
    return (_c = resolved === null || resolved === void 0 ? void 0 : resolved.ref) !== null && _c !== void 0 ? _c : null;
}
