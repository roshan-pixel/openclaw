...
function listChannelSupportedActions(params) {
    ...
    if (!((_a = plugin === null || plugin === void 0 ? void 0 : plugin.actions) === null || _a === void 0 ? void 0 : _a.listActions))
        return [];
...
function resolveChannelMessageToolHints(params) {
    ...
    var resolve = (_a = dock === null || dock === void 0 ? void 0 : dock.agentPrompt) === null || _a === void 0 ? void 0 : _a.messageToolHints;
    if (!resolve)
        return [];
    var cfg = (_b = params.cfg) !== null && _b !== void 0 ? _b : {};
    return ((_c = resolve({ cfg: cfg, accountId: params.accountId })) !== null && _c !== void 0 ? _c : [])
...
function logListActionsError(pluginId, err) {
    ...
    (_a = runtime_js_1.defaultRuntime.error) === null || _a === void 0 ? void 0 : _a.call(runtime_js_1.defaultRuntime, "[channel-tools] ".concat(pluginId, ".actions.listActions failed: ").concat(details));
}
exports.__testing = {
