...
exports.DEFAULT_MEMORY_ALT_FILENAME = exports.DEFAULT_MEMORY_FILENAME = exports.DEFAULT_BOOTSTRAP_FILENAME = exports.DEFAULT_HEARTBEAT_FILENAME = exports.DEFAULT_USER_FILENAME = exports.DEFAULT_IDENTITY_FILENAME = exports.DEFAULT_TOOLS_FILENAME = exports.DEFAULT_SOUL_FILENAME = exports.DEFAULT_AGENTS_FILENAME = exports.DEFAULT_AGENT_WORKSPACE_DIR = void 0;
...
function resolveDefaultAgentWorkspaceDir(env, homedir) {
    ...
    if (homedir === void 0) { homedir = node_os_1.default.homedir; }
...
var TEMPLATE_DIR = node_path_1.default.resolve(node_path_1.default.dirname((0, node_url_1.fileURLToPath)(import.meta.url)), "../../docs/reference/templates");
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    _a = _b.sent();
                    throw new Error("Missing workspace template: ".concat(name, " (").concat(templatePath, "). Ensure docs/reference/templates are packaged."));
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, exec_js_1.runCommandWithTimeout)(["git", "--version"], { timeoutMs: 2000 })];
                case 1:
                    result = _b.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    _b.trys.push([3, 5, , 6]);
                    return [4 /*yield*/, (0, exec_js_1.runCommandWithTimeout)(["git", "init"], { cwd: dir, timeoutMs: 10000 })];
                case 4:
                    _b.sent();
                    return [3 /*break*/, 6];
                case 5:
...
function ensureAgentWorkspace(params) {
    return __awaiter(this, void 0, void 0, function () {
        var rawDir, dir, agentsPath, soulPath, toolsPath, identityPath, userPath, heartbeatPath, bootstrapPath, isBrandNewWorkspace, agentsTemplate, soulTemplate, toolsTemplate, identityTemplate, userTemplate, heartbeatTemplate, bootstrapTemplate;
        var _this = this;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    rawDir = ((_a = params === null || params === void 0 ? void 0 : params.dir) === null || _a === void 0 ? void 0 : _a.trim()) ? params.dir.trim() : exports.DEFAULT_AGENT_WORKSPACE_DIR;
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (function () { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        paths = [agentsPath, soulPath, toolsPath, identityPath, userPath, heartbeatPath];
                                    ...
                                    case 1:
                                        existing = _a.sent();
                                        return [2 /*return*/, existing.every(function (v) { return !v; })];
                                }
                            });
                        }); })()];
                case 2:
                ...
                case 15:
                    _b.sent();
                    if (!isBrandNewWorkspace) return [3 /*break*/, 17];
                    return [4 /*yield*/, writeFileIfMissing(bootstrapPath, bootstrapTemplate)];
                case 16:
                    _b.sent();
                    _b.label = 17;
                case 17: return [4 /*yield*/, ensureGitRepo(dir, isBrandNewWorkspace)];
                case 18:
                    _b.sent();
                    return [2 /*return*/, {
                            dir: dir,
...
function resolveMemoryBootstrapEntries(resolvedDir) {
    return __awaiter(this, void 0, void 0, function () {
        var candidates, entries, _i, candidates_1, name_1, filePath, _a, seen, deduped, _b, entries_1, entry, key, _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 6:
                    ...
                    _d.label = 7;
                case 7:
                    if (!(_b < entries_1.length)) return [3 /*break*/, 13];
                    entry = entries_1[_b];
                    key = entry.filePath;
                    _d.label = 8;
                case 8:
                ...
                case 12:
                    _b++;
                    return [3 /*break*/, 7];
                case 13: return [2 /*return*/, deduped];
            }
        });
    });
}
...
var SUBAGENT_BOOTSTRAP_ALLOWLIST = new Set([exports.DEFAULT_AGENTS_FILENAME, exports.DEFAULT_TOOLS_FILENAME]);
function filterBootstrapFilesForSession(files, sessionKey) {
    if (!sessionKey || !(0, session_key_js_1.isSubagentSessionKey)(sessionKey))
        return files;
    return files.filter(function (file) { return SUBAGENT_BOOTSTRAP_ALLOWLIST.has(file.name); });
}
