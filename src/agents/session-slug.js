...
function randomChoice(values, fallback) {
    var _a;
    return (_a = values[Math.floor(Math.random() * values.length)]) !== null && _a !== void 0 ? _a : fallback;
}
function createSlugBase(words) {
    if (words === void 0) { words = 2; }
...
function createSessionSlug(isTaken) {
    var isIdTaken = isTaken !== null && isTaken !== void 0 ? isTaken : (function () { return false; });
