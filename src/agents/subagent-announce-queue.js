    ...
    if (existing) {
        ...
        existing.cap =
            typeof settings.cap === "number" && settings.cap > 0
                ...
                : existing.cap;
        existing.dropPolicy = (_a = settings.dropPolicy) !== null && _a !== void 0 ? _a : existing.dropPolicy;
        existing.send = send;
        return existing;
    }
    var created = {
...
function scheduleAnnounceDrain(key) {
    ...
    void (function () { return __awaiter(_this, void 0, void 0, function () {
        var forceIndividualCollect, next_1, isCrossChannel, next_2, items, summary, prompt_1, last, summaryPrompt, next_3, next, err_1;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 6:
                    ...
                    summary = (0, queue_helpers_js_1.buildQueueSummaryPrompt)({ state: queue, noun: "announce" });
                ...
                case 7:
                    ...
                    return [3 /*break*/, 1];
                case 8:
                    summaryPrompt = (0, queue_helpers_js_1.buildQueueSummaryPrompt)({ state: queue, noun: "announce" });
                    if (!summaryPrompt) return [3 /*break*/, 10];
                    next_3 = queue.items.shift();
                    if (!next_3)
                        return [3 /*break*/, 12];
                    return [4 /*yield*/, queue.send(__assign(__assign({}, next_3), { prompt: summaryPrompt }))];
                case 9:
                    _b.sent();
                    return [3 /*break*/, 1];
                case 10:
                ...
                case 13:
                    err_1 = _b.sent();
                    (_a = runtime_js_1.defaultRuntime.error) === null || _a === void 0 ? void 0 : _a.call(runtime_js_1.defaultRuntime, "announce queue drain failed for ".concat(key, ": ").concat(String(err_1)));
                    return [3 /*break*/, 15];
                case 14:
...
function enqueueAnnounce(params) {
    ...
    var shouldEnqueue = (0, queue_helpers_js_1.applyQueueDropPolicy)({
        queue: queue,
        summarize: function (item) { var _a; return ((_a = item.summaryLine) === null || _a === void 0 ? void 0 : _a.trim()) || item.prompt.trim(); },
    });
    if (!shouldEnqueue) {
