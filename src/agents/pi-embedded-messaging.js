...
function isMessagingTool(toolName) {
    ...
    return Boolean(providerId && ((_a = (0, index_js_1.getChannelPlugin)(providerId)) === null || _a === void 0 ? void 0 : _a.actions));
}
function isMessagingToolSendAction(toolName, args) {
    ...
    if (!((_a = plugin === null || plugin === void 0 ? void 0 : plugin.actions) === null || _a === void 0 ? void 0 : _a.extractToolSend))
        return false;
    return Boolean((_b = plugin.actions.extractToolSend({ args: args })) === null || _b === void 0 ? void 0 : _b.to);
}
