...
function resolveModelCost(params) {
    ...
    if (!provider || !model)
        return undefined;
    var models = (_f = (_e = (_d = (_c = params.config.models) === null || _c === void 0 ? void 0 : _c.providers) === null || _d === void 0 ? void 0 : _d[provider]) === null || _e === void 0 ? void 0 : _e.models) !== null && _f !== void 0 ? _f : [];
    var entry = models.find(function (candidate) { return candidate.id === model; });
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    storePath = (0, sessions_js_1.resolveStorePath)((_a = cfg.session) === null || _a === void 0 ? void 0 : _a.store, { agentId: agentId });
                ...
                case 3:
                    attempt += 1;
                    return [3 /*break*/, 1];
                case 4: return [2 /*return*/, { entry: entry, storePath: storePath }];
            }
        });
    });
}
function resolveAnnounceOrigin(entry, requesterOrigin) {
    ...
    return (0, delivery_context_js_1.mergeDeliveryContext)(requesterOrigin, (0, delivery_context_js_1.deliveryContextFromSession)(entry));
}
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    origin = item.origin;
                    threadId = (origin === null || origin === void 0 ? void 0 : origin.threadId) != null && origin.threadId !== "" ? String(origin.threadId) : undefined;
...
function loadRequesterSessionEntry(requesterSessionKey) {
    ...
    var storePath = (0, sessions_js_1.resolveStorePath)((_a = cfg.session) === null || _a === void 0 ? void 0 : _a.store, { agentId: agentId });
...
function maybeQueueSubagentAnnounce(params) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, cfg, entry, canonicalKey, sessionId, queueSettings, isActive, shouldSteer, steered, shouldFollowup, origin_1;
        var _b;
        return __generator(this, function (_c) {
            _a = loadRequesterSessionEntry(params.requesterSessionKey), cfg = _a.cfg, entry = _a.entry;
            ...
            queueSettings = (0, queue_js_1.resolveQueueSettings)({
                cfg: cfg,
                channel: (_b = entry === null || entry === void 0 ? void 0 : entry.channel) !== null && _b !== void 0 ? _b : entry === null || entry === void 0 ? void 0 : entry.lastChannel,
                sessionEntry: entry,
            });
            ...
            shouldFollowup = queueSettings.mode === "followup" ||
...
function buildSubagentStatsLine(params) {
    return __awaiter(this, void 0, void 0, function () {
        var cfg, _a, entry, storePath, sessionId, transcriptPath, input, output, total, runtimeMs, provider, model, costConfig, cost, parts, runtime, inputText, outputText, totalText, costText;
        var _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    cfg = (0, config_js_1.loadConfig)();
                    return [4 /*yield*/, waitForSessionUsage({
                            sessionKey: params.sessionKey,
                        })];
                case 1:
                    _a = _c.sent(), entry = _a.entry, storePath = _a.storePath;
                    sessionId = entry === null || entry === void 0 ? void 0 : entry.sessionId;
                    transcriptPath = sessionId && storePath ? node_path_1.default.join(node_path_1.default.dirname(storePath), "".concat(sessionId, ".jsonl")) : undefined;
                    input = entry === null || entry === void 0 ? void 0 : entry.inputTokens;
                    output = entry === null || entry === void 0 ? void 0 : entry.outputTokens;
                    total = (_b = entry === null || entry === void 0 ? void 0 : entry.totalTokens) !== null && _b !== void 0 ? _b : (typeof input === "number" && typeof output === "number" ? input + output : undefined);
                    runtimeMs = typeof params.startedAt === "number" && typeof params.endedAt === "number"
                    ...
                    cost = costConfig && typeof input === "number" && typeof output === "number"
                    ...
                    if (typeof total === "number") {
                        ...
                        parts.push("tokens ".concat(totalText, " (in ").concat(inputText, " / out ").concat(outputText, ")"));
                    }
                    else {
...
function buildSubagentSystemPrompt(params) {
    var _a;
    var taskText = typeof params.task === "string" && params.task.trim()
    ...
    var lines = [
        ...
        params.requesterSessionKey ? "- Requester session: ".concat(params.requesterSessionKey, ".") : undefined,
...
function runSubagentAnnounceFlow(params) {
    return __awaiter(this, void 0, void 0, function () {
        var didAnnounce, requesterOrigin, reply, outcome, waitMs, wait, statsLine, statusLabel, taskLabel, triggerMessage, queued, directOrigin, entry, err_1, _a, _b;
        var _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    ...
                    requesterOrigin = (0, delivery_context_js_1.normalizeDeliveryContext)(params.requesterOrigin);
                    reply = params.roundOneReply;
                    outcome = params.outcome;
                    if (!(!reply && params.waitForCompletion !== false)) return [3 /*break*/, 4];
                ...
                case 2:
                    ...
                    if (typeof (wait === null || wait === void 0 ? void 0 : wait.startedAt) === "number" && !params.startedAt) {
                        params.startedAt = wait.startedAt;
                    }
                    if (typeof (wait === null || wait === void 0 ? void 0 : wait.endedAt) === "number" && !params.endedAt) {
                    ...
                    return [4 /*yield*/, (0, agent_step_js_1.readLatestAssistantReply)({
                ...
                case 6:
                    ...
                    return [4 /*yield*/, buildSubagentStatsLine({
                            sessionKey: params.childSessionKey,
                ...
                case 7:
                    ...
                    return [4 /*yield*/, maybeQueueSubagentAnnounce({
                ...
                case 8:
                    ...
                    return [4 /*yield*/, (0, call_js_1.callGateway)({
                            ...
                            params: {
                                ...
                                deliver: true,
                                channel: directOrigin === null || directOrigin === void 0 ? void 0 : directOrigin.channel,
                                accountId: directOrigin === null || directOrigin === void 0 ? void 0 : directOrigin.accountId,
                                to: directOrigin === null || directOrigin === void 0 ? void 0 : directOrigin.to,
                                threadId: (directOrigin === null || directOrigin === void 0 ? void 0 : directOrigin.threadId) != null && directOrigin.threadId !== ""
                ...
                case 10:
                    err_1 = _d.sent();
                    (_c = runtime_js_1.defaultRuntime.error) === null || _c === void 0 ? void 0 : _c.call(runtime_js_1.defaultRuntime, "Subagent announce failed: ".concat(String(err_1)));
                    return [3 /*break*/, 20];
                case 11:
                    if (!params.label) return [3 /*break*/, 15];
                    _d.label = 12;
                case 12:
                ...
                case 14:
                    ...
                    return [3 /*break*/, 15];
                case 15:
                    if (!(params.cleanup === "delete")) return [3 /*break*/, 19];
                    _d.label = 16;
                case 16:
                ...
                case 20: return [2 /*return*/, didAnnounce];
            }
        });
    });
}
