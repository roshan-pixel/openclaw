...
function resolveClaudeCliCredentialsPath(homeDir) {
    var baseDir = homeDir !== null && homeDir !== void 0 ? homeDir : (0, utils_js_1.resolveUserPath)("~");
...
function resolveCodexHomePath() {
    ...
    var home = configured ? (0, utils_js_1.resolveUserPath)(configured) : (0, utils_js_1.resolveUserPath)("~/.codex");
    try {
...
function readCodexKeychainCredentials(options) {
    var _a, _b;
    var platform = (_a = options === null || options === void 0 ? void 0 : options.platform) !== null && _a !== void 0 ? _a : process.platform;
    if (platform !== "darwin")
        return null;
    var execSyncImpl = (_b = options === null || options === void 0 ? void 0 : options.execSync) !== null && _b !== void 0 ? _b : node_child_process_1.execSync;
    var codexHome = resolveCodexHomePath();
    var account = computeCodexKeychainAccount(codexHome);
    try {
        var secret = execSyncImpl("security find-generic-password -s \"Codex Auth\" -a \"".concat(account, "\" -w"), {
            encoding: "utf8",
            timeout: 5000,
        ...
        var lastRefresh = typeof lastRefreshRaw === "string" || typeof lastRefreshRaw === "number"
            ? new Date(lastRefreshRaw).getTime()
            : Date.now();
        var expires = Number.isFinite(lastRefresh)
            ? lastRefresh + 60 * 60 * 1000
            : Date.now() + 60 * 60 * 1000;
        var accountId = typeof (tokens === null || tokens === void 0 ? void 0 : tokens.account_id) === "string" ? tokens.account_id : undefined;
...
function readQwenCliCredentials(options) {
    var credPath = resolveQwenCliCredentialsPath(options === null || options === void 0 ? void 0 : options.homeDir);
...
function readClaudeCliKeychainCredentials(execSyncImpl) {
    if (execSyncImpl === void 0) { execSyncImpl = node_child_process_1.execSync; }
    try {
        var result = execSyncImpl("security find-generic-password -s \"".concat(CLAUDE_CLI_KEYCHAIN_SERVICE, "\" -w"), { encoding: "utf8", timeout: 5000, stdio: ["pipe", "pipe", "pipe"] });
...
function readClaudeCliCredentials(options) {
    var _a;
    var platform = (_a = options === null || options === void 0 ? void 0 : options.platform) !== null && _a !== void 0 ? _a : process.platform;
    if (platform === "darwin" && (options === null || options === void 0 ? void 0 : options.allowKeychainPrompt) !== false) {
        var keychainCreds = readClaudeCliKeychainCredentials(options === null || options === void 0 ? void 0 : options.execSync);
        if (keychainCreds) {
    ...
    var credPath = resolveClaudeCliCredentialsPath(options === null || options === void 0 ? void 0 : options.homeDir);
    var raw = (0, json_file_js_1.loadJsonFile)(credPath);
    if (!raw || typeof raw !== "object")
        return null;
    var data = raw;
...
function readClaudeCliCredentialsCached(options) {
    var _a;
    var ttlMs = (_a = options === null || options === void 0 ? void 0 : options.ttlMs) !== null && _a !== void 0 ? _a : 0;
    var now = Date.now();
    var cacheKey = resolveClaudeCliCredentialsPath(options === null || options === void 0 ? void 0 : options.homeDir);
    if (ttlMs > 0 &&
        claudeCliCache &&
    ...
    var value = readClaudeCliCredentials({
        allowKeychainPrompt: options === null || options === void 0 ? void 0 : options.allowKeychainPrompt,
...
function writeClaudeCliKeychainCredentials(newCredentials, options) {
    var _a;
    var execSyncImpl = (_a = options === null || options === void 0 ? void 0 : options.execSync) !== null && _a !== void 0 ? _a : node_child_process_1.execSync;
    try {
        var existingResult = execSyncImpl("security find-generic-password -s \"".concat(CLAUDE_CLI_KEYCHAIN_SERVICE, "\" -w 2>/dev/null"), { encoding: "utf8", timeout: 5000, stdio: ["pipe", "pipe", "pipe"] });
        var existingData = JSON.parse(existingResult.trim());
        var existingOauth = existingData === null || existingData === void 0 ? void 0 : existingData.claudeAiOauth;
        if (!existingOauth || typeof existingOauth !== "object") {
            return false;
        }
        existingData.claudeAiOauth = __assign(__assign({}, existingOauth), { accessToken: newCredentials.access, refreshToken: newCredentials.refresh, expiresAt: newCredentials.expires });
        var newValue = JSON.stringify(existingData);
        execSyncImpl("security add-generic-password -U -s \"".concat(CLAUDE_CLI_KEYCHAIN_SERVICE, "\" -a \"").concat(CLAUDE_CLI_KEYCHAIN_ACCOUNT, "\" -w '").concat(newValue.replace(/'/g, "'\"'\"'"), "'"), { encoding: "utf8", timeout: 5000, stdio: ["pipe", "pipe", "pipe"] });
...
function writeClaudeCliFileCredentials(newCredentials, options) {
    ...
    try {
        ...
        if (!existingOauth || typeof existingOauth !== "object")
            return false;
        data.claudeAiOauth = __assign(__assign({}, existingOauth), { accessToken: newCredentials.access, refreshToken: newCredentials.refresh, expiresAt: newCredentials.expires });
...
function writeClaudeCliCredentials(newCredentials, options) {
    var _a, _b, _c;
    var platform = (_a = options === null || options === void 0 ? void 0 : options.platform) !== null && _a !== void 0 ? _a : process.platform;
    var writeKeychain = (_b = options === null || options === void 0 ? void 0 : options.writeKeychain) !== null && _b !== void 0 ? _b : writeClaudeCliKeychainCredentials;
    var writeFile = (_c = options === null || options === void 0 ? void 0 : options.writeFile) !== null && _c !== void 0 ? _c : (function (credentials, fileOptions) { return writeClaudeCliFileCredentials(credentials, fileOptions); });
    if (platform === "darwin") {
    ...
    return writeFile(newCredentials, { homeDir: options === null || options === void 0 ? void 0 : options.homeDir });
}
...
function readCodexCliCredentialsCached(options) {
    ...
    var ttlMs = (_a = options === null || options === void 0 ? void 0 : options.ttlMs) !== null && _a !== void 0 ? _a : 0;
    var now = Date.now();
    var cacheKey = "".concat((_b = options === null || options === void 0 ? void 0 : options.platform) !== null && _b !== void 0 ? _b : process.platform, "|").concat(resolveCodexCliAuthPath());
    if (ttlMs > 0 &&
        codexCliCache &&
...
function readQwenCliCredentialsCached(options) {
    ...
    var ttlMs = (_a = options === null || options === void 0 ? void 0 : options.ttlMs) !== null && _a !== void 0 ? _a : 0;
    var now = Date.now();
    var cacheKey = resolveQwenCliCredentialsPath(options === null || options === void 0 ? void 0 : options.homeDir);
    if (ttlMs > 0 &&
        qwenCliCache &&
    ...
    var value = readQwenCliCredentials({ homeDir: options === null || options === void 0 ? void 0 : options.homeDir });
    if (ttlMs > 0) {
