...
function compilePatterns(patterns) {
    ...
    return (0, tool_policy_js_1.expandToolGroups)(patterns)
        .map(compilePattern)
        .filter(function (pattern) { return pattern.kind !== "exact" || pattern.value; });
}
...
function resolveSubagentToolPolicy(cfg) {
    var _a, _b;
    var configured = (_b = (_a = cfg === null || cfg === void 0 ? void 0 : cfg.tools) === null || _a === void 0 ? void 0 : _a.subagents) === null || _b === void 0 ? void 0 : _b.tools;
    var deny = __spreadArray(__spreadArray([], DEFAULT_SUBAGENT_TOOL_DENY, true), (Array.isArray(configured === null || configured === void 0 ? void 0 : configured.deny) ? configured.deny : []), true);
    var allow = Array.isArray(configured === null || configured === void 0 ? void 0 : configured.allow) ? configured.allow : undefined;
...
function filterToolsByPolicy(tools, policy) {
    ...
    return tools.filter(function (tool) { return matcher(tool.name); });
}
...
function resolveGroupContextFromSessionKey(sessionKey) {
    ...
    if (!raw)
        return {};
    var base = (_a = (0, session_key_utils_js_1.resolveThreadParentSessionKey)(raw)) !== null && _a !== void 0 ? _a : raw;
    ...
    if (body.length < 3)
        return {};
    var channel = body[0], kind = body[1], rest = body.slice(2);
...
function resolveProviderToolPolicy(params) {
    ...
    for (var _i = 0, entries_1 = entries; _i < entries_1.length; _i++) {
        var _c = entries_1[_i], key = _c[0], value = _c[1];
    ...
    var rawModelId = (_b = params.modelId) === null || _b === void 0 ? void 0 : _b.trim().toLowerCase();
    var fullModelId = rawModelId && !rawModelId.includes("/") ? "".concat(normalizedProvider, "/").concat(rawModelId) : rawModelId;
    var candidates = __spreadArray(__spreadArray([], (fullModelId ? [fullModelId] : []), true), [normalizedProvider], false);
...
function resolveEffectiveToolPolicy(params) {
    var _a, _b, _c;
    var agentId = params.sessionKey ? (0, agent_scope_js_1.resolveAgentIdFromSessionKey)(params.sessionKey) : undefined;
    var agentConfig = params.config && agentId ? (0, agent_scope_js_1.resolveAgentConfig)(params.config, agentId) : undefined;
    ...
    var profile = (_b = agentTools === null || agentTools === void 0 ? void 0 : agentTools.profile) !== null && _b !== void 0 ? _b : globalTools === null || globalTools === void 0 ? void 0 : globalTools.profile;
    ...
    return {
        ...
        profile: profile,
        providerProfile: (_c = agentProviderPolicy === null || agentProviderPolicy === void 0 ? void 0 : agentProviderPolicy.profile) !== null && _c !== void 0 ? _c : providerPolicy === null || providerPolicy === void 0 ? void 0 : providerPolicy.profile,
        // alsoAllow is applied at the profile stage (to avoid being filtered out early).
        profileAlsoAllow: Array.isArray(agentTools === null || agentTools === void 0 ? void 0 : agentTools.alsoAllow)
            ? agentTools === null || agentTools === void 0 ? void 0 : agentTools.alsoAllow
            : Array.isArray(globalTools === null || globalTools === void 0 ? void 0 : globalTools.alsoAllow)
                ? globalTools === null || globalTools === void 0 ? void 0 : globalTools.alsoAllow
                : undefined,
        providerProfileAlsoAllow: Array.isArray(agentProviderPolicy === null || agentProviderPolicy === void 0 ? void 0 : agentProviderPolicy.alsoAllow)
            ? agentProviderPolicy === null || agentProviderPolicy === void 0 ? void 0 : agentProviderPolicy.alsoAllow
            : Array.isArray(providerPolicy === null || providerPolicy === void 0 ? void 0 : providerPolicy.alsoAllow)
                ? providerPolicy === null || providerPolicy === void 0 ? void 0 : providerPolicy.alsoAllow
                : undefined,
    };
}
function resolveGroupToolPolicy(params) {
    ...
    var groupId = (_b = (_a = params.groupId) !== null && _a !== void 0 ? _a : sessionContext.groupId) !== null && _b !== void 0 ? _b : spawnedContext.groupId;
    if (!groupId)
        return undefined;
    var channelRaw = (_d = (_c = params.messageProvider) !== null && _c !== void 0 ? _c : sessionContext.channel) !== null && _d !== void 0 ? _d : spawnedContext.channel;
    ...
    var toolsConfig = (_g = (_f = (_e = dock === null || dock === void 0 ? void 0 : dock.groups) === null || _e === void 0 ? void 0 : _e.resolveToolPolicy) === null || _f === void 0 ? void 0 : _f.call(_e, {
        cfg: params.config,
        groupId: groupId,
    ...
    })) !== null && _g !== void 0 ? _g : (0, group_policy_js_1.resolveChannelGroupToolsPolicy)({
        cfg: params.config,
        channel: channel,
        groupId: groupId,
        accountId: params.accountId,
...
function isToolAllowedByPolicies(name, policies) {
    return policies.every(function (policy) { return isToolAllowedByPolicyName(name, policy); });
}
