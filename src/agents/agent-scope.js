...
Object.defineProperty(exports, "resolveAgentIdFromSessionKey", { enumerable: true, get: function () { return session_key_js_2.resolveAgentIdFromSessionKey; } });
...
function listAgentIds(cfg) {
    ...
    for (var _i = 0, agents_1 = agents; _i < agents_1.length; _i++) {
        ...
        var id = (0, session_key_js_1.normalizeAgentId)(entry === null || entry === void 0 ? void 0 : entry.id);
        if (seen.has(id))
            continue;
        seen.add(id);
        ids.push(id);
...
function resolveDefaultAgentId(cfg) {
    ...
    if (agents.length === 0)
        return session_key_js_1.DEFAULT_AGENT_ID;
    var defaults = agents.filter(function (agent) { return agent === null || agent === void 0 ? void 0 : agent.default; });
    if (defaults.length > 1 && !defaultAgentWarned) {
        defaultAgentWarned = true;
        console.warn("Multiple agents marked default=true; using the first entry as default.");
    }
    var chosen = (_c = (_b = ((_a = defaults[0]) !== null && _a !== void 0 ? _a : agents[0])) === null || _b === void 0 ? void 0 : _b.id) === null || _c === void 0 ? void 0 : _c.trim();
...
function resolveSessionAgentIds(params) {
    var _a, _b;
    var defaultAgentId = resolveDefaultAgentId((_a = params.config) !== null && _a !== void 0 ? _a : {});
    ...
    var parsed = normalizedSessionKey ? (0, session_key_js_1.parseAgentSessionKey)(normalizedSessionKey) : null;
    var sessionAgentId = (parsed === null || parsed === void 0 ? void 0 : parsed.agentId) ? (0, session_key_js_1.normalizeAgentId)(parsed.agentId) : defaultAgentId;
...
function resolveAgentEntry(cfg, agentId) {
    ...
    return listAgents(cfg).find(function (entry) { return (0, session_key_js_1.normalizeAgentId)(entry.id) === id; });
}
...
function resolveAgentWorkspaceDir(cfg, agentId) {
    var _a, _b, _c, _d, _e;
    var id = (0, session_key_js_1.normalizeAgentId)(agentId);
    var configured = (_b = (_a = resolveAgentConfig(cfg, id)) === null || _a === void 0 ? void 0 : _a.workspace) === null || _b === void 0 ? void 0 : _b.trim();
    if (configured)
        return (0, utils_js_1.resolveUserPath)(configured);
    var defaultAgentId = resolveDefaultAgentId(cfg);
    if (id === defaultAgentId) {
        var fallback = (_e = (_d = (_c = cfg.agents) === null || _c === void 0 ? void 0 : _c.defaults) === null || _d === void 0 ? void 0 : _d.workspace) === null || _e === void 0 ? void 0 : _e.trim();
        if (fallback)
            return (0, utils_js_1.resolveUserPath)(fallback);
        return workspace_js_1.DEFAULT_AGENT_WORKSPACE_DIR;
    }
    return node_path_1.default.join(node_os_1.default.homedir(), ".openclaw", "workspace-".concat(id));
}
function resolveAgentDir(cfg, agentId) {
    var _a, _b;
    var id = (0, session_key_js_1.normalizeAgentId)(agentId);
    var configured = (_b = (_a = resolveAgentConfig(cfg, id)) === null || _a === void 0 ? void 0 : _a.agentDir) === null || _b === void 0 ? void 0 : _b.trim();
    if (configured)
        return (0, utils_js_1.resolveUserPath)(configured);
