            ...
            switch (_d.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, Promise.all([
                            Promise.resolve().then(function () { return require("@mozilla/readability"); }),
                            Promise.resolve().then(function () { return require("linkedom"); }),
                        ])];
                case 2:
                    ...
                    if (params.extractMode === "text") {
                        text = normalizeWhitespace((_c = parsed.textContent) !== null && _c !== void 0 ? _c : "");
                        return [2 /*return*/, text ? { text: text, title: title } : fallback()];
                    }
                    rendered = htmlToMarkdown(parsed.content);
                    return [2 /*return*/, { text: rendered.text, title: title !== null && title !== void 0 ? title : rendered.title }];
                case 3:
                    _b = _d.sent();
                    return [2 /*return*/, fallback()];
