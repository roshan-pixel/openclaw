...
var CronToolSchema = typebox_1.Type.Object({
    ...
    contextMessages: typebox_1.Type.Optional(typebox_1.Type.Number({ minimum: 0, maximum: REMINDER_CONTEXT_MESSAGES_MAX })),
});
...
function buildReminderContextLines(params) {
    return __awaiter(this, void 0, void 0, function () {
        var maxMessages, sessionKey, cfg, _a, mainKey, alias, resolvedKey, res, messages, parsed, recent, lines, total, _i, recent_1, entry, label, text, line, _b;
        var _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    maxMessages = Math.min(REMINDER_CONTEXT_MESSAGES_MAX, Math.max(0, Math.floor(params.contextMessages)));
                    if (maxMessages <= 0)
                        return [2 /*return*/, []];
                    ...
                    resolvedKey = (0, sessions_helpers_js_1.resolveInternalSessionKey)({ key: sessionKey, alias: alias, mainKey: mainKey });
                    _d.label = 1;
                case 1:
                    _d.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, (0, gateway_js_1.callGatewayTool)("chat.history", params.gatewayOpts, {
                            sessionKey: resolvedKey,
                            limit: maxMessages,
                        })];
                case 2:
                    res = (_d.sent());
                    messages = Array.isArray(res === null || res === void 0 ? void 0 : res.messages) ? res.messages : [];
                    parsed = messages
                        .map(function (msg) { return extractMessageText(msg); })
...
function createCronTool(opts) {
    ...
    return {
        ...
        execute: function (_toolCallId, args) { return __awaiter(_this, void 0, void 0, function () {
            var params, action, gatewayOpts, _a, _b, _c, job, cfg, agentId, contextMessages, payload, contextLines, baseText, _d, id, patch, _e, id, _f, id, _g, id, _h, text, mode, _j;
                ...
                switch (_s.label) {
                    case 0:
                        ...
                        switch (_a) {
                            ...
                            case "run": return [3 /*break*/, 13];
                            case "runs": return [3 /*break*/, 15];
                            case "wake": return [3 /*break*/, 17];
                        }
                        return [3 /*break*/, 19];
                    case 1:
                        _b = common_js_1.jsonResult;
                        return [4 /*yield*/, (0, gateway_js_1.callGatewayTool)("cron.status", gatewayOpts, {})];
                    case 2: return [2 /*return*/, _b.apply(void 0, [_s.sent()])];
                    case 3:
                        _c = common_js_1.jsonResult;
                        return [4 /*yield*/, (0, gateway_js_1.callGatewayTool)("cron.list", gatewayOpts, {
                                includeDisabled: Boolean(params.includeDisabled),
                            })];
                    case 4: return [2 /*return*/, _c.apply(void 0, [_s.sent()])];
                    case 5:
                        if (!params.job || typeof params.job !== "object") {
                            throw new Error("job required");
                        }
                        job = (_k = (0, normalize_js_1.normalizeCronJobCreate)(params.job)) !== null && _k !== void 0 ? _k : params.job;
                        if (job && typeof job === "object" && !("agentId" in job)) {
                            cfg = (0, config_js_1.loadConfig)();
                            agentId = (opts === null || opts === void 0 ? void 0 : opts.agentSessionKey)
                                ? (0, agent_scope_js_1.resolveSessionAgentId)({ sessionKey: opts.agentSessionKey, config: cfg })
                                : undefined;
                            if (agentId) {
                                job.agentId = agentId;
                            }
                        }
                        contextMessages = typeof params.contextMessages === "number" && Number.isFinite(params.contextMessages)
                            ? params.contextMessages
                            : 0;
                        if (!(job &&
                            typeof job === "object" &&
                            "payload" in job &&
                            ((_l = job.payload) === null || _l === void 0 ? void 0 : _l.kind) === "systemEvent")) return [3 /*break*/, 7];
                        payload = job.payload;
                        if (!(typeof payload.text === "string" && payload.text.trim())) return [3 /*break*/, 7];
                        return [4 /*yield*/, buildReminderContextLines({
                    ...
                    case 6:
                        ...
                        if (contextLines.length > 0) {
                            ...
                            payload.text = "".concat(baseText).concat(REMINDER_CONTEXT_MARKER).concat(contextLines.join("\n"));
                        }
                        _s.label = 7;
                    case 7:
                        _d = common_js_1.jsonResult;
                        return [4 /*yield*/, (0, gateway_js_1.callGatewayTool)("cron.add", gatewayOpts, job)];
                    case 8: return [2 /*return*/, _d.apply(void 0, [_s.sent()])];
                    case 9:
                        id = (_m = (0, common_js_1.readStringParam)(params, "jobId")) !== null && _m !== void 0 ? _m : (0, common_js_1.readStringParam)(params, "id");
                        if (!id) {
                        ...
                        patch = (_o = (0, normalize_js_1.normalizeCronJobPatch)(params.patch)) !== null && _o !== void 0 ? _o : params.patch;
                        _e = common_js_1.jsonResult;
                        return [4 /*yield*/, (0, gateway_js_1.callGatewayTool)("cron.update", gatewayOpts, {
                                id: id,
                                patch: patch,
                            })];
                    case 10: return [2 /*return*/, _e.apply(void 0, [_s.sent()])];
                    case 11:
                        id = (_p = (0, common_js_1.readStringParam)(params, "jobId")) !== null && _p !== void 0 ? _p : (0, common_js_1.readStringParam)(params, "id");
                        if (!id) {
                            throw new Error("jobId required (id accepted for backward compatibility)");
                        }
                        _f = common_js_1.jsonResult;
                        return [4 /*yield*/, (0, gateway_js_1.callGatewayTool)("cron.remove", gatewayOpts, { id: id })];
                    case 12: return [2 /*return*/, _f.apply(void 0, [_s.sent()])];
                    case 13:
                        id = (_q = (0, common_js_1.readStringParam)(params, "jobId")) !== null && _q !== void 0 ? _q : (0, common_js_1.readStringParam)(params, "id");
                        if (!id) {
                            throw new Error("jobId required (id accepted for backward compatibility)");
                        }
                        _g = common_js_1.jsonResult;
                        return [4 /*yield*/, (0, gateway_js_1.callGatewayTool)("cron.run", gatewayOpts, { id: id })];
                    case 14: return [2 /*return*/, _g.apply(void 0, [_s.sent()])];
                    case 15:
                        id = (_r = (0, common_js_1.readStringParam)(params, "jobId")) !== null && _r !== void 0 ? _r : (0, common_js_1.readStringParam)(params, "id");
                        if (!id) {
                            throw new Error("jobId required (id accepted for backward compatibility)");
                        }
                        _h = common_js_1.jsonResult;
                        return [4 /*yield*/, (0, gateway_js_1.callGatewayTool)("cron.runs", gatewayOpts, { id: id })];
                    case 16: return [2 /*return*/, _h.apply(void 0, [_s.sent()])];
                    case 17:
                        text = (0, common_js_1.readStringParam)(params, "text", { required: true });
                        mode = params.mode === "now" || params.mode === "next-heartbeat"
                            ? params.mode
                            : "next-heartbeat";
                        _j = common_js_1.jsonResult;
                        return [4 /*yield*/, (0, gateway_js_1.callGatewayTool)("wake", gatewayOpts, { mode: mode, text: text }, { expectFinal: false })];
                    case 18: return [2 /*return*/, _j.apply(void 0, [_s.sent()])];
                    case 19: throw new Error("Unknown action: ".concat(action));
                }
            });
        }); },
    };
