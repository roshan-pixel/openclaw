...
function fetchWithRedirects(params) {
    return __awaiter(this, void 0, void 0, function () {
        var signal, visited, currentUrl, redirectCount, parsedUrl, pinned, dispatcher, res, err_1, location_1, nextUrl;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    _b.trys.push([3, 5, , 7]);
                    return [4 /*yield*/, fetch(parsedUrl.toString(), {
                            method: "GET",
                            headers: {
                                Accept: "*/*",
                ...
                case 6:
                    ...
                    throw err_1;
                case 7:
                    if (!isRedirectStatus(res.status)) return [3 /*break*/, 15];
                ...
                case 9:
                    redirectCount += 1;
                    if (!(redirectCount > params.maxRedirects)) return [3 /*break*/, 11];
                    return [4 /*yield*/, (0, ssrf_js_1.closeDispatcher)(dispatcher)];
                case 10:
                    _b.sent();
                ...
                case 11:
                    ...
                    if (!visited.has(nextUrl)) return [3 /*break*/, 13];
                    return [4 /*yield*/, (0, ssrf_js_1.closeDispatcher)(dispatcher)];
                case 12:
                    _b.sent();
                ...
                case 14:
                    ...
                    currentUrl = nextUrl;
                    return [3 /*break*/, 1];
                case 15: return [2 /*return*/, { response: res, finalUrl: currentUrl, dispatcher: dispatcher }];
            ...
            switch (_e.label) {
                ...
                case 2:
                    ...
                    if (!res.ok || (payload === null || payload === void 0 ? void 0 : payload.success) === false) {
                        detail = (payload === null || payload === void 0 ? void 0 : payload.error) || res.statusText;
                        throw new Error("Firecrawl fetch failed (".concat(res.status, "): ").concat(detail).trim());
                    }
                    data = (_a = payload === null || payload === void 0 ? void 0 : payload.data) !== null && _a !== void 0 ? _a : {};
...
function runWebFetch(params) {
    return __awaiter(this, void 0, void 0, function () {
        var cacheKey, cached, parsedUrl, start, res, dispatcher, finalUrl, result, error_1, firecrawl, truncated, payload, firecrawl, truncated_1, payload_1, rawDetail, detail, contentType, body, title, extractor, text, readable, firecrawl, truncated, payload;
        var _a, _b, _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    _d.trys.push([1, 3, , 6]);
                    return [4 /*yield*/, fetchWithRedirects({
                            url: params.url,
                ...
                case 9:
                    ...
                    throw new Error("Web fetch failed (".concat(res.status, "): ").concat(detail || res.statusText));
                case 10:
                ...
                case 19:
                    ...
                    (0, web_shared_js_1.writeCache)(FETCH_CACHE, cacheKey, payload, params.cacheTtlMs);
                    return [2 /*return*/, payload];
                case 20: return [4 /*yield*/, (0, ssrf_js_1.closeDispatcher)(dispatcher)];
                case 21:
                    _d.sent();
                    return [7 /*endfinally*/];
