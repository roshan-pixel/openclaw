...
function createCanvasTool() {
    ...
    return {
        ...
        execute: function (_toolCallId, args) { return __awaiter(_this, void 0, void 0, function () {
            var params, action, gatewayOpts, nodeId, invoke, _a, placement, invokeParams, url, javaScript, raw, result, formatRaw, format, maxWidth, quality, raw, payload, filePath, mimeType, jsonl, _b, _c;
            var _this = this;
            var _d, _e;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, nodes_utils_js_1.resolveNodeId)(gatewayOpts, (0, common_js_1.readStringParam)(params, "node", { trim: true }), true)];
                    case 1:
                        nodeId = _f.sent();
                        invoke = function (command, invokeParams) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, (0, gateway_js_1.callGatewayTool)("node.invoke", gatewayOpts, {
                                            nodeId: nodeId,
                                            command: command,
                                            params: invokeParams,
                        ...
                        _a = action;
                        switch (_a) {
                            case "present": return [3 /*break*/, 2];
                            case "hide": return [3 /*break*/, 4];
                            case "navigate": return [3 /*break*/, 6];
                            case "eval": return [3 /*break*/, 8];
                            case "snapshot": return [3 /*break*/, 10];
                            case "a2ui_push": return [3 /*break*/, 14];
                            case "a2ui_reset": return [3 /*break*/, 21];
                        }
                        return [3 /*break*/, 23];
                    case 2:
                        placement = {
                    ...
                    case 4: return [4 /*yield*/, invoke("canvas.hide", undefined)];
                    case 5:
                        _f.sent();
                        return [2 /*return*/, (0, common_js_1.jsonResult)({ ok: true })];
                    case 6:
                    ...
                    case 9:
                        raw = (_f.sent());
                        result = (_d = raw === null || raw === void 0 ? void 0 : raw.payload) === null || _d === void 0 ? void 0 : _d.result;
                        if (result) {
                            return [2 /*return*/, {
                        ...
                        return [2 /*return*/, (0, common_js_1.jsonResult)({ ok: true })];
                    case 10:
                        formatRaw = typeof params.outputFormat === "string" ? params.outputFormat.toLowerCase() : "png";
                        ...
                        quality = typeof params.quality === "number" && Number.isFinite(params.quality)
                            ? params.quality
                            : undefined;
                        return [4 /*yield*/, invoke("canvas.snapshot", {
                                format: format,
                                maxWidth: maxWidth,
                                quality: quality,
                            })];
                    case 11:
                        raw = (_f.sent());
                        payload = (0, nodes_canvas_js_1.parseCanvasSnapshotPayload)(raw === null || raw === void 0 ? void 0 : raw.payload);
                    ...
                    case 12:
                        _f.sent();
                        mimeType = (_e = (0, mime_js_1.imageMimeFromFormat)(payload.format)) !== null && _e !== void 0 ? _e : "image/png";
                        return [4 /*yield*/, (0, common_js_1.imageResult)({
                    ...
                    case 14:
                        if (!(typeof params.jsonl === "string" && params.jsonl.trim())) return [3 /*break*/, 15];
                        _b = params.jsonl;
                        return [3 /*break*/, 19];
                    case 15:
                        if (!(typeof params.jsonlPath === "string" && params.jsonlPath.trim())) return [3 /*break*/, 17];
                    ...
                    case 20:
                        _f.sent();
                        return [2 /*return*/, (0, common_js_1.jsonResult)({ ok: true })];
                    case 21: return [4 /*yield*/, invoke("canvas.a2ui.reset", undefined)];
                    case 22:
                        _f.sent();
                        return [2 /*return*/, (0, common_js_1.jsonResult)({ ok: true })];
                    case 23: throw new Error("Unknown action: ".concat(action));
                }
            });
        }); },
    };
