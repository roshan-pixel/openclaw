...
function runSessionsSendA2AFlow(params) {
    return __awaiter(this, void 0, void 0, function () {
        var runContextId, primaryReply, latestReply, waitMs, wait, announceTarget, targetChannel, currentSessionKey, nextSessionKey, incomingMessage, turn, currentRole, replyPrompt, replyText, swap, announcePrompt, announceReply, err_1, err_2;
        var _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    if (!(!primaryReply && params.waitRunId)) return [3 /*break*/, 4];
                ...
                case 2:
                    wait = (_c.sent());
                    if (!((wait === null || wait === void 0 ? void 0 : wait.status) === "ok")) return [3 /*break*/, 4];
                ...
                case 4:
                    if (!latestReply)
                        return [2 /*return*/];
                    return [4 /*yield*/, (0, sessions_announce_target_js_1.resolveAnnounceTarget)({
                            sessionKey: params.targetSessionKey,
                            displayKey: params.displayKey,
                        })];
                case 5:
                    announceTarget = _c.sent();
                    targetChannel = (_b = announceTarget === null || announceTarget === void 0 ? void 0 : announceTarget.channel) !== null && _b !== void 0 ? _b : "unknown";
                    if (!(params.maxPingPongTurns > 0 &&
                        params.requesterSessionKey &&
                        params.requesterSessionKey !== params.targetSessionKey)) return [3 /*break*/, 9];
                    ...
                    _c.label = 6;
                case 6:
                    if (!(turn <= params.maxPingPongTurns)) return [3 /*break*/, 9];
                    ...
                    return [4 /*yield*/, (0, agent_step_js_1.runAgentStep)({
                ...
                case 10:
                    ...
                    if (!(announceTarget && announceReply && announceReply.trim() && !(0, sessions_send_helpers_js_1.isAnnounceSkip)(announceReply))) return [3 /*break*/, 14];
                    _c.label = 11;
                case 11:
