    ...
    var rows = raw.map(function (row, rowIndex) {
        ...
        return row.map(function (button, buttonIndex) {
            if (!button || typeof button !== "object") {
                throw new Error("buttons[".concat(rowIndex, "][").concat(buttonIndex, "] must be an object"));
            }
            var text = typeof button.text === "string"
                ? button.text.trim()
                : "";
            var callbackData = typeof button.callback_data === "string"
                ? button.callback_data.trim()
                : "";
            if (!text || !callbackData) {
                throw new Error("buttons[".concat(rowIndex, "][").concat(buttonIndex, "] requires text and callback_data"));
            }
            if (callbackData.length > 64) {
                throw new Error("buttons[".concat(rowIndex, "][").concat(buttonIndex, "] callback_data too long (max 64 chars)"));
            }
            return { text: text, callback_data: callbackData };
        });
    });
    var filtered = rows.filter(function (row) { return row.length > 0; });
    return filtered.length > 0 ? filtered : undefined;
}
function handleTelegramAction(params, cfg) {
    return __awaiter(this, void 0, void 0, function () {
        var action, accountId, isActionEnabled, reactionLevelInfo, chatId, messageId, _a, emoji, remove, isEmpty, token, to, mediaUrl, content, buttons, inlineButtonsScope, targetType, replyToMessageId, messageThreadId, quoteText, token, result, chatId, messageId, token, chatId, messageId, content, buttons, inlineButtonsScope, token, result, to, fileId, replyToMessageId, messageThreadId, token, result, query, limit, results, stats;
        var _b, _c, _d, _e;
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                    ...
                    isActionEnabled = (0, common_js_1.createActionGate)((_c = (_b = cfg.channels) === null || _b === void 0 ? void 0 : _b.telegram) === null || _c === void 0 ? void 0 : _c.actions);
                    if (!(action === "react")) return [3 /*break*/, 2];
                    ...
                    if (!reactionLevelInfo.agentReactionsEnabled) {
                        throw new Error("Telegram agent reactions disabled (reactionLevel=\"".concat(reactionLevelInfo.level, "\"). ") +
                    ...
                    return [4 /*yield*/, (0, send_js_1.reactMessageTelegram)(chatId !== null && chatId !== void 0 ? chatId : "", messageId !== null && messageId !== void 0 ? messageId : 0, emoji !== null && emoji !== void 0 ? emoji : "", {
                            token: token,
                            remove: remove,
                            accountId: accountId !== null && accountId !== void 0 ? accountId : undefined,
                        })];
                ...
                case 2:
                    if (!(action === "sendMessage")) return [3 /*break*/, 4];
                    ...
                    content = (_d = (0, common_js_1.readStringParam)(params, "content", {
                        required: !mediaUrl,
                        allowEmpty: true,
                    })) !== null && _d !== void 0 ? _d : "";
                    ...
                    if (buttons) {
                        ...
                        if (inlineButtonsScope === "dm" || inlineButtonsScope === "group") {
                            ...
                            if (targetType === "unknown") {
                                throw new Error("Telegram inline buttons require a numeric chat id when inlineButtons=\"".concat(inlineButtonsScope, "\"."));
                            }
                    ...
                    return [4 /*yield*/, (0, send_js_1.sendMessageTelegram)(to, content, {
                            token: token,
                            accountId: accountId !== null && accountId !== void 0 ? accountId : undefined,
                ...
                case 4:
                    if (!(action === "deleteMessage")) return [3 /*break*/, 6];
                    ...
                    return [4 /*yield*/, (0, send_js_1.deleteMessageTelegram)(chatId !== null && chatId !== void 0 ? chatId : "", messageId !== null && messageId !== void 0 ? messageId : 0, {
                            token: token,
                            accountId: accountId !== null && accountId !== void 0 ? accountId : undefined,
                        })];
                case 5:
                ...
                case 6:
                    if (!(action === "editMessage")) return [3 /*break*/, 8];
                    ...
                    return [4 /*yield*/, (0, send_js_1.editMessageTelegram)(chatId !== null && chatId !== void 0 ? chatId : "", messageId !== null && messageId !== void 0 ? messageId : 0, content, {
                            token: token,
                            accountId: accountId !== null && accountId !== void 0 ? accountId : undefined,
                            buttons: buttons,
                        })];
                ...
                case 8:
                    if (!(action === "sendSticker")) return [3 /*break*/, 10];
                    ...
                    return [4 /*yield*/, (0, send_js_1.sendStickerTelegram)(to, fileId, {
                            token: token,
                            accountId: accountId !== null && accountId !== void 0 ? accountId : undefined,
                            replyToMessageId: replyToMessageId !== null && replyToMessageId !== void 0 ? replyToMessageId : undefined,
                            messageThreadId: messageThreadId !== null && messageThreadId !== void 0 ? messageThreadId : undefined,
                ...
                case 10:
                    if (action === "searchSticker") {
                        ...
                        limit = (_e = (0, common_js_1.readNumberParam)(params, "limit", { integer: true })) !== null && _e !== void 0 ? _e : 5;
                        results = (0, sticker_cache_js_1.searchStickers)(query, limit);
                        return [2 /*return*/, (0, common_js_1.jsonResult)({
                                ok: true,
                                count: results.length,
                                stickers: results.map(function (s) { return ({
                                    fileId: s.fileId,
                                    emoji: s.emoji,
