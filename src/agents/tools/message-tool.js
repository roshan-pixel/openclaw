...
function buildRoutingSchema() {
    return {
        ...
        target: typebox_1.Type.Optional((0, typebox_js_1.channelTargetSchema)({ description: "Target channel/user id or name." })),
...
function buildSendSchema(options) {
    var props = {
        ...
        effectId: typebox_1.Type.Optional(typebox_1.Type.String({
            description: "Message effect name/id for sendWithEffect (e.g., invisible ink).",
        })),
        effect: typebox_1.Type.Optional(typebox_1.Type.String({ description: "Alias for effectId (e.g., invisible-ink, balloons)." })),
        media: typebox_1.Type.Optional(typebox_1.Type.String()),
        filename: typebox_1.Type.Optional(typebox_1.Type.String()),
        buffer: typebox_1.Type.Optional(typebox_1.Type.String({
        ...
        quoteText: typebox_1.Type.Optional(typebox_1.Type.String({ description: "Quote text for Telegram reply_parameters" })),
        bestEffort: typebox_1.Type.Optional(typebox_1.Type.Boolean()),
        gifPlayback: typebox_1.Type.Optional(typebox_1.Type.Boolean()),
        buttons: typebox_1.Type.Optional(typebox_1.Type.Array(typebox_1.Type.Array(typebox_1.Type.Object({
        ...
        card: typebox_1.Type.Optional(typebox_1.Type.Object({}, {
...
function buildChannelTargetSchema() {
    return {
        channelId: typebox_1.Type.Optional(typebox_1.Type.String({ description: "Channel id filter (search/thread list/event create)." })),
        channelIds: typebox_1.Type.Optional(typebox_1.Type.Array(typebox_1.Type.String({ description: "Channel id filter (repeatable)." }))),
...
function filterActionsForContext(params) {
    ...
    var currentChannelId = (_a = params.currentChannelId) === null || _a === void 0 ? void 0 : _a.trim();
    if (!currentChannelId)
        return params.actions;
    var normalizedTarget = (_b = (0, target_normalization_js_1.normalizeTargetForProvider)(channel, currentChannelId)) !== null && _b !== void 0 ? _b : currentChannelId;
    var lowered = normalizedTarget.trim().toLowerCase();
    var isGroupTarget = lowered.startsWith("chat_guid:") ||
        lowered.startsWith("chat_id:") ||
        lowered.startsWith("chat_identifier:") ||
        lowered.startsWith("group:");
    if (isGroupTarget)
        return params.actions;
    return params.actions.filter(function (action) { return !bluebubbles_actions_js_1.BLUEBUBBLES_GROUP_ACTIONS.has(action); });
}
function buildMessageToolDescription(options) {
    ...
    if (options === null || options === void 0 ? void 0 : options.currentChannel) {
        ...
        if (channelActions.length > 0) {
            ...
            var actionList = Array.from(allActions).sort().join(", ");
            return "".concat(baseDescription, " Current channel (").concat(options.currentChannel, ") supports: ").concat(actionList, ".");
        }
    }
    ...
    return "".concat(baseDescription, " Supports actions: send, delete, react, poll, pin, threads, and more.");
}
function createMessageTool(options) {
    var _this = this;
    var agentAccountId = resolveAgentAccountId(options === null || options === void 0 ? void 0 : options.agentAccountId);
    var schema = (options === null || options === void 0 ? void 0 : options.config) ? buildMessageToolSchema(options.config) : MessageToolSchema;
    var description = buildMessageToolDescription({
        config: options === null || options === void 0 ? void 0 : options.config,
        currentChannel: options === null || options === void 0 ? void 0 : options.currentChannelProvider,
    ...
    return {
        ...
        parameters: schema,
        execute: function (_toolCallId, args, signal) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        params = args;
                        cfg = (_a = options === null || options === void 0 ? void 0 : options.config) !== null && _a !== void 0 ? _a : (0, config_js_1.loadConfig)();
                        action = (0, common_js_1.readStringParam)(params, "action", {
                            required: true,
                        });
                        accountId = (_b = (0, common_js_1.readStringParam)(params, "accountId")) !== null && _b !== void 0 ? _b : agentAccountId;
                        if (accountId) {
                        ...
                        toolContext = (options === null || options === void 0 ? void 0 : options.currentChannelId) ||
                            ...
                            ? {
                                currentChannelId: options === null || options === void 0 ? void 0 : options.currentChannelId,
                                currentChannelProvider: options === null || options === void 0 ? void 0 : options.currentChannelProvider,
                        ...
                        return [4 /*yield*/, (0, message_action_runner_js_1.runMessageAction)({
                                ...
                                action: action,
                                params: params,
                                defaultAccountId: accountId !== null && accountId !== void 0 ? accountId : undefined,
                                gateway: gateway,
                                toolContext: toolContext,
                                agentId: (options === null || options === void 0 ? void 0 : options.agentSessionKey)
                                    ? (0, agent_scope_js_1.resolveSessionAgentId)({ sessionKey: options.agentSessionKey, config: cfg })
                                    : undefined,
                                abortSignal: signal,
                            })];
                    case 1:
