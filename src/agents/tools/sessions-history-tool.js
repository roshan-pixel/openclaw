        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, sessions.some(function (entry) { return (entry === null || entry === void 0 ? void 0 : entry.key) === params.targetSessionKey; })];
                case 2:
                    _a = _b.sent();
...
function createSessionsHistoryTool(opts) {
    ...
    return {
        ...
        execute: function (_toolCallId, args) { return __awaiter(_this, void 0, void 0, function () {
            var params, sessionKeyParam, cfg, _a, mainKey, alias, visibility, requesterInternalKey, restrictToSpawned, resolvedSession, resolvedKey, displayKey, resolvedViaSessionId, ok, a2aPolicy, requesterAgentId, targetAgentId, isCrossAgent, limit, includeTools, result, rawMessages, messages;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        params = args;
                    ...
                    case 1:
                        ...
                        if (!resolvedSession.ok) {
                            return [2 /*return*/, (0, common_js_1.jsonResult)({ status: resolvedSession.status, error: resolvedSession.error })];
                        }
                        ...
                        if (!(restrictToSpawned && !resolvedViaSessionId)) return [3 /*break*/, 3];
                        return [4 /*yield*/, isSpawnedSessionAllowed({
                    ...
                    case 2:
                        ...
                        if (!ok) {
                            return [2 /*return*/, (0, common_js_1.jsonResult)({
                                    status: "forbidden",
                                    error: "Session not visible from this sandboxed agent session: ".concat(sessionKeyParam),
                                })];
                        }
                        _b.label = 3;
                    case 3:
                    ...
                    case 4:
                        result = (_b.sent());
                        rawMessages = Array.isArray(result === null || result === void 0 ? void 0 : result.messages) ? result.messages : [];
                        messages = includeTools ? rawMessages : (0, sessions_helpers_js_1.stripToolMessages)(rawMessages);
                        return [2 /*return*/, (0, common_js_1.jsonResult)({
