...
function createGatewayTool(opts) {
    ...
    return {
        ...
        execute: function (_toolCallId, args) { return __awaiter(_this, void 0, void 0, function () {
            var params, action, sessionKey, delayMs, reason, note, deliveryContext, threadId, threadMarker, threadIndex, baseSessionKey, threadIdRaw, cfg, storePath, store, entry, payload, _a, scheduled, gatewayUrl, gatewayToken, timeoutMs, gatewayOpts, result, result, raw, baseHash, snapshot, sessionKey, note, restartDelayMs, result, raw, baseHash, snapshot, sessionKey, note, restartDelayMs, result, sessionKey, note, restartDelayMs, result;
            ...
            return __generator(this, function (_k) {
                switch (_k.label) {
                    case 0:
                        ...
                        if (!(action === "restart")) return [3 /*break*/, 5];
                        if (((_c = (_b = opts === null || opts === void 0 ? void 0 : opts.config) === null || _b === void 0 ? void 0 : _b.commands) === null || _c === void 0 ? void 0 : _c.restart) !== true) {
                        ...
                        sessionKey = typeof params.sessionKey === "string" && params.sessionKey.trim()
                            ...
                            : ((_d = opts === null || opts === void 0 ? void 0 : opts.agentSessionKey) === null || _d === void 0 ? void 0 : _d.trim()) || undefined;
                        ...
                        if (sessionKey) {
                            ...
                            threadIdRaw = threadIndex === -1 ? undefined : sessionKey.slice(threadIndex + threadMarker.length);
                            threadId = (threadIdRaw === null || threadIdRaw === void 0 ? void 0 : threadIdRaw.trim()) || undefined;
                            try {
                                cfg = (0, io_js_1.loadConfig)();
                                storePath = (0, sessions_js_1.resolveStorePath)((_e = cfg.session) === null || _e === void 0 ? void 0 : _e.store);
                                store = (0, sessions_js_1.loadSessionStore)(storePath);
                                entry = store[sessionKey];
                                if (!(entry === null || entry === void 0 ? void 0 : entry.deliveryContext) && threadIndex !== -1 && baseSessionKey) {
                        ...
                        payload = {
                            ...
                            threadId: threadId,
                            message: (_f = note !== null && note !== void 0 ? note : reason) !== null && _f !== void 0 ? _f : null,
                    ...
                    case 3:
                        ...
                        return [3 /*break*/, 4];
                    case 4:
                        console.info("gateway tool: restart requested (delayMs=".concat(delayMs !== null && delayMs !== void 0 ? delayMs : "default", ", reason=").concat(reason !== null && reason !== void 0 ? reason : "none", ")"));
                    ...
                    case 5:
                        gatewayUrl = typeof params.gatewayUrl === "string" && params.gatewayUrl.trim()
                            ? params.gatewayUrl.trim()
                            : undefined;
                        gatewayToken = typeof params.gatewayToken === "string" && params.gatewayToken.trim()
                            ? params.gatewayToken.trim()
                            : undefined;
                        timeoutMs = typeof params.timeoutMs === "number" && Number.isFinite(params.timeoutMs)
                            ? Math.max(1, Math.floor(params.timeoutMs))
                            : undefined;
                        gatewayOpts = { gatewayUrl: gatewayUrl, gatewayToken: gatewayToken, timeoutMs: timeoutMs };
                        if (!(action === "config.get")) return [3 /*break*/, 7];
                        return [4 /*yield*/, (0, gateway_js_1.callGatewayTool)("config.get", gatewayOpts, {})];
                    case 6:
                        result = _k.sent();
                        return [2 /*return*/, (0, common_js_1.jsonResult)({ ok: true, result: result })];
                    case 7:
                        if (!(action === "config.schema")) return [3 /*break*/, 9];
                        return [4 /*yield*/, (0, gateway_js_1.callGatewayTool)("config.schema", gatewayOpts, {})];
                    case 8:
                        result = _k.sent();
                        return [2 /*return*/, (0, common_js_1.jsonResult)({ ok: true, result: result })];
                    case 9:
                        if (!(action === "config.apply")) return [3 /*break*/, 13];
                        raw = (0, common_js_1.readStringParam)(params, "raw", { required: true });
                        baseHash = (0, common_js_1.readStringParam)(params, "baseHash");
                        if (!!baseHash) return [3 /*break*/, 11];
                        return [4 /*yield*/, (0, gateway_js_1.callGatewayTool)("config.get", gatewayOpts, {})];
                    case 10:
                        snapshot = _k.sent();
                    ...
                    case 11:
                        sessionKey = typeof params.sessionKey === "string" && params.sessionKey.trim()
                            ? params.sessionKey.trim()
                            : ((_g = opts === null || opts === void 0 ? void 0 : opts.agentSessionKey) === null || _g === void 0 ? void 0 : _g.trim()) || undefined;
                        note = typeof params.note === "string" && params.note.trim() ? params.note.trim() : undefined;
                        restartDelayMs = typeof params.restartDelayMs === "number" && Number.isFinite(params.restartDelayMs)
                            ? Math.floor(params.restartDelayMs)
                            : undefined;
                        return [4 /*yield*/, (0, gateway_js_1.callGatewayTool)("config.apply", gatewayOpts, {
                                raw: raw,
                                baseHash: baseHash,
                                sessionKey: sessionKey,
                                note: note,
                    ...
                    case 12:
                        ...
                        return [2 /*return*/, (0, common_js_1.jsonResult)({ ok: true, result: result })];
                    case 13:
                        if (!(action === "config.patch")) return [3 /*break*/, 17];
                        raw = (0, common_js_1.readStringParam)(params, "raw", { required: true });
                        baseHash = (0, common_js_1.readStringParam)(params, "baseHash");
                        if (!!baseHash) return [3 /*break*/, 15];
                        return [4 /*yield*/, (0, gateway_js_1.callGatewayTool)("config.get", gatewayOpts, {})];
                    case 14:
                        snapshot = _k.sent();
                        baseHash = resolveBaseHashFromSnapshot(snapshot);
                    ...
                    case 15:
                        sessionKey = typeof params.sessionKey === "string" && params.sessionKey.trim()
                            ? params.sessionKey.trim()
                            : ((_h = opts === null || opts === void 0 ? void 0 : opts.agentSessionKey) === null || _h === void 0 ? void 0 : _h.trim()) || undefined;
                        note = typeof params.note === "string" && params.note.trim() ? params.note.trim() : undefined;
                        restartDelayMs = typeof params.restartDelayMs === "number" && Number.isFinite(params.restartDelayMs)
                            ? Math.floor(params.restartDelayMs)
                            : undefined;
                        return [4 /*yield*/, (0, gateway_js_1.callGatewayTool)("config.patch", gatewayOpts, {
                                raw: raw,
                                baseHash: baseHash,
                                sessionKey: sessionKey,
                                note: note,
                    ...
                    case 16:
                        ...
                        return [2 /*return*/, (0, common_js_1.jsonResult)({ ok: true, result: result })];
                    case 17:
                        if (!(action === "update.run")) return [3 /*break*/, 19];
                        sessionKey = typeof params.sessionKey === "string" && params.sessionKey.trim()
                            ? params.sessionKey.trim()
                            : ((_j = opts === null || opts === void 0 ? void 0 : opts.agentSessionKey) === null || _j === void 0 ? void 0 : _j.trim()) || undefined;
                        note = typeof params.note === "string" && params.note.trim() ? params.note.trim() : undefined;
                        restartDelayMs = typeof params.restartDelayMs === "number" && Number.isFinite(params.restartDelayMs)
                            ? Math.floor(params.restartDelayMs)
                            : undefined;
                        return [4 /*yield*/, (0, gateway_js_1.callGatewayTool)("update.run", gatewayOpts, {
                                sessionKey: sessionKey,
                                note: note,
                                restartDelayMs: restartDelayMs,
                                timeoutMs: timeoutMs,
