...
var SessionsSendToolSchema = typebox_1.Type.Object({
    ...
    label: typebox_1.Type.Optional(typebox_1.Type.String({ minLength: 1, maxLength: session_label_js_1.SESSION_LABEL_MAX_LENGTH })),
...
function createSessionsSendTool(opts) {
    ...
    return {
        ...
        execute: function (_toolCallId, args) { return __awaiter(_this, void 0, void 0, function () {
            var params, message, cfg, _a, mainKey, alias, visibility, requesterInternalKey, restrictToSpawned, a2aPolicy, sessionKeyParam, labelParam, labelAgentIdParam, listSessions, sessionKey, requesterAgentId_1, requestedAgentId, resolveParams, resolvedKey_1, resolved, err_1, msg, resolvedSession, resolvedKey, displayKey, resolvedViaSessionId, sessions, ok, timeoutSeconds, timeoutMs, announceTimeoutMs, idempotencyKey, runId, requesterAgentId, targetAgentId, isCrossAgent, agentMessageContext, sendParams, requesterSessionKey, requesterChannel, maxPingPongTurns, delivery, startA2AFlow, response, err_2, messageText, response, err_3, messageText, waitStatus, waitError, wait, err_4, messageText, history, filtered, last, reply;
            var _this = this;
            ...
            return __generator(this, function (_h) {
                switch (_h.label) {
                    case 0:
                        ...
                        visibility = (_e = (_d = (_c = (_b = cfg.agents) === null || _b === void 0 ? void 0 : _b.defaults) === null || _c === void 0 ? void 0 : _c.sandbox) === null || _d === void 0 ? void 0 : _d.sessionToolsVisibility) !== null && _e !== void 0 ? _e : "spawned";
                        requesterInternalKey = typeof (opts === null || opts === void 0 ? void 0 : opts.agentSessionKey) === "string" && opts.agentSessionKey.trim()
                            ...
                            : undefined;
                        restrictToSpawned = (opts === null || opts === void 0 ? void 0 : opts.sandboxed) === true &&
                            visibility === "spawned" &&
                        ...
                        labelParam = ((_f = (0, common_js_1.readStringParam)(params, "label")) === null || _f === void 0 ? void 0 : _f.trim()) || undefined;
                        labelAgentIdParam = ((_g = (0, common_js_1.readStringParam)(params, "agentId")) === null || _g === void 0 ? void 0 : _g.trim()) || undefined;
                        ...
                        listSessions = function (listParams) { return __awaiter(_this, void 0, void 0, function () {
                            var result;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        result = (_a.sent());
                                        return [2 /*return*/, Array.isArray(result === null || result === void 0 ? void 0 : result.sessions) ? result.sessions : []];
                                }
                            });
                        }); };
                        sessionKey = sessionKeyParam;
                        if (!(!sessionKey && labelParam)) return [3 /*break*/, 5];
                        ...
                        if (requesterAgentId_1 && requestedAgentId && requestedAgentId !== requesterAgentId_1) {
                        ...
                        resolveParams = __assign(__assign({ label: labelParam }, (requestedAgentId ? { agentId: requestedAgentId } : {})), (restrictToSpawned ? { spawnedBy: requesterInternalKey } : {}));
                        resolvedKey_1 = "";
                        _h.label = 1;
                    case 1:
                        _h.trys.push([1, 3, , 4]);
                    ...
                    case 2:
                        resolved = (_h.sent());
                        resolvedKey_1 = typeof (resolved === null || resolved === void 0 ? void 0 : resolved.key) === "string" ? resolved.key.trim() : "";
                        return [3 /*break*/, 4];
                    case 3:
                        err_1 = _h.sent();
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, (0, sessions_helpers_js_1.resolveSessionReference)({
                    ...
                    case 6:
                        ...
                        if (!(restrictToSpawned && !resolvedViaSessionId)) return [3 /*break*/, 8];
                    ...
                    case 7:
                        sessions = _h.sent();
                        ok = sessions.some(function (entry) { return (entry === null || entry === void 0 ? void 0 : entry.key) === resolvedKey; });
                        if (!ok) {
                            return [2 /*return*/, (0, common_js_1.jsonResult)({
                                    runId: node_crypto_1.default.randomUUID(),
                                    status: "forbidden",
                                    error: "Session not visible from this sandboxed agent session: ".concat(sessionKey),
                                    sessionKey: displayKey,
                                })];
                        }
                        _h.label = 8;
                    case 8:
                        timeoutSeconds = typeof params.timeoutSeconds === "number" && Number.isFinite(params.timeoutSeconds)
                        ...
                        requesterAgentId = (0, session_key_js_1.resolveAgentIdFromSessionKey)(requesterInternalKey);
                        ...
                        agentMessageContext = (0, sessions_send_helpers_js_1.buildAgentToAgentMessageContext)({
                            requesterSessionKey: opts === null || opts === void 0 ? void 0 : opts.agentSessionKey,
                        ...
                        if (!(timeoutSeconds === 0)) return [3 /*break*/, 12];
                        _h.label = 9;
                    case 9:
                    ...
                    case 10:
                        response = (_h.sent());
                        if (typeof (response === null || response === void 0 ? void 0 : response.runId) === "string" && response.runId) {
                    ...
                    case 11:
                        err_2 = _h.sent();
                        messageText = err_2 instanceof Error ? err_2.message : typeof err_2 === "string" ? err_2 : "error";
                        return [2 /*return*/, (0, common_js_1.jsonResult)({
                                runId: runId,
                                status: "error",
                                error: messageText,
                    ...
                    case 14:
                        err_3 = _h.sent();
                        messageText = err_3 instanceof Error ? err_3.message : typeof err_3 === "string" ? err_3 : "error";
                        return [2 /*return*/, (0, common_js_1.jsonResult)({
                                runId: runId,
                                status: "error",
                                error: messageText,
                    ...
                    case 16:
                        wait = (_h.sent());
                        waitStatus = typeof (wait === null || wait === void 0 ? void 0 : wait.status) === "string" ? wait.status : undefined;
                        waitError = typeof (wait === null || wait === void 0 ? void 0 : wait.error) === "string" ? wait.error : undefined;
                        return [3 /*break*/, 18];
                    case 17:
                        err_4 = _h.sent();
                        messageText = err_4 instanceof Error ? err_4.message : typeof err_4 === "string" ? err_4 : "error";
                        return [2 /*return*/, (0, common_js_1.jsonResult)({
                                runId: runId,
                    ...
                    case 19:
                        history = (_h.sent());
                        filtered = (0, sessions_helpers_js_1.stripToolMessages)(Array.isArray(history === null || history === void 0 ? void 0 : history.messages) ? history.messages : []);
