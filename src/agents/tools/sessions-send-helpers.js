...
function resolveAnnounceTargetFromKey(sessionKey) {
    ...
    if (parts.length < 3)
        return null;
    var channelRaw = parts[0], kind = parts[1], rest = parts.slice(2);
    ...
    if (!channelRaw)
        return null;
    var normalizedChannel = (_a = (0, index_js_1.normalizeChannelId)(channelRaw)) !== null && _a !== void 0 ? _a : (0, registry_js_1.normalizeChannelId)(channelRaw);
    var channel = normalizedChannel !== null && normalizedChannel !== void 0 ? normalizedChannel : channelRaw.toLowerCase();
    ...
    var normalized = normalizedChannel
        ? (_d = (_c = (_b = (0, index_js_1.getChannelPlugin)(normalizedChannel)) === null || _b === void 0 ? void 0 : _b.messaging) === null || _c === void 0 ? void 0 : _c.normalizeTarget) === null || _d === void 0 ? void 0 : _d.call(_c, kindTarget)
        : undefined;
    return {
        channel: channel,
...
function buildAgentToAgentReplyContext(params) {
    var currentLabel = params.currentRole === "requester" ? "Agent 1 (requester)" : "Agent 2 (target)";
    var lines = [
        ...
        params.requesterChannel
            ...
            : undefined,
        "Agent 2 (target) session: ".concat(params.targetSessionKey, "."),
        params.targetChannel ? "Agent 2 (target) channel: ".concat(params.targetChannel, ".") : undefined,
...
function buildAgentToAgentAnnounceContext(params) {
    var lines = [
        ...
        params.latestReply ? "Latest reply: ".concat(params.latestReply) : "Latest reply: (not available).",
...
function resolvePingPongTurns(cfg) {
    var _a, _b;
    var raw = (_b = (_a = cfg === null || cfg === void 0 ? void 0 : cfg.session) === null || _a === void 0 ? void 0 : _a.agentToAgent) === null || _b === void 0 ? void 0 : _b.maxPingPongTurns;
