...
function createNodesTool(options) {
    var _this = this;
    var _a;
    var sessionKey = ((_a = options === null || options === void 0 ? void 0 : options.agentSessionKey) === null || _a === void 0 ? void 0 : _a.trim()) || undefined;
    ...
    return {
        ...
        execute: function (_toolCallId, args) { return __awaiter(_this, void 0, void 0, function () {
            var params, action, gatewayOpts, _a, _b, node, nodeId, _c, _d, requestId, _e, requestId, _f, node, title, body, nodeId, node, nodeId, facingRaw, facings, maxWidth, quality, delayMs, deviceId, content, details, _i, facings_1, facing, raw, payload, normalizedFormat, isJpeg, filePath, result, node, nodeId, raw, payload, node, nodeId, facing, durationMs, includeAudio, deviceId, raw, payload, filePath, node, nodeId, durationMs, fps, screenIndex, includeAudio, raw, payload, filePath, written, node, nodeId, maxAgeMs, desiredAccuracy, locationTimeoutMs, raw, node, nodes, nodeId_1, nodeInfo, supportsSystemRun, commandRaw, command, cwd, env, commandTimeoutMs, invokeTimeoutMs, needsScreenRecording, raw, err_1, nodeLabel, gatewayLabel, agentLabel, message;
            var _g, _h, _j, _k;
                ...
                switch (_l.label) {
                    case 0:
                        ...
                        gatewayOpts = {
                            ...
                            gatewayToken: (0, common_js_1.readStringParam)(params, "gatewayToken", { trim: false }),
                    ...
                    case 1:
                        ...
                        switch (_a) {
                            ...
                            case "describe": return [3 /*break*/, 4];
                            case "pending": return [3 /*break*/, 7];
                            case "approve": return [3 /*break*/, 9];
                            case "reject": return [3 /*break*/, 11];
                            case "notify": return [3 /*break*/, 13];
                            case "camera_snap": return [3 /*break*/, 16];
                            case "camera_list": return [3 /*break*/, 24];
                            case "camera_clip": return [3 /*break*/, 27];
                            case "screen_record": return [3 /*break*/, 31];
                            case "location_get": return [3 /*break*/, 35];
                            case "run": return [3 /*break*/, 38];
                        }
                        return [3 /*break*/, 41];
                    case 2:
                        _b = common_js_1.jsonResult;
                        return [4 /*yield*/, (0, gateway_js_1.callGatewayTool)("node.list", gatewayOpts, {})];
                    case 3: return [2 /*return*/, _b.apply(void 0, [_l.sent()])];
                    case 4:
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, (0, gateway_js_1.callGatewayTool)("node.describe", gatewayOpts, { nodeId: nodeId })];
                    case 6: return [2 /*return*/, _c.apply(void 0, [_l.sent()])];
                    case 7:
                        _d = common_js_1.jsonResult;
                        return [4 /*yield*/, (0, gateway_js_1.callGatewayTool)("node.pair.list", gatewayOpts, {})];
                    case 8: return [2 /*return*/, _d.apply(void 0, [_l.sent()])];
                    case 9:
                        requestId = (0, common_js_1.readStringParam)(params, "requestId", {
                            required: true,
                        });
                        _e = common_js_1.jsonResult;
                        return [4 /*yield*/, (0, gateway_js_1.callGatewayTool)("node.pair.approve", gatewayOpts, {
                                requestId: requestId,
                            })];
                    case 10: return [2 /*return*/, _e.apply(void 0, [_l.sent()])];
                    case 11:
                        requestId = (0, common_js_1.readStringParam)(params, "requestId", {
                            required: true,
                        });
                        _f = common_js_1.jsonResult;
                        return [4 /*yield*/, (0, gateway_js_1.callGatewayTool)("node.pair.reject", gatewayOpts, {
                                requestId: requestId,
                            })];
                    case 12: return [2 /*return*/, _f.apply(void 0, [_l.sent()])];
                    case 13:
                        node = (0, common_js_1.readStringParam)(params, "node", { required: true });
                    ...
                    case 14:
                        nodeId = _l.sent();
                        return [4 /*yield*/, (0, gateway_js_1.callGatewayTool)("node.invoke", gatewayOpts, {
                                nodeId: nodeId,
                    ...
                    case 17:
                        ...
                        quality = typeof params.quality === "number" && Number.isFinite(params.quality)
                            ? params.quality
                            : undefined;
                        delayMs = typeof params.delayMs === "number" && Number.isFinite(params.delayMs)
                            ? params.delayMs
                            : undefined;
                        deviceId = typeof params.deviceId === "string" && params.deviceId.trim()
                        ...
                        _l.label = 18;
                    case 18:
                        if (!(_i < facings_1.length)) return [3 /*break*/, 22];
                        facing = facings_1[_i];
                        return [4 /*yield*/, (0, gateway_js_1.callGatewayTool)("node.invoke", gatewayOpts, {
                                nodeId: nodeId,
                                command: "camera.snap",
                    ...
                    case 19:
                        raw = (_l.sent());
                        payload = (0, nodes_camera_js_1.parseCameraSnapPayload)(raw === null || raw === void 0 ? void 0 : raw.payload);
                    ...
                    case 20:
                        ...
                        content.push({
                            type: "image",
                            data: payload.base64,
                            mimeType: (_g = (0, mime_js_1.imageMimeFromFormat)(payload.format)) !== null && _g !== void 0 ? _g : (isJpeg ? "image/jpeg" : "image/png"),
                        });
                        details.push({
                            facing: facing,
                            path: filePath,
                    ...
                    case 22:
                        ...
                        return [4 /*yield*/, (0, tool_images_js_1.sanitizeToolResultImages)(result, "nodes:camera_snap")];
                    case 23: return [2 /*return*/, _l.sent()];
                    case 24:
                        node = (0, common_js_1.readStringParam)(params, "node", { required: true });
                        return [4 /*yield*/, (0, nodes_utils_js_1.resolveNodeId)(gatewayOpts, node)];
                    case 25:
                    ...
                    case 29:
                        raw = (_l.sent());
                        payload = (0, nodes_camera_js_1.parseCameraClipPayload)(raw === null || raw === void 0 ? void 0 : raw.payload);
                        filePath = (0, nodes_camera_js_1.cameraTempPath)({
                            kind: "clip",
                            facing: facing,
                            ext: payload.format,
                    ...
                    case 32:
                        ...
                        screenIndex = typeof params.screenIndex === "number" && Number.isFinite(params.screenIndex)
                            ? params.screenIndex
                            : 0;
                        includeAudio = typeof params.includeAudio === "boolean" ? params.includeAudio : true;
                        return [4 /*yield*/, (0, gateway_js_1.callGatewayTool)("node.invoke", gatewayOpts, {
                    ...
                    case 33:
                        raw = (_l.sent());
                        payload = (0, nodes_screen_js_1.parseScreenRecordPayload)(raw === null || raw === void 0 ? void 0 : raw.payload);
                        filePath = typeof params.outPath === "string" && params.outPath.trim()
                            ? params.outPath.trim()
                            : (0, nodes_screen_js_1.screenRecordTempPath)({ ext: payload.format || "mp4" });
                        return [4 /*yield*/, (0, nodes_screen_js_1.writeScreenRecordToFile)(filePath, payload.base64)];
                    case 34:
                        written = _l.sent();
                        return [2 /*return*/, {
                    ...
                    case 36:
                        nodeId = _l.sent();
                        maxAgeMs = typeof params.maxAgeMs === "number" && Number.isFinite(params.maxAgeMs)
                            ? params.maxAgeMs
                            : undefined;
                        desiredAccuracy = params.desiredAccuracy === "coarse" ||
                            params.desiredAccuracy === "balanced" ||
                            params.desiredAccuracy === "precise"
                            ? params.desiredAccuracy
                            : undefined;
                        locationTimeoutMs = typeof params.locationTimeoutMs === "number" &&
                    ...
                    case 37:
                        raw = (_l.sent());
                        return [2 /*return*/, (0, common_js_1.jsonResult)((_h = raw === null || raw === void 0 ? void 0 : raw.payload) !== null && _h !== void 0 ? _h : {})];
                    case 38:
                        node = (0, common_js_1.readStringParam)(params, "node", { required: true });
                    ...
                    case 39:
                        ...
                        supportsSystemRun = Array.isArray(nodeInfo === null || nodeInfo === void 0 ? void 0 : nodeInfo.commands)
                            ? (_j = nodeInfo === null || nodeInfo === void 0 ? void 0 : nodeInfo.commands) === null || _j === void 0 ? void 0 : _j.includes("system.run")
                            : false;
                        ...
                        command = commandRaw.map(function (c) { return String(c); });
                        if (command.length === 0) {
                        ...
                        needsScreenRecording = typeof params.needsScreenRecording === "boolean"
                    ...
                    case 40:
                        raw = (_l.sent());
                        return [2 /*return*/, (0, common_js_1.jsonResult)((_k = raw === null || raw === void 0 ? void 0 : raw.payload) !== null && _k !== void 0 ? _k : {})];
                    case 41: throw new Error("Unknown action: ".concat(action));
                    case 42: return [3 /*break*/, 44];
                    case 43:
                        err_1 = _l.sent();
                        nodeLabel = typeof params.node === "string" && params.node.trim() ? params.node.trim() : "auto";
                        gatewayLabel = gatewayOpts.gatewayUrl && gatewayOpts.gatewayUrl.trim()
                        ...
                        throw new Error("agent=".concat(agentLabel, " node=").concat(nodeLabel, " gateway=").concat(gatewayLabel, " action=").concat(action, ": ").concat(message));
