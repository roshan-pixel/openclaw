...
function createMemorySearchTool(options) {
    ...
    return {
        ...
        execute: function (_toolCallId, params) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (!manager) {
                            return [2 /*return*/, (0, common_js_1.jsonResult)({ results: [], disabled: true, error: error })];
                        }
                        _b.label = 2;
                    case 2:
                        _b.trys.push([2, 4, , 5]);
                    ...
                    case 4:
                        ...
                        return [2 /*return*/, (0, common_js_1.jsonResult)({ results: [], disabled: true, error: message })];
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a = _b.sent(), manager = _a.manager, error = _a.error;
                        if (!manager) {
                            return [2 /*return*/, (0, common_js_1.jsonResult)({ path: relPath, text: "", disabled: true, error: error })];
                        }
                        _b.label = 2;
                    case 2:
                        _b.trys.push([2, 4, , 5]);
                        return [4 /*yield*/, manager.readFile({
                                relPath: relPath,
                    ...
                    case 4:
                        ...
                        return [2 /*return*/, (0, common_js_1.jsonResult)({ path: relPath, text: "", disabled: true, error: message })];
                    case 5: return [2 /*return*/];
                }
            });
        }); },
