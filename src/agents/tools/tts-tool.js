...
var TtsToolSchema = typebox_1.Type.Object({
    ...
    channel: typebox_1.Type.Optional(typebox_1.Type.String({ description: "Optional channel id to pick output format (e.g. telegram)." })),
});
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        cfg = (_a = opts === null || opts === void 0 ? void 0 : opts.config) !== null && _a !== void 0 ? _a : (0, config_js_1.loadConfig)();
                        return [4 /*yield*/, (0, tts_js_1.textToSpeech)({
                                text: text,
                                cfg: cfg,
                                channel: channel !== null && channel !== void 0 ? channel : opts === null || opts === void 0 ? void 0 : opts.agentChannel,
                            })];
                    case 1:
                        result = _c.sent();
                        ...
                        return [2 /*return*/, {
                                content: [
                                    {
                                        type: "text",
                                        text: (_b = result.error) !== null && _b !== void 0 ? _b : "TTS conversion failed",
                                    },
                                ],
