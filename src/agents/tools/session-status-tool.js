...
function resolveModelAuthLabel(params) {
    ...
    var profileOverride = (_c = (_b = params.sessionEntry) === null || _b === void 0 ? void 0 : _b.authProfileOverride) === null || _c === void 0 ? void 0 : _c.trim();
    ...
    for (var _i = 0, candidates_1 = candidates; _i < candidates_1.length; _i++) {
        ...
        if (!profile || (0, model_selection_js_1.normalizeProviderId)(profile.provider) !== providerKey) {
            continue;
        }
        ...
        if (profile.type === "token") {
            return "token ".concat(formatApiKeySnippet(profile.token)).concat(label ? " (".concat(label, ")") : "");
        }
        return "api-key ".concat(formatApiKeySnippet(profile.key)).concat(label ? " (".concat(label, ")") : "");
    }
...
function resolveSessionEntry(params) {
    ...
    if (keyRaw === "main") {
        candidates.add((0, session_key_js_1.buildAgentMainSessionKey)({
...
function resolveModelOverride(params) {
    return __awaiter(this, void 0, void 0, function () {
        var raw, configDefault, currentProvider, currentModel, aliasIndex, catalog, allowed, resolved, key, isDefault;
        var _a, _b, _c, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    ...
                    currentProvider = ((_b = (_a = params.sessionEntry) === null || _a === void 0 ? void 0 : _a.providerOverride) === null || _b === void 0 ? void 0 : _b.trim()) || configDefault.provider;
                    currentModel = ((_d = (_c = params.sessionEntry) === null || _c === void 0 ? void 0 : _c.modelOverride) === null || _d === void 0 ? void 0 : _d.trim()) || configDefault.model;
                ...
                case 1:
                    ...
                    isDefault = resolved.ref.provider === configDefault.provider && resolved.ref.model === configDefault.model;
                    return [2 /*return*/, {
                            kind: "set",
...
function createSessionStatusTool(opts) {
    ...
    return {
        ...
        execute: function (_toolCallId, args) { return __awaiter(_this, void 0, void 0, function () {
            var params, cfg, _a, mainKey, alias, a2aPolicy, requestedKeyParam, requestedKeyRaw, requesterAgentId, ensureAgentAccess, isExplicitAgentKey, agentId, storePath, store, resolved, resolvedKey, kind, configured, modelRaw, changedModel, selection, nextEntry_1, applied, agentDir, providerForCard, usageProvider, usageLine, usageSummary, snapshot, formatted, _b, isGroup, groupActivation, queueSettings, queueKey, queueDepth, queueOverrides, userTimezone, userTimeFormat, userTime, timeLine, agentDefaults, defaultLabel, agentModel, statusText;
            var _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s, _t, _u;
            return __generator(this, function (_v) {
                switch (_v.label) {
                    case 0:
                        params = args;
                        cfg = (_c = opts === null || opts === void 0 ? void 0 : opts.config) !== null && _c !== void 0 ? _c : (0, config_js_1.loadConfig)();
                        _a = (0, sessions_helpers_js_1.resolveMainSessionAlias)(cfg), mainKey = _a.mainKey, alias = _a.alias;
                        ...
                        requestedKeyRaw = requestedKeyParam !== null && requestedKeyParam !== void 0 ? requestedKeyParam : opts === null || opts === void 0 ? void 0 : opts.agentSessionKey;
                        if (!(requestedKeyRaw === null || requestedKeyRaw === void 0 ? void 0 : requestedKeyRaw.trim())) {
                            throw new Error("sessionKey required");
                        }
                        requesterAgentId = (0, session_key_js_1.resolveAgentIdFromSessionKey)((_d = opts === null || opts === void 0 ? void 0 : opts.agentSessionKey) !== null && _d !== void 0 ? _d : requestedKeyRaw);
                        ...
                        if (requestedKeyRaw.startsWith("agent:")) {
                            ensureAgentAccess((0, session_key_js_1.resolveAgentIdFromSessionKey)(requestedKeyRaw));
                        }
                        ...
                        agentId = isExplicitAgentKey
                            ...
                            : requesterAgentId;
                        storePath = (0, sessions_js_1.resolveStorePath)((_e = cfg.session) === null || _e === void 0 ? void 0 : _e.store, { agentId: agentId });
                        ...
                        if (!resolved && (0, sessions_helpers_js_1.shouldResolveSessionIdInput)(requestedKeyRaw)) {
                            ...
                            if (resolvedKey) {
                                ...
                                ensureAgentAccess((0, session_key_js_1.resolveAgentIdFromSessionKey)(resolvedKey));
                                requestedKeyRaw = resolvedKey;
                                agentId = (0, session_key_js_1.resolveAgentIdFromSessionKey)(resolvedKey);
                                storePath = (0, sessions_js_1.resolveStorePath)((_f = cfg.session) === null || _f === void 0 ? void 0 : _f.store, { agentId: agentId });
                                store = (0, sessions_js_1.loadSessionStore)(storePath);
                                resolved = resolveSessionEntry({
                                    store: store,
                                    keyRaw: requestedKeyRaw,
                        ...
                        if (!resolved) {
                            kind = (0, sessions_helpers_js_1.shouldResolveSessionIdInput)(requestedKeyRaw) ? "sessionId" : "sessionKey";
                            throw new Error("Unknown ".concat(kind, ": ").concat(requestedKeyRaw));
                        }
                        configured = (0, model_selection_js_1.resolveDefaultModelForAgent)({ cfg: cfg, agentId: agentId });
                        modelRaw = (0, common_js_1.readStringParam)(params, "model");
                        changedModel = false;
                        if (!(typeof modelRaw === "string")) return [3 /*break*/, 3];
                        return [4 /*yield*/, resolveModelOverride({
                                cfg: cfg,
                                raw: modelRaw,
                    ...
                    case 1:
                        ...
                        if (!applied.updated) return [3 /*break*/, 3];
                    ...
                    case 3:
                        ...
                        providerForCard = ((_g = resolved.entry.providerOverride) === null || _g === void 0 ? void 0 : _g.trim()) || configured.provider;
                        usageProvider = (0, provider_usage_js_1.resolveUsageProviderId)(providerForCard);
                        if (!usageProvider) return [3 /*break*/, 7];
                        _v.label = 4;
                    case 4:
                        _v.trys.push([4, 6, , 7]);
                    ...
                    case 5:
                        ...
                        snapshot = usageSummary.providers.find(function (entry) { return entry.provider === usageProvider; });
                        if (snapshot) {
                    ...
                    case 6:
                        ...
                        return [3 /*break*/, 7];
                    case 7:
                        isGroup = resolved.entry.chatType === "group" ||
                            resolved.entry.chatType === "channel" ||
                            resolved.key.includes(":group:") ||
                            resolved.key.includes(":channel:");
                        groupActivation = isGroup
                            ? ((_h = (0, group_activation_js_1.normalizeGroupActivation)(resolved.entry.groupActivation)) !== null && _h !== void 0 ? _h : "mention")
                            : undefined;
                        queueSettings = (0, queue_js_1.resolveQueueSettings)({
                            cfg: cfg,
                            channel: (_k = (_j = resolved.entry.channel) !== null && _j !== void 0 ? _j : resolved.entry.lastChannel) !== null && _k !== void 0 ? _k : "unknown",
                            sessionEntry: resolved.entry,
                        });
                        queueKey = (_l = resolved.key) !== null && _l !== void 0 ? _l : resolved.entry.sessionId;
                        queueDepth = queueKey ? (0, queue_js_1.getFollowupQueueDepth)(queueKey) : 0;
                        queueOverrides = Boolean((_o = (_m = resolved.entry.queueDebounceMs) !== null && _m !== void 0 ? _m : resolved.entry.queueCap) !== null && _o !== void 0 ? _o : resolved.entry.queueDrop);
                        userTimezone = (0, date_time_js_1.resolveUserTimezone)((_q = (_p = cfg.agents) === null || _p === void 0 ? void 0 : _p.defaults) === null || _q === void 0 ? void 0 : _q.userTimezone);
                        userTimeFormat = (0, date_time_js_1.resolveUserTimeFormat)((_s = (_r = cfg.agents) === null || _r === void 0 ? void 0 : _r.defaults) === null || _s === void 0 ? void 0 : _s.timeFormat);
                        ...
                        agentDefaults = (_u = (_t = cfg.agents) === null || _t === void 0 ? void 0 : _t.defaults) !== null && _u !== void 0 ? _u : {};
                        defaultLabel = "".concat(configured.provider, "/").concat(configured.model);
                        agentModel = typeof agentDefaults.model === "object" && agentDefaults.model
                            ? __assign(__assign({}, agentDefaults.model), { primary: defaultLabel }) : { primary: defaultLabel };
