...
function hasAuthForProvider(params) {
    var _a;
    if ((_a = (0, model_auth_js_1.resolveEnvApiKey)(params.provider)) === null || _a === void 0 ? void 0 : _a.apiKey)
        return true;
...
function resolveImageModelConfigForTool(params) {
    ...
    if (((_a = explicit.primary) === null || _a === void 0 ? void 0 : _a.trim()) || ((_c = (_b = explicit.fallbacks) === null || _b === void 0 ? void 0 : _b.length) !== null && _c !== void 0 ? _c : 0) > 0) {
        return explicit;
    }
    ...
    if (preferred === null || preferred === void 0 ? void 0 : preferred.trim()) {
        ...
        var pruned = fallbacks.filter(function (ref) { return ref !== preferred; });
    ...
    if (openaiOk) {
        if (anthropicOk)
            addFallback("anthropic/claude-opus-4-5");
        return __assign({ primary: "openai/gpt-5-mini" }, (fallbacks.length ? { fallbacks: fallbacks } : {}));
    }
    if (anthropicOk) {
...
function pickMaxBytes(cfg, maxBytesMb) {
    ...
    var configured = (_b = (_a = cfg === null || cfg === void 0 ? void 0 : cfg.agents) === null || _a === void 0 ? void 0 : _a.defaults) === null || _b === void 0 ? void 0 : _b.mediaMaxMb;
...
function resolveSandboxedImagePath(params) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    normalize = function (p) { return (p.startsWith("file://") ? p.slice("file://".length) : p); };
                    filePath = normalize(params.imagePath);
                    _b.label = 1;
                case 1:
                    _b.trys.push([1, 3, , 9]);
                    return [4 /*yield*/, (0, sandbox_paths_js_1.assertSandboxPath)({
                            filePath: filePath,
                ...
                case 6:
                    _a = _b.sent();
                    throw err_1;
                case 7: return [4 /*yield*/, (0, sandbox_paths_js_1.assertSandboxPath)({
            ...
            switch (_b.label) {
                case 0:
                    effectiveCfg = params.cfg
                        ? __assign(__assign({}, params.cfg), { agents: __assign(__assign({}, params.cfg.agents), { defaults: __assign(__assign({}, (_a = params.cfg.agents) === null || _a === void 0 ? void 0 : _a.defaults), { imageModel: params.imageModelConfig }) }) }) : undefined;
                    return [4 /*yield*/, (0, models_config_js_1.ensureOpenClawModelsJson)(effectiveCfg, params.agentDir)];
                case 1:
                    _b.sent();
                    ...
                    return [4 /*yield*/, (0, model_fallback_js_1.runWithImageModelFallback)({
                            cfg: effectiveCfg,
                            modelOverride: params.modelOverride,
                            run: function (provider, modelId) { return __awaiter(_this, void 0, void 0, function () {
                                    ...
                                    switch (_b.label) {
                                        case 0:
                                            ...
                                            if (!((_a = model.input) === null || _a === void 0 ? void 0 : _a.includes("image"))) {
                                                throw new Error("Model does not support images: ".concat(provider, "/").concat(modelId));
                                            }
                                        ...
                                        case 1:
                                            ...
                                            imageDataUrl = "data:".concat(params.mimeType, ";base64,").concat(params.base64);
                                            if (!(model.provider === "minimax")) return [3 /*break*/, 3];
                                            return [4 /*yield*/, (0, minimax_vlm_js_1.minimaxUnderstandImage)({
                                                    apiKey: apiKey,
                                        ...
                                        case 2:
                                            text_1 = _b.sent();
                                            return [2 /*return*/, { text: text_1, provider: model.provider, model: model.id }];
                                        case 3:
                                        ...
                                        case 4:
                                            ...
                                            return [2 /*return*/, { text: text, provider: model.provider, model: model.id }];
                                    }
                                });
                            }); },
                        })];
                case 2:
                    ...
                    return [2 /*return*/, {
                            ...
                            attempts: result.attempts.map(function (attempt) { return ({
...
function createImageTool(options) {
    var _this = this;
    var _a, _b, _c, _d;
    var agentDir = (_a = options === null || options === void 0 ? void 0 : options.agentDir) === null || _a === void 0 ? void 0 : _a.trim();
    if (!agentDir) {
        var explicit = (0, image_tool_helpers_js_1.coerceImageModelConfig)(options === null || options === void 0 ? void 0 : options.config);
        if (((_b = explicit.primary) === null || _b === void 0 ? void 0 : _b.trim()) || ((_d = (_c = explicit.fallbacks) === null || _c === void 0 ? void 0 : _c.length) !== null && _d !== void 0 ? _d : 0) > 0) {
    ...
    return {
        ...
        execute: function (_toolCallId, args) { return __awaiter(_this, void 0, void 0, function () {
            var record, imageRawInput, imageRaw, looksLikeWindowsDrivePath, hasScheme, isFileUrl, isHttpUrl, isDataUrl, promptRaw, modelOverride, maxBytesMb, maxBytes, sandboxRoot, isUrl, resolvedImage, resolvedPathInfo, _a, _b, resolvedPath, media, _c, mimeType, base64, result;
            var _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        if (hasScheme && !looksLikeWindowsDrivePath && !isFileUrl && !isHttpUrl && !isDataUrl) {
                            return [2 /*return*/, {
                                    content: [
                                        {
                                            type: "text",
                                            text: "Unsupported image reference: ".concat(imageRawInput, ". Use a file path, a file:// URL, a data: URL, or an http(s) URL."),
                                        },
                                    ],
                                    details: {
                        ...
                        promptRaw = typeof record.prompt === "string" && record.prompt.trim()
                            ? record.prompt.trim()
                            : DEFAULT_PROMPT;
                        modelOverride = typeof record.model === "string" && record.model.trim() ? record.model.trim() : undefined;
                        maxBytesMb = typeof record.maxBytesMb === "number" ? record.maxBytesMb : undefined;
                        maxBytes = pickMaxBytes(options === null || options === void 0 ? void 0 : options.config, maxBytesMb);
                        sandboxRoot = (_d = options === null || options === void 0 ? void 0 : options.sandboxRoot) === null || _d === void 0 ? void 0 : _d.trim();
                        isUrl = isHttpUrl;
                        ...
                        if (!isDataUrl) return [3 /*break*/, 1];
                        _a = { resolved: "" };
                        return [3 /*break*/, 5];
                    case 1:
                        if (!sandboxRoot) return [3 /*break*/, 3];
                        return [4 /*yield*/, resolveSandboxedImagePath({
                    ...
                    case 5:
                        ...
                        if (!isDataUrl) return [3 /*break*/, 6];
                        _c = (0, image_tool_helpers_js_1.decodeDataUrl)(resolvedImage);
                        return [3 /*break*/, 8];
                    case 6: return [4 /*yield*/, (0, media_js_1.loadWebMedia)(resolvedPath !== null && resolvedPath !== void 0 ? resolvedPath : resolvedImage, maxBytes)];
                    case 7:
                        _c = _e.sent();
                        _e.label = 8;
                    case 8:
                        ...
                        mimeType = ("contentType" in media && media.contentType) ||
                            ("mimeType" in media && media.mimeType) ||
                            "image/png";
                        base64 = media.buffer.toString("base64");
                        return [4 /*yield*/, runImagePrompt({
                                cfg: options === null || options === void 0 ? void 0 : options.config,
                                agentDir: agentDir,
                    ...
                    case 9:
                        ...
                        return [2 /*return*/, {
                                ...
                                details: __assign(__assign({ model: "".concat(result.provider, "/").concat(result.model), image: resolvedImage }, (resolvedPathInfo.rewrittenFrom
