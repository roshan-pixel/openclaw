...
function readStringParam(params, key, options) {
    ...
    var _a = options.required, required = _a === void 0 ? false : _a, _b = options.trim, trim = _b === void 0 ? true : _b, _c = options.label, label = _c === void 0 ? key : _c, _d = options.allowEmpty, allowEmpty = _d === void 0 ? false : _d;
    var raw = params[key];
...
function readStringOrNumberParam(params, key, options) {
    if (options === void 0) { options = {}; }
    var _a = options.required, required = _a === void 0 ? false : _a, _b = options.label, label = _b === void 0 ? key : _b;
    var raw = params[key];
...
function readNumberParam(params, key, options) {
    if (options === void 0) { options = {}; }
    var _a = options.required, required = _a === void 0 ? false : _a, _b = options.label, label = _b === void 0 ? key : _b, _c = options.integer, integer = _c === void 0 ? false : _c;
    var raw = params[key];
    var value;
    if (typeof raw === "number" && Number.isFinite(raw)) {
        value = raw;
            ...
            switch (_b.label) {
                case 0:
                    content = [
                        {
                            type: "text",
                            text: (_a = params.extraText) !== null && _a !== void 0 ? _a : "MEDIA:".concat(params.path),
                        },
                        {
                            type: "image",
                            data: params.base64,
                    ...
                    return [4 /*yield*/, (0, tool_images_js_1.sanitizeToolResultImages)(result, params.label)];
