        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    return [2 /*return*/, paired.map(function (n) { return ({
                            nodeId: n.nodeId,
...
function pickDefaultNode(nodes) {
    ...
    if (withCanvas.length === 0)
        return null;
    var connected = withCanvas.filter(function (n) { return n.connected; });
    var candidates = connected.length > 0 ? connected : withCanvas;
    if (candidates.length === 1)
        return candidates[0];
    var local = candidates.filter(function (n) {
        var _a;
        return ((_a = n.platform) === null || _a === void 0 ? void 0 : _a.toLowerCase().startsWith("mac")) &&
...
function resolveNodeId(opts_1, query_1) {
    return __awaiter(this, arguments, void 0, function (opts, query, allowDefault) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, loadNodes(opts)];
                case 1:
                    nodes = _a.sent();
