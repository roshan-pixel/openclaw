...
var WebSearchSchema = typebox_1.Type.Object({
    ...
    search_lang: typebox_1.Type.Optional(typebox_1.Type.String({
        description: "ISO language code for search results (e.g., 'de', 'en', 'fr').",
    })),
    ui_lang: typebox_1.Type.Optional(typebox_1.Type.String({
        description: "ISO language code for UI elements.",
    })),
    freshness: typebox_1.Type.Optional(typebox_1.Type.String({
...
function resolveSearchConfig(cfg) {
    var _a, _b;
    var search = (_b = (_a = cfg === null || cfg === void 0 ? void 0 : cfg.tools) === null || _a === void 0 ? void 0 : _a.web) === null || _b === void 0 ? void 0 : _b.search;
...
function resolveSearchApiKey(search) {
    var _a;
    var fromConfig = search && "apiKey" in search && typeof search.apiKey === "string" ? search.apiKey.trim() : "";
...
function missingSearchKeyPayload(provider) {
    ...
    return {
        ...
        message: "web_search needs a Brave Search API key. Run `".concat((0, command_format_js_1.formatCliCommand)("openclaw configure --section web"), "` to store it, or set BRAVE_API_KEY in the Gateway environment."),
        docs: "https://docs.openclaw.ai/tools/web",
    };
}
function resolveSearchProvider(search) {
    var raw = search && "provider" in search && typeof search.provider === "string"
...
function resolvePerplexityApiKey(perplexity) {
    var fromConfig = normalizeApiKey(perplexity === null || perplexity === void 0 ? void 0 : perplexity.apiKey);
    if (fromConfig) {
...
function inferPerplexityBaseUrlFromApiKey(apiKey) {
    ...
    if (PERPLEXITY_KEY_PREFIXES.some(function (prefix) { return normalized.startsWith(prefix); })) {
        return "direct";
    }
    if (OPENROUTER_KEY_PREFIXES.some(function (prefix) { return normalized.startsWith(prefix); })) {
        return "openrouter";
    }
    return undefined;
}
function resolvePerplexityBaseUrl(perplexity, apiKeySource, apiKey) {
    if (apiKeySource === void 0) { apiKeySource = "none"; }
    var fromConfig = perplexity && "baseUrl" in perplexity && typeof perplexity.baseUrl === "string"
...
function resolvePerplexityModel(perplexity) {
    var fromConfig = perplexity && "model" in perplexity && typeof perplexity.model === "string"
...
function isValidIsoDate(value) {
    if (!/^\d{4}-\d{2}-\d{2}$/.test(value))
        return false;
    var _a = value.split("-").map(function (part) { return Number.parseInt(part, 10); }), year = _a[0], month = _a[1], day = _a[2];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 2:
                    detail = _f.sent();
                    throw new Error("Perplexity API error (".concat(res.status, "): ").concat(detail || res.statusText));
                case 3: return [4 /*yield*/, res.json()];
                case 4:
                    data = (_f.sent());
                    content = (_d = (_c = (_b = (_a = data.choices) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.message) === null || _c === void 0 ? void 0 : _c.content) !== null && _d !== void 0 ? _d : "No response";
...
function runWebSearch(params) {
    return __awaiter(this, void 0, void 0, function () {
        var cacheKey, cached, start, _a, content, citations, payload_1, url, res, detail, data, results, mapped, payload;
        var _b, _c, _d, _e, _f, _g;
        return __generator(this, function (_h) {
            switch (_h.label) {
                case 0:
                    cacheKey = (0, web_shared_js_1.normalizeCacheKey)(params.provider === "brave"
                        ? "".concat(params.provider, ":").concat(params.query, ":").concat(params.count, ":").concat(params.country || "default", ":").concat(params.search_lang || "default", ":").concat(params.ui_lang || "default", ":").concat(params.freshness || "default")
                        : "".concat(params.provider, ":").concat(params.query, ":").concat(params.count, ":").concat(params.country || "default", ":").concat(params.search_lang || "default", ":").concat(params.ui_lang || "default"));
                    cached = (0, web_shared_js_1.readCache)(SEARCH_CACHE, cacheKey);
                    if (cached)
                        return [2 /*return*/, __assign(__assign({}, cached.value), { cached: true })];
                    start = Date.now();
                    if (!(params.provider === "perplexity")) return [3 /*break*/, 2];
                    return [4 /*yield*/, runPerplexitySearch({
                            query: params.query,
                            apiKey: params.apiKey,
                            baseUrl: (_b = params.perplexityBaseUrl) !== null && _b !== void 0 ? _b : DEFAULT_PERPLEXITY_BASE_URL,
                            model: (_c = params.perplexityModel) !== null && _c !== void 0 ? _c : DEFAULT_PERPLEXITY_MODEL,
                ...
                case 1:
                    ...
                    payload_1 = {
                        ...
                        model: (_d = params.perplexityModel) !== null && _d !== void 0 ? _d : DEFAULT_PERPLEXITY_MODEL,
                ...
                case 4:
                    detail = _h.sent();
                    throw new Error("Brave Search API error (".concat(res.status, "): ").concat(detail || res.statusText));
                case 5: return [4 /*yield*/, res.json()];
                case 6:
                    data = (_h.sent());
                    results = Array.isArray((_e = data.web) === null || _e === void 0 ? void 0 : _e.results) ? ((_g = (_f = data.web) === null || _f === void 0 ? void 0 : _f.results) !== null && _g !== void 0 ? _g : []) : [];
...
function createWebSearchTool(options) {
    var _this = this;
    var search = resolveSearchConfig(options === null || options === void 0 ? void 0 : options.config);
    if (!resolveSearchEnabled({ search: search, sandboxed: options === null || options === void 0 ? void 0 : options.sandboxed }))
        return null;
    ...
    return {
        ...
        execute: function (_toolCallId, args) { return __awaiter(_this, void 0, void 0, function () {
            var perplexityAuth, apiKey, params, query, count, country, search_lang, ui_lang, rawFreshness, freshness, result;
            var _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        perplexityAuth = provider === "perplexity" ? resolvePerplexityApiKey(perplexityConfig) : undefined;
                        apiKey = provider === "perplexity" ? perplexityAuth === null || perplexityAuth === void 0 ? void 0 : perplexityAuth.apiKey : resolveSearchApiKey(search);
                        if (!apiKey) {
                            return [2 /*return*/, (0, common_js_1.jsonResult)(missingSearchKeyPayload(provider))];
                        }
                        params = args;
                        query = (0, common_js_1.readStringParam)(params, "query", { required: true });
                        count = (_b = (_a = (0, common_js_1.readNumberParam)(params, "count", { integer: true })) !== null && _a !== void 0 ? _a : search === null || search === void 0 ? void 0 : search.maxResults) !== null && _b !== void 0 ? _b : undefined;
                        ...
                        return [4 /*yield*/, runWebSearch({
                                query: query,
                                count: resolveSearchCount(count, DEFAULT_SEARCH_COUNT),
                                apiKey: apiKey,
                                timeoutSeconds: (0, web_shared_js_1.resolveTimeoutSeconds)(search === null || search === void 0 ? void 0 : search.timeoutSeconds, web_shared_js_1.DEFAULT_TIMEOUT_SECONDS),
                                cacheTtlMs: (0, web_shared_js_1.resolveCacheTtlMs)(search === null || search === void 0 ? void 0 : search.cacheTtlMinutes, web_shared_js_1.DEFAULT_CACHE_TTL_MINUTES),
                                provider: provider,
                                country: country,
                                search_lang: search_lang,
                                ui_lang: ui_lang,
                                freshness: freshness,
                                perplexityBaseUrl: resolvePerplexityBaseUrl(perplexityConfig, perplexityAuth === null || perplexityAuth === void 0 ? void 0 : perplexityAuth.source, perplexityAuth === null || perplexityAuth === void 0 ? void 0 : perplexityAuth.apiKey),
