...
Object.defineProperty(exports, "ensureAuthProfileStore", { enumerable: true, get: function () { return auth_profiles_js_2.ensureAuthProfileStore; } });
Object.defineProperty(exports, "resolveAuthProfileOrder", { enumerable: true, get: function () { return auth_profiles_js_2.resolveAuthProfileOrder; } });
...
function resolveProviderConfig(cfg, provider) {
    var _a, _b, _c, _d;
    var providers = (_b = (_a = cfg === null || cfg === void 0 ? void 0 : cfg.models) === null || _a === void 0 ? void 0 : _a.providers) !== null && _b !== void 0 ? _b : {};
    ...
    return ((_c = providers[normalized]) !== null && _c !== void 0 ? _c : (_d = Object.entries(providers).find(function (_a) {
        var key = _a[0];
        return (0, model_selection_js_1.normalizeProviderId)(key) === normalized;
...
function getCustomProviderApiKey(cfg, provider) {
    ...
    var key = (_a = entry === null || entry === void 0 ? void 0 : entry.apiKey) === null || _a === void 0 ? void 0 : _a.trim();
...
function resolveEnvSourceLabel(params) {
    var shellApplied = params.envVars.some(function (envVar) { return params.applied.has(envVar); });
...
function resolveAwsSdkEnvVarName(env) {
    ...
    if (((_b = env[AWS_ACCESS_KEY_ENV]) === null || _b === void 0 ? void 0 : _b.trim()) && ((_c = env[AWS_SECRET_KEY_ENV]) === null || _c === void 0 ? void 0 : _c.trim())) {
...
function resolveAwsSdkAuthInfo() {
    ...
    if (((_b = process.env[AWS_ACCESS_KEY_ENV]) === null || _b === void 0 ? void 0 : _b.trim()) && ((_c = process.env[AWS_SECRET_KEY_ENV]) === null || _c === void 0 ? void 0 : _c.trim())) {
        return {
            mode: "aws-sdk",
            source: resolveEnvSourceLabel({
                applied: applied,
...
function resolveApiKeyForProvider(params) {
    return __awaiter(this, void 0, void 0, function () {
        var provider, cfg, profileId, preferredProfile, store, resolved, mode, authOverride, order, _i, order_1, candidate, resolved, mode, _a, envResolved, customKey, normalized, hasCodex, authStorePath, resolvedAgentDir;
        var _b, _c, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    provider = params.provider, cfg = params.cfg, profileId = params.profileId, preferredProfile = params.preferredProfile;
                    store = (_b = params.store) !== null && _b !== void 0 ? _b : (0, auth_profiles_js_1.ensureAuthProfileStore)(params.agentDir);
                ...
                case 2:
                    ...
                    _e.label = 3;
                case 3:
                    if (!(_i < order_1.length)) return [3 /*break*/, 8];
                ...
                case 8:
                    ...
                    throw new Error([
                        ...
                        "Configure auth for this agent (".concat((0, command_format_js_1.formatCliCommand)("openclaw agents add <id>"), ") or copy auth-profiles.json from the main agentDir."),
                    ].join(" "));
            }
        });
    });
...
function resolveEnvApiKey(provider) {
    ...
    if (normalized === "github-copilot") {
        return (_b = (_a = pick("COPILOT_GITHUB_TOKEN")) !== null && _a !== void 0 ? _a : pick("GH_TOKEN")) !== null && _b !== void 0 ? _b : pick("GITHUB_TOKEN");
    }
    if (normalized === "anthropic") {
        return (_c = pick("ANTHROPIC_OAUTH_TOKEN")) !== null && _c !== void 0 ? _c : pick("ANTHROPIC_API_KEY");
    }
    if (normalized === "chutes") {
        return (_d = pick("CHUTES_OAUTH_TOKEN")) !== null && _d !== void 0 ? _d : pick("CHUTES_API_KEY");
    }
    if (normalized === "zai") {
    ...
    if (normalized === "opencode") {
        return (_f = pick("OPENCODE_API_KEY")) !== null && _f !== void 0 ? _f : pick("OPENCODE_ZEN_API_KEY");
    }
    if (normalized === "qwen-portal") {
        return (_g = pick("QWEN_OAUTH_TOKEN")) !== null && _g !== void 0 ? _g : pick("QWEN_PORTAL_API_KEY");
    }
    var envMap = {
...
function resolveModelAuthMode(provider, cfg, store) {
    ...
    if (authOverride === "aws-sdk")
        return "aws-sdk";
    var authStore = store !== null && store !== void 0 ? store : (0, auth_profiles_js_1.ensureAuthProfileStore)();
    var profiles = (0, auth_profiles_js_1.listProfilesForProvider)(authStore, resolved);
    if (profiles.length > 0) {
        var modes_1 = new Set(profiles
            .map(function (id) { var _a; return (_a = authStore.profiles[id]) === null || _a === void 0 ? void 0 : _a.type; })
            .filter(function (mode) { return Boolean(mode); }));
    ...
    if (authOverride === undefined && (0, model_selection_js_1.normalizeProviderId)(resolved) === "amazon-bedrock") {
        return "aws-sdk";
    }
...
function getApiKeyForModel(params) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, resolveApiKeyForProvider({
...
function requireApiKey(auth, provider) {
    ...
    if (key)
        return key;
    throw new Error("No API key resolved for provider \"".concat(provider, "\" (auth mode: ").concat(auth.mode, ")."));
}
