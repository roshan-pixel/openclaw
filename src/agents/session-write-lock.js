...
function releaseAllLocksSync() {
    for (var _i = 0, HELD_LOCKS_1 = HELD_LOCKS; _i < HELD_LOCKS_1.length; _i++) {
        var _a = HELD_LOCKS_1[_i], sessionFile = _a[0], held = _a[1];
        try {
...
function registerCleanupHandlers() {
    ...
    var _loop_1 = function (signal) {
        try {
            var handler = function () { return handleTerminationSignal(signal); };
...
function acquireSessionWriteLock(params) {
    return __awaiter(this, void 0, void 0, function () {
        var timeoutMs, staleMs, sessionFile, sessionDir, normalizedDir, _a, normalizedSessionFile, lockPath, held, startedAt, attempt, _loop_2, state_1, payload, owner;
        var _this = this;
        var _b, _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 4:
                    ...
                    return [3 /*break*/, 5];
                case 5:
                    normalizedSessionFile = node_path_1.default.join(normalizedDir, node_path_1.default.basename(sessionFile));
                                ...
                                release: function () { return __awaiter(_this, void 0, void 0, function () {
                                    ...
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            ...
                                            case 1:
                                                _a.sent();
                                                return [4 /*yield*/, promises_1.default.rm(current.lockPath, { force: true })];
                                            case 2:
                                                _a.sent();
                                                return [2 /*return*/];
                                        }
                    ...
                    _loop_2 = function () {
                        ...
                        return __generator(this, function (_e) {
                            switch (_e.label) {
                                ...
                                case 2:
                                    handle = _e.sent();
                                    return [4 /*yield*/, handle.writeFile(JSON.stringify({ pid: process.pid, createdAt: new Date().toISOString() }, null, 2), "utf8")];
                                case 3:
                                    _e.sent();
                                    HELD_LOCKS.set(normalizedSessionFile, { count: 1, handle: handle, lockPath: lockPath });
                                ...
                                case 5:
                                    payload_1 = _e.sent();
                                    createdAt = (payload_1 === null || payload_1 === void 0 ? void 0 : payload_1.createdAt) ? Date.parse(payload_1.createdAt) : NaN;
                                    stale = !Number.isFinite(createdAt) || Date.now() - createdAt > staleMs;
                                    alive = (payload_1 === null || payload_1 === void 0 ? void 0 : payload_1.pid) ? isAlive(payload_1.pid) : false;
                                    if (!(stale || !alive)) return [3 /*break*/, 7];
                    ...
                    _d.label = 6;
                case 6:
                    if (!(Date.now() - startedAt < timeoutMs)) return [3 /*break*/, 8];
                ...
                case 7:
                    ...
                    return [3 /*break*/, 6];
                case 8: return [4 /*yield*/, readLockPayload(lockPath)];
                case 9:
                    payload = _d.sent();
                    owner = (payload === null || payload === void 0 ? void 0 : payload.pid) ? "pid=".concat(payload.pid) : "unknown";
                    throw new Error("session file locked (timeout ".concat(timeoutMs, "ms): ").concat(owner, " ").concat(lockPath));
            }
        });
    });
}
