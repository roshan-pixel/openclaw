...
function rewriteToolResultIds(params) {
    var toolCallId = typeof params.message.toolCallId === "string" && params.message.toolCallId
    ...
    return __assign(__assign(__assign({}, params.message), (nextToolCallId && { toolCallId: nextToolCallId })), (nextToolUseId && { toolUseId: nextToolUseId }));
}
/**
