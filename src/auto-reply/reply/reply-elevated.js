...
var SENDER_PREFIXES = __spreadArray(__spreadArray([], registry_js_1.CHAT_CHANNEL_ORDER, true), [
...
function isApprovedElevatedSender(params) {
    var rawAllow = resolveElevatedAllowList(params.allowFrom, params.provider, params.fallbackAllowFrom);
    if (!rawAllow || rawAllow.length === 0)
        return false;
    var allowTokens = rawAllow.map(function (entry) { return String(entry).trim(); }).filter(Boolean);
    if (allowTokens.length === 0)
        return false;
    if (allowTokens.some(function (entry) { return entry === "*"; }))
        return true;
    var tokens = new Set();
...
function resolveElevatedPermissions(params) {
    ...
    var agentConfig = (_c = (_b = (0, agent_scope_js_1.resolveAgentConfig)(params.cfg, params.agentId)) === null || _b === void 0 ? void 0 : _b.tools) === null || _c === void 0 ? void 0 : _c.elevated;
    var globalEnabled = (globalConfig === null || globalConfig === void 0 ? void 0 : globalConfig.enabled) !== false;
    var agentEnabled = (agentConfig === null || agentConfig === void 0 ? void 0 : agentConfig.enabled) !== false;
    ...
    var dockFallbackAllowFrom = normalizedProvider
        ? (_f = (_e = (_d = (0, dock_js_1.getChannelDock)(normalizedProvider)) === null || _d === void 0 ? void 0 : _d.elevated) === null || _e === void 0 ? void 0 : _e.allowFromFallback) === null || _f === void 0 ? void 0 : _f.call(_e, {
            cfg: params.cfg,
    ...
    var agentAllowed = (agentConfig === null || agentConfig === void 0 ? void 0 : agentConfig.allowFrom)
