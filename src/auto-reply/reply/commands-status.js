...
function resolveModelAuthLabel(provider, cfg, sessionEntry, agentDir) {
    ...
    var profileOverride = (_a = sessionEntry === null || sessionEntry === void 0 ? void 0 : sessionEntry.authProfileOverride) === null || _a === void 0 ? void 0 : _a.trim();
...
function buildStatusReply(params) {
    return __awaiter(this, void 0, void 0, function () {
        var cfg, command, sessionEntry, sessionKey, sessionScope, provider, model, contextTokens, resolvedThinkLevel, resolvedVerboseLevel, resolvedReasoningLevel, resolvedElevatedLevel, resolveDefaultThinkingLevel, isGroup, defaultGroupActivation, statusAgentId, statusAgentDir, currentUsageProvider, usageLine, usageSummary, usageEntry, summaryLine, _a, queueSettings, queueKey, queueDepth, queueOverrides, subagentsLine, _b, mainKey, alias, requesterKey, runs, verboseEnabled, active, done, labels, labelText, groupActivation, agentDefaults, statusText, _c, _d;
        var _e;
        var _f, _g, _h, _j, _k;
        return __generator(this, function (_l) {
            switch (_l.label) {
                case 0:
                    cfg = params.cfg, command = params.command, sessionEntry = params.sessionEntry, sessionKey = params.sessionKey, sessionScope = params.sessionScope, provider = params.provider, model = params.model, contextTokens = params.contextTokens, resolvedThinkLevel = params.resolvedThinkLevel, resolvedVerboseLevel = params.resolvedVerboseLevel, resolvedReasoningLevel = params.resolvedReasoningLevel, resolvedElevatedLevel = params.resolvedElevatedLevel, resolveDefaultThinkingLevel = params.resolveDefaultThinkingLevel, isGroup = params.isGroup, defaultGroupActivation = params.defaultGroupActivation;
                    if (!command.isAuthorizedSender) {
                        (0, globals_js_1.logVerbose)("Ignoring /status from unauthorized sender: ".concat(command.senderId || "<unknown>"));
                    ...
                    usageLine = null;
                    if (!currentUsageProvider) return [3 /*break*/, 4];
                    _l.label = 1;
                case 1:
                    _l.trys.push([1, 3, , 4]);
                ...
                case 4:
                    ...
                    queueKey = sessionKey !== null && sessionKey !== void 0 ? sessionKey : sessionEntry === null || sessionEntry === void 0 ? void 0 : sessionEntry.sessionId;
                    queueDepth = queueKey ? (0, queue_js_1.getFollowupQueueDepth)(queueKey) : 0;
                    queueOverrides = Boolean((_g = (_f = sessionEntry === null || sessionEntry === void 0 ? void 0 : sessionEntry.queueDebounceMs) !== null && _f !== void 0 ? _f : sessionEntry === null || sessionEntry === void 0 ? void 0 : sessionEntry.queueCap) !== null && _g !== void 0 ? _g : sessionEntry === null || sessionEntry === void 0 ? void 0 : sessionEntry.queueDrop);
                    if (sessionKey) {
                        _b = (0, sessions_helpers_js_1.resolveMainSessionAlias)(cfg), mainKey = _b.mainKey, alias = _b.alias;
                        requesterKey = (0, sessions_helpers_js_1.resolveInternalSessionKey)({ key: sessionKey, alias: alias, mainKey: mainKey });
                        ...
                        if (runs.length > 0) {
                            active = runs.filter(function (entry) { return !entry.endedAt; });
                            done = runs.length - active.length;
                            if (verboseEnabled) {
                                labels = active
                                    .map(function (entry) { return (0, subagents_utils_js_1.resolveSubagentLabel)(entry, ""); })
                                    .filter(Boolean)
                                    .slice(0, 3);
                                labelText = labels.length ? " (".concat(labels.join(", "), ")") : "";
                                subagentsLine = "\uD83E\uDD16 Subagents: ".concat(active.length, " active").concat(labelText, " \u00B7 ").concat(done, " done");
                            }
                    ...
                    groupActivation = isGroup
                        ? ((_h = (0, group_activation_js_1.normalizeGroupActivation)(sessionEntry === null || sessionEntry === void 0 ? void 0 : sessionEntry.groupActivation)) !== null && _h !== void 0 ? _h : defaultGroupActivation())
                        : undefined;
                    agentDefaults = (_k = (_j = cfg.agents) === null || _j === void 0 ? void 0 : _j.defaults) !== null && _k !== void 0 ? _k : {};
                    _c = status_js_1.buildStatusMessage;
                    _e = {
                        config: cfg,
                        agent: __assign(__assign({}, agentDefaults), { model: __assign(__assign({}, agentDefaults.model), { primary: "".concat(provider, "/").concat(model) }), contextTokens: contextTokens, thinkingDefault: agentDefaults.thinkingDefault, verboseDefault: agentDefaults.verboseDefault, elevatedDefault: agentDefaults.elevatedDefault }),
                        sessionEntry: sessionEntry,
                        sessionKey: sessionKey,
                        sessionScope: sessionScope,
                        groupActivation: groupActivation
                    };
                    if (!(resolvedThinkLevel !== null && resolvedThinkLevel !== void 0)) return [3 /*break*/, 5];
                    _d = resolvedThinkLevel;
                    return [3 /*break*/, 7];
                case 5: return [4 /*yield*/, resolveDefaultThinkingLevel()];
                case 6:
                    _d = (_l.sent());
                    _l.label = 7;
                case 7:
                    statusText = _c.apply(void 0, [(_e.resolvedThink = _d,
