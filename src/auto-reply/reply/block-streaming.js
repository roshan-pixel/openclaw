...
function resolveBlockStreamingCoalescing(cfg, provider, accountId, chunking) {
    ...
    var providerDefaults = providerId
        ? (_d = (_c = (0, dock_js_1.getChannelDock)(providerId)) === null || _c === void 0 ? void 0 : _c.streaming) === null || _d === void 0 ? void 0 : _d.blockStreamingCoalesceDefaults
        : undefined;
    ...
    var coalesceCfg = providerCfg !== null && providerCfg !== void 0 ? providerCfg : (_f = (_e = cfg === null || cfg === void 0 ? void 0 : cfg.agents) === null || _e === void 0 ? void 0 : _e.defaults) === null || _f === void 0 ? void 0 : _f.blockStreamingCoalesce;
    var minRequested = Math.max(1, Math.floor((_j = (_h = (_g = coalesceCfg === null || coalesceCfg === void 0 ? void 0 : coalesceCfg.minChars) !== null && _g !== void 0 ? _g : providerDefaults === null || providerDefaults === void 0 ? void 0 : providerDefaults.minChars) !== null && _h !== void 0 ? _h : chunking === null || chunking === void 0 ? void 0 : chunking.minChars) !== null && _j !== void 0 ? _j : DEFAULT_BLOCK_STREAM_MIN));
    var maxRequested = Math.max(1, Math.floor((_k = coalesceCfg === null || coalesceCfg === void 0 ? void 0 : coalesceCfg.maxChars) !== null && _k !== void 0 ? _k : textLimit));
    var maxChars = Math.max(1, Math.min(maxRequested, textLimit));
    var minChars = Math.min(minRequested, maxChars);
    var idleMs = Math.max(0, Math.floor((_m = (_l = coalesceCfg === null || coalesceCfg === void 0 ? void 0 : coalesceCfg.idleMs) !== null && _l !== void 0 ? _l : providerDefaults === null || providerDefaults === void 0 ? void 0 : providerDefaults.idleMs) !== null && _m !== void 0 ? _m : DEFAULT_BLOCK_STREAM_COALESCE_IDLE_MS));
    var preference = (_o = chunking === null || chunking === void 0 ? void 0 : chunking.breakPreference) !== null && _o !== void 0 ? _o : "paragraph";
