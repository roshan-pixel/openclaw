...
function normalizeRequesterSessionKey(cfg, key) {
    ...
    if (!cleaned)
        return undefined;
    var _a = (0, sessions_helpers_js_1.resolveMainSessionAlias)(cfg), mainKey = _a.mainKey, alias = _a.alias;
    return (0, sessions_helpers_js_1.resolveInternalSessionKey)({ key: cleaned, alias: alias, mainKey: mainKey });
}
function stopSubagentsForRequester(params) {
    ...
    for (var _i = 0, runs_1 = runs; _i < runs_1.length; _i++) {
        ...
        var storePath = (0, sessions_js_1.resolveStorePath)((_b = params.cfg.session) === null || _b === void 0 ? void 0 : _b.store, { agentId: parsed === null || parsed === void 0 ? void 0 : parsed.agentId });
    ...
    if (stopped > 0) {
        (0, globals_js_1.logVerbose)("abort: stopped ".concat(stopped, " subagent run(s) for ").concat(requesterKey));
    }
    return { stopped: stopped };
}
function tryFastAbortFromMessage(params) {
    return __awaiter(this, void 0, void 0, function () {
        var ctx, cfg, targetKey, agentId, raw, isGroup, stripped, normalized, abortRequested, commandAuthorized, auth, abortKey, requesterSessionKey, storePath, store, _a, entry_1, key_1, sessionId, aborted, cleared, stopped_1, stopped;
            ...
            switch (_k.label) {
                case 0:
                    ...
                    agentId = (0, agent_scope_js_1.resolveSessionAgentId)({
                        sessionKey: (_b = targetKey !== null && targetKey !== void 0 ? targetKey : ctx.SessionKey) !== null && _b !== void 0 ? _b : "",
                        config: cfg,
                    });
                    raw = (0, mentions_js_1.stripStructuralPrefixes)((_e = (_d = (_c = ctx.CommandBody) !== null && _c !== void 0 ? _c : ctx.RawBody) !== null && _d !== void 0 ? _d : ctx.Body) !== null && _e !== void 0 ? _e : "");
                    isGroup = ((_f = ctx.ChatType) === null || _f === void 0 ? void 0 : _f.trim().toLowerCase()) === "group";
                    ...
                    if (!auth.isAuthorizedSender)
                        return [2 /*return*/, { handled: false, aborted: false }];
                    abortKey = (_g = targetKey !== null && targetKey !== void 0 ? targetKey : auth.from) !== null && _g !== void 0 ? _g : auth.to;
                    requesterSessionKey = (_h = targetKey !== null && targetKey !== void 0 ? targetKey : ctx.SessionKey) !== null && _h !== void 0 ? _h : abortKey;
                    if (!targetKey) return [3 /*break*/, 4];
                    storePath = (0, sessions_js_1.resolveStorePath)((_j = cfg.session) === null || _j === void 0 ? void 0 : _j.store, { agentId: agentId });
                    store = (0, sessions_js_1.loadSessionStore)(storePath);
                    _a = resolveSessionEntryForKey(store, targetKey), entry_1 = _a.entry, key_1 = _a.key;
                    ...
                    cleared = (0, queue_js_1.clearSessionQueues)([key_1 !== null && key_1 !== void 0 ? key_1 : targetKey, sessionId]);
                    if (cleared.followupCleared > 0 || cleared.laneCleared > 0) {
                        (0, globals_js_1.logVerbose)("abort: cleared followups=".concat(cleared.followupCleared, " lane=").concat(cleared.laneCleared, " keys=").concat(cleared.keys.join(",")));
                    }
                    if (!(entry_1 && key_1)) return [3 /*break*/, 2];
                ...
                case 2:
                    ...
                    _k.label = 3;
                case 3:
                    stopped_1 = stopSubagentsForRequester({ cfg: cfg, requesterSessionKey: requesterSessionKey }).stopped;
                    return [2 /*return*/, { handled: true, aborted: aborted, stoppedSubagents: stopped_1 }];
                case 4:
                    if (abortKey) {
                        setAbortMemory(abortKey, true);
                    }
                    stopped = stopSubagentsForRequester({ cfg: cfg, requesterSessionKey: requesterSessionKey }).stopped;
