...
function buildReplyPayloads(params) {
    ...
    var replyTaggedPayloads = (0, reply_payloads_js_1.applyReplyThreading)({
        ...
        var _a, _b, _c, _d, _e;
        var parsed = (0, reply_directives_js_1.parseReplyDirectives)((_a = payload.text) !== null && _a !== void 0 ? _a : "", {
            currentMessageId: params.currentMessageId,
            silentToken: tokens_js_1.SILENT_REPLY_TOKEN,
        });
        var mediaUrls = (_b = payload.mediaUrls) !== null && _b !== void 0 ? _b : parsed.mediaUrls;
        var mediaUrl = (_d = (_c = payload.mediaUrl) !== null && _c !== void 0 ? _c : parsed.mediaUrl) !== null && _d !== void 0 ? _d : mediaUrls === null || mediaUrls === void 0 ? void 0 : mediaUrls[0];
        return __assign(__assign({}, payload), { text: parsed.text ? parsed.text : undefined, mediaUrls: mediaUrls, mediaUrl: mediaUrl, replyToId: (_e = payload.replyToId) !== null && _e !== void 0 ? _e : parsed.replyToId, replyToTag: payload.replyToTag || parsed.replyToTag, replyToCurrent: payload.replyToCurrent || parsed.replyToCurrent, audioAsVoice: Boolean(payload.audioAsVoice || parsed.audioAsVoice) });
    })
        .filter(reply_payloads_js_1.isRenderablePayload);
    // Drop final payloads only when block streaming succeeded end-to-end.
    // If streaming aborted (e.g., timeout), fall back to final payloads.
    var shouldDropFinalPayloads = params.blockStreamingEnabled &&
    ...
    var messagingToolSentTexts = (_c = params.messagingToolSentTexts) !== null && _c !== void 0 ? _c : [];
    var messagingToolSentTargets = (_d = params.messagingToolSentTargets) !== null && _d !== void 0 ? _d : [];
    ...
    var filteredPayloads = shouldDropFinalPayloads
        ...
        : params.blockStreamingEnabled
            ? dedupedPayloads.filter(function (payload) { var _a; return !((_a = params.blockReplyPipeline) === null || _a === void 0 ? void 0 : _a.hasSentPayload(payload)); })
            : ((_e = params.directlySentBlockKeys) === null || _e === void 0 ? void 0 : _e.size)
                ? dedupedPayloads.filter(function (payload) { return !params.directlySentBlockKeys.has((0, block_reply_pipeline_js_1.createBlockReplyPayloadKey)(payload)); })
                : dedupedPayloads;
