...
var normalizeProvider = function (value) { return (value === null || value === void 0 ? void 0 : value.trim().toLowerCase()) || ""; };
var resolveInboundPeerId = function (ctx) { var _a, _b, _c; return (_c = (_b = (_a = ctx.OriginatingTo) !== null && _a !== void 0 ? _a : ctx.To) !== null && _b !== void 0 ? _b : ctx.From) !== null && _c !== void 0 ? _c : ctx.SessionKey; };
function buildInboundDedupeKey(ctx) {
    var _a, _b, _c, _d, _e, _f, _g;
    var provider = normalizeProvider((_b = (_a = ctx.OriginatingChannel) !== null && _a !== void 0 ? _a : ctx.Provider) !== null && _b !== void 0 ? _b : ctx.Surface);
    ...
    if (!peerId)
        return null;
    var sessionKey = (_e = (_d = ctx.SessionKey) === null || _d === void 0 ? void 0 : _d.trim()) !== null && _e !== void 0 ? _e : "";
    var accountId = (_g = (_f = ctx.AccountId) === null || _f === void 0 ? void 0 : _f.trim()) !== null && _g !== void 0 ? _g : "";
    var threadId = ctx.MessageThreadId !== undefined && ctx.MessageThreadId !== null
...
function shouldSkipDuplicateInbound(ctx, opts) {
    ...
    if (!key)
        return false;
    var cache = (_a = opts === null || opts === void 0 ? void 0 : opts.cache) !== null && _a !== void 0 ? _a : inboundDedupeCache;
