...
function resolveModelsCommandReply(params) {
    return __awaiter(this, void 0, void 0, function () {
        var body, argText, _a, provider, page, pageSize, all, resolvedDefault, catalog, allowed, aliasIndex, byProvider, add, addRawModelRef, addModelConfigEntries, _i, _b, entry, _c, _d, raw, providers, lines_1, lines_2, models, total, lines_3, effectivePageSize, pageCount, safePage, lines_4, startIndex, endIndexExclusive, pageModels, header, lines, _e, pageModels_1, id, payload;
        var _f, _g, _h, _j;
        return __generator(this, function (_k) {
            switch (_k.label) {
                case 0:
                    ...
                    _a = parseModelsArgs(argText), provider = _a.provider, page = _a.page, pageSize = _a.pageSize, all = _a.all;
                ...
                case 1:
                    ...
                    addModelConfigEntries = function () {
                        ...
                        if (typeof modelConfig === "string") {
                            ...
                            for (var _i = 0, _g = (_c = modelConfig.fallbacks) !== null && _c !== void 0 ? _c : []; _i < _g.length; _i++) {
                                var fallback = _g[_i];
                        ...
                        if (typeof imageConfig === "string") {
                            ...
                            for (var _h = 0, _j = (_f = imageConfig.fallbacks) !== null && _f !== void 0 ? _f : []; _h < _j.length; _h++) {
                                var fallback = _j[_h];
                                addRawModelRef(fallback);
                            }
                        }
                    ...
                    for (_c = 0, _d = Object.keys((_h = (_g = (_f = params.cfg.agents) === null || _f === void 0 ? void 0 : _f.defaults) === null || _g === void 0 ? void 0 : _g.models) !== null && _h !== void 0 ? _h : {}); _c < _d.length; _c++) {
                        raw = _d[_c];
                        addRawModelRef(raw);
                    }
                    ...
                    providers = __spreadArray([], byProvider.keys(), true).sort();
                    if (!provider) {
                        lines_1 = __spreadArray(__spreadArray([
                            "Providers:"
                        ], providers.map(function (p) { var _a, _b; return formatProviderLine({ provider: p, count: (_b = (_a = byProvider.get(p)) === null || _a === void 0 ? void 0 : _a.size) !== null && _b !== void 0 ? _b : 0 }); }), true), [
                            "",
                            "Use: /models <provider>",
                    ...
                    if (!byProvider.has(provider)) {
                        lines_2 = __spreadArray(__spreadArray([
                            "Unknown provider: ".concat(provider),
                            "",
                            "Available providers:"
                        ], providers.map(function (p) { return "- ".concat(p); }), true), [
                            "",
                            "Use: /models <provider>",
                        ], false);
                        return [2 /*return*/, { text: lines_2.join("\n") }];
                    }
                    models = __spreadArray([], ((_j = byProvider.get(provider)) !== null && _j !== void 0 ? _j : new Set()), true).sort();
                    total = models.length;
                    if (total === 0) {
                        lines_3 = [
                    ...
                    header = "Models (".concat(provider, ") \u2014 showing ").concat(startIndex + 1, "-").concat(endIndexExclusive, " of ").concat(total, " (page ").concat(safePage, "/").concat(pageCount, ")");
                    lines = [header];
...
var handleModelsCommand = function (params, allowTextCommands) { return __awaiter(void 0, void 0, void 0, function () {
    var reply;
        ...
        switch (_a.label) {
            case 0:
                if (!allowTextCommands)
                    return [2 /*return*/, null];
                return [4 /*yield*/, resolveModelsCommandReply({
                        cfg: params.cfg,
