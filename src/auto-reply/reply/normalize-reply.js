...
function normalizeReplyPayload(payload, opts) {
    ...
    var trimmed = (_d = (_c = payload.text) === null || _c === void 0 ? void 0 : _c.trim()) !== null && _d !== void 0 ? _d : "";
    if (!trimmed && !hasMedia && !hasChannelData) {
        (_e = opts.onSkip) === null || _e === void 0 ? void 0 : _e.call(opts, "empty");
        return null;
    }
    var silentToken = (_f = opts.silentToken) !== null && _f !== void 0 ? _f : tokens_js_1.SILENT_REPLY_TOKEN;
    ...
    if (shouldStripHeartbeat && (text === null || text === void 0 ? void 0 : text.includes(tokens_js_1.HEARTBEAT_TOKEN))) {
    ...
    var effectivePrefix = opts.responsePrefixContext
        ? (0, response_prefix_template_js_1.resolveResponsePrefixTemplate)(opts.responsePrefix, opts.responsePrefixContext)
        : opts.responsePrefix;
    if (effectivePrefix &&
        text &&
