...
function handleCommands(params) {
    return __awaiter(this, void 0, void 0, function () {
        var resetMatch, resetRequested, commandAction, hookEvent, channel, to, hookReply, allowTextCommands, _i, HANDLERS_1, handler, result, sendPolicy;
            ...
            switch (_g.label) {
                case 0:
                    ...
                    if (resetRequested && !params.command.isAuthorizedSender) {
                        (0, globals_js_1.logVerbose)("Ignoring /reset from unauthorized sender: ".concat(params.command.senderId || "<unknown>"));
                        return [2 /*return*/, { shouldContinue: false }];
                    }
                    if (!(resetRequested && params.command.isAuthorizedSender)) return [3 /*break*/, 3];
                    commandAction = (_a = resetMatch === null || resetMatch === void 0 ? void 0 : resetMatch[1]) !== null && _a !== void 0 ? _a : "new";
                    hookEvent = (0, internal_hooks_js_1.createInternalHookEvent)("command", commandAction, (_b = params.sessionKey) !== null && _b !== void 0 ? _b : "", {
                ...
                case 1:
                    _g.sent();
                    if (!(hookEvent.messages.length > 0)) return [3 /*break*/, 3];
                    ...
                    if (!(channel && to)) return [3 /*break*/, 3];
                ...
                case 7:
                    sendPolicy = (0, send_policy_js_1.resolveSendPolicy)({
                        ...
                        sessionKey: params.sessionKey,
                        channel: (_d = (_c = params.sessionEntry) === null || _c === void 0 ? void 0 : _c.channel) !== null && _d !== void 0 ? _d : params.command.channel,
                        chatType: (_e = params.sessionEntry) === null || _e === void 0 ? void 0 : _e.chatType,
                    });
                    if (sendPolicy === "deny") {
                        (0, globals_js_1.logVerbose)("Send blocked by policy for session ".concat((_f = params.sessionKey) !== null && _f !== void 0 ? _f : "unknown"));
                        return [2 /*return*/, { shouldContinue: false }];
                    }
