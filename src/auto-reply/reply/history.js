...
exports.MAX_HISTORY_KEYS = exports.DEFAULT_GROUP_HISTORY_LIMIT = exports.HISTORY_CONTEXT_MARKER = void 0;
...
function evictOldHistoryKeys(historyMap, maxKeys) {
    if (maxKeys === void 0) { maxKeys = exports.MAX_HISTORY_KEYS; }
...
function buildHistoryContext(params) {
    var _a;
    var historyText = params.historyText, currentMessage = params.currentMessage;
    var lineBreak = (_a = params.lineBreak) !== null && _a !== void 0 ? _a : "\n";
    if (!historyText.trim())
        return currentMessage;
    return [exports.HISTORY_CONTEXT_MARKER, historyText, "", mentions_js_1.CURRENT_MESSAGE_MARKER, currentMessage].join(lineBreak);
}
function appendHistoryEntry(params) {
    var _a;
    var historyMap = params.historyMap, historyKey = params.historyKey, entry = params.entry;
    if (params.limit <= 0)
        return [];
...
function buildHistoryContextFromMap(params) {
    ...
    var entries = params.entry
        ...
        : ((_a = params.historyMap.get(params.historyKey)) !== null && _a !== void 0 ? _a : []);
    return buildHistoryContextFromEntries({
        entries: entries,
        currentMessage: params.currentMessage,
        formatEntry: params.formatEntry,
