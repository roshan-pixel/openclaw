...
var parseChunk = function (raw, options) {
    ...
    var silentToken = (_b = options === null || options === void 0 ? void 0 : options.silentToken) !== null && _b !== void 0 ? _b : tokens_js_1.SILENT_REPLY_TOKEN;
...
var hasRenderableContent = function (parsed) {
    ...
    return Boolean(parsed.text) ||
        ...
        ((_b = (_a = parsed.mediaUrls) === null || _a === void 0 ? void 0 : _a.length) !== null && _b !== void 0 ? _b : 0) > 0 ||
...
function createStreamingDirectiveAccumulator() {
    ...
    var consume = function (raw, options) {
        ...
        var explicitId = (_a = parsed.replyToExplicitId) !== null && _a !== void 0 ? _a : pendingReply.explicitId;
        var combinedResult = __assign(__assign({}, parsed), { replyToId: explicitId, replyToCurrent: sawCurrent, replyToTag: hasTag });
