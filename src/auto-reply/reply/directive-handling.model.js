...
function buildModelPickerCatalog(params) {
    ...
    var buildConfiguredCatalog = function () {
        ...
        var modelConfig = (_b = (_a = params.cfg.agents) === null || _a === void 0 ? void 0 : _a.defaults) === null || _b === void 0 ? void 0 : _b.model;
        var modelFallbacks = modelConfig && typeof modelConfig === "object" ? ((_c = modelConfig.fallbacks) !== null && _c !== void 0 ? _c : []) : [];
        ...
        var imageConfig = (_e = (_d = params.cfg.agents) === null || _d === void 0 ? void 0 : _d.defaults) === null || _e === void 0 ? void 0 : _e.imageModel;
        if (imageConfig && typeof imageConfig === "object") {
            pushRaw(imageConfig.primary);
            for (var _k = 0, _l = (_f = imageConfig.fallbacks) !== null && _f !== void 0 ? _f : []; _k < _l.length; _k++) {
                var fallback = _l[_k];
                pushRaw(String(fallback !== null && fallback !== void 0 ? fallback : ""));
            }
        }
        for (var _m = 0, _o = Object.keys((_j = (_h = (_g = params.cfg.agents) === null || _g === void 0 ? void 0 : _g.defaults) === null || _h === void 0 ? void 0 : _h.models) !== null && _j !== void 0 ? _j : {}); _m < _o.length; _m++) {
            var raw = _o[_m];
            pushRaw(raw);
        }
        return out;
    ...
    var hasAllowlist = Object.keys((_c = (_b = (_a = params.cfg.agents) === null || _a === void 0 ? void 0 : _a.defaults) === null || _b === void 0 ? void 0 : _b.models) !== null && _c !== void 0 ? _c : {}).length > 0;
    if (!hasAllowlist) {
    ...
    for (var _p = 0, _q = Object.keys((_h = (_g = (_f = params.cfg.agents) === null || _f === void 0 ? void 0 : _f.defaults) === null || _g === void 0 ? void 0 : _g.models) !== null && _h !== void 0 ? _h : {}); _p < _q.length; _p++) {
        var raw = _q[_p];
        var resolved = (0, model_selection_js_1.resolveModelRefFromString)({
            raw: String(raw),
            defaultProvider: params.defaultProvider,
...
function maybeHandleModelDirectiveInfo(params) {
    return __awaiter(this, void 0, void 0, function () {
        var rawDirective, directive, wantsStatus, wantsSummary, wantsLegacyList, pickerCatalog, reply, current_1, modelsPath, formatPath, authMode, authByProvider, _i, pickerCatalog_1, entry, provider, auth, current, defaultLabel, lines, byProvider, _a, pickerCatalog_2, entry, provider, models, _b, _c, provider, models, authLabel, endpoint, endpointSuffix, apiSuffix, _d, models_1, entry, label, aliases, aliasSuffix;
        var _e, _f;
        return __generator(this, function (_g) {
            switch (_g.label) {
                case 0:
                    ...
                    rawDirective = (_e = params.directives.rawModelDirective) === null || _e === void 0 ? void 0 : _e.trim();
                    directive = rawDirective === null || rawDirective === void 0 ? void 0 : rawDirective.toLowerCase();
                    ...
                    if (!wantsLegacyList) return [3 /*break*/, 2];
                    return [4 /*yield*/, (0, commands_models_js_1.resolveModelsCommandReply)({
                            cfg: params.cfg,
                            commandBodyNormalized: "/models",
                        })];
                case 1:
                    reply = _g.sent();
                    return [2 /*return*/, reply !== null && reply !== void 0 ? reply : { text: "No models available." }];
                case 2:
                    if (wantsSummary) {
                    ...
                    formatPath = function (value) { return (0, utils_js_1.shortenHomePath)(value); };
                    authMode = "verbose";
                    ...
                    _g.label = 3;
                case 3:
                    if (!(_i < pickerCatalog_1.length)) return [3 /*break*/, 6];
                    entry = pickerCatalog_1[_i];
                    provider = (0, model_selection_js_1.normalizeProviderId)(entry.provider);
                    if (authByProvider.has(provider))
                        return [3 /*break*/, 5];
                    return [4 /*yield*/, (0, directive_handling_auth_js_1.resolveAuthLabel)(provider, params.cfg, modelsPath, params.agentDir, authMode)];
                case 4:
                    auth = _g.sent();
                ...
                case 6:
                    ...
                    lines = [
                        ...
                        "Auth file: ".concat(formatPath((0, auth_profiles_js_1.resolveAuthStorePathForDisplay)(params.agentDir))),
                    ];
                    ...
                    for (_b = 0, _c = byProvider.keys(); _b < _c.length; _b++) {
                        ...
                        if (!models)
                            continue;
                        authLabel = (_f = authByProvider.get(provider)) !== null && _f !== void 0 ? _f : "missing";
                        endpoint = (0, directive_handling_model_picker_js_1.resolveProviderEndpointLabel)(provider, params.cfg);
                        endpointSuffix = endpoint.endpoint
                            ? " endpoint: ".concat(endpoint.endpoint)
                            : " endpoint: default";
                        apiSuffix = endpoint.api ? " api: ".concat(endpoint.api) : "";
                        lines.push("");
                        lines.push("[".concat(provider, "]").concat(endpointSuffix).concat(apiSuffix, " auth: ").concat(authLabel));
                        for (_d = 0, models_1 = models; _d < models_1.length; _d++) {
                            ...
                            aliasSuffix = aliases && aliases.length > 0 ? " (".concat(aliases.join(", "), ")") : "";
...
function resolveModelSelectionFromDirective(params) {
    ...
    if (explicit) {
        ...
        if (params.allowedModelKeys.size === 0 || params.allowedModelKeys.has(explicitKey)) {
            modelSelection = __assign({ provider: explicit.ref.provider, model: explicit.ref.model, isDefault: explicit.ref.provider === params.defaultProvider &&
                    explicit.ref.model === params.defaultModel }, (explicit.alias ? { alias: explicit.alias } : {}));
        }
    }
    if (!modelSelection) {
