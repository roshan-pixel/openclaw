...
function parseBashRequest(raw) {
    ...
    var token = (_c = (_b = tokenMatch === null || tokenMatch === void 0 ? void 0 : tokenMatch[1]) === null || _b === void 0 ? void 0 : _b.trim()) !== null && _c !== void 0 ? _c : "";
    var remainder = (_e = (_d = tokenMatch === null || tokenMatch === void 0 ? void 0 : tokenMatch[2]) === null || _d === void 0 ? void 0 : _d.trim()) !== null && _e !== void 0 ? _e : "";
...
function resolveRawCommandBody(params) {
    var _a, _b, _c;
    var source = (_c = (_b = (_a = params.ctx.CommandBody) !== null && _a !== void 0 ? _a : params.ctx.RawBody) !== null && _b !== void 0 ? _b : params.ctx.Body) !== null && _c !== void 0 ? _c : "";
...
function ensureActiveJobState() {
    ...
    if (activeJob.state === "starting")
        return activeJob;
    var _a = getScopedSession(activeJob.sessionId), running = _a.running, finished = _a.finished;
    if (running)
        return activeJob;
    if (finished) {
        activeJob = null;
...
function attachActiveWatcher(sessionId) {
    ...
    child.once("close", function () {
        if ((activeJob === null || activeJob === void 0 ? void 0 : activeJob.state) === "running" && activeJob.sessionId === sessionId) {
            activeJob = null;
        }
    });
}
...
function formatElevatedUnavailableMessage(params) {
    var lines = [];
    lines.push("elevated is not available right now (runtime=".concat(params.runtimeSandboxed ? "sandboxed" : "direct", ")."));
    if (params.failures.length > 0) {
        lines.push("Failing gates: ".concat(params.failures.map(function (f) { return "".concat(f.gate, " (").concat(f.key, ")"); }).join(", ")));
    }
    else {
    ...
    if (params.sessionKey) {
        lines.push("See: ".concat((0, command_format_js_1.formatCliCommand)("openclaw sandbox explain --session ".concat(params.sessionKey))));
    }
    return lines.join("\n");
}
function handleBashChatCommand(params) {
    return __awaiter(this, void 0, void 0, function () {
        var agentId, runtimeSandboxed, rawBody, request, liveJob, sessionId, _a, running, finished, runtimeSec, tail, exitLabel, prefix, sessionId, running, pid, label, commandText, foregroundMs, shouldBackgroundImmediately, timeoutSec, notifyOnExit, execTool, result, sessionId, snippet, exitCode, output, err_1, message;
        ...
        return __generator(this, function (_r) {
            switch (_r.label) {
                case 0:
                    ...
                    agentId = (_c = params.agentId) !== null && _c !== void 0 ? _c : (0, agent_scope_js_1.resolveSessionAgentId)({
                    ...
                    if (request.action === "poll") {
                        sessionId = ((_d = request.sessionId) === null || _d === void 0 ? void 0 : _d.trim()) || ((liveJob === null || liveJob === void 0 ? void 0 : liveJob.state) === "running" ? liveJob.sessionId : "");
                        if (!sessionId) {
                        ...
                        if (running) {
                            ...
                            return [2 /*return*/, {
                                    text: [
                                        "\u2699\uFE0F bash still running (session ".concat(formatSessionSnippet(sessionId), ", ").concat(runtimeSec, "s)."),
                        ...
                        if (finished) {
                            ...
                            exitLabel = finished.exitSignal
                                ...
                                : "code ".concat(String((_e = finished.exitCode) !== null && _e !== void 0 ? _e : 0));
                            prefix = finished.status === "completed" ? "⚙️" : "⚠️";
                            return [2 /*return*/, {
                                    text: [
                                        "".concat(prefix, " bash finished (session ").concat(formatSessionSnippet(sessionId), ")."),
                        ...
                        return [2 /*return*/, {
                                text: "\u2699\uFE0F No bash session found for ".concat(formatSessionSnippet(sessionId), "."),
                            }];
                    }
                    if (request.action === "stop") {
                        sessionId = ((_f = request.sessionId) === null || _f === void 0 ? void 0 : _f.trim()) || ((liveJob === null || liveJob === void 0 ? void 0 : liveJob.state) === "running" ? liveJob.sessionId : "");
                        if (!sessionId) {
                            return [2 /*return*/, { text: "⚙️ No active bash job." }];
                        }
                        ...
                        if (!running) {
                            ...
                            return [2 /*return*/, {
                                    text: "\u2699\uFE0F No running bash job found for ".concat(formatSessionSnippet(sessionId), "."),
                                }];
                        }
                        if (!running.backgrounded) {
                            return [2 /*return*/, {
                                    text: "\u26A0\uFE0F Session ".concat(formatSessionSnippet(sessionId), " is not backgrounded."),
                                }];
                        }
                        pid = (_g = running.pid) !== null && _g !== void 0 ? _g : (_h = running.child) === null || _h === void 0 ? void 0 : _h.pid;
                        if (pid) {
                        ...
                        return [2 /*return*/, {
                                text: "\u2699\uFE0F bash stopped (session ".concat(formatSessionSnippet(sessionId), ")."),
                            }];
                    }
                    // request.action === "run"
                    if (liveJob) {
                        label = liveJob.state === "running" ? formatSessionSnippet(liveJob.sessionId) : "starting";
                        return [2 /*return*/, {
                                text: "\u26A0\uFE0F A bash job is already running (".concat(label, "). Use !poll / !stop (or /bash poll / /bash stop)."),
                            }];
                    }
                ...
                case 1:
                    ...
                    timeoutSec = (_k = (_j = params.cfg.tools) === null || _j === void 0 ? void 0 : _j.exec) === null || _k === void 0 ? void 0 : _k.timeoutSec;
                    notifyOnExit = (_m = (_l = params.cfg.tools) === null || _l === void 0 ? void 0 : _l.exec) === null || _m === void 0 ? void 0 : _m.notifyOnExit;
                    ...
                    return [4 /*yield*/, execTool.execute("chat-bash", {
                            command: commandText,
                ...
                case 2:
                    result = _r.sent();
                    if (((_o = result.details) === null || _o === void 0 ? void 0 : _o.status) === "running") {
                        ...
                        (0, globals_js_1.logVerbose)("Started bash session ".concat(snippet, ": ").concat(commandText));
                        return [2 /*return*/, {
                                text: "\u2699\uFE0F bash started (session ".concat(sessionId, "). Still running; use !poll / !stop (or /bash poll / /bash stop)."),
                            }];
                    }
                    // Completed in foreground.
                    activeJob = null;
                    exitCode = ((_p = result.details) === null || _p === void 0 ? void 0 : _p.status) === "completed" ? result.details.exitCode : 0;
                    output = ((_q = result.details) === null || _q === void 0 ? void 0 : _q.status) === "completed"
                        ? result.details.aggregated
                        : result.content.map(function (chunk) { return (chunk.type === "text" ? chunk.text : ""); }).join("\n");
                    return [2 /*return*/, {
                            text: [
                ...
                case 3:
                    ...
                    return [2 /*return*/, {
                            text: ["\u26A0\uFE0F bash failed: ".concat(commandText), formatOutputBlock(message)].join("\n"),
                        }];
