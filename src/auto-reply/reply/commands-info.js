...
exports.handleWhoamiCommand = exports.handleContextCommand = exports.handleStatusCommand = exports.handleCommandsListCommand = exports.handleHelpCommand = void 0;
...
var handleHelpCommand = function (params, allowTextCommands) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        ...
        if (!params.command.isAuthorizedSender) {
            (0, globals_js_1.logVerbose)("Ignoring /help from unauthorized sender: ".concat(params.command.senderId || "<unknown>"));
...
var handleCommandsListCommand = function (params, allowTextCommands) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        ...
        if (params.command.commandBodyNormalized !== "/commands")
            return [2 /*return*/, null];
        if (!params.command.isAuthorizedSender) {
            (0, globals_js_1.logVerbose)("Ignoring /commands from unauthorized sender: ".concat(params.command.senderId || "<unknown>"));
            return [2 /*return*/, { shouldContinue: false }];
        }
        skillCommands = (_a = params.skillCommands) !== null && _a !== void 0 ? _a : (0, skill_commands_js_1.listSkillCommandsForAgents)({
            cfg: params.cfg,
        ...
        return [2 /*return*/, {
                shouldContinue: false,
                reply: { text: (0, status_js_1.buildCommandsMessage)(params.cfg, skillCommands, { surface: surface }) },
            }];
    });
}); };
...
var handleStatusCommand = function (params, allowTextCommands) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!allowTextCommands)
                    return [2 /*return*/, null];
                statusRequested = params.directives.hasStatusDirective || params.command.commandBodyNormalized === "/status";
                if (!statusRequested)
                    return [2 /*return*/, null];
                if (!params.command.isAuthorizedSender) {
                    (0, globals_js_1.logVerbose)("Ignoring /status from unauthorized sender: ".concat(params.command.senderId || "<unknown>"));
                    return [2 /*return*/, { shouldContinue: false }];
                }
                return [4 /*yield*/, (0, commands_status_js_1.buildStatusReply)({
                        cfg: params.cfg,
...
var handleContextCommand = function (params, allowTextCommands) { return __awaiter(void 0, void 0, void 0, function () {
    var normalized;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                if (normalized !== "/context" && !normalized.startsWith("/context "))
                    return [2 /*return*/, null];
                if (!params.command.isAuthorizedSender) {
                    (0, globals_js_1.logVerbose)("Ignoring /context from unauthorized sender: ".concat(params.command.senderId || "<unknown>"));
                    return [2 /*return*/, { shouldContinue: false }];
                }
                _a = { shouldContinue: false };
                return [4 /*yield*/, (0, commands_context_report_js_1.buildContextReply)(params)];
            case 1: return [2 /*return*/, (_a.reply = _b.sent(), _a)];
        }
    });
}); };
exports.handleContextCommand = handleContextCommand;
var handleWhoamiCommand = function (params, allowTextCommands) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        ...
        if (params.command.commandBodyNormalized !== "/whoami")
            return [2 /*return*/, null];
        if (!params.command.isAuthorizedSender) {
            (0, globals_js_1.logVerbose)("Ignoring /whoami from unauthorized sender: ".concat(params.command.senderId || "<unknown>"));
            return [2 /*return*/, { shouldContinue: false }];
        }
