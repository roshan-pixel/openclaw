...
exports.FOLLOWUP_QUEUES = exports.DEFAULT_QUEUE_DROP = exports.DEFAULT_QUEUE_CAP = exports.DEFAULT_QUEUE_DEBOUNCE_MS = void 0;
...
function getFollowupQueue(key, settings) {
    ...
    var created = {
        ...
        dropPolicy: (_b = settings.dropPolicy) !== null && _b !== void 0 ? _b : exports.DEFAULT_QUEUE_DROP,
        droppedCount: 0,
        summaryLines: [],
    };
