...
function createTypingController(params) {
    var _this = this;
    var onReplyStart = params.onReplyStart, _a = params.typingIntervalSeconds, typingIntervalSeconds = _a === void 0 ? 6 : _a, _b = params.typingTtlMs, typingTtlMs = _b === void 0 ? 2 * 60000 : _b, _c = params.silentToken, silentToken = _c === void 0 ? tokens_js_1.SILENT_REPLY_TOKEN : _c, log = params.log;
    var started = false;
    var active = false;
    ...
    var refreshTypingTtl = function () {
        ...
        typingTtlTimer = setTimeout(function () {
            if (!typingTimer)
                return;
            log === null || log === void 0 ? void 0 : log("typing TTL reached (".concat(formatTypingTtl(typingTtlMs), "); stopping typing indicator"));
            cleanup();
        }, typingTtlMs);
    };
    var isActive = function () { return active && !sealed; };
    var triggerTyping = function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (sealed)
                        return [2 /*return*/];
                    return [4 /*yield*/, (onReplyStart === null || onReplyStart === void 0 ? void 0 : onReplyStart())];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    var ensureStart = function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (sealed)
    ...
    var startTypingLoop = function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (sealed)
    ...
    var startTypingOnText = function (text) { return __awaiter(_this, void 0, void 0, function () {
        var trimmed;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
