...
function parseTtsCommand(normalized) {
    ...
    if (!rest)
        return { action: "status", args: "" };
    var _a = rest.split(/\s+/), action = _a[0], tail = _a.slice(1);
...
var handleTtsCommands = function (params, allowTextCommands) { return __awaiter(void 0, void 0, void 0, function () {
    var parsed, config, prefsPath, action, args, start, result, payload, currentProvider, hasOpenAI, hasElevenLabs, hasEdge, requested, currentLimit, next, enabled, maxLen, requested, enabled, provider, hasKey, maxLength, summarize, last, lines, timeAgo;
    var _a, _b, _c;
        ...
        switch (_d.label) {
            case 0:
                ...
                if (!params.command.isAuthorizedSender) {
                    (0, globals_js_1.logVerbose)("Ignoring TTS command from unauthorized sender: ".concat(params.command.senderId || "<unknown>"));
                ...
                if (!(action === "audio")) return [3 /*break*/, 2];
                if (!args.trim()) {
                    return [2 /*return*/, {
                ...
                start = Date.now();
                return [4 /*yield*/, (0, tts_js_1.textToSpeech)({
                        text: args,
                        cfg: params.cfg,
            ...
            case 1:
                ...
                return [2 /*return*/, {
                        shouldContinue: false,
                        reply: { text: "\u274C Error generating audio: ".concat((_a = result.error) !== null && _a !== void 0 ? _a : "unknown error") },
                    }];
            case 2:
                if (action === "provider") {
                ...
                if (action === "limit") {
                    if (!args.trim()) {
                        ...
                        return [2 /*return*/, {
                                shouldContinue: false,
                                reply: {
                                    text: "\uD83D\uDCCF TTS limit: ".concat(currentLimit, " characters.\n\n") +
                ...
                if (action === "summary") {
                    if (!args.trim()) {
                        ...
                        return [2 /*return*/, {
                                shouldContinue: false,
                                reply: {
                                    text: "\uD83D\uDCDD TTS auto-summary: ".concat(enabled ? "on" : "off", ".\n\n") +
                ...
                if (action === "status") {
                    ...
                    lines = [
                        ...
                        "Provider: ".concat(provider, " (").concat(hasKey ? "✅ configured" : "❌ not configured", ")"),
                    ...
                    if (last) {
                        ...
                        lines.push("");
                        lines.push("Last attempt (".concat(timeAgo, "s ago): ").concat(last.success ? "✅" : "❌"));
                        lines.push("Text: ".concat(last.textLength, " chars").concat(last.summarized ? " (summarized)" : ""));
                        if (last.success) {
                            lines.push("Provider: ".concat((_b = last.provider) !== null && _b !== void 0 ? _b : "unknown"));
                            lines.push("Latency: ".concat((_c = last.latencyMs) !== null && _c !== void 0 ? _c : 0, "ms"));
                        }
                        else if (last.error) {
