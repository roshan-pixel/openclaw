...
function deriveMentionPatterns(identity) {
    var _a, _b;
    var patterns = [];
    var name = (_a = identity === null || identity === void 0 ? void 0 : identity.name) === null || _a === void 0 ? void 0 : _a.trim();
    if (name) {
        var parts = name.split(/\s+/).filter(Boolean).map(escapeRegExp);
        var re = parts.length ? parts.join(String.raw(templateObject_1 || (templateObject_1 = __makeTemplateObject(["s+"], ["\\s+"])))) : escapeRegExp(name);
        patterns.push(String.raw(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\b@?", "\b"], ["\\b@?", "\\b"])), re));
    }
    var emoji = (_b = identity === null || identity === void 0 ? void 0 : identity.emoji) === null || _b === void 0 ? void 0 : _b.trim();
    if (emoji) {
...
function resolveMentionPatterns(cfg, agentId) {
    ...
    var agentGroupChat = agentConfig === null || agentConfig === void 0 ? void 0 : agentConfig.groupChat;
    ...
    var derived = deriveMentionPatterns(agentConfig === null || agentConfig === void 0 ? void 0 : agentConfig.identity);
...
function normalizeMentionText(text) {
    return (text !== null && text !== void 0 ? text : "").replace(/[\u200b-\u200f\u202a-\u202e\u2060-\u206f]/g, "").toLowerCase();
}
function matchesMentionPatterns(text, mentionRegexes) {
    ...
    if (!cleaned)
        return false;
    return mentionRegexes.some(function (re) { return re.test(cleaned); });
}
function matchesMentionWithExplicit(params) {
    var _a, _b, _c, _d;
    var cleaned = normalizeMentionText((_a = params.text) !== null && _a !== void 0 ? _a : "");
    var explicit = ((_b = params.explicit) === null || _b === void 0 ? void 0 : _b.isExplicitlyMentioned) === true;
    var explicitAvailable = ((_c = params.explicit) === null || _c === void 0 ? void 0 : _c.canResolveExplicit) === true;
    var hasAnyMention = ((_d = params.explicit) === null || _d === void 0 ? void 0 : _d.hasAnyMention) === true;
    if (hasAnyMention && explicitAvailable) {
        return explicit || params.mentionRegexes.some(function (re) { return re.test(cleaned); });
    }
    if (!cleaned)
        return explicit;
    return explicit || params.mentionRegexes.some(function (re) { return re.test(cleaned); });
...
function stripStructuralPrefixes(text) {
    ...
    var afterMarker = text.includes(exports.CURRENT_MESSAGE_MARKER)
        ? text.slice(text.indexOf(exports.CURRENT_MESSAGE_MARKER) + exports.CURRENT_MESSAGE_MARKER.length).trimStart()
        : text;
    return afterMarker
        .replace(/\[[^\]]+\]\s*/g, "")
...
function stripMentions(text, ctx, cfg, agentId) {
    ...
    var providerMentions = providerId ? (_a = (0, dock_js_1.getChannelDock)(providerId)) === null || _a === void 0 ? void 0 : _a.mentions : undefined;
    var patterns = normalizeMentionPatterns(__spreadArray(__spreadArray([], resolveMentionPatterns(cfg, agentId), true), ((_c = (_b = providerMentions === null || providerMentions === void 0 ? void 0 : providerMentions.stripPatterns) === null || _b === void 0 ? void 0 : _b.call(providerMentions, { ctx: ctx, cfg: cfg, agentId: agentId })) !== null && _c !== void 0 ? _c : []), true));
    ...
    if (providerMentions === null || providerMentions === void 0 ? void 0 : providerMentions.stripMentions) {
