...
exports.formatReasoningEvent = exports.formatElevatedEvent = exports.formatElevatedRuntimeHint = exports.withOptions = exports.formatOptionsLine = exports.formatDirectiveAck = exports.SYSTEM_MARK = void 0;
...
var formatOptionsLine = function (options) { return "Options: ".concat(options, "."); };
...
function formatElevatedUnavailableText(params) {
    ...
    if (failures.length > 0) {
        lines.push("Failing gates: ".concat(failures.map(function (f) { return "".concat(f.gate, " (").concat(f.key, ")"); }).join(", ")));
    }
    else {
