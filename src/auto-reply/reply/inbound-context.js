...
function finalizeInboundContext(ctx, opts) {
    ...
    if (opts === void 0) { opts = {}; }
    var normalized = ctx;
    normalized.Body = (0, inbound_text_js_1.normalizeInboundTextNewlines)(typeof normalized.Body === "string" ? normalized.Body : "");
    ...
    var bodyForAgentSource = opts.forceBodyForAgent
        ? normalized.Body
        : ((_a = normalized.BodyForAgent) !== null && _a !== void 0 ? _a : normalized.Body);
    ...
    var bodyForCommandsSource = opts.forceBodyForCommands
        ? ((_c = (_b = normalized.CommandBody) !== null && _b !== void 0 ? _b : normalized.RawBody) !== null && _c !== void 0 ? _c : normalized.Body)
        : ((_f = (_e = (_d = normalized.BodyForCommands) !== null && _d !== void 0 ? _d : normalized.CommandBody) !== null && _e !== void 0 ? _e : normalized.RawBody) !== null && _f !== void 0 ? _f : normalized.Body);
    normalized.BodyForCommands = (0, inbound_text_js_1.normalizeInboundTextNewlines)(bodyForCommandsSource);
    var explicitLabel = (_g = normalized.ConversationLabel) === null || _g === void 0 ? void 0 : _g.trim();
    if (opts.forceConversationLabel || !explicitLabel) {
        var resolved = (_h = (0, conversation_label_js_1.resolveConversationLabel)(normalized)) === null || _h === void 0 ? void 0 : _h.trim();
        if (resolved)
    ...
    normalized.Body = (0, inbound_sender_meta_js_1.formatInboundBodyWithSenderMeta)({ ctx: normalized, body: normalized.Body });
