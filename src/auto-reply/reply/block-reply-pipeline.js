...
function createAudioAsVoiceBuffer(params) {
    ...
    return {
        ...
        shouldBuffer: function (payload) { return params.isAudioPayload(payload); },
        finalize: function (payload) { return (seenAudioAsVoice ? __assign(__assign({}, payload), { audioAsVoice: true }) : payload); },
    };
}
function createBlockReplyPayloadKey(payload) {
    var _a, _b, _c, _d;
    var text = (_b = (_a = payload.text) === null || _a === void 0 ? void 0 : _a.trim()) !== null && _b !== void 0 ? _b : "";
...
var withTimeout = function (promise, timeoutMs, timeoutError) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        switch (_a.label) {
            case 0:
                ...
                timeoutPromise = new Promise(function (_, reject) {
                    timer = setTimeout(function () { return reject(timeoutError); }, timeoutMs);
                });
                _a.label = 1;
            case 1:
                _a.trys.push([1, , 3, 4]);
...
function createBlockReplyPipeline(params) {
    var _this = this;
    var onBlockReply = params.onBlockReply, timeoutMs = params.timeoutMs, coalescing = params.coalescing, buffer = params.buffer;
    ...
    var sendPayload = function (payload, skipSeen) {
        ...
        sendChain = sendChain
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, withTimeout((_a = onBlockReply(payload, {
                                abortSignal: abortController.signal,
                                timeoutMs: timeoutMs,
                            })) !== null && _a !== void 0 ? _a : Promise.resolve(), timeoutMs, timeoutError)];
                    case 1:
                        _b.sent();
            ...
            if (err === timeoutError) {
                ...
                if (!didLogTimeout) {
                    didLogTimeout = true;
                    (0, globals_js_1.logVerbose)("block reply delivery timed out after ".concat(timeoutMs, "ms; skipping remaining block replies to preserve ordering"));
                }
                return;
            }
    ...
    var bufferPayload = function (payload) {
        var _a;
        (_a = buffer === null || buffer === void 0 ? void 0 : buffer.onEnqueue) === null || _a === void 0 ? void 0 : _a.call(buffer, payload);
    ...
    var flushBuffered = function () {
        ...
        for (var _i = 0, bufferedPayloads_1 = bufferedPayloads; _i < bufferedPayloads_1.length; _i++) {
            ...
            var finalPayload = (_b = (_a = buffer === null || buffer === void 0 ? void 0 : buffer.finalize) === null || _a === void 0 ? void 0 : _a.call(buffer, payload)) !== null && _b !== void 0 ? _b : payload;
    ...
    var flush = function (options) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (coalescer === null || coalescer === void 0 ? void 0 : coalescer.flush(options))];
                case 1:
                    _a.sent();
                    flushBuffered();
    ...
    return {
        ...
        flush: flush,
        stop: stop,
        hasBuffered: function () { return Boolean((coalescer === null || coalescer === void 0 ? void 0 : coalescer.hasBuffered()) || bufferedPayloads.length > 0); },
        didStream: function () { return didStream; },
