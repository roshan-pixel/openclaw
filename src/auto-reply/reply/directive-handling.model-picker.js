...
var PROVIDER_RANK = new Map(MODEL_PICK_PROVIDER_PREFERENCE.map(function (provider, idx) { return [provider, idx]; }));
...
function resolveProviderEndpointLabel(provider, cfg) {
    ...
    var providers = ((_b = (_a = cfg.models) === null || _a === void 0 ? void 0 : _a.providers) !== null && _b !== void 0 ? _b : {});
    var entry = providers[normalized];
    var endpoint = (_c = entry === null || entry === void 0 ? void 0 : entry.baseUrl) === null || _c === void 0 ? void 0 : _c.trim();
    var api = (_d = entry === null || entry === void 0 ? void 0 : entry.api) === null || _d === void 0 ? void 0 : _d.trim();
    return {
