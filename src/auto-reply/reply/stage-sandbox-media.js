...
function stageSandboxMedia(params) {
    return __awaiter(this, void 0, void 0, function () {
        var ctx, sessionCtx, cfg, sessionKey, workspaceDir, hasPathsArray, pathsFromArray, rawPaths, sandbox, remoteMediaCacheDir, effectiveWorkspaceDir, resolveAbsolutePath, destDir, usedNames, staged_1, _i, rawPaths_1, raw, source, baseName, parsed, fileName, suffix, dest, stagedPath, rewriteIfStaged_1, nextMediaPaths, rewritten, nextUrls, rewrittenUrl, err_1;
        var _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ctx = params.ctx, sessionCtx = params.sessionCtx, cfg = params.cfg, sessionKey = params.sessionKey, workspaceDir = params.workspaceDir;
                    ...
                    rawPaths = pathsFromArray && pathsFromArray.length > 0
                        ? pathsFromArray
                    ...
                    if (rawPaths.length === 0 || !sessionKey)
                        return [2 /*return*/];
                    return [4 /*yield*/, (0, sandbox_js_1.ensureSandboxWorkspaceForSession)({
                            config: cfg,
                ...
                case 1:
                    ...
                    remoteMediaCacheDir = ctx.MediaRemoteHost
                        ...
                        : null;
                    effectiveWorkspaceDir = (_b = sandbox === null || sandbox === void 0 ? void 0 : sandbox.workspaceDir) !== null && _b !== void 0 ? _b : remoteMediaCacheDir;
                ...
                case 3:
                    ...
                    _c.label = 4;
                case 4:
                    if (!(_i < rawPaths_1.length)) return [3 /*break*/, 10];
                    raw = rawPaths_1[_i];
                    ...
                    if (!ctx.MediaRemoteHost) return [3 /*break*/, 6];
                ...
                case 5:
                    ...
                    _c.sent();
                    return [3 /*break*/, 8];
                case 6: return [4 /*yield*/, promises_1.default.copyFile(source, dest)];
                case 7:
                    _c.sent();
                    _c.label = 8;
                case 8:
                    stagedPath = sandbox ? node_path_1.default.posix.join("media", "inbound", fileName) : dest;
                ...
                case 10:
                    ...
                    nextMediaPaths = hasPathsArray ? rawPaths.map(function (p) { var _a; return (_a = rewriteIfStaged_1(p)) !== null && _a !== void 0 ? _a : p; }) : undefined;
                    if (nextMediaPaths) {
                    ...
                    if (Array.isArray(ctx.MediaUrls) && ctx.MediaUrls.length > 0) {
                        nextUrls = ctx.MediaUrls.map(function (u) { var _a; return (_a = rewriteIfStaged_1(u)) !== null && _a !== void 0 ? _a : u; });
                ...
                case 11:
                    err_1 = _c.sent();
                    (0, globals_js_1.logVerbose)("Failed to stage inbound media for sandbox: ".concat(String(err_1)));
                    return [3 /*break*/, 12];
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    var _a, _b;
                    var child = (0, node_child_process_1.spawn)("/usr/bin/scp", [
                        "-o",
                        "BatchMode=yes",
                        "-o",
