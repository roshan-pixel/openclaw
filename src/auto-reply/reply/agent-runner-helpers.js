...
exports.signalTypingIfNeeded = exports.finalizeWithFollowup = exports.createShouldEmitToolOutput = exports.createShouldEmitToolResult = exports.isAudioPayload = void 0;
...
var hasAudioMedia = function (urls) {
    return Boolean(urls === null || urls === void 0 ? void 0 : urls.some(function (url) { return (0, mime_js_1.isAudioFileName)(url); }));
};
var isAudioPayload = function (payload) { var _a; return hasAudioMedia((_a = payload.mediaUrls) !== null && _a !== void 0 ? _a : (payload.mediaUrl ? [payload.mediaUrl] : undefined)); };
...
var createShouldEmitToolResult = function (params) {
    ...
    var fallbackVerbose = (_b = (0, thinking_js_1.normalizeVerboseLevel)(String((_a = params.resolvedVerboseLevel) !== null && _a !== void 0 ? _a : ""))) !== null && _b !== void 0 ? _b : "off";
    return function () {
        var _a;
        ...
        try {
            ...
            var current = (0, thinking_js_1.normalizeVerboseLevel)(String((_a = entry === null || entry === void 0 ? void 0 : entry.verboseLevel) !== null && _a !== void 0 ? _a : ""));
            if (current)
                return current !== "off";
        }
        catch (_b) {
...
var signalTypingIfNeeded = function (payloads, typingSignals) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (!shouldSignalTyping) return [3 /*break*/, 2];
