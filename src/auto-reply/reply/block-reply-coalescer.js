...
function createBlockReplyCoalescer(params) {
    var _this = this;
    var _a;
    var config = params.config, shouldAbort = params.shouldAbort, onFlush = params.onFlush;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!bufferText)
                        return [2 /*return*/];
                    if (!(options === null || options === void 0 ? void 0 : options.force) && bufferText.length < minChars) {
                        scheduleIdleFlush();
                        return [2 /*return*/];
                    }
                    payload = {
    ...
    return {
        enqueue: enqueue,
        flush: flush,
        hasBuffered: function () { return Boolean(bufferText); },
        stop: function () { return clearIdleTimer(); },
    };
}
