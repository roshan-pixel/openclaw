...
function resolveSubagentLabel(entry, fallback) {
    var _a, _b;
    if (fallback === void 0) { fallback = "subagent"; }
    var raw = ((_a = entry.label) === null || _a === void 0 ? void 0 : _a.trim()) || ((_b = entry.task) === null || _b === void 0 ? void 0 : _b.trim()) || "";
    return raw || fallback;
}
function formatRunLabel(entry, options) {
    var _a;
    var raw = resolveSubagentLabel(entry);
    var maxLength = (_a = options === null || options === void 0 ? void 0 : options.maxLength) !== null && _a !== void 0 ? _a : 72;
    if (!Number.isFinite(maxLength) || maxLength <= 0)
        return raw;
    return raw.length > maxLength ? "".concat((0, utils_js_1.truncateUtf16Safe)(raw, maxLength).trimEnd(), "\u2026") : raw;
}
function formatRunStatus(entry) {
    var _a, _b;
    if (!entry.endedAt)
        return "running";
    var status = (_b = (_a = entry.outcome) === null || _a === void 0 ? void 0 : _a.status) !== null && _b !== void 0 ? _b : "done";
    return status === "ok" ? "done" : status;
}
function sortSubagentRuns(runs) {
    return __spreadArray([], runs, true).sort(function (a, b) {
        var _a, _b, _c, _d;
        var aTime = (_b = (_a = a.startedAt) !== null && _a !== void 0 ? _a : a.createdAt) !== null && _b !== void 0 ? _b : 0;
        var bTime = (_d = (_c = b.startedAt) !== null && _c !== void 0 ? _c : b.createdAt) !== null && _d !== void 0 ? _d : 0;
        return bTime - aTime;
    });
}
