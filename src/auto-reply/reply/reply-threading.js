...
function resolveReplyToMode(cfg, channel, accountId, chatType) {
    ...
    if (!provider)
        return "all";
    var resolved = (_c = (_b = (_a = (0, dock_js_1.getChannelDock)(provider)) === null || _a === void 0 ? void 0 : _a.threading) === null || _b === void 0 ? void 0 : _b.resolveReplyToMode) === null || _c === void 0 ? void 0 : _c.call(_b, {
        cfg: cfg,
        accountId: accountId,
        chatType: chatType,
    });
...
function createReplyToModeFilterForChannel(mode, channel) {
    ...
    var allowTagsWhenOff = provider
        ? Boolean((_b = (_a = (0, dock_js_1.getChannelDock)(provider)) === null || _a === void 0 ? void 0 : _a.threading) === null || _b === void 0 ? void 0 : _b.allowTagsWhenOff)
        : false;
