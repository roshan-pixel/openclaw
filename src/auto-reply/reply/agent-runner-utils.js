...
exports.resolveEnforceFinalTag = exports.appendUsageLine = exports.formatResponseUsageLine = exports.formatBunFetchSocketError = exports.isBunFetchSocketError = void 0;
...
function buildThreadingToolContext(params) {
    var _a, _b, _c, _d, _e;
    var sessionCtx = params.sessionCtx, config = params.config, hasRepliedRef = params.hasRepliedRef;
    if (!config)
        return {};
    var rawProvider = (_a = sessionCtx.Provider) === null || _a === void 0 ? void 0 : _a.trim().toLowerCase();
    if (!rawProvider)
        return {};
    var provider = (_b = (0, registry_js_1.normalizeChannelId)(rawProvider)) !== null && _b !== void 0 ? _b : (0, registry_js_1.normalizeAnyChannelId)(rawProvider);
    // Fallback for unrecognized/plugin channels (e.g., BlueBubbles before plugin registry init)
    var dock = provider ? (0, dock_js_1.getChannelDock)(provider) : undefined;
    if (!((_c = dock === null || dock === void 0 ? void 0 : dock.threading) === null || _c === void 0 ? void 0 : _c.buildToolContext)) {
        return {
            currentChannelId: ((_d = sessionCtx.To) === null || _d === void 0 ? void 0 : _d.trim()) || undefined,
            currentChannelProvider: provider !== null && provider !== void 0 ? provider : rawProvider,
            hasRepliedRef: hasRepliedRef,
        };
    }
    var context = (_e = dock.threading.buildToolContext({
        cfg: config,
...
var formatResponseUsageLine = function (params) {
    ...
    var outputLabel = typeof output === "number" ? (0, usage_format_js_1.formatTokenCount)(output) : "?";
    var cost = params.showCost && typeof input === "number" && typeof output === "number"
...
var appendUsageLine = function (payloads, line) {
    ...
    var next = __assign(__assign({}, existing), { text: "".concat(existingText).concat(separator).concat(line) });
