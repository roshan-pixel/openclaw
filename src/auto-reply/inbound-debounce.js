...
function resolveInboundDebounceMs(params) {
    ...
    return (_c = (_b = override !== null && override !== void 0 ? override : byChannel) !== null && _b !== void 0 ? _b : base) !== null && _c !== void 0 ? _c : 0;
}
function createInboundDebouncer(params) {
    var _this = this;
    var buffers = new Map();
    var debounceMs = Math.max(0, Math.trunc(params.debounceMs));
    var flushBuffer = function (key, buffer) { return __awaiter(_this, void 0, void 0, function () {
        var err_1;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    err_1 = _b.sent();
                    (_a = params.onError) === null || _a === void 0 ? void 0 : _a.call(params, err_1, buffer.items);
                    return [3 /*break*/, 4];
                case 4: return [2 /*return*/];
            }
        });
    }); };
    var flushKey = function (key) { return __awaiter(_this, void 0, void 0, function () {
        var buffer;
    ...
    var enqueue = function (item) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    canDebounce = debounceMs > 0 && ((_b = (_a = params.shouldDebounce) === null || _a === void 0 ? void 0 : _a.call(params, item)) !== null && _b !== void 0 ? _b : true);
                    if (!(!canDebounce || !key)) return [3 /*break*/, 4];
                    if (!(key && buffers.has(key))) return [3 /*break*/, 2];
                    return [4 /*yield*/, flushKey(key)];
                case 1:
                    _c.sent();
                    _c.label = 2;
                case 2: return [4 /*yield*/, params.onFlush([item])];
                case 3:
                    _c.sent();
                    return [2 /*return*/];
                case 4:
