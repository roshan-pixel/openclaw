...
function formatToolAggregate(toolName, metas, options) {
    ...
    return "".concat(prefix, ": ").concat(formatMetaForDisplay(toolName, meta, options === null || options === void 0 ? void 0 : options.markdown));
}
function formatToolPrefix(toolName, meta) {
    var extra = (meta === null || meta === void 0 ? void 0 : meta.trim()) ? shortenMeta(meta) : undefined;
...
function formatMetaForDisplay(toolName, meta, markdown) {
    ...
    if (normalized === "exec" || normalized === "bash") {
        var _a = splitExecFlags(meta), flags = _a.flags, body = _a.body;
        if (flags.length > 0) {
            if (!body)
                return flags.join(" · ");
