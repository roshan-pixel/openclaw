...
function listSkillCommandsForAgents(params) {
    ...
    var entries = [];
    var agentIds = (_a = params.agentIds) !== null && _a !== void 0 ? _a : (0, agent_scope_js_1.listAgentIds)(params.cfg);
...
function resolveSkillCommandInvocation(params) {
    ...
    if (commandName === "skill") {
        ...
        if (!skillMatch)
            return null;
        var skillCommand = findSkillCommand(params.skillCommands, (_c = skillMatch[1]) !== null && _c !== void 0 ? _c : "");
        if (!skillCommand)
            return null;
        var args_1 = (_d = skillMatch[2]) === null || _d === void 0 ? void 0 : _d.trim();
        return { command: skillCommand, args: args_1 || undefined };
    }
    var command = params.skillCommands.find(function (entry) { return entry.name.toLowerCase() === commandName; });
    if (!command)
        return null;
