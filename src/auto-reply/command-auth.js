...
function resolveProviderFromContext(ctx, cfg) {
    var _a, _b;
    var direct = (_b = (_a = (0, registry_js_1.normalizeAnyChannelId)(ctx.Provider)) !== null && _a !== void 0 ? _a : (0, registry_js_1.normalizeAnyChannelId)(ctx.Surface)) !== null && _b !== void 0 ? _b : (0, registry_js_1.normalizeAnyChannelId)(ctx.OriginatingChannel);
    if (direct)
        return direct;
    var candidates = [ctx.From, ctx.To]
        .filter(function (value) { return Boolean(value === null || value === void 0 ? void 0 : value.trim()); })
        .flatMap(function (value) { return value.split(":").map(function (part) { return part.trim(); }); });
...
function formatAllowFromList(params) {
    var _a;
    var dock = params.dock, cfg = params.cfg, accountId = params.accountId, allowFrom = params.allowFrom;
...
function normalizeAllowFromEntry(params) {
    ...
    return normalized.filter(function (entry) { return entry.trim().length > 0; });
}
function resolveSenderCandidates(params) {
    var dock = params.dock, cfg = params.cfg, accountId = params.accountId;
    var candidates = [];
    ...
    for (var _i = 0, candidates_2 = candidates; _i < candidates_2.length; _i++) {
        ...
        var entries = normalizeAllowFromEntry({ dock: dock, cfg: cfg, accountId: accountId, value: sender });
...
function resolveCommandAuthorization(params) {
    var _a, _b, _c, _d;
    var ctx = params.ctx, cfg = params.cfg, commandAuthorized = params.commandAuthorized;
    ...
    var allowFromRaw = ((_c = dock === null || dock === void 0 ? void 0 : dock.config) === null || _c === void 0 ? void 0 : _c.resolveAllowFrom)
    ...
    var allowAll = allowFromList.length === 0 || allowFromList.some(function (entry) { return entry.trim() === "*"; });
    var ownerCandidates = allowAll ? [] : allowFromList.filter(function (entry) { return entry !== "*"; });
    ...
    var matchedSender = ownerList.length
        ? senderCandidates.find(function (candidate) { return ownerList.includes(candidate); })
        : undefined;
    var senderId = matchedSender !== null && matchedSender !== void 0 ? matchedSender : senderCandidates[0];
    var enforceOwner = Boolean((_d = dock === null || dock === void 0 ? void 0 : dock.commands) === null || _d === void 0 ? void 0 : _d.enforceOwnerForCommands);
