...
function resolveRuntimeLabel(args) {
    ...
    var sandboxMode = (_e = (_d = (_c = args.agent) === null || _c === void 0 ? void 0 : _c.sandbox) === null || _d === void 0 ? void 0 : _d.mode) !== null && _e !== void 0 ? _e : "off";
    if (sandboxMode === "off")
        return "direct";
...
var formatTokens = function (total, contextTokens) {
    ...
    return "".concat(totalLabel, "/").concat(ctxLabel).concat(pct !== null ? " (".concat(pct, "%)") : "");
};
var formatContextUsageShort = function (total, contextTokens) { return "Context ".concat(formatTokens(total, contextTokens !== null && contextTokens !== void 0 ? contextTokens : null)); };
...
var formatQueueDetails = function (queue) {
    ...
    if (typeof queue.debounceMs === "number") {
        ...
        var label = ms >= 1000 ? "".concat(ms % 1000 === 0 ? ms / 1000 : (ms / 1000).toFixed(1), "s") : "".concat(ms, "ms");
    ...
    try {
        ...
        for (var _i = 0, lines_1 = lines; _i < lines_1.length; _i++) {
            ...
            try {
                ...
                var usageRaw = (_b = (_a = parsed.message) === null || _a === void 0 ? void 0 : _a.usage) !== null && _b !== void 0 ? _b : parsed.usage;
                var usage = (0, usage_js_1.normalizeUsage)(usageRaw);
                if (usage)
                    lastUsage = usage;
                model = (_e = (_d = (_c = parsed.message) === null || _c === void 0 ? void 0 : _c.model) !== null && _d !== void 0 ? _d : parsed.model) !== null && _e !== void 0 ? _e : model;
            }
            catch (_l) {
                // ignore bad lines
            }
        ...
        promptTokens = (_j = (_h = (0, usage_js_1.derivePromptTokens)(lastUsage)) !== null && _h !== void 0 ? _h : lastUsage.total) !== null && _j !== void 0 ? _j : input + output;
...
var formatMediaUnderstandingLine = function (decisions) {
    ...
    var parts = decisions
        ...
        if (decision.outcome === "success") {
            ...
            var modelLabel = provider ? (model ? "".concat(provider, "/").concat(model) : provider) : null;
            return "".concat(decision.capability).concat(countLabel, " ok").concat(modelLabel ? " (".concat(modelLabel, ")") : "");
        }
        ...
        if (decision.outcome === "skipped") {
            ...
            return "".concat(decision.capability, " skipped").concat(shortReason ? " (".concat(shortReason, ")") : "");
        }
        return null;
    })
    ...
    if (parts.length === 0)
        return null;
    if (parts.every(function (part) { return part.endsWith(" none"); }))
        return null;
...
var formatVoiceModeLine = function (config, sessionEntry) {
    ...
    return "\uD83D\uDD0A Voice: ".concat(autoMode, " \u00B7 provider=").concat(provider, " \u00B7 limit=").concat(maxLength, " \u00B7 summary=").concat(summarize);
};
function buildStatusMessage(args) {
    ...
    var provider = (_d = (_c = entry === null || entry === void 0 ? void 0 : entry.providerOverride) !== null && _c !== void 0 ? _c : resolved.provider) !== null && _d !== void 0 ? _d : defaults_js_1.DEFAULT_PROVIDER;
    var model = (_f = (_e = entry === null || entry === void 0 ? void 0 : entry.modelOverride) !== null && _e !== void 0 ? _e : resolved.model) !== null && _f !== void 0 ? _f : defaults_js_1.DEFAULT_MODEL;
    var contextTokens = (_k = (_j = (_g = entry === null || entry === void 0 ? void 0 : entry.contextTokens) !== null && _g !== void 0 ? _g : (_h = args.agent) === null || _h === void 0 ? void 0 : _h.contextTokens) !== null && _j !== void 0 ? _j : (0, context_js_1.lookupContextTokens)(model)) !== null && _k !== void 0 ? _k : defaults_js_1.DEFAULT_CONTEXT_TOKENS;
    ...
    var totalTokens = (_l = entry === null || entry === void 0 ? void 0 : entry.totalTokens) !== null && _l !== void 0 ? _l : ((_m = entry === null || entry === void 0 ? void 0 : entry.inputTokens) !== null && _m !== void 0 ? _m : 0) + ((_o = entry === null || entry === void 0 ? void 0 : entry.outputTokens) !== null && _o !== void 0 ? _o : 0);
    // Prefer prompt-size tokens from the session transcript when it looks larger
    // (cached prompt tokens are often missing from agent meta/store).
    if (args.includeTranscriptUsage) {
        var logUsage = readUsageFromSessionLog(entry === null || entry === void 0 ? void 0 : entry.sessionId, entry);
        if (logUsage) {
            ...
            if (!contextTokens && logUsage.model) {
                contextTokens = (_q = (0, context_js_1.lookupContextTokens)(logUsage.model)) !== null && _q !== void 0 ? _q : contextTokens;
            }
    ...
    var thinkLevel = (_t = (_r = args.resolvedThink) !== null && _r !== void 0 ? _r : (_s = args.agent) === null || _s === void 0 ? void 0 : _s.thinkingDefault) !== null && _t !== void 0 ? _t : "off";
    var verboseLevel = (_w = (_u = args.resolvedVerbose) !== null && _u !== void 0 ? _u : (_v = args.agent) === null || _v === void 0 ? void 0 : _v.verboseDefault) !== null && _w !== void 0 ? _w : "off";
    var reasoningLevel = (_x = args.resolvedReasoning) !== null && _x !== void 0 ? _x : "off";
    var elevatedLevel = (_2 = (_0 = (_y = args.resolvedElevated) !== null && _y !== void 0 ? _y : (_z = args.sessionEntry) === null || _z === void 0 ? void 0 : _z.elevatedLevel) !== null && _0 !== void 0 ? _0 : (_1 = args.agent) === null || _1 === void 0 ? void 0 : _1.elevatedDefault) !== null && _2 !== void 0 ? _2 : "on";
    ...
    var sessionLine = [
        ...
        .filter(Boolean)
        .join(" • ");
    var isGroupSession = (entry === null || entry === void 0 ? void 0 : entry.chatType) === "group" ||
    ...
    var groupActivationValue = isGroupSession
        ? ((_7 = (_6 = args.groupActivation) !== null && _6 !== void 0 ? _6 : entry === null || entry === void 0 ? void 0 : entry.groupActivation) !== null && _7 !== void 0 ? _7 : "mention")
        : undefined;
    var contextLine = [
        "Context: ".concat(formatTokens(totalTokens, contextTokens !== null && contextTokens !== void 0 ? contextTokens : null)),
        "\uD83E\uDDF9 Compactions: ".concat((_8 = entry === null || entry === void 0 ? void 0 : entry.compactionCount) !== null && _8 !== void 0 ? _8 : 0),
    ]
        .filter(Boolean)
        .join(" · ");
    var queueMode = (_10 = (_9 = args.queue) === null || _9 === void 0 ? void 0 : _9.mode) !== null && _10 !== void 0 ? _10 : "unknown";
    var queueDetails = formatQueueDetails(args.queue);
    var verboseLabel = verboseLevel === "full" ? "verbose:full" : verboseLevel === "on" ? "verbose" : null;
    var elevatedLabel = elevatedLevel && elevatedLevel !== "off"
        ? elevatedLevel === "on"
            ? "elevated"
    ...
    var authLabelValue = (_11 = args.modelAuth) !== null && _11 !== void 0 ? _11 : (authMode && authMode !== "unknown" ? authMode : undefined);
    ...
    var versionLine = "\uD83E\uDD9E OpenClaw ".concat(version_js_1.VERSION).concat(commit ? " (".concat(commit, ")") : "");
    var usagePair = formatUsagePair(inputTokens, outputTokens);
    var costLine = costLabel ? "\uD83D\uDCB5 Cost: ".concat(costLabel) : null;
    var usageCostLine = usagePair && costLine ? "".concat(usagePair, " \u00B7 ").concat(costLine) : (usagePair !== null && usagePair !== void 0 ? usagePair : costLine);
...
function buildHelpMessage(cfg) {
    ...
    if (((_a = cfg === null || cfg === void 0 ? void 0 : cfg.commands) === null || _a === void 0 ? void 0 : _a.config) === true)
        optionParts.push("/config");
    if (((_b = cfg === null || cfg === void 0 ? void 0 : cfg.commands) === null || _b === void 0 ? void 0 : _b.debug) === true)
...
function formatCommandEntry(command) {
    ...
    var primary = command.nativeName
        ...
        : ((_a = command.textAliases[0]) === null || _a === void 0 ? void 0 : _a.trim()) || "/".concat(command.key);
    var seen = new Set();
    var aliases = command.textAliases
        .map(function (alias) { return alias.trim(); })
        .filter(Boolean)
        .filter(function (alias) { return alias.toLowerCase() !== primary.toLowerCase(); })
    ...
    return "".concat(primary).concat(aliasLabel).concat(scopeLabel, " - ").concat(command.description);
}
...
function buildCommandsMessagePaginated(cfg, skillCommands, options) {
    var _a, _b;
    var page = Math.max(1, (_a = options === null || options === void 0 ? void 0 : options.page) !== null && _a !== void 0 ? _a : 1);
    var surface = (_b = options === null || options === void 0 ? void 0 : options.surface) === null || _b === void 0 ? void 0 : _b.toLowerCase();
