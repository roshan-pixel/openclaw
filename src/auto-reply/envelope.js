...
function resolveEnvelopeFormatOptions(cfg) {
    ...
    return {
        ...
        includeTimestamp: (defaults === null || defaults === void 0 ? void 0 : defaults.envelopeTimestamp) !== "off",
        includeElapsed: (defaults === null || defaults === void 0 ? void 0 : defaults.envelopeElapsed) !== "off",
        userTimezone: defaults === null || defaults === void 0 ? void 0 : defaults.userTimezone,
    };
}
function normalizeEnvelopeOptions(options) {
    var _a;
    var includeTimestamp = (options === null || options === void 0 ? void 0 : options.includeTimestamp) !== false;
    var includeElapsed = (options === null || options === void 0 ? void 0 : options.includeElapsed) !== false;
    return {
        timezone: ((_a = options === null || options === void 0 ? void 0 : options.timezone) === null || _a === void 0 ? void 0 : _a.trim()) || "local",
...
function resolveEnvelopeTimezone(options) {
    ...
    if (lowered === "local" || lowered === "host")
        return { mode: "local" };
    if (lowered === "user") {
        return { mode: "iana", timeZone: (0, date_time_js_1.resolveUserTimezone)(options.userTimezone) };
    }
...
function formatAgentEnvelope(params) {
    ...
    var elapsed = resolved.includeElapsed && params.timestamp && params.previousTimestamp
...
function formatInboundEnvelope(params) {
    ...
    var resolvedSender = ((_a = params.senderLabel) === null || _a === void 0 ? void 0 : _a.trim()) || (0, sender_label_js_1.resolveSenderLabel)((_b = params.sender) !== null && _b !== void 0 ? _b : {});
    var body = !isDirect && resolvedSender ? "".concat(resolvedSender, ": ").concat(params.body) : params.body;
