...
function formatMediaAttachedLine(params) {
    var _a, _b;
    var prefix = typeof params.index === "number" && typeof params.total === "number"
        ? "[media attached ".concat(params.index, "/").concat(params.total, ": ")
        : "[media attached: ";
    var typePart = ((_a = params.type) === null || _a === void 0 ? void 0 : _a.trim()) ? " (".concat(params.type.trim(), ")") : "";
...
function buildInboundMediaNote(ctx) {
    ...
    if (Array.isArray(ctx.MediaUnderstandingDecisions)) {
        for (var _h = 0, _j = ctx.MediaUnderstandingDecisions; _h < _j.length; _h++) {
            ...
            for (var _k = 0, _l = decision.attachments; _k < _l.length; _k++) {
                ...
                if (((_a = attachment.chosen) === null || _a === void 0 ? void 0 : _a.outcome) === "success") {
    ...
    var paths = pathsFromArray && pathsFromArray.length > 0
        ? pathsFromArray
    ...
    if (paths.length === 0)
        return undefined;
    var urls = Array.isArray(ctx.MediaUrls) && ctx.MediaUrls.length === paths.length
        ? ctx.MediaUrls
        : undefined;
    var types = Array.isArray(ctx.MediaTypes) && ctx.MediaTypes.length === paths.length
        ? ctx.MediaTypes
        : undefined;
    var entries = paths
        ...
        return ({
            ...
            type: (_a = types === null || types === void 0 ? void 0 : types[index]) !== null && _a !== void 0 ? _a : ctx.MediaType,
            url: (_b = urls === null || urls === void 0 ? void 0 : urls[index]) !== null && _b !== void 0 ? _b : ctx.MediaUrl,
            index: index,
        });
    })
        .filter(function (entry) { return !suppressed.has(entry.index); });
    if (entries.length === 0)
        return undefined;
    if (entries.length === 1) {
        return formatMediaAttachedLine({
            path: (_d = (_c = entries[0]) === null || _c === void 0 ? void 0 : _c.path) !== null && _d !== void 0 ? _d : "",
    ...
    for (var _m = 0, _o = entries.entries(); _m < _o.length; _m++) {
        var _p = _o[_m], idx = _p[0], entry = _p[1];
        lines.push(formatMediaAttachedLine({
            path: entry.path,
            index: idx + 1,
            total: count,
            type: entry.type,
