...
var XHIGH_MODEL_SET = new Set(exports.XHIGH_MODEL_REFS.map(function (entry) { return entry.toLowerCase(); }));
var XHIGH_MODEL_IDS = new Set(exports.XHIGH_MODEL_REFS.map(function (entry) { var _a; return (_a = entry.split("/")[1]) === null || _a === void 0 ? void 0 : _a.toLowerCase(); }).filter(function (entry) { return Boolean(entry); }));
...
function supportsXHighThinking(provider, model) {
    ...
    if (!modelKey)
        return false;
    var providerKey = provider === null || provider === void 0 ? void 0 : provider.trim().toLowerCase();
    if (providerKey) {
