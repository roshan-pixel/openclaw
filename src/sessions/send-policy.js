...
function resolveSendPolicy(params) {
    ...
    var override = normalizeSendPolicy((_a = params.entry) === null || _a === void 0 ? void 0 : _a.sendPolicy);
    if (override)
        return override;
    var policy = (_b = params.cfg.session) === null || _b === void 0 ? void 0 : _b.sendPolicy;
    if (!policy)
        return "allow";
    var channel = (_g = (_e = (_c = normalizeMatchValue(params.channel)) !== null && _c !== void 0 ? _c : normalizeMatchValue((_d = params.entry) === null || _d === void 0 ? void 0 : _d.channel)) !== null && _e !== void 0 ? _e : normalizeMatchValue((_f = params.entry) === null || _f === void 0 ? void 0 : _f.lastChannel)) !== null && _g !== void 0 ? _g : deriveChannelFromKey(params.sessionKey);
    var chatType = (_k = (0, chat_type_js_1.normalizeChatType)((_h = params.chatType) !== null && _h !== void 0 ? _h : (_j = params.entry) === null || _j === void 0 ? void 0 : _j.chatType)) !== null && _k !== void 0 ? _k : (0, chat_type_js_1.normalizeChatType)(deriveChatTypeFromKey(params.sessionKey));
    var sessionKey = (_l = params.sessionKey) !== null && _l !== void 0 ? _l : "";
    var allowedMatch = false;
    for (var _i = 0, _q = (_m = policy.rules) !== null && _m !== void 0 ? _m : []; _i < _q.length; _i++) {
        var rule = _q[_i];
        if (!rule)
            continue;
