...
function isSubagentSessionKey(sessionKey) {
    ...
    return Boolean(((_a = parsed === null || parsed === void 0 ? void 0 : parsed.rest) !== null && _a !== void 0 ? _a : "").toLowerCase().startsWith("subagent:"));
}
function isAcpSessionKey(sessionKey) {
    ...
    if (normalized.startsWith("acp:"))
        return true;
    var parsed = parseAgentSessionKey(raw);
    return Boolean(((_a = parsed === null || parsed === void 0 ? void 0 : parsed.rest) !== null && _a !== void 0 ? _a : "").toLowerCase().startsWith("acp:"));
}
...
function resolveThreadParentSessionKey(sessionKey) {
    ...
    var normalized = raw.toLowerCase();
    var idx = -1;
    for (var _i = 0, THREAD_SESSION_MARKERS_1 = THREAD_SESSION_MARKERS; _i < THREAD_SESSION_MARKERS_1.length; _i++) {
