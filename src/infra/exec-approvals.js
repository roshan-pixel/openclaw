...
function mergeLegacyAgent(current, legacy) {
    ...
    for (var _i = 0, _g = (_a = current.allowlist) !== null && _a !== void 0 ? _a : []; _i < _g.length; _i++) {
        var entry = _g[_i];
        pushEntry(entry);
    }
    for (var _h = 0, _j = (_b = legacy.allowlist) !== null && _b !== void 0 ? _b : []; _h < _j.length; _h++) {
        var entry = _j[_h];
        pushEntry(entry);
    }
    return {
        ...
        autoAllowSkills: (_f = current.autoAllowSkills) !== null && _f !== void 0 ? _f : legacy.autoAllowSkills,
...
function normalizeExecApprovals(file) {
    ...
    var token = (_d = (_c = file.socket) === null || _c === void 0 ? void 0 : _c.token) === null || _d === void 0 ? void 0 : _d.trim();
    var agents = __assign({}, file.agents);
    var legacyDefault = agents.default;
    if (legacyDefault) {
        var main = agents[session_key_js_1.DEFAULT_AGENT_ID];
        agents[session_key_js_1.DEFAULT_AGENT_ID] = main ? mergeLegacyAgent(main, legacyDefault) : legacyDefault;
        delete agents.default;
    }
    for (var _i = 0, _j = Object.entries(agents); _i < _j.length; _i++) {
        var _k = _j[_i], key = _k[0], agent = _k[1];
...
function readExecApprovalsSnapshot() {
    ...
    var file = (parsed === null || parsed === void 0 ? void 0 : parsed.version) === 1
...
function ensureExecApprovals() {
    ...
    var socketPath = (_b = (_a = next.socket) === null || _a === void 0 ? void 0 : _a.path) === null || _b === void 0 ? void 0 : _b.trim();
    var token = (_d = (_c = next.socket) === null || _c === void 0 ? void 0 : _c.token) === null || _d === void 0 ? void 0 : _d.trim();
    var updated = __assign(__assign({}, next), { socket: {
...
function resolveExecApprovals(agentId, overrides) {
    ...
    return resolveExecApprovalsFromFile({
        ...
        socketPath: expandHome((_b = (_a = file.socket) === null || _a === void 0 ? void 0 : _a.path) !== null && _b !== void 0 ? _b : resolveExecApprovalsSocketPath()),
        token: (_d = (_c = file.socket) === null || _c === void 0 ? void 0 : _c.token) !== null && _d !== void 0 ? _d : "",
    });
}
function resolveExecApprovalsFromFile(params) {
    ...
    var agentKey = (_b = params.agentId) !== null && _b !== void 0 ? _b : session_key_js_1.DEFAULT_AGENT_ID;
    var agent = (_d = (_c = file.agents) === null || _c === void 0 ? void 0 : _c[agentKey]) !== null && _d !== void 0 ? _d : {};
    var wildcard = (_f = (_e = file.agents) === null || _e === void 0 ? void 0 : _e["*"]) !== null && _f !== void 0 ? _f : {};
    var fallbackSecurity = (_h = (_g = params.overrides) === null || _g === void 0 ? void 0 : _g.security) !== null && _h !== void 0 ? _h : DEFAULT_SECURITY;
    var fallbackAsk = (_k = (_j = params.overrides) === null || _j === void 0 ? void 0 : _j.ask) !== null && _k !== void 0 ? _k : DEFAULT_ASK;
    var fallbackAskFallback = (_m = (_l = params.overrides) === null || _l === void 0 ? void 0 : _l.askFallback) !== null && _m !== void 0 ? _m : DEFAULT_ASK_FALLBACK;
    var fallbackAutoAllowSkills = (_p = (_o = params.overrides) === null || _o === void 0 ? void 0 : _o.autoAllowSkills) !== null && _p !== void 0 ? _p : DEFAULT_AUTO_ALLOW_SKILLS;
    var resolvedDefaults = {
        security: normalizeSecurity(defaults.security, fallbackSecurity),
        ask: normalizeAsk(defaults.ask, fallbackAsk),
        askFallback: normalizeSecurity((_q = defaults.askFallback) !== null && _q !== void 0 ? _q : fallbackAskFallback, fallbackAskFallback),
        autoAllowSkills: Boolean((_r = defaults.autoAllowSkills) !== null && _r !== void 0 ? _r : fallbackAutoAllowSkills),
    };
    var resolvedAgent = {
        security: normalizeSecurity((_t = (_s = agent.security) !== null && _s !== void 0 ? _s : wildcard.security) !== null && _t !== void 0 ? _t : resolvedDefaults.security, resolvedDefaults.security),
        ask: normalizeAsk((_v = (_u = agent.ask) !== null && _u !== void 0 ? _u : wildcard.ask) !== null && _v !== void 0 ? _v : resolvedDefaults.ask, resolvedDefaults.ask),
        askFallback: normalizeSecurity((_x = (_w = agent.askFallback) !== null && _w !== void 0 ? _w : wildcard.askFallback) !== null && _x !== void 0 ? _x : resolvedDefaults.askFallback, resolvedDefaults.askFallback),
        autoAllowSkills: Boolean((_z = (_y = agent.autoAllowSkills) !== null && _y !== void 0 ? _y : wildcard.autoAllowSkills) !== null && _z !== void 0 ? _z : resolvedDefaults.autoAllowSkills),
    };
    var allowlist = __spreadArray(__spreadArray([], (Array.isArray(wildcard.allowlist) ? wildcard.allowlist : []), true), (Array.isArray(agent.allowlist) ? agent.allowlist : []), true);
    return {
        path: (_0 = params.path) !== null && _0 !== void 0 ? _0 : resolveExecApprovalsPath(),
        socketPath: expandHome((_3 = (_1 = params.socketPath) !== null && _1 !== void 0 ? _1 : (_2 = file.socket) === null || _2 === void 0 ? void 0 : _2.path) !== null && _3 !== void 0 ? _3 : resolveExecApprovalsSocketPath()),
        token: (_6 = (_4 = params.token) !== null && _4 !== void 0 ? _4 : (_5 = file.socket) === null || _5 === void 0 ? void 0 : _5.token) !== null && _6 !== void 0 ? _6 : "",
...
function resolveExecutablePath(rawExecutable, cwd, env) {
    ...
    var envPath = (_d = (_c = (_b = (_a = env === null || env === void 0 ? void 0 : env.PATH) !== null && _a !== void 0 ? _a : env === null || env === void 0 ? void 0 : env.Path) !== null && _b !== void 0 ? _b : process.env.PATH) !== null && _c !== void 0 ? _c : process.env.Path) !== null && _d !== void 0 ? _d : "";
    var entries = envPath.split(node_path_1.default.delimiter).filter(Boolean);
    var hasExtension = process.platform === "win32" && node_path_1.default.extname(expanded).length > 0;
    var extensions = process.platform === "win32"
        ? hasExtension
            ? [""]
            : ((_h = (_g = (_f = (_e = env === null || env === void 0 ? void 0 : env.PATHEXT) !== null && _e !== void 0 ? _e : env === null || env === void 0 ? void 0 : env.Pathext) !== null && _f !== void 0 ? _f : process.env.PATHEXT) !== null && _g !== void 0 ? _g : process.env.Pathext) !== null && _h !== void 0 ? _h : ".EXE;.CMD;.BAT;.COM")
                .split(";")
...
function resolveCommandResolution(command, cwd, env) {
    ...
    return { rawExecutable: rawExecutable, resolvedPath: resolvedPath, executableName: executableName };
}
...
function matchAllowlist(entries, resolution) {
    var _a;
    if (!entries.length || !(resolution === null || resolution === void 0 ? void 0 : resolution.resolvedPath))
        return null;
...
function analyzeArgvCommand(params) {
    var argv = params.argv.filter(function (entry) { return entry.trim().length > 0; });
    if (argv.length === 0) {
...
function isSafeBinUsage(params) {
    ...
    var execName = (_a = resolution === null || resolution === void 0 ? void 0 : resolution.executableName) === null || _a === void 0 ? void 0 : _a.toLowerCase();
    if (!execName)
        return false;
    var matchesSafeBin = params.safeBins.has(execName) ||
...
function evaluateSegments(segments, params) {
    var _a, _b;
    var matches = [];
    var allowSkills = params.autoAllowSkills === true && ((_b = (_a = params.skillBins) === null || _a === void 0 ? void 0 : _a.size) !== null && _b !== void 0 ? _b : 0) > 0;
    var satisfied = segments.every(function (segment) {
        ...
        var candidateResolution = candidatePath && segment.resolution
            ? __assign(__assign({}, segment.resolution), { resolvedPath: candidatePath }) : segment.resolution;
        ...
        var skillAllow = allowSkills && ((_a = segment.resolution) === null || _a === void 0 ? void 0 : _a.executableName)
            ? (_b = params.skillBins) === null || _b === void 0 ? void 0 : _b.has(segment.resolution.executableName)
            : false;
...
function recordAllowlistUse(approvals, agentId, entry, command, resolvedPath) {
    ...
    var nextAllowlist = allowlist.map(function (item) {
        ...
        return item.pattern === entry.pattern
            ? __assign(__assign({}, item), { id: (_a = item.id) !== null && _a !== void 0 ? _a : node_crypto_1.default.randomUUID(), lastUsedAt: Date.now(), lastUsedCommand: command, lastResolvedPath: resolvedPath }) : item;
    });
...
function addAllowlistEntry(approvals, agentId, pattern) {
    ...
    if (!trimmed)
        return;
    if (allowlist.some(function (entry) { return entry.pattern === trimmed; }))
        return;
    allowlist.push({ id: node_crypto_1.default.randomUUID(), pattern: trimmed, lastUsedAt: Date.now() });
            ...
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, new Promise(function (resolve) {
                            ...
                            var timer = setTimeout(function () { return finish(null); }, timeoutMs);
                            ...
                            client.on("error", function () { return finish(null); });
                            ...
                            client.on("data", function (data) {
                                ...
                                while (idx !== -1) {
                                    ...
                                    try {
                                        ...
                                        if ((msg === null || msg === void 0 ? void 0 : msg.type) === "decision" && msg.decision) {
                                            clearTimeout(timer);
                                            finish(msg.decision);
                                            return;
                                        }
