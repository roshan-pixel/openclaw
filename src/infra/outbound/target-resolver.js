...
function formatTargetDisplay(params) {
    ...
    if ((_a = plugin === null || plugin === void 0 ? void 0 : plugin.messaging) === null || _a === void 0 ? void 0 : _a.formatTargetDisplay) {
    ...
    var kind = (_c = params.kind) !== null && _c !== void 0 ? _c : (lowered.startsWith("user:") ? "user" : lowered.startsWith("channel:") ? "group" : undefined);
    if (display) {
...
function matchesDirectoryEntry(params) {
    ...
    var candidates = [id, name, handle].map(function (value) { return normalizeQuery(value); }).filter(Boolean);
    return candidates.some(function (value) { return value === query || value.includes(query); });
}
        ...
        return __generator(this, function (_h) {
            switch (_h.label) {
                case 0:
                    ...
                    if (!directory)
                        return [2 /*return*/, []];
                    runtime = (_a = params.runtime) !== null && _a !== void 0 ? _a : runtime_js_1.defaultRuntime;
                    useLive = params.source === "live";
                    if (!(params.kind === "user")) return [3 /*break*/, 2];
                    fn_1 = useLive ? ((_b = directory.listPeersLive) !== null && _b !== void 0 ? _b : directory.listPeers) : directory.listPeers;
                    if (!fn_1)
                        return [2 /*return*/, []];
                    return [4 /*yield*/, fn_1({
                            cfg: params.cfg,
                ...
                case 2:
                    fn = useLive ? ((_e = directory.listGroupsLive) !== null && _e !== void 0 ? _e : directory.listGroups) : directory.listGroups;
                    if (!fn)
                        return [2 /*return*/, []];
                    return [4 /*yield*/, fn({
                            cfg: params.cfg,
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, listDirectoryEntries({
                            cfg: params.cfg,
                            channel: params.channel,
                            accountId: params.accountId,
                            kind: params.kind,
...
function pickAmbiguousMatch(entries, mode) {
    ...
    var ranked = entries.map(function (entry) { return ({
        entry: entry,
        rank: typeof entry.rank === "number" ? entry.rank : 0,
    }); });
    var bestRank = Math.max.apply(Math, ranked.map(function (item) { return item.rank; }));
    var best = (_b = ranked.find(function (item) { return item.rank === bestRank; })) === null || _b === void 0 ? void 0 : _b.entry;
    return (_c = best !== null && best !== void 0 ? best : entries[0]) !== null && _c !== void 0 ? _c : null;
}
function resolveMessagingTarget(params) {
    return __awaiter(this, void 0, void 0, function () {
        var raw, plugin, providerLabel, hint, kind, normalized, looksLikeTargetId, directTarget, query, entries, match, entry, mode, best, directTarget;
        ...
        return __generator(this, function (_l) {
            switch (_l.label) {
                case 0:
                    ...
                    plugin = (0, index_js_1.getChannelPlugin)(params.channel);
                    providerLabel = (_b = (_a = plugin === null || plugin === void 0 ? void 0 : plugin.meta) === null || _a === void 0 ? void 0 : _a.label) !== null && _b !== void 0 ? _b : params.channel;
                    hint = (_d = (_c = plugin === null || plugin === void 0 ? void 0 : plugin.messaging) === null || _c === void 0 ? void 0 : _c.targetResolver) === null || _d === void 0 ? void 0 : _d.hint;
                    kind = detectTargetKind(params.channel, raw, params.preferredKind);
                    normalized = (_e = (0, target_normalization_js_1.normalizeTargetForProvider)(params.channel, raw)) !== null && _e !== void 0 ? _e : raw;
                    looksLikeTargetId = function () {
                        var _a, _b;
                        var trimmed = raw.trim();
                        if (!trimmed)
                            return false;
                        var lookup = (_b = (_a = plugin === null || plugin === void 0 ? void 0 : plugin.messaging) === null || _a === void 0 ? void 0 : _a.targetResolver) === null || _b === void 0 ? void 0 : _b.looksLikeId;
                        if (lookup)
                    ...
                    return [4 /*yield*/, getDirectoryEntries({
                            cfg: params.cfg,
                            channel: params.channel,
                            accountId: params.accountId,
                    ...
                    if (match.kind === "single") {
                        ...
                        return [2 /*return*/, {
                                ...
                                target: {
                                    ...
                                    kind: kind,
                                    display: (_g = (_f = entry.name) !== null && _f !== void 0 ? _f : entry.handle) !== null && _g !== void 0 ? _g : stripTargetPrefixes(entry.id),
                                    source: "directory",
                                },
                            }];
                    }
                            ...
                            if (best) {
                                return [2 /*return*/, {
                                        ...
                                        target: {
                                            ...
                                            kind: kind,
                                            display: (_k = (_j = best.name) !== null && _j !== void 0 ? _j : best.handle) !== null && _k !== void 0 ? _k : stripTargetPrefixes(best.id),
                                            source: "directory",
                                        },
                                    }];
                            }
...
function lookupDirectoryDisplay(params) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                    normalized = (_b = (0, target_normalization_js_1.normalizeTargetForProvider)(params.channel, params.targetId)) !== null && _b !== void 0 ? _b : params.targetId;
                ...
                case 1:
                    ...
                    findMatch = function (candidates) {
                        return candidates.find(function (candidate) { return normalizeDirectoryEntryId(params.channel, candidate) === normalized; });
                    };
                    entry = (_c = findMatch(groups)) !== null && _c !== void 0 ? _c : findMatch(users);
                    return [2 /*return*/, (_e = (_d = entry === null || entry === void 0 ? void 0 : entry.name) !== null && _d !== void 0 ? _d : entry === null || entry === void 0 ? void 0 : entry.handle) !== null && _e !== void 0 ? _e : undefined];
            }
        });
    });
}
