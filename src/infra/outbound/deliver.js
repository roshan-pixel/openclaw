...
Object.defineProperty(exports, "normalizeOutboundPayloads", { enumerable: true, get: function () { return payloads_js_2.normalizeOutboundPayloads; } });
...
function createChannelHandler(params) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, load_js_1.loadChannelOutboundAdapter)(params.channel)];
                case 1:
                    outbound = _a.sent();
                    if (!(outbound === null || outbound === void 0 ? void 0 : outbound.sendText) || !(outbound === null || outbound === void 0 ? void 0 : outbound.sendMedia)) {
...
function createPluginHandler(params) {
    ...
    return {
        ...
        sendPayload: outbound.sendPayload
            ? function (payload) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    return [2 /*return*/, outbound.sendPayload({
                            cfg: params.cfg,
                            to: params.to,
            ...
            : undefined,
        sendText: function (text) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, sendText({
                        cfg: params.cfg,
                        to: params.to,
                        text: text,
                        accountId: params.accountId,
        ...
        sendMedia: function (caption, mediaUrl) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, sendMedia({
                        cfg: params.cfg,
                        to: params.to,
                        text: caption,
                        mediaUrl: mediaUrl,
...
function deliverOutboundPayloads(params) {
    return __awaiter(this, void 0, void 0, function () {
        var cfg, channel, to, payloads, accountId, deps, abortSignal, sendSignal, results, handler, textLimit, chunkMode, isSignalChannel, signalTableMode, signalMaxBytes, sendTextChunks, sendSignalText, sendSignalTextChunks, sendSignalMedia, normalizedPayloads, _i, normalizedPayloads_1, payload, payloadSummary, _a, _b, first, _c, _d, url, caption, _e, _f, _g, _h, err_1, mirrorText;
        var _this = this;
        var _j, _k, _l, _m, _o, _p;
        return __generator(this, function (_q) {
            switch (_q.label) {
                case 0:
                    cfg = params.cfg, channel = params.channel, to = params.to, payloads = params.payloads;
                    accountId = params.accountId;
                    deps = params.deps;
                    abortSignal = params.abortSignal;
                    sendSignal = (_k = (_j = params.deps) === null || _j === void 0 ? void 0 : _j.sendSignal) !== null && _k !== void 0 ? _k : send_js_1.sendMessageSignal;
                    results = [];
                    return [4 /*yield*/, createChannelHandler({
                            cfg: cfg,
                            channel: channel,
                            to: to,
                            deps: deps,
                ...
                case 1:
                    ...
                    textLimit = handler.chunker
                        ...
                        : undefined;
                    chunkMode = handler.chunker ? (0, chunk_js_1.resolveChunkMode)(cfg, channel, accountId) : "length";
                    isSignalChannel = channel === "signal";
                    signalTableMode = isSignalChannel
                        ? (0, markdown_tables_js_1.resolveMarkdownTableMode)({ cfg: cfg, channel: "signal", accountId: accountId })
                        : "code";
                    signalMaxBytes = isSignalChannel
                        ...
                        : undefined;
                    sendTextChunks = function (text) { return __awaiter(_this, void 0, void 0, function () {
                        var _a, _b, mode, blockChunks, _i, blockChunks_1, blockChunk, chunks_3, _c, chunks_1, chunk, _d, _e, chunks, _f, chunks_2, chunk, _g, _h;
                        var _j;
                        return __generator(this, function (_k) {
                            switch (_k.label) {
                                case 0:
                                    throwIfAborted(abortSignal);
                                    if (!(!handler.chunker || textLimit === undefined)) return [3 /*break*/, 2];
                                    _b = (_a = results).push;
                                ...
                                case 1:
                                    ...
                                    return [2 /*return*/];
                                case 2:
                                    if (!(chunkMode === "newline")) return [3 /*break*/, 9];
                                    mode = (_j = handler.chunkerMode) !== null && _j !== void 0 ? _j : "text";
                                    blockChunks = mode === "markdown"
                                    ...
                                    _k.label = 3;
                                case 3:
                                    if (!(_i < blockChunks_1.length)) return [3 /*break*/, 8];
                                ...
                                case 9:
                                    ...
                                    _k.label = 10;
                                case 10:
                                    if (!(_f < chunks_2.length)) return [3 /*break*/, 13];
                                    chunk = chunks_2[_f];
                                    throwIfAborted(abortSignal);
                                    _h = (_g = results).push;
                                    return [4 /*yield*/, handler.sendText(chunk)];
                    ...
                    sendSignalText = function (text, styles) { return __awaiter(_this, void 0, void 0, function () {
                        var _a;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    throwIfAborted(abortSignal);
                                    _a = [{ channel: "signal" }];
                                    return [4 /*yield*/, sendSignal(to, text, {
                    ...
                    sendSignalTextChunks = function (text) { return __awaiter(_this, void 0, void 0, function () {
                        var signalChunks, _i, signalChunks_1, chunk, _a, _b;
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                case 0:
                                    throwIfAborted(abortSignal);
                                    signalChunks = textLimit === undefined
                                        ? (0, format_js_1.markdownToSignalTextChunks)(text, Number.POSITIVE_INFINITY, {
                                            tableMode: signalTableMode,
                                        })
                                        : (0, format_js_1.markdownToSignalTextChunks)(text, textLimit, { tableMode: signalTableMode });
                                    ...
                                    _c.label = 1;
                                case 1:
                                    if (!(_i < signalChunks_1.length)) return [3 /*break*/, 4];
                    ...
                    sendSignalMedia = function (caption, mediaUrl) { return __awaiter(_this, void 0, void 0, function () {
                        var formatted, _a;
                        var _b;
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                case 0:
                                    throwIfAborted(abortSignal);
                                    formatted = (_b = (0, format_js_1.markdownToSignalTextChunks)(caption, Number.POSITIVE_INFINITY, {
                                        tableMode: signalTableMode,
                                    })[0]) !== null && _b !== void 0 ? _b : {
                                        text: caption,
                                        styles: [],
                                    ...
                                    _a = [{ channel: "signal" }];
                                    return [4 /*yield*/, sendSignal(to, formatted.text, {
                                            mediaUrl: mediaUrl,
                                            maxBytes: signalMaxBytes,
                                            accountId: accountId !== null && accountId !== void 0 ? accountId : undefined,
                                            textMode: "plain",
                                ...
                                case 1: return [2 /*return*/, __assign.apply(void 0, _a.concat([(_c.sent())]))];
                            }
                        });
                    }); };
                    ...
                    _q.label = 2;
                case 2:
                    if (!(_i < normalizedPayloads_1.length)) return [3 /*break*/, 19];
                    payload = normalizedPayloads_1[_i];
                    payloadSummary = {
                        text: (_l = payload.text) !== null && _l !== void 0 ? _l : "",
                        mediaUrls: (_m = payload.mediaUrls) !== null && _m !== void 0 ? _m : (payload.mediaUrl ? [payload.mediaUrl] : []),
                ...
                case 3:
                    ...
                    throwIfAborted(abortSignal);
                    (_o = params.onPayload) === null || _o === void 0 ? void 0 : _o.call(params, payloadSummary);
                    if (!(handler.sendPayload && payload.channelData)) return [3 /*break*/, 5];
                    _b = (_a = results).push;
                ...
                case 4:
                    ...
                    return [3 /*break*/, 18];
                case 5:
                    if (!(payloadSummary.mediaUrls.length === 0)) return [3 /*break*/, 10];
                    if (!isSignalChannel) return [3 /*break*/, 7];
                    return [4 /*yield*/, sendSignalTextChunks(payloadSummary.text)];
                case 6:
                    _q.sent();
                    return [3 /*break*/, 9];
                case 7: return [4 /*yield*/, sendTextChunks(payloadSummary.text)];
                case 8:
                    _q.sent();
                    _q.label = 9;
                ...
                case 11:
                    ...
                    first = false;
                    if (!isSignalChannel) return [3 /*break*/, 13];
                    _f = (_e = results).push;
                ...
                case 17:
                    ...
                    if (!params.bestEffort)
                        throw err_1;
                    (_p = params.onError) === null || _p === void 0 ? void 0 : _p.call(params, err_1, payloadSummary);
                    return [3 /*break*/, 18];
                case 18:
                    _i++;
                    return [3 /*break*/, 2];
                case 19:
                    if (!(params.mirror && results.length > 0)) return [3 /*break*/, 21];
                    mirrorText = (0, sessions_js_1.resolveMirroredTranscriptText)({
                        text: params.mirror.text,
                        mediaUrls: params.mirror.mediaUrls,
                    });
                    if (!mirrorText) return [3 /*break*/, 21];
                    return [4 /*yield*/, (0, sessions_js_1.appendAssistantMessageToSessionTranscript)({
