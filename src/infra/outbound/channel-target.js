...
exports.CHANNEL_TARGET_DESCRIPTION = "Recipient/channel: E.164 for WhatsApp/Signal, Telegram chat id/@username, Discord/Slack channel/user, or iMessage handle/chat_id";
exports.CHANNEL_TARGETS_DESCRIPTION = "Recipient/channel targets (same format as --target); accepts ids or names when the directory is available.";
function applyTargetToParams(params) {
    ...
    var mode = (_a = message_action_spec_js_1.MESSAGE_ACTION_TARGET_MODE[params.action]) !== null && _a !== void 0 ? _a : "none";
    if (mode !== "none") {
