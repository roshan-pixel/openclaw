...
function applyCrossContextMessageDecoration(_a) {
    var _b;
    var params = _a.params, message = _a.message, decoration = _a.decoration, preferEmbeds = _a.preferEmbeds;
...
function maybeApplyCrossContextMarker(params) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    if (!(0, outbound_policy_js_1.shouldApplyCrossContextMarker)(params.action) || !params.toolContext) {
                        return [2 /*return*/, params.message];
                    }
                    return [4 /*yield*/, (0, outbound_policy_js_1.buildCrossContextDecoration)({
                            cfg: params.cfg,
                ...
                case 1:
                    ...
                    if (!decoration)
                        return [2 /*return*/, params.message];
                    return [2 /*return*/, applyCrossContextMessageDecoration({
                            params: params.args,
...
function resolveSlackAutoThreadId(params) {
    ...
    if (!(context === null || context === void 0 ? void 0 : context.currentThreadTs) || !context.currentChannelId)
        return undefined;
    ...
    if (parsedTarget.id.toLowerCase() !== context.currentChannelId.toLowerCase())
        return undefined;
    if (context.replyToMode === "first" && ((_a = context.hasRepliedRef) === null || _a === void 0 ? void 0 : _a.value))
        return undefined;
    return context.currentThreadTs;
}
function resolveAttachmentMaxBytes(params) {
    var _a, _b, _c, _d, _e, _f, _g;
    var fallback = (_b = (_a = params.cfg.agents) === null || _a === void 0 ? void 0 : _a.defaults) === null || _b === void 0 ? void 0 : _b.mediaMaxMb;
    ...
    var channelObj = channelCfg && typeof channelCfg === "object"
        ? channelCfg
        : undefined;
    var channelMediaMax = typeof (channelObj === null || channelObj === void 0 ? void 0 : channelObj.mediaMaxMb) === "number" ? channelObj.mediaMaxMb : undefined;
    var accountsObj = (channelObj === null || channelObj === void 0 ? void 0 : channelObj.accounts) && typeof channelObj.accounts === "object"
        ? channelObj.accounts
        : undefined;
    var accountCfg = accountId && accountsObj ? accountsObj[accountId] : undefined;
    var accountMediaMax = accountCfg && typeof accountCfg === "object"
        ? accountCfg.mediaMaxMb
        : undefined;
    var limitMb = (_e = (_d = (typeof accountMediaMax === "number" ? accountMediaMax : undefined)) !== null && _d !== void 0 ? _d : channelMediaMax) !== null && _e !== void 0 ? _e : (_g = (_f = params.cfg.agents) === null || _f === void 0 ? void 0 : _f.defaults) === null || _g === void 0 ? void 0 : _g.mediaMaxMb;
...
function normalizeBase64Payload(params) {
    ...
    if (!match)
        return { base64: params.base64, contentType: params.contentType };
    var mime = match[1], payload = match[2];
    return {
        base64: payload,
...
function hydrateSetGroupIconParams(params) {
    return __awaiter(this, void 0, void 0, function () {
        var mediaHint, fileHint, contentTypeParam, rawBuffer, normalized, filename, mediaSource, maxBytes, media;
        var _a, _b, _c, _d, _e;
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                    ...
                    fileHint = (_a = (0, common_js_1.readStringParam)(params.args, "path", { trim: false })) !== null && _a !== void 0 ? _a : (0, common_js_1.readStringParam)(params.args, "filePath", { trim: false });
                    contentTypeParam = (_b = (0, common_js_1.readStringParam)(params.args, "contentType")) !== null && _b !== void 0 ? _b : (0, common_js_1.readStringParam)(params.args, "mimeType");
                    rawBuffer = (0, common_js_1.readStringParam)(params.args, "buffer", { trim: false });
                    normalized = normalizeBase64Payload({
                        base64: rawBuffer,
                        contentType: contentTypeParam !== null && contentTypeParam !== void 0 ? contentTypeParam : undefined,
                    });
                    ...
                    if (!(!params.dryRun && !(0, common_js_1.readStringParam)(params.args, "buffer", { trim: false }) && mediaSource)) return [3 /*break*/, 2];
                ...
                case 1:
                    ...
                    if (!filename) {
                        params.args.filename = inferAttachmentFilename({
                            ...
                            contentType: (_e = (_d = media.contentType) !== null && _d !== void 0 ? _d : contentTypeParam) !== null && _e !== void 0 ? _e : undefined,
                        });
                    }
                    return [3 /*break*/, 3];
                case 2:
...
function hydrateSendAttachmentParams(params) {
    return __awaiter(this, void 0, void 0, function () {
        var mediaHint, fileHint, contentTypeParam, caption, message, rawBuffer, normalized, filename, mediaSource, maxBytes, media;
        var _a, _b, _c, _d, _e, _f, _g;
        return __generator(this, function (_h) {
            switch (_h.label) {
                case 0:
                    ...
                    fileHint = (_a = (0, common_js_1.readStringParam)(params.args, "path", { trim: false })) !== null && _a !== void 0 ? _a : (0, common_js_1.readStringParam)(params.args, "filePath", { trim: false });
                    contentTypeParam = (_b = (0, common_js_1.readStringParam)(params.args, "contentType")) !== null && _b !== void 0 ? _b : (0, common_js_1.readStringParam)(params.args, "mimeType");
                    caption = (_c = (0, common_js_1.readStringParam)(params.args, "caption", { allowEmpty: true })) === null || _c === void 0 ? void 0 : _c.trim();
                    message = (_d = (0, common_js_1.readStringParam)(params.args, "message", { allowEmpty: true })) === null || _d === void 0 ? void 0 : _d.trim();
                    if (!caption && message)
                ...
                case 1:
                    ...
                    if (!filename) {
                        params.args.filename = inferAttachmentFilename({
                            ...
                            contentType: (_g = (_f = media.contentType) !== null && _f !== void 0 ? _f : contentTypeParam) !== null && _g !== void 0 ? _g : undefined,
                        });
                    }
                    return [3 /*break*/, 3];
                case 2:
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    if (!toRaw) return [3 /*break*/, 2];
                    return [4 /*yield*/, (0, target_resolver_js_1.resolveChannelTarget)({
                            cfg: params.cfg,
                            channel: params.channel,
                            input: toRaw,
                            accountId: (_a = params.accountId) !== null && _a !== void 0 ? _a : undefined,
                ...
                case 1:
                    ...
                    _c.label = 2;
                case 2:
                    channelIdRaw = typeof params.args.channelId === "string" ? params.args.channelId.trim() : "";
                    if (!channelIdRaw) return [3 /*break*/, 4];
                    return [4 /*yield*/, (0, target_resolver_js_1.resolveChannelTarget)({
                            cfg: params.cfg,
                            channel: params.channel,
                            input: channelIdRaw,
                ...
                case 3:
                    ...
                    _c.label = 4;
                case 4: return [2 /*return*/, resolvedTarget];
            }
        });
    });
}
...
function handleBroadcastAction(input, params) {
    return __awaiter(this, void 0, void 0, function () {
        var broadcastEnabled, rawTargets, channelHint, configured, targetChannels, _a, results, isAbortError, _i, targetChannels_1, targetChannel, _b, rawTargets_1, target, resolved, sendResult, err_1;
        var _c, _d, _e, _f, _g;
        return __generator(this, function (_h) {
            switch (_h.label) {
                case 0:
                    throwIfAborted(input.abortSignal);
                    broadcastEnabled = ((_e = (_d = (_c = input.cfg.tools) === null || _c === void 0 ? void 0 : _c.message) === null || _d === void 0 ? void 0 : _d.broadcast) === null || _e === void 0 ? void 0 : _e.enabled) !== false;
                    if (!broadcastEnabled) {
                        throw new Error("Broadcast is disabled. Set tools.message.broadcast.enabled to true.");
                    }
                    rawTargets = (_f = (0, common_js_1.readStringArrayParam)(params, "targets", { required: true })) !== null && _f !== void 0 ? _f : [];
                    if (rawTargets.length === 0) {
                        throw new Error("Broadcast requires at least one target in --targets.");
                    }
                    channelHint = (0, common_js_1.readStringParam)(params, "channel");
                    return [4 /*yield*/, (0, channel_selection_js_1.listConfiguredMessageChannels)(input.cfg)];
                case 1:
                    configured = _h.sent();
                    if (configured.length === 0) {
                        throw new Error("Broadcast requires at least one configured channel.");
                    }
                    if (!(channelHint && channelHint.trim().toLowerCase() !== "all")) return [3 /*break*/, 3];
                ...
                case 4:
                    targetChannels = _a;
                    results = [];
                    isAbortError = function (err) { return err instanceof Error && err.name === "AbortError"; };
                    _i = 0, targetChannels_1 = targetChannels;
                    _h.label = 5;
                case 5:
                    if (!(_i < targetChannels_1.length)) return [3 /*break*/, 13];
                    targetChannel = targetChannels_1[_i];
                    throwIfAborted(input.abortSignal);
                    _b = 0, rawTargets_1 = rawTargets;
                    _h.label = 6;
                case 6:
                    if (!(_b < rawTargets_1.length)) return [3 /*break*/, 12];
                ...
                case 8:
                    ...
                    if (!resolved.ok)
                        throw resolved.error;
                    return [4 /*yield*/, runMessageAction(__assign(__assign({}, input), { action: "send", params: __assign(__assign({}, params), { channel: targetChannel, target: resolved.target.to }) }))];
                case 9:
                    sendResult = _h.sent();
                    results.push({
                        channel: targetChannel,
...
function handleSendAction(ctx) {
    return __awaiter(this, void 0, void 0, function () {
        var cfg, params, channel, accountId, dryRun, gateway, input, agentId, resolvedTarget, abortSignal, action, to, mediaHint, hasCard, message, parsed, mergedMediaUrls, seenMedia, pushMedia, _i, _a, url, mediaUrl, gifPlayback, bestEffort, replyToId, threadId, slackAutoThreadId, outboundRoute, _b, mirrorMediaUrls, send;
        var _c, _d, _e, _f, _g;
        return __generator(this, function (_h) {
            switch (_h.label) {
                case 0:
                    cfg = ctx.cfg, params = ctx.params, channel = ctx.channel, accountId = ctx.accountId, dryRun = ctx.dryRun, gateway = ctx.gateway, input = ctx.input, agentId = ctx.agentId, resolvedTarget = ctx.resolvedTarget, abortSignal = ctx.abortSignal;
                    throwIfAborted(abortSignal);
                    action = "send";
                    to = (0, common_js_1.readStringParam)(params, "to", { required: true });
                    mediaHint = (_d = (_c = (0, common_js_1.readStringParam)(params, "media", { trim: false })) !== null && _c !== void 0 ? _c : (0, common_js_1.readStringParam)(params, "path", { trim: false })) !== null && _d !== void 0 ? _d : (0, common_js_1.readStringParam)(params, "filePath", { trim: false });
                    hasCard = params.card != null && typeof params.card === "object";
                    message = (_e = (0, common_js_1.readStringParam)(params, "message", {
                    ...
                    pushMedia(mediaHint);
                    for (_i = 0, _a = (_f = parsed.mediaUrls) !== null && _f !== void 0 ? _f : []; _i < _a.length; _i++) {
                        url = _a[_i];
                        pushMedia(url);
                    }
                    ...
                    return [4 /*yield*/, maybeApplyCrossContextMarker({
                            cfg: cfg,
                            channel: channel,
                            action: action,
                            target: to,
                ...
                case 1:
                    ...
                    gifPlayback = (_g = readBooleanParam(params, "gifPlayback")) !== null && _g !== void 0 ? _g : false;
                    ...
                    slackAutoThreadId = channel === "slack" && !replyToId && !threadId
                        ? resolveSlackAutoThreadId({ to: to, toolContext: input.toolContext })
                        : undefined;
                    if (!(agentId && !dryRun)) return [3 /*break*/, 3];
                ...
                case 4:
                    outboundRoute = _b;
                    if (!(outboundRoute && agentId && !dryRun)) return [3 /*break*/, 6];
                ...
                case 5:
                    ...
                    _h.label = 6;
                case 6:
                    mirrorMediaUrls = mergedMediaUrls.length > 0 ? mergedMediaUrls : mediaUrl ? [mediaUrl] : undefined;
                    throwIfAborted(abortSignal);
                    return [4 /*yield*/, (0, outbound_send_service_js_1.executeSendAction)({
                            ctx: {
                                cfg: cfg,
                                channel: channel,
                                params: params,
...
function handlePollAction(ctx) {
    return __awaiter(this, void 0, void 0, function () {
        var cfg, params, channel, accountId, dryRun, gateway, input, abortSignal, action, to, question, options, allowMultiselect, durationHours, maxSelections, base, poll;
        var _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    cfg = ctx.cfg, params = ctx.params, channel = ctx.channel, accountId = ctx.accountId, dryRun = ctx.dryRun, gateway = ctx.gateway, input = ctx.input, abortSignal = ctx.abortSignal;
                    throwIfAborted(abortSignal);
                    action = "poll";
                    to = (0, common_js_1.readStringParam)(params, "to", { required: true });
                    ...
                    options = (_a = (0, common_js_1.readStringArrayParam)(params, "pollOption", { required: true })) !== null && _a !== void 0 ? _a : [];
                    if (options.length < 2) {
                        throw new Error("pollOption requires at least two values");
                    }
                    allowMultiselect = (_b = readBooleanParam(params, "pollMulti")) !== null && _b !== void 0 ? _b : false;
                ...
                case 1:
                    _c.sent();
                    return [4 /*yield*/, (0, outbound_send_service_js_1.executePollAction)({
                            ctx: {
                                cfg: cfg,
                                channel: channel,
                                params: params,
                            ...
                            durationHours: durationHours !== null && durationHours !== void 0 ? durationHours : undefined,
                        })];
                case 2:
                    poll = _c.sent();
                    return [2 /*return*/, {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, message_actions_js_1.dispatchChannelMessageAction)({
                            channel: channel,
                            action: action,
                            cfg: cfg,
                            params: params,
                ...
                case 1:
                    handled = _a.sent();
                    if (!handled) {
                        throw new Error("Message action ".concat(action, " not supported for channel ").concat(channel, "."));
                    }
                    return [2 /*return*/, {
                            kind: "action",
                            channel: channel,
...
function runMessageAction(input) {
    return __awaiter(this, void 0, void 0, function () {
        var cfg, params, resolvedAgentId, action, explicitTarget, hasLegacyTarget, inferredTarget, legacyTo, legacyChannelId, legacyTarget, explicitChannel, inferredChannel, channel, accountId, dryRun, resolvedTarget, gateway;
        ...
        return __generator(this, function (_g) {
            switch (_g.label) {
                case 0:
                    ...
                    resolvedAgentId = (_a = input.agentId) !== null && _a !== void 0 ? _a : (input.sessionKey
                        ? (0, agent_scope_js_1.resolveSessionAgentId)({ sessionKey: input.sessionKey, config: cfg })
                        : undefined);
                    ...
                    hasLegacyTarget = (typeof params.to === "string" && params.to.trim().length > 0) ||
                    ...
                    if (!explicitTarget &&
                        ...
                        inferredTarget = (_c = (_b = input.toolContext) === null || _b === void 0 ? void 0 : _b.currentChannelId) === null || _c === void 0 ? void 0 : _c.trim();
                        if (inferredTarget) {
                            params.target = inferredTarget;
                        }
                    }
                    if (!explicitTarget && (0, message_action_spec_js_1.actionRequiresTarget)(action) && hasLegacyTarget) {
                    ...
                    if (!explicitChannel) {
                        inferredChannel = (0, message_channel_js_1.normalizeMessageChannel)((_d = input.toolContext) === null || _d === void 0 ? void 0 : _d.currentChannelProvider);
                        if (inferredChannel && (0, message_channel_js_1.isDeliverableMessageChannel)(inferredChannel)) {
                ...
                case 1:
                    channel = _g.sent();
                    accountId = (_e = (0, common_js_1.readStringParam)(params, "accountId")) !== null && _e !== void 0 ? _e : input.defaultAccountId;
                    if (accountId) {
                        params.accountId = accountId;
                    }
                    dryRun = Boolean((_f = input.dryRun) !== null && _f !== void 0 ? _f : readBooleanParam(params, "dryRun"));
                    return [4 /*yield*/, hydrateSendAttachmentParams({
                            cfg: cfg,
                            channel: channel,
                            accountId: accountId,
                            args: params,
                ...
                case 2:
                    _g.sent();
                    return [4 /*yield*/, hydrateSetGroupIconParams({
                            cfg: cfg,
                            channel: channel,
                            accountId: accountId,
                            args: params,
                ...
                case 3:
                    _g.sent();
                    return [4 /*yield*/, resolveActionTarget({
                            cfg: cfg,
                            channel: channel,
                            action: action,
                            args: params,
                ...
                case 4:
                    ...
                    if (action === "send") {
                        return [2 /*return*/, handleSendAction({
                                cfg: cfg,
                                params: params,
                                channel: channel,
                                accountId: accountId,
                    ...
                    if (action === "poll") {
                        return [2 /*return*/, handlePollAction({
                                cfg: cfg,
                                params: params,
                                channel: channel,
                                accountId: accountId,
                    ...
                    return [2 /*return*/, handlePluginAction({
                            cfg: cfg,
                            params: params,
                            channel: channel,
                            accountId: accountId,
