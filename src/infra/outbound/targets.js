...
function resolveSessionDeliveryTarget(params) {
    ...
    var lastChannel = (context === null || context === void 0 ? void 0 : context.channel) && (0, message_channel_js_1.isDeliverableMessageChannel)(context.channel) ? context.channel : undefined;
    ...
    var requested = rawRequested === "last" ? "last" : (0, message_channel_js_1.normalizeMessageChannel)(rawRequested);
    var requestedChannel = requested === "last"
        ? "last"
    ...
    var explicitTo = typeof params.explicitTo === "string" && params.explicitTo.trim()
        ...
        : undefined;
    var explicitThreadId = params.explicitThreadId != null && params.explicitThreadId !== ""
        ? params.explicitThreadId
        : undefined;
    var channel = requestedChannel === "last" ? lastChannel : requestedChannel;
    if (!channel && params.fallbackChannel && (0, message_channel_js_1.isDeliverableMessageChannel)(params.fallbackChannel)) {
    ...
    var mode = (_b = params.mode) !== null && _b !== void 0 ? _b : (explicitTo ? "explicit" : "implicit");
    return {
        channel: channel,
        to: to,
        accountId: accountId,
        threadId: explicitThreadId !== null && explicitThreadId !== void 0 ? explicitThreadId : threadId,
        mode: mode,
...
function resolveOutboundTarget(params) {
    ...
    if (params.channel === message_channel_js_1.INTERNAL_MESSAGE_CHANNEL) {
        return {
            ok: false,
            error: new Error("Delivering to WebChat is not supported via `".concat((0, command_format_js_1.formatCliCommand)("openclaw agent"), "`; use WhatsApp/Telegram or run with --deliver=false.")),
        };
    }
    ...
    var allowFrom = (_a = params.allowFrom) !== null && _a !== void 0 ? _a : (params.cfg && plugin.config.resolveAllowFrom
    ...
    var hint = (_h = (_g = plugin.messaging) === null || _g === void 0 ? void 0 : _g.targetResolver) === null || _h === void 0 ? void 0 : _h.hint;
    return {
        ok: false,
        error: (0, target_errors_js_1.missingTargetError)((_j = plugin.meta.label) !== null && _j !== void 0 ? _j : params.channel, hint),
    };
}
function resolveHeartbeatDeliveryTarget(params) {
    var _a, _b, _c;
    var cfg = params.cfg, entry = params.entry;
    var heartbeat = (_a = params.heartbeat) !== null && _a !== void 0 ? _a : (_c = (_b = cfg.agents) === null || _b === void 0 ? void 0 : _b.defaults) === null || _c === void 0 ? void 0 : _c.heartbeat;
...
function resolveHeartbeatSenderId(params) {
    var _a, _b;
    var allowFrom = params.allowFrom, deliveryTo = params.deliveryTo, lastTo = params.lastTo, provider = params.provider;
    var candidates = [
    ...
    ].filter(function (val) { return Boolean(val === null || val === void 0 ? void 0 : val.trim()); });
    ...
    if (candidates.length > 0 && allowList.length > 0) {
        var matched = candidates.find(function (candidate) { return allowList.includes(candidate); });
        if (matched)
            return matched;
    }
    if (candidates.length > 0 && allowList.length === 0) {
...
function resolveHeartbeatSenderContext(params) {
    var _a, _b, _c, _d, _e;
    var provider = params.delivery.channel !== "none" ? params.delivery.channel : params.delivery.lastChannel;
    var allowFrom = provider
        ? ((_d = (_c = (_a = (0, index_js_1.getChannelPlugin)(provider)) === null || _a === void 0 ? void 0 : (_b = _a.config).resolveAllowFrom) === null || _c === void 0 ? void 0 : _c.call(_b, {
            cfg: params.cfg,
