        ...
        return __generator(this, function (_g) {
            switch (_g.label) {
                case 0:
                    ...
                    if (!!params.ctx.dryRun) return [3 /*break*/, 4];
                ...
                case 1:
                    ...
                    if (!params.ctx.mirror) return [3 /*break*/, 3];
                    mirrorText = (_b = params.ctx.mirror.text) !== null && _b !== void 0 ? _b : params.message;
                    mirrorMediaUrls = (_d = (_c = params.ctx.mirror.mediaUrls) !== null && _c !== void 0 ? _c : params.mediaUrls) !== null && _d !== void 0 ? _d : (params.mediaUrl ? [params.mediaUrl] : undefined);
                ...
                case 4:
                    throwIfAborted(params.ctx.abortSignal);
                    return [4 /*yield*/, (0, message_js_1.sendMessage)({
                            cfg: params.ctx.cfg,
                            to: params.to,
...
function executePollAction(params) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    if (!!params.ctx.dryRun) return [3 /*break*/, 2];
                    return [4 /*yield*/, (0, message_actions_js_1.dispatchChannelMessageAction)({
                            channel: params.ctx.channel,
                            action: "poll",
                            cfg: params.ctx.cfg,
                ...
                case 1:
                    ...
                    _c.label = 2;
                case 2: return [4 /*yield*/, (0, message_js_1.sendPoll)({
                        cfg: params.ctx.cfg,
                        to: params.to,
