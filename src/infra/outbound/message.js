...
function resolveGatewayOptions(opts) {
    ...
    return {
        ...
        timeoutMs: typeof (opts === null || opts === void 0 ? void 0 : opts.timeoutMs) === "number" && Number.isFinite(opts.timeoutMs)
            ? Math.max(1, Math.floor(opts.timeoutMs))
            : 10000,
        clientName: (_a = opts === null || opts === void 0 ? void 0 : opts.clientName) !== null && _a !== void 0 ? _a : message_channel_js_1.GATEWAY_CLIENT_NAMES.CLI,
        clientDisplayName: opts === null || opts === void 0 ? void 0 : opts.clientDisplayName,
        mode: (_b = opts === null || opts === void 0 ? void 0 : opts.mode) !== null && _b !== void 0 ? _b : message_channel_js_1.GATEWAY_CLIENT_MODES.CLI,
    };
}
function sendMessage(params) {
    return __awaiter(this, void 0, void 0, function () {
        var cfg, channel, _a, plugin, deliveryMode, normalizedPayloads, mirrorText, mirrorMediaUrls, primaryMediaUrl, outboundChannel, resolvedTarget, results, gateway, result;
        var _b, _c, _d, _e, _f, _g, _h, _j;
        return __generator(this, function (_k) {
            switch (_k.label) {
                case 0:
                    cfg = (_b = params.cfg) !== null && _b !== void 0 ? _b : (0, config_js_1.loadConfig)();
                    if (!((_c = params.channel) === null || _c === void 0 ? void 0 : _c.trim())) return [3 /*break*/, 1];
                    _a = (0, index_js_1.normalizeChannelId)(params.channel);
                    return [3 /*break*/, 3];
                case 1: return [4 /*yield*/, (0, channel_selection_js_1.resolveMessageChannelSelection)({ cfg: cfg })];
                case 2:
                    _a = (_k.sent()).channel;
                    _k.label = 3;
                case 3:
                    ...
                    deliveryMode = (_e = (_d = plugin.outbound) === null || _d === void 0 ? void 0 : _d.deliveryMode) !== null && _e !== void 0 ? _e : "direct";
                    ...
                    mirrorText = normalizedPayloads
                        ...
                        .filter(Boolean)
                        .join("\n");
                    mirrorMediaUrls = normalizedPayloads.flatMap(function (payload) { var _a; return (_a = payload.mediaUrls) !== null && _a !== void 0 ? _a : (payload.mediaUrl ? [payload.mediaUrl] : []); });
                    primaryMediaUrl = (_g = (_f = mirrorMediaUrls[0]) !== null && _f !== void 0 ? _f : params.mediaUrl) !== null && _g !== void 0 ? _g : null;
                    if (params.dryRun) {
                        return [2 /*return*/, {
                                channel: channel,
                                to: params.to,
                    ...
                    if (!(deliveryMode !== "gateway")) return [3 /*break*/, 5];
                    ...
                    return [4 /*yield*/, (0, deliver_js_1.deliverOutboundPayloads)({
                            ...
                            mirror: params.mirror
                                ? __assign(__assign({}, params.mirror), { text: mirrorText || params.content, mediaUrls: mirrorMediaUrls.length ? mirrorMediaUrls : undefined }) : undefined,
                        })];
                case 4:
                    results = _k.sent();
                    return [2 /*return*/, {
                ...
                case 5:
                    ...
                    return [4 /*yield*/, (0, call_js_1.callGateway)({
                            ...
                            params: {
                                ...
                                idempotencyKey: (_j = params.idempotencyKey) !== null && _j !== void 0 ? _j : (0, call_js_1.randomIdempotencyKey)(),
                            },
                ...
                case 3:
                    ...
                    if (params.dryRun) {
                        return [2 /*return*/, {
                                ...
                                durationHours: (_d = normalized.durationHours) !== null && _d !== void 0 ? _d : null,
                                via: "gateway",
                                dryRun: true,
                            }];
                    }
                    ...
                    return [4 /*yield*/, (0, call_js_1.callGateway)({
                            ...
                            params: {
                                ...
                                channel: channel,
                                idempotencyKey: (_e = params.idempotencyKey) !== null && _e !== void 0 ? _e : (0, call_js_1.randomIdempotencyKey)(),
                            },
                            timeoutMs: gateway.timeoutMs,
                            clientName: gateway.clientName,
                            clientDisplayName: gateway.clientDisplayName,
