...
function normalizeReplyPayloadsForDelivery(payloads) {
    return payloads.flatMap(function (payload) {
        ...
        var explicitMediaUrls = (_b = payload.mediaUrls) !== null && _b !== void 0 ? _b : parsed.mediaUrls;
        var explicitMediaUrl = (_c = payload.mediaUrl) !== null && _c !== void 0 ? _c : parsed.mediaUrl;
        var mergedMedia = mergeMediaUrls(explicitMediaUrls, explicitMediaUrl ? [explicitMediaUrl] : undefined);
        var hasMultipleMedia = ((_d = explicitMediaUrls === null || explicitMediaUrls === void 0 ? void 0 : explicitMediaUrls.length) !== null && _d !== void 0 ? _d : 0) > 1;
        var resolvedMediaUrl = hasMultipleMedia ? undefined : explicitMediaUrl;
        var next = __assign(__assign({}, payload), { text: (_e = parsed.text) !== null && _e !== void 0 ? _e : "", mediaUrls: mergedMedia.length ? mergedMedia : undefined, mediaUrl: resolvedMediaUrl, replyToId: (_f = payload.replyToId) !== null && _f !== void 0 ? _f : parsed.replyToId, replyToTag: payload.replyToTag || parsed.replyToTag, replyToCurrent: payload.replyToCurrent || parsed.replyToCurrent, audioAsVoice: Boolean(payload.audioAsVoice || parsed.audioAsVoice) });
...
function normalizeOutboundPayloads(payloads) {
    return normalizeReplyPayloadsForDelivery(payloads)
        ...
        var normalized = {
            ...
            mediaUrls: (_b = payload.mediaUrls) !== null && _b !== void 0 ? _b : (payload.mediaUrl ? [payload.mediaUrl] : []),
        };
...
function normalizeOutboundPayloadsForJson(payloads) {
    return normalizeReplyPayloadsForDelivery(payloads).map(function (payload) {
        ...
        return ({
            ...
            mediaUrls: (_c = payload.mediaUrls) !== null && _c !== void 0 ? _c : (payload.mediaUrl ? [payload.mediaUrl] : undefined),
