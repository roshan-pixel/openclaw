...
var getMessageChannels = function () { return (0, message_channel_js_1.listDeliverableMessageChannels)(); };
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    _a.label = 1;
                case 1:
                    if (!(_i < accountIds_1.length)) return [3 /*break*/, 4];
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    if (!normalized) return [3 /*break*/, 2];
                ...
                case 1: return [2 /*return*/, (_a.configured = _b.sent(),
                        _a)];
                case 2: return [4 /*yield*/, listConfiguredMessageChannels(params.cfg)];
                case 3:
                    configured = _b.sent();
                    ...
                    throw new Error("Channel is required when multiple channels are configured: ".concat(configured.join(", ")));
            }
        });
    });
}
