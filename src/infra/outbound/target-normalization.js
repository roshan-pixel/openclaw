...
function normalizeTargetForProvider(provider, raw) {
    ...
    var normalized = (_c = (_b = (_a = plugin === null || plugin === void 0 ? void 0 : plugin.messaging) === null || _a === void 0 ? void 0 : _a.normalizeTarget) === null || _b === void 0 ? void 0 : _b.call(_a, raw)) !== null && _c !== void 0 ? _c : (raw.trim().toLowerCase() || undefined);
    return normalized || undefined;
}
function buildTargetResolverSignature(channel) {
    var _a, _b;
    var plugin = (0, index_js_1.getChannelPlugin)(channel);
    var resolver = (_a = plugin === null || plugin === void 0 ? void 0 : plugin.messaging) === null || _a === void 0 ? void 0 : _a.targetResolver;
    var hint = (_b = resolver === null || resolver === void 0 ? void 0 : resolver.hint) !== null && _b !== void 0 ? _b : "";
