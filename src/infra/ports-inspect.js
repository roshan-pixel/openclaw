...
function resolveUnixCommandLine(pid) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, runCommandSafe(["ps", "-p", String(pid), "-o", "command="])];
                case 1:
                    res = _a.sent();
                    if (res.code !== 0)
...
function resolveUnixUser(pid) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, runCommandSafe(["ps", "-p", String(pid), "-o", "user="])];
                case 1:
                    res = _a.sent();
                    if (res.code !== 0)
                        return [2 /*return*/, undefined];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    lsof = _a.sent();
                    return [4 /*yield*/, runCommandSafe([lsof, "-nP", "-iTCP:".concat(port), "-sTCP:LISTEN", "-FpFcn"])];
                case 2:
                    res = _a.sent();
                    if (!(res.code === 0)) return [3 /*break*/, 4];
                    listeners = parseLsofFieldOutput(res.stdout);
                    return [4 /*yield*/, Promise.all(listeners.map(function (listener) { return __awaiter(_this, void 0, void 0, function () {
                ...
                case 3:
                    _a.sent();
                    return [2 /*return*/, { listeners: listeners, detail: res.stdout.trim() || undefined, errors: errors }];
                case 4:
...
function resolveWindowsImageName(pid) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, runCommandSafe(["tasklist", "/FI", "PID eq ".concat(pid), "/FO", "LIST"])];
                case 1:
                    res = _b.sent();
                    if (res.code !== 0)
                        return [2 /*return*/, undefined];
...
function resolveWindowsCommandLine(pid) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, runCommandSafe([
                        "wmic",
                        "process",
                        "where",
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    _a.label = 1;
                case 1:
                    if (!(_i < hosts_1.length)) return [3 /*break*/, 4];
                    host = hosts_1[_i];
                ...
                case 3:
                    _i++;
                    return [3 /*break*/, 1];
                case 4: return [2 /*return*/, sawUnknown ? "unknown" : "free"];
            }
        });
    });
}
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _a = _b.sent();
                    return [3 /*break*/, 4];
                case 2: return [4 /*yield*/, readUnixListeners(port)];
                case 3:
                    _a = _b.sent();
                    _b.label = 4;
                case 4:
                    ...
                    if (!(listeners.length === 0)) return [3 /*break*/, 6];
