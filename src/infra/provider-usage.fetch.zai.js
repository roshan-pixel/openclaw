...
function fetchZaiUsage(apiKey, timeoutMs, fetchFn) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0: return [4 /*yield*/, (0, provider_usage_fetch_shared_js_1.fetchJson)("https://api.z.ai/api/monitor/usage/quota/limit", {
                        method: "GET",
                        headers: {
                ...
                case 2:
                    ...
                    planName = ((_b = data.data) === null || _b === void 0 ? void 0 : _b.planName) || ((_c = data.data) === null || _c === void 0 ? void 0 : _c.plan) || undefined;
                    return [2 /*return*/, {
                            provider: "zai",
                            displayName: provider_usage_shared_js_1.PROVIDER_LABELS.zai,
                            windows: windows,
