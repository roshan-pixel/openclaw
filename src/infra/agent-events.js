...
function emitAgentEvent(event) {
    ...
    var sessionKey = typeof event.sessionKey === "string" && event.sessionKey.trim()
        ? event.sessionKey
        : context === null || context === void 0 ? void 0 : context.sessionKey;
    var enriched = __assign(__assign({}, event), { sessionKey: sessionKey, seq: nextSeq, ts: Date.now() });
