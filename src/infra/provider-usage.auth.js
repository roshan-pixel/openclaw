...
function resolveZaiApiKey() {
    var _a, _b, _c, _d, _e;
    var envDirect = ((_a = process.env.ZAI_API_KEY) === null || _a === void 0 ? void 0 : _a.trim()) || ((_b = process.env.Z_AI_API_KEY) === null || _b === void 0 ? void 0 : _b.trim());
    if (envDirect)
        return envDirect;
    ...
    var key = (0, model_auth_js_1.getCustomProviderApiKey)(cfg, "zai") || (0, model_auth_js_1.getCustomProviderApiKey)(cfg, "z-ai");
    if (key)
        return key;
    var store = (0, auth_profiles_js_1.ensureAuthProfileStore)();
    var apiProfile = __spreadArray(__spreadArray([], (0, auth_profiles_js_1.listProfilesForProvider)(store, "zai"), true), (0, auth_profiles_js_1.listProfilesForProvider)(store, "z-ai"), true).find(function (id) { var _a; return ((_a = store.profiles[id]) === null || _a === void 0 ? void 0 : _a.type) === "api_key"; });
    if (apiProfile) {
        var cred = store.profiles[apiProfile];
        if ((cred === null || cred === void 0 ? void 0 : cred.type) === "api_key" && ((_c = cred.key) === null || _c === void 0 ? void 0 : _c.trim())) {
            return cred.key.trim();
        }
    }
    try {
        var authPath = node_path_1.default.join(node_os_1.default.homedir(), ".pi", "agent", "auth.json");
        if (!node_fs_1.default.existsSync(authPath))
            return undefined;
        var data = JSON.parse(node_fs_1.default.readFileSync(authPath, "utf-8"));
        return ((_d = data["z-ai"]) === null || _d === void 0 ? void 0 : _d.access) || ((_e = data.zai) === null || _e === void 0 ? void 0 : _e.access);
    }
    catch (_f) {
        return undefined;
    }
...
function resolveMinimaxApiKey() {
    var _a, _b, _c, _d;
    var envDirect = ((_a = process.env.MINIMAX_CODE_PLAN_KEY) === null || _a === void 0 ? void 0 : _a.trim()) || ((_b = process.env.MINIMAX_API_KEY) === null || _b === void 0 ? void 0 : _b.trim());
    if (envDirect)
        return envDirect;
    ...
    if (key)
        return key;
    var store = (0, auth_profiles_js_1.ensureAuthProfileStore)();
    var apiProfile = (0, auth_profiles_js_1.listProfilesForProvider)(store, "minimax").find(function (id) {
        var cred = store.profiles[id];
        return (cred === null || cred === void 0 ? void 0 : cred.type) === "api_key" || (cred === null || cred === void 0 ? void 0 : cred.type) === "token";
    });
    if (!apiProfile)
        return undefined;
    var cred = store.profiles[apiProfile];
    ...
    if ((cred === null || cred === void 0 ? void 0 : cred.type) === "token" && ((_d = cred.token) === null || _d === void 0 ? void 0 : _d.trim())) {
...
function resolveXiaomiApiKey() {
    ...
    if (key)
        return key;
    var store = (0, auth_profiles_js_1.ensureAuthProfileStore)();
    var apiProfile = (0, auth_profiles_js_1.listProfilesForProvider)(store, "xiaomi").find(function (id) {
        var cred = store.profiles[id];
        return (cred === null || cred === void 0 ? void 0 : cred.type) === "api_key" || (cred === null || cred === void 0 ? void 0 : cred.type) === "token";
    });
    if (!apiProfile)
        return undefined;
    var cred = store.profiles[apiProfile];
    if ((cred === null || cred === void 0 ? void 0 : cred.type) === "api_key" && ((_b = cred.key) === null || _b === void 0 ? void 0 : _b.trim())) {
        return cred.key.trim();
    }
    if ((cred === null || cred === void 0 ? void 0 : cred.type) === "token" && ((_c = cred.token) === null || _c === void 0 ? void 0 : _c.trim())) {
        return cred.token.trim();
    }
    return undefined;
}
function resolveOAuthToken(params) {
    return __awaiter(this, void 0, void 0, function () {
        var cfg, store, order, candidates, deduped, _i, candidates_1, entry, _a, deduped_1, profileId, cred, resolved, token, parsed, _b;
        var _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    _d.label = 1;
                case 1:
                    if (!(_a < deduped_1.length)) return [3 /*break*/, 6];
                ...
                case 3:
                    ...
                    if (params.provider === "google-gemini-cli" || params.provider === "google-antigravity") {
                        ...
                        token = (_c = parsed === null || parsed === void 0 ? void 0 : parsed.token) !== null && _c !== void 0 ? _c : resolved.apiKey;
                    }
                    return [2 /*return*/, {
                            provider: params.provider,
                            token: token,
...
function resolveOAuthProviders(agentDir) {
    ...
    var isOAuthLikeCredential = function (id) {
        var cred = store.profiles[id];
        return (cred === null || cred === void 0 ? void 0 : cred.type) === "oauth" || (cred === null || cred === void 0 ? void 0 : cred.type) === "token";
    };
    return providers.filter(function (provider) {
        var _a, _b;
        var profiles = (0, auth_profiles_js_1.listProfilesForProvider)(store, provider).filter(isOAuthLikeCredential);
        if (profiles.length > 0)
            return true;
        var normalized = (0, model_selection_js_1.normalizeProviderId)(provider);
        var configuredProfiles = Object.entries((_b = (_a = cfg.auth) === null || _a === void 0 ? void 0 : _a.profiles) !== null && _b !== void 0 ? _b : {})
            .filter(function (_a) {
            var profile = _a[1];
            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (!oauthProviders.includes(provider))
                        return [3 /*break*/, 3];
                    return [4 /*yield*/, resolveOAuthToken({
                            provider: provider,
                            agentDir: params.agentDir,
                        })];
                case 2:
