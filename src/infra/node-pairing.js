    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    state = _a.sent();
                    pending = Object.values(state.pendingById).sort(function (a, b) { return b.ts - a.ts; });
                    paired = Object.values(state.pairedByNodeId).sort(function (a, b) { return b.approvedAtMs - a.approvedAtMs; });
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    state = _b.sent();
                    return [2 /*return*/, (_a = state.pairedByNodeId[normalizeNodeId(nodeId)]) !== null && _a !== void 0 ? _a : null];
            }
        });
    });
}
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    ...
                                    existing = Object.values(state.pendingById).find(function (p) { return p.nodeId === nodeId; });
                                    if (existing) {
                        ...
                        return __generator(this, function (_p) {
                            switch (_p.label) {
                                ...
                                case 1:
                                    ...
                                    if (!existing)
                                        return [2 /*return*/];
                                    next = __assign(__assign({}, existing), { displayName: (_a = patch.displayName) !== null && _a !== void 0 ? _a : existing.displayName, platform: (_b = patch.platform) !== null && _b !== void 0 ? _b : existing.platform, version: (_c = patch.version) !== null && _c !== void 0 ? _c : existing.version, coreVersion: (_d = patch.coreVersion) !== null && _d !== void 0 ? _d : existing.coreVersion, uiVersion: (_e = patch.uiVersion) !== null && _e !== void 0 ? _e : existing.uiVersion, deviceFamily: (_f = patch.deviceFamily) !== null && _f !== void 0 ? _f : existing.deviceFamily, modelIdentifier: (_g = patch.modelIdentifier) !== null && _g !== void 0 ? _g : existing.modelIdentifier, remoteIp: (_h = patch.remoteIp) !== null && _h !== void 0 ? _h : existing.remoteIp, caps: (_j = patch.caps) !== null && _j !== void 0 ? _j : existing.caps, commands: (_k = patch.commands) !== null && _k !== void 0 ? _k : existing.commands, bins: (_l = patch.bins) !== null && _l !== void 0 ? _l : existing.bins, permissions: (_m = patch.permissions) !== null && _m !== void 0 ? _m : existing.permissions, lastConnectedAtMs: (_o = patch.lastConnectedAtMs) !== null && _o !== void 0 ? _o : existing.lastConnectedAtMs });
