...
function parseIpv4(address) {
    ...
    if (parts.length !== 4)
        return null;
    var numbers = parts.map(function (part) { return Number.parseInt(part, 10); });
    if (numbers.some(function (value) { return Number.isNaN(value) || value < 0 || value > 255; }))
        return null;
    return numbers;
}
function parseIpv4FromMappedIpv6(mapped) {
    ...
    if (parts.length === 1) {
        ...
        if (Number.isNaN(value_1) || value_1 < 0 || value_1 > 4294967295)
            return null;
        return [(value_1 >>> 24) & 0xff, (value_1 >>> 16) & 0xff, (value_1 >>> 8) & 0xff, value_1 & 0xff];
    }
    if (parts.length !== 2)
        return null;
...
function isPrivateIpv4(parts) {
    var octet1 = parts[0], octet2 = parts[1];
    if (octet1 === 0)
        return true;
    if (octet1 === 10)
        return true;
...
function isPrivateIpAddress(address) {
    ...
    if (normalized.includes(":")) {
        if (normalized === "::" || normalized === "::1")
            return true;
        return PRIVATE_IPV6_PREFIXES.some(function (prefix) { return normalized.startsWith(prefix); });
    }
...
function createPinnedLookup(params) {
    ...
    var records = params.addresses.map(function (address) { return ({
        address: address,
    ...
    return (function (host, options, callback) {
        ...
        var opts = typeof options === "object" && options !== null
            ? options
            : {};
        var requestedFamily = typeof options === "number" ? options : typeof opts.family === "number" ? opts.family : 0;
        var candidates = requestedFamily === 4 || requestedFamily === 6
            ? records.filter(function (entry) { return entry.family === requestedFamily; })
            : records;
...
function resolvePinnedHostname(hostname_1) {
    return __awaiter(this, arguments, void 0, function (hostname, lookupFn) {
        ...
        if (lookupFn === void 0) { lookupFn = promises_1.lookup; }
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    addresses = Array.from(new Set(results.map(function (entry) { return entry.address; })));
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.trys.push([1, 4, , 5]);
                    if (!(typeof candidate.close === "function")) return [3 /*break*/, 3];
...
function assertPublicHostname(hostname_1) {
    return __awaiter(this, arguments, void 0, function (hostname, lookupFn) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, resolvePinnedHostname(hostname, lookupFn)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
