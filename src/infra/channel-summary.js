...
var buildAccountDetails = function (params) {
    ...
    if (params.includeAllowFrom && ((_a = snapshot.allowFrom) === null || _a === void 0 ? void 0 : _a.length)) {
            ...
            switch (_l.label) {
                case 0:
                    ...
                    _loop_1 = function (plugin) {
                        var accountIds, defaultAccountId, resolvedAccountIds, entries, _m, resolvedAccountIds_1, accountId, account, enabled, configured_1, snapshot, configuredEntries, anyEnabled, fallbackEntry, summary, _o, summaryRecord, linked, configured, status_1, statusColor, baseLabel, line, authAgeMs, self_1, _p, configuredEntries_1, entry, details;
                        return __generator(this, function (_q) {
                            switch (_q.label) {
                                case 0:
                                    accountIds = plugin.config.listAccountIds(effective);
                                    defaultAccountId = (_e = (_d = (_c = (_b = plugin.config).defaultAccountId) === null || _c === void 0 ? void 0 : _c.call(_b, effective)) !== null && _d !== void 0 ? _d : accountIds[0]) !== null && _e !== void 0 ? _e : session_key_js_1.DEFAULT_ACCOUNT_ID;
                                    resolvedAccountIds = accountIds.length > 0 ? accountIds : [defaultAccountId];
                                    entries = [];
                                    _m = 0, resolvedAccountIds_1 = resolvedAccountIds;
                                    _q.label = 1;
                                case 1:
                                    if (!(_m < resolvedAccountIds_1.length)) return [3 /*break*/, 4];
                                ...
                                case 2:
                                    ...
                                    entries.push({ accountId: accountId, account: account, enabled: enabled, configured: configured_1, snapshot: snapshot });
                                    _q.label = 3;
                                case 3:
                                    _m++;
                                    return [3 /*break*/, 1];
                                case 4:
                                    configuredEntries = entries.filter(function (entry) { return entry.configured; });
                                    anyEnabled = entries.some(function (entry) { return entry.enabled; });
                                    fallbackEntry = (_f = entries.find(function (entry) { return entry.accountId === defaultAccountId; })) !== null && _f !== void 0 ? _f : entries[0];
                                    if (!((_g = plugin.status) === null || _g === void 0 ? void 0 : _g.buildChannelSummary)) return [3 /*break*/, 6];
                                    return [4 /*yield*/, plugin.status.buildChannelSummary({
                                            account: (_h = fallbackEntry === null || fallbackEntry === void 0 ? void 0 : fallbackEntry.account) !== null && _h !== void 0 ? _h : {},
                                            cfg: effective,
                                            defaultAccountId: defaultAccountId,
                                            snapshot: (_j = fallbackEntry === null || fallbackEntry === void 0 ? void 0 : fallbackEntry.snapshot) !== null && _j !== void 0 ? _j : { accountId: defaultAccountId },
                                        })];
                                case 5:
                                    _o = _q.sent();
                                    return [3 /*break*/, 7];
                                ...
                                case 7:
                                    ...
                                    linked = summaryRecord && typeof summaryRecord.linked === "boolean" ? summaryRecord.linked : null;
                                    configured = summaryRecord && typeof summaryRecord.configured === "boolean"
                                    ...
                                    status_1 = !anyEnabled
                                        ...
                                        : linked !== null
                                            ...
                                            : configured
                                                ? "configured"
                                                : "not configured";
                                    statusColor = status_1 === "linked" || status_1 === "configured"
                                    ...
                                    self_1 = summaryRecord === null || summaryRecord === void 0 ? void 0 : summaryRecord.self;
                                    ...
                                    if (configuredEntries.length > 0) {
                                        for (_p = 0, configuredEntries_1 = configuredEntries; _p < configuredEntries_1.length; _p++) {
