...
var readCommitFromPackageJson = function () {
    ...
    try {
        ...
        return formatCommit((_b = (_a = pkg.gitHead) !== null && _a !== void 0 ? _a : pkg.githead) !== null && _b !== void 0 ? _b : null);
    }
    catch (_c) {
        return null;
    }
...
var resolveCommitHash = function (options) {
    ...
    var envCommit = ((_b = env.GIT_COMMIT) === null || _b === void 0 ? void 0 : _b.trim()) || ((_c = env.GIT_SHA) === null || _c === void 0 ? void 0 : _c.trim());
    ...
    try {
        var headPath = resolveGitHead((_d = options.cwd) !== null && _d !== void 0 ? _d : process.cwd());
        if (!headPath) {
            cachedCommit = null;
            return cachedCommit;
        }
