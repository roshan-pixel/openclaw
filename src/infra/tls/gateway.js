    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    _c.sent();
                    if (!(keyDir !== certDir)) return [3 /*break*/, 3];
                    return [4 /*yield*/, (0, utils_js_1.ensureDir)(keyDir)];
                case 2:
                    _c.sent();
                    _c.label = 3;
                case 3: return [4 /*yield*/, execFileAsync("openssl", [
                        "req",
                        "-x509",
                        "-newkey",
                        "rsa:2048",
                ...
                case 5:
                    _c.sent();
                    return [4 /*yield*/, promises_1.default.chmod(params.certPath, 384).catch(function () { })];
                case 6:
                    _c.sent();
                    (_b = (_a = params.log) === null || _a === void 0 ? void 0 : _a.info) === null || _b === void 0 ? void 0 : _b.call(_a, "gateway tls: generated self-signed cert at ".concat((0, utils_js_1.shortenHomeInString)(params.certPath)));
                    return [2 /*return*/];
            }
        });
    });
...
function loadGatewayTlsRuntime(cfg, log) {
    return __awaiter(this, void 0, void 0, function () {
        var autoGenerate, baseDir, certPath, keyPath, caPath, hasCert, hasKey, err_1, _a, cert, key, ca, _b, x509, fingerprintSha256, err_2;
        var _c, _d, _e;
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                    ...
                    certPath = (0, utils_js_1.resolveUserPath)((_c = cfg.certPath) !== null && _c !== void 0 ? _c : node_path_1.default.join(baseDir, "gateway-cert.pem"));
                    keyPath = (0, utils_js_1.resolveUserPath)((_d = cfg.keyPath) !== null && _d !== void 0 ? _d : node_path_1.default.join(baseDir, "gateway-key.pem"));
                ...
                case 2:
                    hasKey = _f.sent();
                    if (!(!hasCert && !hasKey && autoGenerate)) return [3 /*break*/, 6];
                    _f.label = 3;
                case 3:
                    _f.trys.push([3, 5, , 6]);
                    return [4 /*yield*/, generateSelfSignedCert({ certPath: certPath, keyPath: keyPath, log: log })];
                case 4:
                    _f.sent();
                    return [3 /*break*/, 6];
                case 5:
                ...
                case 6: return [4 /*yield*/, fileExists(certPath)];
                case 7:
                    _a = !(_f.sent());
                ...
                case 15:
                    ...
                    fingerprintSha256 = (0, fingerprint_js_1.normalizeFingerprint)((_e = x509.fingerprint256) !== null && _e !== void 0 ? _e : "");
