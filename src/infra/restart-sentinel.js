...
function formatDoctorNonInteractiveHint(env) {
    ...
    return "Run: ".concat((0, command_format_js_1.formatCliCommand)("openclaw doctor --non-interactive", env));
}
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, promises_1.default.writeFile(filePath, "".concat(JSON.stringify(data, null, 2), "\n"), "utf-8")];
                case 2:
                    _a.sent();
    ...
    return __awaiter(this, arguments, void 0, function (env) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 6:
                    if (!(!parsed || parsed.version !== 1 || !parsed.payload)) return [3 /*break*/, 8];
                    return [4 /*yield*/, promises_1.default.unlink(filePath).catch(function () { })];
                case 7:
                    _c.sent();
                    return [2 /*return*/, null];
                case 8: return [2 /*return*/, parsed];
                case 9:
                    _b = _c.sent();
                    return [2 /*return*/, null];
...
function summarizeRestartSentinel(payload) {
    ...
    var mode = ((_a = payload.stats) === null || _a === void 0 ? void 0 : _a.mode) ? " (".concat(payload.stats.mode, ")") : "";
    return "Gateway restart ".concat(kind, " ").concat(status).concat(mode).trim();
}
function trimLogTail(input, maxChars) {
    if (maxChars === void 0) { maxChars = 8000; }
    if (!input)
        return null;
