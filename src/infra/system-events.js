...
function isSystemEventContextChanged(sessionKey, contextKey) {
    ...
    return normalized !== ((_a = existing === null || existing === void 0 ? void 0 : existing.lastContextKey) !== null && _a !== void 0 ? _a : null);
}
function enqueueSystemEvent(text, options) {
    var _a;
    var key = requireSessionKey(options === null || options === void 0 ? void 0 : options.sessionKey);
    var entry = (_a = queues.get(key)) !== null && _a !== void 0 ? _a : (function () {
        var created = {
            queue: [],
            lastText: null,
            lastContextKey: null,
    ...
    if (!cleaned)
        return;
    entry.lastContextKey = normalizeContextKey(options === null || options === void 0 ? void 0 : options.contextKey);
...
function drainSystemEvents(sessionKey) {
    return drainSystemEventEntries(sessionKey).map(function (event) { return event.text; });
}
function peekSystemEvents(sessionKey) {
    var _a, _b;
    var key = requireSessionKey(sessionKey);
    return (_b = (_a = queues.get(key)) === null || _a === void 0 ? void 0 : _a.queue.map(function (e) { return e.text; })) !== null && _b !== void 0 ? _b : [];
}
function hasSystemEvents(sessionKey) {
    var _a, _b;
    var key = requireSessionKey(sessionKey);
    return ((_b = (_a = queues.get(key)) === null || _a === void 0 ? void 0 : _a.queue.length) !== null && _b !== void 0 ? _b : 0) > 0;
}
