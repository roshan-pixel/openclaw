...
function loadShellEnvFallback(opts) {
    ...
    var hasAnyKey = opts.expectedKeys.some(function (key) { var _a; return Boolean((_a = opts.env[key]) === null || _a === void 0 ? void 0 : _a.trim()); });
    if (hasAnyKey) {
        lastAppliedKeys = [];
        return { ok: true, applied: [], skippedReason: "already-has-keys" };
    }
    var timeoutMs = typeof opts.timeoutMs === "number" && Number.isFinite(opts.timeoutMs)
