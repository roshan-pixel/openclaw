...
function setGatewaySigusr1RestartPolicy(opts) {
    sigusr1ExternalAllowed = (opts === null || opts === void 0 ? void 0 : opts.allowExternal) === true;
}
...
function triggerOpenClawRestart() {
    ...
    if (process.platform !== "darwin") {
        if (process.platform === "linux") {
            var unit = normalizeSystemdUnit(process.env.OPENCLAW_SYSTEMD_UNIT, process.env.OPENCLAW_PROFILE);
    ...
    var label = process.env.OPENCLAW_LAUNCHD_LABEL ||
...
function scheduleGatewaySigusr1Restart(opts) {
    var delayMsRaw = typeof (opts === null || opts === void 0 ? void 0 : opts.delayMs) === "number" && Number.isFinite(opts.delayMs)
        ? Math.floor(opts.delayMs)
        : 2000;
    var delayMs = Math.min(Math.max(delayMsRaw, 0), 60000);
    var reason = typeof (opts === null || opts === void 0 ? void 0 : opts.reason) === "string" && opts.reason.trim()
