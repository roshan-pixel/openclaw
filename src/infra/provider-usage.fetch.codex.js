        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, provider_usage_fetch_shared_js_1.fetchJson)("https://chatgpt.com/backend-api/wham/usage", { method: "GET", headers: headers }, timeoutMs, fetchFn)];
                case 1:
                    res = _d.sent();
                ...
                case 2:
                    ...
                    plan = data.plan_type;
                    if (((_c = data.credits) === null || _c === void 0 ? void 0 : _c.balance) !== undefined && data.credits.balance !== null) {
                        balance = typeof data.credits.balance === "number"
                            ? data.credits.balance
                            : parseFloat(data.credits.balance) || 0;
                        plan = plan ? "".concat(plan, " ($").concat(balance.toFixed(2), ")") : "$".concat(balance.toFixed(2));
                    }
                    return [2 /*return*/, {
                            provider: "openai-codex",
                            displayName: provider_usage_shared_js_1.PROVIDER_LABELS["openai-codex"],
