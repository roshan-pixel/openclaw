...
function resolveDeviceAuthPath(env) {
    ...
    return node_path_1.default.join((0, paths_js_1.resolveStateDir)(env), "identity", DEVICE_AUTH_FILE);
}
...
function normalizeScopes(scopes) {
    ...
    return __spreadArray([], out, true).sort();
}
function readStore(filePath) {
    try {
        ...
        if ((parsed === null || parsed === void 0 ? void 0 : parsed.version) !== 1 || typeof parsed.deviceId !== "string")
            return null;
