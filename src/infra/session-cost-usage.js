...
var emptyTotals = function () { return ({
    input: 0,
    output: 0,
    cacheRead: 0,
    cacheWrite: 0,
...
var parseTimestamp = function (entry) {
    ...
    var messageTimestamp = toFiniteNumber(message === null || message === void 0 ? void 0 : message.timestamp);
...
var parseUsageEntry = function (entry) {
    ...
    if (role !== "assistant")
        return null;
    var usageRaw = (_a = message === null || message === void 0 ? void 0 : message.usage) !== null && _a !== void 0 ? _a : entry.usage;
    var usage = (0, usage_js_1.normalizeUsage)(usageRaw);
    if (!usage)
        return null;
    var provider = (_b = (typeof (message === null || message === void 0 ? void 0 : message.provider) === "string" ? message === null || message === void 0 ? void 0 : message.provider : undefined)) !== null && _b !== void 0 ? _b : (typeof entry.provider === "string" ? entry.provider : undefined);
    var model = (_c = (typeof (message === null || message === void 0 ? void 0 : message.model) === "string" ? message === null || message === void 0 ? void 0 : message.model : undefined)) !== null && _c !== void 0 ? _c : (typeof entry.model === "string" ? entry.model : undefined);
    return {
        usage: usage,
...
var applyUsageTotals = function (totals, usage) {
    ...
    var totalTokens = (_e = usage.total) !== null && _e !== void 0 ? _e : ((_f = usage.input) !== null && _f !== void 0 ? _f : 0) + ((_g = usage.output) !== null && _g !== void 0 ? _g : 0) + ((_h = usage.cacheRead) !== null && _h !== void 0 ? _h : 0) + ((_j = usage.cacheWrite) !== null && _j !== void 0 ? _j : 0);
                ...
                case 3:
                    ...
                    try {
                        ...
                        if (entry.costTotal === undefined) {
                            ...
                            entry.costTotal = (0, usage_format_js_1.estimateUsageCost)({ usage: entry.usage, cost: cost });
                        }
...
function loadCostUsageSummary(params) {
    return __awaiter(this, void 0, void 0, function () {
        var days, now, since, sinceTime, dailyMap, totals, sessionsDir, entries, files, _i, files_1, filePath, daily;
        var _this = this;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    days = Math.max(1, Math.floor((_a = params === null || params === void 0 ? void 0 : params.days) !== null && _a !== void 0 ? _a : 30));
                    now = new Date();
                    since = new Date(now);
                    ...
                    dailyMap = new Map();
                    totals = emptyTotals();
                    sessionsDir = (0, paths_js_1.resolveSessionTranscriptsDirForAgent)(params === null || params === void 0 ? void 0 : params.agentId);
                    return [4 /*yield*/, node_fs_1.default.promises.readdir(sessionsDir, { withFileTypes: true }).catch(function () { return []; })];
                case 1:
                    entries = _b.sent();
                    return [4 /*yield*/, Promise.all(entries
                            .filter(function (entry) { return entry.isFile() && entry.name.endsWith(".jsonl"); })
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, node_fs_1.default.promises.stat(filePath).catch(function () { return null; })];
                                    case 1:
                                        stats = _a.sent();
                                        if (!stats)
                ...
                case 2:
                    files = (_b.sent()).filter(function (filePath) { return Boolean(filePath); });
                    _i = 0, files_1 = files;
                    _b.label = 3;
                case 3:
                    if (!(_i < files_1.length)) return [3 /*break*/, 6];
                    filePath = files_1[_i];
                    return [4 /*yield*/, scanUsageFile({
                            filePath: filePath,
                            ...
                            onEntry: function (entry) {
                                ...
                                if (!ts || ts < sinceTime)
                                    return;
                                var dayKey = formatDayKey((_b = entry.timestamp) !== null && _b !== void 0 ? _b : now);
                                var bucket = (_c = dailyMap.get(dayKey)) !== null && _c !== void 0 ? _c : emptyTotals();
...
function loadSessionCostSummary(params) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    sessionFile = (_a = params.sessionFile) !== null && _a !== void 0 ? _a : (params.sessionId ? (0, paths_js_1.resolveSessionFilePath)(params.sessionId, params.sessionEntry) : undefined);
                ...
                case 1:
                    _b.sent();
                    return [2 /*return*/, __assign({ sessionId: params.sessionId, sessionFile: sessionFile, lastActivity: lastActivity }, totals)];
            }
        });
    });
}
