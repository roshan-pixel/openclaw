...
function resolveClaudeWebSessionKey() {
    var _a, _b, _c, _d, _e;
    var direct = (_b = (_a = process.env.CLAUDE_AI_SESSION_KEY) === null || _a === void 0 ? void 0 : _a.trim()) !== null && _b !== void 0 ? _b : (_c = process.env.CLAUDE_WEB_SESSION_KEY) === null || _c === void 0 ? void 0 : _c.trim();
    if (direct === null || direct === void 0 ? void 0 : direct.startsWith("sk-ant-"))
        return direct;
    var cookieHeader = (_d = process.env.CLAUDE_WEB_COOKIE) === null || _d === void 0 ? void 0 : _d.trim();
    if (!cookieHeader)
        return undefined;
    var stripped = cookieHeader.replace(/^cookie:\\s*/i, "");
    var match = stripped.match(/(?:^|;\\s*)sessionKey=([^;\\s]+)/i);
    var value = (_e = match === null || match === void 0 ? void 0 : match[1]) === null || _e === void 0 ? void 0 : _e.trim();
    return (value === null || value === void 0 ? void 0 : value.startsWith("sk-ant-")) ? value : undefined;
}
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, provider_usage_fetch_shared_js_1.fetchJson)("https://claude.ai/api/organizations", { headers: headers }, timeoutMs, fetchFn)];
                case 1:
                    orgRes = _e.sent();
                    if (!orgRes.ok)
                ...
                case 2:
                    orgs = (_e.sent());
                    orgId = (_b = (_a = orgs === null || orgs === void 0 ? void 0 : orgs[0]) === null || _a === void 0 ? void 0 : _a.uuid) === null || _b === void 0 ? void 0 : _b.trim();
                    if (!orgId)
                        return [2 /*return*/, null];
                    return [4 /*yield*/, (0, provider_usage_fetch_shared_js_1.fetchJson)("https://claude.ai/api/organizations/".concat(orgId, "/usage"), { headers: headers }, timeoutMs, fetchFn)];
                case 3:
                    usageRes = _e.sent();
                    if (!usageRes.ok)
                        return [2 /*return*/, null];
                ...
                case 4:
                    data = (_e.sent());
                    windows = [];
                    if (((_c = data.five_hour) === null || _c === void 0 ? void 0 : _c.utilization) !== undefined) {
                        windows.push({
                            label: "5h",
                    ...
                    if (((_d = data.seven_day) === null || _d === void 0 ? void 0 : _d.utilization) !== undefined) {
                        windows.push({
                            label: "Week",
                    ...
                    if ((modelWindow === null || modelWindow === void 0 ? void 0 : modelWindow.utilization) !== undefined) {
                        windows.push({
...
function fetchClaudeUsage(token, timeoutMs, fetchFn) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0: return [4 /*yield*/, (0, provider_usage_fetch_shared_js_1.fetchJson)("https://api.anthropic.com/api/oauth/usage", {
                        headers: {
                ...
                case 3:
                    data_1 = (_e.sent());
                    raw = (_b = data_1 === null || data_1 === void 0 ? void 0 : data_1.error) === null || _b === void 0 ? void 0 : _b.message;
                ...
                case 4:
                    ...
                    return [3 /*break*/, 5];
                case 5:
                    if (!(res.status === 403 && (message === null || message === void 0 ? void 0 : message.includes("scope requirement user:profile")))) return [3 /*break*/, 7];
                    sessionKey = resolveClaudeWebSessionKey();
                    if (!sessionKey) return [3 /*break*/, 7];
