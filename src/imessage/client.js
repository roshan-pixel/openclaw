...
var IMessageRpcClient = /** @class */ (function () {
    function IMessageRpcClient(opts) {
        ...
        this.dbPath = ((_b = opts.dbPath) === null || _b === void 0 ? void 0 : _b.trim()) ? (0, utils_js_1.resolveUserPath)(opts.dbPath) : undefined;
            ...
            return __generator(this, function (_b) {
                ...
                (_a = child.stderr) === null || _a === void 0 ? void 0 : _a.on("data", function (chunk) {
                    ...
                    for (var _i = 0, lines_1 = lines; _i < lines_1.length; _i++) {
                        ...
                        if (!line.trim())
                            continue;
                        (_b = (_a = _this.runtime) === null || _a === void 0 ? void 0 : _a.error) === null || _b === void 0 ? void 0 : _b.call(_a, "imsg rpc: ".concat(line.trim()));
                    }
                });
    ...
    IMessageRpcClient.prototype.waitForClose = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.closed];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        timeoutMs = (_a = opts === null || opts === void 0 ? void 0 : opts.timeoutMs) !== null && _a !== void 0 ? _a : 10000;
                        response = new Promise(function (resolve, reject) {
                            var key = String(id);
                            var timer = timeoutMs > 0
                                ? setTimeout(function () {
    ...
    IMessageRpcClient.prototype.handleLine = function (line) {
        ...
        try {
            ...
            (_b = (_a = this.runtime) === null || _a === void 0 ? void 0 : _a.error) === null || _b === void 0 ? void 0 : _b.call(_a, "imsg rpc: failed to parse ".concat(line, ": ").concat(detail));
            return;
        }
        if (parsed.id !== undefined && parsed.id !== null) {
            ...
            if (parsed.error) {
                var baseMessage = (_c = parsed.error.message) !== null && _c !== void 0 ? _c : "imsg rpc error";
                ...
                var msg = suffixes.length > 0 ? "".concat(baseMessage, ": ").concat(suffixes.join(" ")) : baseMessage;
        ...
        if (parsed.method) {
            (_d = this.onNotification) === null || _d === void 0 ? void 0 : _d.call(this, {
    ...
    IMessageRpcClient.prototype.failAll = function (err) {
        for (var _i = 0, _a = this.pending.entries(); _i < _a.length; _i++) {
            var _b = _a[_i], key = _b[0], pending = _b[1];
            if (pending.timer)
                clearTimeout(pending.timer);
            pending.reject(err);
            this.pending.delete(key);
