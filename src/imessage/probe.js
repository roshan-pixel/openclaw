    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, (0, exec_js_1.runCommandWithTimeout)([cliPath, "rpc", "--help"], { timeoutMs: 2000 })];
                case 2:
                    result = _b.sent();
                    ...
                    return [2 /*return*/, {
                            supported: false,
                            error: combined || "imsg rpc --help failed (code ".concat(String((_a = result.code) !== null && _a !== void 0 ? _a : "unknown"), ")"),
                        }];
                case 3:
                    err_1 = _b.sent();
        ...
        return __generator(this, function (_k) {
            switch (_k.label) {
                case 0:
                    ...
                    cliPath = ((_a = opts.cliPath) === null || _a === void 0 ? void 0 : _a.trim()) || ((_d = (_c = (_b = cfg === null || cfg === void 0 ? void 0 : cfg.channels) === null || _b === void 0 ? void 0 : _b.imessage) === null || _c === void 0 ? void 0 : _c.cliPath) === null || _d === void 0 ? void 0 : _d.trim()) || "imsg";
                    dbPath = ((_e = opts.dbPath) === null || _e === void 0 ? void 0 : _e.trim()) || ((_h = (_g = (_f = cfg === null || cfg === void 0 ? void 0 : cfg.channels) === null || _f === void 0 ? void 0 : _f.imessage) === null || _g === void 0 ? void 0 : _g.dbPath) === null || _h === void 0 ? void 0 : _h.trim());
                ...
                case 2:
                    ...
                    if (!rpcSupport.supported) {
                        return [2 /*return*/, {
                                ok: false,
                                error: (_j = rpcSupport.error) !== null && _j !== void 0 ? _j : "imsg rpc unavailable",
                ...
                case 4:
                    ...
                    return [4 /*yield*/, client.request("chats.list", { limit: 1 }, { timeoutMs: timeoutMs })];
                case 5:
                    _k.sent();
                ...
                case 7: return [4 /*yield*/, client.stop()];
                case 8:
                    _k.sent();
                    return [7 /*endfinally*/];
