...
function normalizeIMessageHandle(raw) {
    ...
    for (var _a = 0, CHAT_GUID_PREFIXES_1 = CHAT_GUID_PREFIXES; _a < CHAT_GUID_PREFIXES_1.length; _a++) {
    ...
    for (var _b = 0, CHAT_IDENTIFIER_PREFIXES_1 = CHAT_IDENTIFIER_PREFIXES; _b < CHAT_IDENTIFIER_PREFIXES_1.length; _b++) {
...
function parseIMessageTarget(raw) {
    ...
    for (var _c = 0, CHAT_GUID_PREFIXES_2 = CHAT_GUID_PREFIXES; _c < CHAT_GUID_PREFIXES_2.length; _c++) {
    ...
    for (var _d = 0, CHAT_IDENTIFIER_PREFIXES_2 = CHAT_IDENTIFIER_PREFIXES; _d < CHAT_IDENTIFIER_PREFIXES_2.length; _d++) {
...
function parseIMessageAllowTarget(raw) {
    ...
    for (var _b = 0, CHAT_GUID_PREFIXES_3 = CHAT_GUID_PREFIXES; _b < CHAT_GUID_PREFIXES_3.length; _b++) {
    ...
    for (var _c = 0, CHAT_IDENTIFIER_PREFIXES_3 = CHAT_IDENTIFIER_PREFIXES; _c < CHAT_IDENTIFIER_PREFIXES_3.length; _c++) {
