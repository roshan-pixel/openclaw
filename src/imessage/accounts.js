...
function listConfiguredAccountIds(cfg) {
    var _a, _b;
    var accounts = (_b = (_a = cfg.channels) === null || _a === void 0 ? void 0 : _a.imessage) === null || _b === void 0 ? void 0 : _b.accounts;
...
function mergeIMessageAccountConfig(cfg, accountId) {
    var _a, _b, _c;
    var _d = ((_b = (_a = cfg.channels) === null || _a === void 0 ? void 0 : _a.imessage) !== null && _b !== void 0 ? _b : {}), _ignored = _d.accounts, base = __rest(_d, ["accounts"]);
...
function resolveIMessageAccount(params) {
    ...
    var baseEnabled = ((_b = (_a = params.cfg.channels) === null || _a === void 0 ? void 0 : _a.imessage) === null || _b === void 0 ? void 0 : _b.enabled) !== false;
    var merged = mergeIMessageAccountConfig(params.cfg, accountId);
    var accountEnabled = merged.enabled !== false;
    var configured = Boolean(((_c = merged.cliPath) === null || _c === void 0 ? void 0 : _c.trim()) ||
...
function listEnabledIMessageAccounts(cfg) {
    return listIMessageAccountIds(cfg)
        .map(function (accountId) { return resolveIMessageAccount({ cfg: cfg, accountId: accountId }); })
