...
function createCliProgress(options) {
    ...
    var completed = 0;
    var percent = 0;
    var indeterminate = (_c = options.indeterminate) !== null && _c !== void 0 ? _c : (options.total === undefined || options.total === null);
    activeProgress += 1;
    if (isTty) {
...
function withProgressTotals(options, work) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withProgress(options, function (progress) { return __awaiter(_this, void 0, void 0, function () {
                        var update;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    update = function (_a) {
                                        var completed = _a.completed, total = _a.total, label = _a.label;
                                        if (label)
