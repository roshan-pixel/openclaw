...
function normalizeAttachments(ctx) {
    ...
    var resolveMime = function (count, index) {
        var typeHint = typesFromArray === null || typesFromArray === void 0 ? void 0 : typesFromArray[index];
    ...
    if (pathsFromArray && pathsFromArray.length > 0) {
        ...
        return pathsFromArray
            ...
            return ({
                ...
                url: (_a = urls_1 === null || urls_1 === void 0 ? void 0 : urls_1[index]) !== null && _a !== void 0 ? _a : ctx.MediaUrl,
                mime: resolveMime(count_1, index),
                index: index,
            });
        })
            .filter(function (entry) { var _a, _b; return Boolean(((_a = entry.path) === null || _a === void 0 ? void 0 : _a.trim()) || ((_b = entry.url) === null || _b === void 0 ? void 0 : _b.trim())); });
    }
    if (urlsFromArray && urlsFromArray.length > 0) {
        ...
        return urlsFromArray
            ...
            .filter(function (entry) { var _a; return Boolean((_a = entry.url) === null || _a === void 0 ? void 0 : _a.trim()); });
    }
...
function resolveAttachmentKind(attachment) {
    ...
    if (kind === "image" || kind === "audio" || kind === "video")
        return kind;
    var ext = (0, mime_js_1.getFileExtension)((_a = attachment.path) !== null && _a !== void 0 ? _a : attachment.url);
    if (!ext)
        return "unknown";
    if ([".mp4", ".mov", ".mkv", ".webm", ".avi", ".m4v"].includes(ext))
        return "video";
    if ((0, mime_js_1.isAudioFileName)((_b = attachment.path) !== null && _b !== void 0 ? _b : attachment.url))
        return "audio";
...
function orderAttachments(attachments, prefer) {
    ...
    if (prefer === "path") {
        var withPath = attachments.filter(function (item) { return item.path; });
        var withoutPath = attachments.filter(function (item) { return !item.path; });
        return __spreadArray(__spreadArray([], withPath, true), withoutPath, true);
    }
    if (prefer === "url") {
        var withUrl = attachments.filter(function (item) { return item.url; });
        var withoutUrl = attachments.filter(function (item) { return !item.url; });
...
function selectAttachments(params) {
    var _a, _b;
    var capability = params.capability, attachments = params.attachments, policy = params.policy;
    ...
    if (matches.length === 0)
        return [];
    var ordered = orderAttachments(matches, policy === null || policy === void 0 ? void 0 : policy.prefer);
    var mode = (_a = policy === null || policy === void 0 ? void 0 : policy.mode) !== null && _a !== void 0 ? _a : "first";
    var maxAttachments = (_b = policy === null || policy === void 0 ? void 0 : policy.maxAttachments) !== null && _b !== void 0 ? _b : DEFAULT_MAX_ATTACHMENTS;
    if (mode === "all") {
    ...
    MediaAttachmentCache.prototype.getBuffer = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_o) {
                switch (_o.label) {
                    case 0: return [4 /*yield*/, this.ensureEntry(params.attachmentIndex)];
                    case 1:
                        entry = _o.sent();
                        if (entry.buffer) {
                            if (entry.buffer.length > params.maxBytes) {
                                throw new errors_js_1.MediaUnderstandingSkipError("maxBytes", "Attachment ".concat(params.attachmentIndex + 1, " exceeds maxBytes ").concat(params.maxBytes));
                            }
                            return [2 /*return*/, {
                                    buffer: entry.buffer,
                                    mime: entry.bufferMime,
                                    fileName: (_e = entry.bufferFileName) !== null && _e !== void 0 ? _e : "media-".concat(params.attachmentIndex + 1),
                                    size: entry.buffer.length,
                                }];
                        }
                        if (!entry.resolvedPath) return [3 /*break*/, 7];
                    ...
                    case 3:
                        ...
                        entry.buffer = buffer;
                        _a = entry;
                        if (!((_g = (_f = entry.bufferMime) !== null && _f !== void 0 ? _f : entry.attachment.mime) !== null && _g !== void 0)) return [3 /*break*/, 4];
                        _b = _g;
                        return [3 /*break*/, 6];
                    case 4: return [4 /*yield*/, (0, mime_js_1.detectMime)({
                            buffer: buffer,
                    ...
                    case 6:
                        ...
                        entry.bufferFileName =
                            node_path_1.default.basename(entry.resolvedPath) || "media-".concat(params.attachmentIndex + 1);
                        return [2 /*return*/, {
                                buffer: buffer,
                                mime: entry.bufferMime,
                    ...
                    case 7:
                        ...
                        if (!url) {
                            throw new errors_js_1.MediaUnderstandingSkipError("empty", "Attachment ".concat(params.attachmentIndex + 1, " has no path or URL."));
                        }
                        _o.label = 8;
                    case 8:
                        _o.trys.push([8, 13, , 14]);
                        fetchImpl = function (input, init) {
                            return (0, shared_js_1.fetchWithTimeout)(resolveRequestUrl(input), init !== null && init !== void 0 ? init : {}, params.timeoutMs, fetch);
                        };
                        return [4 /*yield*/, (0, fetch_js_1.fetchRemoteMedia)({ url: url, fetchImpl: fetchImpl, maxBytes: params.maxBytes })];
                    case 9:
                        fetched = _o.sent();
                        entry.buffer = fetched.buffer;
                        _c = entry;
                        if (!((_k = (_j = entry.attachment.mime) !== null && _j !== void 0 ? _j : fetched.contentType) !== null && _k !== void 0)) return [3 /*break*/, 10];
                        _d = _k;
                        return [3 /*break*/, 12];
                    case 10: return [4 /*yield*/, (0, mime_js_1.detectMime)({
                    ...
                    case 12:
                        _c.bufferMime = _d;
                        entry.bufferFileName = (_m = fetched.fileName) !== null && _m !== void 0 ? _m : "media-".concat(params.attachmentIndex + 1);
                        return [2 /*return*/, {
                                buffer: fetched.buffer,
                                mime: entry.bufferMime,
                                fileName: entry.bufferFileName,
                    ...
                    case 13:
                        ...
                        if (isAbortError(err_1)) {
                            throw new errors_js_1.MediaUnderstandingSkipError("timeout", "Attachment ".concat(params.attachmentIndex + 1, " timed out while fetching."));
                        }
                        throw err_1;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        entry = _b.sent();
                        if (!entry.resolvedPath) return [3 /*break*/, 4];
                        if (!params.maxBytes) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.ensureLocalStat(entry)];
                    case 2:
                        size = _b.sent();
                    ...
                    case 4:
                        ...
                        maxBytes = (_a = params.maxBytes) !== null && _a !== void 0 ? _a : Number.POSITIVE_INFINITY;
                    ...
                    case 5:
                        ...
                        tmpPath = node_path_1.default.join(node_os_1.default.tmpdir(), "openclaw-media-".concat(node_crypto_1.default.randomUUID()).concat(extension));
                        return [4 /*yield*/, promises_1.default.writeFile(tmpPath, bufferResult.buffer)];
                    case 6:
                        _b.sent();
                        entry.tempPath = tmpPath;
                        entry.tempCleanup = function () { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, promises_1.default.unlink(tmpPath).catch(function () { })];
                                    case 1:
                                        _a.sent();
                                        return [2 /*return*/];
                                }
    ...
    MediaAttachmentCache.prototype.ensureEntry = function (attachmentIndex) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                attachment = (_a = this.attachments.find(function (item) { return item.index === attachmentIndex; })) !== null && _a !== void 0 ? _a : {
                ...
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        if ((0, globals_js_1.shouldLogVerbose)()) {
                            (0, globals_js_1.logVerbose)("Failed to read attachment ".concat(entry.attachment.index + 1, ": ").concat(String(err_2)));
                        }
                        return [2 /*return*/, undefined];
