...
function describeImageWithModel(params) {
    return __awaiter(this, void 0, void 0, function () {
        var authStorage, modelRegistry, model, apiKeyInfo, apiKey, base64, text_1, context, message, text;
        var _a, _b, _c, _d, _e, _f;
        return __generator(this, function (_g) {
            switch (_g.label) {
                case 0: return [4 /*yield*/, (0, models_config_js_1.ensureOpenClawModelsJson)(params.cfg, params.agentDir)];
                case 1:
                    _g.sent();
                    ...
                    if (!((_a = model.input) === null || _a === void 0 ? void 0 : _a.includes("image"))) {
                        throw new Error("Model does not support images: ".concat(params.provider, "/").concat(params.model));
                    }
                ...
                case 2:
                    ...
                    if (!(model.provider === "minimax")) return [3 /*break*/, 4];
                    return [4 /*yield*/, (0, minimax_vlm_js_1.minimaxUnderstandImage)({
                            apiKey: apiKey,
                            prompt: (_b = params.prompt) !== null && _b !== void 0 ? _b : "Describe the image.",
                            imageDataUrl: "data:".concat((_c = params.mime) !== null && _c !== void 0 ? _c : "image/jpeg", ";base64,").concat(base64),
                        ...
                        messages: [
                            {
                                role: "user",
                                content: [
                                    { type: "text", text: (_d = params.prompt) !== null && _d !== void 0 ? _d : "Describe the image." },
                                    { type: "image", data: base64, mimeType: (_e = params.mime) !== null && _e !== void 0 ? _e : "image/jpeg" },
                                ],
                                timestamp: Date.now(),
                            },
                        ],
