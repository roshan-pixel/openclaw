...
function transcribeDeepgramAudio(params) {
    return __awaiter(this, void 0, void 0, function () {
        var fetchFn, baseUrl, model, url, _i, _a, _b, key, value, headers, body, res, detail, suffix, payload, transcript;
        var _c, _d, _e, _f, _g, _h, _j, _k, _l;
        return __generator(this, function (_m) {
            switch (_m.label) {
                case 0:
                    fetchFn = (_c = params.fetchFn) !== null && _c !== void 0 ? _c : fetch;
                    baseUrl = (0, shared_js_1.normalizeBaseUrl)(params.baseUrl, exports.DEFAULT_DEEPGRAM_AUDIO_BASE_URL);
                    ...
                    if (!headers.has("content-type")) {
                        headers.set("content-type", (_e = params.mime) !== null && _e !== void 0 ? _e : "application/octet-stream");
                    }
                    body = new Uint8Array(params.buffer);
                    return [4 /*yield*/, (0, shared_js_1.fetchWithTimeout)(url.toString(), {
                            method: "POST",
                            headers: headers,
                            body: body,
                ...
                case 2:
                    ...
                    throw new Error("Audio transcription failed (HTTP ".concat(res.status, ")").concat(suffix));
                case 3: return [4 /*yield*/, res.json()];
                case 4:
                    payload = (_m.sent());
                    transcript = (_l = (_k = (_j = (_h = (_g = (_f = payload.results) === null || _f === void 0 ? void 0 : _f.channels) === null || _g === void 0 ? void 0 : _g[0]) === null || _h === void 0 ? void 0 : _h.alternatives) === null || _j === void 0 ? void 0 : _j[0]) === null || _k === void 0 ? void 0 : _k.transcript) === null || _l === void 0 ? void 0 : _l.trim();
                    if (!transcript) {
