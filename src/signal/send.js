...
function resolveSignalRpcContext(opts, accountInfo) {
    ...
    var resolvedAccount = accountInfo ||
        (!hasBaseUrl || !hasAccount
            ...
            : undefined);
    var baseUrl = ((_c = opts.baseUrl) === null || _c === void 0 ? void 0 : _c.trim()) || (resolvedAccount === null || resolvedAccount === void 0 ? void 0 : resolvedAccount.baseUrl);
    if (!baseUrl) {
        throw new Error("Signal base URL is required");
    }
    var account = ((_d = opts.account) === null || _d === void 0 ? void 0 : _d.trim()) || ((_e = resolvedAccount === null || resolvedAccount === void 0 ? void 0 : resolvedAccount.config.account) === null || _e === void 0 ? void 0 : _e.trim());
...
function sendMessageSignal(to_1, text_1) {
    return __awaiter(this, arguments, void 0, function (to, text, opts) {
        var cfg, accountInfo, _a, baseUrl, account, target, message, messageFromPlaceholder, textStyles, textMode, maxBytes, attachments, resolved, kind, tableMode, formatted, params, targetParams, result, timestamp;
        var _b, _c, _d, _e;
        if (opts === void 0) { opts = {}; }
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                    ...
                    _a = resolveSignalRpcContext(opts, accountInfo), baseUrl = _a.baseUrl, account = _a.account;
                    ...
                    maxBytes = (function () {
                        ...
                        if (typeof ((_b = (_a = cfg.agents) === null || _a === void 0 ? void 0 : _a.defaults) === null || _b === void 0 ? void 0 : _b.mediaMaxMb) === "number") {
                            return cfg.agents.defaults.mediaMaxMb * 1024 * 1024;
                        }
                        return 8 * 1024 * 1024;
                    })();
                    if (!((_c = opts.mediaUrl) === null || _c === void 0 ? void 0 : _c.trim())) return [3 /*break*/, 2];
                    return [4 /*yield*/, resolveAttachment(opts.mediaUrl.trim(), maxBytes)];
                case 1:
                    resolved = _f.sent();
                    attachments = [resolved.path];
                    kind = (0, constants_js_1.mediaKindFromMime)((_d = resolved.contentType) !== null && _d !== void 0 ? _d : undefined);
                    if (!message && kind) {
                ...
                case 2:
                    ...
                    if (textStyles.length > 0) {
                        params["text-style"] = textStyles.map(function (style) { return "".concat(style.start, ":").concat(style.length, ":").concat(style.style); });
                    }
                    if (account)
                    ...
                    return [4 /*yield*/, (0, client_js_1.signalRpcRequest)("send", params, {
                            baseUrl: baseUrl,
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    if (opts.stop)
                        params.stop = true;
                    return [4 /*yield*/, (0, client_js_1.signalRpcRequest)("sendTyping", params, {
                            baseUrl: baseUrl,
                            timeoutMs: opts.timeoutMs,
                        })];
                case 1:
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    if (!targetParams)
                        return [2 /*return*/, false];
                    params = __assign(__assign({}, targetParams), { targetTimestamp: targetTimestamp, type: (_b = opts.type) !== null && _b !== void 0 ? _b : "read" });
                    if (account)
                        params.account = account;
                    return [4 /*yield*/, (0, client_js_1.signalRpcRequest)("sendReceipt", params, {
                            baseUrl: baseUrl,
                            timeoutMs: opts.timeoutMs,
                        })];
                case 1:
