    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, , 3, 4]);
                    return [4 /*yield*/, fetchImpl(url, __assign(__assign({}, init), { signal: controller.signal }))];
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetchWithTimeout("".concat(baseUrl, "/api/v1/rpc"), {
                            method: "POST",
    ...
    return __awaiter(this, arguments, void 0, function (baseUrl, timeoutMs) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, fetchWithTimeout("".concat(normalized, "/api/v1/check"), { method: "GET" }, timeoutMs)];
                case 2:
                    res = _a.sent();
                    if (!res.ok) {
...
function streamSignalEvents(params) {
    return __awaiter(this, void 0, void 0, function () {
        var baseUrl, url, fetchImpl, res, reader, decoder, buffer, currentEvent, flushEvent, _a, value, done, lineEnd, line, _b, rawField, rest, field, rawValue, value_1;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    res = _c.sent();
                    if (!res.ok || !res.body) {
                        throw new Error("Signal SSE failed (".concat(res.status, " ").concat(res.statusText || "error", ")"));
                    }
                ...
                case 3:
                    ...
                    while (lineEnd !== -1) {
                        ...
                        if (field === "event") {
                            ...
                            currentEvent.data = currentEvent.data ? "".concat(currentEvent.data, "\n").concat(value_1) : value_1;
                        }
                        else if (field === "id") {
