...
function listConfiguredAccountIds(cfg) {
    var _a, _b;
    var accounts = (_b = (_a = cfg.channels) === null || _a === void 0 ? void 0 : _a.signal) === null || _b === void 0 ? void 0 : _b.accounts;
...
function mergeSignalAccountConfig(cfg, accountId) {
    var _a, _b, _c;
    var _d = ((_b = (_a = cfg.channels) === null || _a === void 0 ? void 0 : _a.signal) !== null && _b !== void 0 ? _b : {}), _ignored = _d.accounts, base = __rest(_d, ["accounts"]);
...
function resolveSignalAccount(params) {
    ...
    var baseEnabled = ((_b = (_a = params.cfg.channels) === null || _a === void 0 ? void 0 : _a.signal) === null || _b === void 0 ? void 0 : _b.enabled) !== false;
    ...
    var baseUrl = ((_e = merged.httpUrl) === null || _e === void 0 ? void 0 : _e.trim()) || "http://".concat(host, ":").concat(port);
    var configured = Boolean(((_f = merged.account) === null || _f === void 0 ? void 0 : _f.trim()) ||
...
function listEnabledSignalAccounts(cfg) {
    return listSignalAccountIds(cfg)
        .map(function (accountId) { return resolveSignalAccount({ cfg: cfg, accountId: accountId }); })
