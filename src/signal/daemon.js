...
function spawnSignalDaemon(opts) {
    ...
    var log = (_b = (_a = opts.runtime) === null || _a === void 0 ? void 0 : _a.log) !== null && _b !== void 0 ? _b : (function () { });
    var error = (_d = (_c = opts.runtime) === null || _c === void 0 ? void 0 : _c.error) !== null && _d !== void 0 ? _d : (function () { });
    (_e = child.stdout) === null || _e === void 0 ? void 0 : _e.on("data", function (data) {
    ...
    (_f = child.stderr) === null || _f === void 0 ? void 0 : _f.on("data", function (data) {
        for (var _i = 0, _a = data.toString().split(/\r?\n/); _i < _a.length; _i++) {
            var line = _a[_i];
            var kind = classifySignalCliLogLine(line);
            if (kind === "log")
