...
function sendReactionSignal(recipient_1, targetTimestamp_1, emoji_1) {
    return __awaiter(this, arguments, void 0, function (recipient, targetTimestamp, emoji, opts) {
        var accountInfo, _a, baseUrl, account, normalizedRecipient, groupId, targetAuthorParams, params, result;
        var _b;
        if (opts === void 0) { opts = {}; }
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    _a = resolveReactionRpcContext(opts, accountInfo), baseUrl = _a.baseUrl, account = _a.account;
                    ...
                    params = __assign({ emoji: emoji.trim(), targetTimestamp: targetTimestamp }, targetAuthorParams);
                    ...
                    return [4 /*yield*/, (0, client_js_1.signalRpcRequest)("sendReaction", params, {
                            baseUrl: baseUrl,
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    params = __assign({ emoji: emoji.trim(), targetTimestamp: targetTimestamp, remove: true }, targetAuthorParams);
                    if (normalizedRecipient)
                        params.recipients = [normalizedRecipient];
                    if (groupId)
                        params.groupIds = [groupId];
