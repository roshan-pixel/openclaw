...
function normalizeAllowlist(list) {
    return new Set((list !== null && list !== void 0 ? list : []).map(tool_policy_js_1.normalizeToolName).filter(Boolean));
}
...
function resolvePluginTools(params) {
    ...
    var existingNormalized = new Set(Array.from(existing, function (tool) { return (0, tool_policy_js_1.normalizeToolName)(tool); }));
