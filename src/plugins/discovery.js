...
function resolvePackageExtensions(manifest) {
    var _a;
    var raw = (_a = (0, manifest_js_1.getPackageManifestMetadata)(manifest)) === null || _a === void 0 ? void 0 : _a.extensions;
...
function deriveIdHint(params) {
    var _a, _b;
    var base = node_path_1.default.basename(params.filePath, node_path_1.default.extname(params.filePath));
    ...
    var unscoped = rawPackageName.includes("/")
        ? ((_b = rawPackageName.split("/").pop()) !== null && _b !== void 0 ? _b : rawPackageName)
        : rawPackageName;
...
function addCandidate(params) {
    ...
    params.candidates.push({
        ...
        packageName: ((_b = manifest === null || manifest === void 0 ? void 0 : manifest.name) === null || _b === void 0 ? void 0 : _b.trim()) || undefined,
        packageVersion: ((_c = manifest === null || manifest === void 0 ? void 0 : manifest.version) === null || _c === void 0 ? void 0 : _c.trim()) || undefined,
        packageDescription: ((_d = manifest === null || manifest === void 0 ? void 0 : manifest.description) === null || _d === void 0 ? void 0 : _d.trim()) || undefined,
        packageDir: params.packageDir,
        packageManifest: (0, manifest_js_1.getPackageManifestMetadata)(manifest !== null && manifest !== void 0 ? manifest : undefined),
    });
}
function discoverInDirectory(params) {
    ...
    var _loop_1 = function (entry) {
        ...
        var indexFile = indexCandidates
            .map(function (candidate) { return node_path_1.default.join(fullPath, candidate); })
            .find(function (candidate) { return node_fs_1.default.existsSync(candidate); });
...
function discoverFromPath(params) {
    ...
    if (stat.isDirectory()) {
        ...
        var indexCandidates = ["index.ts", "index.js", "index.mjs", "index.cjs"];
        var indexFile = indexCandidates
            .map(function (candidate) { return node_path_1.default.join(resolved, candidate); })
            .find(function (candidate) { return node_fs_1.default.existsSync(candidate); });
        if (indexFile && isExtensionFile(indexFile)) {
            addCandidate({
                candidates: params.candidates,
...
function discoverOpenClawPlugins(params) {
    ...
    for (var _i = 0, extra_1 = extra; _i < extra_1.length; _i++) {
        ...
        discoverFromPath({
            rawPath: trimmed,
            origin: "config",
            workspaceDir: (workspaceDir === null || workspaceDir === void 0 ? void 0 : workspaceDir.trim()) || undefined,
