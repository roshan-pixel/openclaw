...
var normalizeList = function (value) {
    if (!Array.isArray(value))
        return [];
    return value.map(function (entry) { return (typeof entry === "string" ? entry.trim() : ""); }).filter(Boolean);
};
...
var normalizePluginsConfig = function (config) {
    var _a, _b;
    var memorySlot = normalizeSlotValue((_a = config === null || config === void 0 ? void 0 : config.slots) === null || _a === void 0 ? void 0 : _a.memory);
    return {
        ...
        loadPaths: normalizeList((_b = config === null || config === void 0 ? void 0 : config.load) === null || _b === void 0 ? void 0 : _b.paths),
        slots: {
...
var hasExplicitMemorySlot = function (plugins) {
    return Boolean((plugins === null || plugins === void 0 ? void 0 : plugins.slots) && Object.prototype.hasOwnProperty.call(plugins.slots, "memory"));
};
var hasExplicitMemoryEntry = function (plugins) {
    return Boolean((plugins === null || plugins === void 0 ? void 0 : plugins.entries) && Object.prototype.hasOwnProperty.call(plugins.entries, "memory-core"));
};
var hasExplicitPluginConfig = function (plugins) {
    ...
    if (Array.isArray(plugins.deny) && plugins.deny.length > 0)
        return true;
    if (((_a = plugins.load) === null || _a === void 0 ? void 0 : _a.paths) && Array.isArray(plugins.load.paths) && plugins.load.paths.length > 0)
        return true;
...
function applyTestPluginDefaults(cfg, env) {
    ...
    if (explicitConfig) {
        ...
        return __assign(__assign({}, cfg), { plugins: __assign(__assign({}, plugins), { slots: __assign(__assign({}, plugins === null || plugins === void 0 ? void 0 : plugins.slots), { memory: "none" }) }) });
    }
    return __assign(__assign({}, cfg), { plugins: __assign(__assign({}, plugins), { enabled: false, slots: __assign(__assign({}, plugins === null || plugins === void 0 ? void 0 : plugins.slots), { memory: "none" }) }) });
}
