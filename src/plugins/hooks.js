...
function getHooksForName(registry, hookName) {
    return registry.typedHooks
        .filter(function (h) { return h.hookName === hookName; })
...
function createHookRunner(registry, options) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (hooks.length === 0)
                            return [2 /*return*/];
                        (_a = logger === null || logger === void 0 ? void 0 : logger.debug) === null || _a === void 0 ? void 0 : _a.call(logger, "[hooks] running ".concat(hookName, " (").concat(hooks.length, " handlers)"));
                        promises = hooks.map(function (hook) { return __awaiter(_this, void 0, void 0, function () {
                            var err_1, msg;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 2:
                                        err_1 = _a.sent();
                                        msg = "[hooks] ".concat(hookName, " handler from ").concat(hook.pluginId, " failed: ").concat(String(err_1));
                                        if (catchErrors) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        (_a = logger === null || logger === void 0 ? void 0 : logger.debug) === null || _a === void 0 ? void 0 : _a.call(logger, "[hooks] running ".concat(hookName, " (").concat(hooks.length, " handlers, sequential)"));
                        _i = 0, hooks_1 = hooks;
                        _b.label = 1;
                    case 1:
                        if (!(_i < hooks_1.length)) return [3 /*break*/, 6];
                        hook = hooks_1[_i];
                        _b.label = 2;
                    case 2:
                        _b.trys.push([2, 4, , 5]);
                    ...
                    case 4:
                        err_2 = _b.sent();
                        msg = "[hooks] ".concat(hookName, " handler from ").concat(hook.pluginId, " failed: ").concat(String(err_2));
                        if (catchErrors) {
                            logger === null || logger === void 0 ? void 0 : logger.error(msg);
                        }
                        else {
    ...
    function runBeforeAgentStart(event, ctx) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, runModifyingHook("before_agent_start", event, ctx, function (acc, next) {
                        var _a, _b;
                        return ({
                            systemPrompt: (_a = next.systemPrompt) !== null && _a !== void 0 ? _a : acc === null || acc === void 0 ? void 0 : acc.systemPrompt,
                            prependContext: (acc === null || acc === void 0 ? void 0 : acc.prependContext) && next.prependContext
                                ? "".concat(acc.prependContext, "\n\n").concat(next.prependContext)
                                : ((_b = next.prependContext) !== null && _b !== void 0 ? _b : acc === null || acc === void 0 ? void 0 : acc.prependContext),
                        });
                    })];
            });
        });
    ...
    function runMessageSending(event, ctx) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, runModifyingHook("message_sending", event, ctx, function (acc, next) {
                        var _a, _b;
                        return ({
                            content: (_a = next.content) !== null && _a !== void 0 ? _a : acc === null || acc === void 0 ? void 0 : acc.content,
                            cancel: (_b = next.cancel) !== null && _b !== void 0 ? _b : acc === null || acc === void 0 ? void 0 : acc.cancel,
                        });
                    })];
            });
        });
    ...
    function runBeforeToolCall(event, ctx) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, runModifyingHook("before_tool_call", event, ctx, function (acc, next) {
                        var _a, _b, _c;
                        return ({
                            params: (_a = next.params) !== null && _a !== void 0 ? _a : acc === null || acc === void 0 ? void 0 : acc.params,
                            block: (_b = next.block) !== null && _b !== void 0 ? _b : acc === null || acc === void 0 ? void 0 : acc.block,
                            blockReason: (_c = next.blockReason) !== null && _c !== void 0 ? _c : acc === null || acc === void 0 ? void 0 : acc.blockReason,
                        });
                    })];
            });
        });
        ...
        for (var _i = 0, hooks_2 = hooks; _i < hooks_2.length; _i++) {
            ...
            try {
                ...
                if (out && typeof out.then === "function") {
                    var msg = "[hooks] tool_result_persist handler from ".concat(hook.pluginId, " returned a Promise; ") +
                        "this hook is synchronous and the result was ignored.";
                    if (catchErrors) {
                        (_a = logger === null || logger === void 0 ? void 0 : logger.warn) === null || _a === void 0 ? void 0 : _a.call(logger, msg);
                        continue;
                    }
                    throw new Error(msg);
                }
                ...
                var msg = "[hooks] tool_result_persist handler from ".concat(hook.pluginId, " failed: ").concat(String(err));
                if (catchErrors) {
                    logger === null || logger === void 0 ? void 0 : logger.error(msg);
                }
                else {
    ...
    function hasHooks(hookName) {
        return registry.typedHooks.some(function (h) { return h.hookName === hookName; });
    }
    /**
     * Get count of registered hooks for a given hook name.
     */
    function getHookCount(hookName) {
        return registry.typedHooks.filter(function (h) { return h.hookName === hookName; }).length;
    }
    return {
        // Agent hooks
