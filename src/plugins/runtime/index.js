...
function createPluginRuntime() {
    return {
        ...
        channel: {
            ...
            reply: {
                dispatchReplyWithBufferedBlockDispatcher: provider_dispatcher_js_1.dispatchReplyWithBufferedBlockDispatcher,
            ...
            commands: {
                resolveCommandAuthorizedFromAuthorizers: command_gating_js_1.resolveCommandAuthorizedFromAuthorizers,
        ...
        logging: {
            ...
            getChildLogger: function (bindings, opts) {
                var logger = (0, logging_js_1.getChildLogger)(bindings, {
                    level: (opts === null || opts === void 0 ? void 0 : opts.level) ? (0, levels_js_1.normalizeLogLevel)(opts.level) : undefined,
                });
                return {
                    debug: function (message) { var _a; return (_a = logger.debug) === null || _a === void 0 ? void 0 : _a.call(logger, message); },
                    info: function (message) { return logger.info(message); },
                    warn: function (message) { return logger.warn(message); },
