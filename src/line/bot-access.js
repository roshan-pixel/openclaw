...
exports.isSenderAllowed = exports.firstDefined = exports.normalizeAllowFromWithStore = exports.normalizeAllowFrom = void 0;
...
var normalizeAllowFrom = function (list) {
    var entries = (list !== null && list !== void 0 ? list : []).map(function (value) { return normalizeAllowEntry(value); }).filter(Boolean);
...
var normalizeAllowFromWithStore = function (params) {
    var _a, _b;
    var combined = __spreadArray(__spreadArray([], ((_a = params.allowFrom) !== null && _a !== void 0 ? _a : []), true), ((_b = params.storeAllowFrom) !== null && _b !== void 0 ? _b : []), true);
...
var isSenderAllowed = function (params) {
    var allow = params.allow, senderId = params.senderId;
    if (!allow.hasEntries)
        return false;
