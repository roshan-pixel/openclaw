...
function recordChannelRuntimeState(params) {
    ...
    var existing = (_a = runtimeState.get(key)) !== null && _a !== void 0 ? _a : {
        running: false,
        lastStartAt: null,
        lastStopAt: null,
        lastError: null,
...
function monitorLineProvider(opts) {
    return __awaiter(this, void 0, void 0, function () {
        var channelAccessToken, channelSecret, accountId, config, runtime, abortSignal, webhookPath, resolvedAccountId, bot, normalizedPath, unregisterHttp, stopHandler;
        var _this = this;
        var _a;
        return __generator(this, function (_b) {
            channelAccessToken = opts.channelAccessToken, channelSecret = opts.channelSecret, accountId = opts.accountId, config = opts.config, runtime = opts.runtime, abortSignal = opts.abortSignal, webhookPath = opts.webhookPath;
            ...
            bot = (0, bot_js_1.createLineBot)({
                ...
                runtime: runtime,
                config: config,
                onMessage: function (ctx) { return __awaiter(_this, void 0, void 0, function () {
                    var ctxPayload, replyToken, route, shouldShowLoading, displayNamePromise, stopLoading, displayName, textLimit_1, replyTokenUsed_1, queuedFinal, err_1, replyErr_1;
                    var _this = this;
                    var _a, _b;
                    return __generator(this, function (_c) {
                        switch (_c.label) {
                            case 0:
                                if (!ctx)
                                    return [2 /*return*/];
                                ctxPayload = ctx.ctxPayload, replyToken = ctx.replyToken, route = ctx.route;
                            ...
                            case 1:
                                displayName = _c.sent();
                                (0, globals_js_1.logVerbose)("line: received message from ".concat(displayName, " (").concat(ctxPayload.From, ")"));
                                _c.label = 2;
                            case 2:
                                ...
                                return [4 /*yield*/, (0, provider_dispatcher_js_1.dispatchReplyWithBufferedBlockDispatcher)({
                                        ...
                                        cfg: config,
                                        dispatcherOptions: {
                                            responsePrefix: (0, identity_js_1.resolveEffectiveMessagesConfig)(config, route.agentId).responsePrefix,
                                            deliver: function (payload, _info) { return __awaiter(_this, void 0, void 0, function () {
                                                var lineData, nextReplyTokenUsed;
                                                var _a, _b;
                                                return __generator(this, function (_c) {
                                                    switch (_c.label) {
                                                        case 0:
                                                            lineData = (_b = (_a = payload.channelData) === null || _a === void 0 ? void 0 : _a.line) !== null && _b !== void 0 ? _b : {};
                                                            // Show loading animation before each delivery (non-blocking)
                                                            if (ctx.userId && !ctx.isGroup) {
                                                                void (0, send_js_1.showLoadingAnimation)(ctx.userId, { accountId: ctx.accountId }).catch(function () { });
                                                            }
                                                            return [4 /*yield*/, (0, auto_reply_delivery_js_1.deliverLineAutoReply)({
                                                                    payload: payload,
                                                                    lineData: lineData,
                                                                    to: ctxPayload.From,
                                                                    ...
                                                                    deps: {
                                                                        ...
                                                                        processLineMessage: markdown_to_line_js_1.processLineMessage,
                                                                        ...
                                                                        pushTextMessageWithQuickReplies: send_js_1.pushTextMessageWithQuickReplies,
                                                                        createQuickReplyItems: send_js_1.createQuickReplyItems,
                                                                        createTextMessageWithQuickReplies: send_js_1.createTextMessageWithQuickReplies,
                                                                        ...
                                                                        onReplyError: function (replyErr) {
                                                                            (0, globals_js_1.logVerbose)("line: reply token failed, falling back to push: ".concat(String(replyErr)));
                                                                        },
                                                                    },
                                                                })];
                                                        case 1:
                                            ...
                                            onError: function (err, info) {
                                                var _a;
                                                (_a = runtime.error) === null || _a === void 0 ? void 0 : _a.call(runtime, (0, globals_js_1.danger)("line ".concat(info.kind, " reply failed: ").concat(String(err))));
                                            },
                                        },
                                        replyOptions: {},
                                    })];
                            case 3:
                                ...
                                if (!queuedFinal) {
                                    (0, globals_js_1.logVerbose)("line: no response generated for message from ".concat(ctxPayload.From));
                                }
                                return [3 /*break*/, 10];
                            case 4:
                                err_1 = _c.sent();
                                (_a = runtime.error) === null || _a === void 0 ? void 0 : _a.call(runtime, (0, globals_js_1.danger)("line: auto-reply failed: ".concat(String(err_1))));
                                if (!replyToken) return [3 /*break*/, 8];
                                _c.label = 5;
                            case 5:
                                _c.trys.push([5, 7, , 8]);
                                return [4 /*yield*/, (0, send_js_1.replyMessageLine)(replyToken, [{ type: "text", text: "Sorry, I encountered an error processing your message." }], { accountId: ctx.accountId })];
                            case 6:
                                _c.sent();
                                return [3 /*break*/, 8];
                            case 7:
                                replyErr_1 = _c.sent();
                                (_b = runtime.error) === null || _b === void 0 ? void 0 : _b.call(runtime, (0, globals_js_1.danger)("line: error reply failed: ".concat(String(replyErr_1))));
                                return [3 /*break*/, 8];
            ...
            normalizedPath = (_a = (0, http_path_js_1.normalizePluginHttpPath)(webhookPath, "/line/webhook")) !== null && _a !== void 0 ? _a : "/line/webhook";
            unregisterHttp = (0, http_registry_js_1.registerPluginHttpRoute)({
                path: normalizedPath,
                pluginId: "line",
                accountId: resolvedAccountId,
                log: function (msg) { return (0, globals_js_1.logVerbose)(msg); },
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 2:
                                ...
                                if (!(body.events && body.events.length > 0)) return [3 /*break*/, 4];
                                (0, globals_js_1.logVerbose)("line: received ".concat(body.events.length, " webhook events"));
                                return [4 /*yield*/, bot.handleWebhook(body).catch(function (err) {
                                        var _a;
                                        (_a = runtime.error) === null || _a === void 0 ? void 0 : _a.call(runtime, (0, globals_js_1.danger)("line webhook handler failed: ".concat(String(err))));
                                    })];
                            case 3:
                                _b.sent();
                                _b.label = 4;
                            ...
                            case 5:
                                err_2 = _b.sent();
                                (_a = runtime.error) === null || _a === void 0 ? void 0 : _a.call(runtime, (0, globals_js_1.danger)("line webhook error: ".concat(String(err_2))));
                                if (!res.headersSent) {
                                    res.statusCode = 500;
                                    res.setHeader("Content-Type", "application/json");
            ...
            stopHandler = function () {
                (0, globals_js_1.logVerbose)("line: stopping provider for account ".concat(resolvedAccountId));
                unregisterHttp();
                recordChannelRuntimeState({
                    channel: "line",
                    accountId: resolvedAccountId,
            ...
            abortSignal === null || abortSignal === void 0 ? void 0 : abortSignal.addEventListener("abort", stopHandler);
            return [2 /*return*/, {
                    account: bot.account,
                    handleWebhook: bot.handleWebhook,
                    stop: function () {
                        stopHandler();
                        abortSignal === null || abortSignal === void 0 ? void 0 : abortSignal.removeEventListener("abort", stopHandler);
                    },
                }];
        });
    });
