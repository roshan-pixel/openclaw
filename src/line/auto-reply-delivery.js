...
function deliverLineAutoReply(params) {
    return __awaiter(this, void 0, void 0, function () {
        var payload, lineData, replyToken, accountId, to, textLimit, deps, replyTokenUsed, pushLineMessages, sendLineMessages, richMessages, hasQuickReplies, templateMsg, processed, _i, _a, flexMsg, chunks, mediaUrls, mediaMessages, hasRichOrMedia, err_1, nextReplyTokenUsed, combined, quickReply, targetIndex, target;
        var _this = this;
        var _b, _c, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    payload = params.payload, lineData = params.lineData, replyToken = params.replyToken, accountId = params.accountId, to = params.to, textLimit = params.textLimit, deps = params.deps;
                    replyTokenUsed = params.replyTokenUsed;
                    pushLineMessages = function (messages) { return __awaiter(_this, void 0, void 0, function () {
                        var i;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    ...
                                    return [4 /*yield*/, deps.pushMessagesLine(to, messages.slice(i, i + 5), {
                                            accountId: accountId,
                                        })];
                                case 2:
                                    _a.sent();
                    ...
                    sendLineMessages = function (messages, allowReplyToken) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            switch (_b.label) {
                                case 0:
                                    if (messages.length === 0)
                                        return [2 /*return*/];
                                    remaining = messages;
                                    if (!(allowReplyToken && replyToken && !replyTokenUsed)) return [3 /*break*/, 6];
                                    replyBatch = remaining.slice(0, 5);
                                    _b.label = 1;
                                case 1:
                                    _b.trys.push([1, 3, , 5]);
                                    return [4 /*yield*/, deps.replyMessageLine(replyToken, replyBatch, {
                                            accountId: accountId,
                                        })];
                                case 2:
                                    _b.sent();
                                ...
                                case 3:
                                    err_2 = _b.sent();
                                    (_a = deps.onReplyError) === null || _a === void 0 ? void 0 : _a.call(deps, err_2);
                    ...
                    richMessages = [];
                    hasQuickReplies = Boolean((_b = lineData.quickReplies) === null || _b === void 0 ? void 0 : _b.length);
                    ...
                    mediaMessages = mediaUrls
                        .map(function (url) { return url === null || url === void 0 ? void 0 : url.trim(); })
                        .filter(function (url) { return Boolean(url); })
                        .map(function (url) { return deps.createImageMessage(url); });
                    if (!(chunks.length > 0)) return [3 /*break*/, 9];
                    hasRichOrMedia = richMessages.length > 0 || mediaMessages.length > 0;
                    if (!(hasQuickReplies && hasRichOrMedia)) return [3 /*break*/, 4];
                    _e.label = 1;
                case 1:
                    _e.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, sendLineMessages(__spreadArray(__spreadArray([], richMessages, true), mediaMessages, true), false)];
                case 2:
                    _e.sent();
                    return [3 /*break*/, 4];
                case 3:
                    ...
                    return [3 /*break*/, 4];
                case 4: return [4 /*yield*/, deps.sendLineReplyChunks({
                        to: to,
                        chunks: chunks,
                ...
                case 5:
                    ...
                    if (!(!hasQuickReplies || !hasRichOrMedia)) return [3 /*break*/, 8];
                    return [4 /*yield*/, sendLineMessages(richMessages, false)];
                case 6:
                    _e.sent();
                    if (!(mediaMessages.length > 0)) return [3 /*break*/, 8];
                ...
                case 9:
                    ...
                    if (hasQuickReplies && combined.length > 0) {
                        ...
                        targetIndex = replyToken && !replyTokenUsed ? Math.min(4, combined.length - 1) : combined.length - 1;
                ...
                case 10:
                    _e.sent();
                    _e.label = 11;
                case 11: return [2 /*return*/, { replyTokenUsed: replyTokenUsed }];
            }
        });
    });
}
