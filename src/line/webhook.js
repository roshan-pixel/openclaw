...
function readRawBody(req) {
    var _a;
    var rawBody = (_a = req.rawBody) !== null && _a !== void 0 ? _a : (typeof req.body === "string" || Buffer.isBuffer(req.body) ? req.body : null);
    if (!rawBody)
        return null;
...
function createLineWebhookMiddleware(options) {
    var _this = this;
    var channelSecret = options.channelSecret, onEvents = options.onEvents, runtime = options.runtime;
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    if (!(body.events && body.events.length > 0)) return [3 /*break*/, 2];
                    (0, globals_js_1.logVerbose)("line: received ".concat(body.events.length, " webhook events"));
                    return [4 /*yield*/, onEvents(body).catch(function (err) {
                            var _a;
                            (_a = runtime === null || runtime === void 0 ? void 0 : runtime.error) === null || _a === void 0 ? void 0 : _a.call(runtime, (0, globals_js_1.danger)("line webhook handler failed: ".concat(String(err))));
                        })];
                case 1:
                    _b.sent();
                    _b.label = 2;
                ...
                case 3:
                    err_1 = _b.sent();
                    (_a = runtime === null || runtime === void 0 ? void 0 : runtime.error) === null || _a === void 0 ? void 0 : _a.call(runtime, (0, globals_js_1.danger)("line webhook error: ".concat(String(err_1))));
                    if (!res.headersSent) {
