...
function createImageCard(imageUrl, title, body, options) {
    ...
    var bubble = {
        ...
        hero: {
            ...
            url: imageUrl,
            size: "full",
            aspectRatio: (_a = options === null || options === void 0 ? void 0 : options.aspectRatio) !== null && _a !== void 0 ? _a : "20:13",
            aspectMode: (_b = options === null || options === void 0 ? void 0 : options.aspectMode) !== null && _b !== void 0 ? _b : "cover",
...
function createNotificationBubble(text, options) {
    ...
    var typeColors = colors[(_a = options === null || options === void 0 ? void 0 : options.type) !== null && _a !== void 0 ? _a : "info"];
    var contents = [];
    // Accent bar
    contents.push({
        type: "box",
    ...
    textContents.push({
        ...
        color: (options === null || options === void 0 ? void 0 : options.title) ? "#666666" : "#333333",
        wrap: true,
...
function createReceiptCard(params) {
    var title = params.title, subtitle = params.subtitle, items = params.items, total = params.total, footer = params.footer;
...
function createEventCard(params) {
    var title = params.title, date = params.date, time = params.time, location = params.location, description = params.description, calendar = params.calendar, isAllDay = params.isAllDay, action = params.action;
...
function createAgendaCard(params) {
    var title = params.title, subtitle = params.subtitle, events = params.events, footer = params.footer;
...
function createMediaPlayerCard(params) {
    var title = params.title, subtitle = params.subtitle, source = params.source, imageUrl = params.imageUrl, isPlaying = params.isPlaying, progress = params.progress, controls = params.controls, extraActions = params.extraActions;
    // Track info section
    var trackInfo = [
        {
            type: "text",
    ...
    if (controls || (extraActions === null || extraActions === void 0 ? void 0 : extraActions.length)) {
        var footerContents = [];
...
function createAppleTvRemoteCard(params) {
    var deviceName = params.deviceName, status = params.status, actionData = params.actionData;
    var headerContents = [
        {
            type: "text",
            text: deviceName,
    ...
    var makeButton = function (label, data, style) {
        if (style === void 0) { style = "secondary"; }
        return ({
            type: "button",
            action: {
                type: "postback",
...
function createDeviceControlCard(params) {
    var _a;
    var deviceName = params.deviceName, deviceType = params.deviceType, status = params.status, isOnline = params.isOnline, imageUrl = params.imageUrl, controls = params.controls;
