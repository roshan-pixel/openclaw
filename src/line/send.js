...
function createImageMessage(originalContentUrl, previewImageUrl) {
    return {
        ...
        previewImageUrl: previewImageUrl !== null && previewImageUrl !== void 0 ? previewImageUrl : originalContentUrl,
    };
}
...
function logLineHttpError(err, context) {
    if (!err || typeof err !== "object")
        return;
    var _a = err, status = _a.status, statusText = _a.statusText, body = _a.body;
    if (typeof body === "string") {
        var summary = status ? "".concat(status, " ").concat(statusText !== null && statusText !== void 0 ? statusText : "").trim() : "unknown status";
        (0, globals_js_1.logVerbose)("line: ".concat(context, " failed (").concat(summary, "): ").concat(body));
    }
}
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    if (!opts.replyToken) return [3 /*break*/, 2];
                    return [4 /*yield*/, client.replyMessage({
                ...
                return [4 /*yield*/, client.pushMessage({
                        to: chatId,
                        messages: messages,
                    })];
                case 3:
...
function pushMessageLine(to_1, text_1) {
    return __awaiter(this, arguments, void 0, function (to, text, opts) {
        ...
        return __generator(this, function (_a) {
            ...
            return [2 /*return*/, sendMessageLine(to, text, __assign(__assign({}, opts), { replyToken: undefined }))];
        });
    });
}
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (opts.verbose) {
                        (0, globals_js_1.logVerbose)("line: replied with ".concat(messages.length, " messages"));
                    }
                    return [2 /*return*/];
            }
        });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (opts.verbose) {
                        (0, globals_js_1.logVerbose)("line: pushed ".concat(messages.length, " messages to ").concat(chatId));
                    }
                    return [2 /*return*/, {
                            messageId: "push",
                            chatId: chatId,
...
function pushImageMessage(to_1, originalContentUrl_1, previewImageUrl_1) {
    return __awaiter(this, arguments, void 0, function (to, originalContentUrl, previewImageUrl, opts) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (opts.verbose) {
                        (0, globals_js_1.logVerbose)("line: pushed message with quick replies to ".concat(chatId));
                    }
                    return [2 /*return*/, {
                            messageId: "push",
                            chatId: chatId,
...
function createQuickReplyItems(labels) {
    var items = labels.slice(0, 13).map(function (label) { return ({
        type: "action",
        action: {
            type: "message",
    ...
    return __awaiter(this, arguments, void 0, function (chatId, opts) {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, client.showLoadingAnimation({
                ...
                case 3:
                    ...
                    (0, globals_js_1.logVerbose)("line: loading animation failed (non-fatal): ".concat(String(err_1)));
                    return [3 /*break*/, 4];
    ...
    return __awaiter(this, arguments, void 0, function (userId, opts) {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    if (useCache) {
                        ...
                        if (cached && Date.now() - cached.fetchedAt < PROFILE_CACHE_TTL_MS) {
                            return [2 /*return*/, { displayName: cached.displayName, pictureUrl: cached.pictureUrl }];
                        }
                    }
                    cfg = (0, config_js_1.loadConfig)();
                    account = (0, accounts_js_1.resolveLineAccount)({
                ...
                case 3:
                    err_2 = _b.sent();
                    (0, globals_js_1.logVerbose)("line: failed to fetch profile for ".concat(userId, ": ").concat(String(err_2)));
...
function getUserDisplayName(userId_1) {
    return __awaiter(this, arguments, void 0, function (userId, opts) {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, getUserProfile(userId, opts)];
                case 1:
                    profile = _b.sent();
                    return [2 /*return*/, (_a = profile === null || profile === void 0 ? void 0 : profile.displayName) !== null && _a !== void 0 ? _a : userId];
            }
        });
    });
}
