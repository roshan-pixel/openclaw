...
function downloadLineMedia(messageId_1, channelAccessToken_1) {
    return __awaiter(this, arguments, void 0, function (messageId, channelAccessToken, maxBytes) {
        var client, response, chunks, totalSize, _a, _b, _c, chunk, e_1_1, buffer, contentType, ext, tempDir, fileName, filePath;
        var _d, e_1, _e, _f;
            ...
            switch (_g.label) {
                ...
                case 4:
                    ...
                    if (totalSize > maxBytes) {
                        throw new Error("Media exceeds ".concat(Math.round(maxBytes / (1024 * 1024)), "MB limit"));
                    }
                    chunks.push(chunk);
                    _g.label = 5;
                case 5:
                ...
                case 14:
                    _g.sent();
                    (0, globals_js_1.logVerbose)("line: downloaded media ".concat(messageId, " to ").concat(filePath, " (").concat(buffer.length, " bytes)"));
                    return [2 /*return*/, {
                            path: filePath,
