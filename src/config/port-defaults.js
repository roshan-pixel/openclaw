...
exports.DEFAULT_BROWSER_CDP_PORT_RANGE_END = exports.DEFAULT_BROWSER_CDP_PORT_RANGE_START = exports.DEFAULT_CANVAS_HOST_PORT = exports.DEFAULT_BROWSER_CONTROL_PORT = exports.DEFAULT_BRIDGE_PORT = void 0;
...
function deriveDefaultBrowserCdpPortRange(browserControlPort) {
    ...
    var end = clampPort(start + (exports.DEFAULT_BROWSER_CDP_PORT_RANGE_END - exports.DEFAULT_BROWSER_CDP_PORT_RANGE_START), exports.DEFAULT_BROWSER_CDP_PORT_RANGE_END);
    if (end < start)
