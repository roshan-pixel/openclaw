...
exports.LEGACY_CONFIG_MIGRATIONS_PART_3 = [
    {
        ...
        apply: function (raw, changes) {
            ...
            var profiles = (0, legacy_shared_js_1.getRecord)(auth === null || auth === void 0 ? void 0 : auth.profiles);
            if (!profiles)
                return;
    ...
    },
    {
        ...
        apply: function (raw, changes) {
            ...
            var tts = (0, legacy_shared_js_1.getRecord)(messages === null || messages === void 0 ? void 0 : messages.tts);
            if (!tts)
                return;
            ...
            delete tts.enabled;
            changes.push("Moved messages.tts.enabled \u2192 messages.tts.auto (".concat(String(tts.auto), ")."));
        },
    },
    {
        ...
        apply: function (raw, changes) {
            ...
            var defaults = (_a = (0, legacy_shared_js_1.getRecord)(agents.defaults)) !== null && _a !== void 0 ? _a : {};
            var tools = (0, legacy_shared_js_1.ensureRecord)(raw, "tools");
