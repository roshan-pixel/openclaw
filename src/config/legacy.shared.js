...
exports.ensureAgentEntry = exports.resolveDefaultAgentIdFromRaw = exports.getAgentsList = exports.mapLegacyAudioTranscription = exports.mergeMissing = exports.ensureRecord = exports.getRecord = exports.isRecord = void 0;
...
var mapLegacyAudioTranscription = function (value) {
    ...
    var command = Array.isArray(transcriber === null || transcriber === void 0 ? void 0 : transcriber.command) ? transcriber === null || transcriber === void 0 ? void 0 : transcriber.command : null;
    if (!command || command.length === 0)
        return null;
    var rawExecutable = String((_a = command[0]) !== null && _a !== void 0 ? _a : "").trim();
    if (!rawExecutable)
        return null;
    var executableName = (_b = rawExecutable.split(/[\\/]/).pop()) !== null && _b !== void 0 ? _b : rawExecutable;
    if (!AUDIO_TRANSCRIPTION_CLI_ALLOWLIST.has(executableName))
        return null;
    var args = command.slice(1).map(function (part) { return String(part); });
    var timeoutSeconds = typeof (transcriber === null || transcriber === void 0 ? void 0 : transcriber.timeoutSeconds) === "number" ? transcriber === null || transcriber === void 0 ? void 0 : transcriber.timeoutSeconds : undefined;
...
var resolveDefaultAgentIdFromRaw = function (raw) {
    ...
    var defaultEntry = list.find(function (entry) {
        return (0, exports.isRecord)(entry) &&
            entry.default === true &&
    ...
    var routingDefault = typeof (routing === null || routing === void 0 ? void 0 : routing.defaultAgentId) === "string" ? routing.defaultAgentId.trim() : "";
    if (routingDefault)
...
var ensureAgentEntry = function (list, id) {
    ...
    var existing = list.find(function (entry) {
        return (0, exports.isRecord)(entry) && typeof entry.id === "string" && entry.id.trim() === normalized;
    });
    if (existing)
        return existing;
