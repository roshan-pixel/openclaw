...
var getGroupSurfaces = function () { return new Set(__spreadArray(__spreadArray([], (0, message_channel_js_1.listDeliverableMessageChannels)(), true), ["webchat"], false)); };
...
function buildGroupDisplayName(params) {
    var _a, _b, _c, _d, _e;
    var providerKey = (((_a = params.provider) === null || _a === void 0 ? void 0 : _a.trim().toLowerCase()) || "group").trim();
    ...
    var detail = (groupChannel && space
        ? "".concat(space).concat(groupChannel.startsWith("#") ? "" : "#").concat(groupChannel)
...
function resolveGroupSessionKey(ctx) {
    ...
    var normalizedChatType = chatType === "channel" ? "channel" : chatType === "group" ? "group" : undefined;
    var isWhatsAppGroupId = from.toLowerCase().endsWith("@g.us");
    var looksLikeGroup = normalizedChatType === "group" ||
    ...
    if (!looksLikeGroup)
        return null;
    var providerHint = (_b = ctx.Provider) === null || _b === void 0 ? void 0 : _b.trim().toLowerCase();
    var parts = from.split(":").filter(Boolean);
    var head = (_d = (_c = parts[0]) === null || _c === void 0 ? void 0 : _c.trim().toLowerCase()) !== null && _d !== void 0 ? _d : "";
    var headIsSurface = head ? getGroupSurfaces().has(head) : false;
    var provider = headIsSurface
        ? head
        : (providerHint !== null && providerHint !== void 0 ? providerHint : (isWhatsAppGroupId ? "whatsapp" : undefined));
    if (!provider)
        return null;
