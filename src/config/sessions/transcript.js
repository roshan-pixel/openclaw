...
function resolveMirroredTranscriptText(params) {
    var _a, _b, _c;
    var mediaUrls = (_b = (_a = params.mediaUrls) === null || _a === void 0 ? void 0 : _a.filter(function (url) { return url && url.trim(); })) !== null && _b !== void 0 ? _b : [];
    if (mediaUrls.length > 0) {
        var names = mediaUrls
            .map(function (url) { return extractFileNameFromMediaUrl(url); })
            .filter(function (name) { return Boolean(name && name.trim()); });
        if (names.length > 0)
            return names.join(", ");
        return "media";
    }
            ...
            switch (_a.label) {
                case 0:
                    if (node_fs_1.default.existsSync(params.sessionFile))
                        return [2 /*return*/];
                    return [4 /*yield*/, node_fs_1.default.promises.mkdir(node_path_1.default.dirname(params.sessionFile), { recursive: true })];
                case 1:
                    _a.sent();
                    header = {
                        type: "session",
                    ...
                    return [4 /*yield*/, node_fs_1.default.promises.writeFile(params.sessionFile, "".concat(JSON.stringify(header), "\n"), "utf-8")];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    storePath = (_a = params.storePath) !== null && _a !== void 0 ? _a : (0, paths_js_1.resolveDefaultSessionStorePath)(params.agentId);
                    ...
                    sessionFile = ((_b = entry.sessionFile) === null || _b === void 0 ? void 0 : _b.trim()) || (0, paths_js_1.resolveSessionTranscriptPath)(entry.sessionId, params.agentId);
                    return [4 /*yield*/, ensureSessionHeader({ sessionFile: sessionFile, sessionId: entry.sessionId })];
                case 1:
                    _c.sent();
                    ...
                    if (!(!entry.sessionFile || entry.sessionFile !== sessionFile)) return [3 /*break*/, 3];
                    return [4 /*yield*/, (0, store_js_1.updateSessionStore)(storePath, function (current) {
