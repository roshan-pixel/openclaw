...
function isThreadSessionKey(sessionKey) {
    ...
    if (!normalized)
        return false;
    return THREAD_SESSION_MARKERS.some(function (marker) { return normalized.includes(marker); });
}
function resolveSessionResetType(params) {
    ...
    if (GROUP_SESSION_MARKERS.some(function (marker) { return normalized.includes(marker); }))
        return "group";
    return "dm";
}
...
function resolveSessionResetPolicy(params) {
    ...
    var baseReset = (_a = params.resetOverride) !== null && _a !== void 0 ? _a : sessionCfg === null || sessionCfg === void 0 ? void 0 : sessionCfg.reset;
    var typeReset = params.resetOverride ? undefined : (_b = sessionCfg === null || sessionCfg === void 0 ? void 0 : sessionCfg.resetByType) === null || _b === void 0 ? void 0 : _b[params.resetType];
    var hasExplicitReset = Boolean(baseReset || (sessionCfg === null || sessionCfg === void 0 ? void 0 : sessionCfg.resetByType));
    var legacyIdleMinutes = params.resetOverride ? undefined : sessionCfg === null || sessionCfg === void 0 ? void 0 : sessionCfg.idleMinutes;
    var mode = (_d = (_c = typeReset === null || typeReset === void 0 ? void 0 : typeReset.mode) !== null && _c !== void 0 ? _c : baseReset === null || baseReset === void 0 ? void 0 : baseReset.mode) !== null && _d !== void 0 ? _d : (!hasExplicitReset && legacyIdleMinutes != null ? "idle" : exports.DEFAULT_RESET_MODE);
    var atHour = normalizeResetAtHour((_f = (_e = typeReset === null || typeReset === void 0 ? void 0 : typeReset.atHour) !== null && _e !== void 0 ? _e : baseReset === null || baseReset === void 0 ? void 0 : baseReset.atHour) !== null && _f !== void 0 ? _f : exports.DEFAULT_RESET_AT_HOUR);
    var idleMinutesRaw = (_h = (_g = typeReset === null || typeReset === void 0 ? void 0 : typeReset.idleMinutes) !== null && _g !== void 0 ? _g : baseReset === null || baseReset === void 0 ? void 0 : baseReset.idleMinutes) !== null && _h !== void 0 ? _h : legacyIdleMinutes;
    var idleMinutes;
...
function resolveChannelResetConfig(params) {
    var _a, _b, _c;
    var resetByChannel = (_a = params.sessionCfg) === null || _a === void 0 ? void 0 : _a.resetByChannel;
    if (!resetByChannel)
        return undefined;
    ...
    if (!key)
        return undefined;
    return (_c = resetByChannel[key]) !== null && _c !== void 0 ? _c : resetByChannel[key.toLowerCase()];
}
function evaluateSessionFreshness(params) {
    var dailyResetAt = params.policy.mode === "daily"
        ? resolveDailyResetAtMs(params.now, params.policy.atHour)
        : undefined;
    var idleExpiresAt = params.policy.idleMinutes != null
