...
function normalizeSessionEntryDelivery(entry) {
    ...
    var sameDelivery = ((_b = (_a = entry.deliveryContext) === null || _a === void 0 ? void 0 : _a.channel) !== null && _b !== void 0 ? _b : undefined) === (nextDelivery === null || nextDelivery === void 0 ? void 0 : nextDelivery.channel) &&
        ((_d = (_c = entry.deliveryContext) === null || _c === void 0 ? void 0 : _c.to) !== null && _d !== void 0 ? _d : undefined) === (nextDelivery === null || nextDelivery === void 0 ? void 0 : nextDelivery.to) &&
        ((_f = (_e = entry.deliveryContext) === null || _e === void 0 ? void 0 : _e.accountId) !== null && _f !== void 0 ? _f : undefined) === (nextDelivery === null || nextDelivery === void 0 ? void 0 : nextDelivery.accountId) &&
        ((_h = (_g = entry.deliveryContext) === null || _g === void 0 ? void 0 : _g.threadId) !== null && _h !== void 0 ? _h : undefined) === (nextDelivery === null || nextDelivery === void 0 ? void 0 : nextDelivery.threadId);
    var sameLast = entry.lastChannel === normalized.lastChannel &&
        entry.lastTo === normalized.lastTo &&
        entry.lastAccountId === normalized.lastAccountId &&
        entry.lastThreadId === normalized.lastThreadId;
    if (sameDelivery && sameLast)
        return entry;
    return __assign(__assign({}, entry), { deliveryContext: nextDelivery, lastChannel: normalized.lastChannel, lastTo: normalized.lastTo, lastAccountId: normalized.lastAccountId, lastThreadId: normalized.lastThreadId });
}
...
function loadSessionStore(storePath, opts) {
    ...
    try {
        ...
        mtimeMs = (_a = (0, cache_utils_js_1.getFileMtimeMs)(storePath)) !== null && _a !== void 0 ? _a : mtimeMs;
    }
    catch (_b) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, node_fs_1.default.promises.mkdir(node_path_1.default.dirname(storePath), { recursive: true })];
                case 1:
                    _a.sent();
                ...
                case 6:
                    tmp = "".concat(storePath, ".").concat(process.pid, ".").concat(node_crypto_1.default.randomUUID(), ".tmp");
                    _a.label = 7;
                case 7:
                    _a.trys.push([7, 11, 19, 21]);
                    return [4 /*yield*/, node_fs_1.default.promises.writeFile(tmp, json, { mode: 384, encoding: "utf-8" })];
                case 8:
                    _a.sent();
                ...
                case 11:
                    ...
                    code = err_2 && typeof err_2 === "object" && "code" in err_2
                        ? String(err_2.code)
                        : null;
                    if (!(code === "ENOENT")) return [3 /*break*/, 18];
                    _a.label = 12;
                case 12:
                ...
                case 13:
                    _a.sent();
                    return [4 /*yield*/, node_fs_1.default.promises.writeFile(storePath, json, { mode: 384, encoding: "utf-8" })];
                case 14:
                    _a.sent();
                    return [4 /*yield*/, node_fs_1.default.promises.chmod(storePath, 384)];
                case 15:
                ...
                case 16:
                    err2_1 = _a.sent();
                    code2 = err2_1 && typeof err2_1 === "object" && "code" in err2_1
                        ? String(err2_1.code)
                        : null;
                    if (code2 === "ENOENT")
                        return [2 /*return*/];
                ...
                case 18: throw err_2;
                case 19: return [4 /*yield*/, node_fs_1.default.promises.rm(tmp, { force: true })];
                case 20:
                    _a.sent();
                    return [7 /*endfinally*/];
...
function saveSessionStore(storePath, store) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withSessionStoreLock(storePath, function () { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, saveSessionStoreUnlocked(storePath, store)];
                                case 1:
                                    _a.sent();
                                    return [2 /*return*/];
                            }
...
function withSessionStoreLock(storePath_1, fn_1) {
    return __awaiter(this, arguments, void 0, function (storePath, fn, opts) {
        var timeoutMs, pollIntervalMs, staleMs, lockPath, startedAt, handle, _a, err_3, code, now, st, ageMs, _b;
        var _c, _d, _e;
        if (opts === void 0) { opts = {}; }
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 5:
                    _f.trys.push([5, 7, , 8]);
                    return [4 /*yield*/, handle.writeFile(JSON.stringify({ pid: process.pid, startedAt: Date.now() }), "utf-8")];
                case 6:
                    _f.sent();
                    return [3 /*break*/, 8];
                case 7:
                ...
                case 10:
                    err_3 = _f.sent();
                    code = err_3 && typeof err_3 === "object" && "code" in err_3
                        ? String(err_3.code)
                        : null;
                    if (!(code === "ENOENT")) return [3 /*break*/, 13];
                ...
                case 11:
                    ...
                    // Best-effort: recreate the parent dir and retry until timeout.
                    _f.sent();
                    return [4 /*yield*/, new Promise(function (r) { return setTimeout(r, pollIntervalMs); })];
                case 12:
                    _f.sent();
                    return [3 /*break*/, 2];
                case 13:
                ...
                case 15:
                    ...
                    if (!(ageMs > staleMs)) return [3 /*break*/, 17];
                ...
                case 18:
                    _b = _f.sent();
                    return [3 /*break*/, 19];
                case 19: return [4 /*yield*/, new Promise(function (r) { return setTimeout(r, pollIntervalMs); })];
                case 20:
                    _f.sent();
                    return [3 /*break*/, 21];
                ...
                case 24: return [4 /*yield*/, node_fs_1.default.promises.unlink(lockPath).catch(function () { return undefined; })];
                case 25:
                    _f.sent();
                    return [7 /*endfinally*/];
...
function updateSessionStoreEntry(params) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    storePath = params.storePath, sessionKey = params.sessionKey, update = params.update;
                    return [4 /*yield*/, withSessionStoreLock(storePath, function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, updateSessionStore(storePath, function (store) {
...
function updateLastRoute(params) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    storePath = params.storePath, sessionKey = params.sessionKey, channel = params.channel, to = params.to, accountId = params.accountId, threadId = params.threadId, ctx = params.ctx;
                    return [4 /*yield*/, withSessionStoreLock(storePath, function () { return __awaiter(_this, void 0, void 0, function () {
                            var store, existing, now, explicitContext, inlineContext, mergedInput, merged, normalized, metaPatch, basePatch, next;
                            var _a;
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        ...
                                        existing = store[sessionKey];
                                        now = Date.now();
                                        explicitContext = (0, delivery_context_js_1.normalizeDeliveryContext)(params.deliveryContext);
                                        ...
                                        mergedInput = (0, delivery_context_js_1.mergeDeliveryContext)(explicitContext, inlineContext);
                                        merged = (0, delivery_context_js_1.mergeDeliveryContext)(mergedInput, (0, delivery_context_js_1.deliveryContextFromSession)(existing));
                                        normalized = (0, delivery_context_js_1.normalizeSessionDeliveryFields)({
                                            deliveryContext: {
                                                ...
                                                accountId: merged === null || merged === void 0 ? void 0 : merged.accountId,
                                        ...
                                        metaPatch = ctx
                                            ...
                                            : null;
                                        basePatch = {
                                            updatedAt: Math.max((_a = existing === null || existing === void 0 ? void 0 : existing.updatedAt) !== null && _a !== void 0 ? _a : 0, now),
                                        ...
                                        next = (0, types_js_1.mergeSessionEntry)(existing, metaPatch ? __assign(__assign({}, basePatch), metaPatch) : basePatch);
                                        store[sessionKey] = next;
                                        return [4 /*yield*/, saveSessionStoreUnlocked(storePath, store)];
                                    case 1:
                                        _b.sent();
