...
function deriveSessionOrigin(ctx) {
    ...
    var label = (_a = (0, conversation_label_js_1.resolveConversationLabel)(ctx)) === null || _a === void 0 ? void 0 : _a.trim();
    var providerRaw = (typeof ctx.OriginatingChannel === "string" && ctx.OriginatingChannel) ||
        ctx.Surface ||
        ctx.Provider;
    ...
    var chatType = (_c = (0, chat_type_js_1.normalizeChatType)(ctx.ChatType)) !== null && _c !== void 0 ? _c : undefined;
    var from = (_d = ctx.From) === null || _d === void 0 ? void 0 : _d.trim();
    var to = (_f = (_e = (typeof ctx.OriginatingTo === "string" ? ctx.OriginatingTo : ctx.To)) === null || _e === void 0 ? void 0 : _e.trim()) !== null && _f !== void 0 ? _f : undefined;
...
function deriveGroupSessionPatch(params) {
    ...
    var resolution = (_a = params.groupResolution) !== null && _a !== void 0 ? _a : (0, group_js_1.resolveGroupSessionKey)(params.ctx);
    ...
    var explicitChannel = (_d = params.ctx.GroupChannel) === null || _d === void 0 ? void 0 : _d.trim();
    var normalizedChannel = (0, index_js_1.normalizeChannelId)(channel);
    var isChannelProvider = Boolean(normalizedChannel &&
        ((_e = (0, dock_js_1.getChannelDock)(normalizedChannel)) === null || _e === void 0 ? void 0 : _e.capabilities.chatTypes.includes("channel")));
    var nextGroupChannel = explicitChannel !== null && explicitChannel !== void 0 ? explicitChannel : ((resolution.chatType === "channel" || isChannelProvider) && subject && subject.startsWith("#")
        ? subject
        : undefined);
    ...
    var displayName = (0, group_js_1.buildGroupDisplayName)({
        provider: channel,
        subject: nextSubject !== null && nextSubject !== void 0 ? nextSubject : (_g = params.existing) === null || _g === void 0 ? void 0 : _g.subject,
        groupChannel: nextGroupChannel !== null && nextGroupChannel !== void 0 ? nextGroupChannel : (_h = params.existing) === null || _h === void 0 ? void 0 : _h.groupChannel,
        space: space !== null && space !== void 0 ? space : (_j = params.existing) === null || _j === void 0 ? void 0 : _j.space,
        id: resolution.id,
...
function deriveSessionMetaPatch(params) {
    ...
    var mergedOrigin = mergeOrigin((_a = params.existing) === null || _a === void 0 ? void 0 : _a.origin, origin);
    if (mergedOrigin)
