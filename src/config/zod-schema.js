...
exports.OpenClawSchema = zod_1.z
    ...
    wizard: zod_1.z
        ...
        lastRunMode: zod_1.z.union([zod_1.z.literal("local"), zod_1.z.literal("remote")]).optional(),
    })
        .strict()
        .optional(),
    diagnostics: zod_1.z
        ...
        otel: zod_1.z
            ...
            protocol: zod_1.z.union([zod_1.z.literal("http/protobuf"), zod_1.z.literal("grpc")]).optional(),
    ...
    logging: zod_1.z
        ...
        consoleStyle: zod_1.z
            ...
            .optional(),
        redactSensitive: zod_1.z.union([zod_1.z.literal("off"), zod_1.z.literal("tools")]).optional(),
    ...
    update: zod_1.z
        .object({
        channel: zod_1.z.union([zod_1.z.literal("stable"), zod_1.z.literal("beta"), zod_1.z.literal("dev")]).optional(),
    ...
    browser: zod_1.z
        ...
        profiles: zod_1.z
            .record(zod_1.z
            .string()
            .regex(/^[a-z0-9-]+$/, "Profile names must be alphanumeric with hyphens only"), zod_1.z
            .object({
            cdpPort: zod_1.z.number().int().min(1).max(65535).optional(),
            cdpUrl: zod_1.z.string().optional(),
            driver: zod_1.z.union([zod_1.z.literal("openclaw"), zod_1.z.literal("extension")]).optional(),
            color: zod_schema_core_js_1.HexColorSchema,
        })
            .strict()
            .refine(function (value) { return value.cdpPort || value.cdpUrl; }, {
    ...
    auth: zod_1.z
        ...
        profiles: zod_1.z
            ...
            mode: zod_1.z.union([zod_1.z.literal("api_key"), zod_1.z.literal("oauth"), zod_1.z.literal("token")]),
        ...
        cooldowns: zod_1.z
            ...
            billingBackoffHoursByProvider: zod_1.z.record(zod_1.z.string(), zod_1.z.number().positive()).optional(),
    ...
    gateway: zod_1.z
        ...
        remote: zod_1.z
            ...
            transport: zod_1.z.union([zod_1.z.literal("ssh"), zod_1.z.literal("direct")]).optional(),
            token: zod_1.z.string().optional(),
            password: zod_1.z.string().optional(),
        ...
        nodes: zod_1.z
            ...
            browser: zod_1.z
                .object({
                mode: zod_1.z
                    .union([zod_1.z.literal("auto"), zod_1.z.literal("manual"), zod_1.z.literal("off")])
                    .optional(),
    ...
    skills: zod_1.z
        ...
        install: zod_1.z
            ...
            nodeManager: zod_1.z
                .union([zod_1.z.literal("npm"), zod_1.z.literal("pnpm"), zod_1.z.literal("yarn"), zod_1.z.literal("bun")])
                .optional(),
        })
            .strict()
            .optional(),
    ...
    if (agents.length === 0)
        return;
    var agentIds = new Set(agents.map(function (agent) { return agent.id; }));
    var broadcast = cfg.broadcast;
    if (!broadcast)
        return;
    for (var _i = 0, _c = Object.entries(broadcast); _i < _c.length; _i++) {
        var _d = _c[_i], peerId = _d[0], ids = _d[1];
        if (peerId === "strategy")
            continue;
