...
exports.AgentDefaultsSchema = zod_1.z
    ...
    timeFormat: zod_1.z.union([zod_1.z.literal("auto"), zod_1.z.literal("12"), zod_1.z.literal("24")]).optional(),
    ...
    thinkingDefault: zod_1.z
        ...
        .optional(),
    verboseDefault: zod_1.z.union([zod_1.z.literal("off"), zod_1.z.literal("on"), zod_1.z.literal("full")]).optional(),
    elevatedDefault: zod_1.z
        .union([zod_1.z.literal("off"), zod_1.z.literal("on"), zod_1.z.literal("ask"), zod_1.z.literal("full")])
        .optional(),
    blockStreamingDefault: zod_1.z.union([zod_1.z.literal("off"), zod_1.z.literal("on")]).optional(),
    blockStreamingBreak: zod_1.z.union([zod_1.z.literal("text_end"), zod_1.z.literal("message_end")]).optional(),
