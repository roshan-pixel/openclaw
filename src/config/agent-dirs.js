...
function collectReferencedAgentIds(cfg) {
    ...
    var ids = new Set();
    var agents = Array.isArray((_a = cfg.agents) === null || _a === void 0 ? void 0 : _a.list) ? (_b = cfg.agents) === null || _b === void 0 ? void 0 : _b.list : [];
    var defaultAgentId = (_f = (_d = (_c = agents.find(function (agent) { return agent === null || agent === void 0 ? void 0 : agent.default; })) === null || _c === void 0 ? void 0 : _c.id) !== null && _d !== void 0 ? _d : (_e = agents[0]) === null || _e === void 0 ? void 0 : _e.id) !== null && _f !== void 0 ? _f : session_key_js_1.DEFAULT_AGENT_ID;
...
function resolveEffectiveAgentDir(cfg, agentId, deps) {
    ...
    var configured = Array.isArray((_a = cfg.agents) === null || _a === void 0 ? void 0 : _a.list)
        ? (_c = (_b = cfg.agents) === null || _b === void 0 ? void 0 : _b.list.find(function (agent) { return (0, session_key_js_1.normalizeAgentId)(agent.id) === id; })) === null || _c === void 0 ? void 0 : _c.agentDir
        : undefined;
    var trimmed = configured === null || configured === void 0 ? void 0 : configured.trim();
    if (trimmed)
        return (0, utils_js_1.resolveUserPath)(trimmed);
    var root = (0, paths_js_1.resolveStateDir)((_d = deps === null || deps === void 0 ? void 0 : deps.env) !== null && _d !== void 0 ? _d : process.env, (_e = deps === null || deps === void 0 ? void 0 : deps.homedir) !== null && _e !== void 0 ? _e : node_os_1.default.homedir);
...
function findDuplicateAgentDirs(cfg, deps) {
    ...
    return __spreadArray([], byDir.values(), true).filter(function (v) { return v.agentIds.length > 1; });
}
function formatDuplicateAgentDirError(dups) {
    var lines = __spreadArray(__spreadArray([
        ...
        "",
        "Conflicts:"
    ], dups.map(function (d) { return "- ".concat(d.agentDir, ": ").concat(d.agentIds.map(function (id) { return "\"".concat(id, "\""); }).join(", ")); }), true), [
        "",
