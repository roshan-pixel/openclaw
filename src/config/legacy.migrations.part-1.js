...
exports.LEGACY_CONFIG_MIGRATIONS_PART_1 = [
        ...
        apply: function (raw, changes) {
            ...
            for (var _i = 0, bindings_2 = bindings; _i < bindings_2.length; _i++) {
                ...
                if (match.accountId !== undefined)
                    continue;
                var accountID = typeof match.accountID === "string" ? match.accountID.trim() : match.accountID;
                if (!accountID)
                    continue;
    ...
    },
    {
        ...
        apply: function (raw, changes) {
            ...
            var legacyEntries = legacyKeys.filter(function (key) { return (0, legacy_shared_js_1.isRecord)(raw[key]); });
            ...
            for (var _i = 0, legacyEntries_1 = legacyEntries; _i < legacyEntries_1.length; _i++) {
                ...
                delete raw[key];
                changes.push(hadEntries ? "Merged ".concat(key, " \u2192 channels.").concat(key, ".") : "Moved ".concat(key, " \u2192 channels.").concat(key, "."));
            }
    ...
    },
    {
        ...
        apply: function (raw, changes) {
            ...
            if (!routing || typeof routing !== "object")
                return;
            var groupChat = routing.groupChat &&
            ...
            var applyTo = function (key, options) {
                if ((options === null || options === void 0 ? void 0 : options.requireExisting) && !(0, legacy_shared_js_1.isRecord)(channels[key]))
                    return;
                var section = channels[key] && typeof channels[key] === "object"
                    ? channels[key]
                    : {};
                var groups = section.groups && typeof section.groups === "object"
                    ? section.groups
                    : {};
                var defaultKey = "*";
                var entry = groups[defaultKey] && typeof groups[defaultKey] === "object"
                    ? groups[defaultKey]
                    : {};
                if (entry.requireMention === undefined) {
                    ...
                    changes.push("Moved routing.groupChat.requireMention \u2192 channels.".concat(key, ".groups.\"*\".requireMention."));
                }
                else {
                    changes.push("Removed routing.groupChat.requireMention (channels.".concat(key, ".groups.\"*\" already set)."));
                }
            };
    ...
    },
    {
        ...
        apply: function (raw, changes) {
            ...
            var auth = gatewayObj.auth && typeof gatewayObj.auth === "object"
                ? gatewayObj.auth
                : {};
