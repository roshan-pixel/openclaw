...
function resolveNativeSkillsEnabled(params) {
    var providerId = params.providerId, providerSetting = params.providerSetting, globalSetting = params.globalSetting;
...
function isNativeCommandsExplicitlyDisabled(params) {
    var providerSetting = params.providerSetting, globalSetting = params.globalSetting;
