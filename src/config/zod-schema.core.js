...
exports.ProviderCommandsSchema = exports.NativeCommandsSettingSchema = exports.ToolsLinksSchema = exports.LinkModelSchema = exports.ToolsMediaSchema = exports.ToolsMediaUnderstandingSchema = exports.MediaUnderstandingModelSchema = exports.MediaUnderstandingAttachmentsSchema = exports.MediaUnderstandingCapabilitiesSchema = exports.MediaUnderstandingScopeSchema = exports.ExecutableTokenSchema = exports.HexColorSchema = exports.TranscribeAudioSchema = exports.InboundDebounceSchema = exports.QueueSchema = exports.DebounceMsBySurfaceSchema = exports.QueueModeBySurfaceSchema = exports.RetryConfigSchema = exports.MSTeamsReplyStyleSchema = exports.requireOpenAllowFrom = exports.normalizeAllowFrom = exports.CliBackendSchema = exports.HumanDelaySchema = exports.TtsConfigSchema = exports.TtsAutoSchema = exports.TtsModeSchema = exports.TtsProviderSchema = exports.MarkdownConfigSchema = exports.MarkdownTableModeSchema = exports.BlockStreamingChunkSchema = exports.BlockStreamingCoalesceSchema = exports.DmPolicySchema = exports.GroupPolicySchema = exports.ReplyToModeSchema = exports.QueueDropSchema = exports.QueueModeSchema = exports.IdentitySchema = exports.DmConfigSchema = exports.GroupChatSchema = exports.ModelsConfigSchema = exports.BedrockDiscoverySchema = exports.ModelProviderSchema = exports.ModelDefinitionSchema = exports.ModelCompatSchema = exports.ModelApiSchema = void 0;
...
exports.ModelDefinitionSchema = zod_1.z
    ...
    input: zod_1.z.array(zod_1.z.union([zod_1.z.literal("text"), zod_1.z.literal("image")])).optional(),
    cost: zod_1.z
        .object({
...
exports.ModelProviderSchema = zod_1.z
    ...
    auth: zod_1.z
        .union([zod_1.z.literal("api-key"), zod_1.z.literal("aws-sdk"), zod_1.z.literal("oauth"), zod_1.z.literal("token")])
        .optional(),
    api: exports.ModelApiSchema.optional(),
    headers: zod_1.z.record(zod_1.z.string(), zod_1.z.string()).optional(),
...
exports.ReplyToModeSchema = zod_1.z.union([zod_1.z.literal("off"), zod_1.z.literal("first"), zod_1.z.literal("all")]);
...
exports.BlockStreamingChunkSchema = zod_1.z
    ...
    breakPreference: zod_1.z
        .union([zod_1.z.literal("paragraph"), zod_1.z.literal("newline"), zod_1.z.literal("sentence")])
        .optional(),
})
    .strict();
...
exports.HumanDelaySchema = zod_1.z
    .object({
    mode: zod_1.z.union([zod_1.z.literal("off"), zod_1.z.literal("natural"), zod_1.z.literal("custom")]).optional(),
...
exports.CliBackendSchema = zod_1.z
    ...
    output: zod_1.z.union([zod_1.z.literal("json"), zod_1.z.literal("text"), zod_1.z.literal("jsonl")]).optional(),
    resumeOutput: zod_1.z.union([zod_1.z.literal("json"), zod_1.z.literal("text"), zod_1.z.literal("jsonl")]).optional(),
    ...
    systemPromptMode: zod_1.z.union([zod_1.z.literal("append"), zod_1.z.literal("replace")]).optional(),
...
exports.TranscribeAudioSchema = zod_1.z
    ...
    .strict()
    .optional();
exports.HexColorSchema = zod_1.z.string().regex(/^#?[0-9a-fA-F]{6}$/, "expected hex color (RRGGBB)");
...
exports.MediaUnderstandingScopeSchema = zod_1.z
    ...
    rules: zod_1.z
        ...
        match: zod_1.z
            ...
            chatType: zod_1.z
                .union([zod_1.z.literal("direct"), zod_1.z.literal("group"), zod_1.z.literal("channel")])
                .optional(),
...
exports.MediaUnderstandingCapabilitiesSchema = zod_1.z
    .array(zod_1.z.union([zod_1.z.literal("image"), zod_1.z.literal("audio"), zod_1.z.literal("video")]))
    .optional();
exports.MediaUnderstandingAttachmentsSchema = zod_1.z
    ...
    prefer: zod_1.z
        .union([zod_1.z.literal("first"), zod_1.z.literal("last"), zod_1.z.literal("path"), zod_1.z.literal("url")])
        .optional(),
})
    .strict()
    .optional();
var DeepgramAudioSchema = zod_1.z
    ...
    .strict()
    .optional();
var ProviderOptionValueSchema = zod_1.z.union([zod_1.z.string(), zod_1.z.number(), zod_1.z.boolean()]);
