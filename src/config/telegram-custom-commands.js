...
function resolveTelegramCustomCommands(params) {
    ...
    for (var index = 0; index < entries.length; index += 1) {
        ...
        var normalized = normalizeTelegramCommandName(String((_b = entry === null || entry === void 0 ? void 0 : entry.command) !== null && _b !== void 0 ? _b : ""));
        if (!normalized) {
            issues.push({
                index: index,
                field: "command",
        ...
        if (!exports.TELEGRAM_COMMAND_NAME_PATTERN.test(normalized)) {
            issues.push({
                index: index,
                field: "command",
                message: "Telegram custom command \"/".concat(normalized, "\" is invalid (use a-z, 0-9, underscore; max 32 chars)."),
            });
            continue;
        }
        if (checkReserved && reserved.has(normalized)) {
            issues.push({
                index: index,
                field: "command",
                message: "Telegram custom command \"/".concat(normalized, "\" conflicts with a native command."),
            });
            continue;
        }
        ...
        var description = normalizeTelegramCommandDescription(String((_c = entry === null || entry === void 0 ? void 0 : entry.description) !== null && _c !== void 0 ? _c : ""));
        if (!description) {
            issues.push({
                index: index,
                field: "description",
