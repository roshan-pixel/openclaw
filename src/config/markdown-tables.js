...
function resolveMarkdownModeFromSection(section, accountId) {
    ...
    if (accounts && typeof accounts === "object") {
        ...
        var directMode = (_a = direct === null || direct === void 0 ? void 0 : direct.markdown) === null || _a === void 0 ? void 0 : _a.tables;
        ...
        var matchMode = (_b = match === null || match === void 0 ? void 0 : match.markdown) === null || _b === void 0 ? void 0 : _b.tables;
...
function resolveMarkdownTableMode(params) {
    ...
    var defaultMode = channel ? ((_a = DEFAULT_TABLE_MODES.get(channel)) !== null && _a !== void 0 ? _a : "code") : "code";
    if (!channel || !params.cfg)
        return defaultMode;
    var channelsConfig = params.cfg.channels;
    var section = ((_b = channelsConfig === null || channelsConfig === void 0 ? void 0 : channelsConfig[channel]) !== null && _b !== void 0 ? _b : (_c = params.cfg) === null || _c === void 0 ? void 0 : _c[channel]);
    return (_d = resolveMarkdownModeFromSection(section, params.accountId)) !== null && _d !== void 0 ? _d : defaultMode;
}
