...
function findLegacyConfigIssues(raw) {
    ...
    var root = raw;
    var issues = [];
    for (var _i = 0, LEGACY_CONFIG_RULES_1 = legacy_rules_js_1.LEGACY_CONFIG_RULES; _i < LEGACY_CONFIG_RULES_1.length; _i++) {
...
function applyLegacyMigrations(raw) {
    ...
    var changes = [];
    for (var _i = 0, LEGACY_CONFIG_MIGRATIONS_1 = legacy_migrations_js_1.LEGACY_CONFIG_MIGRATIONS; _i < LEGACY_CONFIG_MIGRATIONS_1.length; _i++) {
