...
function normalizeCapabilities(capabilities) {
    ...
    if (!isStringArray(capabilities))
        return undefined;
    var normalized = capabilities.map(function (entry) { return entry.trim(); }).filter(Boolean);
...
function resolveAccountCapabilities(params) {
    ...
    if (accounts && typeof accounts === "object") {
        ...
        if (direct) {
            return (_a = normalizeCapabilities(direct.capabilities)) !== null && _a !== void 0 ? _a : normalizeCapabilities(cfg.capabilities);
        }
        ...
        if (match) {
            return (_b = normalizeCapabilities(match.capabilities)) !== null && _b !== void 0 ? _b : normalizeCapabilities(cfg.capabilities);
        }
    }
...
function resolveChannelCapabilities(params) {
    ...
    var channelConfig = ((_a = channelsConfig === null || channelsConfig === void 0 ? void 0 : channelsConfig[channel]) !== null && _a !== void 0 ? _a : cfg[channel]);
