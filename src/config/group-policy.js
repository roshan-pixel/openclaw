...
function resolveToolsBySender(params) {
    ...
    for (var _i = 0, entries_1 = entries; _i < entries_1.length; _i++) {
        var _a = entries_1[_i], rawKey = _a[0], policy = _a[1];
        if (!policy)
            continue;
...
function resolveChannelGroups(cfg, channel, accountId) {
    ...
    if (!channelConfig)
        return undefined;
    var accountGroups = (_d = (_c = (_b = channelConfig.accounts) === null || _b === void 0 ? void 0 : _b[normalizedAccountId]) === null || _c === void 0 ? void 0 : _c.groups) !== null && _d !== void 0 ? _d : (_h = (_e = channelConfig.accounts) === null || _e === void 0 ? void 0 : _e[(_g = Object.keys((_f = channelConfig.accounts) !== null && _f !== void 0 ? _f : {}).find(function (key) { return key.toLowerCase() === normalizedAccountId.toLowerCase(); })) !== null && _g !== void 0 ? _g : ""]) === null || _h === void 0 ? void 0 : _h.groups;
...
function resolveChannelGroupPolicy(params) {
    var _a;
    var cfg = params.cfg, channel = params.channel;
...
function resolveChannelGroupRequireMention(params) {
    var requireMentionOverride = params.requireMentionOverride, _a = params.overrideOrder, overrideOrder = _a === void 0 ? "after-config" : _a;
    var _b = resolveChannelGroupPolicy(params), groupConfig = _b.groupConfig, defaultConfig = _b.defaultConfig;
    var configMention = typeof (groupConfig === null || groupConfig === void 0 ? void 0 : groupConfig.requireMention) === "boolean"
        ? groupConfig.requireMention
        : typeof (defaultConfig === null || defaultConfig === void 0 ? void 0 : defaultConfig.requireMention) === "boolean"
...
function resolveChannelGroupToolsPolicy(params) {
    var _a = resolveChannelGroupPolicy(params), groupConfig = _a.groupConfig, defaultConfig = _a.defaultConfig;
    var groupSenderPolicy = resolveToolsBySender({
        toolsBySender: groupConfig === null || groupConfig === void 0 ? void 0 : groupConfig.toolsBySender,
    ...
    var defaultSenderPolicy = resolveToolsBySender({
        toolsBySender: defaultConfig === null || defaultConfig === void 0 ? void 0 : defaultConfig.toolsBySender,
        senderId: params.senderId,
        senderName: params.senderName,
        senderUsername: params.senderUsername,
        senderE164: params.senderE164,
