...
exports.MSTeamsConfigSchema = exports.MSTeamsTeamSchema = exports.MSTeamsChannelSchema = exports.BlueBubblesConfigSchema = exports.BlueBubblesAccountSchema = exports.BlueBubblesAccountSchemaBase = exports.IMessageConfigSchema = exports.IMessageAccountSchema = exports.IMessageAccountSchemaBase = exports.SignalConfigSchema = exports.SignalAccountSchema = exports.SignalAccountSchemaBase = exports.SlackConfigSchema = exports.SlackAccountSchema = exports.SlackThreadSchema = exports.SlackChannelSchema = exports.SlackDmSchema = exports.GoogleChatConfigSchema = exports.GoogleChatAccountSchema = exports.GoogleChatGroupSchema = exports.GoogleChatDmSchema = exports.DiscordConfigSchema = exports.DiscordAccountSchema = exports.DiscordGuildSchema = exports.DiscordGuildChannelSchema = exports.DiscordDmSchema = exports.TelegramConfigSchema = exports.TelegramAccountSchema = exports.TelegramAccountSchemaBase = exports.TelegramGroupSchema = exports.TelegramTopicSchema = void 0;
...
var ToolPolicyBySenderSchema = zod_1.z.record(zod_1.z.string(), zod_schema_agent_runtime_js_1.ToolPolicySchema).optional();
...
var TelegramCustomCommandSchema = zod_1.z
    ...
    description: zod_1.z.string().transform(telegram_custom_commands_js_1.normalizeTelegramCommandDescription),
})
    .strict();
...
exports.TelegramAccountSchemaBase = zod_1.z
    ...
    dms: zod_1.z.record(zod_1.z.string(), zod_schema_core_js_1.DmConfigSchema.optional()).optional(),
    ...
    .strict();
exports.TelegramAccountSchema = exports.TelegramAccountSchemaBase.superRefine(function (value, ctx) {
...
exports.DiscordGuildSchema = zod_1.z
    ...
    users: zod_1.z.array(zod_1.z.union([zod_1.z.string(), zod_1.z.number()])).optional(),
    channels: zod_1.z.record(zod_1.z.string(), exports.DiscordGuildChannelSchema.optional()).optional(),
})
    .strict();
...
exports.GoogleChatAccountSchema = zod_1.z
    ...
    serviceAccount: zod_1.z.union([zod_1.z.string(), zod_1.z.record(zod_1.z.string(), zod_1.z.unknown())]).optional(),
...
exports.SlackAccountSchema = zod_1.z
    ...
    mediaMaxMb: zod_1.z.number().positive().optional(),
    reactionNotifications: zod_1.z.enum(["off", "own", "all", "allowlist"]).optional(),
    reactionAllowlist: zod_1.z.array(zod_1.z.union([zod_1.z.string(), zod_1.z.number()])).optional(),
    replyToMode: zod_schema_core_js_1.ReplyToModeSchema.optional(),
...
exports.SlackConfigSchema = exports.SlackAccountSchema.extend({
    ...
    for (var _i = 0, _d = Object.entries(value.accounts); _i < _d.length; _i++) {
        var _e = _d[_i], accountId = _e[0], account = _e[1];
        if (!account)
            continue;
        ...
        if (accountMode !== "http")
            continue;
        var accountSecret = (_c = account.signingSecret) !== null && _c !== void 0 ? _c : value.signingSecret;
        if (!accountSecret) {
            ctx.addIssue({
                code: zod_1.z.ZodIssueCode.custom,
...
exports.IMessageAccountSchemaBase = zod_1.z
    ...
    service: zod_1.z.union([zod_1.z.literal("imessage"), zod_1.z.literal("sms"), zod_1.z.literal("auto")]).optional(),
    ...
    .strict();
exports.IMessageAccountSchema = exports.IMessageAccountSchemaBase.superRefine(function (value, ctx) {
    (0, zod_schema_core_js_1.requireOpenAllowFrom)({
        policy: value.dmPolicy,
        allowFrom: value.allowFrom,
        ctx: ctx,
...
exports.BlueBubblesAccountSchemaBase = zod_1.z
    ...
    .strict();
exports.BlueBubblesAccountSchema = exports.BlueBubblesAccountSchemaBase.superRefine(function (value, ctx) {
    (0, zod_schema_core_js_1.requireOpenAllowFrom)({
        policy: value.dmPolicy,
        allowFrom: value.allowFrom,
        ctx: ctx,
...
exports.BlueBubblesConfigSchema = exports.BlueBubblesAccountSchemaBase.extend({
    accounts: zod_1.z.record(zod_1.z.string(), exports.BlueBubblesAccountSchema.optional()).optional(),
