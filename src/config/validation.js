...
function validateIdentityAvatar(config) {
    ...
    for (var _i = 0, _d = agents.entries(); _i < _d.length; _i++) {
        var _e = _d[_i], index = _e[0], entry = _e[1];
        ...
        var workspaceDir = (0, agent_scope_js_1.resolveAgentWorkspaceDir)(config, (_c = entry.id) !== null && _c !== void 0 ? _c : (0, agent_scope_js_1.resolveDefaultAgentId)(config));
...
function validateConfigObject(raw) {
    ...
    if (legacyIssues.length > 0) {
        return {
            ok: false,
            issues: legacyIssues.map(function (iss) { return ({
                path: iss.path,
                message: iss.message,
            }); }),
        };
    ...
    if (!validated.success) {
        return {
            ok: false,
            issues: validated.error.issues.map(function (iss) { return ({
                path: iss.path.join("."),
                message: iss.message,
            }); }),
        };
    ...
    return {
        ok: true,
        config: (0, defaults_js_1.applyModelDefaults)((0, defaults_js_1.applyAgentDefaults)((0, defaults_js_1.applySessionDefaults)(validated.data))),
    };
}
...
function validateConfigObjectWithPlugins(raw) {
    ...
    var knownIds = new Set(registry.plugins.map(function (record) { return record.id; }));
    ...
    var allow = (_a = pluginsConfig === null || pluginsConfig === void 0 ? void 0 : pluginsConfig.allow) !== null && _a !== void 0 ? _a : [];
    ...
    var deny = (_b = pluginsConfig === null || pluginsConfig === void 0 ? void 0 : pluginsConfig.deny) !== null && _b !== void 0 ? _b : [];
    ...
    validateHeartbeatTarget((_e = (_d = (_c = config.agents) === null || _c === void 0 ? void 0 : _c.defaults) === null || _d === void 0 ? void 0 : _d.heartbeat) === null || _e === void 0 ? void 0 : _e.target, "agents.defaults.heartbeat.target");
    if (Array.isArray((_f = config.agents) === null || _f === void 0 ? void 0 : _f.list)) {
        for (var _2 = 0, _3 = config.agents.list.entries(); _2 < _3.length; _2++) {
            var _4 = _3[_2], index = _4[0], entry = _4[1];
            validateHeartbeatTarget((_g = entry === null || entry === void 0 ? void 0 : entry.heartbeat) === null || _g === void 0 ? void 0 : _g.target, "agents.list.".concat(index, ".heartbeat.target"));
        }
    }
    ...
    for (var _5 = 0, _6 = registry.plugins; _5 < _6.length; _5++) {
        ...
        var enableState = (0, config_state_js_1.resolveEnableState)(pluginId, record.origin, normalizedPlugins);
        ...
        if (shouldValidate) {
            if (record.configSchema) {
                var res = (0, schema_validator_js_1.validateJsonSchemaValue)({
                    ...
                    cacheKey: (_j = (_h = record.schemaCacheKey) !== null && _h !== void 0 ? _h : record.manifestPath) !== null && _j !== void 0 ? _j : pluginId,
                    value: (_k = entry === null || entry === void 0 ? void 0 : entry.config) !== null && _k !== void 0 ? _k : {},
                });
                if (!res.ok) {
        ...
        if (!enabled && entryHasConfig) {
            warnings.push({
                path: "plugins.entries.".concat(pluginId),
                message: "plugin disabled (".concat(reason !== null && reason !== void 0 ? reason : "disabled", ") but config is present"),
            });
        }
    }
    if (issues.length > 0) {
