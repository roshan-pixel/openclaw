...
exports.ToolsSchema = exports.AgentEntrySchema = exports.AgentModelSchema = exports.MemorySearchSchema = exports.AgentToolsSchema = exports.AgentSandboxSchema = exports.ElevatedAllowFromSchema = exports.ToolPolicyWithProfileSchema = exports.ToolProfileSchema = exports.ToolsWebSchema = exports.ToolsWebFetchSchema = exports.ToolsWebSearchSchema = exports.ToolPolicySchema = exports.SandboxPruneSchema = exports.SandboxBrowserSchema = exports.SandboxDockerSchema = exports.HeartbeatSchema = void 0;
...
exports.ToolProfileSchema = zod_1.z
    .union([zod_1.z.literal("minimal"), zod_1.z.literal("coding"), zod_1.z.literal("messaging"), zod_1.z.literal("full")])
    .optional();
...
exports.AgentSandboxSchema = zod_1.z
    .object({
    mode: zod_1.z.union([zod_1.z.literal("off"), zod_1.z.literal("non-main"), zod_1.z.literal("all")]).optional(),
    workspaceAccess: zod_1.z.union([zod_1.z.literal("none"), zod_1.z.literal("ro"), zod_1.z.literal("rw")]).optional(),
    sessionToolsVisibility: zod_1.z.union([zod_1.z.literal("spawned"), zod_1.z.literal("all")]).optional(),
    scope: zod_1.z.union([zod_1.z.literal("session"), zod_1.z.literal("agent"), zod_1.z.literal("shared")]).optional(),
...
exports.MemorySearchSchema = zod_1.z
    .object({
    enabled: zod_1.z.boolean().optional(),
    sources: zod_1.z.array(zod_1.z.union([zod_1.z.literal("memory"), zod_1.z.literal("sessions")])).optional(),
    ...
    experimental: zod_1.z
        ...
        .strict()
        .optional(),
    provider: zod_1.z.union([zod_1.z.literal("openai"), zod_1.z.literal("local"), zod_1.z.literal("gemini")]).optional(),
    remote: zod_1.z
        .object({
        baseUrl: zod_1.z.string().optional(),
        apiKey: zod_1.z.string().optional(),
        ...
        .optional(),
    fallback: zod_1.z
        .union([zod_1.z.literal("openai"), zod_1.z.literal("gemini"), zod_1.z.literal("local"), zod_1.z.literal("none")])
        .optional(),
    model: zod_1.z.string().optional(),
    local: zod_1.z
        .object({
