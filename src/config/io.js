...
Object.defineProperty(exports, "CircularIncludeError", { enumerable: true, get: function () { return includes_js_2.CircularIncludeError; } });
Object.defineProperty(exports, "ConfigIncludeError", { enumerable: true, get: function () { return includes_js_2.ConfigIncludeError; } });
var env_substitution_js_2 = require("./env-substitution.js");
Object.defineProperty(exports, "MissingEnvVarError", { enumerable: true, get: function () { return env_substitution_js_2.MissingEnvVarError; } });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, ioFs.unlink("".concat(backupBase, ".").concat(maxIndex)).catch(function () {
                            // best-effort
                        })];
                case 1:
                    _a.sent();
                ...
                case 2:
                    ...
                    return [4 /*yield*/, ioFs.rename("".concat(backupBase, ".").concat(index), "".concat(backupBase, ".").concat(index + 1)).catch(function () {
                            // best-effort
                        })];
                case 3:
                    _a.sent();
                ...
                case 4:
                    index -= 1;
                    return [3 /*break*/, 2];
                case 5: return [4 /*yield*/, ioFs.rename(backupBase, "".concat(backupBase, ".1")).catch(function () {
                        // best-effort
                    })];
                case 6:
                    _a.sent();
...
function stampConfigVersion(cfg) {
    ...
    return __assign(__assign({}, cfg), { meta: __assign(__assign({}, cfg.meta), { lastTouchedVersion: version_js_1.VERSION, lastTouchedAt: now }) });
}
function warnIfConfigFromFuture(cfg, logger) {
    ...
    if (cmp === null)
        return;
    if (cmp < 0) {
        logger.warn("Config was last written by a newer OpenClaw (".concat(touched, "); current version is ").concat(version_js_1.VERSION, "."));
    }
}
...
function resolveConfigPathForDeps(deps) {
    ...
    return (0, paths_js_1.resolveConfigPath)(deps.env, (0, paths_js_1.resolveStateDir)(deps.env, deps.homedir));
}
...
function parseConfigJson5(raw, json5) {
    if (json5 === void 0) { json5 = json5_1.default; }
    try {
...
function createConfigIO(overrides) {
    ...
    var configPath = (_a = candidatePaths.find(function (candidate) { return deps.fs.existsSync(candidate); })) !== null && _a !== void 0 ? _a : requestedConfigPath;
    function loadConfig() {
        var _a, _b, _c, _d, _e;
        try {
            if (!deps.fs.existsSync(configPath)) {
                if ((0, shell_env_js_1.shouldEnableShellEnvFallback)(deps.env) && !(0, shell_env_js_1.shouldDeferShellEnvFallback)(deps.env)) {
            ...
            var resolved = (0, includes_js_1.resolveConfigIncludes)(parsed, configPath, {
                readFile: function (p) { return deps.fs.readFileSync(p, "utf-8"); },
                parseJson: function (raw) { return deps.json5.parse(raw); },
            });
            ...
            if (!validated.ok) {
                var details = validated.issues
                    .map(function (iss) { return "- ".concat(iss.path || "<root>", ": ").concat(iss.message); })
                    .join("\n");
            ...
            var cfg = (0, defaults_js_1.applyModelDefaults)((0, defaults_js_1.applyCompactionDefaults)((0, defaults_js_1.applyContextPruningDefaults)((0, defaults_js_1.applyAgentDefaults)((0, defaults_js_1.applySessionDefaults)((0, defaults_js_1.applyLoggingDefaults)((0, defaults_js_1.applyMessageDefaults)(validated.config)))))));
            ...
            var enabled = (0, shell_env_js_1.shouldEnableShellEnvFallback)(deps.env) || ((_b = (_a = cfg.env) === null || _a === void 0 ? void 0 : _a.shellEnv) === null || _b === void 0 ? void 0 : _b.enabled) === true;
            if (enabled && !(0, shell_env_js_1.shouldDeferShellEnvFallback)(deps.env)) {
                (0, shell_env_js_1.loadShellEnvFallback)({
                    ...
                    expectedKeys: SHELL_ENV_EXPECTED_KEYS,
                    logger: deps.logger,
                    timeoutMs: (_e = (_d = (_c = cfg.env) === null || _c === void 0 ? void 0 : _c.shellEnv) === null || _d === void 0 ? void 0 : _d.timeoutMs) !== null && _e !== void 0 ? _e : (0, shell_env_js_1.resolveShellEnvFallbackTimeoutMs)(deps.env),
                });
            }
    ...
    function readConfigFileSnapshot() {
        return __awaiter(this, void 0, void 0, function () {
            var exists, hash, config, legacyIssues, raw, hash, parsedRes, resolved, message, substituted, message, resolvedConfigRaw, legacyIssues, validated;
            return __generator(this, function (_a) {
                exists = deps.fs.existsSync(configPath);
                if (!exists) {
                    hash = hashConfigRaw(null);
                    config = (0, defaults_js_1.applyTalkApiKey)((0, defaults_js_1.applyModelDefaults)((0, defaults_js_1.applyCompactionDefaults)((0, defaults_js_1.applyContextPruningDefaults)((0, defaults_js_1.applyAgentDefaults)((0, defaults_js_1.applySessionDefaults)((0, defaults_js_1.applyMessageDefaults)({})))))));
                    legacyIssues = [];
                    return [2 /*return*/, {
                            path: configPath,
                            exists: false,
                ...
                try {
                    ...
                    try {
                        ...
                        message = err instanceof includes_js_1.ConfigIncludeError
                            ? err.message
                    ...
                    try {
                        ...
                        message = err instanceof env_substitution_js_1.MissingEnvVarError
                            ? err.message
                    ...
                    return [2 /*return*/, {
                            ...
                            parsed: parsedRes.parsed,
                            valid: true,
                            config: (0, normalize_paths_js_1.normalizeConfigPaths)((0, defaults_js_1.applyTalkApiKey)((0, defaults_js_1.applyModelDefaults)((0, defaults_js_1.applyAgentDefaults)((0, defaults_js_1.applySessionDefaults)((0, defaults_js_1.applyLoggingDefaults)((0, defaults_js_1.applyMessageDefaults)(validated.config))))))),
                            hash: hash,
                            issues: [],
                            warnings: validated.warnings,
                            legacyIssues: legacyIssues,
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        if (!validated.ok) {
                            ...
                            pathLabel = (issue === null || issue === void 0 ? void 0 : issue.path) ? issue.path : "<root>";
                            throw new Error("Config validation failed: ".concat(pathLabel, ": ").concat((_a = issue === null || issue === void 0 ? void 0 : issue.message) !== null && _a !== void 0 ? _a : "invalid"));
                        }
                        if (validated.warnings.length > 0) {
                            details = validated.warnings
                                .map(function (warning) { return "- ".concat(warning.path, ": ").concat(warning.message); })
                                .join("\n");
                            deps.logger.warn("Config warnings:\n".concat(details));
                        }
                    ...
                    case 1:
                        _b.sent();
                        json = JSON.stringify((0, defaults_js_1.applyModelDefaults)(stampConfigVersion(cfg)), null, 2)
                            .trimEnd()
                            .concat("\n");
                        tmp = node_path_1.default.join(dir, "".concat(node_path_1.default.basename(configPath), ".").concat(process.pid, ".").concat(node_crypto_1.default.randomUUID(), ".tmp"));
                        return [4 /*yield*/, deps.fs.promises.writeFile(tmp, json, {
                                encoding: "utf-8",
                                mode: 384,
                            })];
                    case 2:
                        _b.sent();
                        if (!deps.fs.existsSync(configPath)) return [3 /*break*/, 5];
                        return [4 /*yield*/, rotateConfigBackups(configPath, deps.fs.promises)];
                    case 3:
                        _b.sent();
                        return [4 /*yield*/, deps.fs.promises.copyFile(configPath, "".concat(configPath, ".bak")).catch(function () {
                                // best-effort
                            })];
                    case 4:
                        _b.sent();
                    ...
                    case 7:
                        err_1 = _b.sent();
                        code = err_1.code;
                        if (!(code === "EPERM" || code === "EEXIST")) return [3 /*break*/, 11];
                        return [4 /*yield*/, deps.fs.promises.copyFile(tmp, configPath)];
                    case 8:
                        _b.sent();
                        return [4 /*yield*/, deps.fs.promises.chmod(configPath, 384).catch(function () {
                                // best-effort
                            })];
                    case 9:
                        _b.sent();
                        return [4 /*yield*/, deps.fs.promises.unlink(tmp).catch(function () {
                                // best-effort
                            })];
                    case 10:
                        _b.sent();
                        return [2 /*return*/];
                    case 11: return [4 /*yield*/, deps.fs.promises.unlink(tmp).catch(function () {
                            // best-effort
                        })];
                    case 12:
                        _b.sent();
...
function readConfigFileSnapshot() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, createConfigIO().readConfigFileSnapshot()];
