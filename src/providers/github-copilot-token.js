...
function resolveCopilotTokenCachePath(env) {
    ...
    return node_path_1.default.join((0, paths_js_1.resolveStateDir)(env), "credentials", "github-copilot.token.json");
}
...
function deriveCopilotApiBaseUrlFromToken(token) {
    ...
    var proxyEp = (_a = match === null || match === void 0 ? void 0 : match[1]) === null || _a === void 0 ? void 0 : _a.trim();
    if (!proxyEp)
        return null;
            ...
            switch (_f.label) {
                    ...
                    if (cached && typeof cached.token === "string" && typeof cached.expiresAt === "number") {
                        if (isTokenUsable(cached)) {
                            return [2 /*return*/, {
                                    ...
                                    baseUrl: (_c = deriveCopilotApiBaseUrlFromToken(cached.token)) !== null && _c !== void 0 ? _c : exports.DEFAULT_COPILOT_API_BASE_URL,
                                }];
                        }
                    }
                    fetchImpl = (_d = params.fetchImpl) !== null && _d !== void 0 ? _d : fetch;
                    return [4 /*yield*/, fetchImpl(COPILOT_TOKEN_URL, {
                            method: "GET",
                            headers: {
                ...
                case 2:
                    ...
                    return [2 /*return*/, {
                            ...
                            baseUrl: (_e = deriveCopilotApiBaseUrlFromToken(payload.token)) !== null && _e !== void 0 ? _e : exports.DEFAULT_COPILOT_API_BASE_URL,
                        }];
            }
        });
    });
