...
exports.LEGACY_GATEWAY_WINDOWS_TASK_NAMES = exports.LEGACY_GATEWAY_SYSTEMD_SERVICE_NAMES = exports.LEGACY_GATEWAY_LAUNCH_AGENT_LABELS = exports.NODE_WINDOWS_TASK_SCRIPT_NAME = exports.NODE_SERVICE_KIND = exports.NODE_SERVICE_MARKER = exports.NODE_WINDOWS_TASK_NAME = exports.NODE_SYSTEMD_SERVICE_NAME = exports.NODE_LAUNCH_AGENT_LABEL = exports.GATEWAY_SERVICE_KIND = exports.GATEWAY_SERVICE_MARKER = exports.GATEWAY_WINDOWS_TASK_NAME = exports.GATEWAY_SYSTEMD_SERVICE_NAME = exports.GATEWAY_LAUNCH_AGENT_LABEL = void 0;
...
function formatGatewayServiceDescription(params) {
    var _a;
    var profile = normalizeGatewayProfile(params === null || params === void 0 ? void 0 : params.profile);
    var version = (_a = params === null || params === void 0 ? void 0 : params.version) === null || _a === void 0 ? void 0 : _a.trim();
    var parts = [];
    if (profile)
