        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                            ...
                            switch (_c.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, (0, extension_relay_js_1.ensureChromeExtensionRelayServer)({ cdpUrl: profile.cdpUrl }).catch(function (err) {
                                            logService.warn("Chrome extension relay init failed for profile \"".concat(name_1, "\": ").concat(String(err)));
                                        })];
                                case 1:
                                    _c.sent();
                                    return [2 /*return*/];
                ...
                case 3:
                    ...
                    return [3 /*break*/, 1];
                case 4:
                    logService.info("Browser control service ready (profiles=".concat(Object.keys(resolved.profiles).length, ")"));
                    return [2 /*return*/, state];
            }
        });
    });
