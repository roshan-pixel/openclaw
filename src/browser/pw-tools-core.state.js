        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    page = _c.sent();
                    (0, pw_session_js_1.ensurePageState)(page);
                    if (!opts.clear) return [3 /*break*/, 3];
                ...
                case 3:
                    ...
                    return [4 /*yield*/, page.context().setHTTPCredentials({ username: username, password: password })];
                case 4:
                    _c.sent();
                    return [2 /*return*/];
            }
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (!opts.clear) return [3 /*break*/, 4];
                ...
                case 4:
                    ...
                    return [4 /*yield*/, context.setGeolocation({
                ...
                case 5:
                    _b.sent();
                    origin = ((_a = opts.origin) === null || _a === void 0 ? void 0 : _a.trim()) ||
                        (function () {
                            try {
                    ...
                    if (!origin) return [3 /*break*/, 7];
                    return [4 /*yield*/, context.grantPermissions(["geolocation"], { origin: origin }).catch(function () { })];
                case 6:
                    _b.sent();
                    _b.label = 7;
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, withCdpSession(page, function (session) { return __awaiter(_this, void 0, void 0, function () {
                            var err_1;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        _a.trys.push([0, 2, , 3]);
                                        return [4 /*yield*/, session.send("Emulation.setLocaleOverride", { locale: locale })];
                                    case 1:
                                        _a.sent();
                                        return [3 /*break*/, 3];
                                    case 2:
                    ...
                    return [4 /*yield*/, withCdpSession(page, function (session) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        _a.trys.push([0, 2, , 3]);
                                        return [4 /*yield*/, session.send("Emulation.setTimezoneOverride", { timezoneId: timezoneId })];
                                    case 1:
                                        _a.sent();
                                        return [3 /*break*/, 3];
                                    case 2:
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (!descriptor.viewport) return [3 /*break*/, 3];
                ...
                case 2:
                    _b.sent();
                    _b.label = 3;
                case 3: return [4 /*yield*/, withCdpSession(page, function (session) { return __awaiter(_this, void 0, void 0, function () {
                        var _a, _b, _c;
                        return __generator(this, function (_d) {
                            switch (_d.label) {
                                case 0:
                                    if (!(descriptor.userAgent || descriptor.locale)) return [3 /*break*/, 2];
                                    return [4 /*yield*/, session.send("Emulation.setUserAgentOverride", {
                                            userAgent: (_a = descriptor.userAgent) !== null && _a !== void 0 ? _a : "",
                                            acceptLanguage: (_b = descriptor.locale) !== null && _b !== void 0 ? _b : undefined,
                                        })];
                                case 1:
                                    _d.sent();
                                    _d.label = 2;
                                case 2:
                                    if (!descriptor.viewport) return [3 /*break*/, 4];
                                    return [4 /*yield*/, session.send("Emulation.setDeviceMetricsOverride", {
                                            mobile: Boolean(descriptor.isMobile),
                                            width: descriptor.viewport.width,
                                            height: descriptor.viewport.height,
                                            deviceScaleFactor: (_c = descriptor.deviceScaleFactor) !== null && _c !== void 0 ? _c : 1,
                                ...
                                case 3:
                                    ...
                                    _d.label = 4;
                                case 4:
                                    if (!descriptor.hasTouch) return [3 /*break*/, 6];
                                    return [4 /*yield*/, session.send("Emulation.setTouchEmulationEnabled", {
                                            enabled: true,
                                        })];
                                case 5:
                                    _d.sent();
