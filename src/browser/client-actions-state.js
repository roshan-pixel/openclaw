        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, client_fetch_js_1.fetchBrowserJson)(withBaseUrl(baseUrl, "/cookies".concat(suffix)), { timeoutMs: 20000 })];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, client_fetch_js_1.fetchBrowserJson)(withBaseUrl(baseUrl, "/cookies/set".concat(q)), {
                            method: "POST",
    ...
    return __awaiter(this, arguments, void 0, function (baseUrl, opts) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    q = buildProfileQuery(opts.profile);
                    return [4 /*yield*/, (0, client_fetch_js_1.fetchBrowserJson)(withBaseUrl(baseUrl, "/cookies/clear".concat(q)), {
                            method: "POST",
                            headers: { "Content-Type": "application/json" },
            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (opts.profile)
                        q.set("profile", opts.profile);
                    suffix = q.toString() ? "?".concat(q.toString()) : "";
                    return [4 /*yield*/, (0, client_fetch_js_1.fetchBrowserJson)(withBaseUrl(baseUrl, "/storage/".concat(opts.kind).concat(suffix)), { timeoutMs: 20000 })];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    });
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    q = buildProfileQuery(opts.profile);
                    return [4 /*yield*/, (0, client_fetch_js_1.fetchBrowserJson)(withBaseUrl(baseUrl, "/storage/".concat(opts.kind, "/set").concat(q)), {
                            method: "POST",
                            headers: { "Content-Type": "application/json" },
                            body: JSON.stringify({
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    q = buildProfileQuery(opts.profile);
                    return [4 /*yield*/, (0, client_fetch_js_1.fetchBrowserJson)(withBaseUrl(baseUrl, "/storage/".concat(opts.kind, "/clear").concat(q)), {
                            method: "POST",
                            headers: { "Content-Type": "application/json" },
                            body: JSON.stringify({ targetId: opts.targetId }),
                            timeoutMs: 20000,
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    q = buildProfileQuery(opts.profile);
                    return [4 /*yield*/, (0, client_fetch_js_1.fetchBrowserJson)(withBaseUrl(baseUrl, "/set/offline".concat(q)), {
                            method: "POST",
                            headers: { "Content-Type": "application/json" },
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    q = buildProfileQuery(opts.profile);
                    return [4 /*yield*/, (0, client_fetch_js_1.fetchBrowserJson)(withBaseUrl(baseUrl, "/set/headers".concat(q)), {
                            method: "POST",
                            headers: { "Content-Type": "application/json" },
    ...
    return __awaiter(this, arguments, void 0, function (baseUrl, opts) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    q = buildProfileQuery(opts.profile);
                    return [4 /*yield*/, (0, client_fetch_js_1.fetchBrowserJson)(withBaseUrl(baseUrl, "/set/credentials".concat(q)), {
                            method: "POST",
                            headers: { "Content-Type": "application/json" },
                            body: JSON.stringify({
                                targetId: opts.targetId,
    ...
    return __awaiter(this, arguments, void 0, function (baseUrl, opts) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    q = buildProfileQuery(opts.profile);
                    return [4 /*yield*/, (0, client_fetch_js_1.fetchBrowserJson)(withBaseUrl(baseUrl, "/set/geolocation".concat(q)), {
                            method: "POST",
                            headers: { "Content-Type": "application/json" },
                            body: JSON.stringify({
                                targetId: opts.targetId,
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    q = buildProfileQuery(opts.profile);
                    return [4 /*yield*/, (0, client_fetch_js_1.fetchBrowserJson)(withBaseUrl(baseUrl, "/set/media".concat(q)), {
                            method: "POST",
                            headers: { "Content-Type": "application/json" },
                            body: JSON.stringify({
                                targetId: opts.targetId,
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    q = buildProfileQuery(opts.profile);
                    return [4 /*yield*/, (0, client_fetch_js_1.fetchBrowserJson)(withBaseUrl(baseUrl, "/set/timezone".concat(q)), {
                            method: "POST",
                            headers: { "Content-Type": "application/json" },
                            body: JSON.stringify({
                                targetId: opts.targetId,
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    q = buildProfileQuery(opts.profile);
                    return [4 /*yield*/, (0, client_fetch_js_1.fetchBrowserJson)(withBaseUrl(baseUrl, "/set/locale".concat(q)), {
                            method: "POST",
                            headers: { "Content-Type": "application/json" },
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    q = buildProfileQuery(opts.profile);
                    return [4 /*yield*/, (0, client_fetch_js_1.fetchBrowserJson)(withBaseUrl(baseUrl, "/set/device".concat(q)), {
                            method: "POST",
                            headers: { "Content-Type": "application/json" },
