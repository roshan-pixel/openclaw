...
function responseBodyViaPlaywright(opts) {
    return __awaiter(this, void 0, void 0, function () {
        var pattern, maxChars, timeout, page, promise, resp, url, status, headers, bodyText, buf, err_1, trimmed;
        var _a, _b, _c, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    ...
                    maxChars = typeof opts.maxChars === "number" && Number.isFinite(opts.maxChars)
                ...
                case 1:
                    ...
                    promise = new Promise(function (resolve, reject) {
                        ...
                        timer = setTimeout(function () {
                            ...
                            cleanup();
                            reject(new Error("Response not found for url pattern \"".concat(pattern, "\". Run '").concat((0, command_format_js_1.formatCliCommand)("openclaw browser requests"), "' to inspect recent network activity.")));
                        }, timeout);
                    });
                ...
                case 3:
                    _e.trys.push([3, 8, , 9]);
                    if (!(typeof resp.text === "function")) return [3 /*break*/, 5];
                    return [4 /*yield*/, resp.text()];
                case 4:
                    bodyText = _e.sent();
                    return [3 /*break*/, 7];
                case 5:
                    if (!(typeof resp.body === "function")) return [3 /*break*/, 7];
                ...
                case 8:
                    err_1 = _e.sent();
                    throw new Error("Failed to read response body for \"".concat(url, "\": ").concat(String(err_1)));
                case 9:
