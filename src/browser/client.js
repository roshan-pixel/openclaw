        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, client_fetch_js_1.fetchBrowserJson)(withBaseUrl(baseUrl, "/".concat(q)), {
                            timeoutMs: 1500,
                        })];
...
function browserProfiles(baseUrl) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, (0, client_fetch_js_1.fetchBrowserJson)(withBaseUrl(baseUrl, "/profiles"), {
                        timeoutMs: 3000,
                    })];
                case 1:
                    res = _b.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    q = buildProfileQuery(opts === null || opts === void 0 ? void 0 : opts.profile);
                    return [4 /*yield*/, (0, client_fetch_js_1.fetchBrowserJson)(withBaseUrl(baseUrl, "/start".concat(q)), {
                            method: "POST",
                            timeoutMs: 15000,
                        })];
                case 1:
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    q = buildProfileQuery(opts === null || opts === void 0 ? void 0 : opts.profile);
                    return [4 /*yield*/, (0, client_fetch_js_1.fetchBrowserJson)(withBaseUrl(baseUrl, "/stop".concat(q)), {
                            method: "POST",
                            timeoutMs: 15000,
                        })];
                case 1:
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    q = buildProfileQuery(opts === null || opts === void 0 ? void 0 : opts.profile);
                    return [4 /*yield*/, (0, client_fetch_js_1.fetchBrowserJson)(withBaseUrl(baseUrl, "/reset-profile".concat(q)), {
                            method: "POST",
                            timeoutMs: 20000,
                        })];
                case 1: return [2 /*return*/, _a.sent()];
...
function browserCreateProfile(baseUrl, opts) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, client_fetch_js_1.fetchBrowserJson)(withBaseUrl(baseUrl, "/profiles/create"), {
                        method: "POST",
...
function browserDeleteProfile(baseUrl, profile) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, client_fetch_js_1.fetchBrowserJson)(withBaseUrl(baseUrl, "/profiles/".concat(encodeURIComponent(profile))), {
                        method: "DELETE",
                        timeoutMs: 20000,
                    })];
                case 1: return [2 /*return*/, _a.sent()];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    q = buildProfileQuery(opts === null || opts === void 0 ? void 0 : opts.profile);
                    return [4 /*yield*/, (0, client_fetch_js_1.fetchBrowserJson)(withBaseUrl(baseUrl, "/tabs".concat(q)), { timeoutMs: 3000 })];
                case 1:
                    res = _b.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    q = buildProfileQuery(opts === null || opts === void 0 ? void 0 : opts.profile);
                    return [4 /*yield*/, (0, client_fetch_js_1.fetchBrowserJson)(withBaseUrl(baseUrl, "/tabs/open".concat(q)), {
                            method: "POST",
                            headers: { "Content-Type": "application/json" },
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    q = buildProfileQuery(opts === null || opts === void 0 ? void 0 : opts.profile);
                    return [4 /*yield*/, (0, client_fetch_js_1.fetchBrowserJson)(withBaseUrl(baseUrl, "/tabs/focus".concat(q)), {
                            method: "POST",
                            headers: { "Content-Type": "application/json" },
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    q = buildProfileQuery(opts === null || opts === void 0 ? void 0 : opts.profile);
                    return [4 /*yield*/, (0, client_fetch_js_1.fetchBrowserJson)(withBaseUrl(baseUrl, "/tabs/".concat(encodeURIComponent(targetId)).concat(q)), {
                            method: "DELETE",
                            timeoutMs: 5000,
                        })];
                case 1:
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, client_fetch_js_1.fetchBrowserJson)(withBaseUrl(baseUrl, "/tabs/action".concat(q)), {
                            method: "POST",
                            headers: { "Content-Type": "application/json" },
                            body: JSON.stringify({
                                action: opts.action,
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, client_fetch_js_1.fetchBrowserJson)(withBaseUrl(baseUrl, "/snapshot?".concat(q.toString())), {
                            timeoutMs: 20000,
                        })];
