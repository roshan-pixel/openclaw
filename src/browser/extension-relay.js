...
function parseBaseUrl(raw) {
    ...
    var port = ((_a = parsed.port) === null || _a === void 0 ? void 0 : _a.trim()) !== "" ? Number(parsed.port) : parsed.protocol === "https:" ? 443 : 80;
...
function text(res, status, bodyText) {
    ...
    res.write("HTTP/1.1 ".concat(status, " ").concat(status === 200 ? "OK" : "ERR", "\r\n") +
...
function ensureChromeExtensionRelayServer(opts) {
    return __awaiter(this, void 0, void 0, function () {
        var info, existing, extensionWs, cdpClients, connectedTargets, pendingExtension, nextExtensionId, sendToExtension, broadcastToCdpClients, sendResponseToCdp, ensureTargetEventsForClient, routeCdpCommand, server, wssExtension, wssCdp, addr, port, host, baseUrl, relay;
        var _this = this;
        var _a;
            ...
            switch (_b.label) {
                case 0:
                    ...
                    if (!isLoopbackHost(info.host)) {
                        throw new Error("extension relay requires loopback cdpUrl host (got ".concat(info.host, ")"));
                    }
                    ...
                    nextExtensionId = 1;
                    sendToExtension = function (payload) { return __awaiter(_this, void 0, void 0, function () {
                        var ws;
                                ...
                                case 0:
                                    ...
                                    return [4 /*yield*/, new Promise(function (resolve, reject) {
                                            var timer = setTimeout(function () {
                                                ...
                                                reject(new Error("extension request timeout: ".concat(payload.params.method)));
                                            }, 30000);
                                            pendingExtension.set(payload.id, { resolve: resolve, reject: reject, timer: timer });
                                        })];
                        ...
                        for (var _i = 0, _a = connectedTargets.values(); _i < _a.length; _i++) {
                            ...
                            if (mode === "autoAttach") {
                                ...
                                ws.send(JSON.stringify({
                                    ...
                                    params: { targetInfo: __assign(__assign({}, target.targetInfo), { attached: true }) },
                                }));
                            }
                        }
                    };
                    routeCdpCommand = function (cmd) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_g) {
                            switch (_g.label) {
                                case 0:
                                    _a = cmd.method;
                                    switch (_a) {
                                        case "Browser.getVersion": return [3 /*break*/, 1];
                                        case "Browser.setDownloadBehavior": return [3 /*break*/, 2];
                                        case "Target.setAutoAttach": return [3 /*break*/, 3];
                                        case "Target.setDiscoverTargets": return [3 /*break*/, 3];
                                        case "Target.getTargets": return [3 /*break*/, 4];
                                        case "Target.getTargetInfo": return [3 /*break*/, 5];
                                        case "Target.attachToTarget": return [3 /*break*/, 6];
                                    }
                                    return [3 /*break*/, 7];
                                ...
                                case 4: return [2 /*return*/, {
                                        targetInfos: Array.from(connectedTargets.values()).map(function (t) { return (__assign(__assign({}, t.targetInfo), { attached: true })); }),
                                    }];
                                case 5:
                                    {
                                        ...
                                        return [2 /*return*/, { targetInfo: first === null || first === void 0 ? void 0 : first.targetInfo }];
                                    }
                                    _g.label = 6;
                                case 6:
                                    {
                                ...
                                case 7:
                                    id = nextExtensionId++;
                                    return [4 /*yield*/, sendToExtension({
                                            id: id,
                    ...
                    server = (0, node_http_1.createServer)(function (req, res) {
                        ...
                        var hostHeader = ((_b = req.headers.host) === null || _b === void 0 ? void 0 : _b.trim()) || "".concat(info.host, ":").concat(info.port);
                        ...
                        if (listPaths.has(path) && (req.method === "GET" || req.method === "PUT")) {
                            var list = Array.from(connectedTargets.values()).map(function (t) {
                                ...
                                return ({
                                    ...
                                    devtoolsFrontendUrl: "/devtools/inspector.html?ws=".concat(cdpWsUrl.replace("ws://", "")),
                                });
                            });
                            res.writeHead(200, { "Content-Type": "application/json" });
                        ...
                        if (activateMatch && (req.method === "GET" || req.method === "PUT")) {
                            var targetId_1 = decodeURIComponent((_c = activateMatch[1]) !== null && _c !== void 0 ? _c : "").trim();
                            if (!targetId_1) {
                                res.writeHead(400);
                                    ...
                                    switch (_b.label) {
                                        case 0:
                                            ...
                                            return [4 /*yield*/, sendToExtension({
                                                    id: nextExtensionId++,
                                                    method: "forwardCDPCommand",
                                                    params: { method: "Target.activateTarget", params: { targetId: targetId_1 } },
                                                })];
                                        case 1:
                                            _b.sent();
                                            return [3 /*break*/, 3];
                        ...
                        if (closeMatch && (req.method === "GET" || req.method === "PUT")) {
                            var targetId_2 = decodeURIComponent((_d = closeMatch[1]) !== null && _d !== void 0 ? _d : "").trim();
                            if (!targetId_2) {
                                res.writeHead(400);
                                res.end("targetId required");
                                return;
                                    ...
                                    switch (_b.label) {
                                        case 0:
                                            ...
                                            return [4 /*yield*/, sendToExtension({
                                                    id: nextExtensionId++,
                                                    method: "forwardCDPCommand",
                                                    params: { method: "Target.closeTarget", params: { targetId: targetId_2 } },
                                                })];
                                        case 1:
                                            _b.sent();
                                            return [3 /*break*/, 3];
                    ...
                    wssExtension.on("connection", function (ws) {
                        ...
                        ws.on("message", function (data) {
                            ...
                            if (parsed && typeof parsed === "object" && "method" in parsed) {
                                ...
                                if (method === "Target.attachedToTarget") {
                                    ...
                                    var targetType = (_e = (_d = attached === null || attached === void 0 ? void 0 : attached.targetInfo) === null || _d === void 0 ? void 0 : _d.type) !== null && _e !== void 0 ? _e : "page";
                                    if (targetType !== "page")
                                        return;
                                    if ((attached === null || attached === void 0 ? void 0 : attached.sessionId) && ((_f = attached === null || attached === void 0 ? void 0 : attached.targetInfo) === null || _f === void 0 ? void 0 : _f.targetId)) {
                                        ...
                                        var changedTarget = Boolean(prev && prevTargetId && prevTargetId !== nextTargetId);
                                ...
                                if (method === "Target.targetInfoChanged") {
                                    ...
                                    var targetInfo = changed === null || changed === void 0 ? void 0 : changed.targetInfo;
                                    var targetId = targetInfo === null || targetInfo === void 0 ? void 0 : targetInfo.targetId;
                                    if (targetId && ((_g = targetInfo === null || targetInfo === void 0 ? void 0 : targetInfo.type) !== null && _g !== void 0 ? _g : "page") === "page") {
                                        for (var _i = 0, connectedTargets_1 = connectedTargets; _i < connectedTargets_1.length; _i++) {
                                            var _j = connectedTargets_1[_i], sid = _j[0], target = _j[1];
                                            if (target.targetId !== targetId)
                                                continue;
                                            connectedTargets.set(sid, __assign(__assign({}, target), { targetInfo: __assign(__assign({}, target.targetInfo), targetInfo) }));
                                        }
                                    }
                                }
                                broadcastToCdpClients({ method: method, params: params, sessionId: sessionId });
                        ...
                        ws.on("close", function () {
                            clearInterval(ping);
                            extensionWs = null;
                            for (var _i = 0, pendingExtension_1 = pendingExtension; _i < pendingExtension_1.length; _i++) {
                                var _a = pendingExtension_1[_i], pending = _a[1];
                                clearTimeout(pending.timer);
                                ...
                                switch (_c.label) {
                                    ...
                                    case 2:
                                        ...
                                        if (cmd.method === "Target.attachToTarget") {
                                            ...
                                            targetId_3 = typeof params.targetId === "string" ? params.targetId : undefined;
                                            if (targetId_3) {
                                                target = Array.from(connectedTargets.values()).find(function (t) { return t.targetId === targetId_3; });
                                                if (target) {
                                                    ws.send(JSON.stringify({
                                                        method: "Target.attachedToTarget",
                                                        params: {
                                        ...
                                        sendResponseToCdp(ws, { id: cmd.id, sessionId: cmd.sessionId, result: result });
                                        return [3 /*break*/, 4];
                                    case 3:
                                        err_1 = _c.sent();
                                        sendResponseToCdp(ws, {
                    ...
                    return [4 /*yield*/, new Promise(function (resolve, reject) {
                            server.listen(info.port, info.host, function () { return resolve(); });
                            server.once("error", reject);
                        })];
                case 1:
                    _b.sent();
                    addr = server.address();
                    port = (_a = addr === null || addr === void 0 ? void 0 : addr.port) !== null && _a !== void 0 ? _a : info.port;
                    host = info.host;
                    ...
                    relay = {
                        ...
                        extensionConnected: function () { return Boolean(extensionWs); },
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        try {
                                            extensionWs === null || extensionWs === void 0 ? void 0 : extensionWs.close(1001, "server stopping");
                                        }
                                        catch (_b) {
                                            // ignore
                                        }
