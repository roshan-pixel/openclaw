...
function parseHttpUrl(raw, label) {
    ...
    if (parsed.protocol !== "http:" && parsed.protocol !== "https:") {
        throw new Error("".concat(label, " must be http(s), got: ").concat(parsed.protocol.replace(":", "")));
    }
    var port = parsed.port && Number.parseInt(parsed.port, 10) > 0
...
function ensureDefaultProfile(profiles, defaultColor, legacyCdpPort, derivedDefaultCdpPort) {
    ...
    if (!result[constants_js_1.DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME]) {
        result[constants_js_1.DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME] = {
            cdpPort: (_a = legacyCdpPort !== null && legacyCdpPort !== void 0 ? legacyCdpPort : derivedDefaultCdpPort) !== null && _a !== void 0 ? _a : profiles_js_1.CDP_PORT_RANGE_START,
            color: defaultColor,
        };
    }
    return result;
...
function resolveBrowserConfig(cfg, rootConfig) {
    var _a, _b, _c, _d, _e;
    var enabled = (_a = cfg === null || cfg === void 0 ? void 0 : cfg.enabled) !== null && _a !== void 0 ? _a : constants_js_1.DEFAULT_OPENCLAW_BROWSER_ENABLED;
    var evaluateEnabled = (_b = cfg === null || cfg === void 0 ? void 0 : cfg.evaluateEnabled) !== null && _b !== void 0 ? _b : constants_js_1.DEFAULT_BROWSER_EVALUATE_ENABLED;
    var gatewayPort = (0, paths_js_1.resolveGatewayPort)(rootConfig);
    var controlPort = (0, port_defaults_js_1.deriveDefaultBrowserControlPort)(gatewayPort !== null && gatewayPort !== void 0 ? gatewayPort : port_defaults_js_1.DEFAULT_BROWSER_CONTROL_PORT);
    var defaultColor = normalizeHexColor(cfg === null || cfg === void 0 ? void 0 : cfg.color);
    var remoteCdpTimeoutMs = normalizeTimeoutMs(cfg === null || cfg === void 0 ? void 0 : cfg.remoteCdpTimeoutMs, 1500);
    var remoteCdpHandshakeTimeoutMs = normalizeTimeoutMs(cfg === null || cfg === void 0 ? void 0 : cfg.remoteCdpHandshakeTimeoutMs, Math.max(2000, remoteCdpTimeoutMs * 2));
    var derivedCdpRange = (0, port_defaults_js_1.deriveDefaultBrowserCdpPortRange)(controlPort);
    var rawCdpUrl = ((_c = cfg === null || cfg === void 0 ? void 0 : cfg.cdpUrl) !== null && _c !== void 0 ? _c : "").trim();
    var cdpInfo;
    if (rawCdpUrl) {
        ...
        if (derivedPort > 65535) {
            throw new Error("Derived CDP port (".concat(derivedPort, ") is too high; check gateway port configuration."));
        }
    ...
    var executablePath = ((_d = cfg === null || cfg === void 0 ? void 0 : cfg.executablePath) === null || _d === void 0 ? void 0 : _d.trim()) || undefined;
    var defaultProfileFromConfig = ((_e = cfg === null || cfg === void 0 ? void 0 : cfg.defaultProfile) === null || _e === void 0 ? void 0 : _e.trim()) || undefined;
    // Use legacy cdpUrl port for backward compatibility when no profiles configured
    var legacyCdpPort = rawCdpUrl ? cdpInfo.port : undefined;
    var profiles = ensureDefaultChromeExtensionProfile(ensureDefaultProfile(cfg === null || cfg === void 0 ? void 0 : cfg.profiles, defaultColor, legacyCdpPort, derivedCdpRange.start), controlPort);
    var cdpProtocol = cdpInfo.parsed.protocol === "https:" ? "https" : "http";
    var defaultProfile = defaultProfileFromConfig !== null && defaultProfileFromConfig !== void 0 ? defaultProfileFromConfig : (profiles[constants_js_1.DEFAULT_BROWSER_DEFAULT_PROFILE_NAME]
...
function resolveProfile(resolved, profileName) {
    ...
    if (!profile)
        return null;
    var rawProfileUrl = (_b = (_a = profile.cdpUrl) === null || _a === void 0 ? void 0 : _a.trim()) !== null && _b !== void 0 ? _b : "";
