...
function rememberRoleRefsForTarget(opts) {
    ...
    if (!targetId)
        return;
    roleRefsByTarget.set(roleRefsKey(opts.cdpUrl, targetId), __assign(__assign({ refs: opts.refs }, (opts.frameSelector ? { frameSelector: opts.frameSelector } : {})), (opts.mode ? { mode: opts.mode } : {})));
...
function ensurePageState(page) {
    ...
    if (!observedPages.has(page)) {
        ...
        page.on("pageerror", function (err) {
            state.errors.push({
                message: (err === null || err === void 0 ? void 0 : err.message) ? String(err.message) : String(err),
                name: (err === null || err === void 0 ? void 0 : err.name) ? String(err.name) : undefined,
                stack: (err === null || err === void 0 ? void 0 : err.stack) ? String(err.stack) : undefined,
                timestamp: new Date().toISOString(),
            });
...
function observeContext(context) {
    ...
    context.on("page", function (page) { return ensurePageState(page); });
}
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!connecting) return [3 /*break*/, 2];
                    return [4 /*yield*/, connecting];
                case 1: return [2 /*return*/, _a.sent()];
                case 2:
                    connectWithRetry = function () { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                        ...
                                        return __generator(this, function (_b) {
                                            switch (_b.label) {
                                                case 0:
                                                    ...
                                                    return [4 /*yield*/, (0, chrome_js_1.getChromeWebSocketUrl)(normalized, timeout).catch(function () { return null; })];
                                                case 1:
                                                    wsUrl = _b.sent();
                                                    endpoint = wsUrl !== null && wsUrl !== void 0 ? wsUrl : normalized;
                                                    headers = (0, cdp_helpers_js_1.getHeadersWithAuth)(endpoint);
                                                    return [4 /*yield*/, playwright_core_1.chromium.connectOverCDP(endpoint, { timeout: timeout, headers: headers })];
                                                case 2:
                                                    browser_1 = _b.sent();
                                                    ...
                                                    browser_1.on("disconnected", function () {
                                                        if ((cached === null || cached === void 0 ? void 0 : cached.browser) === browser_1)
                                                            cached = null;
                                                    });
                                ...
                                case 4:
                                    ...
                                    message = lastErr ? (0, errors_js_1.formatErrorMessage)(lastErr) : "CDP connect failed";
...
function getAllPages(browser) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            pages = contexts.flatMap(function (c) { return c.pages(); });
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    info = (_c.sent());
                    targetId = String((_b = (_a = info === null || info === void 0 ? void 0 : info.targetInfo) === null || _a === void 0 ? void 0 : _a.targetId) !== null && _b !== void 0 ? _b : "").trim();
                    return [2 /*return*/, targetId || null];
                case 4: return [4 /*yield*/, session.detach().catch(function () { })];
                case 5:
                    _c.sent();
                    return [7 /*endfinally*/];
...
function findPageByTargetId(browser, targetId, cdpUrl) {
    return __awaiter(this, void 0, void 0, function () {
        var pages, _i, pages_1, page, tid, baseUrl, response, targets, target_1, urlMatch, sameUrlTargets, idx, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, getAllPages(browser)];
                case 1:
                    pages = _b.sent();
                    _i = 0, pages_1 = pages;
                    _b.label = 2;
                case 2:
                    if (!(_i < pages_1.length)) return [3 /*break*/, 5];
                    page = pages_1[_i];
                    return [4 /*yield*/, pageTargetId(page).catch(function () { return null; })];
                case 3:
                    tid = _b.sent();
                    if (tid && tid === targetId)
                ...
                case 8:
                    targets = (_b.sent());
                    target_1 = targets.find(function (t) { return t.id === targetId; });
                    if (target_1) {
                        urlMatch = pages.filter(function (p) { return p.url() === target_1.url; });
                        ...
                        if (urlMatch.length > 1) {
                            sameUrlTargets = targets.filter(function (t) { return t.url === target_1.url; });
                            if (sameUrlTargets.length === urlMatch.length) {
                                idx = sameUrlTargets.findIndex(function (t) { return t.id === targetId; });
...
function getPageForTargetId(opts) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, connectBrowser(opts.cdpUrl)];
                case 1:
...
function refLocator(page, ref) {
    ...
    if (/^e\d+$/.test(normalized)) {
        ...
        var info = (_a = state === null || state === void 0 ? void 0 : state.roleRefs) === null || _a === void 0 ? void 0 : _a[normalized];
        if (!info) {
            throw new Error("Unknown ref \"".concat(normalized, "\". Run a new snapshot and use a ref from that snapshot."));
        }
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 2:
                    ...
                    _d.label = 3;
                case 3:
                    if (!(_i < pages_2.length)) return [3 /*break*/, 7];
                    page = pages_2[_i];
                    return [4 /*yield*/, pageTargetId(page).catch(function () { return null; })];
                case 4:
                    tid = _d.sent();
                    ...
                    return [4 /*yield*/, page.title().catch(function () { return ""; })];
                case 5:
                    _b.apply(_a, [(_c.title = _d.sent(),
                            _c.url = page.url(),
                            _c.type = "page",
                            _c)]);
                    _d.label = 6;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    browser = (_d.sent()).browser;
                    if (!((_c = browser.contexts()[0]) !== null && _c !== void 0)) return [3 /*break*/, 2];
                    _a = _c;
                    return [3 /*break*/, 4];
                case 2: return [4 /*yield*/, browser.newContext()];
                case 3:
                    _a = (_d.sent());
                    _d.label = 4;
                case 4:
                ...
                case 5:
                    ...
                    if (!(targetUrl !== "about:blank")) return [3 /*break*/, 7];
                    return [4 /*yield*/, page.goto(targetUrl, { timeout: 30000 }).catch(function () {
                            // Navigation might fail for some URLs, but page is still created
                        })];
                case 6:
                    _d.sent();
                    _d.label = 7;
                case 7: return [4 /*yield*/, pageTargetId(page).catch(function () { return null; })];
                case 8:
                    tid = _d.sent();
                    if (!tid) {
                    ...
                    return [4 /*yield*/, page.title().catch(function () { return ""; })];
                case 9: return [2 /*return*/, (_b.title = _d.sent(),
                        _b.url = page.url(),
                        _b.type = "page",
                        _b)];
            }
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 9:
                    _a = _b.sent();
                    throw err_2;
                case 10: return [4 /*yield*/, session.detach().catch(function () { })];
                case 11:
                    _b.sent();
                    return [7 /*endfinally*/];
