...
function isProfileDecorated(userDataDir, desiredName, desiredColorHex) {
    ...
    var infoCache = typeof profile === "object" && profile !== null && !Array.isArray(profile)
        ? profile.info_cache
        : null;
    var info = typeof infoCache === "object" &&
        infoCache !== null &&
    ...
    var browserTheme = (function () {
        ...
        var theme = typeof browser === "object" && browser !== null && !Array.isArray(browser)
            ? browser.theme
            : null;
    ...
    var autogeneratedTheme = (function () {
        ...
        var theme = typeof autogenerated === "object" && autogenerated !== null && !Array.isArray(autogenerated)
            ? autogenerated.theme
            : null;
        return typeof theme === "object" && theme !== null && !Array.isArray(theme)
            ? theme
    ...
    var nameOk = typeof (info === null || info === void 0 ? void 0 : info.name) === "string" ? info.name === desiredName : true;
    if (desiredColorInt == null) {
        // If the user provided a non-#RRGGBB value, we can only do best-effort.
        return nameOk;
    }
    var localSeedOk = typeof (info === null || info === void 0 ? void 0 : info.profile_color_seed) === "number"
        ? info.profile_color_seed === desiredColorInt
        : false;
    var prefOk = (typeof (browserTheme === null || browserTheme === void 0 ? void 0 : browserTheme.user_color2) === "number" &&
        browserTheme.user_color2 === desiredColorInt) ||
        (typeof (autogeneratedTheme === null || autogeneratedTheme === void 0 ? void 0 : autogeneratedTheme.color) === "number" && autogeneratedTheme.color === desiredColorInt);
...
function decorateOpenClawProfile(userDataDir, opts) {
    var _a, _b, _c, _d;
    var desiredName = (_a = opts === null || opts === void 0 ? void 0 : opts.name) !== null && _a !== void 0 ? _a : constants_js_1.DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME;
    var desiredColor = ((_b = opts === null || opts === void 0 ? void 0 : opts.color) !== null && _b !== void 0 ? _b : constants_js_1.DEFAULT_OPENCLAW_BROWSER_COLOR).toUpperCase();
    ...
    try {
        node_fs_1.default.writeFileSync(decoratedMarkerPath(userDataDir), "".concat(Date.now(), "\n"), "utf-8");
    }
    catch (_e) {
        // ignore
    }
