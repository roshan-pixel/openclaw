        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    timeout = Math.max(500, Math.min(120000, (_a = opts.timeoutMs) !== null && _a !== void 0 ? _a : 120000));
                    ...
                    void page
                        ...
                        .then(function (fileChooser) { return __awaiter(_this, void 0, void 0, function () {
                        var _a, input, _b, _c;
                        var _d;
                            ...
                            switch (_e.label) {
                                case 0:
                                    if (state.armIdUpload !== armId)
                                        return [2 /*return*/];
                                    if (!!((_d = opts.paths) === null || _d === void 0 ? void 0 : _d.length)) return [3 /*break*/, 5];
                                    _e.label = 1;
                                case 1:
                                    _e.trys.push([1, 3, , 4]);
                                ...
                                case 5: return [4 /*yield*/, fileChooser.setFiles(opts.paths)];
                                case 6:
                                    _e.sent();
                                    _e.label = 7;
                                case 7:
                                    _e.trys.push([7, 13, , 14]);
                                    if (!(typeof fileChooser.element === "function")) return [3 /*break*/, 9];
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    void page
                        ...
                        .then(function (dialog) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    if (state.armIdDialog !== armId)
                                        return [2 /*return*/];
                                    if (!opts.accept) return [3 /*break*/, 2];
                                    return [4 /*yield*/, dialog.accept(opts.promptText)];
                                case 1:
                                    _a.sent();
                                    return [3 /*break*/, 4];
                                case 2: return [4 /*yield*/, dialog.dismiss()];
                                case 3:
                                    _a.sent();
                                    _a.label = 4;
                                case 4: return [2 /*return*/];
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 3:
                    ...
                    suggested = ((_a = download.suggestedFilename) === null || _a === void 0 ? void 0 : _a.call(download)) || "download.bin";
                    outPath = ((_b = opts.path) === null || _b === void 0 ? void 0 : _b.trim()) || buildTempDownloadPath(suggested);
                    return [4 /*yield*/, promises_1.default.mkdir(node_path_1.default.dirname(outPath), { recursive: true })];
                case 4:
                    _e.sent();
                    return [4 /*yield*/, ((_c = download.saveAs) === null || _c === void 0 ? void 0 : _c.call(download, outPath))];
                case 5:
                    _e.sent();
                    return [2 /*return*/, {
                            url: ((_d = download.url) === null || _d === void 0 ? void 0 : _d.call(download)) || "",
...
function downloadViaPlaywright(opts) {
    return __awaiter(this, void 0, void 0, function () {
        var page, state, timeout, ref, outPath, armId, waiter, locator, err_2, download, suggested, err_3;
        var _a, _b, _c, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0: return [4 /*yield*/, (0, pw_session_js_1.getPageForTargetId)(opts)];
                ...
                case 6: return [4 /*yield*/, waiter.promise];
                case 7:
                    download = (_e.sent());
                    if (state.armIdDownload !== armId) {
                        throw new Error("Download was superseded by another waiter");
                    }
                    suggested = ((_b = download.suggestedFilename) === null || _b === void 0 ? void 0 : _b.call(download)) || "download.bin";
                    return [4 /*yield*/, promises_1.default.mkdir(node_path_1.default.dirname(outPath), { recursive: true })];
                case 8:
                    _e.sent();
                    return [4 /*yield*/, ((_c = download.saveAs) === null || _c === void 0 ? void 0 : _c.call(download, outPath))];
