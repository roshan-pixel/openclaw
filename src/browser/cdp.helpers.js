...
function getHeadersWithAuth(url, headers) {
    ...
    try {
        ...
        var hasAuthHeader = Object.keys(headers).some(function (key) { return key.toLowerCase() === "authorization"; });
        if (hasAuthHeader)
            return headers;
        if (parsed.username || parsed.password) {
            var auth = Buffer.from("".concat(parsed.username, ":").concat(parsed.password)).toString("base64");
    ...
    return __awaiter(this, arguments, void 0, function (url, timeoutMs, init) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, , 4, 5]);
                    headers = getHeadersWithAuth(url, (init === null || init === void 0 ? void 0 : init.headers) || {});
...
function withCdpSocket(wsUrl, fn, opts) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    headers = getHeadersWithAuth(wsUrl, (_b = opts === null || opts === void 0 ? void 0 : opts.headers) !== null && _b !== void 0 ? _b : {});
                    ws = new ws_1.default(wsUrl, __assign({ handshakeTimeout: 5000 }, (Object.keys(headers).length ? { headers: headers } : {})));
                    ...
                    openPromise = new Promise(function (resolve, reject) {
                        ...
                        ws.once("error", function (err) { return reject(err); });
                    });
