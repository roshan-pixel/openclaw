...
exports.isProfileDecorated = exports.ensureProfileCleanExit = exports.decorateOpenClawProfile = exports.resolveBrowserExecutableForPlatform = exports.findChromeExecutableWindows = exports.findChromeExecutableMac = exports.findChromeExecutableLinux = void 0;
...
Object.defineProperty(exports, "findChromeExecutableLinux", { enumerable: true, get: function () { return chrome_executables_js_2.findChromeExecutableLinux; } });
Object.defineProperty(exports, "findChromeExecutableMac", { enumerable: true, get: function () { return chrome_executables_js_2.findChromeExecutableMac; } });
Object.defineProperty(exports, "findChromeExecutableWindows", { enumerable: true, get: function () { return chrome_executables_js_2.findChromeExecutableWindows; } });
Object.defineProperty(exports, "resolveBrowserExecutableForPlatform", { enumerable: true, get: function () { return chrome_executables_js_2.resolveBrowserExecutableForPlatform; } });
var chrome_profile_decoration_js_2 = require("./chrome.profile-decoration.js");
Object.defineProperty(exports, "decorateOpenClawProfile", { enumerable: true, get: function () { return chrome_profile_decoration_js_2.decorateOpenClawProfile; } });
Object.defineProperty(exports, "ensureProfileCleanExit", { enumerable: true, get: function () { return chrome_profile_decoration_js_2.ensureProfileCleanExit; } });
Object.defineProperty(exports, "isProfileDecorated", { enumerable: true, get: function () { return chrome_profile_decoration_js_2.isProfileDecorated; } });
...
function resolveOpenClawUserDataDir(profileName) {
    if (profileName === void 0) { profileName = constants_js_1.DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME; }
...
function isChromeReachable(cdpUrl_1) {
    return __awaiter(this, arguments, void 0, function (cdpUrl, timeoutMs) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetchChromeVersion(cdpUrl, timeoutMs)];
                case 1:
                    version = _a.sent();
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, fetch(versionUrl, {
                            signal: ctrl.signal,
    ...
    return __awaiter(this, arguments, void 0, function (cdpUrl, timeoutMs) {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    version = _b.sent();
                    wsUrl = String((_a = version === null || version === void 0 ? void 0 : version.webSocketDebuggerUrl) !== null && _a !== void 0 ? _a : "").trim();
                    if (!wsUrl)
                        return [2 /*return*/, null];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, new Promise(function (resolve) {
                        ...
                        var ws = new ws_1.default(wsUrl, __assign({ handshakeTimeout: timeoutMs }, (Object.keys(headers).length ? { headers: headers } : {})));
...
function isChromeCdpReady(cdpUrl_1) {
    return __awaiter(this, arguments, void 0, function (cdpUrl, timeoutMs, handshakeTimeoutMs) {
        var wsUrl;
        if (timeoutMs === void 0) { timeoutMs = 500; }
        if (handshakeTimeoutMs === void 0) { handshakeTimeoutMs = 800; }
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getChromeWebSocketUrl(cdpUrl, timeoutMs)];
                case 1:
                    wsUrl = _a.sent();
                    if (!wsUrl)
...
function launchOpenClawChrome(resolved, profile) {
    return __awaiter(this, void 0, void 0, function () {
        var exe, userDataDir, needsDecorate, spawnOnce, startedAt, localStatePath, preferencesPath, needsBootstrap, bootstrap, deadline, exitDeadline, proc, readyDeadline, pid;
        var _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    if (!profile.cdpIsLoopback) {
                        throw new Error("Profile \"".concat(profile.name, "\" is remote; cannot launch local Chrome."));
                    }
                ...
                case 1:
                    ...
                    needsDecorate = !(0, chrome_profile_decoration_js_1.isProfileDecorated)(userDataDir, profile.name, ((_a = profile.color) !== null && _a !== void 0 ? _a : constants_js_1.DEFAULT_OPENCLAW_BROWSER_COLOR).toUpperCase());
                    spawnOnce = function () {
                        var args = [
                    ...
                    if (!needsBootstrap) return [3 /*break*/, 7];
                    bootstrap = spawnOnce();
                ...
                case 4:
                    ...
                    _c.label = 5;
                case 5:
                    if (!(Date.now() < exitDeadline)) return [3 /*break*/, 7];
                ...
                case 7:
                    if (needsDecorate) {
                        try {
                            ...
                            log.info("\uD83E\uDD9E openclaw browser profile decorated (".concat(profile.color, ")"));
                        }
                        catch (err) {
                    ...
                    _c.label = 8;
                case 8:
                    if (!(Date.now() < readyDeadline)) return [3 /*break*/, 11];
                ...
                case 10:
                    _c.sent();
                    return [3 /*break*/, 8];
                case 11: return [4 /*yield*/, isChromeReachable(profile.cdpUrl, 500)];
                case 12:
                    if (!(_c.sent())) {
                        try {
                            proc.kill("SIGKILL");
                        ...
                        throw new Error("Failed to start Chrome CDP on port ".concat(profile.cdpPort, " for profile \"").concat(profile.name, "\"."));
                    }
                    pid = (_b = proc.pid) !== null && _b !== void 0 ? _b : -1;
                    log.info("\uD83E\uDD9E openclaw browser started (".concat(exe.kind, ") profile \"").concat(profile.name, "\" on 127.0.0.1:").concat(profile.cdpPort, " (pid ").concat(pid, ")"));
                    return [2 /*return*/, {
                            pid: pid,
                            exe: exe,
