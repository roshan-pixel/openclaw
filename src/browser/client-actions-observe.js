        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, client_fetch_js_1.fetchBrowserJson)(withBaseUrl(baseUrl, "/console".concat(suffix)), { timeoutMs: 20000 })];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, client_fetch_js_1.fetchBrowserJson)(withBaseUrl(baseUrl, "/pdf".concat(q)), {
                            method: "POST",
            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (opts.profile)
                        q.set("profile", opts.profile);
                    suffix = q.toString() ? "?".concat(q.toString()) : "";
                    return [4 /*yield*/, (0, client_fetch_js_1.fetchBrowserJson)(withBaseUrl(baseUrl, "/errors".concat(suffix)), { timeoutMs: 20000 })];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    });
            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (opts.profile)
                        q.set("profile", opts.profile);
                    suffix = q.toString() ? "?".concat(q.toString()) : "";
                    return [4 /*yield*/, (0, client_fetch_js_1.fetchBrowserJson)(withBaseUrl(baseUrl, "/requests".concat(suffix)), { timeoutMs: 20000 })];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    });
    ...
    return __awaiter(this, arguments, void 0, function (baseUrl, opts) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    q = buildProfileQuery(opts.profile);
                    return [4 /*yield*/, (0, client_fetch_js_1.fetchBrowserJson)(withBaseUrl(baseUrl, "/trace/start".concat(q)), {
                            method: "POST",
                            headers: { "Content-Type": "application/json" },
                            body: JSON.stringify({
    ...
    return __awaiter(this, arguments, void 0, function (baseUrl, opts) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    q = buildProfileQuery(opts.profile);
                    return [4 /*yield*/, (0, client_fetch_js_1.fetchBrowserJson)(withBaseUrl(baseUrl, "/trace/stop".concat(q)), {
                            method: "POST",
                            headers: { "Content-Type": "application/json" },
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    q = buildProfileQuery(opts.profile);
                    return [4 /*yield*/, (0, client_fetch_js_1.fetchBrowserJson)(withBaseUrl(baseUrl, "/highlight".concat(q)), {
                            method: "POST",
                            headers: { "Content-Type": "application/json" },
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    q = buildProfileQuery(opts.profile);
                    return [4 /*yield*/, (0, client_fetch_js_1.fetchBrowserJson)(withBaseUrl(baseUrl, "/response/body".concat(q)), {
                            method: "POST",
                            headers: { "Content-Type": "application/json" },
                            body: JSON.stringify({
                                targetId: opts.targetId,
