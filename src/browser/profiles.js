...
exports.PROFILE_COLORS = exports.PROFILE_NAME_REGEX = exports.CDP_PORT_RANGE_END = exports.CDP_PORT_RANGE_START = void 0;
...
function allocateCdpPort(usedPorts, range) {
    var _a, _b;
    var start = (_a = range === null || range === void 0 ? void 0 : range.start) !== null && _a !== void 0 ? _a : exports.CDP_PORT_RANGE_START;
    var end = (_b = range === null || range === void 0 ? void 0 : range.end) !== null && _b !== void 0 ? _b : exports.CDP_PORT_RANGE_END;
...
function allocateColor(usedColors) {
    ...
    return (_a = exports.PROFILE_COLORS[index]) !== null && _a !== void 0 ? _a : exports.PROFILE_COLORS[0];
}
function getUsedColors(profiles) {
    if (!profiles)
        return new Set();
    return new Set(Object.values(profiles).map(function (p) { return p.color.toUpperCase(); }));
}
