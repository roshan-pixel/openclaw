...
function highlightViaPlaywright(opts) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, pw_session_js_1.getPageForTargetId)(opts)];
                case 1:
                    page = _a.sent();
                    (0, pw_session_js_1.ensurePageState)(page);
                    (0, pw_session_js_1.restoreRoleRefsForTarget)({ cdpUrl: opts.cdpUrl, targetId: opts.targetId, page: page });
...
function clickViaPlaywright(opts) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, (0, pw_session_js_1.getPageForTargetId)({
                        cdpUrl: opts.cdpUrl,
                ...
                case 1:
                    ...
                    timeout = Math.max(500, Math.min(60000, Math.floor((_a = opts.timeoutMs) !== null && _a !== void 0 ? _a : 8000)));
                    _b.label = 2;
                case 2:
                    _b.trys.push([2, 7, , 8]);
                    if (!opts.doubleClick) return [3 /*break*/, 4];
                    return [4 /*yield*/, locator.dblclick({
                            timeout: timeout,
                            button: opts.button,
                ...
                case 3:
                    _b.sent();
                    return [3 /*break*/, 6];
                case 4: return [4 /*yield*/, locator.click({
                        timeout: timeout,
                        button: opts.button,
                        modifiers: opts.modifiers,
                    })];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    _b.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, (0, pw_session_js_1.refLocator)(page, ref).hover({
                            timeout: Math.max(500, Math.min(60000, (_a = opts.timeoutMs) !== null && _a !== void 0 ? _a : 8000)),
                        })];
                case 3:
                    _b.sent();
                    return [3 /*break*/, 5];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    _b.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, (0, pw_session_js_1.refLocator)(page, startRef).dragTo((0, pw_session_js_1.refLocator)(page, endRef), {
                            timeout: Math.max(500, Math.min(60000, (_a = opts.timeoutMs) !== null && _a !== void 0 ? _a : 8000)),
                        })];
                case 3:
                    _b.sent();
                ...
                case 4:
                    err_4 = _b.sent();
                    throw (0, pw_tools_core_shared_js_1.toAIFriendlyError)(err_4, "".concat(startRef, " -> ").concat(endRef));
                case 5: return [2 /*return*/];
            }
        });
    });
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    _c.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, (0, pw_session_js_1.refLocator)(page, ref).selectOption(opts.values, {
                            timeout: Math.max(500, Math.min(60000, (_b = opts.timeoutMs) !== null && _b !== void 0 ? _b : 8000)),
                        })];
                case 3:
                    _c.sent();
                    return [3 /*break*/, 5];
            ...
            switch (_c.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, page.keyboard.press(key, {
                            delay: Math.max(0, Math.floor((_b = opts.delayMs) !== null && _b !== void 0 ? _b : 0)),
                        })];
                case 2:
                    _c.sent();
                    return [2 /*return*/];
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    if (!opts.slowly) return [3 /*break*/, 5];
                ...
                case 4:
                    _c.sent();
                    return [3 /*break*/, 7];
                case 5: return [4 /*yield*/, locator.fill(text, { timeout: timeout })];
                case 6:
                    _c.sent();
                    _c.label = 7;
                case 7:
                    if (!opts.submit) return [3 /*break*/, 9];
            ...
            switch (_c.label) {
                ...
                case 2:
                    ...
                    if (!ref || !type)
                        return [3 /*break*/, 10];
                    locator = (0, pw_session_js_1.refLocator)(page, ref);
                    if (!(type === "checkbox" || type === "radio")) return [3 /*break*/, 7];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    (0, pw_session_js_1.ensurePageState)(page);
                    timeout = (0, pw_tools_core_shared_js_1.normalizeTimeoutMs)(opts.timeoutMs, 20000);
                    if (!(typeof opts.timeMs === "number" && Number.isFinite(opts.timeMs))) return [3 /*break*/, 3];
                    return [4 /*yield*/, page.waitForTimeout(Math.max(0, opts.timeMs))];
                case 2:
                    _a.sent();
                    _a.label = 3;
                case 3:
                    if (!opts.text) return [3 /*break*/, 5];
                    return [4 /*yield*/, page.getByText(opts.text).first().waitFor({
                            state: "visible",
                            timeout: timeout,
                        })];
                case 4:
                    ...
                    _a.label = 5;
                case 5:
                    if (!opts.textGone) return [3 /*break*/, 7];
                    return [4 /*yield*/, page.getByText(opts.textGone).first().waitFor({
                            state: "hidden",
                            timeout: timeout,
                        })];
                case 6:
                    ...
                    _a.label = 7;
                case 7:
                    if (!opts.selector) return [3 /*break*/, 9];
                    selector = String(opts.selector).trim();
                    if (!selector) return [3 /*break*/, 9];
                    return [4 /*yield*/, page.locator(selector).first().waitFor({ state: "visible", timeout: timeout })];
                case 8:
                    _a.sent();
                    _a.label = 9;
                case 9:
                    if (!opts.url) return [3 /*break*/, 11];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    if (!opts.element) return [3 /*break*/, 5];
                    if (opts.fullPage)
                        throw new Error("fullPage is not supported for element screenshots");
                ...
                case 5: return [4 /*yield*/, page.screenshot({
                        type: type,
...
function screenshotWithLabelsViaPlaywright(opts) {
    return __awaiter(this, void 0, void 0, function () {
        var page, type, maxLabels, viewport, refs, boxes, skipped, _i, refs_1, ref, box, x0, y0, x1, y1, vx0, vy0, vx1, vy1, _a, buffer;
        var _b, _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    ...
                    maxLabels = typeof opts.maxLabels === "number" && Number.isFinite(opts.maxLabels)
                ...
                case 2:
                    ...
                    _d.label = 3;
                case 3:
                    if (!(_i < refs_1.length)) return [3 /*break*/, 8];
                    ref = refs_1[_i];
                ...
                case 8:
                    ...
                    if (!(boxes.length > 0)) return [3 /*break*/, 10];
                    return [4 /*yield*/, page.evaluate(function (labels) {
                ...
                case 9:
                    _d.sent();
                    _d.label = 10;
                case 10: return [4 /*yield*/, page.screenshot({ type: type })];
                case 11:
                    buffer = _d.sent();
                    return [2 /*return*/, { buffer: buffer, labels: boxes.length, skipped: skipped }];
                case 12: return [4 /*yield*/, page
                        .evaluate(function () {
                        var existing = document.querySelectorAll("[data-openclaw-labels]");
                        existing.forEach(function (el) { return el.remove(); });
                    })
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    locator = inputRef ? (0, pw_session_js_1.refLocator)(page, inputRef) : page.locator(element).first();
                    _b.label = 2;
                case 2:
                    _b.trys.push([2, 4, , 5]);
                ...
                case 6:
                    handle = _b.sent();
                    if (!handle) return [3 /*break*/, 8];
                    return [4 /*yield*/, handle.evaluate(function (el) {
