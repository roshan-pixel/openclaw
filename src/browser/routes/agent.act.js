...
function registerBrowserAgentActRoutes(app, ctx) {
    var _this = this;
    app.post("/act", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        var profileCtx, body, kindRaw, kind, targetId, tab, cdpUrl, pw, evaluateEnabled, _a, ref, doubleClick, timeoutMs, buttonRaw, button, modifiersRaw, parsedModifiers, modifiers, clickRequest, ref, text, submit, slowly, timeoutMs, typeRequest, key, delayMs, ref, timeoutMs, ref, timeoutMs, scrollRequest, startRef, endRef, timeoutMs, ref, values, timeoutMs, rawFields, fields, timeoutMs, width, height, timeMs, text, textGone, selector, url, loadStateRaw, loadState, fn, timeoutMs, fn, ref, result, err_1;
        var _b, _c, _d, _e, _f;
            ...
            switch (_g.label) {
                case 0:
                    ...
                    if (Object.hasOwn(body, "selector") && kind !== "wait") {
                        return [2 /*return*/, (0, utils_js_1.jsonError)(res, 400, agent_shared_js_1.SELECTOR_UNSUPPORTED_MESSAGE)];
                    }
                    _g.label = 1;
                case 1:
                ...
                case 3:
                    ...
                    switch (_a) {
                        ...
                        case "press": return [3 /*break*/, 8];
                        case "hover": return [3 /*break*/, 10];
                        case "scrollIntoView": return [3 /*break*/, 12];
                        case "drag": return [3 /*break*/, 14];
                        case "select": return [3 /*break*/, 16];
                        case "fill": return [3 /*break*/, 18];
                        case "resize": return [3 /*break*/, 20];
                        case "wait": return [3 /*break*/, 22];
                        case "evaluate": return [3 /*break*/, 24];
                        case "close": return [3 /*break*/, 26];
                    }
                    return [3 /*break*/, 28];
                case 4:
                    ...
                    doubleClick = (_b = (0, utils_js_1.toBoolean)(body.doubleClick)) !== null && _b !== void 0 ? _b : false;
                    ...
                    if (buttonRaw && !button)
                        return [2 /*return*/, (0, utils_js_1.jsonError)(res, 400, "button must be left|right|middle")];
                    modifiersRaw = (_c = (0, utils_js_1.toStringArray)(body.modifiers)) !== null && _c !== void 0 ? _c : [];
                ...
                case 6:
                    ...
                    text = body.text;
                    submit = (_d = (0, utils_js_1.toBoolean)(body.submit)) !== null && _d !== void 0 ? _d : false;
                    slowly = (_e = (0, utils_js_1.toBoolean)(body.slowly)) !== null && _e !== void 0 ? _e : false;
                    timeoutMs = (0, utils_js_1.toNumber)(body.timeoutMs);
                    typeRequest = {
                        cdpUrl: cdpUrl,
                        targetId: tab.targetId,
                ...
                case 8:
                    ...
                    return [4 /*yield*/, pw.pressKeyViaPlaywright({
                            cdpUrl: cdpUrl,
                            targetId: tab.targetId,
                            key: key,
                ...
                case 10:
                    ...
                    if (!ref)
                        return [2 /*return*/, (0, utils_js_1.jsonError)(res, 400, "ref is required")];
                    timeoutMs = (0, utils_js_1.toNumber)(body.timeoutMs);
                    return [4 /*yield*/, pw.hoverViaPlaywright({
                            cdpUrl: cdpUrl,
                            targetId: tab.targetId,
                            ref: ref,
                ...
                case 14:
                    ...
                    if (!startRef || !endRef)
                        return [2 /*return*/, (0, utils_js_1.jsonError)(res, 400, "startRef and endRef are required")];
                    timeoutMs = (0, utils_js_1.toNumber)(body.timeoutMs);
                    return [4 /*yield*/, pw.dragViaPlaywright({
                            cdpUrl: cdpUrl,
                            targetId: tab.targetId,
                            startRef: startRef,
                            endRef: endRef,
                ...
                case 16:
                    ...
                    if (!ref || !(values === null || values === void 0 ? void 0 : values.length))
                        return [2 /*return*/, (0, utils_js_1.jsonError)(res, 400, "ref and values are required")];
                    timeoutMs = (0, utils_js_1.toNumber)(body.timeoutMs);
                    return [4 /*yield*/, pw.selectOptionViaPlaywright({
                            cdpUrl: cdpUrl,
                            targetId: tab.targetId,
                            ref: ref,
                            values: values,
                ...
                case 18:
                    ...
                    fields = rawFields
                        ...
                        if (!ref || !type)
                            return null;
                        var value = typeof rec.value === "string" ||
                            typeof rec.value === "number" ||
                            typeof rec.value === "boolean"
                            ? rec.value
                            : undefined;
                        var parsed = value === undefined ? { ref: ref, type: type } : { ref: ref, type: type, value: value };
                        return parsed;
                    })
                    ...
                    timeoutMs = (0, utils_js_1.toNumber)(body.timeoutMs);
                    return [4 /*yield*/, pw.fillFormViaPlaywright({
                            cdpUrl: cdpUrl,
                            targetId: tab.targetId,
                            fields: fields,
                            timeoutMs: timeoutMs !== null && timeoutMs !== void 0 ? timeoutMs : undefined,
                ...
                case 20:
                    ...
                    if (!width || !height)
                        return [2 /*return*/, (0, utils_js_1.jsonError)(res, 400, "width and height are required")];
                    return [4 /*yield*/, pw.resizeViewportViaPlaywright({
                            cdpUrl: cdpUrl,
                            targetId: tab.targetId,
                            width: width,
                            height: height,
                ...
                case 22:
                    ...
                    loadState = loadStateRaw === "load" ||
                        loadStateRaw === "domcontentloaded" ||
                        loadStateRaw === "networkidle"
                        ? loadStateRaw
                        : undefined;
                    fn = (0, utils_js_1.toStringOrEmpty)(body.fn) || undefined;
                    timeoutMs = (_f = (0, utils_js_1.toNumber)(body.timeoutMs)) !== null && _f !== void 0 ? _f : undefined;
                    if (fn && !evaluateEnabled) {
                        return [2 /*return*/, (0, utils_js_1.jsonError)(res, 403, [
                    ...
                    if (timeMs === undefined &&
                        ...
                        !loadState &&
                        !fn) {
                        return [2 /*return*/, (0, utils_js_1.jsonError)(res, 400, "wait requires at least one of: timeMs, text, textGone, selector, url, loadState, fn")];
                    }
                    return [4 /*yield*/, pw.waitForViaPlaywright({
                            cdpUrl: cdpUrl,
                            targetId: tab.targetId,
                            timeMs: timeMs,
                            text: text,
                ...
                case 24:
                    ...
                    return [4 /*yield*/, pw.evaluateViaPlaywright({
                            cdpUrl: cdpUrl,
                            targetId: tab.targetId,
                            fn: fn,
                            ref: ref,
                ...
                case 26: return [4 /*yield*/, pw.closePageViaPlaywright({ cdpUrl: cdpUrl, targetId: tab.targetId })];
                case 27:
                    _g.sent();
                    return [2 /*return*/, res.json({ ok: true, targetId: tab.targetId })];
                case 28:
    ...
    app.post("/hooks/file-chooser", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    paths = (_a = (0, utils_js_1.toStringArray)(body.paths)) !== null && _a !== void 0 ? _a : [];
                    timeoutMs = (0, utils_js_1.toNumber)(body.timeoutMs);
                    if (!paths.length)
                ...
                case 3:
                    ...
                    if (!pw)
                        return [2 /*return*/];
                    if (!(inputRef || element)) return [3 /*break*/, 5];
                    if (ref) {
                        return [2 /*return*/, (0, utils_js_1.jsonError)(res, 400, "ref cannot be combined with inputRef/element")];
                    }
                    return [4 /*yield*/, pw.setInputFilesViaPlaywright({
                            cdpUrl: profileCtx.profile.cdpUrl,
                            targetId: tab.targetId,
                            inputRef: inputRef,
                            element: element,
                ...
                case 4:
                    _b.sent();
                    return [3 /*break*/, 8];
                case 5: return [4 /*yield*/, pw.armFileUploadViaPlaywright({
                        cdpUrl: profileCtx.profile.cdpUrl,
                        targetId: tab.targetId,
                        paths: paths,
                        timeoutMs: timeoutMs !== null && timeoutMs !== void 0 ? timeoutMs : undefined,
                ...
                case 6:
                    _b.sent();
                    if (!ref) return [3 /*break*/, 8];
                    return [4 /*yield*/, pw.clickViaPlaywright({
                            cdpUrl: profileCtx.profile.cdpUrl,
                            targetId: tab.targetId,
                            ref: ref,
                        })];
    ...
    app.post("/hooks/dialog", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    if (!pw)
                        return [2 /*return*/];
                    return [4 /*yield*/, pw.armDialogViaPlaywright({
                            cdpUrl: profileCtx.profile.cdpUrl,
                            targetId: tab.targetId,
                            accept: accept,
    ...
    app.post("/wait/download", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    if (!pw)
                        return [2 /*return*/];
                    return [4 /*yield*/, pw.waitForDownloadViaPlaywright({
                            cdpUrl: profileCtx.profile.cdpUrl,
                            targetId: tab.targetId,
                            path: out,
                            timeoutMs: timeoutMs !== null && timeoutMs !== void 0 ? timeoutMs : undefined,
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    if (!pw)
                        return [2 /*return*/];
                    return [4 /*yield*/, pw.downloadViaPlaywright({
                            cdpUrl: profileCtx.profile.cdpUrl,
                            targetId: tab.targetId,
                            ref: ref,
                            path: out,
    ...
    app.post("/response/body", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    if (!pw)
                        return [2 /*return*/];
                    return [4 /*yield*/, pw.responseBodyViaPlaywright({
                            cdpUrl: profileCtx.profile.cdpUrl,
                            targetId: tab.targetId,
                            url: url,
                            timeoutMs: timeoutMs !== null && timeoutMs !== void 0 ? timeoutMs : undefined,
    ...
    app.post("/highlight", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    if (!pw)
                        return [2 /*return*/];
                    return [4 /*yield*/, pw.highlightViaPlaywright({
                            cdpUrl: profileCtx.profile.cdpUrl,
                            targetId: tab.targetId,
                            ref: ref,
                        })];
