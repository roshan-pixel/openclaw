...
function registerBrowserTabRoutes(app, ctx) {
    var _this = this;
    app.get("/tabs", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    ...
    app.post("/tabs/open", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    if ("error" in profileCtx)
                        return [2 /*return*/, (0, utils_js_1.jsonError)(res, profileCtx.status, profileCtx.error)];
                    url = (0, utils_js_1.toStringOrEmpty)((_a = req.body) === null || _a === void 0 ? void 0 : _a.url);
                    if (!url)
    ...
    app.post("/tabs/focus", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    if ("error" in profileCtx)
                        return [2 /*return*/, (0, utils_js_1.jsonError)(res, profileCtx.status, profileCtx.error)];
                    targetId = (0, utils_js_1.toStringOrEmpty)((_a = req.body) === null || _a === void 0 ? void 0 : _a.targetId);
                    if (!targetId)
    ...
    app.delete("/tabs/:targetId", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    ...
    app.post("/tabs/action", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        var profileCtx, action, index, reachable, tabs, tab, tabs, target, tabs, target, err_5, mapped;
        var _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    if ("error" in profileCtx)
                        return [2 /*return*/, (0, utils_js_1.jsonError)(res, profileCtx.status, profileCtx.error)];
                    action = (0, utils_js_1.toStringOrEmpty)((_a = req.body) === null || _a === void 0 ? void 0 : _a.action);
                    index = (0, utils_js_1.toNumber)((_b = req.body) === null || _b === void 0 ? void 0 : _b.index);
                    _c.label = 1;
                case 1:
                    _c.trys.push([1, 14, , 15]);
                    if (!(action === "list")) return [3 /*break*/, 4];
                    return [4 /*yield*/, profileCtx.isReachable(300)];
                case 2:
                    reachable = _c.sent();
                    if (!reachable)
                ...
                case 4:
                    if (!(action === "new")) return [3 /*break*/, 7];
                    return [4 /*yield*/, profileCtx.ensureBrowserAvailable()];
                case 5:
                    _c.sent();
                ...
                case 7:
                    if (!(action === "close")) return [3 /*break*/, 10];
                    return [4 /*yield*/, profileCtx.listTabs()];
                case 8:
                    tabs = _c.sent();
                ...
                case 10:
                    if (!(action === "select")) return [3 /*break*/, 13];
                ...
                case 12:
                    _c.sent();
                    return [2 /*return*/, res.json({ ok: true, targetId: target.targetId })];
                case 13: return [2 /*return*/, (0, utils_js_1.jsonError)(res, 400, "unknown tab action")];
                case 14:
                    err_5 = _c.sent();
