...
function registerBrowserAgentStorageRoutes(app, ctx) {
    var _this = this;
    app.get("/cookies", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    if (!pw)
                        return [2 /*return*/];
                    return [4 /*yield*/, pw.cookiesGetViaPlaywright({
    ...
    app.post("/cookies/set", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    cookie = body.cookie && typeof body.cookie === "object" && !Array.isArray(body.cookie)
                        ? body.cookie
                        : null;
                    if (!cookie)
                ...
                case 3:
                    ...
                    if (!pw)
                        return [2 /*return*/];
                    return [4 /*yield*/, pw.cookiesSetViaPlaywright({
                            cdpUrl: profileCtx.profile.cdpUrl,
                            targetId: tab.targetId,
                            cookie: {
                                ...
                                expires: (_a = (0, utils_js_1.toNumber)(cookie.expires)) !== null && _a !== void 0 ? _a : undefined,
                                httpOnly: (_b = (0, utils_js_1.toBoolean)(cookie.httpOnly)) !== null && _b !== void 0 ? _b : undefined,
                                secure: (_c = (0, utils_js_1.toBoolean)(cookie.secure)) !== null && _c !== void 0 ? _c : undefined,
    ...
    app.post("/cookies/clear", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    if (!pw)
                        return [2 /*return*/];
                    return [4 /*yield*/, pw.cookiesClearViaPlaywright({
                            cdpUrl: profileCtx.profile.cdpUrl,
                            targetId: tab.targetId,
                        })];
                case 4:
    ...
    app.get("/storage/:kind", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (kind !== "local" && kind !== "session")
                        return [2 /*return*/, (0, utils_js_1.jsonError)(res, 400, "kind must be local|session")];
                    targetId = typeof req.query.targetId === "string" ? req.query.targetId.trim() : "";
                ...
                case 3:
                    ...
                    if (!pw)
                        return [2 /*return*/];
                    return [4 /*yield*/, pw.storageGetViaPlaywright({
                            cdpUrl: profileCtx.profile.cdpUrl,
                            targetId: tab.targetId,
                            kind: kind,
    ...
    app.post("/storage/:kind/set", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    if (!pw)
                        return [2 /*return*/];
                    return [4 /*yield*/, pw.storageSetViaPlaywright({
                            cdpUrl: profileCtx.profile.cdpUrl,
                            targetId: tab.targetId,
                            kind: kind,
                            key: key,
    ...
    app.post("/storage/:kind/clear", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    if (!pw)
                        return [2 /*return*/];
                    return [4 /*yield*/, pw.storageClearViaPlaywright({
                            cdpUrl: profileCtx.profile.cdpUrl,
                            targetId: tab.targetId,
                            kind: kind,
                        })];
    ...
    app.post("/set/offline", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    if (!pw)
                        return [2 /*return*/];
                    return [4 /*yield*/, pw.setOfflineViaPlaywright({
                            cdpUrl: profileCtx.profile.cdpUrl,
                            targetId: tab.targetId,
                            offline: offline,
                        })];
    ...
    app.post("/set/headers", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    ...
                    if (!pw)
                        return [2 /*return*/];
                    return [4 /*yield*/, pw.setExtraHTTPHeadersViaPlaywright({
                            cdpUrl: profileCtx.profile.cdpUrl,
                            targetId: tab.targetId,
                            headers: parsed,
                        })];
    ...
    app.post("/set/credentials", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    body = (0, agent_shared_js_1.readBody)(req);
                    targetId = (0, utils_js_1.toStringOrEmpty)(body.targetId) || undefined;
                    clear = (_a = (0, utils_js_1.toBoolean)(body.clear)) !== null && _a !== void 0 ? _a : false;
                ...
                case 3:
                    ...
                    if (!pw)
                        return [2 /*return*/];
                    return [4 /*yield*/, pw.setHttpCredentialsViaPlaywright({
                            cdpUrl: profileCtx.profile.cdpUrl,
                            targetId: tab.targetId,
                            username: username,
                            password: password,
    ...
    app.post("/set/geolocation", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    accuracy = (_b = (0, utils_js_1.toNumber)(body.accuracy)) !== null && _b !== void 0 ? _b : undefined;
                ...
                case 3:
                    ...
                    if (!pw)
                        return [2 /*return*/];
                    return [4 /*yield*/, pw.setGeolocationViaPlaywright({
                            cdpUrl: profileCtx.profile.cdpUrl,
                            targetId: tab.targetId,
                            latitude: latitude,
                            longitude: longitude,
    ...
    app.post("/set/media", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    colorScheme = schemeRaw === "dark" || schemeRaw === "light" || schemeRaw === "no-preference"
                        ? schemeRaw
                        : schemeRaw === "none"
                            ? null
                            : undefined;
                    if (colorScheme === undefined)
                        return [2 /*return*/, (0, utils_js_1.jsonError)(res, 400, "colorScheme must be dark|light|no-preference|none")];
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 5, , 6]);
                    return [4 /*yield*/, profileCtx.ensureTabAvailable(targetId)];
                ...
                case 3:
                    ...
                    if (!pw)
                        return [2 /*return*/];
                    return [4 /*yield*/, pw.emulateMediaViaPlaywright({
                            cdpUrl: profileCtx.profile.cdpUrl,
                            targetId: tab.targetId,
    ...
    app.post("/set/timezone", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    if (!pw)
                        return [2 /*return*/];
                    return [4 /*yield*/, pw.setTimezoneViaPlaywright({
                            cdpUrl: profileCtx.profile.cdpUrl,
                            targetId: tab.targetId,
    ...
    app.post("/set/locale", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    if (!pw)
                        return [2 /*return*/];
                    return [4 /*yield*/, pw.setLocaleViaPlaywright({
                            cdpUrl: profileCtx.profile.cdpUrl,
                            targetId: tab.targetId,
                            locale: locale,
                        })];
    ...
    app.post("/set/device", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    if (!pw)
                        return [2 /*return*/];
                    return [4 /*yield*/, pw.setDeviceViaPlaywright({
                            cdpUrl: profileCtx.profile.cdpUrl,
                            targetId: tab.targetId,
                            name: name,
                        })];
