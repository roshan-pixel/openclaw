...
function registerBrowserAgentDebugRoutes(app, ctx) {
    var _this = this;
    app.get("/console", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    if (!pw)
                        return [2 /*return*/];
                    return [4 /*yield*/, pw.getConsoleMessagesViaPlaywright({
    ...
    app.get("/errors", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            switch (_b.label) {
                case 0:
                    ...
                    if (!profileCtx)
                        return [2 /*return*/];
                    targetId = typeof req.query.targetId === "string" ? req.query.targetId.trim() : "";
                    clear = (_a = (0, utils_js_1.toBoolean)(req.query.clear)) !== null && _a !== void 0 ? _a : false;
                    _b.label = 1;
                case 1:
                    _b.trys.push([1, 5, , 6]);
                    return [4 /*yield*/, profileCtx.ensureTabAvailable(targetId || undefined)];
                ...
                case 3:
                    ...
                    if (!pw)
                        return [2 /*return*/];
                    return [4 /*yield*/, pw.getPageErrorsViaPlaywright({
                            cdpUrl: profileCtx.profile.cdpUrl,
                            targetId: tab.targetId,
                            clear: clear,
                        })];
    ...
    app.get("/requests", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    if (!pw)
                        return [2 /*return*/];
                    return [4 /*yield*/, pw.getNetworkRequestsViaPlaywright({
                            cdpUrl: profileCtx.profile.cdpUrl,
                            targetId: tab.targetId,
    ...
    app.post("/trace/start", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    screenshots = (_a = (0, utils_js_1.toBoolean)(body.screenshots)) !== null && _a !== void 0 ? _a : undefined;
                    snapshots = (_b = (0, utils_js_1.toBoolean)(body.snapshots)) !== null && _b !== void 0 ? _b : undefined;
                    sources = (_c = (0, utils_js_1.toBoolean)(body.sources)) !== null && _c !== void 0 ? _c : undefined;
                    _d.label = 1;
                case 1:
                    _d.trys.push([1, 5, , 6]);
                ...
                case 3:
                    ...
                    if (!pw)
                        return [2 /*return*/];
                    return [4 /*yield*/, pw.traceStartViaPlaywright({
                            cdpUrl: profileCtx.profile.cdpUrl,
                            targetId: tab.targetId,
    ...
    app.post("/trace/stop", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    _a.sent();
                    tracePath = out.trim() || node_path_1.default.join(dir, "browser-trace-".concat(id, ".zip"));
                    return [4 /*yield*/, pw.traceStopViaPlaywright({
                            cdpUrl: profileCtx.profile.cdpUrl,
                            targetId: tab.targetId,
                            path: tracePath,
                        })];
