...
function getPwAiModule() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, pw_ai_module_js_1.getPwAiModule)({ mode: "soft" })];
...
function requirePwAi(res, feature) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getPwAiModule()];
                case 1:
                    mod = _a.sent();
                    if (mod)
                        return [2 /*return*/, mod];
                    (0, utils_js_1.jsonError)(res, 501, [
                        "Playwright is not available in this gateway build; '".concat(feature, "' is unsupported."),
