...
function createRegistry() {
    var routes = [];
    var register = function (method) { return function (path, handler) {
        var _a = compileRoute(path), regex = _a.regex, paramNames = _a.paramNames;
        routes.push({ method: method, path: path, regex: regex, paramNames: paramNames, handler: handler });
    }; };
    var router = {
        get: register("GET"),
        post: register("POST"),
...
function createBrowserRouteDispatcher(ctx) {
    ...
    return {
        dispatch: function (req) { return __awaiter(_this, void 0, void 0, function () {
            var method, path, query, body, match, exec, params, _i, _a, _b, idx, name_2, value, status, payload, res, err_1;
            var _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 4: return [2 /*return*/, { status: status, body: payload }];
                }
            });
        }); },
    };
