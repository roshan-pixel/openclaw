...
function registerBrowserBasicRoutes(app, ctx) {
    ...
    app.get("/profiles", function (_req, res) { return __awaiter(_this, void 0, void 0, function () {
    ...
    app.get("/", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        var current, profileCtx, _a, cdpHttp, cdpReady, profileState, detectedBrowser, detectedExecutablePath, detectError, detected;
            ...
            switch (_j.label) {
                case 0:
                    try {
                        ...
                        return [2 /*return*/, (0, utils_js_1.jsonError)(res, 503, "browser server not started")];
                    }
                    profileCtx = (0, utils_js_1.getProfileContext)(req, ctx);
                    if ("error" in profileCtx) {
                        return [2 /*return*/, (0, utils_js_1.jsonError)(res, profileCtx.status, profileCtx.error)];
                    }
                ...
                case 1:
                    ...
                    detectError = null;
                    try {
                        detected = (0, chrome_executables_js_1.resolveBrowserExecutableForPlatform)(current.resolved, process.platform);
                        if (detected) {
                    ...
                    res.json({
                        ...
                        cdpReady: cdpReady,
                        cdpHttp: cdpHttp,
                        pid: (_c = (_b = profileState === null || profileState === void 0 ? void 0 : profileState.running) === null || _b === void 0 ? void 0 : _b.pid) !== null && _c !== void 0 ? _c : null,
                        cdpPort: profileCtx.profile.cdpPort,
                        cdpUrl: profileCtx.profile.cdpUrl,
                        chosenBrowser: (_e = (_d = profileState === null || profileState === void 0 ? void 0 : profileState.running) === null || _d === void 0 ? void 0 : _d.exe.kind) !== null && _e !== void 0 ? _e : null,
                        detectedBrowser: detectedBrowser,
                        detectedExecutablePath: detectedExecutablePath,
                        detectError: detectError,
                        userDataDir: (_g = (_f = profileState === null || profileState === void 0 ? void 0 : profileState.running) === null || _f === void 0 ? void 0 : _f.userDataDir) !== null && _g !== void 0 ? _g : null,
                        color: profileCtx.profile.color,
                        headless: current.resolved.headless,
                        noSandbox: current.resolved.noSandbox,
                        executablePath: (_h = current.resolved.executablePath) !== null && _h !== void 0 ? _h : null,
    ...
    app.post("/start", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    ...
    app.post("/stop", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    ...
    app.post("/reset-profile", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    ...
    app.post("/profiles/create", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        var name, color, cdpUrl, driver, service, result, err_5, msg;
        var _a, _b, _c, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    name = (0, utils_js_1.toStringOrEmpty)((_a = req.body) === null || _a === void 0 ? void 0 : _a.name);
                    color = (0, utils_js_1.toStringOrEmpty)((_b = req.body) === null || _b === void 0 ? void 0 : _b.color);
                    cdpUrl = (0, utils_js_1.toStringOrEmpty)((_c = req.body) === null || _c === void 0 ? void 0 : _c.cdpUrl);
                    driver = (0, utils_js_1.toStringOrEmpty)((_d = req.body) === null || _d === void 0 ? void 0 : _d.driver);
                    if (!name)
    ...
    // Delete a profile
    app.delete("/profiles/:name", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!name)
                        return [2 /*return*/, (0, utils_js_1.jsonError)(res, 400, "profile name is required")];
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    service = (0, profiles_service_js_1.createBrowserProfilesService)(ctx);
