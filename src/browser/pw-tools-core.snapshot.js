        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, pw_session_js_1.getPageForTargetId)({
                            cdpUrl: opts.cdpUrl,
                ...
                case 6: return [4 /*yield*/, session.detach().catch(function () { })];
                case 7:
                    _b.sent();
                    return [7 /*endfinally*/];
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, maybe._snapshotForAI({
                            timeout: Math.max(500, Math.min(60000, Math.floor((_a = opts.timeoutMs) !== null && _a !== void 0 ? _a : 5000))),
                            track: "response",
                        })];
                case 2:
                    result = _c.sent();
                    snapshot = String((_b = result === null || result === void 0 ? void 0 : result.full) !== null && _b !== void 0 ? _b : "");
                    maxChars = opts.maxChars;
                    limit = typeof maxChars === "number" && Number.isFinite(maxChars) && maxChars > 0
                        ? Math.floor(maxChars)
                        : undefined;
                    truncated = false;
                    ...
                    return [2 /*return*/, truncated ? { snapshot: snapshot, truncated: truncated, refs: built.refs } : { snapshot: snapshot, refs: built.refs }];
            }
        });
    });
}
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 1:
                    page = _f.sent();
                    (0, pw_session_js_1.ensurePageState)(page);
                    if (!(opts.refsMode === "aria")) return [3 /*break*/, 3];
                    if (((_a = opts.selector) === null || _a === void 0 ? void 0 : _a.trim()) || ((_b = opts.frameSelector) === null || _b === void 0 ? void 0 : _b.trim())) {
                ...
                case 2:
                    result = _f.sent();
                    built_1 = (0, pw_role_snapshot_js_1.buildRoleSnapshotFromAiSnapshot)(String((_c = result === null || result === void 0 ? void 0 : result.full) !== null && _c !== void 0 ? _c : ""), opts.options);
                    (0, pw_session_js_1.storeRoleRefsForTarget)({
                        page: page,
                        cdpUrl: opts.cdpUrl,
                        targetId: opts.targetId,
                    ...
                    return [2 /*return*/, {
                            ...
                            refs: built_1.refs,
                            stats: (0, pw_role_snapshot_js_1.getRoleSnapshotStats)(built_1.snapshot, built_1.refs),
                        }];
                case 3:
                    frameSelector = ((_d = opts.frameSelector) === null || _d === void 0 ? void 0 : _d.trim()) || "";
                ...
                case 4:
                    ...
                    built = (0, pw_role_snapshot_js_1.buildRoleSnapshotFromAriaSnapshot)(String(ariaSnapshot !== null && ariaSnapshot !== void 0 ? ariaSnapshot : ""), opts.options);
                    (0, pw_session_js_1.storeRoleRefsForTarget)({
                        page: page,
                        cdpUrl: opts.cdpUrl,
                        targetId: opts.targetId,
            ...
            switch (_c.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, page.goto(url, {
                            timeout: Math.max(1000, Math.min(120000, (_b = opts.timeoutMs) !== null && _b !== void 0 ? _b : 20000)),
                        })];
                case 2:
                    _c.sent();
