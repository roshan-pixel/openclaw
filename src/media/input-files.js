...
function fetchWithGuard(params) {
    return __awaiter(this, void 0, void 0, function () {
        var currentUrl, redirectCount, controller, timeoutId, parsedUrl, pinned, dispatcher, response, location_1, contentLength, size, buffer, _a, _b, contentType, parsed, mimeType;
        var _c, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    ...
                    timeoutId = setTimeout(function () { return controller.abort(); }, params.timeoutMs);
                    _e.label = 1;
                case 1:
                ...
                case 2:
                    ...
                    if (!["http:", "https:"].includes(parsedUrl.protocol)) {
                        throw new Error("Invalid URL protocol: ".concat(parsedUrl.protocol, ". Only HTTP/HTTPS allowed."));
                    }
                ...
                case 4:
                    _e.trys.push([4, , 7, 9]);
                    return [4 /*yield*/, fetch(parsedUrl, {
                ...
                case 7: return [4 /*yield*/, (0, ssrf_js_1.closeDispatcher)(dispatcher)];
                case 8:
                    _e.sent();
                    return [7 /*endfinally*/];
