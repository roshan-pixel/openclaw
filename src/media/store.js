...
var resolveMediaDir = function () { return node_path_1.default.join((0, utils_js_1.resolveConfigDir)(), "media"); };
...
function extractOriginalFilename(filePath) {
    ...
    var match = nameWithoutExt.match(/^(.+)---[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12}$/i);
...
function cleanOldMedia() {
    return __awaiter(this, arguments, void 0, function (ttlMs) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, ensureMediaDir()];
                case 1:
                    mediaDir = _a.sent();
                    return [4 /*yield*/, promises_1.default.readdir(mediaDir).catch(function () { return []; })];
                case 2:
                    entries = _a.sent();
                    now = Date.now();
                    return [4 /*yield*/, Promise.all(entries.map(function (file) { return __awaiter(_this, void 0, void 0, function () {
                            var full, stat;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        full = node_path_1.default.join(mediaDir, file);
                                        return [4 /*yield*/, promises_1.default.stat(full).catch(function () { return null; })];
                                    case 1:
                                        stat = _a.sent();
                                        if (!stat)
                                            return [2 /*return*/];
                                        if (!(now - stat.mtimeMs > ttlMs)) return [3 /*break*/, 3];
            ...
            switch (_a.label) {
                case 0: return [4 /*yield*/, new Promise(function (resolve, reject) {
                        ...
                        if (!["http:", "https:"].includes(parsedUrl.protocol)) {
                            reject(new Error("Invalid URL protocol: ".concat(parsedUrl.protocol, ". Only HTTP/HTTPS allowed.")));
                            return;
                        }
                        var requestImpl = parsedUrl.protocol === "https:" ? node_https_1.request : node_http_1.request;
                        (0, ssrf_js_1.resolvePinnedHostname)(parsedUrl.hostname)
                            .then(function (pinned) {
                            var req = requestImpl(parsedUrl, { headers: headers, lookup: pinned.lookup }, function (res) {
                                var _a;
                                // Follow redirects
                                ...
                                if (!res.statusCode || res.statusCode >= 400) {
                                    reject(new Error("HTTP ".concat((_a = res.statusCode) !== null && _a !== void 0 ? _a : "?", " downloading media")));
                                    return;
                                }
                                var total = 0;
                                var sniffChunks = [];
...
function saveMediaSource(source_1, headers_1) {
    return __awaiter(this, arguments, void 0, function (source, headers, subdir) {
        var baseDir, dir, baseId, tempDest, _a, headerMime, sniffBuffer, size, mime_1, ext_1, id_1, finalDest, stat, buffer, mime, ext, id, dest;
        var _b, _c;
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 2:
                    ...
                    if (!looksLikeUrl(source)) return [3 /*break*/, 6];
                    tempDest = node_path_1.default.join(dir, "".concat(baseId, ".tmp"));
                    return [4 /*yield*/, downloadToFile(source, tempDest, headers)];
                case 3:
                    _a = _d.sent(), headerMime = _a.headerMime, sniffBuffer = _a.sniffBuffer, size = _a.size;
                ...
                case 4:
                    mime_1 = _d.sent();
                    ext_1 = (_b = (0, mime_js_1.extensionForMime)(mime_1)) !== null && _b !== void 0 ? _b : node_path_1.default.extname(new URL(source).pathname);
                ...
                case 6: return [4 /*yield*/, promises_1.default.stat(source)];
                case 7:
                    stat = _d.sent();
                    if (!stat.isFile()) {
                ...
                case 9:
                    mime = _d.sent();
                    ext = (_c = (0, mime_js_1.extensionForMime)(mime)) !== null && _c !== void 0 ? _c : node_path_1.default.extname(source);
...
function saveMediaBuffer(buffer_1, contentType_1) {
    return __awaiter(this, arguments, void 0, function (buffer, contentType, subdir, maxBytes, originalFilename) {
        var dir, uuid, headerExt, mime, ext, id, base, sanitized, dest;
        var _a, _b, _c;
        if (subdir === void 0) { subdir = "inbound"; }
        if (maxBytes === void 0) { maxBytes = MAX_BYTES; }
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    if (buffer.byteLength > maxBytes) {
                        throw new Error("Media exceeds ".concat((maxBytes / (1024 * 1024)).toFixed(0), "MB limit"));
                    }
                ...
                case 1:
                    ...
                    headerExt = (0, mime_js_1.extensionForMime)((_b = (_a = contentType === null || contentType === void 0 ? void 0 : contentType.split(";")[0]) === null || _a === void 0 ? void 0 : _a.trim()) !== null && _b !== void 0 ? _b : undefined);
                    return [4 /*yield*/, (0, mime_js_1.detectMime)({ buffer: buffer, headerMime: contentType })];
                case 2:
                    mime = _d.sent();
                    ext = (_c = headerExt !== null && headerExt !== void 0 ? headerExt : (0, mime_js_1.extensionForMime)(mime)) !== null && _c !== void 0 ? _c : "";
                    if (originalFilename) {
                        base = node_path_1.default.parse(originalFilename).name;
                        sanitized = sanitizeFilename(base);
                        id = sanitized ? "".concat(sanitized, "---").concat(uuid).concat(ext) : "".concat(uuid).concat(ext);
                    }
                    else {
                        // Legacy: just UUID
                ...
                case 3:
                    _d.sent();
                    return [2 /*return*/, { id: id, path: dest, size: buffer.byteLength, contentType: mime }];
            }
        });
    });
}
