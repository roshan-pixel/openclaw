...
function loadSharp() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require("sharp"); })];
                case 1:
                    mod = (_b.sent());
                    sharp = (_a = mod.default) !== null && _a !== void 0 ? _a : mod;
                    return [2 /*return*/, function (buffer) { return sharp(buffer, { failOnError: false }); }];
            }
        });
    });
}
...
function withTempDir(fn) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, promises_1.default.mkdtemp(node_path_1.default.join(node_os_1.default.tmpdir(), "openclaw-img-"))];
                case 1:
                    dir = _a.sent();
                    _a.label = 2;
                case 2:
                ...
                case 4: return [4 /*yield*/, promises_1.default.rm(dir, { recursive: true, force: true }).catch(function () { })];
                case 5:
                    _a.sent();
                    return [7 /*endfinally*/];
...
function sipsMetadataFromBuffer(buffer) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withTempDir(function (dir) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    _a.sent();
                                    return [4 /*yield*/, (0, exec_js_1.runExec)("/usr/bin/sips", ["-g", "pixelWidth", "-g", "pixelHeight", input], {
                                            timeoutMs: 10000,
                                            maxBuffer: 512 * 1024,
                                        })];
                                case 2:
                                    ...
                                    if (!(w === null || w === void 0 ? void 0 : w[1]) || !(h === null || h === void 0 ? void 0 : h[1]))
                ...
                case 0: return [4 /*yield*/, withTempDir(function (dir) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    _a.sent();
                                    return [4 /*yield*/, (0, exec_js_1.runExec)("/usr/bin/sips", [
                                            "-Z",
                ...
                case 0: return [4 /*yield*/, withTempDir(function (dir) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    _a.sent();
                                    return [4 /*yield*/, (0, exec_js_1.runExec)("/usr/bin/sips", ["-s", "format", "jpeg", input, "--out", output], {
                                            timeoutMs: 20000,
                                            maxBuffer: 1024 * 1024,
                                        })];
                                case 2:
...
function getImageMetadata(buffer) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    if (!prefersSips()) return [3 /*break*/, 2];
                    return [4 /*yield*/, sipsMetadataFromBuffer(buffer).catch(function () { return null; })];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, withTempDir(function (dir) { return __awaiter(_this, void 0, void 0, function () {
                            var input, output;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                    ...
                                    case 1:
                                        _a.sent();
                                        return [4 /*yield*/, (0, exec_js_1.runExec)("/usr/bin/sips", __spreadArray(__spreadArray([], ops, true), [input, "--out", output], false), {
                                                timeoutMs: 20000,
                                                maxBuffer: 1024 * 1024,
                                            })];
                                    case 2:
...
function normalizeExifOrientation(buffer) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    if (!prefersSips()) return [3 /*break*/, 4];
                    _c.label = 1;
                case 1:
                    _c.trys.push([1, 3, , 4]);
...
function resizeToJpeg(params) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!prefersSips()) return [3 /*break*/, 6];
                    return [4 /*yield*/, normalizeExifOrientationSips(params.buffer)];
                case 1:
                    normalized = _a.sent();
                    if (!(params.withoutEnlargement !== false)) return [3 /*break*/, 4];
                    return [4 /*yield*/, getImageMetadata(normalized)];
                case 2:
                    meta = _a.sent();
                    if (!meta) return [3 /*break*/, 4];
                    maxDim = Math.max(meta.width, meta.height);
                    if (!(maxDim > 0 && maxDim <= params.maxSide)) return [3 /*break*/, 4];
                    return [4 /*yield*/, sipsResizeToJpeg({
                            buffer: normalized,
                            maxSide: maxDim,
                            quality: params.quality,
                        })];
                case 3: return [2 /*return*/, _a.sent()];
                case 4: return [4 /*yield*/, sipsResizeToJpeg({
                        buffer: normalized,
                        maxSide: params.maxSide,
                        quality: params.quality,
                    })];
                case 5: return [2 /*return*/, _a.sent()];
                case 6: return [4 /*yield*/, loadSharp()];
                case 7:
                    sharp = _a.sent();
                    return [4 /*yield*/, sharp(params.buffer)
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1: return [2 /*return*/, _a.sent()];
                case 2: return [4 /*yield*/, loadSharp()];
                case 3:
                    sharp = _a.sent();
...
function resizeToPng(params) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, loadSharp()];
                case 1:
                    sharp = _b.sent();
...
function optimizeImageToPng(buffer, maxBytes) {
    return __awaiter(this, void 0, void 0, function () {
        var sides, compressionLevels, smallest, _i, sides_1, side, _a, compressionLevels_1, compressionLevel, out, size, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    _c.label = 1;
                case 1:
                    if (!(_i < sides_1.length)) return [3 /*break*/, 8];
                    side = sides_1[_i];
                    _a = 0, compressionLevels_1 = compressionLevels;
                    _c.label = 2;
                case 2:
                    if (!(_a < compressionLevels_1.length)) return [3 /*break*/, 7];
                    compressionLevel = compressionLevels_1[_a];
                    _c.label = 3;
                case 3:
                    _c.trys.push([3, 5, , 6]);
                    return [4 /*yield*/, resizeToPng({
                            buffer: buffer,
                            maxSide: side,
                ...
                case 4:
                    ...
                    if (!smallest || size < smallest.size) {
                        smallest = { buffer: out, size: size, resizeSide: side, compressionLevel: compressionLevel };
                    }
                    if (size <= maxBytes) {
                        return [2 /*return*/, {
                                buffer: out,
