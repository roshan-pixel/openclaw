...
var MIME_BY_EXT = __assign(__assign({}, Object.fromEntries(Object.entries(EXT_BY_MIME).map(function (_a) {
    var mime = _a[0], ext = _a[1];
    return [ext, mime];
}))), { 
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    type = _c.sent();
                    return [2 /*return*/, (_b = type === null || type === void 0 ? void 0 : type.mime) !== null && _b !== void 0 ? _b : undefined];
                case 3:
                    _a = _c.sent();
                    return [2 /*return*/, undefined];
...
function isGifMedia(opts) {
    var _a;
    if (((_a = opts.contentType) === null || _a === void 0 ? void 0 : _a.toLowerCase()) === "image/gif")
        return true;
