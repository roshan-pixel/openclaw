...
function normalizeCode(code) {
    var _a;
    return (_a = code === null || code === void 0 ? void 0 : code.trim().toUpperCase()) !== null && _a !== void 0 ? _a : "";
}
...
function isRecoverableTelegramNetworkError(err, options) {
    ...
    if (!err)
        return false;
    var allowMessageMatch = typeof options.allowMessageMatch === "boolean"
    ...
    var _loop_1 = function (candidate) {
        ...
        if (allowMessageMatch) {
            ...
            if (message_1 && RECOVERABLE_MESSAGE_SNIPPETS.some(function (snippet) { return message_1.includes(snippet); })) {
                return { value: true };
            }
        }
    };
