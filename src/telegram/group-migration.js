...
function resolveAccountGroups(cfg, accountId) {
    ...
    return { groups: matchKey ? (_c = accounts[matchKey]) === null || _c === void 0 ? void 0 : _c.groups : undefined };
}
...
function migrateTelegramGroupConfig(params) {
    ...
    var globalGroups = (_b = (_a = params.cfg.channels) === null || _a === void 0 ? void 0 : _a.telegram) === null || _b === void 0 ? void 0 : _b.groups;
    if (globalGroups) {
