...
function startTelegramWebhook(opts) {
    return __awaiter(this, void 0, void 0, function () {
        var path, healthPath, port, host, runtime, diagnosticsEnabled, bot, handler, server, publicUrl, shutdown;
        ...
        return __generator(this, function (_h) {
            switch (_h.label) {
                case 0:
                    ...
                    runtime = (_e = opts.runtime) !== null && _e !== void 0 ? _e : runtime_js_1.defaultRuntime;
                    ...
                    server = (0, node_http_1.createServer)(function (req, res) {
                        ...
                        if (diagnosticsEnabled) {
                            (0, diagnostic_js_1.logWebhookReceived)({ channel: "telegram", updateType: "telegram-post" });
                        }
                        ...
                        if (handled && typeof handled.catch === "function") {
                            void handled
                                ...
                                (_a = runtime.log) === null || _a === void 0 ? void 0 : _a.call(runtime, "webhook handler failed: ".concat(errMsg));
                                if (!res.headersSent)
                                    res.writeHead(500);
                                res.end();
                            });
                    ...
                    publicUrl = (_f = opts.publicUrl) !== null && _f !== void 0 ? _f : "http://".concat(host === "0.0.0.0" ? "localhost" : host, ":").concat(port).concat(path);
                ...
                case 1:
                    _h.sent();
                    return [4 /*yield*/, new Promise(function (resolve) { return server.listen(port, host, resolve); })];
                case 2:
                    _h.sent();
                    (_g = runtime.log) === null || _g === void 0 ? void 0 : _g.call(runtime, "webhook listening on ".concat(publicUrl));
                    shutdown = function () {
                        server.close();
                        void bot.stop();
                        if (diagnosticsEnabled) {
