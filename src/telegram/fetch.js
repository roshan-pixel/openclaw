...
function applyTelegramNetworkWorkarounds(network) {
    var decision = (0, network_config_js_1.resolveTelegramAutoSelectFamilyDecision)({ network: network });
...
function resolveTelegramFetch(proxyFetch, options) {
    applyTelegramNetworkWorkarounds(options === null || options === void 0 ? void 0 : options.network);
    if (proxyFetch)
