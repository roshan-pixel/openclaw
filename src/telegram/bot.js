...
function getTelegramSequentialKey(ctx) {
    ...
    if ((_b = reaction === null || reaction === void 0 ? void 0 : reaction.chat) === null || _b === void 0 ? void 0 : _b.id) {
        return "telegram:".concat(reaction.chat.id);
    }
    var msg = (_g = (_e = (_c = ctx.message) !== null && _c !== void 0 ? _c : (_d = ctx.update) === null || _d === void 0 ? void 0 : _d.message) !== null && _e !== void 0 ? _e : (_f = ctx.update) === null || _f === void 0 ? void 0 : _f.edited_message) !== null && _g !== void 0 ? _g : (_j = (_h = ctx.update) === null || _h === void 0 ? void 0 : _h.callback_query) === null || _j === void 0 ? void 0 : _j.message;
    var chatId = (_l = (_k = msg === null || msg === void 0 ? void 0 : msg.chat) === null || _k === void 0 ? void 0 : _k.id) !== null && _l !== void 0 ? _l : (_m = ctx.chat) === null || _m === void 0 ? void 0 : _m.id;
    var rawText = (_o = msg === null || msg === void 0 ? void 0 : msg.text) !== null && _o !== void 0 ? _o : msg === null || msg === void 0 ? void 0 : msg.caption;
    var botUsername = (_p = ctx.me) === null || _p === void 0 ? void 0 : _p.username;
    if (rawText &&
        (0, command_detection_js_1.isControlCommandMessage)(rawText, undefined, botUsername ? { botUsername: botUsername } : undefined)) {
        if (typeof chatId === "number")
            return "telegram:".concat(chatId, ":control");
        return "telegram:control";
    }
    var isGroup = ((_q = msg === null || msg === void 0 ? void 0 : msg.chat) === null || _q === void 0 ? void 0 : _q.type) === "group" || ((_r = msg === null || msg === void 0 ? void 0 : msg.chat) === null || _r === void 0 ? void 0 : _r.type) === "supergroup";
    var messageThreadId = msg === null || msg === void 0 ? void 0 : msg.message_thread_id;
    var isForum = (_s = msg === null || msg === void 0 ? void 0 : msg.chat) === null || _s === void 0 ? void 0 : _s.is_forum;
    var threadId = isGroup
        ? (0, helpers_js_1.resolveTelegramForumThreadId)({ isForum: isForum, messageThreadId: messageThreadId })
        : messageThreadId;
    if (typeof chatId === "number") {
        return threadId != null ? "telegram:".concat(chatId, ":topic:").concat(threadId) : "telegram:".concat(chatId);
    }
...
function createTelegramBot(opts) {
    ...
    var runtime = (_a = opts.runtime) !== null && _a !== void 0 ? _a : {
        log: console.log,
        error: console.error,
        exit: function (code) {
    ...
    var timeoutSeconds = typeof (telegramCfg === null || telegramCfg === void 0 ? void 0 : telegramCfg.timeoutSeconds) === "number" && Number.isFinite(telegramCfg.timeoutSeconds)
        ? Math.max(1, Math.floor(telegramCfg.timeoutSeconds))
        : undefined;
    var client = shouldProvideFetch || timeoutSeconds
        ? __assign(__assign({}, (shouldProvideFetch && fetchImpl
            ? { fetch: fetchImpl }
            : {})), (timeoutSeconds ? { timeoutSeconds: timeoutSeconds } : {})) : undefined;
    ...
    bot.catch(function (err) {
        var _a;
        (_a = runtime.error) === null || _a === void 0 ? void 0 : _a.call(runtime, (0, globals_js_1.danger)("telegram bot error: ".concat((0, errors_js_1.formatUncaughtError)(err))));
    });
    // Catch all errors from bot middleware to prevent unhandled rejections
    bot.catch(function (err) {
        var _a;
        var message = err instanceof Error ? err.message : String(err);
        (_a = runtime.error) === null || _a === void 0 ? void 0 : _a.call(runtime, (0, globals_js_1.danger)("telegram bot error: ".concat(message)));
    });
    var recentUpdates = (0, bot_updates_js_1.createTelegramUpdateDedupe)();
    var lastUpdateId = typeof ((_c = opts.updateOffset) === null || _c === void 0 ? void 0 : _c.lastUpdateId) === "number" ? opts.updateOffset.lastUpdateId : null;
    var recordUpdateId = function (ctx) {
        ...
        void ((_b = (_a = opts.updateOffset) === null || _a === void 0 ? void 0 : _a.onUpdateId) === null || _b === void 0 ? void 0 : _b.call(_a, updateId));
    };
    ...
    var rawUpdateLogger = (0, subsystem_js_1.createSubsystemLogger)("gateway/channels/telegram/raw-update");
    ...
    var stringifyUpdate = function (update) {
        ...
        return JSON.stringify(update !== null && update !== void 0 ? update : null, function (key, value) {
            ...
            if (Array.isArray(value) && value.length > MAX_RAW_UPDATE_ARRAY) {
                return __spreadArray(__spreadArray([], value.slice(0, MAX_RAW_UPDATE_ARRAY), true), [
                ...
                case 0:
                    if ((0, globals_js_1.shouldLogVerbose)()) {
                        try {
                            ...
                            preview = raw.length > MAX_RAW_UPDATE_CHARS ? "".concat(raw.slice(0, MAX_RAW_UPDATE_CHARS), "...") : raw;
    ...
    var historyLimit = Math.max(0, (_g = (_d = telegramCfg.historyLimit) !== null && _d !== void 0 ? _d : (_f = (_e = cfg.messages) === null || _e === void 0 ? void 0 : _e.groupChat) === null || _f === void 0 ? void 0 : _f.historyLimit) !== null && _g !== void 0 ? _g : history_js_1.DEFAULT_GROUP_HISTORY_LIMIT);
    ...
    var groupAllowFrom = (_m = (_l = (_k = opts.groupAllowFrom) !== null && _k !== void 0 ? _k : telegramCfg.groupAllowFrom) !== null && _l !== void 0 ? _l : (telegramCfg.allowFrom && telegramCfg.allowFrom.length > 0
        ? telegramCfg.allowFrom
        : undefined)) !== null && _m !== void 0 ? _m : (opts.allowFrom && opts.allowFrom.length > 0 ? opts.allowFrom : undefined);
    var replyToMode = (_p = (_o = opts.replyToMode) !== null && _o !== void 0 ? _o : telegramCfg.replyToMode) !== null && _p !== void 0 ? _p : "first";
    ...
    var nativeSkillsEnabled = (0, commands_js_1.resolveNativeSkillsEnabled)({
        providerId: "telegram",
        providerSetting: (_s = telegramCfg.commands) === null || _s === void 0 ? void 0 : _s.nativeSkills,
    ...
    var useAccessGroups = ((_w = cfg.commands) === null || _w === void 0 ? void 0 : _w.useAccessGroups) !== false;
    var ackReactionScope = (_y = (_x = cfg.messages) === null || _x === void 0 ? void 0 : _x.ackReactionScope) !== null && _y !== void 0 ? _y : "group-mentions";
    var mediaMaxBytes = ((_0 = (_z = opts.mediaMaxMb) !== null && _z !== void 0 ? _z : telegramCfg.mediaMaxMb) !== null && _0 !== void 0 ? _0 : 5) * 1024 * 1024;
    var logger = (0, logging_js_1.getChildLogger)({ module: "telegram-auto-reply" });
    var botHasTopicsEnabled;
    var resolveBotTopicsEnabled = function (ctx) { return __awaiter(_this, void 0, void 0, function () {
        var fromCtx, me, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    fromCtx = ctx === null || ctx === void 0 ? void 0 : ctx.me;
                    if (typeof (fromCtx === null || fromCtx === void 0 ? void 0 : fromCtx.has_topics_enabled) === "boolean") {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, api_logging_js_1.withTelegramApiErrorLogging)({
                            operation: "getMe",
                            runtime: runtime,
                            fn: function () { return bot.api.getMe(); },
                        })];
                case 2:
                    me = (_a.sent());
                    botHasTopicsEnabled = Boolean(me === null || me === void 0 ? void 0 : me.has_topics_enabled);
                    return [3 /*break*/, 4];
                case 3:
                    err_1 = _a.sent();
                    ...
                    return [3 /*break*/, 4];
                case 4: return [2 /*return*/, botHasTopicsEnabled];
            }
        });
    }); };
    ...
    var resolveGroupActivation = function (params) {
        var _a, _b, _c;
        var agentId = (_a = params.agentId) !== null && _a !== void 0 ? _a : (0, agent_scope_js_1.resolveDefaultAgentId)(cfg);
        var sessionKey = (_b = params.sessionKey) !== null && _b !== void 0 ? _b : "agent:".concat(agentId, ":telegram:group:").concat((0, helpers_js_1.buildTelegramGroupPeerId)(params.chatId, params.messageThreadId));
        var storePath = (0, sessions_js_1.resolveStorePath)((_c = cfg.session) === null || _c === void 0 ? void 0 : _c.store, { agentId: agentId });
        try {
            ...
            (0, globals_js_1.logVerbose)("Failed to load session for activation check: ".concat(String(err)));
        }
        return undefined;
    };
    ...
    var resolveTelegramGroupConfig = function (chatId, messageThreadId) {
        ...
        var topicConfig = messageThreadId != null ? (_b = groupConfig === null || groupConfig === void 0 ? void 0 : groupConfig.topics) === null || _b === void 0 ? void 0 : _b[String(messageThreadId)] : undefined;
    ...
    bot.on("message_reaction", function (ctx) { return __awaiter(_this, void 0, void 0, function () {
        var reaction, chatId, messageId, user, reactionMode, oldEmojis_1, addedReactions, senderName, senderUsername, senderLabel, messageThreadId, isForum, resolvedThreadId, isGroup, peerId, route, baseSessionKey, dmThreadId, threadKeys, sessionKey, _i, addedReactions_1, r, emoji, text;
        var _a, _b, _c, _d;
        return __generator(this, function (_e) {
            try {
                ...
                user = reaction.user;
                reactionMode = (_a = telegramCfg.reactionNotifications) !== null && _a !== void 0 ? _a : "own";
                if (reactionMode === "off")
                    return [2 /*return*/];
                if (user === null || user === void 0 ? void 0 : user.is_bot)
                    return [2 /*return*/];
                if (reactionMode === "own" && !(0, sent_message_cache_js_1.wasSentByBot)(chatId, messageId))
                    return [2 /*return*/];
                oldEmojis_1 = new Set(reaction.old_reaction
                    .filter(function (r) { return r.type === "emoji"; })
                    .map(function (r) { return r.emoji; }));
                addedReactions = reaction.new_reaction
                    .filter(function (r) { return r.type === "emoji"; })
                    .filter(function (r) { return !oldEmojis_1.has(r.emoji); });
                if (addedReactions.length === 0)
                    return [2 /*return*/];
                senderName = user
                    ? [user.first_name, user.last_name].filter(Boolean).join(" ").trim() || user.username
                    : undefined;
                senderUsername = (user === null || user === void 0 ? void 0 : user.username) ? "@".concat(user.username) : undefined;
                ...
                threadKeys = dmThreadId != null
                    ...
                    : null;
                sessionKey = (_b = threadKeys === null || threadKeys === void 0 ? void 0 : threadKeys.sessionKey) !== null && _b !== void 0 ? _b : baseSessionKey;
                // Enqueue system event for each added reaction
                for (_i = 0, addedReactions_1 = addedReactions; _i < addedReactions_1.length; _i++) {
                    r = addedReactions_1[_i];
                    emoji = r.emoji;
                    text = "Telegram reaction added: ".concat(emoji, " by ").concat(senderLabel, " on msg ").concat(messageId);
                    (0, system_events_js_1.enqueueSystemEvent)(text, {
                        sessionKey: sessionKey,
                        contextKey: "telegram:reaction:add:".concat(chatId, ":").concat(messageId, ":").concat((_c = user === null || user === void 0 ? void 0 : user.id) !== null && _c !== void 0 ? _c : "anon", ":").concat(emoji),
                    });
                    (0, globals_js_1.logVerbose)("telegram: reaction event enqueued: ".concat(text));
                }
            }
            catch (err) {
                (_d = runtime.error) === null || _d === void 0 ? void 0 : _d.call(runtime, (0, globals_js_1.danger)("telegram reaction handler failed: ".concat(String(err))));
            }
            return [2 /*return*/];
        });
    }); });
...
function createTelegramWebhookCallback(bot, path) {
    if (path === void 0) { path = "/telegram-webhook"; }
