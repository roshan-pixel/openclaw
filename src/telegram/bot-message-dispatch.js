    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    catalog = _b.sent();
                    defaultModel = (0, model_selection_js_1.resolveDefaultModelForAgent)({ cfg: cfg, agentId: agentId });
...
var dispatchTelegramMessage = function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    var ctxPayload, primaryCtx, msg, chatId, isGroup, resolvedThreadId, historyKey, historyLimit, groupHistories, route, skillFilter, sendTyping, sendRecordVoice, ackReactionPromise, reactionApi, removeAckAfterReply, isPrivateChat, draftMaxChars, canStreamDraft, _c, draftStream, draftChunking, draftChunker, lastPartialText, draftText, updateDraftFromPartial, flushDraft, disableBlockStreaming, prefixContext, tableMode, chunkMode, sticker, agentDir, stickerSupportsVision, description, stickerContext, formattedDesc, replyQuoteText, deliveryState, queuedFinal, sentFallback, result, hasFinalResponse;
    var _d;
    var context = _b.context, bot = _b.bot, cfg = _b.cfg, runtime = _b.runtime, replyToMode = _b.replyToMode, streamMode = _b.streamMode, textLimit = _b.textLimit, telegramCfg = _b.telegramCfg, opts = _b.opts, resolveBotTopicsEnabled = _b.resolveBotTopicsEnabled;
    return __generator(this, function (_e) {
        switch (_e.label) {
            case 0:
                ctxPayload = context.ctxPayload, primaryCtx = context.primaryCtx, msg = context.msg, chatId = context.chatId, isGroup = context.isGroup, resolvedThreadId = context.resolvedThreadId, historyKey = context.historyKey, historyLimit = context.historyLimit, groupHistories = context.groupHistories, route = context.route, skillFilter = context.skillFilter, sendTyping = context.sendTyping, sendRecordVoice = context.sendRecordVoice, ackReactionPromise = context.ackReactionPromise, reactionApi = context.reactionApi, removeAckAfterReply = context.removeAckAfterReply;
            ...
            case 2:
                ...
                draftStream = canStreamDraft
                    ...
                    : undefined;
                draftChunking = draftStream && streamMode === "block"
                    ? (0, draft_chunking_js_1.resolveTelegramDraftStreamingChunking)(cfg, route.accountId)
                    : undefined;
                draftChunker = draftChunking ? new pi_embedded_block_chunker_js_1.EmbeddedBlockChunker(draftChunking) : undefined;
                lastPartialText = "";
                draftText = "";
                ...
                flushDraft = function () { return __awaiter(void 0, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                if (!draftStream)
                                    return [2 /*return*/];
                                if (draftChunker === null || draftChunker === void 0 ? void 0 : draftChunker.hasBuffered()) {
                                    draftChunker.drain({
                                        force: true,
                                        emit: function (chunk) {
                                            draftText += chunk;
                ...
                if (!((sticker === null || sticker === void 0 ? void 0 : sticker.fileUniqueId) && ctxPayload.MediaPath)) return [3 /*break*/, 6];
            ...
            case 3:
                ...
                return [4 /*yield*/, (0, sticker_cache_js_1.describeStickerImage)({
            ...
            case 5:
                if (description) {
                    stickerContext = [sticker.emoji, sticker.setName ? "from \"".concat(sticker.setName, "\"") : null]
                        .filter(Boolean)
                        .join(" ");
                    formattedDesc = "[Sticker".concat(stickerContext ? " ".concat(stickerContext) : "", "] ").concat(description);
                    ...
                    (0, globals_js_1.logVerbose)("telegram: cached sticker description for ".concat(sticker.fileUniqueId));
                }
                _e.label = 6;
            case 6:
                replyQuoteText = ctxPayload.ReplyToIsQuote && ctxPayload.ReplyToBody
                ...
                return [4 /*yield*/, (0, provider_dispatcher_js_1.dispatchReplyWithBufferedBlockDispatcher)({
                        ...
                        dispatcherOptions: {
                            ...
                            deliver: function (payload, info) { return __awaiter(void 0, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            if (!(info.kind === "final")) return [3 /*break*/, 2];
                                            return [4 /*yield*/, flushDraft()];
                                        case 1:
                                            _a.sent();
                                            draftStream === null || draftStream === void 0 ? void 0 : draftStream.stop();
                                            _a.label = 2;
                                        case 2: return [4 /*yield*/, (0, delivery_js_1.deliverReplies)({
                                                replies: [payload],
                            ...
                            onError: function (err, info) {
                                var _a;
                                (_a = runtime.error) === null || _a === void 0 ? void 0 : _a.call(runtime, (0, globals_js_1.danger)("telegram ".concat(info.kind, " reply failed: ").concat(String(err))));
                            },
                        ...
                        replyOptions: {
                            ...
                            onPartialReply: draftStream ? function (payload) { return updateDraftFromPartial(payload.text); } : undefined,
            ...
            case 7:
                ...
                draftStream === null || draftStream === void 0 ? void 0 : draftStream.stop();
                sentFallback = false;
                if (!(!deliveryState.delivered && deliveryState.skippedNonSilent > 0)) return [3 /*break*/, 9];
            ...
            case 9:
                ...
                (0, ack_reactions_js_1.removeAckReactionAfterReply)({
                    ...
                    remove: function () { var _a, _b; return (_b = reactionApi === null || reactionApi === void 0 ? void 0 : reactionApi(chatId, (_a = msg.message_id) !== null && _a !== void 0 ? _a : 0, [])) !== null && _b !== void 0 ? _b : Promise.resolve(); },
