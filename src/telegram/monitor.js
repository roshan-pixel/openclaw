...
var isNetworkRelatedError = function (err) {
    ...
    if (!message)
        return false;
    return NETWORK_ERROR_SNIPPETS.some(function (snippet) { return message.includes(snippet); });
};
function monitorTelegramProvider() {
    return __awaiter(this, arguments, void 0, function (opts) {
        var cfg, account, token, proxyFetch, lastUpdateId, persistUpdateId, bot, restartAttempts, _loop_1, state_1;
        var _this = this;
        ...
        return __generator(this, function (_l) {
            switch (_l.label) {
                case 0:
                    ...
                    token = ((_b = opts.token) === null || _b === void 0 ? void 0 : _b.trim()) || account.token;
                    if (!token) {
                        throw new Error("Telegram bot token missing for account \"".concat(account.accountId, "\" (set channels.telegram.accounts.").concat(account.accountId, ".botToken/tokenFile or TELEGRAM_BOT_TOKEN for default)."));
                    }
                    proxyFetch = (_c = opts.proxyFetch) !== null && _c !== void 0 ? _c : (account.config.proxy ? (0, proxy_js_1.makeProxyFetch)(account.config.proxy) : undefined);
                ...
                case 1:
                    ...
                    if (!opts.useWebhook) return [3 /*break*/, 3];
                ...
                case 3:
                    restartAttempts = 0;
                    _loop_1 = function () {
                        var runner, stopOnAbort, err_2, isConflict, isRecoverable, isNetworkError, delayMs, reason, errMsg, sleepErr_1;
                        return __generator(this, function (_m) {
                            switch (_m.label) {
                                case 0:
                                    ...
                                    (_e = opts.abortSignal) === null || _e === void 0 ? void 0 : _e.addEventListener("abort", stopOnAbort, { once: true });
                                    _m.label = 1;
                                case 1:
                                ...
                                case 3:
                                    ...
                                    ((_h = (_g = opts.runtime) === null || _g === void 0 ? void 0 : _g.error) !== null && _h !== void 0 ? _h : console.error)("Telegram ".concat(reason, ": ").concat(errMsg, "; retrying in ").concat((0, format_duration_js_1.formatDurationMs)(delayMs), "."));
                                    _m.label = 4;
                                case 4:
                                    _m.trys.push([4, 6, , 7]);
                                ...
                                case 8:
                                    (_k = opts.abortSignal) === null || _k === void 0 ? void 0 : _k.removeEventListener("abort", stopOnAbort);
                                    return [7 /*endfinally*/];
                    ...
                    _l.label = 4;
                case 4:
                    if (!!((_d = opts.abortSignal) === null || _d === void 0 ? void 0 : _d.aborted)) return [3 /*break*/, 6];
