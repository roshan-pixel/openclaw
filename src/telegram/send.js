...
function createTelegramHttpLogger(cfg) {
    ...
    return function (label, err) {
        ...
        if (!(err instanceof grammy_1.HttpError))
            return;
        var detail = (0, redact_js_1.redactSensitiveText)((0, errors_js_1.formatUncaughtError)((_a = err.error) !== null && _a !== void 0 ? _a : err));
...
function resolveTelegramClientOptions(account) {
    ...
    var timeoutSeconds = typeof account.config.timeoutSeconds === "number" &&
        Number.isFinite(account.config.timeoutSeconds)
        ? Math.max(1, Math.floor(account.config.timeoutSeconds))
        : undefined;
    return fetchImpl || timeoutSeconds
        ? __assign(__assign({}, (fetchImpl ? { fetch: fetchImpl } : {})), (timeoutSeconds ? { timeoutSeconds: timeoutSeconds } : {})) : undefined;
}
function resolveToken(explicit, params) {
    if (explicit === null || explicit === void 0 ? void 0 : explicit.trim())
        return explicit.trim();
    if (!params.token) {
        throw new Error("Telegram bot token missing for account \"".concat(params.accountId, "\" (set channels.telegram.accounts.").concat(params.accountId, ".botToken/tokenFile or TELEGRAM_BOT_TOKEN for default)."));
    }
...
function normalizeChatId(to) {
    ...
    var m = (_a = /^https?:\/\/t\.me\/([A-Za-z0-9_]+)$/i.exec(normalized)) !== null && _a !== void 0 ? _a : /^t\.me\/([A-Za-z0-9_]+)$/i.exec(normalized);
...
function buildInlineKeyboard(buttons) {
    ...
    var rows = buttons
        .map(function (row) {
        return row
            .filter(function (button) { return (button === null || button === void 0 ? void 0 : button.text) && (button === null || button === void 0 ? void 0 : button.callback_data); })
            .map(function (button) { return ({
            text: button.text,
...
function sendMessageTelegram(to_1, text_1) {
    return __awaiter(this, arguments, void 0, function (to, text, opts) {
        var cfg, account, token, target, chatId, client, api, mediaUrl, replyMarkup, messageThreadId, threadIdParams, threadParams, quoteText, hasThreadParams, request, logHttpError, requestWithDiag, wrapChatNotFound, textMode, tableMode, renderHtmlText, linkPreviewEnabled, linkPreviewOptions, sendTelegramText, media, kind, isGif, fileName, file_1, _a, caption, followUpText, htmlCaption, needsSeparateText, baseMediaParams, mediaParams_1, result, useVoice, mediaMessageId, resolvedChatId, textParams_1, textRes, textParams, res, messageId;
        var _this = this;
        ...
        return __generator(this, function (_s) {
            switch (_s.label) {
                case 0:
                    ...
                    api = (_b = opts.api) !== null && _b !== void 0 ? _b : new grammy_1.Bot(token, client ? { client: client } : undefined).api;
                    mediaUrl = (_c = opts.mediaUrl) === null || _c === void 0 ? void 0 : _c.trim();
                    replyMarkup = buildInlineKeyboard(opts.buttons);
                    messageThreadId = opts.messageThreadId != null ? opts.messageThreadId : target.messageThreadId;
                    ...
                    request = (0, retry_policy_js_1.createTelegramRetryRunner)({
                        ...
                        shouldRetry: function (err) { return (0, network_errors_js_1.isRecoverableTelegramNetworkError)(err, { context: "send" }); },
                    });
                    ...
                    requestWithDiag = function (fn, label) {
                        return (0, api_logging_js_1.withTelegramApiErrorLogging)({
                            ...
                            fn: function () { return request(fn, label); },
                        }).catch(function (err) {
                    ...
                    wrapChatNotFound = function (err) {
                        if (!/400: Bad Request: chat not found/i.test((0, errors_js_1.formatErrorMessage)(err)))
                            return err;
                        return new Error([
                    ...
                    renderHtmlText = function (value) { return (0, format_js_1.renderTelegramHtmlText)(value, { textMode: textMode, tableMode: tableMode }); };
                    linkPreviewEnabled = (_f = account.config.linkPreview) !== null && _f !== void 0 ? _f : true;
                    linkPreviewOptions = linkPreviewEnabled ? undefined : { is_disabled: true };
                    sendTelegramText = function (rawText, params, fallbackText) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    sendParams = __assign(__assign({ parse_mode: "HTML" }, baseParams), (opts.silent === true ? { disable_notification: true } : {}));
                                    return [4 /*yield*/, requestWithDiag(function () { return api.sendMessage(chatId, htmlText, sendParams); }, "message").catch(function (err) { return __awaiter(_this, void 0, void 0, function () {
                                            var errText, fallback_1, plainParams_1;
                                            return __generator(this, function (_a) {
                                                switch (_a.label) {
                                                    case 0:
                                                        errText = (0, errors_js_1.formatErrorMessage)(err);
                                                        if (!PARSE_ERR_RE.test(errText)) return [3 /*break*/, 2];
                                                        if (opts.verbose) {
                                                            console.warn("telegram HTML parse failed, retrying as plain text: ".concat(errText));
                                                        }
                                                        fallback_1 = fallbackText !== null && fallbackText !== void 0 ? fallbackText : rawText;
                                                        plainParams_1 = hasBaseParams ? baseParams : undefined;
                                                        return [4 /*yield*/, requestWithDiag(function () {
                                                    ...
                                                    case 2: throw wrapChatNotFound(err);
                                                }
                                            });
                                        }); })];
                                case 1:
                ...
                case 1:
                    media = _s.sent();
                    kind = (0, constants_js_1.mediaKindFromMime)((_g = media.contentType) !== null && _g !== void 0 ? _g : undefined);
                    isGif = (0, mime_js_1.isGifMedia)({
                        contentType: media.contentType,
                        fileName: media.fileName,
                    });
                    fileName = (_j = (_h = media.fileName) !== null && _h !== void 0 ? _h : (isGif ? "animation.gif" : inferFilename(kind))) !== null && _j !== void 0 ? _j : "file";
                    file_1 = new grammy_1.InputFile(media.buffer, fileName);
                    _a = (0, caption_js_1.splitTelegramCaption)(text), caption = _a.caption, followUpText = _a.followUpText;
                    htmlCaption = caption ? renderHtmlText(caption) : undefined;
                    needsSeparateText = Boolean(followUpText);
                    baseMediaParams = __assign(__assign({}, (hasThreadParams ? threadParams : {})), (!needsSeparateText && replyMarkup ? { reply_markup: replyMarkup } : {}));
                    mediaParams_1 = __assign(__assign(__assign({ caption: htmlCaption }, (htmlCaption ? { parse_mode: "HTML" } : {})), baseMediaParams), (opts.silent === true ? { disable_notification: true } : {}));
                    result = void 0;
                    if (!isGif) return [3 /*break*/, 3];
                    return [4 /*yield*/, requestWithDiag(function () { return api.sendAnimation(chatId, file_1, mediaParams_1); }, "animation").catch(function (err) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, requestWithDiag(function () { return api.sendPhoto(chatId, file_1, mediaParams_1); }, "photo").catch(function (err) {
                            throw wrapChatNotFound(err);
                        })];
                case 4:
                    result = _s.sent();
                    return [3 /*break*/, 14];
                case 5:
                    if (!(kind === "video")) return [3 /*break*/, 7];
                    return [4 /*yield*/, requestWithDiag(function () { return api.sendVideo(chatId, file_1, mediaParams_1); }, "video").catch(function (err) {
                            throw wrapChatNotFound(err);
                        })];
                case 6:
                    result = _s.sent();
                    return [3 /*break*/, 14];
                case 7:
                    if (!(kind === "audio")) return [3 /*break*/, 12];
                    ...
                    if (!useVoice) return [3 /*break*/, 9];
                    return [4 /*yield*/, requestWithDiag(function () { return api.sendVoice(chatId, file_1, mediaParams_1); }, "voice").catch(function (err) {
                            throw wrapChatNotFound(err);
                        })];
                case 8:
                    result = _s.sent();
                    return [3 /*break*/, 11];
                case 9: return [4 /*yield*/, requestWithDiag(function () { return api.sendAudio(chatId, file_1, mediaParams_1); }, "audio").catch(function (err) {
                        throw wrapChatNotFound(err);
                    })];
                case 10:
                    result = _s.sent();
                ...
                case 12: return [4 /*yield*/, requestWithDiag(function () { return api.sendDocument(chatId, file_1, mediaParams_1); }, "document").catch(function (err) {
                        throw wrapChatNotFound(err);
                    })];
                case 13:
                    result = _s.sent();
                    _s.label = 14;
                case 14:
                    mediaMessageId = String((_k = result === null || result === void 0 ? void 0 : result.message_id) !== null && _k !== void 0 ? _k : "unknown");
                    resolvedChatId = String((_m = (_l = result === null || result === void 0 ? void 0 : result.chat) === null || _l === void 0 ? void 0 : _l.id) !== null && _m !== void 0 ? _m : chatId);
                    ...
                    if (!(needsSeparateText && followUpText)) return [3 /*break*/, 16];
                    textParams_1 = hasThreadParams || replyMarkup
                        ? __assign(__assign({}, threadParams), (replyMarkup ? { reply_markup: replyMarkup } : {})) : undefined;
                ...
                case 15:
                    ...
                    return [2 /*return*/, {
                            messageId: String((_o = textRes === null || textRes === void 0 ? void 0 : textRes.message_id) !== null && _o !== void 0 ? _o : mediaMessageId),
                            chatId: resolvedChatId,
                        }];
                case 16: return [2 /*return*/, { messageId: mediaMessageId, chatId: resolvedChatId }];
                case 17:
                    if (!text || !text.trim()) {
                        throw new Error("Message must be non-empty for Telegram sends");
                    }
                    textParams = hasThreadParams || replyMarkup
                        ? __assign(__assign({}, threadParams), (replyMarkup ? { reply_markup: replyMarkup } : {})) : undefined;
                    return [4 /*yield*/, sendTelegramText(text, textParams, opts.plainText)];
                case 18:
                    res = _s.sent();
                    messageId = String((_p = res === null || res === void 0 ? void 0 : res.message_id) !== null && _p !== void 0 ? _p : "unknown");
                    ...
                    return [2 /*return*/, { messageId: messageId, chatId: String((_r = (_q = res === null || res === void 0 ? void 0 : res.chat) === null || _q === void 0 ? void 0 : _q.id) !== null && _r !== void 0 ? _r : chatId) }];
            }
        });
    });
}
function reactMessageTelegram(chatIdInput_1, messageIdInput_1, emoji_1) {
    return __awaiter(this, arguments, void 0, function (chatIdInput, messageIdInput, emoji, opts) {
        var cfg, account, token, chatId, messageId, client, api, request, logHttpError, requestWithDiag, remove, trimmedEmoji, reactions;
        var _a;
        if (opts === void 0) { opts = {}; }
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    client = resolveTelegramClientOptions(account);
                    api = (_a = opts.api) !== null && _a !== void 0 ? _a : new grammy_1.Bot(token, client ? { client: client } : undefined).api;
                    request = (0, retry_policy_js_1.createTelegramRetryRunner)({
                        retry: opts.retry,
                        configRetry: account.config.retry,
                        verbose: opts.verbose,
                    ...
                    reactions = remove || !trimmedEmoji
                        ? []
                        : [{ type: "emoji", emoji: trimmedEmoji }];
                    if (typeof api.setMessageReaction !== "function") {
                        throw new Error("Telegram reactions are unavailable in this bot API.");
                    }
                    return [4 /*yield*/, requestWithDiag(function () { return api.setMessageReaction(chatId, messageId, reactions); }, "reaction")];
                case 1:
                    _b.sent();
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, requestWithDiag(function () { return api.deleteMessage(chatId, messageId); }, "deleteMessage")];
                case 1:
                    _b.sent();
                    (0, globals_js_1.logVerbose)("[telegram] Deleted message ".concat(messageId, " from chat ").concat(chatId));
                    return [2 /*return*/, { ok: true }];
            }
        });
    });
...
function editMessageTelegram(chatIdInput_1, messageIdInput_1, text_1) {
    return __awaiter(this, arguments, void 0, function (chatIdInput, messageIdInput, text, opts) {
        var cfg, account, token, chatId, messageId, client, api, request, logHttpError, requestWithDiag, textMode, tableMode, htmlText, shouldTouchButtons, builtKeyboard, replyMarkup, editParams;
        var _this = this;
        var _a, _b, _c;
        if (opts === void 0) { opts = {}; }
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    htmlText = (0, format_js_1.renderTelegramHtmlText)(text, { textMode: textMode, tableMode: tableMode });
                    shouldTouchButtons = opts.buttons !== undefined;
                    builtKeyboard = shouldTouchButtons ? buildInlineKeyboard(opts.buttons) : undefined;
                    replyMarkup = shouldTouchButtons ? (builtKeyboard !== null && builtKeyboard !== void 0 ? builtKeyboard : { inline_keyboard: [] }) : undefined;
                    editParams = {
                        parse_mode: "HTML",
                    };
                    ...
                    return [4 /*yield*/, requestWithDiag(function () { return api.editMessageText(chatId, messageId, htmlText, editParams); }, "editMessage").catch(function (err) { return __awaiter(_this, void 0, void 0, function () {
                ...
                case 1:
                    _d.sent();
                    (0, globals_js_1.logVerbose)("[telegram] Edited message ".concat(messageId, " in chat ").concat(chatId));
...
function sendStickerTelegram(to_1, fileId_1) {
    return __awaiter(this, arguments, void 0, function (to, fileId, opts) {
        var cfg, account, token, target, chatId, client, api, messageThreadId, threadIdParams, threadParams, hasThreadParams, request, logHttpError, requestWithDiag, wrapChatNotFound, stickerParams, result, messageId, resolvedChatId;
        var _a, _b, _c, _d;
        if (opts === void 0) { opts = {}; }
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    ...
                    return [4 /*yield*/, requestWithDiag(function () { return api.sendSticker(chatId, fileId.trim(), stickerParams); }, "sticker").catch(function (err) {
                            throw wrapChatNotFound(err);
                        })];
                case 1:
                    result = _e.sent();
                    messageId = String((_b = result === null || result === void 0 ? void 0 : result.message_id) !== null && _b !== void 0 ? _b : "unknown");
                    resolvedChatId = String((_d = (_c = result === null || result === void 0 ? void 0 : result.chat) === null || _c === void 0 ? void 0 : _c.id) !== null && _d !== void 0 ? _d : chatId);
                    if (result === null || result === void 0 ? void 0 : result.message_id) {
                        (0, sent_message_cache_js_1.recordSentMessage)(chatId, result.message_id);
                    }
                    (0, channel_activity_js_1.recordChannelActivity)({
