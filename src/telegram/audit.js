...
function collectTelegramUnmentionedGroupIds(groups) {
    ...
    var hasWildcardUnmentionedGroups = Boolean(((_a = groups["*"]) === null || _a === void 0 ? void 0 : _a.requireMention) === false) && ((_b = groups["*"]) === null || _b === void 0 ? void 0 : _b.enabled) !== false;
    var groupIds = [];
    ...
    groupIds.sort(function (a, b) { return a.localeCompare(b); });
    return { groupIds: groupIds, unresolvedGroups: unresolvedGroups, hasWildcardUnmentionedGroups: hasWildcardUnmentionedGroups };
}
function auditTelegramGroupMembership(params) {
    return __awaiter(this, void 0, void 0, function () {
        var started, token, fetcher, base, groups, _i, _a, chatId, url, res, json, desc, status_1, ok, err_1;
        var _b, _c, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    started = Date.now();
                    token = (_c = (_b = params.token) === null || _b === void 0 ? void 0 : _b.trim()) !== null && _c !== void 0 ? _c : "";
                ...
                case 2:
                    _e.trys.push([2, 5, , 6]);
                    url = "".concat(base, "/getChatMember?chat_id=").concat(encodeURIComponent(chatId), "&user_id=").concat(encodeURIComponent(String(params.botId)));
                ...
                case 4:
                    ...
                    if (!res.ok || !isRecord(json) || json.ok !== true) {
                        desc = isRecord(json) && json.ok === false && typeof json.description === "string"
                            ? json.description
                    ...
                    status_1 = isRecord(json.result)
                        ? ((_d = json.result.status) !== null && _d !== void 0 ? _d : null)
                        : null;
                ...
                case 7: return [2 /*return*/, {
                        ok: groups.every(function (g) { return g.ok; }),
