...
function resolveTelegramUpdateOffsetPath(accountId, env) {
    ...
    return node_path_1.default.join(stateDir, "telegram", "update-offset-".concat(normalized, ".json"));
}
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    return [2 /*return*/, (_a = parsed === null || parsed === void 0 ? void 0 : parsed.lastUpdateId) !== null && _a !== void 0 ? _a : null];
                case 3:
                    err_1 = _b.sent();
                    code = err_1.code;
                    if (code === "ENOENT")
