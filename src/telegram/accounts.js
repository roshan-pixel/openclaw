...
function listConfiguredAccountIds(cfg) {
    var _a, _b;
    var accounts = (_b = (_a = cfg.channels) === null || _a === void 0 ? void 0 : _a.telegram) === null || _b === void 0 ? void 0 : _b.accounts;
...
function listTelegramAccountIds(cfg) {
    var ids = Array.from(new Set(__spreadArray(__spreadArray([], listConfiguredAccountIds(cfg), true), (0, bindings_js_1.listBoundAccountIds)(cfg, "telegram"), true)));
...
function resolveAccountConfig(cfg, accountId) {
    ...
    var matchKey = Object.keys(accounts).find(function (key) { return (0, session_key_js_1.normalizeAccountId)(key) === normalized; });
    return matchKey ? accounts[matchKey] : undefined;
}
function mergeTelegramAccountConfig(cfg, accountId) {
    var _a, _b, _c;
    var _d = ((_b = (_a = cfg.channels) === null || _a === void 0 ? void 0 : _a.telegram) !== null && _b !== void 0 ? _b : {}), _ignored = _d.accounts, base = __rest(_d, ["accounts"]);
...
function resolveTelegramAccount(params) {
    ...
    var baseEnabled = ((_c = (_b = params.cfg.channels) === null || _b === void 0 ? void 0 : _b.telegram) === null || _c === void 0 ? void 0 : _c.enabled) !== false;
    var resolve = function (accountId) {
        ...
        var tokenResolution = (0, token_js_1.resolveTelegramToken)(params.cfg, { accountId: accountId });
...
function listEnabledTelegramAccounts(cfg) {
    return listTelegramAccountIds(cfg)
        .map(function (accountId) { return resolveTelegramAccount({ cfg: cfg, accountId: accountId }); })
