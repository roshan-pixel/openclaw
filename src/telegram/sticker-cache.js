...
function searchStickers(query, limit) {
    ...
    for (var _i = 0, _b = Object.values(cache.stickers); _i < _b.length; _i++) {
        ...
        var _loop_1 = function (qWord) {
            if (descWords.some(function (dWord) { return dWord.includes(qWord); })) {
                score += 5;
            }
        };
        ...
        // Set name match
        if ((_a = sticker.setName) === null || _a === void 0 ? void 0 : _a.toLowerCase().includes(queryLower)) {
            score += 3;
        }
        if (score > 0) {
    ...
    return results
        ...
        .slice(0, limit)
        .map(function (r) { return r.sticker; });
}
/**
...
function getCacheStats() {
    ...
    var sorted = __spreadArray([], stickers, true).sort(function (a, b) { return new Date(a.cachedAt).getTime() - new Date(b.cachedAt).getTime(); });
    return {
...
var STICKER_DESCRIPTION_PROMPT = "Describe this sticker image in 1-2 sentences. Focus on what the sticker depicts (character, object, action, emotion). Be concise and objective.";
...
function describeStickerImage(params) {
    return __awaiter(this, void 0, void 0, function () {
        var imagePath, cfg, agentDir, agentId, defaultModel, activeModel, catalog, entry, supportsVision, _a, hasProviderKey, selectCatalogModel, resolved, _b, _i, VISION_PROVIDERS_1, provider_1, entry, provider, model, buffer, describeImageWithModel, result, err_1;
        var _this = this;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    imagePath = params.imagePath, cfg = params.cfg, agentDir = params.agentDir, agentId = params.agentId;
                ...
                case 3:
                    ...
                    return [3 /*break*/, 4];
                case 4:
                    hasProviderKey = function (provider) { return __awaiter(_this, void 0, void 0, function () {
                        var _a;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    _b.trys.push([0, 2, , 3]);
                                    return [4 /*yield*/, (0, model_auth_js_1.resolveApiKeyForProvider)({ provider: provider, cfg: cfg, agentDir: agentDir })];
                                case 1:
                                    _b.sent();
                    ...
                    selectCatalogModel = function (provider) {
                        var entries = catalog.filter(function (entry) {
                            return entry.provider.toLowerCase() === provider.toLowerCase() && (0, model_catalog_js_1.modelSupportsVision)(entry);
                        });
                        if (entries.length === 0)
                            return undefined;
                        var defaultId = provider === "openai"
                            ? "gpt-5-mini"
                            : provider === "anthropic"
                                ? "claude-opus-4-5"
                                : provider === "google"
                                    ...
                                    : "MiniMax-VL-01";
                        var preferred = entries.find(function (entry) { return entry.id === defaultId; });
                ...
                case 6:
                    ...
                    _c.label = 7;
                case 7:
                    if (!(_i < VISION_PROVIDERS_1.length)) return [3 /*break*/, 10];
                ...
                case 10:
                    ...
                    return [4 /*yield*/, (0, runner_js_1.resolveAutoImageModel)({
                            cfg: cfg,
                            agentDir: agentDir,
                ...
                case 12:
                    if (!(resolved === null || resolved === void 0 ? void 0 : resolved.model)) {
                        (0, globals_js_1.logVerbose)("telegram: no vision provider available for sticker description");
                        return [2 /*return*/, null];
                    }
                    provider = resolved.provider, model = resolved.model;
                    (0, globals_js_1.logVerbose)("telegram: describing sticker with ".concat(provider, "/").concat(model));
                    _c.label = 13;
                case 13:
                ...
                case 14:
                    buffer = _c.sent();
                    return [4 /*yield*/, Promise.resolve().then(function () { return require("../media-understanding/providers/image.js"); })];
                case 15:
                    describeImageWithModel = (_c.sent()).describeImageWithModel;
                    return [4 /*yield*/, describeImageWithModel({
                            buffer: buffer,
                ...
                case 17:
                    err_1 = _c.sent();
                    (0, globals_js_1.logVerbose)("telegram: failed to describe sticker: ".concat(String(err_1)));
                    return [2 /*return*/, null];
