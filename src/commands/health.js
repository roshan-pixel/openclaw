...
var resolveAgentOrder = function (cfg) {
    ...
    var entries = Array.isArray((_a = cfg.agents) === null || _a === void 0 ? void 0 : _a.list) ? cfg.agents.list : [];
    var seen = new Set();
    var ordered = [];
...
var buildSessionSummary = function (storePath) {
    ...
    var sessions = Object.entries(store)
        ...
        return ({ key: key, updatedAt: (_b = entry === null || entry === void 0 ? void 0 : entry.updatedAt) !== null && _b !== void 0 ? _b : 0 });
    })
        .sort(function (a, b) { return b.updatedAt - a.updatedAt; });
    var recent = sessions.slice(0, 5).map(function (s) { return ({
        key: s.key,
...
var formatProbeLine = function (probe, opts) {
    ...
    for (var _i = 0, _b = (_a = opts.botUsernames) !== null && _a !== void 0 ? _a : []; _i < _b.length; _i++) {
        var extra = _b[_i];
        if (extra)
            usernames.add(extra);
    }
...
var formatHealthChannelLines = function (summary, opts) {
    ...
    var channelOrder = ((_b = summary.channelOrder) === null || _b === void 0 ? void 0 : _b.length) > 0 ? summary.channelOrder : Object.keys(channels);
    ...
    var _loop_1 = function (channelId) {
        ...
        var label = (_f = (_e = (_d = summary.channelLabels) === null || _d === void 0 ? void 0 : _d[channelId]) !== null && _e !== void 0 ? _e : plugin === null || plugin === void 0 ? void 0 : plugin.meta.label) !== null && _f !== void 0 ? _f : channelId;
        var accountSummaries = (_g = channelSummary.accounts) !== null && _g !== void 0 ? _g : {};
        var accountIds = (_h = opts.accountIdsByChannel) === null || _h === void 0 ? void 0 : _h[channelId];
        var filteredSummaries = accountIds && accountIds.length > 0
            ? accountIds
                .map(function (accountId) { return accountSummaries[accountId]; })
                .filter(function (entry) { return Boolean(entry); })
            : undefined;
        var listSummaries = accountMode === "all"
            ? Object.values(accountSummaries)
            : (filteredSummaries !== null && filteredSummaries !== void 0 ? filteredSummaries : (channelSummary.accounts ? Object.values(accountSummaries) : []));
        var baseSummary = filteredSummaries && filteredSummaries.length > 0 ? filteredSummaries[0] : channelSummary;
        ...
        if (linked !== null) {
            if (linked) {
                ...
                var authLabel = authAgeMs != null ? " (auth age ".concat(Math.round(authAgeMs / 60000), "m)") : "";
        ...
        var accountTimings = accountMode === "all"
            ? listSummaries
                .map(function (account) { return formatAccountProbeTiming(account); })
                .filter(function (value) { return Boolean(value); })
            : [];
        var failedSummary = listSummaries.find(function (summary) { return isProbeFailure(summary); });
        if (failedSummary) {
...
function getHealthSnapshot(params) {
    return __awaiter(this, void 0, void 0, function () {
        var timeoutMs, cfg, _a, defaultAgentId, ordered, channelBindings, sessionCache, agents, defaultAgent, heartbeatSeconds, sessions, start, cappedTimeout, doProbe, channels, channelOrder, channelLabels, _i, _b, plugin, accountIds, defaultAccountId, boundAccounts, preferredAccountId, boundAccountIdsAll, accountIdsToProbe, accountSummaries, _c, accountIdsToProbe_1, accountId, account, enabled, configured, _d, probe, lastProbeAt, err_1, probeRecord, bot, snapshot, summary_1, _e, record, defaultSummary, fallbackSummary, summary;
        ...
        return __generator(this, function (_u) {
            switch (_u.label) {
                case 0:
                    ...
                    _a = resolveAgentOrder(cfg), defaultAgentId = _a.defaultAgentId, ordered = _a.ordered;
                    channelBindings = (0, bindings_js_1.buildChannelAccountBindings)(cfg);
                    sessionCache = new Map();
                    agents = ordered.map(function (entry) {
                        var _a, _b;
                        var storePath = (0, sessions_js_1.resolveStorePath)((_a = cfg.session) === null || _a === void 0 ? void 0 : _a.store, { agentId: entry.id });
                        var sessions = (_b = sessionCache.get(storePath)) !== null && _b !== void 0 ? _b : buildSessionSummary(storePath);
                    ...
                    defaultAgent = (_f = agents.find(function (agent) { return agent.isDefault; })) !== null && _f !== void 0 ? _f : agents[0];
                    heartbeatSeconds = (defaultAgent === null || defaultAgent === void 0 ? void 0 : defaultAgent.heartbeat.everyMs)
                        ? Math.round(defaultAgent.heartbeat.everyMs / 1000)
                        : 0;
                    sessions = (_g = defaultAgent === null || defaultAgent === void 0 ? void 0 : defaultAgent.sessions) !== null && _g !== void 0 ? _g : buildSessionSummary((0, sessions_js_1.resolveStorePath)((_h = cfg.session) === null || _h === void 0 ? void 0 : _h.store, { agentId: defaultAgentId }));
                    start = Date.now();
                    cappedTimeout = Math.max(1000, timeoutMs !== null && timeoutMs !== void 0 ? timeoutMs : DEFAULT_TIMEOUT_MS);
                    doProbe = (params === null || params === void 0 ? void 0 : params.probe) !== false;
                    channels = {};
                    channelOrder = (0, index_js_1.listChannelPlugins)().map(function (plugin) { return plugin.id; });
                    channelLabels = {};
                ...
                case 1:
                    ...
                    plugin = _b[_i];
                    channelLabels[plugin.id] = (_j = plugin.meta.label) !== null && _j !== void 0 ? _j : plugin.id;
                    ...
                    boundAccounts = (_l = (_k = channelBindings.get(plugin.id)) === null || _k === void 0 ? void 0 : _k.get(defaultAgentId)) !== null && _l !== void 0 ? _l : [];
                    preferredAccountId = (0, bindings_js_1.resolvePreferredAccountId)({
                        accountIds: accountIds,
                        defaultAccountId: defaultAccountId,
                        boundAccounts: boundAccounts,
                    });
                    boundAccountIdsAll = Array.from(new Set(Array.from((_o = (_m = channelBindings.get(plugin.id)) === null || _m === void 0 ? void 0 : _m.values()) !== null && _o !== void 0 ? _o : []).flatMap(function (ids) { return ids; })));
                    accountIdsToProbe = Array.from(new Set(__spreadArray(__spreadArray([preferredAccountId, defaultAccountId], accountIds, true), boundAccountIdsAll, true).filter(function (value) { return value && value.trim(); })));
                    debugHealth("channel", {
                        id: plugin.id,
                        accountIds: accountIds,
                        defaultAccountId: defaultAccountId,
                    ...
                    _u.label = 2;
                case 2:
                    if (!(_c < accountIdsToProbe_1.length)) return [3 /*break*/, 14];
                ...
                case 5:
                    ...
                    probe = void 0;
                    lastProbeAt = null;
                    if (!(enabled && configured && doProbe && ((_p = plugin.status) === null || _p === void 0 ? void 0 : _p.probeAccount))) return [3 /*break*/, 9];
                    _u.label = 6;
                case 6:
                    _u.trys.push([6, 8, , 9]);
                ...
                case 9:
                    ...
                    bot = probeRecord && typeof probeRecord.bot === "object"
                        ? probeRecord.bot
                        : null;
                    if (bot === null || bot === void 0 ? void 0 : bot.username) {
                        debugHealth("probe.bot", { channel: plugin.id, accountId: accountId, username: bot.username });
                    }
                    snapshot = {
                        accountId: accountId,
                        enabled: enabled,
                    ...
                    if (!((_q = plugin.status) === null || _q === void 0 ? void 0 : _q.buildChannelSummary)) return [3 /*break*/, 11];
                ...
                case 12:
                    summary_1 = _e;
                    record = summary_1 && typeof summary_1 === "object"
                        ? summary_1
                        : {
                            accountId: accountId,
                            configured: configured,
                ...
                case 13:
                    ...
                    return [3 /*break*/, 2];
                case 14:
                    defaultSummary = (_s = (_r = accountSummaries[preferredAccountId]) !== null && _r !== void 0 ? _r : accountSummaries[defaultAccountId]) !== null && _s !== void 0 ? _s : accountSummaries[(_t = accountIdsToProbe[0]) !== null && _t !== void 0 ? _t : preferredAccountId];
                    fallbackSummary = defaultSummary !== null && defaultSummary !== void 0 ? defaultSummary : accountSummaries[Object.keys(accountSummaries)[0]];
                    if (fallbackSummary) {
                        channels[plugin.id] = __assign(__assign({}, fallbackSummary), { accounts: accountSummaries });
                    }
                    _u.label = 15;
                case 15:
                    _i++;
...
function healthCommand(opts, runtime) {
    return __awaiter(this, void 0, void 0, function () {
        var cfg, summary, fatal, debugEnabled, details, _i, _a, line, localAgents_1, defaultAgentId_1, agents, fallbackAgents, resolvedAgents_1, displayAgents_2, channelBindings_1, _b, _c, plugin, accountIds, defaultAccountId, _d, accountIds_1, accountId, account, record, tokenSource, configured, _e, _f, _g, _h, channelId, byAgent, entries, _j, _k, _l, channelId, channelSummary, accounts, probes, channelAccountFallbacks_1, accountIdsByChannel, channelLines, _m, channelLines_1, line, _o, _p, plugin, channelSummary, boundAccounts, accountIds, defaultAccountId, accountId, account, agentLabels, heartbeatParts, _q, _r, r, _s, displayAgents_1, agent, _t, _u, r;
        var _this = this;
        ...
        return __generator(this, function (_3) {
            switch (_3.label) {
                ...
                case 2:
                    ...
                    defaultAgentId_1 = (_w = summary.defaultAgentId) !== null && _w !== void 0 ? _w : localAgents_1.defaultAgentId;
                    ...
                    displayAgents_2 = opts.verbose
                        ? resolvedAgents_1
                        : resolvedAgents_1.filter(function (agent) { return agent.agentId === defaultAgentId_1; });
                    channelBindings_1 = (0, bindings_js_1.buildChannelAccountBindings)(cfg);
                    if (!debugEnabled) return [3 /*break*/, 11];
                ...
                case 3:
                    ...
                    runtime.log("  ".concat(plugin.id, ": accounts=").concat(accountIds.join(", ") || "(none)", " default=").concat(defaultAccountId));
                    _d = 0, accountIds_1 = accountIds;
                    _3.label = 4;
                case 4:
                    if (!(_d < accountIds_1.length)) return [3 /*break*/, 9];
                    accountId = accountIds_1[_d];
                    account = plugin.config.resolveAccount(cfg, accountId);
                    record = asRecord(account);
                    tokenSource = record && typeof record.tokenSource === "string" ? record.tokenSource : undefined;
                ...
                case 7:
                    configured = _e;
                    runtime.log("    - ".concat(accountId, ": configured=").concat(configured).concat(tokenSource ? " tokenSource=".concat(tokenSource) : ""));
                    _3.label = 8;
                case 8:
                    _d++;
                    return [3 /*break*/, 4];
                ...
                case 10:
                    ...
                    for (_j = 0, _k = Object.entries((_x = summary.channels) !== null && _x !== void 0 ? _x : {}); _j < _k.length; _j++) {
                        ...
                        probes = Object.entries(accounts).map(function (_a) {
                            var accountId = _a[0], accountSummary = _a[1];
                            ...
                            return "".concat(accountId, "=").concat(username !== null && username !== void 0 ? username : "(no bot)");
                        });
                        runtime.log("  ".concat(channelId, ": ").concat(probes.join(", ") || "(none)"));
                    }
                    _3.label = 11;
                case 11:
                    channelAccountFallbacks_1 = Object.fromEntries((0, index_js_1.listChannelPlugins)().map(function (plugin) {
                        var _a, _b;
                        ...
                        var preferred = (0, bindings_js_1.resolvePreferredAccountId)({
                            accountIds: accountIds,
                            defaultAccountId: defaultAccountId,
                            boundAccounts: (_b = (_a = channelBindings_1.get(plugin.id)) === null || _a === void 0 ? void 0 : _a.get(defaultAgentId_1)) !== null && _b !== void 0 ? _b : [],
                        });
                    ...
                    accountIdsByChannel = (function () {
                        ...
                        for (var _i = 0, _b = channelBindings_1.entries(); _i < _b.length; _i++) {
                            var _c = _b[_i], channelId = _c[0], byAgent = _c[1];
                            var accountIds = [];
                        ...
                        for (var _f = 0, _g = Object.entries(channelAccountFallbacks_1); _f < _g.length; _f++) {
                            var _h = _g[_f], channelId = _h[0], fallbackIds = _h[1];
                    ...
                    channelLines = Object.keys(accountIdsByChannel).length > 0
                    ...
                    for (_o = 0, _p = (0, index_js_1.listChannelPlugins)(); _o < _p.length; _o++) {
                        plugin = _p[_o];
                        channelSummary = (_z = summary.channels) === null || _z === void 0 ? void 0 : _z[plugin.id];
                        if (!channelSummary || channelSummary.linked !== true)
                            continue;
                        if (!((_0 = plugin.status) === null || _0 === void 0 ? void 0 : _0.logSelfId))
                            continue;
                        boundAccounts = (_2 = (_1 = channelBindings_1.get(plugin.id)) === null || _1 === void 0 ? void 0 : _1.get(defaultAgentId_1)) !== null && _2 !== void 0 ? _2 : [];
                        accountIds = plugin.config.listAccountIds(cfg);
                        defaultAccountId = (0, helpers_js_1.resolveChannelDefaultAccountId)({
                            plugin: plugin,
                            cfg: cfg,
                    ...
                    if (heartbeatParts.length > 0) {
                        runtime.log((0, globals_js_1.info)("Heartbeat interval: ".concat(heartbeatParts.join(", "))));
                    }
                    if (displayAgents_2.length === 0) {
                        runtime.log((0, globals_js_1.info)("Session store: ".concat(summary.sessions.path, " (").concat(summary.sessions.count, " entries)")));
                        if (summary.sessions.recent.length > 0) {
                            for (_q = 0, _r = summary.sessions.recent; _q < _r.length; _q++) {
                                r = _r[_q];
                                runtime.log("- ".concat(r.key, " (").concat(r.updatedAt ? "".concat(Math.round((Date.now() - r.updatedAt) / 60000), "m ago") : "no activity", ")"));
                            }
                        }
                    }
                    else {
                        for (_s = 0, displayAgents_1 = displayAgents_2; _s < displayAgents_1.length; _s++) {
                            ...
                            runtime.log((0, globals_js_1.info)("Session store (".concat(agent.agentId, "): ").concat(agent.sessions.path, " (").concat(agent.sessions.count, " entries)")));
