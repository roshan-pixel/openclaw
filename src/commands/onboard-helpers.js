...
function summarizeExistingConfig(config) {
    ...
    if ((_f = (_e = config.gateway) === null || _e === void 0 ? void 0 : _e.remote) === null || _f === void 0 ? void 0 : _f.url) {
        rows.push((0, utils_js_1.shortenHomeInString)("gateway.remote.url: ".concat(config.gateway.remote.url)));
    }
    if ((_h = (_g = config.skills) === null || _g === void 0 ? void 0 : _g.install) === null || _h === void 0 ? void 0 : _h.nodeManager) {
        rows.push((0, utils_js_1.shortenHomeInString)("skills.nodeManager: ".concat(config.skills.install.nodeManager)));
    }
...
function applyWizardMetadata(cfg, params) {
    var _a, _b;
    var commit = ((_a = process.env.GIT_COMMIT) === null || _a === void 0 ? void 0 : _a.trim()) || ((_b = process.env.GIT_SHA) === null || _b === void 0 ? void 0 : _b.trim()) || undefined;
    return __assign(__assign({}, cfg), { wizard: __assign(__assign({}, cfg.wizard), { lastRunAt: new Date().toISOString(), lastRunVersion: version_js_1.VERSION, lastRunCommit: commit, lastRunCommand: params.command, lastRunMode: params.mode }) });
}
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    isSsh = Boolean(process.env.SSH_CLIENT) ||
                ...
                case 1:
                    hasOpen = _a.sent();
                    return [2 /*return*/, hasOpen ? { argv: ["open"], command: "open" } : { argv: null, reason: "missing-open" }];
                case 2:
                ...
                case 4:
                    ...
                    _a.label = 5;
                case 5: return [4 /*yield*/, detectBinary("xdg-open")];
                case 6:
                    hasXdgOpen = _a.sent();
                    return [2 /*return*/, hasXdgOpen
                            ? { argv: ["xdg-open"], command: "xdg-open" }
                            : { argv: null, reason: "missing-xdg-open" }];
                case 7: return [2 /*return*/, { argv: null, reason: "unsupported-platform" }];
            }
        });
    });
}
function detectBrowserOpenSupport() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, resolveBrowserOpenCommand()];
                case 1:
                    resolved = _a.sent();
                    if (!resolved.argv)
...
function resolveSshTargetHint() {
    ...
    var conn = (_a = process.env.SSH_CONNECTION) === null || _a === void 0 ? void 0 : _a.trim().split(/\s+/);
    var host = (_b = conn === null || conn === void 0 ? void 0 : conn[2]) !== null && _b !== void 0 ? _b : "<host>";
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    _b.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, (0, exec_js_1.runCommandWithTimeout)(command, {
                            timeoutMs: 5000,
...
function ensureWorkspaceAndSessions(workspaceDir, runtime, options) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, workspace_js_1.ensureAgentWorkspace)({
                        dir: workspaceDir,
                        ensureBootstrapFiles: !(options === null || options === void 0 ? void 0 : options.skipBootstrap),
                    })];
                case 1:
                    ws = _a.sent();
                    runtime.log("Workspace OK: ".concat((0, utils_js_1.shortenHomePath)(ws.dir)));
                    sessionsDir = (0, sessions_js_1.resolveSessionTranscriptsDirForAgent)(options === null || options === void 0 ? void 0 : options.agentId);
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 4:
                    _c.trys.push([4, 6, , 7]);
                    return [4 /*yield*/, (0, exec_js_1.runCommandWithTimeout)(["trash", pathname], { timeoutMs: 5000 })];
                case 5:
                    _c.sent();
                ...
                case 6:
                    _b = _c.sent();
                    runtime.log("Failed to move to Trash (manual delete): ".concat((0, utils_js_1.shortenHomePath)(pathname)));
                    return [3 /*break*/, 7];
...
function handleReset(scope, workspaceDir, runtime) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, moveToTrash(config_js_1.CONFIG_PATH, runtime)];
                case 1:
                    _a.sent();
                    if (scope === "config")
                        return [2 /*return*/];
                    return [4 /*yield*/, moveToTrash(node_path_1.default.join(utils_js_1.CONFIG_DIR, "credentials"), runtime)];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, moveToTrash((0, sessions_js_1.resolveSessionTranscriptsDirForAgent)(), runtime)];
                case 3:
                    _a.sent();
                    if (!(scope === "full")) return [3 /*break*/, 5];
            ...
            switch (_c.label) {
                case 0:
                    ...
                    if (!(node_path_1.default.isAbsolute(resolved) ||
                        resolved.startsWith(".") ||
                        resolved.includes("/") ||
                        resolved.includes("\\"))) return [3 /*break*/, 4];
                    _c.label = 1;
                case 1:
                    _c.trys.push([1, 3, , 4]);
                ...
                case 3:
                    ...
                    return [2 /*return*/, false];
                case 4:
                    command = process.platform === "win32" ? ["where", name] : ["/usr/bin/env", "which", name];
                    _c.label = 5;
                case 5:
                    _c.trys.push([5, 7, , 8]);
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    _d.label = 1;
                case 1:
                    if (!(Date.now() - startedAt < deadlineMs)) return [3 /*break*/, 4];
                    return [4 /*yield*/, probeGatewayReachable({
                            url: params.url,
                            token: params.token,
                            password: params.password,
                ...
                case 3:
                    _d.sent();
                    return [3 /*break*/, 1];
                case 4: return [2 /*return*/, { ok: false, detail: lastDetail }];
            }
        });
    });
}
function summarizeError(err) {
    ...
    var line = (_a = raw
        ...
        .find(Boolean)) !== null && _a !== void 0 ? _a : raw;
