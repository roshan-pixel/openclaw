    ...
    telegram: {
        ...
        config: {
            resolveAllowFrom: function (_a) {
                ...
                return ((_b = (0, accounts_js_5.resolveTelegramAccount)({ cfg: cfg, accountId: accountId }).config.allowFrom) !== null && _b !== void 0 ? _b : []).map(function (entry) {
                    return String(entry);
                });
            },
    ...
    whatsapp: {
        ...
        config: {
            resolveAllowFrom: function (_a) {
                var _b;
                var cfg = _a.cfg, accountId = _a.accountId;
                return (_b = (0, accounts_js_6.resolveWhatsAppAccount)({ cfg: cfg, accountId: accountId }).allowFrom) !== null && _b !== void 0 ? _b : [];
            },
            formatAllowFrom: function (_a) {
                var allowFrom = _a.allowFrom;
                return allowFrom
                    ...
                    .map(function (entry) { return (entry === "*" ? entry : (0, normalize_js_1.normalizeWhatsAppTarget)(entry)); })
                    .filter(function (entry) { return Boolean(entry); });
            },
        },
        groups: {
        ...
        threading: {
            buildToolContext: function (_a) {
                var _b, _c;
                var context = _a.context, hasRepliedRef = _a.hasRepliedRef;
                var channelId = ((_b = context.From) === null || _b === void 0 ? void 0 : _b.trim()) || ((_c = context.To) === null || _c === void 0 ? void 0 : _c.trim()) || undefined;
                return {
    ...
    discord: {
        ...
        elevated: {
            allowFromFallback: function (_a) {
                var _b, _c, _d;
                var cfg = _a.cfg;
                return (_d = (_c = (_b = cfg.channels) === null || _b === void 0 ? void 0 : _b.discord) === null || _c === void 0 ? void 0 : _c.dm) === null || _d === void 0 ? void 0 : _d.allowFrom;
            },
        },
        config: {
            resolveAllowFrom: function (_a) {
                var _b, _c;
                var cfg = _a.cfg, accountId = _a.accountId;
                return ((_c = (_b = (0, accounts_js_1.resolveDiscordAccount)({ cfg: cfg, accountId: accountId }).config.dm) === null || _b === void 0 ? void 0 : _b.allowFrom) !== null && _c !== void 0 ? _c : []).map(function (entry) {
                    return String(entry);
                });
            },
            formatAllowFrom: function (_a) {
    ...
    googlechat: {
        ...
        config: {
            resolveAllowFrom: function (_a) {
                ...
                var account = (_d = (_c = channel === null || channel === void 0 ? void 0 : channel.accounts) === null || _c === void 0 ? void 0 : _c[normalized]) !== null && _d !== void 0 ? _d : (_e = channel === null || channel === void 0 ? void 0 : channel.accounts) === null || _e === void 0 ? void 0 : _e[(_g = Object.keys((_f = channel === null || channel === void 0 ? void 0 : channel.accounts) !== null && _f !== void 0 ? _f : {}).find(function (key) { return key.toLowerCase() === normalized.toLowerCase(); })) !== null && _g !== void 0 ? _g : ""];
                return ((_l = (_j = (_h = account === null || account === void 0 ? void 0 : account.dm) === null || _h === void 0 ? void 0 : _h.allowFrom) !== null && _j !== void 0 ? _j : (_k = channel === null || channel === void 0 ? void 0 : channel.dm) === null || _k === void 0 ? void 0 : _k.allowFrom) !== null && _l !== void 0 ? _l : []).map(function (entry) {
                    return String(entry);
                });
            },
            formatAllowFrom: function (_a) {
    ...
    slack: {
        ...
        config: {
            resolveAllowFrom: function (_a) {
                var _b, _c;
                var cfg = _a.cfg, accountId = _a.accountId;
                return ((_c = (_b = (0, accounts_js_4.resolveSlackAccount)({ cfg: cfg, accountId: accountId }).dm) === null || _b === void 0 ? void 0 : _b.allowFrom) !== null && _c !== void 0 ? _c : []).map(function (entry) { return String(entry); });
            },
            formatAllowFrom: function (_a) {
                var allowFrom = _a.allowFrom;
                return formatLower(allowFrom);
        ...
        threading: {
            resolveReplyToMode: function (_a) {
                ...
                return (0, accounts_js_4.resolveSlackReplyToMode)((0, accounts_js_4.resolveSlackAccount)({ cfg: cfg, accountId: accountId }), chatType);
            },
            allowTagsWhenOff: true,
            buildToolContext: function (params) { return (0, threading_tool_context_js_1.buildSlackThreadingToolContext)(params); },
        },
    },
    signal: {
        id: "signal",
        ...
        config: {
            resolveAllowFrom: function (_a) {
                var _b;
                var cfg = _a.cfg, accountId = _a.accountId;
                return ((_b = (0, accounts_js_3.resolveSignalAccount)({ cfg: cfg, accountId: accountId }).config.allowFrom) !== null && _b !== void 0 ? _b : []).map(function (entry) {
                    return String(entry);
                });
            },
            formatAllowFrom: function (_a) {
                ...
                return allowFrom
                    .map(function (entry) { return String(entry).trim(); })
                    .filter(Boolean)
                    .map(function (entry) { return (entry === "*" ? "*" : (0, utils_js_1.normalizeE164)(entry.replace(/^signal:/i, ""))); })
                    .filter(Boolean);
            },
        },
        threading: {
            buildToolContext: function (_a) {
                var _b, _c, _d;
                var context = _a.context, hasRepliedRef = _a.hasRepliedRef;
                var isDirect = ((_b = context.ChatType) === null || _b === void 0 ? void 0 : _b.toLowerCase()) === "direct";
                var channelId = ((_d = (isDirect ? ((_c = context.From) !== null && _c !== void 0 ? _c : context.To) : context.To)) === null || _d === void 0 ? void 0 : _d.trim()) || undefined;
                return {
                    currentChannelId: channelId,
                    currentThreadTs: context.ReplyToId,
                    hasRepliedRef: hasRepliedRef,
    ...
    imessage: {
        ...
        config: {
            resolveAllowFrom: function (_a) {
                var _b;
                var cfg = _a.cfg, accountId = _a.accountId;
                return ((_b = (0, accounts_js_2.resolveIMessageAccount)({ cfg: cfg, accountId: accountId }).config.allowFrom) !== null && _b !== void 0 ? _b : []).map(function (entry) {
                    return String(entry);
                });
            },
            formatAllowFrom: function (_a) {
...
function listChannelDocks() {
    var baseEntries = registry_js_1.CHAT_CHANNEL_ORDER.map(function (id) { return ({
        id: id,
        dock: DOCKS[id],
    ...
    return combined.map(function (entry) { return entry.dock; });
}
function getChannelDock(id) {
    ...
    if (core)
        return core;
    var registry = (0, runtime_js_1.requireActivePluginRegistry)();
    var pluginEntry = registry.channels.find(function (entry) { return entry.plugin.id === id; });
    if (!pluginEntry)
        return undefined;
    return (_a = pluginEntry.dock) !== null && _a !== void 0 ? _a : buildDockFromPlugin(pluginEntry.plugin);
}
