...
exports.CHAT_CHANNEL_ALIASES = exports.DEFAULT_CHAT_CHANNEL = exports.CHANNEL_IDS = exports.CHAT_CHANNEL_ORDER = void 0;
...
function listChatChannels() {
    return exports.CHAT_CHANNEL_ORDER.map(function (id) { return CHAT_CHANNEL_META[id]; });
}
...
function normalizeChatChannelId(raw) {
    ...
    if (!normalized)
        return null;
    var resolved = (_a = exports.CHAT_CHANNEL_ALIASES[normalized]) !== null && _a !== void 0 ? _a : normalized;
    return exports.CHAT_CHANNEL_ORDER.includes(resolved)
        ? resolved
        : null;
}
...
function normalizeAnyChannelId(raw) {
    ...
    var hit = registry.channels.find(function (entry) {
        ...
        if (id && id === key)
            return true;
        return ((_b = entry.plugin.meta.aliases) !== null && _b !== void 0 ? _b : []).some(function (alias) { return alias.trim().toLowerCase() === key; });
    });
    return (_a = hit === null || hit === void 0 ? void 0 : hit.plugin.id) !== null && _a !== void 0 ? _a : null;
}
...
function formatChannelSelectionLine(meta, docsLink) {
    ...
    var extras = ((_c = meta.selectionExtras) !== null && _c !== void 0 ? _c : []).filter(Boolean).join(" ");
    return "".concat(meta.label, " \u2014 ").concat(meta.blurb, " ").concat(docsPrefix ? "".concat(docsPrefix, " ") : "").concat(docs).concat(extras ? " ".concat(extras) : "");
}
