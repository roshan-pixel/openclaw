...
function resolveConversationLabel(ctx) {
    ...
    if (chatType === "direct") {
        return ((_c = ctx.SenderName) === null || _c === void 0 ? void 0 : _c.trim()) || ((_d = ctx.From) === null || _d === void 0 ? void 0 : _d.trim()) || undefined;
    }
    var base = ((_e = ctx.GroupChannel) === null || _e === void 0 ? void 0 : _e.trim()) ||
