...
function parseTelegramGroupId(value) {
    var _a;
    var raw = (_a = value === null || value === void 0 ? void 0 : value.trim()) !== null && _a !== void 0 ? _a : "";
    if (!raw)
...
function resolveTelegramRequireMention(params) {
    ...
    var cfg = params.cfg, chatId = params.chatId, topicId = params.topicId;
    if (!chatId)
        return undefined;
    var groupConfig = (_c = (_b = (_a = cfg.channels) === null || _a === void 0 ? void 0 : _a.telegram) === null || _b === void 0 ? void 0 : _b.groups) === null || _c === void 0 ? void 0 : _c[chatId];
    var groupDefault = (_f = (_e = (_d = cfg.channels) === null || _d === void 0 ? void 0 : _d.telegram) === null || _e === void 0 ? void 0 : _e.groups) === null || _f === void 0 ? void 0 : _f["*"];
    var topicConfig = topicId && (groupConfig === null || groupConfig === void 0 ? void 0 : groupConfig.topics) ? groupConfig.topics[topicId] : undefined;
    var defaultTopicConfig = topicId && (groupDefault === null || groupDefault === void 0 ? void 0 : groupDefault.topics) ? groupDefault.topics[topicId] : undefined;
    if (typeof (topicConfig === null || topicConfig === void 0 ? void 0 : topicConfig.requireMention) === "boolean") {
        return topicConfig.requireMention;
    }
    if (typeof (defaultTopicConfig === null || defaultTopicConfig === void 0 ? void 0 : defaultTopicConfig.requireMention) === "boolean") {
        return defaultTopicConfig.requireMention;
    }
    if (typeof (groupConfig === null || groupConfig === void 0 ? void 0 : groupConfig.requireMention) === "boolean") {
        return groupConfig.requireMention;
    }
    if (typeof (groupDefault === null || groupDefault === void 0 ? void 0 : groupDefault.requireMention) === "boolean") {
...
function resolveDiscordGuildEntry(guilds, groupSpace) {
    ...
    if (!guilds || Object.keys(guilds).length === 0)
        return null;
    var space = (_a = groupSpace === null || groupSpace === void 0 ? void 0 : groupSpace.trim()) !== null && _a !== void 0 ? _a : "";
    ...
    if (normalized) {
        var match = Object.values(guilds).find(function (entry) { var _a; return normalizeDiscordSlug((_a = entry === null || entry === void 0 ? void 0 : entry.slug) !== null && _a !== void 0 ? _a : undefined) === normalized; });
        if (match)
            return match;
    }
...
function resolveTelegramGroupRequireMention(params) {
    var _a = parseTelegramGroupId(params.groupId), chatId = _a.chatId, topicId = _a.topicId;
...
function resolveDiscordGroupRequireMention(params) {
    var _a, _b, _c, _d, _e;
    var guildEntry = resolveDiscordGuildEntry((_b = (_a = params.cfg.channels) === null || _a === void 0 ? void 0 : _a.discord) === null || _b === void 0 ? void 0 : _b.guilds, params.groupSpace);
    ...
    if (channelEntries && Object.keys(channelEntries).length > 0) {
        ...
        var entry = (_e = (_c = (params.groupId ? channelEntries[params.groupId] : undefined)) !== null && _c !== void 0 ? _c : (channelSlug
            ? ((_d = channelEntries[channelSlug]) !== null && _d !== void 0 ? _d : channelEntries["#".concat(channelSlug)])
            : undefined)) !== null && _e !== void 0 ? _e : (groupChannel ? channelEntries[normalizeDiscordSlug(groupChannel)] : undefined);
        if (entry && typeof entry.requireMention === "boolean") {
            return entry.requireMention;
        }
    }
    if (typeof (guildEntry === null || guildEntry === void 0 ? void 0 : guildEntry.requireMention) === "boolean") {
...
function resolveSlackGroupRequireMention(params) {
    ...
    var groupChannel = params.groupChannel;
    var channelName = groupChannel === null || groupChannel === void 0 ? void 0 : groupChannel.replace(/^#/, "");
    ...
    if (typeof (resolved === null || resolved === void 0 ? void 0 : resolved.requireMention) === "boolean") {
