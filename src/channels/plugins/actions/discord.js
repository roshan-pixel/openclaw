...
exports.discordMessageActions = {
    listActions: function (_a) {
        var _b, _c;
        var cfg = _a.cfg;
        var accounts = (0, accounts_js_1.listEnabledDiscordAccounts)(cfg).filter(function (account) { return account.tokenSource !== "none"; });
        if (accounts.length === 0)
            return [];
        var gate = (0, common_js_1.createActionGate)((_c = (_b = cfg.channels) === null || _b === void 0 ? void 0 : _b.discord) === null || _c === void 0 ? void 0 : _c.actions);
    ...
    handleAction: function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, (0, handle_action_js_1.handleDiscordMessageAction)({ action: action, params: params, cfg: cfg, accountId: accountId })];
