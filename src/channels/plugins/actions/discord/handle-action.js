...
function handleDiscordMessageAction(ctx) {
    return __awaiter(this, void 0, void 0, function () {
        var action, params, cfg, accountId, resolveChannelId, to, content, mediaUrl, replyTo, embeds, to, question, answers, allowMultiselect, durationHours, messageId, emoji, remove, messageId, limit, limit, messageId, content, messageId, messageId, name_1, messageId, autoArchiveMinutes, stickerIds, adminResult;
        var _a, _b, _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    action = ctx.action, params = ctx.params, cfg = ctx.cfg;
                    accountId = (_a = ctx.accountId) !== null && _a !== void 0 ? _a : (0, common_js_1.readStringParam)(params, "accountId");
                    resolveChannelId = function () {
                        var _a;
                        return (0, targets_js_1.resolveDiscordChannelId)((_a = (0, common_js_1.readStringParam)(params, "channelId")) !== null && _a !== void 0 ? _a : (0, common_js_1.readStringParam)(params, "to", { required: true }));
                    };
                ...
                case 2:
                    if (!(action === "poll")) return [3 /*break*/, 4];
                    to = (0, common_js_1.readStringParam)(params, "to", { required: true });
                    question = (0, common_js_1.readStringParam)(params, "pollQuestion", {
                        required: true,
                    });
                    answers = (_b = (0, common_js_1.readStringArrayParam)(params, "pollOption", { required: true })) !== null && _b !== void 0 ? _b : [];
                ...
                case 4:
                    if (!(action === "react")) return [3 /*break*/, 6];
                ...
                case 6:
                    if (!(action === "reactions")) return [3 /*break*/, 8];
                    messageId = (0, common_js_1.readStringParam)(params, "messageId", { required: true });
                ...
                case 8:
                    if (!(action === "read")) return [3 /*break*/, 10];
                    limit = (0, common_js_1.readNumberParam)(params, "limit", { integer: true });
                    return [4 /*yield*/, (0, discord_actions_js_1.handleDiscordAction)({
                            action: "readMessages",
                            accountId: accountId !== null && accountId !== void 0 ? accountId : undefined,
                ...
                case 10:
                    if (!(action === "edit")) return [3 /*break*/, 12];
                    messageId = (0, common_js_1.readStringParam)(params, "messageId", { required: true });
                ...
                case 12:
                    if (!(action === "delete")) return [3 /*break*/, 14];
                    messageId = (0, common_js_1.readStringParam)(params, "messageId", { required: true });
                    return [4 /*yield*/, (0, discord_actions_js_1.handleDiscordAction)({
                ...
                case 14:
                    if (!(action === "pin" || action === "unpin" || action === "list-pins")) return [3 /*break*/, 16];
                    messageId = action === "list-pins" ? undefined : (0, common_js_1.readStringParam)(params, "messageId", { required: true });
                    return [4 /*yield*/, (0, discord_actions_js_1.handleDiscordAction)({
                ...
                case 16:
                    if (!(action === "permissions")) return [3 /*break*/, 18];
                    return [4 /*yield*/, (0, discord_actions_js_1.handleDiscordAction)({
                            action: "permissions",
                            accountId: accountId !== null && accountId !== void 0 ? accountId : undefined,
                            channelId: resolveChannelId(),
                ...
                case 18:
                    if (!(action === "thread-create")) return [3 /*break*/, 20];
                ...
                case 20:
                    if (!(action === "sticker")) return [3 /*break*/, 22];
                    stickerIds = (_c = (0, common_js_1.readStringArrayParam)(params, "stickerId", {
                        required: true,
                        label: "sticker-id",
                    })) !== null && _c !== void 0 ? _c : [];
                    return [4 /*yield*/, (0, discord_actions_js_1.handleDiscordAction)({
                ...
                case 22: return [4 /*yield*/, (0, handle_action_guild_admin_js_1.tryHandleDiscordMessageActionGuildAdmin)({
                        ctx: ctx,
                ...
                case 23:
                    ...
                    throw new Error("Action ".concat(String(action), " is not supported for provider ").concat(providerId, "."));
            }
        });
    });
}
