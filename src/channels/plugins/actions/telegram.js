...
function readTelegramSendParams(params) {
    ...
    var message = (0, common_js_1.readStringParam)(params, "message", { required: !mediaUrl, allowEmpty: true });
...
exports.telegramMessageActions = {
    listActions: function (_a) {
        var _b, _c;
        var cfg = _a.cfg;
        var accounts = (0, accounts_js_1.listEnabledTelegramAccounts)(cfg).filter(function (account) { return account.tokenSource !== "none"; });
        if (accounts.length === 0)
            return [];
        var gate = (0, common_js_1.createActionGate)((_c = (_b = cfg.channels) === null || _b === void 0 ? void 0 : _b.telegram) === null || _c === void 0 ? void 0 : _c.actions);
    ...
    supportsButtons: function (_a) {
        ...
        return accounts.some(function (account) {
            return (0, inline_buttons_js_1.isTelegramInlineButtonsEnabled)({ cfg: cfg, accountId: account.accountId });
        });
    },
    ...
    handleAction: function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var sendParams, messageId, emoji, remove, chatId, messageId, chatId, messageId, message, buttons, to, stickerIds, fileId, replyToMessageId, messageThreadId, query, limit;
        ...
        return __generator(this, function (_l) {
            switch (_l.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, telegram_actions_js_1.handleTelegramAction)(__assign(__assign({ action: "sendMessage" }, sendParams), { accountId: accountId !== null && accountId !== void 0 ? accountId : undefined }), cfg)];
                ...
                case 2:
                    ...
                    return [4 /*yield*/, (0, telegram_actions_js_1.handleTelegramAction)({
                            action: "react",
                            chatId: (_d = (_c = (0, common_js_1.readStringOrNumberParam)(params, "chatId")) !== null && _c !== void 0 ? _c : (0, common_js_1.readStringOrNumberParam)(params, "channelId")) !== null && _d !== void 0 ? _d : (0, common_js_1.readStringParam)(params, "to", { required: true }),
                            messageId: messageId,
                            emoji: emoji,
                            remove: remove,
                ...
                case 4:
                    ...
                    chatId = (_f = (_e = (0, common_js_1.readStringOrNumberParam)(params, "chatId")) !== null && _e !== void 0 ? _e : (0, common_js_1.readStringOrNumberParam)(params, "channelId")) !== null && _f !== void 0 ? _f : (0, common_js_1.readStringParam)(params, "to", { required: true });
                ...
                case 6:
                    if (!(action === "edit")) return [3 /*break*/, 8];
                    chatId = (_h = (_g = (0, common_js_1.readStringOrNumberParam)(params, "chatId")) !== null && _g !== void 0 ? _g : (0, common_js_1.readStringOrNumberParam)(params, "channelId")) !== null && _h !== void 0 ? _h : (0, common_js_1.readStringParam)(params, "to", { required: true });
                    messageId = (0, common_js_1.readNumberParam)(params, "messageId", {
                        required: true,
                        integer: true,
                    });
                    message = (0, common_js_1.readStringParam)(params, "message", { required: true, allowEmpty: false });
                ...
                case 8:
                    if (!(action === "sticker")) return [3 /*break*/, 10];
                    to = (_j = (0, common_js_1.readStringParam)(params, "to")) !== null && _j !== void 0 ? _j : (0, common_js_1.readStringParam)(params, "target", { required: true });
                    stickerIds = (0, common_js_1.readStringArrayParam)(params, "stickerId");
                    fileId = (_k = stickerIds === null || stickerIds === void 0 ? void 0 : stickerIds[0]) !== null && _k !== void 0 ? _k : (0, common_js_1.readStringParam)(params, "fileId", { required: true });
                    replyToMessageId = (0, common_js_1.readNumberParam)(params, "replyTo", { integer: true });
                    messageThreadId = (0, common_js_1.readNumberParam)(params, "threadId", { integer: true });
                    return [4 /*yield*/, (0, telegram_actions_js_1.handleTelegramAction)({
                            action: "sendSticker",
                            to: to,
                            fileId: fileId,
                            replyToMessageId: replyToMessageId !== null && replyToMessageId !== void 0 ? replyToMessageId : undefined,
                            messageThreadId: messageThreadId !== null && messageThreadId !== void 0 ? messageThreadId : undefined,
                            accountId: accountId !== null && accountId !== void 0 ? accountId : undefined,
                        }, cfg)];
                case 9: return [2 /*return*/, _l.sent()];
                case 10:
                    if (!(action === "sticker-search")) return [3 /*break*/, 12];
                ...
                case 12: throw new Error("Action ".concat(action, " is not supported for provider ").concat(providerId, "."));
            }
        });
    }); },
};
