...
exports.signalMessageActions = {
    listActions: function (_a) {
        ...
        if (accounts.length === 0)
            return [];
        var configuredAccounts = accounts.filter(function (account) { return account.configured; });
    ...
    handleAction: function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var reactionLevelInfo, actionConfig, isActionEnabled, recipientRaw, target, messageId, targetAuthor, targetAuthorUuid, emoji, remove, timestamp;
        var _c, _d, _e;
            ...
            switch (_f.label) {
                case 0:
                    ...
                    if (!reactionLevelInfo.agentReactionsEnabled) {
                        throw new Error("Signal agent reactions disabled (reactionLevel=\"".concat(reactionLevelInfo.level, "\"). ") +
                            "Set channels.signal.reactionLevel to \"minimal\" or \"extensive\" to enable.");
                    }
                    actionConfig = (0, accounts_js_1.resolveSignalAccount)({ cfg: cfg, accountId: accountId }).config.actions;
                    ...
                    recipientRaw = (_c = (0, common_js_1.readStringParam)(params, "recipient")) !== null && _c !== void 0 ? _c : (0, common_js_1.readStringParam)(params, "to", {
                        required: true,
                    ...
                    if (!Number.isFinite(timestamp)) {
                        throw new Error("Invalid messageId: ".concat(messageId, ". Expected numeric timestamp."));
                    }
                    if (!remove) return [3 /*break*/, 2];
                    if (!emoji)
                        throw new Error("Emoji required to remove reaction.");
                    return [4 /*yield*/, (0, send_reactions_js_1.removeReactionSignal)((_d = target.recipient) !== null && _d !== void 0 ? _d : "", timestamp, emoji, {
                            accountId: accountId !== null && accountId !== void 0 ? accountId : undefined,
                ...
                case 2:
                    ...
                    return [4 /*yield*/, (0, send_reactions_js_1.sendReactionSignal)((_e = target.recipient) !== null && _e !== void 0 ? _e : "", timestamp, emoji, {
                            accountId: accountId !== null && accountId !== void 0 ? accountId : undefined,
                            groupId: target.groupId,
                            targetAuthor: targetAuthor,
                            targetAuthorUuid: targetAuthorUuid,
                ...
                case 4: throw new Error("Action ".concat(action, " not supported for ").concat(providerId, "."));
            }
        });
    }); },
};
