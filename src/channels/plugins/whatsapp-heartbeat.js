...
function getSessionRecipients(cfg) {
    ...
    var isCronKey = function (key) { return key.startsWith("cron:"); };
    var recipients = Object.entries(store)
        ...
        return ({
            to: (0, registry_js_1.normalizeChatChannelId)(entry === null || entry === void 0 ? void 0 : entry.lastChannel) === "whatsapp" && (entry === null || entry === void 0 ? void 0 : entry.lastTo)
                ? (0, utils_js_1.normalizeE164)(entry.lastTo)
                : "",
            updatedAt: (_b = entry === null || entry === void 0 ? void 0 : entry.updatedAt) !== null && _b !== void 0 ? _b : 0,
        });
    })
        .filter(function (_a) {
        var to = _a.to;
...
function resolveWhatsAppHeartbeatRecipients(cfg, opts) {
    ...
    var allowFrom = Array.isArray((_b = (_a = cfg.channels) === null || _a === void 0 ? void 0 : _a.whatsapp) === null || _b === void 0 ? void 0 : _b.allowFrom) && cfg.channels.whatsapp.allowFrom.length > 0
        ? cfg.channels.whatsapp.allowFrom.filter(function (v) { return v !== "*"; }).map(utils_js_1.normalizeE164)
        : [];
    var unique = function (list) { return __spreadArray([], new Set(list.filter(Boolean)), true); };
    if (opts.all) {
        var all = unique(__spreadArray(__spreadArray([], sessionRecipients.map(function (s) { return s.to; }), true), allowFrom, true));
    ...
    if (sessionRecipients.length > 1) {
        return {
            recipients: sessionRecipients.map(function (s) { return s.to; }),
