...
function resolveAccountConfig(accounts, accountId) {
    ...
    var matchKey = Object.keys(accounts).find(function (key) { return key.toLowerCase() === accountId.toLowerCase(); });
...
function resolveChannelConfigWrites(params) {
    ...
    var channelConfig = channels === null || channels === void 0 ? void 0 : channels[params.channelId];
    if (!channelConfig)
        return true;
    ...
    var value = (_a = accountConfig === null || accountConfig === void 0 ? void 0 : accountConfig.configWrites) !== null && _a !== void 0 ? _a : channelConfig.configWrites;
    return value !== false;
}
