...
function listChannelMessageActions(cfg) {
    ...
    for (var _i = 0, _c = (0, index_js_1.listChannelPlugins)(); _i < _c.length; _i++) {
        var plugin = _c[_i];
        var list = (_b = (_a = plugin.actions) === null || _a === void 0 ? void 0 : _a.listActions) === null || _b === void 0 ? void 0 : _b.call(_a, { cfg: cfg });
        if (!list)
            continue;
...
function supportsChannelMessageButtons(cfg) {
    ...
    for (var _i = 0, _c = (0, index_js_1.listChannelPlugins)(); _i < _c.length; _i++) {
        var plugin = _c[_i];
        if ((_b = (_a = plugin.actions) === null || _a === void 0 ? void 0 : _a.supportsButtons) === null || _b === void 0 ? void 0 : _b.call(_a, { cfg: cfg }))
            return true;
    }
    return false;
}
function supportsChannelMessageCards(cfg) {
    ...
    for (var _i = 0, _c = (0, index_js_1.listChannelPlugins)(); _i < _c.length; _i++) {
        var plugin = _c[_i];
        if ((_b = (_a = plugin.actions) === null || _a === void 0 ? void 0 : _a.supportsCards) === null || _b === void 0 ? void 0 : _b.call(_a, { cfg: cfg }))
            return true;
    }
    return false;
}
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    if (!((_a = plugin === null || plugin === void 0 ? void 0 : plugin.actions) === null || _a === void 0 ? void 0 : _a.handleAction))
