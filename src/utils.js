...
function ensureDir(dir) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, node_fs_1.default.promises.mkdir(dir, { recursive: true })];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
function resolveLidMappingDirs(opts) {
    ...
    for (var _i = 0, _b = (_a = opts === null || opts === void 0 ? void 0 : opts.lidMappingDirs) !== null && _a !== void 0 ? _a : []; _i < _b.length; _i++) {
        var dir = _b[_i];
        addDir(dir);
    }
...
function jidToE164(jid, opts) {
    ...
    if (lidMatch) {
        ...
        if (phone)
            return phone;
        var shouldLog = (_a = opts === null || opts === void 0 ? void 0 : opts.logMissing) !== null && _a !== void 0 ? _a : (0, globals_js_1.shouldLogVerbose)();
        if (shouldLog) {
            (0, globals_js_1.logVerbose)("LID mapping not found for ".concat(lid, "; skipping inbound message"));
        }
    }
    return null;
}
            ...
            switch (_b.label) {
                case 0:
                    ...
                    if (!/(@lid|@hosted\.lid)$/.test(jid))
                        return [2 /*return*/, null];
                    if (!((_a = opts === null || opts === void 0 ? void 0 : opts.lidLookup) === null || _a === void 0 ? void 0 : _a.getPNForLID))
                        return [2 /*return*/, null];
                    _b.label = 1;
                case 1:
                    _b.trys.push([1, 3, , 4]);
                ...
                case 3:
                    ...
                    if ((0, globals_js_1.shouldLogVerbose)()) {
                        (0, globals_js_1.logVerbose)("LID mapping lookup failed for ".concat(jid, ": ").concat(String(err_1)));
                    }
                    return [2 /*return*/, null];
...
function formatTerminalLink(label, url, opts) {
    ...
    var allow = (opts === null || opts === void 0 ? void 0 : opts.force) === true ? true : (opts === null || opts === void 0 ? void 0 : opts.force) === false ? false : Boolean(process.stdout.isTTY);
    if (!allow) {
        return (_a = opts === null || opts === void 0 ? void 0 : opts.fallback) !== null && _a !== void 0 ? _a : "".concat(safeLabel, " (").concat(safeUrl, ")");
    }
