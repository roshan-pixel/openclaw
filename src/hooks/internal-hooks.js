        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    specificHandlers = (_b = handlers.get("".concat(event.type, ":").concat(event.action))) !== null && _b !== void 0 ? _b : [];
                    allHandlers = __spreadArray(__spreadArray([], typeHandlers, true), specificHandlers, true);
                    ...
                    _c.label = 1;
                case 1:
                    if (!(_i < allHandlers_1.length)) return [3 /*break*/, 6];
                ...
                case 4:
                    err_1 = _c.sent();
                    console.error("Hook error [".concat(event.type, ":").concat(event.action, "]:"), err_1 instanceof Error ? err_1.message : String(err_1));
                    return [3 /*break*/, 5];
                case 5:
                    _i++;
                    return [3 /*break*/, 1];
