...
function buildQueueSummaryPrompt(params) {
    ...
    var title = (_a = params.title) !== null && _a !== void 0 ? _a : "[Queue overflow] Dropped ".concat(params.state.droppedCount, " ").concat(noun).concat(params.state.droppedCount === 1 ? "" : "s", " due to cap.");
    var lines = [title];
