...
function parseInlineDirectives(text, options) {
    ...
    var currentMessageId = options.currentMessageId, _a = options.stripAudioTag, stripAudioTag = _a === void 0 ? true : _a, _b = options.stripReplyTags, stripReplyTags = _b === void 0 ? true : _b;
    if (!text) {
        return {
            text: "",
            audioAsVoice: false,
    ...
    var replyToId = lastExplicitId !== null && lastExplicitId !== void 0 ? lastExplicitId : (sawCurrent ? (currentMessageId === null || currentMessageId === void 0 ? void 0 : currentMessageId.trim()) || undefined : undefined);
    return {
        text: cleaned,
