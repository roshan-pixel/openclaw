...
function resolveModelCostConfig(params) {
    ...
    if (!provider || !model)
        return undefined;
    var providers = (_e = (_d = (_c = params.config) === null || _c === void 0 ? void 0 : _c.models) === null || _d === void 0 ? void 0 : _d.providers) !== null && _e !== void 0 ? _e : {};
    var entry = (_g = (_f = providers[provider]) === null || _f === void 0 ? void 0 : _f.models) === null || _g === void 0 ? void 0 : _g.find(function (item) { return item.id === model; });
