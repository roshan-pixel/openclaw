...
function listGuilds(token, fetcher) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, api_js_1.fetchDiscord)("/users/@me/guilds", token, fetcher)];
                case 1:
                    raw = _a.sent();
                    return [2 /*return*/, raw.map(function (guild) { return ({
                            id: guild.id,
                            name: guild.name,
...
function listGuildChannels(token, fetcher, guildId) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, api_js_1.fetchDiscord)("/guilds/".concat(guildId, "/channels"), token, fetcher)];
                case 1:
                    raw = (_a.sent());
                    return [2 /*return*/, raw
                            .filter(function (channel) { return Boolean(channel.id) && "name" in channel; })
                            .map(function (channel) {
                            var _a, _b;
                            var archived = "thread_metadata" in channel
                                ? (_a = channel.thread_metadata) === null || _a === void 0 ? void 0 : _a.archived
                                : undefined;
                            return {
                                id: channel.id,
                                name: "name" in channel ? ((_b = channel.name) !== null && _b !== void 0 ? _b : "") : "",
                                guildId: guildId,
                                type: channel.type,
                                archived: archived,
                            };
                        })
                            .filter(function (channel) { return Boolean(channel.name); })];
            }
        });
    });
}
function fetchChannel(token, fetcher, channelId) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, (0, api_js_1.fetchDiscord)("/channels/".concat(channelId), token, fetcher)];
                case 1:
                    raw = (_c.sent());
...
function preferActiveMatch(candidates) {
    ...
    return (_b = (_a = scored[0]) === null || _a === void 0 ? void 0 : _a.channel) !== null && _b !== void 0 ? _b : candidates[0];
}
function resolveGuildByName(guilds, input) {
    var slug = (0, allow_list_js_1.normalizeDiscordSlug)(input);
    if (!slug)
        return undefined;
    return guilds.find(function (guild) { return guild.slug === slug; });
}
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    if (!token)
                        return [2 /*return*/, params.entries.map(function (input) { return ({
                                input: input,
                                resolved: false,
                            }); })];
                ...
                case 1:
                    ...
                    _loop_1 = function (input) {
                        var parsed, guild, channel_1, guild, guild, channelQuery_1, channels, matches, match_1, channelName, candidates, _e, guilds_1, guild, channels, _f, channels_1, channel, match, guild;
                        return __generator(this, function (_g) {
                            switch (_g.label) {
                                case 0:
                                    parsed = parseDiscordChannelInput(input);
                                    if (parsed.guildOnly) {
                                        guild = parsed.guildId && guilds.find(function (entry) { return entry.id === parsed.guildId; })
                                            ? guilds.find(function (entry) { return entry.id === parsed.guildId; })
                                            : parsed.guild
                                ...
                                case 1:
                                    ...
                                    return [2 /*return*/, "continue"];
                                case 2:
                                    if (!(parsed.guildId || parsed.guild)) return [3 /*break*/, 4];
                                    guild = parsed.guildId && guilds.find(function (entry) { return entry.id === parsed.guildId; })
                                        ? guilds.find(function (entry) { return entry.id === parsed.guildId; })
                                        : parsed.guild
                                            ? resolveGuildByName(guilds, parsed.guild)
                                            : undefined;
                                    channelQuery_1 = (_c = parsed.channel) === null || _c === void 0 ? void 0 : _c.trim();
                                    if (!guild || !channelQuery_1) {
                                        results.push({
                                            ...
                                            guildId: parsed.guildId,
                                            guildName: parsed.guild,
                                            channelName: channelQuery_1 !== null && channelQuery_1 !== void 0 ? channelQuery_1 : parsed.channel,
                                        });
                                        return [2 /*return*/, "continue"];
                                    }
                                ...
                                case 3:
                                    channels = _g.sent();
                                    matches = channels.filter(function (channel) { return (0, allow_list_js_1.normalizeDiscordSlug)(channel.name) === (0, allow_list_js_1.normalizeDiscordSlug)(channelQuery_1); });
                                ...
                                case 4:
                                    ...
                                    _g.label = 5;
                                case 5:
                                    if (!(_e < guilds_1.length)) return [3 /*break*/, 8];
                                    guild = guilds_1[_e];
                                    return [4 /*yield*/, getChannels(guild.id)];
                                case 6:
                                    channels = _g.sent();
                                    for (_f = 0, channels_1 = channels; _f < channels_1.length; _f++) {
                                        ...
                                        if ((0, allow_list_js_1.normalizeDiscordSlug)(channel.name) === (0, allow_list_js_1.normalizeDiscordSlug)(channelName)) {
                                ...
                                case 8:
                                    ...
                                    if (match) {
                                        guild = guilds.find(function (entry) { return entry.id === match.guildId; });
                                        results.push({
                                            input: input,
                                            resolved: true,
                                            ...
                                            note: candidates.length > 1 && (guild === null || guild === void 0 ? void 0 : guild.name)
