...
function isThreadChannelType(channelType) {
    return (channelType === v10_1.ChannelType.GuildNewsThread ||
...
function fetchBotUserId(rest) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, rest.get(v10_1.Routes.user("@me"))];
                case 1:
                    me = (_a.sent());
...
function fetchChannelPermissionsDiscord(channelId_1) {
    return __awaiter(this, arguments, void 0, function (channelId, opts) {
        var rest, channel, channelType, guildId, botId, _a, guild, member, rolesById, everyoneRole, base, _i, _b, roleId, role, permissions, overwrites, _c, overwrites_1, overwrite, _d, overwrites_2, overwrite, _e, overwrites_3, overwrite;
        ...
        return __generator(this, function (_r) {
            switch (_r.label) {
                ...
                case 3:
                    ...
                    rolesById = new Map(((_f = guild.roles) !== null && _f !== void 0 ? _f : []).map(function (role) { return [role.id, role]; }));
                    everyoneRole = rolesById.get(guildId);
                    base = 0n;
                    if (everyoneRole === null || everyoneRole === void 0 ? void 0 : everyoneRole.permissions) {
                        base = addPermissionBits(base, everyoneRole.permissions);
                    }
                    for (_i = 0, _b = (_g = member.roles) !== null && _g !== void 0 ? _g : []; _i < _b.length; _i++) {
                        roleId = _b[_i];
                    ...
                    permissions = base;
                    overwrites = "permission_overwrites" in channel ? ((_h = channel.permission_overwrites) !== null && _h !== void 0 ? _h : []) : [];
                    for (_c = 0, overwrites_1 = overwrites; _c < overwrites_1.length; _c++) {
                        overwrite = overwrites_1[_c];
                        if (overwrite.id === guildId) {
                            permissions = removePermissionBits(permissions, (_j = overwrite.deny) !== null && _j !== void 0 ? _j : "0");
                            permissions = addPermissionBits(permissions, (_k = overwrite.allow) !== null && _k !== void 0 ? _k : "0");
                        }
                    }
                    for (_d = 0, overwrites_2 = overwrites; _d < overwrites_2.length; _d++) {
                        overwrite = overwrites_2[_d];
                        if ((_l = member.roles) === null || _l === void 0 ? void 0 : _l.includes(overwrite.id)) {
                            permissions = removePermissionBits(permissions, (_m = overwrite.deny) !== null && _m !== void 0 ? _m : "0");
                            permissions = addPermissionBits(permissions, (_o = overwrite.allow) !== null && _o !== void 0 ? _o : "0");
                        }
                    }
                    for (_e = 0, overwrites_3 = overwrites; _e < overwrites_3.length; _e++) {
                        overwrite = overwrites_3[_e];
                        if (overwrite.id === botId) {
                            permissions = removePermissionBits(permissions, (_p = overwrite.deny) !== null && _p !== void 0 ? _p : "0");
                            permissions = addPermissionBits(permissions, (_q = overwrite.allow) !== null && _q !== void 0 ? _q : "0");
                        }
                    }
                    return [2 /*return*/, {
                            channelId: channelId,
