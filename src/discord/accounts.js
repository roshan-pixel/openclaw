...
function listConfiguredAccountIds(cfg) {
    var _a, _b;
    var accounts = (_b = (_a = cfg.channels) === null || _a === void 0 ? void 0 : _a.discord) === null || _b === void 0 ? void 0 : _b.accounts;
...
function mergeDiscordAccountConfig(cfg, accountId) {
    var _a, _b, _c;
    var _d = ((_b = (_a = cfg.channels) === null || _a === void 0 ? void 0 : _a.discord) !== null && _b !== void 0 ? _b : {}), _ignored = _d.accounts, base = __rest(_d, ["accounts"]);
...
function resolveDiscordAccount(params) {
    ...
    var baseEnabled = ((_b = (_a = params.cfg.channels) === null || _a === void 0 ? void 0 : _a.discord) === null || _b === void 0 ? void 0 : _b.enabled) !== false;
...
function listEnabledDiscordAccounts(cfg) {
    return listDiscordAccountIds(cfg)
        .map(function (accountId) { return resolveDiscordAccount({ cfg: cfg, accountId: accountId }); })
