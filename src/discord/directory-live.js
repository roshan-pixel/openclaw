...
function listDiscordDirectoryGroupsLive(params) {
    return __awaiter(this, void 0, void 0, function () {
        var account, token, query, guilds, rows, _i, guilds_1, guild, channels, _a, channels_1, channel, name_1;
        var _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    _c.label = 2;
                case 2:
                    if (!(_i < guilds_1.length)) return [3 /*break*/, 5];
                    guild = guilds_1[_i];
                    return [4 /*yield*/, (0, api_js_1.fetchDiscord)("/guilds/".concat(guild.id, "/channels"), token)];
                case 3:
                    channels = _c.sent();
                    for (_a = 0, channels_1 = channels; _a < channels_1.length; _a++) {
                        ...
                        if (!name_1)
                            continue;
                        if (query && !(0, allow_list_js_1.normalizeDiscordSlug)(name_1).includes((0, allow_list_js_1.normalizeDiscordSlug)(query)))
                            continue;
                        rows.push({
                            kind: "group",
...
function listDiscordDirectoryPeersLive(params) {
    return __awaiter(this, void 0, void 0, function () {
        var account, token, query, guilds, rows, limit, _i, guilds_2, guild, paramsObj, members, _a, members_1, member, user, name_2;
        var _b, _c, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 1:
                    ...
                    _e.label = 2;
                case 2:
                    if (!(_i < guilds_2.length)) return [3 /*break*/, 5];
                    guild = guilds_2[_i];
                    paramsObj = new URLSearchParams({
                        query: query,
                        limit: String(Math.min(limit, 100)),
                    });
                    return [4 /*yield*/, (0, api_js_1.fetchDiscord)("/guilds/".concat(guild.id, "/members/search?").concat(paramsObj.toString()), token)];
                case 3:
                    members = _e.sent();
                    for (_a = 0, members_1 = members; _a < members_1.length; _a++) {
                        ...
                        if (!(user === null || user === void 0 ? void 0 : user.id))
                            continue;
                        name_2 = ((_b = member.nick) === null || _b === void 0 ? void 0 : _b.trim()) || ((_c = user.global_name) === null || _c === void 0 ? void 0 : _c.trim()) || ((_d = user.username) === null || _d === void 0 ? void 0 : _d.trim());
                        rows.push({
                            kind: "user",
