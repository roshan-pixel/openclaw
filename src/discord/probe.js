...
function fetchDiscordApplicationSummary(token_1, timeoutMs_1) {
    return __awaiter(this, arguments, void 0, function (token, timeoutMs, fetcher) {
        ...
        var _b;
        if (fetcher === void 0) { fetcher = fetch; }
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    _c.trys.push([1, 4, , 5]);
                    return [4 /*yield*/, fetchWithTimeout("".concat(DISCORD_API_BASE, "/oauth2/applications/@me"), timeoutMs, fetcher, {
                ...
                case 3:
                    json = (_c.sent());
                    flags = typeof json.flags === "number" && Number.isFinite(json.flags) ? json.flags : undefined;
                    return [2 /*return*/, {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                    started = Date.now();
                    fetcher = (_b = opts === null || opts === void 0 ? void 0 : opts.fetcher) !== null && _b !== void 0 ? _b : fetch;
                    includeApplication = (opts === null || opts === void 0 ? void 0 : opts.includeApplication) === true;
                    normalized = (0, token_js_1.normalizeDiscordToken)(token);
                    result = {
                        ok: false,
                        status: null,
                    ...
                    if (!normalized) {
                        return [2 /*return*/, __assign(__assign({}, result), { error: "missing token", elapsedMs: Date.now() - started })];
                    }
                    _f.label = 1;
                case 1:
                    _f.trys.push([1, 6, , 7]);
                    return [4 /*yield*/, fetchWithTimeout("".concat(DISCORD_API_BASE, "/users/@me"), timeoutMs, fetcher, {
                            Authorization: "Bot ".concat(normalized),
                        })];
                case 2:
                    res = _f.sent();
                ...
                case 3:
                    ...
                    if (!includeApplication) return [3 /*break*/, 5];
                    _a = result;
                    return [4 /*yield*/, fetchDiscordApplicationSummary(normalized, timeoutMs, fetcher)];
                case 4:
                    _a.application =
                        (_e = (_f.sent())) !== null && _e !== void 0 ? _e : undefined;
                    _f.label = 5;
                case 5: return [2 /*return*/, __assign(__assign({}, result), { elapsedMs: Date.now() - started })];
                case 6:
                    err_1 = _f.sent();
