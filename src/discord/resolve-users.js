...
function scoreDiscordMember(member, query) {
    ...
    var candidates = [user.username, user.global_name, (_a = member.nick) !== null && _a !== void 0 ? _a : undefined]
        .map(function (value) { return value === null || value === void 0 ? void 0 : value.toLowerCase(); })
        .filter(Boolean);
    var score = 0;
    if (candidates.some(function (value) { return value === q; }))
        score += 3;
    if (candidates.some(function (value) { return value === null || value === void 0 ? void 0 : value.includes(q); }))
        score += 1;
    if (!user.bot)
        score += 1;
    return score;
            ...
            switch (_h.label) {
                ...
                case 1:
                    ...
                    _loop_1 = function (input) {
                        var parsed, query, guildName, guildList, best, matches, _j, guildList_1, guild, paramsObj, members, _k, members_1, member, score, user, name_1;
                        return __generator(this, function (_l) {
                            switch (_l.label) {
                                case 0:
                                    ...
                                    guildName = (_d = parsed.guildName) === null || _d === void 0 ? void 0 : _d.trim();
                                    guildList = parsed.guildId
                                        ? guilds.filter(function (g) { return g.id === parsed.guildId; })
                                        : guildName
                                            ? guilds.filter(function (g) { return g.slug === (0, allow_list_js_1.normalizeDiscordSlug)(guildName); })
                                            : guilds;
                                    best = null;
                                    matches = 0;
                                    ...
                                    _l.label = 1;
                                case 1:
                                    if (!(_j < guildList_1.length)) return [3 /*break*/, 4];
                                    guild = guildList_1[_j];
                                    paramsObj = new URLSearchParams({
                                        query: query,
                                        limit: "25",
                                    });
                                    return [4 /*yield*/, (0, api_js_1.fetchDiscord)("/guilds/".concat(guild.id, "/members/search?").concat(paramsObj.toString()), token, fetcher)];
                                case 2:
                                    members = _l.sent();
                                ...
                                case 4:
                                    if (best) {
                                        ...
                                        name_1 = ((_e = best.member.nick) === null || _e === void 0 ? void 0 : _e.trim()) || ((_f = user.global_name) === null || _f === void 0 ? void 0 : _f.trim()) || ((_g = user.username) === null || _g === void 0 ? void 0 : _g.trim()) || undefined;
                                        results.push({
                                            input: input,
                                            resolved: true,
                                            id: user.id,
