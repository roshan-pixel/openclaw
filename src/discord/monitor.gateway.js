...
function waitForDiscordGatewayStop(params) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    gateway = params.gateway, abortSignal = params.abortSignal, onGatewayError = params.onGatewayError, shouldStopOnError = params.shouldStopOnError;
                    emitter = gateway === null || gateway === void 0 ? void 0 : gateway.emitter;
                    return [4 /*yield*/, new Promise(function (resolve, reject) {
                            var settled = false;
                            var cleanup = function () {
                                abortSignal === null || abortSignal === void 0 ? void 0 : abortSignal.removeEventListener("abort", onAbort);
                                emitter === null || emitter === void 0 ? void 0 : emitter.removeListener("error", onGatewayErrorEvent);
                            };
                            var finishResolve = function () {
                                ...
                                cleanup();
                                try {
                                    (_a = gateway === null || gateway === void 0 ? void 0 : gateway.disconnect) === null || _a === void 0 ? void 0 : _a.call(gateway);
                                }
                                finally {
                                    resolve();
                                }
                            ...
                            var onGatewayErrorEvent = function (err) {
                                ...
                                var shouldStop = (_a = shouldStopOnError === null || shouldStopOnError === void 0 ? void 0 : shouldStopOnError(err)) !== null && _a !== void 0 ? _a : true;
                                if (shouldStop) {
                                    finishReject(err);
                                }
                            };
                            ...
                            emitter === null || emitter === void 0 ? void 0 : emitter.on("error", onGatewayErrorEvent);
                        })];
