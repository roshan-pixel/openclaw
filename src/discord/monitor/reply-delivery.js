...
function deliverDiscordReply(params) {
    return __awaiter(this, void 0, void 0, function () {
        var chunkLimit, _i, _a, payload, mediaList, rawText, tableMode, text, replyTo, isFirstChunk, mode, chunks, _b, chunks_1, chunk, trimmed, firstMedia, _c, _d, extra;
        var _e, _f, _g, _h, _j;
        return __generator(this, function (_k) {
            switch (_k.label) {
                ...
                case 1:
                    ...
                    payload = _a[_i];
                    mediaList = (_e = payload.mediaUrls) !== null && _e !== void 0 ? _e : (payload.mediaUrl ? [payload.mediaUrl] : []);
                    ...
                    if (!text && mediaList.length === 0)
                        return [3 /*break*/, 11];
                    replyTo = ((_h = params.replyToId) === null || _h === void 0 ? void 0 : _h.trim()) || undefined;
                    ...
                    _k.label = 2;
                case 2:
                    if (!(_b < chunks_1.length)) return [3 /*break*/, 5];
                    chunk = chunks_1[_b];
                    trimmed = chunk.trim();
                    if (!trimmed)
                        return [3 /*break*/, 4];
                    return [4 /*yield*/, (0, send_js_1.sendMessageDiscord)(params.target, trimmed, {
                            token: params.token,
                            rest: params.rest,
                ...
                case 6:
                    ...
                    if (!firstMedia)
                        return [3 /*break*/, 11];
                    return [4 /*yield*/, (0, send_js_1.sendMessageDiscord)(params.target, text, {
                            token: params.token,
                            rest: params.rest,
                            mediaUrl: firstMedia,
                            accountId: params.accountId,
                ...
                case 8:
                    ...
                    extra = _d[_c];
                    return [4 /*yield*/, (0, send_js_1.sendMessageDiscord)(params.target, "", {
                            token: params.token,
                            rest: params.rest,
                            mediaUrl: extra,
                            accountId: params.accountId,
