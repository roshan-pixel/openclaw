...
function buildExecApprovalCustomId(approvalId, action) {
    return ["".concat(EXEC_APPROVAL_KEY, ":id=").concat(encodeCustomIdValue(approvalId)), "action=".concat(action)].join(";");
}
...
function formatExecApprovalEmbed(request) {
    ...
    var commandPreview = commandText.length > 1000 ? "".concat(commandText.slice(0, 1000), "...") : commandText;
...
function formatResolvedEmbed(request, decision, resolvedBy) {
    var commandText = request.request.command;
    var commandPreview = commandText.length > 500 ? "".concat(commandText.slice(0, 500), "...") : commandText;
    var decisionLabel = decision === "allow-once"
        ? "Allowed (once)"
...
var DiscordExecApprovalHandler = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                this.gatewayClient = new client_js_1.GatewayClient({
                    ...
                    onEvent: function (evt) { return _this.handleGatewayEvent(evt); },
                    onHelloOk: function () {
                        (0, logger_js_1.logDebug)("discord exec approvals: connected to gateway");
                    },
                    onConnectError: function (err) {
                        (0, logger_js_1.logError)("discord exec approvals: connect error: ".concat(err.message));
                    },
                    onClose: function (code, reason) {
                        (0, logger_js_1.logDebug)("discord exec approvals: gateway closed: ".concat(code, " ").concat(reason));
                    },
                });
    ...
    DiscordExecApprovalHandler.prototype.handleApprovalRequested = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, rest, discordRequest, embed, components, approvers, _loop_1, this_1, _i, approvers_1, approver;
            var _this = this;
            var _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (!this.shouldHandle(request))
                            return [2 /*return*/];
                        (0, logger_js_1.logDebug)("discord exec approvals: received request ".concat(request.id));
                        this.requestCache.set(request.id, request);
                        _a = (0, send_shared_js_1.createDiscordClient)({ token: this.opts.token, accountId: this.opts.accountId }, this.opts.cfg), rest = _a.rest, discordRequest = _a.request;
                        ...
                        _loop_1 = function (approver) {
                            ...
                            return __generator(this, function (_d) {
                                switch (_d.label) {
                                    ...
                                    case 1:
                                        _d.trys.push([1, 4, , 5]);
                                        return [4 /*yield*/, discordRequest(function () {
                                    ...
                                    case 2:
                                        dmChannel_1 = (_d.sent());
                                        if (!(dmChannel_1 === null || dmChannel_1 === void 0 ? void 0 : dmChannel_1.id)) {
                                            (0, logger_js_1.logError)("discord exec approvals: failed to create DM for user ".concat(userId));
                                    ...
                                    case 3:
                                        ...
                                        if (!(message === null || message === void 0 ? void 0 : message.id)) {
                                            (0, logger_js_1.logError)("discord exec approvals: failed to send message to user ".concat(userId));
                                            return [2 /*return*/, "continue"];
                                        }
                                        ...
                                        (0, logger_js_1.logDebug)("discord exec approvals: sent approval ".concat(request.id, " to user ").concat(userId));
                                        return [3 /*break*/, 5];
                                    case 4:
                                        err_1 = _d.sent();
                                        (0, logger_js_1.logError)("discord exec approvals: failed to notify user ".concat(userId, ": ").concat(String(err_1)));
                                        return [3 /*break*/, 5];
                        ...
                        _c.label = 1;
                    case 1:
                        if (!(_i < approvers_1.length)) return [3 /*break*/, 4];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!request)
                            return [2 /*return*/];
                        (0, logger_js_1.logDebug)("discord exec approvals: resolved ".concat(resolved.id, " with ").concat(resolved.decision));
                        return [4 /*yield*/, this.updateMessage(pending.discordChannelId, pending.discordMessageId, formatResolvedEmbed(request, resolved.decision, resolved.resolvedBy))];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.updateMessage(pending.discordChannelId, pending.discordMessageId, formatExpiredEmbed(request))];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = (0, send_shared_js_1.createDiscordClient)({ token: this.opts.token, accountId: this.opts.accountId }, this.opts.cfg), rest_1 = _a.rest, discordRequest = _a.request;
                        return [4 /*yield*/, discordRequest(function () {
                    ...
                    case 2:
                        err_2 = _b.sent();
                        (0, logger_js_1.logError)("discord exec approvals: failed to update message: ".concat(String(err_2)));
                        return [3 /*break*/, 3];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        (0, logger_js_1.logDebug)("discord exec approvals: resolving ".concat(approvalId, " with ").concat(decision));
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.gatewayClient.request("exec.approval.resolve", {
                                id: approvalId,
                                decision: decision,
                            })];
                    case 2:
                        _a.sent();
                        (0, logger_js_1.logDebug)("discord exec approvals: resolved ".concat(approvalId, " successfully"));
                        return [2 /*return*/, true];
                    case 3:
                        err_3 = _a.sent();
                        (0, logger_js_1.logError)("discord exec approvals: resolve failed: ".concat(String(err_3)));
                        return [2 /*return*/, false];
                    case 4: return [2 /*return*/];
                }
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 4: return [2 /*return*/];
                    case 5:
                        decisionLabel = parsed.action === "allow-once"
                            ? "Allowed (once)"
                    ...
                    case 8:
                        _b = _d.sent();
                        return [3 /*break*/, 9];
                    case 9: return [4 /*yield*/, this.ctx.handler.resolveApproval(parsed.approvalId, parsed.action)];
                    case 10:
                        ok = _d.sent();
                        if (!!ok) return [3 /*break*/, 14];
                        _d.label = 11;
                    case 11:
