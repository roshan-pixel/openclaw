...
function isDiscordThreadType(type) {
    return (type === carbon_1.ChannelType.PublicThread ||
...
function resolveDiscordThreadChannel(params) {
    ...
    if (!params.isGuildMessage)
        return null;
    var message = params.message, channelInfo = params.channelInfo;
    var channel = "channel" in message ? message.channel : undefined;
    var isThreadChannel = channel &&
    ...
    if (isThreadChannel)
        return channel;
    if (!isDiscordThreadType(channelInfo === null || channelInfo === void 0 ? void 0 : channelInfo.type))
        return null;
    return {
        id: message.channelId,
        name: (_a = channelInfo === null || channelInfo === void 0 ? void 0 : channelInfo.name) !== null && _a !== void 0 ? _a : undefined,
        parentId: (_b = channelInfo === null || channelInfo === void 0 ? void 0 : channelInfo.parentId) !== null && _b !== void 0 ? _b : undefined,
        parent: undefined,
        ownerId: (_c = channelInfo === null || channelInfo === void 0 ? void 0 : channelInfo.ownerId) !== null && _c !== void 0 ? _c : undefined,
    };
}
function resolveDiscordThreadParentInfo(params) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                    threadChannel = params.threadChannel, channelInfo = params.channelInfo, client = params.client;
                    parentId = (_d = (_c = (_a = threadChannel.parentId) !== null && _a !== void 0 ? _a : (_b = threadChannel.parent) === null || _b === void 0 ? void 0 : _b.id) !== null && _c !== void 0 ? _c : channelInfo === null || channelInfo === void 0 ? void 0 : channelInfo.parentId) !== null && _d !== void 0 ? _d : undefined;
                    if (!parentId)
                        return [2 /*return*/, {}];
                ...
                case 1:
                    parentInfo = _f.sent();
                    parentName = parentName !== null && parentName !== void 0 ? parentName : parentInfo === null || parentInfo === void 0 ? void 0 : parentInfo.name;
...
function resolveDiscordThreadStarter(params) {
    return __awaiter(this, void 0, void 0, function () {
        var cacheKey, cached, parentType, isForumParent, messageChannelId, starter, text, author, timestamp, payload, _a;
        ...
        return __generator(this, function (_q) {
            switch (_q.label) {
                ...
                case 1:
                    ...
                    isForumParent = parentType === carbon_1.ChannelType.GuildForum || parentType === carbon_1.ChannelType.GuildMedia;
                    messageChannelId = isForumParent ? params.channel.id : params.parentId;
                    if (!messageChannelId)
                        return [2 /*return*/, null];
                    return [4 /*yield*/, params.client.rest.get(v10_1.Routes.channelMessage(messageChannelId, params.channel.id))];
                case 2:
                    starter = (_q.sent());
                    if (!starter)
                        return [2 /*return*/, null];
                    text = (_g = (_c = (_b = starter.content) === null || _b === void 0 ? void 0 : _b.trim()) !== null && _c !== void 0 ? _c : (_f = (_e = (_d = starter.embeds) === null || _d === void 0 ? void 0 : _d[0]) === null || _e === void 0 ? void 0 : _e.description) === null || _f === void 0 ? void 0 : _f.trim()) !== null && _g !== void 0 ? _g : "";
                    if (!text)
                        return [2 /*return*/, null];
                    author = (_l = (_j = (_h = starter.member) === null || _h === void 0 ? void 0 : _h.nick) !== null && _j !== void 0 ? _j : (_k = starter.member) === null || _k === void 0 ? void 0 : _k.displayName) !== null && _l !== void 0 ? _l : (starter.author
                        ? starter.author.discriminator && starter.author.discriminator !== "0"
                            ? "".concat((_m = starter.author.username) !== null && _m !== void 0 ? _m : "Unknown", "#").concat(starter.author.discriminator)
                            : ((_p = (_o = starter.author.username) !== null && _o !== void 0 ? _o : starter.author.id) !== null && _p !== void 0 ? _p : "Unknown")
                        : "Unknown");
...
function resolveDiscordAutoThreadContext(params) {
    var _a;
    var createdThreadId = String((_a = params.createdThreadId) !== null && _a !== void 0 ? _a : "").trim();
    if (!createdThreadId)
        return null;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, maybeCreateDiscordAutoThread({
                ...
                case 1:
                    ...
                    autoThreadContext = params.isGuildMessage
                        ...
                        : null;
                    return [2 /*return*/, __assign(__assign({}, deliveryPlan), { createdThreadId: createdThreadId, autoThreadContext: autoThreadContext })];
            }
        });
    });
}
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    threadName = sanitizeDiscordThreadName(params.baseText || params.combinedBody || "Thread", params.message.id);
                    return [4 /*yield*/, params.client.rest.post("".concat(v10_1.Routes.channelMessage(params.message.channelId, params.message.id), "/threads"), {
                            body: {
                                name: threadName,
                ...
                case 2:
                    created = (_b.sent());
                    createdId = (created === null || created === void 0 ? void 0 : created.id) ? String(created.id) : "";
                    return [2 /*return*/, createdId || undefined];
                case 3:
                    err_1 = _b.sent();
                    (0, globals_js_1.logVerbose)("discord: autoThread failed for ".concat(params.message.channelId, "/").concat(params.message.id, ": ").concat(String(err_1)));
                    return [2 /*return*/, undefined];
                case 4: return [2 /*return*/];
            }
        });
