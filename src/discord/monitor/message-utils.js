        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 2:
                    ...
                    name_1 = "name" in channel ? ((_a = channel.name) !== null && _a !== void 0 ? _a : undefined) : undefined;
                    topic = "topic" in channel ? ((_b = channel.topic) !== null && _b !== void 0 ? _b : undefined) : undefined;
                    parentId = "parentId" in channel ? ((_c = channel.parentId) !== null && _c !== void 0 ? _c : undefined) : undefined;
                    ownerId = "ownerId" in channel ? ((_d = channel.ownerId) !== null && _d !== void 0 ? _d : undefined) : undefined;
                    payload = {
                        type: channel.type,
                        name: name_1,
                        topic: topic,
                ...
                case 3:
                    err_1 = _e.sent();
                    (0, globals_js_1.logVerbose)("discord: failed to fetch channel ".concat(channelId, ": ").concat(String(err_1)));
                    DISCORD_CHANNEL_INFO_CACHE.set(channelId, {
                        value: null,
                        expiresAt: Date.now() + DISCORD_CHANNEL_INFO_NEGATIVE_CACHE_TTL_MS,
                    });
            ...
            switch (_e.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, (0, fetch_js_1.fetchRemoteMedia)({
                            url: attachment.url,
                            filePathHint: (_b = attachment.filename) !== null && _b !== void 0 ? _b : attachment.url,
                        })];
                case 3:
                    fetched = _e.sent();
                    return [4 /*yield*/, (0, store_js_1.saveMediaBuffer)(fetched.buffer, (_c = fetched.contentType) !== null && _c !== void 0 ? _c : attachment.content_type, "inbound", maxBytes)];
                case 4:
                    saved = _e.sent();
                    out.push({
                        path: saved.path,
                ...
                case 5:
                    ...
                    (0, globals_js_1.logVerbose)("discord: failed to download attachment ".concat(id, ": ").concat(String(err_2)));
                    return [3 /*break*/, 6];
                case 6:
                    _i++;
                    return [3 /*break*/, 1];
...
function isImageAttachment(attachment) {
    ...
    if (mime.startsWith("image/"))
        return true;
    var name = (_c = (_b = attachment.filename) === null || _b === void 0 ? void 0 : _b.toLowerCase()) !== null && _c !== void 0 ? _c : "";
    if (!name)
        return false;
...
function resolveDiscordMessageText(message, options) {
    var _a, _b, _c, _d;
    var baseText = ((_a = message.content) === null || _a === void 0 ? void 0 : _a.trim()) ||
        buildDiscordAttachmentPlaceholder(message.attachments) ||
        ((_c = (_b = message.embeds) === null || _b === void 0 ? void 0 : _b[0]) === null || _c === void 0 ? void 0 : _c.description) ||
        ((_d = options === null || options === void 0 ? void 0 : options.fallbackText) === null || _d === void 0 ? void 0 : _d.trim()) ||
        "";
...
function resolveDiscordMessageSnapshots(message) {
    ...
    var snapshots = (_b = (_a = rawData === null || rawData === void 0 ? void 0 : rawData.message_snapshots) !== null && _a !== void 0 ? _a : message.message_snapshots) !== null && _b !== void 0 ? _b : message.messageSnapshots;
    if (!Array.isArray(snapshots))
        return [];
    return snapshots.filter(function (entry) { return Boolean(entry) && typeof entry === "object"; });
}
function resolveDiscordSnapshotMessageText(snapshot) {
    var _a, _b, _c, _d, _e, _f;
    var content = (_b = (_a = snapshot.content) === null || _a === void 0 ? void 0 : _a.trim()) !== null && _b !== void 0 ? _b : "";
    var attachmentText = buildDiscordAttachmentPlaceholder((_c = snapshot.attachments) !== null && _c !== void 0 ? _c : undefined);
    var embed = (_d = snapshot.embeds) === null || _d === void 0 ? void 0 : _d[0];
    var embedText = ((_e = embed === null || embed === void 0 ? void 0 : embed.description) === null || _e === void 0 ? void 0 : _e.trim()) || ((_f = embed === null || embed === void 0 ? void 0 : embed.title) === null || _f === void 0 ? void 0 : _f.trim()) || "";
