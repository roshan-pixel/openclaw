...
function resolveReplyContext(message, resolveDiscordMessageText, options) {
    ...
    var body = "".concat(referencedText, "\n[discord message id: ").concat(referenced.id, " channel: ").concat(referenced.channelId, " from: ").concat((0, format_js_1.formatDiscordUserTag)(referenced.author), " user id:").concat((_b = (_a = referenced.author) === null || _a === void 0 ? void 0 : _a.id) !== null && _b !== void 0 ? _b : "unknown", "]");
