        ...
        return __generator(this, function (_8) {
            switch (_8.label) {
                ...
                case 1:
                    ...
                    dmPolicy = (_f = (_e = (_d = params.discordConfig) === null || _d === void 0 ? void 0 : _d.dm) === null || _e === void 0 ? void 0 : _e.policy) !== null && _f !== void 0 ? _f : "pairing";
                    commandAuthorized = true;
                    if (!isDirectMessage) return [3 /*break*/, 11];
                ...
                case 2:
                    ...
                    effectiveAllowFrom = __spreadArray(__spreadArray([], ((_g = params.allowFrom) !== null && _g !== void 0 ? _g : []), true), storeAllowFrom, true);
                    ...
                    if (!!permitted) return [3 /*break*/, 10];
                ...
                case 6:
                    err_1 = _8.sent();
                    (0, globals_js_1.logVerbose)("discord pairing reply failed for ".concat(author.id, ": ").concat(String(err_1)));
                    return [3 /*break*/, 7];
                case 7: return [3 /*break*/, 9];
                case 8:
                    (0, globals_js_1.logVerbose)("Blocked unauthorized discord sender ".concat(author.id, " (dmPolicy=").concat(dmPolicy, ", ").concat(allowMatchMeta, ")"));
                    _8.label = 9;
                ...
                case 11:
                    ...
                    explicitlyMentioned = Boolean(botId && ((_k = message.mentionedUsers) === null || _k === void 0 ? void 0 : _k.some(function (user) { return user.id === botId; })));
                    hasAnyMention = Boolean(!isDirectMessage &&
                        (message.mentionedEveryone ||
                            ((_m = (_l = message.mentionedUsers) === null || _l === void 0 ? void 0 : _l.length) !== null && _m !== void 0 ? _m : 0) > 0 ||
                            ((_p = (_o = message.mentionedRoles) === null || _o === void 0 ? void 0 : _o.length) !== null && _p !== void 0 ? _p : 0) > 0));
                    ...
                    implicitMention = Boolean(!isDirectMessage &&
                        botId &&
                        ((_r = (_q = message.referencedMessage) === null || _q === void 0 ? void 0 : _q.author) === null || _r === void 0 ? void 0 : _r.id) &&
                        message.referencedMessage.author.id === botId);
                    if ((0, globals_js_1.shouldLogVerbose)()) {
                        (0, globals_js_1.logVerbose)("discord: inbound id=".concat(message.id, " guild=").concat((_t = (_s = message.guild) === null || _s === void 0 ? void 0 : _s.id) !== null && _t !== void 0 ? _t : "dm", " channel=").concat(message.channelId, " mention=").concat(wasMentioned ? "yes" : "no", " type=").concat(isDirectMessage ? "dm" : isGroupDm ? "group-dm" : "guild", " content=").concat(messageText ? "yes" : "no"));
                    }
                    if (isGuildMessage &&
                    ...
                    if (isGuildMessage &&
                        ...
                        !guildInfo) {
                        (0, globals_js_1.logVerbose)("Blocked discord guild ".concat((_v = params.data.guild_id) !== null && _v !== void 0 ? _v : "unknown", " (not in discord.guilds)"));
                        return [2 /*return*/, null];
                    }
                    channelName = (_w = channelInfo === null || channelInfo === void 0 ? void 0 : channelInfo.name) !== null && _w !== void 0 ? _w : ((isGuildMessage || isGroupDm) && message.channel && "name" in message.channel
                    ...
                    if (!threadChannel) return [3 /*break*/, 13];
                ...
                case 13:
                    ...
                    guildSlug = (guildInfo === null || guildInfo === void 0 ? void 0 : guildInfo.slug) ||
                        (((_x = params.data.guild) === null || _x === void 0 ? void 0 : _x.name) ? (0, allow_list_js_1.normalizeDiscordSlug)(params.data.guild.name) : "");
                    ...
                    if (isGroupDm && !groupDmAllowed)
                        return [2 /*return*/, null];
                    channelAllowlistConfigured = Boolean(guildInfo === null || guildInfo === void 0 ? void 0 : guildInfo.channels) && Object.keys((_y = guildInfo === null || guildInfo === void 0 ? void 0 : guildInfo.channels) !== null && _y !== void 0 ? _y : {}).length > 0;
                    ...
                    historyEntry = isGuildMessage && params.historyLimit > 0 && textForHistory
                        ? {
                            sender: (_2 = (_1 = (_0 = (_z = params.data.member) === null || _z === void 0 ? void 0 : _z.nickname) !== null && _0 !== void 0 ? _0 : author.globalName) !== null && _1 !== void 0 ? _1 : author.username) !== null && _2 !== void 0 ? _2 : author.id,
                            body: textForHistory,
                            timestamp: (0, format_js_1.resolveTimestampMs)(message.timestamp),
                            messageId: message.id,
                        }
                        : undefined;
                    threadOwnerId = threadChannel ? ((_3 = threadChannel.ownerId) !== null && _3 !== void 0 ? _3 : channelInfo === null || channelInfo === void 0 ? void 0 : channelInfo.ownerId) : undefined;
                    ...
                    if (!isDirectMessage) {
                        ownerAllowList = (0, allow_list_js_1.normalizeDiscordAllowList)(params.allowFrom, ["discord:", "user:"]);
                        ownerOk = ownerAllowList
                            ...
                            : false;
                        channelUsers = (_4 = channelConfig === null || channelConfig === void 0 ? void 0 : channelConfig.users) !== null && _4 !== void 0 ? _4 : guildInfo === null || guildInfo === void 0 ? void 0 : guildInfo.users;
                        usersOk = Array.isArray(channelUsers) && channelUsers.length > 0
                            ...
                            : false;
                        useAccessGroups = ((_5 = params.cfg.commands) === null || _5 === void 0 ? void 0 : _5.useAccessGroups) !== false;
                    ...
                    if (isGuildMessage) {
                        channelUsers = (_6 = channelConfig === null || channelConfig === void 0 ? void 0 : channelConfig.users) !== null && _6 !== void 0 ? _6 : guildInfo === null || guildInfo === void 0 ? void 0 : guildInfo.users;
                        if (Array.isArray(channelUsers) && channelUsers.length > 0) {
                            ...
                            if (!userOk) {
                                (0, globals_js_1.logVerbose)("Blocked discord guild sender ".concat(author.id, " (not in channel users allowlist)"));
                                return [2 /*return*/, null];
                            }
                        }
                    }
