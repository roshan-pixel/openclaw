...
exports.DiscordPresenceListener = exports.DiscordReactionRemoveListener = exports.DiscordReactionListener = exports.DiscordMessageListener = void 0;
...
function logSlowDiscordListener(params) {
    ...
    var message = "Slow listener detected: ".concat(params.listener, " took ").concat(duration, " for event ").concat(params.event);
...
function registerDiscordListener(listeners, listener) {
    if (listeners.some(function (existing) { return existing.constructor === listener.constructor; })) {
        return false;
    }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, , 3, 4]);
                        return [4 /*yield*/, handleDiscordReactionEvent({
                                data: data,
                                client: client,
                                action: "added",
                                cfg: this.params.cfg,
...
function handleDiscordReactionEvent(params) {
    return __awaiter(this, void 0, void 0, function () {
        var data, client, action, botUserId, guildEntries, user, guildInfo, channel, channelName, channelSlug, channelType, isThreadChannel, parentId, parentName, parentSlug, channelInfo, parentInfo, channelConfig, reactionMode, message, messageAuthorId, shouldNotify, emojiLabel, actorLabel, guildSlug, channelLabel, authorLabel, baseText, text, route, err_1;
        var _a, _b, _c, _d, _e, _f, _g, _h;
        return __generator(this, function (_j) {
            switch (_j.label) {
                case 0:
                    _j.trys.push([0, 7, , 8]);
                    data = params.data, client = params.client, action = params.action, botUserId = params.botUserId, guildEntries = params.guildEntries;
                    if (!("user" in data))
                        return [2 /*return*/];
                    user = data.user;
                    if (!user || user.bot)
                ...
                case 1:
                    ...
                    if (!channel)
                        return [2 /*return*/];
                    channelName = "name" in channel ? ((_b = channel.name) !== null && _b !== void 0 ? _b : undefined) : undefined;
                    ...
                    parentId = "parentId" in channel ? ((_c = channel.parentId) !== null && _c !== void 0 ? _c : undefined) : undefined;
                    parentName = void 0;
                    parentSlug = "";
                    if (!isThreadChannel) return [3 /*break*/, 5];
                    if (!!parentId) return [3 /*break*/, 3];
                    return [4 /*yield*/, (0, message_utils_js_1.resolveDiscordChannelInfo)(client, data.channel_id)];
                case 2:
                    channelInfo = _j.sent();
                ...
                case 5:
                    ...
                    if ((channelConfig === null || channelConfig === void 0 ? void 0 : channelConfig.allowed) === false)
                        return [2 /*return*/];
                    if (botUserId && user.id === botUserId)
                        return [2 /*return*/];
                    reactionMode = (_d = guildInfo === null || guildInfo === void 0 ? void 0 : guildInfo.reactionNotifications) !== null && _d !== void 0 ? _d : "own";
                    return [4 /*yield*/, data.message.fetch().catch(function () { return null; })];
                case 6:
                    message = _j.sent();
                    messageAuthorId = (_f = (_e = message === null || message === void 0 ? void 0 : message.author) === null || _e === void 0 ? void 0 : _e.id) !== null && _f !== void 0 ? _f : undefined;
                    ...
                    guildSlug = (guildInfo === null || guildInfo === void 0 ? void 0 : guildInfo.slug) || (((_g = data.guild) === null || _g === void 0 ? void 0 : _g.name) ? (0, allow_list_js_1.normalizeDiscordSlug)(data.guild.name) : data.guild_id);
                    channelLabel = channelSlug
                        ? "#".concat(channelSlug)
                        : channelName
                            ? "#".concat((0, allow_list_js_1.normalizeDiscordSlug)(channelName))
                            : "#".concat(data.channel_id);
                    authorLabel = (message === null || message === void 0 ? void 0 : message.author) ? (0, format_js_1.formatDiscordUserTag)(message.author) : undefined;
                    baseText = "Discord reaction ".concat(action, ": ").concat(emojiLabel, " by ").concat(actorLabel, " on ").concat(guildSlug, " ").concat(channelLabel, " msg ").concat(data.message_id);
                    ...
                    (0, system_events_js_1.enqueueSystemEvent)(text, {
                        ...
                        contextKey: "discord:reaction:".concat(action, ":").concat(data.message_id, ":").concat(user.id, ":").concat(emojiLabel),
                    });
                    return [3 /*break*/, 8];
                case 7:
                    err_1 = _j.sent();
                    params.logger.error((0, globals_js_1.danger)("discord reaction handler failed: ".concat(String(err_1))));
                    return [3 /*break*/, 8];
    ...
    DiscordPresenceListener.prototype.handle = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                try {
                    userId = "user" in data && data.user && typeof data.user === "object" && "id" in data.user
                        ? String(data.user.id)
                        : undefined;
                    if (!userId)
                        return [2 /*return*/];
                    ...
                    logger.error((0, globals_js_1.danger)("discord presence handler failed: ".concat(String(err))));
                }
                return [2 /*return*/];
            });
        });
