...
function parseDiscordTarget(raw, options) {
    ...
    if (/^\d+$/.test(trimmed)) {
        ...
        throw new Error((_a = options.ambiguousMessage) !== null && _a !== void 0 ? _a : "Ambiguous Discord recipient \"".concat(trimmed, "\". Use \"user:").concat(trimmed, "\" for DMs or \"channel:").concat(trimmed, "\" for channel messages."));
    }
...
function resolveDiscordChannelId(raw) {
    ...
    return (0, targets_js_1.requireTargetKind)({ platform: "Discord", target: target, kind: "channel" });
}
/**
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    if (!shouldLookup) {
                        return [2 /*return*/, directParse !== null && directParse !== void 0 ? directParse : parseDiscordTarget(trimmed, parseOptions)];
                    }
                    _b.label = 1;
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, (0, directory_live_js_1.listDiscordDirectoryPeersLive)(__assign(__assign({}, options), { query: trimmed, limit: 1 }))];
                case 2:
