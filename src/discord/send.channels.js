        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, rest.post(v10_1.Routes.guildChannels(payload.guildId), {
                            body: body,
                        })];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, rest.patch(v10_1.Routes.channel(payload.channelId), {
                            body: body,
                        })];
                case 1: return [2 /*return*/, (_a.sent())];
            }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    rest = (0, send_shared_js_1.resolveDiscordRest)(opts);
                    body = [
                        __assign(__assign({ id: payload.channelId }, (payload.parentId !== undefined && { parent_id: payload.parentId })), (payload.position !== undefined && { position: payload.position })),
                    ];
                    return [4 /*yield*/, rest.patch(v10_1.Routes.guildChannels(payload.guildId), { body: body })];
                case 1:
                    _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, rest.put("/channels/".concat(payload.channelId, "/permissions/").concat(payload.targetId), { body: body })];
                case 1:
                    _a.sent();
                    return [2 /*return*/, { ok: true }];
            }
    ...
    return __awaiter(this, arguments, void 0, function (channelId, targetId, opts) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    rest = (0, send_shared_js_1.resolveDiscordRest)(opts);
                    return [4 /*yield*/, rest.delete("/channels/".concat(channelId, "/permissions/").concat(targetId))];
                case 1:
                    _a.sent();
                    return [2 /*return*/, { ok: true }];
            }
