        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    limit = typeof query.limit === "number" && Number.isFinite(query.limit)
    ...
    return __awaiter(this, arguments, void 0, function (channelId, messageId, payload, opts) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    rest = (0, send_shared_js_1.resolveDiscordRest)(opts);
                    return [4 /*yield*/, rest.patch(v10_1.Routes.channelMessage(channelId, messageId), {
    ...
    return __awaiter(this, arguments, void 0, function (payload, opts) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    rest = (0, send_shared_js_1.resolveDiscordRest)(opts);
                    if (!payload.includeArchived) return [3 /*break*/, 2];
                    ...
                    return [4 /*yield*/, rest.get(v10_1.Routes.channelThreads(payload.channelId, "public"), params)];
                case 1: return [2 /*return*/, _a.sent()];
                case 2: return [4 /*yield*/, rest.get(v10_1.Routes.guildActiveThreads(payload.guildId))];
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                    ...
                    return [4 /*yield*/, rest.get("/guilds/".concat(query.guildId, "/messages/search?").concat(params.toString()))];
