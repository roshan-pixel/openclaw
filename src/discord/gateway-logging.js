...
var shouldPromoteGatewayDebug = function (message) {
    return INFO_DEBUG_MARKERS.some(function (marker) { return message.includes(marker); });
};
...
function attachDiscordGatewayLogging(params) {
    var emitter = params.emitter, runtime = params.runtime;
    if (!emitter)
        return function () { };
    var onGatewayDebug = function (msg) {
        ...
        if (shouldPromoteGatewayDebug(message)) {
            (_a = runtime.log) === null || _a === void 0 ? void 0 : _a.call(runtime, "discord gateway: ".concat(message));
        }
    };
