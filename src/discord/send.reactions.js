        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    _a = (0, send_shared_js_1.createDiscordClient)(opts, cfg), rest = _a.rest, request = _a.request;
                    encoded = (0, send_shared_js_1.normalizeReactionEmoji)(emoji);
                    return [4 /*yield*/, request(function () { return rest.put(v10_1.Routes.channelMessageOwnReaction(channelId, messageId, encoded)); }, "react")];
                case 1:
                    _b.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    encoded = (0, send_shared_js_1.normalizeReactionEmoji)(emoji);
                    return [4 /*yield*/, rest.delete(v10_1.Routes.channelMessageOwnReaction(channelId, messageId, encoded))];
                case 1:
                    _a.sent();
                    return [2 /*return*/, { ok: true }];
            }
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    message = (_c.sent());
                    identifiers = new Set();
                    for (_i = 0, _a = (_b = message.reactions) !== null && _b !== void 0 ? _b : []; _i < _a.length; _i++) {
                        reaction = _a[_i];
                    ...
                    removed = [];
                    return [4 /*yield*/, Promise.allSettled(Array.from(identifiers, function (identifier) {
                            removed.push(identifier);
                            return rest.delete(v10_1.Routes.channelMessageOwnReaction(channelId, messageId, (0, send_shared_js_1.normalizeReactionEmoji)(identifier)));
                        }))];
                case 2:
                    _c.sent();
...
function fetchReactionsDiscord(channelId_1, messageId_1) {
    return __awaiter(this, arguments, void 0, function (channelId, messageId, opts) {
        var rest, message, reactions, limit, summaries, _i, reactions_1, reaction, identifier, encoded, users;
        var _a, _b, _c;
        if (opts === void 0) { opts = {}; }
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    ...
                    _d.label = 2;
                case 2:
                    if (!(_i < reactions_1.length)) return [3 /*break*/, 5];
                    reaction = reactions_1[_i];
                    identifier = (0, send_shared_js_1.buildReactionIdentifier)(reaction.emoji);
                    if (!identifier)
                        return [3 /*break*/, 4];
                    encoded = encodeURIComponent(identifier);
                    return [4 /*yield*/, rest.get(v10_1.Routes.channelMessageReaction(channelId, messageId, encoded), {
                            limit: limit,
                        })];
                case 3:
                    users = (_d.sent());
...
Object.defineProperty(exports, "fetchChannelPermissionsDiscord", { enumerable: true, get: function () { return send_permissions_js_1.fetchChannelPermissionsDiscord; } });
