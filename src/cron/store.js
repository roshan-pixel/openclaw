        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    jobs = Array.isArray(parsed === null || parsed === void 0 ? void 0 : parsed.jobs) ? parsed === null || parsed === void 0 ? void 0 : parsed.jobs : [];
                    return [2 /*return*/, {
                            version: 1,
...
function saveCronStore(storePath, store) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, node_fs_1.default.promises.mkdir(node_path_1.default.dirname(storePath), { recursive: true })];
                case 1:
                    _b.sent();
                    tmp = "".concat(storePath, ".").concat(process.pid, ".").concat(Math.random().toString(16).slice(2), ".tmp");
                ...
                case 4:
                    _b.trys.push([4, 6, , 7]);
                    return [4 /*yield*/, node_fs_1.default.promises.copyFile(storePath, "".concat(storePath, ".bak"))];
                case 5:
                    _b.sent();
                    return [3 /*break*/, 7];
                case 6:
