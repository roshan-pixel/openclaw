...
function start(state) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, locked_js_1.locked)(state, function () { return __awaiter(_this, void 0, void 0, function () {
                        var _a, _b, _c;
                        return __generator(this, function (_d) {
                            switch (_d.label) {
                                ...
                                case 2:
                                    ...
                                    state.deps.log.info({
                                        enabled: true,
                                        jobs: (_b = (_a = state.store) === null || _a === void 0 ? void 0 : _a.jobs.length) !== null && _b !== void 0 ? _b : 0,
                                        nextWakeAtMs: (_c = (0, jobs_js_1.nextWakeAtMs)(state)) !== null && _c !== void 0 ? _c : null,
                                    }, "cron: started");
                                    return [2 /*return*/];
                            }
                        });
                            ...
                            switch (_d.label) {
                                ...
                                case 1:
                                    ...
                                    return [2 /*return*/, {
                                            ...
                                            jobs: (_b = (_a = state.store) === null || _a === void 0 ? void 0 : _a.jobs.length) !== null && _b !== void 0 ? _b : 0,
                                            nextWakeAtMs: state.deps.cronEnabled === true ? ((_c = (0, jobs_js_1.nextWakeAtMs)(state)) !== null && _c !== void 0 ? _c : null) : null,
                                        }];
                            }
                        });
                    }); })];
                ...
                case 0: return [4 /*yield*/, (0, locked_js_1.locked)(state, function () { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                ...
                                case 1:
                                    _c.sent();
                                    includeDisabled = (opts === null || opts === void 0 ? void 0 : opts.includeDisabled) === true;
                                    jobs = ((_b = (_a = state.store) === null || _a === void 0 ? void 0 : _a.jobs) !== null && _b !== void 0 ? _b : []).filter(function (j) { return includeDisabled || j.enabled; });
                                    return [2 /*return*/, jobs.sort(function (a, b) { var _a, _b; return ((_a = a.state.nextRunAtMs) !== null && _a !== void 0 ? _a : 0) - ((_b = b.state.nextRunAtMs) !== null && _b !== void 0 ? _b : 0); })];
                            }
                        });
                    }); })];
                case 1: return [2 /*return*/, _a.sent()];
                ...
                case 0: return [4 /*yield*/, (0, locked_js_1.locked)(state, function () { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_d) {
                            switch (_d.label) {
                                ...
                                case 1:
                                    _d.sent();
                                    before = (_b = (_a = state.store) === null || _a === void 0 ? void 0 : _a.jobs.length) !== null && _b !== void 0 ? _b : 0;
                                    if (!state.store)
                                        return [2 /*return*/, { ok: false, removed: false }];
                                    state.store.jobs = state.store.jobs.filter(function (j) { return j.id !== id; });
                                    removed = ((_c = state.store.jobs.length) !== null && _c !== void 0 ? _c : 0) !== before;
                                    return [4 /*yield*/, (0, store_js_1.persist)(state)];
                                case 2:
                                    _d.sent();
                                    (0, timer_js_1.armTimer)(state);
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    ...
                                    return [4 /*yield*/, (0, timer_js_1.executeJob)(state, job, now, { forced: mode === "force" })];
                                case 2:
                                    _a.sent();
                                    return [4 /*yield*/, (0, store_js_1.persist)(state)];
                                case 3:
