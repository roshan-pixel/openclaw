...
function truncateText(input, maxLen) {
    if (input.length <= maxLen)
        return input;
    return "".concat((0, utils_js_1.truncateUtf16Safe)(input, Math.max(0, maxLen - 1)).trimEnd(), "\u2026");
}
...
function inferLegacyName(job) {
    ...
    var text = ((_a = job === null || job === void 0 ? void 0 : job.payload) === null || _a === void 0 ? void 0 : _a.kind) === "systemEvent" && typeof job.payload.text === "string"
        ? job.payload.text
        : ((_b = job === null || job === void 0 ? void 0 : job.payload) === null || _b === void 0 ? void 0 : _b.kind) === "agentTurn" && typeof job.payload.message === "string"
            ? job.payload.message
            : "";
    var firstLine = (_c = text
        .split("\n")
        .map(function (l) { return l.trim(); })
        .find(Boolean)) !== null && _c !== void 0 ? _c : "";
    if (firstLine)
        return truncateText(firstLine, 60);
    var kind = typeof ((_d = job === null || job === void 0 ? void 0 : job.schedule) === null || _d === void 0 ? void 0 : _d.kind) === "string" ? job.schedule.kind : "";
    if (kind === "cron" && typeof ((_e = job === null || job === void 0 ? void 0 : job.schedule) === null || _e === void 0 ? void 0 : _e.expr) === "string")
        return "Cron: ".concat(truncateText(job.schedule.expr, 52));
    if (kind === "every" && typeof ((_f = job === null || job === void 0 ? void 0 : job.schedule) === null || _f === void 0 ? void 0 : _f.everyMs) === "number")
