    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, , 3, 4]);
                    return [4 /*yield*/, (0, locked_js_1.locked)(state, function () { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, (0, store_js_1.ensureLoaded)(state)];
                                    case 1:
                                        _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    _a.label = 1;
                case 1:
                    if (!(_i < due_1.length)) return [3 /*break*/, 4];
                    job = due_1[_i];
...
function executeJob(state, job, nowMs, opts) {
    return __awaiter(this, void 0, void 0, function () {
        var startedAt, deleted, finish, text, kind, reason, delay, maxWaitMs, waitStartedAt, heartbeatResult, res, err_1;
        var _this = this;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    deleted = false;
                    finish = function (status, err, summary, outputText) { return __awaiter(_this, void 0, void 0, function () {
                        var endedAt, shouldDelete, prefix, mode, body, maxCharsRaw, maxChars, fullText, statusPrefix;
                        ...
                        return __generator(this, function (_g) {
                            ...
                            shouldDelete = job.schedule.kind === "at" && status === "ok" && job.deleteAfterRun === true;
                            if (!shouldDelete) {
                            ...
                            if (shouldDelete && state.store) {
                                state.store.jobs = state.store.jobs.filter(function (j) { return j.id !== job.id; });
                                deleted = true;
                                emit(state, { jobId: job.id, action: "removed" });
                            }
                            if (job.sessionTarget === "isolated") {
                                prefix = ((_b = (_a = job.isolation) === null || _a === void 0 ? void 0 : _a.postToMainPrefix) === null || _b === void 0 ? void 0 : _b.trim()) || "Cron";
                                mode = (_d = (_c = job.isolation) === null || _c === void 0 ? void 0 : _c.postToMainMode) !== null && _d !== void 0 ? _d : "summary";
                                body = ((_e = summary !== null && summary !== void 0 ? summary : err) !== null && _e !== void 0 ? _e : status).trim();
                                if (mode === "full") {
                                    maxCharsRaw = (_f = job.isolation) === null || _f === void 0 ? void 0 : _f.postToMainMaxChars;
                                    maxChars = Number.isFinite(maxCharsRaw) ? Math.max(0, maxCharsRaw) : 8000;
                                    fullText = (outputText !== null && outputText !== void 0 ? outputText : "").trim();
                                    if (fullText) {
                                        body = fullText.length > maxChars ? "".concat(fullText.slice(0, maxChars), "\u2026") : fullText;
                                    }
                                }
                                statusPrefix = status === "ok" ? prefix : "".concat(prefix, " (").concat(status, ")");
                ...
                case 1:
                    ...
                    if (!(job.sessionTarget === "main")) return [3 /*break*/, 18];
                    text = (0, jobs_js_1.resolveJobPayloadTextForMain)(job);
                    if (!!text) return [3 /*break*/, 3];
                    kind = job.payload.kind;
                    return [4 /*yield*/, finish("skipped", kind === "systemEvent"
                ...
                case 3:
                    ...
                    if (!(job.wakeMode === "now" && state.deps.runHeartbeatOnce)) return [3 /*break*/, 15];
                    ...
                    _b.label = 4;
                case 4: return [4 /*yield*/, state.deps.runHeartbeatOnce({ reason: reason })];
                case 5:
                ...
                case 8:
                    if (!(heartbeatResult.status === "ran")) return [3 /*break*/, 10];
                    return [4 /*yield*/, finish("ok", undefined, text)];
                case 9:
                    _b.sent();
                    return [3 /*break*/, 14];
                case 10:
                    if (!(heartbeatResult.status === "skipped")) return [3 /*break*/, 12];
                    return [4 /*yield*/, finish("skipped", heartbeatResult.reason, text)];
                case 11:
                    _b.sent();
                    return [3 /*break*/, 14];
                case 12: return [4 /*yield*/, finish("error", heartbeatResult.reason, text)];
                case 13:
                    _b.sent();
                    _b.label = 14;
                ...
                case 18:
                    if (!(job.payload.kind !== "agentTurn")) return [3 /*break*/, 20];
                    return [4 /*yield*/, finish("skipped", "isolated job requires payload.kind=agentTurn")];
                case 19:
                    _b.sent();
                    return [2 /*return*/];
                case 20: return [4 /*yield*/, state.deps.runIsolatedAgentJob({
                        job: job,
                        message: job.payload.message,
                    })];
                case 21:
                    res = _b.sent();
                    if (!(res.status === "ok")) return [3 /*break*/, 23];
                    return [4 /*yield*/, finish("ok", undefined, res.summary, res.outputText)];
                case 22:
                    _b.sent();
                    return [3 /*break*/, 27];
                case 23:
                    if (!(res.status === "skipped")) return [3 /*break*/, 25];
                    return [4 /*yield*/, finish("skipped", undefined, res.summary, res.outputText)];
                case 24:
                    _b.sent();
                    return [3 /*break*/, 27];
                case 25: return [4 /*yield*/, finish("error", (_a = res.error) !== null && _a !== void 0 ? _a : "cron job failed", res.summary, res.outputText)];
                case 26:
                    _b.sent();
                    _b.label = 27;
