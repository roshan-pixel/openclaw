...
exports.resolveSessionTranscriptCandidates = exports.readSessionMessages = exports.readSessionPreviewItemsFromTranscript = exports.readLastMessagePreviewFromTranscript = exports.readFirstUserMessageFromTranscript = exports.capArrayByJsonBytes = exports.archiveFileOnDisk = void 0;
...
Object.defineProperty(exports, "archiveFileOnDisk", { enumerable: true, get: function () { return session_utils_fs_js_2.archiveFileOnDisk; } });
Object.defineProperty(exports, "capArrayByJsonBytes", { enumerable: true, get: function () { return session_utils_fs_js_2.capArrayByJsonBytes; } });
Object.defineProperty(exports, "readFirstUserMessageFromTranscript", { enumerable: true, get: function () { return session_utils_fs_js_2.readFirstUserMessageFromTranscript; } });
Object.defineProperty(exports, "readLastMessagePreviewFromTranscript", { enumerable: true, get: function () { return session_utils_fs_js_2.readLastMessagePreviewFromTranscript; } });
Object.defineProperty(exports, "readSessionPreviewItemsFromTranscript", { enumerable: true, get: function () { return session_utils_fs_js_2.readSessionPreviewItemsFromTranscript; } });
Object.defineProperty(exports, "readSessionMessages", { enumerable: true, get: function () { return session_utils_fs_js_2.readSessionMessages; } });
Object.defineProperty(exports, "resolveSessionTranscriptCandidates", { enumerable: true, get: function () { return session_utils_fs_js_2.resolveSessionTranscriptCandidates; } });
...
function loadSessionEntry(sessionKey) {
    ...
    var storePath = (0, sessions_js_1.resolveStorePath)(sessionCfg === null || sessionCfg === void 0 ? void 0 : sessionCfg.store, { agentId: agentId });
...
function parseGroupKey(key) {
    ...
    var rawKey = (_a = agentParsed === null || agentParsed === void 0 ? void 0 : agentParsed.rest) !== null && _a !== void 0 ? _a : key;
    var parts = rawKey.split(":").filter(Boolean);
    if (parts.length >= 3) {
        var channel = parts[0], kind = parts[1], rest = parts.slice(2);
...
function listExistingAgentIdsFromDisk() {
    ...
    try {
        ...
        return entries
            ...
            .map(function (entry) { return (0, session_key_js_1.normalizeAgentId)(entry.name); })
            .filter(Boolean);
    }
    catch (_a) {
        return [];
...
function listConfiguredAgentIds(cfg) {
    var _a, _b;
    var agents = (_b = (_a = cfg.agents) === null || _a === void 0 ? void 0 : _a.list) !== null && _b !== void 0 ? _b : [];
    if (agents.length > 0) {
        var ids_1 = new Set();
        ...
        var defaultId_1 = (0, session_key_js_1.normalizeAgentId)((0, agent_scope_js_1.resolveDefaultAgentId)(cfg));
        ids_1.add(defaultId_1);
        var sorted_1 = Array.from(ids_1).filter(Boolean);
        sorted_1.sort(function (a, b) { return a.localeCompare(b); });
        return sorted_1.includes(defaultId_1)
            ? __spreadArray([defaultId_1], sorted_1.filter(function (id) { return id !== defaultId_1; }), true) : sorted_1;
    }
    var ids = new Set();
    var defaultId = (0, session_key_js_1.normalizeAgentId)((0, agent_scope_js_1.resolveDefaultAgentId)(cfg));
    ids.add(defaultId);
    ...
    if (sorted.includes(defaultId)) {
        return __spreadArray([defaultId], sorted.filter(function (id) { return id !== defaultId; }), true);
    }
    return sorted;
}
function listAgentsForGateway(cfg) {
    ...
    for (var _i = 0, _o = (_e = (_d = cfg.agents) === null || _d === void 0 ? void 0 : _d.list) !== null && _e !== void 0 ? _e : []; _i < _o.length; _i++) {
        var entry = _o[_i];
        if (!(entry === null || entry === void 0 ? void 0 : entry.id))
            continue;
        var identity = entry.identity
            ? {
                name: ((_f = entry.identity.name) === null || _f === void 0 ? void 0 : _f.trim()) || undefined,
                theme: ((_g = entry.identity.theme) === null || _g === void 0 ? void 0 : _g.trim()) || undefined,
                emoji: ((_h = entry.identity.emoji) === null || _h === void 0 ? void 0 : _h.trim()) || undefined,
                avatar: ((_j = entry.identity.avatar) === null || _j === void 0 ? void 0 : _j.trim()) || undefined,
                avatarUrl: resolveIdentityAvatarUrl(cfg, (0, session_key_js_1.normalizeAgentId)(entry.id), (_k = entry.identity.avatar) === null || _k === void 0 ? void 0 : _k.trim()),
            }
            : undefined;
    ...
    var explicitIds = new Set(((_m = (_l = cfg.agents) === null || _l === void 0 ? void 0 : _l.list) !== null && _m !== void 0 ? _m : [])
        .map(function (entry) { return ((entry === null || entry === void 0 ? void 0 : entry.id) ? (0, session_key_js_1.normalizeAgentId)(entry.id) : ""); })
        .filter(Boolean));
    var allowedIds = explicitIds.size > 0 ? new Set(__spreadArray(__spreadArray([], explicitIds, true), [defaultId], false)) : null;
...
function resolveSessionStoreKey(params) {
    ...
    var rawMainKey = (0, session_key_js_1.normalizeMainKey)((_a = params.cfg.session) === null || _a === void 0 ? void 0 : _a.mainKey);
...
function resolveGatewaySessionStoreTarget(params) {
    ...
    if (canonicalKey === "global" || canonicalKey === "unknown") {
        ...
        return { agentId: agentId, storePath: storePath, canonicalKey: canonicalKey, storeKeys: storeKeys_1 };
    }
...
function mergeSessionEntryIntoCombined(params) {
    var _a, _b, _c, _d;
    var combined = params.combined, entry = params.entry, agentId = params.agentId, canonicalKey = params.canonicalKey;
    var existing = combined[canonicalKey];
    if (existing && ((_a = existing.updatedAt) !== null && _a !== void 0 ? _a : 0) > ((_b = entry.updatedAt) !== null && _b !== void 0 ? _b : 0)) {
        combined[canonicalKey] = __assign(__assign(__assign({}, entry), existing), { spawnedBy: canonicalizeSpawnedByForAgent(agentId, (_c = existing.spawnedBy) !== null && _c !== void 0 ? _c : entry.spawnedBy) });
    }
    else {
        combined[canonicalKey] = __assign(__assign(__assign({}, existing), entry), { spawnedBy: canonicalizeSpawnedByForAgent(agentId, (_d = entry.spawnedBy) !== null && _d !== void 0 ? _d : existing === null || existing === void 0 ? void 0 : existing.spawnedBy) });
    }
}
function loadCombinedSessionStoreForGateway(cfg) {
    ...
    var storePath = typeof storeConfig === "string" && storeConfig.trim() ? storeConfig.trim() : "(multiple)";
...
function getSessionDefaults(cfg) {
    ...
    var contextTokens = (_d = (_c = (_b = (_a = cfg.agents) === null || _a === void 0 ? void 0 : _a.defaults) === null || _b === void 0 ? void 0 : _b.contextTokens) !== null && _c !== void 0 ? _c : (0, context_js_1.lookupContextTokens)(resolved.model)) !== null && _d !== void 0 ? _d : defaults_js_1.DEFAULT_CONTEXT_TOKENS;
    return {
...
function resolveSessionModelRef(cfg, entry) {
    ...
    var storedModelOverride = (_a = entry === null || entry === void 0 ? void 0 : entry.modelOverride) === null || _a === void 0 ? void 0 : _a.trim();
    if (storedModelOverride) {
        provider = ((_b = entry === null || entry === void 0 ? void 0 : entry.providerOverride) === null || _b === void 0 ? void 0 : _b.trim()) || provider;
        model = storedModelOverride;
    }
    return { provider: provider, model: model };
}
function listSessionsFromStore(params) {
    var cfg = params.cfg, storePath = params.storePath, store = params.store, opts = params.opts;
    var now = Date.now();
    ...
    var agentId = typeof opts.agentId === "string" ? (0, session_key_js_1.normalizeAgentId)(opts.agentId) : "";
    var search = typeof opts.search === "string" ? opts.search.trim().toLowerCase() : "";
    var activeMinutes = typeof opts.activeMinutes === "number" && Number.isFinite(opts.activeMinutes)
    ...
    var sessions = Object.entries(store)
        ...
        var input = (_c = entry === null || entry === void 0 ? void 0 : entry.inputTokens) !== null && _c !== void 0 ? _c : 0;
        var output = (_d = entry === null || entry === void 0 ? void 0 : entry.outputTokens) !== null && _d !== void 0 ? _d : 0;
        var total = (_e = entry === null || entry === void 0 ? void 0 : entry.totalTokens) !== null && _e !== void 0 ? _e : input + output;
        var parsed = parseGroupKey(key);
        var channel = (_f = entry === null || entry === void 0 ? void 0 : entry.channel) !== null && _f !== void 0 ? _f : parsed === null || parsed === void 0 ? void 0 : parsed.channel;
        ...
        var displayName = (_j = (_h = (_g = entry === null || entry === void 0 ? void 0 : entry.displayName) !== null && _g !== void 0 ? _g : (channel
            ...
            : undefined)) !== null && _h !== void 0 ? _h : entry === null || entry === void 0 ? void 0 : entry.label) !== null && _j !== void 0 ? _j : originLabel;
    ...
    if (search) {
        sessions = sessions.filter(function (s) {
            ...
            return fields.some(function (f) { return typeof f === "string" && f.toLowerCase().includes(search); });
        });
    }
    if (activeMinutes !== undefined) {
        var cutoff_1 = now - activeMinutes * 60000;
        sessions = sessions.filter(function (s) { var _a; return ((_a = s.updatedAt) !== null && _a !== void 0 ? _a : 0) >= cutoff_1; });
    }
    ...
    var finalSessions = sessions.map(function (s) {
        var entry = s.entry, rest = __rest(s, ["entry"]);
        var derivedTitle;
        var lastMessagePreview;
        if (entry === null || entry === void 0 ? void 0 : entry.sessionId) {
            if (includeDerivedTitles) {
                var firstUserMsg = (0, session_utils_fs_js_1.readFirstUserMessageFromTranscript)(entry.sessionId, storePath, entry.sessionFile);
                derivedTitle = deriveSessionTitle(entry, firstUserMsg);
            }
            if (includeLastMessage) {
                var lastMsg = (0, session_utils_fs_js_1.readLastMessagePreviewFromTranscript)(entry.sessionId, storePath, entry.sessionFile);
                if (lastMsg)
                    lastMessagePreview = lastMsg;
            }
        }
        return __assign(__assign({}, rest), { derivedTitle: derivedTitle, lastMessagePreview: lastMessagePreview });
    });
    return {
        ts: now,
        path: storePath,
