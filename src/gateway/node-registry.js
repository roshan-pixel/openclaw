...
var NodeRegistry = /** @class */ (function () {
    ...
    NodeRegistry.prototype.register = function (client, opts) {
        ...
        var nodeId = (_b = (_a = connect.device) === null || _a === void 0 ? void 0 : _a.id) !== null && _b !== void 0 ? _b : connect.client.id;
        var caps = Array.isArray(connect.caps) ? connect.caps : [];
        var commands = Array.isArray(connect.commands)
            ? ((_c = connect.commands) !== null && _c !== void 0 ? _c : [])
            : [];
        var permissions = typeof connect.permissions === "object"
            ? ((_d = connect.permissions) !== null && _d !== void 0 ? _d : undefined)
            : undefined;
        var pathEnv = typeof connect.pathEnv === "string"
            ? connect.pathEnv
            : undefined;
        var session = {
            nodeId: nodeId,
