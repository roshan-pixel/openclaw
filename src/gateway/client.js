...
var GatewayClient = /** @class */ (function () {
    function GatewayClient(opts) {
        ...
        this.tickTimer = null;
        this.opts = __assign(__assign({}, opts), { deviceIdentity: (_a = opts.deviceIdentity) !== null && _a !== void 0 ? _a : (0, device_identity_js_1.loadOrCreateDeviceIdentity)() });
    }
    GatewayClient.prototype.start = function () {
        ...
        if (this.opts.tlsFingerprint && !url.startsWith("wss://")) {
            (_c = (_b = this.opts).onConnectError) === null || _c === void 0 ? void 0 : _c.call(_b, new Error("gateway tls fingerprint requires wss:// gateway url"));
            return;
        }
        ...
        if (url.startsWith("wss://") && this.opts.tlsFingerprint) {
            ...
            wsOptions.checkServerIdentity = (function (_host, cert) {
                var _a, _b;
                var fingerprintValue = typeof cert === "object" && cert && "fingerprint256" in cert
                    ? ((_a = cert.fingerprint256) !== null && _a !== void 0 ? _a : "")
                    : "";
                var fingerprint = (0, fingerprint_js_1.normalizeFingerprint)(typeof fingerprintValue === "string" ? fingerprintValue : "");
                var expected = (0, fingerprint_js_1.normalizeFingerprint)((_b = _this.opts.tlsFingerprint) !== null && _b !== void 0 ? _b : "");
                if (!expected) {
        ...
        this.ws.on("open", function () {
            ...
            if (url.startsWith("wss://") && _this.opts.tlsFingerprint) {
                ...
                if (tlsError) {
                    (_b = (_a = _this.opts).onConnectError) === null || _b === void 0 ? void 0 : _b.call(_a, tlsError);
        ...
        this.ws.on("message", function (data) { return _this.handleMessage((0, ws_js_1.rawDataToString)(data)); });
        this.ws.on("close", function (code, reason) {
            var _a, _b;
            var reasonText = (0, ws_js_1.rawDataToString)(reason);
            _this.ws = null;
            _this.flushPendingErrors(new Error("gateway closed (".concat(code, "): ").concat(reasonText)));
            _this.scheduleReconnect();
            (_b = (_a = _this.opts).onClose) === null || _b === void 0 ? void 0 : _b.call(_a, code, reasonText);
        });
        this.ws.on("error", function (err) {
            var _a, _b;
            (0, logger_js_1.logDebug)("gateway client error: ".concat(String(err)));
            if (!_this.connectSent) {
                (_b = (_a = _this.opts).onConnectError) === null || _b === void 0 ? void 0 : _b.call(_a, err instanceof Error ? err : new Error(String(err)));
            }
        });
    };
    ...
    GatewayClient.prototype.sendConnect = function () {
        ...
        var storedToken = this.opts.deviceIdentity
            ? (_b = (0, device_auth_store_js_1.loadDeviceAuthToken)({ deviceId: this.opts.deviceIdentity.deviceId, role: role })) === null || _b === void 0 ? void 0 : _b.token
            : null;
        var authToken = (_c = storedToken !== null && storedToken !== void 0 ? storedToken : this.opts.token) !== null && _c !== void 0 ? _c : undefined;
        var canFallbackToShared = Boolean(storedToken && this.opts.token);
        var auth = authToken || this.opts.password
            ? {
                token: authToken,
        ...
        var device = (function () {
            ...
            var payload = (0, device_auth_js_1.buildDeviceAuthPayload)({
                ...
                clientId: (_a = _this.opts.clientName) !== null && _a !== void 0 ? _a : message_channel_js_1.GATEWAY_CLIENT_NAMES.GATEWAY_CLIENT,
                clientMode: (_b = _this.opts.mode) !== null && _b !== void 0 ? _b : message_channel_js_1.GATEWAY_CLIENT_MODES.BACKEND,
                role: role,
                scopes: scopes,
            ...
            var signature = (0, device_identity_js_1.signDevicePayload)(_this.opts.deviceIdentity.privateKeyPem, payload);
            return {
                id: _this.opts.deviceIdentity.deviceId,
                publicKey: (0, device_identity_js_1.publicKeyRawBase64UrlFromPem)(_this.opts.deviceIdentity.publicKeyPem),
                signature: signature,
                signedAt: signedAtMs,
                nonce: nonce,
            };
        ...
        var params = {
            minProtocol: (_f = this.opts.minProtocol) !== null && _f !== void 0 ? _f : index_js_1.PROTOCOL_VERSION,
            maxProtocol: (_g = this.opts.maxProtocol) !== null && _g !== void 0 ? _g : index_js_1.PROTOCOL_VERSION,
            client: {
                id: (_h = this.opts.clientName) !== null && _h !== void 0 ? _h : message_channel_js_1.GATEWAY_CLIENT_NAMES.GATEWAY_CLIENT,
                ...
                mode: (_l = this.opts.mode) !== null && _l !== void 0 ? _l : message_channel_js_1.GATEWAY_CLIENT_MODES.BACKEND,
        ...
        void this.request("connect", params)
            ...
            if ((authInfo === null || authInfo === void 0 ? void 0 : authInfo.deviceToken) && _this.opts.deviceIdentity) {
            ...
            _this.tickIntervalMs =
                typeof ((_c = helloOk.policy) === null || _c === void 0 ? void 0 : _c.tickIntervalMs) === "number"
                    ? helloOk.policy.tickIntervalMs
                    : 30000;
            _this.lastTick = Date.now();
            _this.startTickWatch();
            (_e = (_d = _this.opts).onHelloOk) === null || _e === void 0 ? void 0 : _e.call(_d, helloOk);
        })
            .catch(function (err) {
            var _a, _b, _c;
        ...
        try {
            ...
            if ((0, index_js_1.validateResponseFrame)(parsed)) {
                ...
                if (parsed.ok)
                    ...
                    pending.reject(new Error((_f = (_e = parsed.error) === null || _e === void 0 ? void 0 : _e.message) !== null && _f !== void 0 ? _f : "unknown error"));
            }
        }
        catch (err) {
    ...
    GatewayClient.prototype.scheduleReconnect = function () {
        ...
        setTimeout(function () { return _this.start(); }, delay).unref();
    };
    ...
    GatewayClient.prototype.validateTlsFingerprint = function () {
        ...
        var fingerprint = (0, fingerprint_js_1.normalizeFingerprint)((_a = cert === null || cert === void 0 ? void 0 : cert.fingerprint256) !== null && _a !== void 0 ? _a : "");
        if (!fingerprint)
            return new Error("gateway tls fingerprint unavailable");
        if (fingerprint !== expected)
            return new Error("gateway tls fingerprint mismatch");
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (!(0, index_js_1.validateRequestFrame)(frame)) {
                    throw new Error("invalid request frame: ".concat(JSON.stringify(index_js_1.validateRequestFrame.errors, null, 2)));
                }
