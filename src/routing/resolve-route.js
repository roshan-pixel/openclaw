...
Object.defineProperty(exports, "DEFAULT_ACCOUNT_ID", { enumerable: true, get: function () { return session_key_js_2.DEFAULT_ACCOUNT_ID; } });
Object.defineProperty(exports, "DEFAULT_AGENT_ID", { enumerable: true, get: function () { return session_key_js_2.DEFAULT_AGENT_ID; } });
...
function buildAgentSessionKey(params) {
    ...
    return (0, session_key_js_1.buildAgentPeerSessionKey)({
        ...
        peerKind: (_a = peer === null || peer === void 0 ? void 0 : peer.kind) !== null && _a !== void 0 ? _a : "dm",
...
function pickFirstExistingAgentId(cfg, agentId) {
    ...
    var match = agents.find(function (agent) { return (0, session_key_js_1.normalizeAgentId)(agent.id) === normalized; });
    if ((_a = match === null || match === void 0 ? void 0 : match.id) === null || _a === void 0 ? void 0 : _a.trim())
...
function resolveAgentRoute(input) {
    ...
    var bindings = (0, bindings_js_1.listBindings)(input.cfg).filter(function (binding) {
        ...
        if (!matchesChannel(binding.match, channel))
            return false;
        return matchesAccountId((_a = binding.match) === null || _a === void 0 ? void 0 : _a.accountId, accountId);
    });
    var dmScope = (_b = (_a = input.cfg.session) === null || _a === void 0 ? void 0 : _a.dmScope) !== null && _b !== void 0 ? _b : "main";
    var identityLinks = (_c = input.cfg.session) === null || _c === void 0 ? void 0 : _c.identityLinks;
    ...
    if (peer) {
        var peerMatch = bindings.find(function (b) { return matchesPeer(b.match, peer); });
        if (peerMatch)
            return choose(peerMatch.agentId, "binding.peer");
    }
    if (guildId) {
        var guildMatch = bindings.find(function (b) { return matchesGuild(b.match, guildId); });
        if (guildMatch)
            return choose(guildMatch.agentId, "binding.guild");
    }
    if (teamId) {
        var teamMatch = bindings.find(function (b) { return matchesTeam(b.match, teamId); });
        if (teamMatch)
            return choose(teamMatch.agentId, "binding.team");
    }
    var accountMatch = bindings.find(function (b) { var _a, _b, _c, _d, _e; return ((_b = (_a = b.match) === null || _a === void 0 ? void 0 : _a.accountId) === null || _b === void 0 ? void 0 : _b.trim()) !== "*" && !((_c = b.match) === null || _c === void 0 ? void 0 : _c.peer) && !((_d = b.match) === null || _d === void 0 ? void 0 : _d.guildId) && !((_e = b.match) === null || _e === void 0 ? void 0 : _e.teamId); });
    if (accountMatch)
        return choose(accountMatch.agentId, "binding.account");
    var anyAccountMatch = bindings.find(function (b) { var _a, _b, _c, _d, _e; return ((_b = (_a = b.match) === null || _a === void 0 ? void 0 : _a.accountId) === null || _b === void 0 ? void 0 : _b.trim()) === "*" && !((_c = b.match) === null || _c === void 0 ? void 0 : _c.peer) && !((_d = b.match) === null || _d === void 0 ? void 0 : _d.guildId) && !((_e = b.match) === null || _e === void 0 ? void 0 : _e.teamId); });
    if (anyAccountMatch)
