...
exports.DEFAULT_ACCOUNT_ID = exports.DEFAULT_MAIN_KEY = exports.DEFAULT_AGENT_ID = exports.parseAgentSessionKey = exports.isSubagentSessionKey = exports.isAcpSessionKey = void 0;
...
Object.defineProperty(exports, "isAcpSessionKey", { enumerable: true, get: function () { return session_key_utils_js_2.isAcpSessionKey; } });
Object.defineProperty(exports, "isSubagentSessionKey", { enumerable: true, get: function () { return session_key_utils_js_2.isSubagentSessionKey; } });
Object.defineProperty(exports, "parseAgentSessionKey", { enumerable: true, get: function () { return session_key_utils_js_2.parseAgentSessionKey; } });
...
function toAgentRequestSessionKey(storeKey) {
    ...
    if (!raw)
        return undefined;
    return (_b = (_a = (0, session_key_utils_js_1.parseAgentSessionKey)(raw)) === null || _a === void 0 ? void 0 : _a.rest) !== null && _b !== void 0 ? _b : raw;
}
...
function resolveAgentIdFromSessionKey(sessionKey) {
    ...
    return normalizeAgentId((_a = parsed === null || parsed === void 0 ? void 0 : parsed.agentId) !== null && _a !== void 0 ? _a : exports.DEFAULT_AGENT_ID);
}
...
function buildAgentPeerSessionKey(params) {
    ...
    if (peerKind === "dm") {
        ...
        if (dmScope === "per-account-channel-peer" && peerId_1) {
            var channel_1 = ((_d = params.channel) !== null && _d !== void 0 ? _d : "").trim().toLowerCase() || "unknown";
            var accountId = normalizeAccountId(params.accountId);
            return "agent:".concat(normalizeAgentId(params.agentId), ":").concat(channel_1, ":").concat(accountId, ":dm:").concat(peerId_1);
        }
        if (dmScope === "per-channel-peer" && peerId_1) {
            var channel_2 = ((_e = params.channel) !== null && _e !== void 0 ? _e : "").trim().toLowerCase() || "unknown";
            return "agent:".concat(normalizeAgentId(params.agentId), ":").concat(channel_2, ":dm:").concat(peerId_1);
        }
    ...
    var channel = ((_f = params.channel) !== null && _f !== void 0 ? _f : "").trim().toLowerCase() || "unknown";
    var peerId = (((_g = params.peerId) !== null && _g !== void 0 ? _g : "").trim() || "unknown").toLowerCase();
    return "agent:".concat(normalizeAgentId(params.agentId), ":").concat(channel, ":").concat(peerKind, ":").concat(peerId);
}
function resolveLinkedPeerId(params) {
    ...
    for (var _i = 0, _a = Object.entries(identityLinks); _i < _a.length; _i++) {
        var _b = _a[_i], canonical = _b[0], ids = _b[1];
