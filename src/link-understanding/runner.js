...
function resolveTimeoutMsFromConfig(params) {
    var _a, _b;
    var configured = (_a = params.entry.timeoutSeconds) !== null && _a !== void 0 ? _a : (_b = params.config) === null || _b === void 0 ? void 0 : _b.timeoutSeconds;
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 4:
                    ...
                    lastError = err_1;
                    if ((0, globals_js_1.shouldLogVerbose)()) {
                        (0, globals_js_1.logVerbose)("Link understanding failed for ".concat(params.url, ": ").concat(String(err_1)));
                    }
                    return [3 /*break*/, 5];
                case 5:
                    _i++;
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                    ...
                    message = (_d = (_c = (_b = params.message) !== null && _b !== void 0 ? _b : params.ctx.CommandBody) !== null && _c !== void 0 ? _c : params.ctx.RawBody) !== null && _d !== void 0 ? _d : params.ctx.Body;
                    links = (0, detect_js_1.extractLinksFromMessage)(message !== null && message !== void 0 ? message : "", { maxLinks: config === null || config === void 0 ? void 0 : config.maxLinks });
                    if (links.length === 0)
                        return [2 /*return*/, { urls: [], outputs: [] }];
                    entries = (_e = config === null || config === void 0 ? void 0 : config.models) !== null && _e !== void 0 ? _e : [];
                    if (entries.length === 0)
                ...
                case 3:
                    _i++;
                    return [3 /*break*/, 1];
                case 4: return [2 /*return*/, { urls: links, outputs: outputs }];
            }
        });
    });
}
