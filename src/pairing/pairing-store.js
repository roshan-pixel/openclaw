...
function resolvePairingPath(channel, env) {
    if (env === void 0) { env = process.env; }
    return node_path_1.default.join(resolveCredentialsDir(env), "".concat(safeChannelKey(channel), "-pairing.json"));
}
function resolveAllowFromPath(channel, env) {
    if (env === void 0) { env = process.env; }
    return node_path_1.default.join(resolveCredentialsDir(env), "".concat(safeChannelKey(channel), "-allowFrom.json"));
}
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, node_fs_1.default.promises.writeFile(tmp, "".concat(JSON.stringify(value, null, 2), "\n"), {
                            encoding: "utf-8",
                        })];
                case 2:
                    _a.sent();
...
function withFileLock(filePath, fallback, fn) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, ensureJsonFile(filePath, fallback)];
                case 1:
                    _b.sent();
                    _b.label = 2;
                case 2:
                    _b.trys.push([2, , 5, 10]);
                    return [4 /*yield*/, proper_lockfile_1.default.lock(filePath, PAIRING_STORE_LOCK_OPTIONS)];
                case 3:
                    release = _b.sent();
                    return [4 /*yield*/, fn()];
...
function resolveLastSeenAt(entry) {
    var _a, _b;
    return (_b = (_a = parseTimestamp(entry.lastSeenAt)) !== null && _a !== void 0 ? _a : parseTimestamp(entry.createdAt)) !== null && _b !== void 0 ? _b : 0;
}
function pruneExcessRequests(reqs, maxPending) {
    if (maxPending <= 0 || reqs.length <= maxPending) {
        return { requests: reqs, removed: false };
    }
    var sorted = reqs.slice().sort(function (a, b) { return resolveLastSeenAt(a) - resolveLastSeenAt(b); });
...
function normalizeAllowEntry(channel, entry) {
    ...
    var normalized = (adapter === null || adapter === void 0 ? void 0 : adapter.normalizeAllowEntry) ? adapter.normalizeAllowEntry(trimmed) : trimmed;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, list.map(function (v) { return normalizeAllowEntry(channel, String(v)); }).filter(Boolean)];
            }
        });
    });
}
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, withFileLock(filePath, { version: 1, allowFrom: [] }, function () { return __awaiter(_this, void 0, void 0, function () {
                            var value, current, normalized, next;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, readJsonFile(filePath, {
                                            version: 1,
                                            allowFrom: [],
                                        })];
                                    case 1:
                                        ...
                                        current = (Array.isArray(value.allowFrom) ? value.allowFrom : [])
                                            .map(function (v) { return normalizeAllowEntry(params.channel, String(v)); })
                                            .filter(Boolean);
                                        ...
                                        return [4 /*yield*/, writeJsonFile(filePath, {
                                                version: 1,
                                                allowFrom: next,
                                            })];
                                    case 2:
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        ...
                                        if (!normalized)
                                            return [2 /*return*/, { changed: false, allowFrom: current }];
                                        next = current.filter(function (entry) { return entry !== normalized; });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, withFileLock(filePath, { version: 1, requests: [] }, function () { return __awaiter(_this, void 0, void 0, function () {
                            var value, reqs, nowMs, _a, prunedExpired, expiredRemoved, _b, pruned, cappedRemoved;
                            return __generator(this, function (_c) {
                                switch (_c.label) {
                                    ...
                                    case 1:
                                        ...
                                        nowMs = Date.now();
                                        _a = pruneExpiredRequests(reqs, nowMs), prunedExpired = _a.requests, expiredRemoved = _a.removed;
                                        _b = pruneExcessRequests(prunedExpired, PAIRING_PENDING_MAX), pruned = _b.requests, cappedRemoved = _b.removed;
                                        if (!(expiredRemoved || cappedRemoved)) return [3 /*break*/, 3];
                                        return [4 /*yield*/, writeJsonFile(filePath, {
                                                version: 1,
                                                requests: pruned,
                                            })];
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, withFileLock(filePath, { version: 1, requests: [] }, function () { return __awaiter(_this, void 0, void 0, function () {
                            var value, now, nowMs, id, meta, reqs, _a, prunedExpired, expiredRemoved, existingIdx, existingCodes, existing, existingCode, code_1, next_1, capped_1, _b, capped, cappedRemoved, code, next;
                            var _c;
                            return __generator(this, function (_d) {
                                switch (_d.label) {
                                    ...
                                    case 1:
                                        ...
                                        meta = params.meta && typeof params.meta === "object"
                                        ...
                                        _a = pruneExpiredRequests(reqs, nowMs), prunedExpired = _a.requests, expiredRemoved = _a.removed;
                                        reqs = prunedExpired;
                                        existingIdx = reqs.findIndex(function (r) { return r.id === id; });
                                        existingCodes = new Set(reqs.map(function (req) {
                                            var _a;
                                            return String((_a = req.code) !== null && _a !== void 0 ? _a : "")
                                                .trim()
                                                .toUpperCase();
                                        }));
                                        if (!(existingIdx >= 0)) return [3 /*break*/, 3];
                                        existing = reqs[existingIdx];
                                        existingCode = existing && typeof existing.code === "string" ? existing.code.trim() : "";
                                        code_1 = existingCode || generateUniqueCode(existingCodes);
                                        next_1 = {
                                            id: id,
                                            code: code_1,
                                            createdAt: (_c = existing === null || existing === void 0 ? void 0 : existing.createdAt) !== null && _c !== void 0 ? _c : now,
                                            lastSeenAt: now,
                                            meta: meta !== null && meta !== void 0 ? meta : existing === null || existing === void 0 ? void 0 : existing.meta,
                                        };
                                    ...
                                    case 3:
                                        _b = pruneExcessRequests(reqs, PAIRING_PENDING_MAX), capped = _b.requests, cappedRemoved = _b.removed;
                                        reqs = capped;
                                        if (!(PAIRING_PENDING_MAX > 0 && reqs.length >= PAIRING_PENDING_MAX)) return [3 /*break*/, 6];
                                        if (!(expiredRemoved || cappedRemoved)) return [3 /*break*/, 5];
                                        return [4 /*yield*/, writeJsonFile(filePath, {
                                                version: 1,
                                                requests: reqs,
                                            })];
                                    case 4:
                                        _d.sent();
                                        _d.label = 5;
                                    case 5: return [2 /*return*/, { code: "", created: false }];
                                    case 6:
                                        code = generateUniqueCode(existingCodes);
                                        next = __assign({ id: id, code: code, createdAt: now, lastSeenAt: now }, (meta ? { meta: meta } : {}));
                                        return [4 /*yield*/, writeJsonFile(filePath, {
                                                version: 1,
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    ...
                                    case 1:
                                        ...
                                        reqs = Array.isArray(value.requests) ? value.requests : [];
                                        nowMs = Date.now();
                                        _a = pruneExpiredRequests(reqs, nowMs), pruned = _a.requests, removed = _a.removed;
                                        idx = pruned.findIndex(function (r) { var _a; return String((_a = r.code) !== null && _a !== void 0 ? _a : "").toUpperCase() === code; });
                                        if (!(idx < 0)) return [3 /*break*/, 4];
                                        if (!removed) return [3 /*break*/, 3];
                                        return [4 /*yield*/, writeJsonFile(filePath, {
                                                version: 1,
                                                requests: pruned,
                                            })];
                                    ...
                                    case 5:
                                        _b.sent();
                                        return [4 /*yield*/, addChannelAllowFromStoreEntry({
