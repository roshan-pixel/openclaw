...
function getGeminiBaseUrl(gemini) {
    var _a, _b;
    return (_b = (_a = gemini.baseUrl) === null || _a === void 0 ? void 0 : _a.replace(/\/$/, "")) !== null && _b !== void 0 ? _b : "";
}
...
function submitGeminiBatch(params) {
    return __awaiter(this, void 0, void 0, function () {
        var baseUrl, jsonl, displayName, uploadPayload, uploadUrl, fileRes, text_1, filePayload, fileId, batchBody, batchEndpoint, batchRes, text;
        var _a, _b;
            ...
            switch (_c.label) {
                case 0:
                    ...
                    jsonl = params.requests
                        ...
                        .join("\n");
                    displayName = "memory-embeddings-".concat((0, internal_js_1.hashText)(String(Date.now())));
                    ...
                    return [4 /*yield*/, fetch(uploadUrl, {
                            method: "POST",
                            headers: __assign(__assign({}, getGeminiHeaders(params.gemini, { json: false })), { "Content-Type": uploadPayload.contentType }),
                ...
                case 2:
                    text_1 = _c.sent();
                    throw new Error("gemini batch file upload failed: ".concat(fileRes.status, " ").concat(text_1));
                case 3: return [4 /*yield*/, fileRes.json()];
                case 4:
                    filePayload = (_c.sent());
                    fileId = (_a = filePayload.name) !== null && _a !== void 0 ? _a : (_b = filePayload.file) === null || _b === void 0 ? void 0 : _b.name;
                    if (!fileId) {
                    ...
                    batchEndpoint = "".concat(baseUrl, "/").concat(params.gemini.modelPath, ":asyncBatchEmbedContent");
                    debugLog("memory embeddings: gemini batch create", {
                        batchEndpoint: batchEndpoint,
                        fileId: fileId,
                    });
                    return [4 /*yield*/, fetch(batchEndpoint, {
                            method: "POST",
                ...
                case 5:
                    batchRes = _c.sent();
                    if (!batchRes.ok) return [3 /*break*/, 7];
                    return [4 /*yield*/, batchRes.json()];
                case 6: return [2 /*return*/, (_c.sent())];
                case 7: return [4 /*yield*/, batchRes.text()];
                case 8:
                    text = _c.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    baseUrl = getGeminiBaseUrl(params.gemini);
                    file = params.fileId.startsWith("files/") ? params.fileId : "files/".concat(params.fileId);
                ...
                case 2:
                    text = _a.sent();
                    throw new Error("gemini batch file content failed: ".concat(res.status, " ").concat(text));
        ...
        return __generator(this, function (_m) {
            switch (_m.label) {
                ...
                case 1:
                    ...
                    _a = current;
                    return [3 /*break*/, 4];
                case 2: return [4 /*yield*/, fetchGeminiBatchStatus({
                ...
                case 4:
                    ...
                    if (["SUCCEEDED", "COMPLETED", "DONE"].includes(state)) {
                        outputFileId = (_f = (_d = (_c = status_1.outputConfig) === null || _c === void 0 ? void 0 : _c.file) !== null && _d !== void 0 ? _d : (_e = status_1.outputConfig) === null || _e === void 0 ? void 0 : _e.fileId) !== null && _f !== void 0 ? _f : (_h = (_g = status_1.metadata) === null || _g === void 0 ? void 0 : _g.output) === null || _h === void 0 ? void 0 : _h.responsesFile;
                        if (!outputFileId) {
                            throw new Error("gemini batch ".concat(params.batchName, " completed without output file"));
                        }
                        return [2 /*return*/, { outputFileId: outputFileId }];
                    }
                    if (["FAILED", "CANCELLED", "CANCELED", "EXPIRED"].includes(state)) {
                        message = (_k = (_j = status_1.error) === null || _j === void 0 ? void 0 : _j.message) !== null && _k !== void 0 ? _k : "unknown error";
                        throw new Error("gemini batch ".concat(params.batchName, " ").concat(state, ": ").concat(message));
                    }
                    if (!params.wait) {
                        throw new Error("gemini batch ".concat(params.batchName, " still ").concat(state, "; wait disabled"));
                    }
                    if (Date.now() - start > params.timeoutMs) {
                        throw new Error("gemini batch ".concat(params.batchName, " timed out after ").concat(params.timeoutMs, "ms"));
                    }
                    (_l = params.debug) === null || _l === void 0 ? void 0 : _l.call(params, "gemini batch ".concat(params.batchName, " ").concat(state, "; waiting ").concat(params.pollIntervalMs, "ms"));
            ...
            switch (_b.label) {
                case 0:
                    ...
                    tasks = groups.map(function (group, groupIndex) { return function () { return __awaiter(_this, void 0, void 0, function () {
                        var batchInfo, batchName, completed, _a, content, outputLines, errors, remaining, _i, outputLines_1, line, customId, embedding;
                        var _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s, _t, _u, _v;
                        return __generator(this, function (_w) {
                            switch (_w.label) {
                                case 0: return [4 /*yield*/, submitGeminiBatch({
                                        gemini: params.gemini,
                                        requests: group,
                                ...
                                case 1:
                                    ...
                                    (_c = params.debug) === null || _c === void 0 ? void 0 : _c.call(params, "memory embeddings: gemini batch created", {
                                        batchName: batchName,
                                    ...
                                    if (!params.wait &&
                                        ...
                                        throw new Error("gemini batch ".concat(batchName, " submitted; enable remote.batch.wait to await completion"));
                                    }
                                    if (!(batchInfo.state && ["SUCCEEDED", "COMPLETED", "DONE"].includes(batchInfo.state))) return [3 /*break*/, 2];
                                    _a = {
                                        outputFileId: (_k = (_g = (_e = (_d = batchInfo.outputConfig) === null || _d === void 0 ? void 0 : _d.file) !== null && _e !== void 0 ? _e : (_f = batchInfo.outputConfig) === null || _f === void 0 ? void 0 : _f.fileId) !== null && _g !== void 0 ? _g : (_j = (_h = batchInfo.metadata) === null || _h === void 0 ? void 0 : _h.output) === null || _j === void 0 ? void 0 : _j.responsesFile) !== null && _k !== void 0 ? _k : "",
                                    };
                                    return [3 /*break*/, 4];
                                case 2: return [4 /*yield*/, waitForGeminiBatch({
                                        gemini: params.gemini,
                                        batchName: batchName,
                                        wait: params.wait,
                                ...
                                case 4:
                                    ...
                                    if (!completed.outputFileId) {
                                        throw new Error("gemini batch ".concat(batchName, " completed without output file"));
                                    }
                                    return [4 /*yield*/, fetchGeminiFileContent({
                                            gemini: params.gemini,
                                ...
                                case 5:
                                    ...
                                    for (_i = 0, outputLines_1 = outputLines; _i < outputLines_1.length; _i++) {
                                        ...
                                        customId = (_m = (_l = line.key) !== null && _l !== void 0 ? _l : line.custom_id) !== null && _m !== void 0 ? _m : line.request_id;
                                        if (!customId)
                                            continue;
                                        ...
                                        if ((_q = (_p = line.response) === null || _p === void 0 ? void 0 : _p.error) === null || _q === void 0 ? void 0 : _q.message) {
                                            errors.push("".concat(customId, ": ").concat(line.response.error.message));
                                            continue;
                                        }
                                        embedding = (_v = (_s = (_r = line.embedding) === null || _r === void 0 ? void 0 : _r.values) !== null && _s !== void 0 ? _s : (_u = (_t = line.response) === null || _t === void 0 ? void 0 : _t.embedding) === null || _u === void 0 ? void 0 : _u.values) !== null && _v !== void 0 ? _v : [];
                                    ...
                                    if (errors.length > 0) {
                                        throw new Error("gemini batch ".concat(batchName, " failed: ").concat(errors.join("; ")));
                                    }
                                    if (remaining.size > 0) {
                                        throw new Error("gemini batch ".concat(batchName, " missing ").concat(remaining.size, " embedding responses"));
                                    }
                                    return [2 /*return*/];
                            }
                        });
                    }); }; });
                    (_a = params.debug) === null || _a === void 0 ? void 0 : _a.call(params, "memory embeddings: gemini batch submit", {
                        requests: params.requests.length,
                        groups: groups.length,
                        wait: params.wait,
