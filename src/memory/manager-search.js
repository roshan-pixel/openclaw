                ...
                case 1:
                    if (_b.sent()) {
                        rows = (_a = params.db
                            ...
                            " ORDER BY dist ASC\n" +
                            " LIMIT ?"))
                            .all.apply(_a, __spreadArray(__spreadArray([vectorToBlob(params.queryVec),
                            params.providerModel], params.sourceFilterVec.params, false), [params.limit], false));
                    ...
                    return [2 /*return*/, scored
                            ...
                            score: entry.score,
                            snippet: (0, utils_js_1.truncateUtf16Safe)(entry.chunk.text, params.snippetMaxChars),
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            ...
            rows = (_a = params.db
                ...
                " WHERE ".concat(params.ftsTable, " MATCH ? AND model = ?").concat(params.sourceFilter.sql, "\n") +
                " ORDER BY rank ASC\n" +
                " LIMIT ?"))
                .all.apply(_a, __spreadArray(__spreadArray([ftsQuery, params.providerModel], params.sourceFilter.params, false), [params.limit], false));
