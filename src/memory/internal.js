...
function normalizeExtraMemoryPaths(workspaceDir, extraPaths) {
    ...
    var resolved = extraPaths
        ...
        .filter(Boolean)
        .map(function (value) {
        return node_path_1.default.isAbsolute(value) ? node_path_1.default.resolve(value) : node_path_1.default.resolve(workspaceDir, value);
    });
...
function listMemoryFiles(workspaceDir, extraPaths) {
    return __awaiter(this, void 0, void 0, function () {
        var result, memoryFile, altMemoryFile, memoryDir, addMarkdownFile, dirStat, _a, normalizedExtraPaths, _i, normalizedExtraPaths_1, inputPath, stat, _b, seen, deduped, _c, result_1, entry, key, _d;
        var _this = this;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    ...
                    addMarkdownFile = function (absPath) { return __awaiter(_this, void 0, void 0, function () {
                        var stat, _a;
                ...
                case 4:
                    dirStat = _e.sent();
                    if (!(!dirStat.isSymbolicLink() && dirStat.isDirectory())) return [3 /*break*/, 6];
                ...
                case 8:
                    ...
                    if (!(normalizedExtraPaths.length > 0)) return [3 /*break*/, 16];
                    _i = 0, normalizedExtraPaths_1 = normalizedExtraPaths;
                    _e.label = 9;
                case 9:
                    if (!(_i < normalizedExtraPaths_1.length)) return [3 /*break*/, 16];
                ...
                case 11:
                    ...
                    if (stat.isSymbolicLink())
                        return [3 /*break*/, 15];
                    if (!stat.isDirectory()) return [3 /*break*/, 13];
                ...
                case 16:
                    ...
                    _e.label = 17;
                case 17:
                    if (!(_c < result_1.length)) return [3 /*break*/, 23];
                    entry = result_1[_c];
                    key = entry;
                    _e.label = 18;
                case 18:
                ...
                case 22:
                    _c++;
                    return [3 /*break*/, 17];
                case 23: return [2 /*return*/, deduped];
            }
        });
    });
}
...
function buildFileEntry(absPath, workspaceDir) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, promises_1.default.stat(absPath)];
                case 1:
                    stat = _a.sent();
...
function chunkMarkdown(content, chunking) {
    ...
    var flush = function () {
        ...
        if (!firstEntry || !lastEntry)
            return;
        var text = current.map(function (entry) { return entry.line; }).join("\n");
    ...
    var carryOverlap = function () {
        ...
        current = kept;
        currentChars = kept.reduce(function (sum, entry) { return sum + entry.line.length + 1; }, 0);
    };
