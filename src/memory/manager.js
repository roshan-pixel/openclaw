...
var MemoryIndexManager = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        key = "".concat(agentId, ":").concat(workspaceDir, ":").concat(JSON.stringify(settings));
                        existing = INDEX_CACHE.get(key);
                        if (existing)
                            return [2 /*return*/, existing];
                        return [4 /*yield*/, (0, embeddings_js_1.createEmbeddingProvider)({
                                config: cfg,
    ...
    MemoryIndexManager.prototype.search = function (query, opts) {
        return __awaiter(this, void 0, void 0, function () {
            var cleaned, minScore, maxResults, hybrid, candidates, keywordResults, _a, queryVec, hasVector, vectorResults, _b, merged;
            var _c, _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        if (!cleaned)
                            return [2 /*return*/, []];
                        minScore = (_c = opts === null || opts === void 0 ? void 0 : opts.minScore) !== null && _c !== void 0 ? _c : this.settings.query.minScore;
                        maxResults = (_d = opts === null || opts === void 0 ? void 0 : opts.maxResults) !== null && _d !== void 0 ? _d : this.settings.query.maxResults;
                        hybrid = this.settings.query.hybrid;
                        candidates = Math.min(200, Math.max(1, Math.floor(maxResults * hybrid.candidateMultiplier)));
                        if (!hybrid.enabled) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.searchKeyword(cleaned, candidates).catch(function () { return []; })];
                    case 1:
                        _a = _e.sent();
                        return [3 /*break*/, 3];
                    case 2:
                    ...
                    case 4:
                        queryVec = _e.sent();
                        hasVector = queryVec.some(function (v) { return v !== 0; });
                        if (!hasVector) return [3 /*break*/, 6];
                        return [4 /*yield*/, this.searchVector(queryVec, candidates).catch(function () { return []; })];
                    case 5:
                        _b = _e.sent();
                        return [3 /*break*/, 7];
                    case 6:
                    ...
                    case 7:
                        vectorResults = _b;
                        if (!hybrid.enabled) {
                            return [2 /*return*/, vectorResults.filter(function (entry) { return entry.score >= minScore; }).slice(0, maxResults)];
                        }
                        ...
                        return [2 /*return*/, merged.filter(function (entry) { return entry.score >= minScore; }).slice(0, maxResults)];
                }
            });
        });
    };
    MemoryIndexManager.prototype.searchVector = function (queryVec, limit) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, manager_search_js_1.searchVector)({
                            db: this.db,
                            ...
                            ensureVectorReady: function (dimensions) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, this.ensureVectorReady(dimensions)];
                    ...
                    case 1:
                        results = _a.sent();
                        return [2 /*return*/, results.map(function (entry) { return entry; })];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, manager_search_js_1.searchKeyword)({
                                db: this.db,
                                ftsTable: FTS_TABLE,
                                providerModel: this.provider.model,
                                query: query,
                                ...
                                buildFtsQuery: function (raw) { return _this.buildFtsQuery(raw); },
    ...
    MemoryIndexManager.prototype.mergeHybridResults = function (params) {
        var merged = (0, hybrid_js_1.mergeHybridResults)({
            vector: params.vector.map(function (r) { return ({
                id: r.id,
                path: r.path,
            ...
            keyword: params.keyword.map(function (r) { return ({
                id: r.id,
                path: r.path,
                startLine: r.startLine,
                endLine: r.endLine,
        ...
        return merged.map(function (entry) { return entry; });
    };
    ...
    MemoryIndexManager.prototype.readFile = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var rawPath, absPath, relPath, inWorkspace, allowedWorkspace, allowedAdditional, additionalPaths, _i, additionalPaths_1, additionalPath, stat_1, _a, stat, content, lines, start, count, slice;
            var _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        inWorkspace = relPath.length > 0 && !relPath.startsWith("..") && !node_path_1.default.isAbsolute(relPath);
                        allowedWorkspace = inWorkspace && (0, internal_js_1.isMemoryPath)(relPath);
                        allowedAdditional = false;
                        if (!(!allowedWorkspace && this.settings.extraPaths.length > 0)) return [3 /*break*/, 6];
                        additionalPaths = (0, internal_js_1.normalizeExtraMemoryPaths)(this.workspaceDir, this.settings.extraPaths);
                        _i = 0, additionalPaths_1 = additionalPaths;
                        _d.label = 1;
                    case 1:
                        if (!(_i < additionalPaths_1.length)) return [3 /*break*/, 6];
                    ...
                    case 3:
                        ...
                        if (stat_1.isDirectory()) {
                            if (absPath === additionalPath || absPath.startsWith("".concat(additionalPath).concat(node_path_1.default.sep))) {
    ...
    MemoryIndexManager.prototype.status = function () {
        ...
        var files = (_a = this.db
            .prepare("SELECT COUNT(*) as c FROM files WHERE 1=1".concat(sourceFilter.sql)))
            .get.apply(_a, sourceFilter.params);
        var chunks = (_b = this.db
            .prepare("SELECT COUNT(*) as c FROM chunks WHERE 1=1".concat(sourceFilter.sql)))
        ...
        var sourceCounts = (function () {
            ...
            var fileRows = (_a = _this.db
                .prepare("SELECT source, COUNT(*) as c FROM files WHERE 1=1".concat(sourceFilter.sql, " GROUP BY source")))
                .all.apply(_a, sourceFilter.params);
            for (var _g = 0, fileRows_1 = fileRows; _g < fileRows_1.length; _g++) {
                var row = fileRows_1[_g];
                var entry = (_c = bySource.get(row.source)) !== null && _c !== void 0 ? _c : { files: 0, chunks: 0 };
                entry.files = (_d = row.c) !== null && _d !== void 0 ? _d : 0;
                bySource.set(row.source, entry);
            }
            var chunkRows = (_b = _this.db
                .prepare("SELECT source, COUNT(*) as c FROM chunks WHERE 1=1".concat(sourceFilter.sql, " GROUP BY source")))
                .all.apply(_b, sourceFilter.params);
            for (var _h = 0, chunkRows_1 = chunkRows; _h < chunkRows_1.length; _h++) {
                var row = chunkRows_1[_h];
                var entry = (_e = bySource.get(row.source)) !== null && _e !== void 0 ? _e : { files: 0, chunks: 0 };
                entry.chunks = (_f = row.c) !== null && _f !== void 0 ? _f : 0;
                bySource.set(row.source, entry);
            }
            return sources.map(function (source) { return (__assign({ source: source }, bySource.get(source))); });
        })();
        return {
            files: (_c = files === null || files === void 0 ? void 0 : files.c) !== null && _c !== void 0 ? _c : 0,
            chunks: (_d = chunks === null || chunks === void 0 ? void 0 : chunks.c) !== null && _d !== void 0 ? _d : 0,
            dirty: this.dirty,
            ...
            cache: this.cache.enabled
                ? {
                    enabled: true,
                    entries: (_f = (_e = this.db.prepare("SELECT COUNT(*) as c FROM ".concat(EMBEDDING_CACHE_TABLE)).get()) === null || _e === void 0 ? void 0 : _e.c) !== null && _f !== void 0 ? _f : 0,
            ...
            fallback: this.fallbackReason
                ? { from: (_g = this.fallbackFrom) !== null && _g !== void 0 ? _g : "local", reason: this.fallbackReason }
                : undefined,
            vector: {
                ...
                switch (_a.label) {
                    case 0:
                        if (!this.vector.enabled)
                            return [2 /*return*/, false];
                        if (!this.vectorReady) {
                            this.vectorReady = this.withTimeout(this.loadVectorExtension(), VECTOR_LOAD_TIMEOUT_MS, "sqlite-vec load timed out after ".concat(Math.round(VECTOR_LOAD_TIMEOUT_MS / 1000), "s"));
                        }
                        ready = false;
                        _a.label = 1;
                    case 1:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _c.trys.push([1, 3, , 4]);
                        resolvedPath = ((_a = this.vector.extensionPath) === null || _a === void 0 ? void 0 : _a.trim())
                            ? (0, utils_js_1.resolveUserPath)(this.vector.extensionPath)
                            : undefined;
                        return [4 /*yield*/, (0, sqlite_vec_js_1.loadSqliteVecExtension)({ db: this.db, extensionPath: resolvedPath })];
                    case 2:
                        loaded = _c.sent();
                        if (!loaded.ok)
                            throw new Error((_b = loaded.error) !== null && _b !== void 0 ? _b : "unknown sqlite-vec load error");
    ...
    MemoryIndexManager.prototype.ensureVectorTable = function (dimensions) {
        ...
        this.db.exec("CREATE VIRTUAL TABLE IF NOT EXISTS ".concat(VECTOR_TABLE, " USING vec0(\n") +
            "  id TEXT PRIMARY KEY,\n" +
    ...
    MemoryIndexManager.prototype.buildSourceFilter = function (alias) {
        ...
        var placeholders = sources.map(function () { return "?"; }).join(", ");
    ...
    MemoryIndexManager.prototype.seedEmbeddingCache = function (sourceDb) {
        ...
        try {
            var rows = sourceDb
                .prepare("SELECT provider, model, provider_key, hash, embedding, dims, updated_at FROM ".concat(EMBEDDING_CACHE_TABLE))
                .all();
            if (!rows.length)
                return;
            var insert = this.db.prepare("INSERT INTO ".concat(EMBEDDING_CACHE_TABLE, " (provider, model, provider_key, hash, embedding, dims, updated_at)\n         VALUES (?, ?, ?, ?, ?, ?, ?)\n         ON CONFLICT(provider, model, provider_key, hash) DO UPDATE SET\n           embedding=excluded.embedding,\n           dims=excluded.dims,\n           updated_at=excluded.updated_at"));
            this.db.exec("BEGIN");
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        _a.sent();
                        throw err_4;
                    case 6: return [4 /*yield*/, this.removeIndexFiles(backupPath)];
                    case 7:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        _a.label = 1;
                    case 1:
                        if (!(_i < suffixes_1.length)) return [3 /*break*/, 6];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        suffixes = ["", "-wal", "-shm"];
                        return [4 /*yield*/, Promise.all(suffixes.map(function (suffix) { return promises_1.default.rm("".concat(basePath).concat(suffix), { force: true }); }))];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    MemoryIndexManager.prototype.ensureWatcher = function () {
        ...
        if (!this.sources.has("memory") || !this.settings.sync.watch || this.watcher)
            return;
        var additionalPaths = (0, internal_js_1.normalizeExtraMemoryPaths)(this.workspaceDir, this.settings.extraPaths)
            .map(function (entry) {
            try {
        ...
        var watchPaths = new Set(__spreadArray([
    ...
    MemoryIndexManager.prototype.ensureSessionListener = function () {
        ...
        if (!this.sources.has("sessions") || this.sessionUnsubscribe)
            return;
        this.sessionUnsubscribe = (0, transcript_events_js_1.onSessionTranscriptUpdate)(function (update) {
            if (_this.closed)
                return;
    ...
    MemoryIndexManager.prototype.processSessionDeltaBatch = function () {
        return __awaiter(this, void 0, void 0, function () {
            var pending, shouldSync, _i, pending_1, sessionFile, delta, bytesThreshold, messagesThreshold, bytesHit, messagesHit;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        _a.label = 1;
                    case 1:
                        if (!(_i < pending_1.length)) return [3 /*break*/, 4];
                    ...
                    case 2:
                        ...
                        bytesHit = bytesThreshold <= 0 ? delta.pendingBytes > 0 : delta.pendingBytes >= bytesThreshold;
                        messagesHit = messagesThreshold <= 0
    ...
    MemoryIndexManager.prototype.updateSessionDelta = function (sessionFile) {
        return __awaiter(this, void 0, void 0, function () {
            var thresholds, stat, _a, size, state, deltaBytes, shouldCountMessages, _b, _c, shouldCountMessages, _d, _e;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 4:
                        ...
                        if (!(size < state.lastSize)) return [3 /*break*/, 7];
                        state.lastSize = size;
                        state.pendingBytes += size;
                        shouldCountMessages = thresholds.deltaMessages > 0 &&
                            (thresholds.deltaBytes <= 0 || state.pendingBytes < thresholds.deltaBytes);
                        if (!shouldCountMessages) return [3 /*break*/, 6];
                        _b = state;
                    ...
                    case 7:
                        ...
                        shouldCountMessages = thresholds.deltaMessages > 0 &&
                            (thresholds.deltaBytes <= 0 || state.pendingBytes < thresholds.deltaBytes);
                        if (!shouldCountMessages) return [3 /*break*/, 9];
                        _d = state;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        _a.label = 3;
                    case 3:
                        if (!(offset < end)) return [3 /*break*/, 5];
    ...
    MemoryIndexManager.prototype.shouldSyncSessions = function (params, needsFullReindex) {
        if (needsFullReindex === void 0) { needsFullReindex = false; }
    ...
    MemoryIndexManager.prototype.syncMemoryFiles = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, internal_js_1.listMemoryFiles)(this.workspaceDir, this.settings.extraPaths)];
                    case 1:
                        files = _a.sent();
                        return [4 /*yield*/, Promise.all(files.map(function (file) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                                return [2 /*return*/, (0, internal_js_1.buildFileEntry)(file, this.workspaceDir)];
                            }); }); }))];
                    case 2:
                        fileEntries = _a.sent();
                        ...
                        activePaths = new Set(fileEntries.map(function (entry) { return entry.path; }));
                        if (params.progress) {
                        ...
                        tasks = fileEntries.map(function (entry) { return function () { return __awaiter(_this, void 0, void 0, function () {
                            var record;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        if (!params.needsFullReindex && (record === null || record === void 0 ? void 0 : record.hash) === entry.hash) {
                                            if (params.progress) {
                    ...
                    case 3:
                        ...
                        for (_i = 0, staleRows_1 = staleRows; _i < staleRows_1.length; _i++) {
                            ...
                            try {
                                this.db
                                    .prepare("DELETE FROM ".concat(VECTOR_TABLE, " WHERE id IN (SELECT id FROM chunks WHERE path = ? AND source = ?)"))
                            ...
                            if (this.fts.enabled && this.fts.available) {
                                try {
                                    this.db
                                        .prepare("DELETE FROM ".concat(FTS_TABLE, " WHERE path = ? AND source = ? AND model = ?"))
    ...
    MemoryIndexManager.prototype.syncSessionFiles = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.listSessionFiles()];
                    case 1:
                        files = _a.sent();
                        activePaths = new Set(files.map(function (file) { return _this.sessionPathForFile(file); }));
                        ...
                        tasks = files.map(function (absPath) { return function () { return __awaiter(_this, void 0, void 0, function () {
                            var entry, record;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                    ...
                                    case 1:
                                        ...
                                        return [4 /*yield*/, this.indexFile(entry, { source: "sessions", content: entry.content })];
                                    case 2:
                                        _a.sent();
                                        this.resetSessionDelta(absPath, entry.size);
                                        if (params.progress) {
    ...
    MemoryIndexManager.prototype.createSyncProgress = function (onProgress) {
        var state = {
            ...
            report: function (update) {
                ...
                var label = update.total > 0 && state.label
    ...
    MemoryIndexManager.prototype.runSync = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var progress, vectorReady, meta, needsFullReindex, shouldSyncMemory, shouldSyncSessions, err_6, reason, activated, _a;
            var _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        progress = (params === null || params === void 0 ? void 0 : params.progress) ? this.createSyncProgress(params.progress) : undefined;
                        if (progress) {
                            progress.report({
                    ...
                    case 1:
                        vectorReady = _c.sent();
                        meta = this.readMeta();
                        needsFullReindex = (params === null || params === void 0 ? void 0 : params.force) ||
                            !meta ||
                    ...
                    case 2:
                        ...
                        if (!needsFullReindex) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.runSafeReindex({
                    ...
                    case 3:
                        ...
                        return [2 /*return*/];
                    case 4:
                        shouldSyncMemory = this.sources.has("memory") && ((params === null || params === void 0 ? void 0 : params.force) || needsFullReindex || this.dirty);
                        shouldSyncSessions = this.shouldSyncSessions(params, needsFullReindex);
                        if (!shouldSyncMemory) return [3 /*break*/, 6];
                        return [4 /*yield*/, this.syncMemoryFiles({ needsFullReindex: needsFullReindex, progress: progress !== null && progress !== void 0 ? progress : undefined })];
                    case 5:
                        _c.sent();
                        this.dirty = false;
                        _c.label = 6;
                    case 6:
                        if (!shouldSyncSessions) return [3 /*break*/, 8];
                        return [4 /*yield*/, this.syncSessionFiles({ needsFullReindex: needsFullReindex, progress: progress !== null && progress !== void 0 ? progress : undefined })];
                    case 7:
                        _c.sent();
                        this.sessionsDirty = false;
                    ...
                    case 12:
                        activated = _a;
                        if (!activated) return [3 /*break*/, 14];
                        return [4 /*yield*/, this.runSafeReindex({
                                reason: (_b = params === null || params === void 0 ? void 0 : params.reason) !== null && _b !== void 0 ? _b : "fallback",
                                force: true,
                                progress: progress !== null && progress !== void 0 ? progress : undefined,
                            })];
                    case 13:
    ...
    MemoryIndexManager.prototype.resolveBatchConfig = function () {
        ...
        var enabled = Boolean((batch === null || batch === void 0 ? void 0 : batch.enabled) &&
            ((this.openAi && this.provider.id === "openai") ||
                (this.gemini && this.provider.id === "gemini")));
        return {
            enabled: enabled,
            wait: (_b = batch === null || batch === void 0 ? void 0 : batch.wait) !== null && _b !== void 0 ? _b : true,
            concurrency: Math.max(1, (_c = batch === null || batch === void 0 ? void 0 : batch.concurrency) !== null && _c !== void 0 ? _c : 2),
            pollIntervalMs: (_d = batch === null || batch === void 0 ? void 0 : batch.pollIntervalMs) !== null && _d !== void 0 ? _d : 2000,
            timeoutMs: ((_e = batch === null || batch === void 0 ? void 0 : batch.timeoutMinutes) !== null && _e !== void 0 ? _e : 60) * 60 * 1000,
        };
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.providerKey = this.computeProviderKey();
                        this.batch = this.resolveBatchConfig();
                        log.warn("memory embeddings: switched to fallback provider (".concat(fallback, ")"), { reason: reason });
                        return [2 /*return*/, true];
                }
            });
        });
    ...
    MemoryIndexManager.prototype.runSafeReindex = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var dbPath, tempDbPath, tempDb, originalDb, originalDbClosed, originalState, restoreOriginalState, nextMeta, shouldSyncMemory, shouldSyncSessions, err_7;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        shouldSyncSessions = this.shouldSyncSessions({ reason: params.reason, force: params.force }, true);
                        if (!shouldSyncMemory) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.syncMemoryFiles({ needsFullReindex: true, progress: params.progress })];
                    case 2:
                        _a.sent();
                        this.dirty = false;
                        _a.label = 3;
                    case 3:
                        if (!shouldSyncSessions) return [3 /*break*/, 5];
                        return [4 /*yield*/, this.syncSessionFiles({ needsFullReindex: true, progress: params.progress })];
                    case 4:
                        _a.sent();
                        this.sessionsDirty = false;
                        this.sessionsDirtyFiles.clear();
    ...
    MemoryIndexManager.prototype.buildSessionEntry = function (absPath) {
        return __awaiter(this, void 0, void 0, function () {
            var stat, raw, lines, collected, _i, lines_1, line, record, message, text, label, content, err_8;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
    ...
    MemoryIndexManager.prototype.loadEmbeddingCache = function (hashes) {
        ...
        for (var start = 0; start < unique.length; start += batchSize) {
            ...
            var rows = (_a = this.db
                .prepare("SELECT hash, embedding FROM ".concat(EMBEDDING_CACHE_TABLE, "\n") +
                " WHERE provider = ? AND model = ? AND provider_key = ? AND hash IN (".concat(placeholders, ")")))
    ...
    MemoryIndexManager.prototype.upsertEmbeddingCache = function (entries) {
        ...
        if (entries.length === 0)
            return;
        var now = Date.now();
        var stmt = this.db.prepare("INSERT INTO ".concat(EMBEDDING_CACHE_TABLE, " (provider, model, provider_key, hash, embedding, dims, updated_at)\n") +
            " VALUES (?, ?, ?, ?, ?, ?, ?)\n" +
            " ON CONFLICT(provider, model, provider_key, hash) DO UPDATE SET\n" +
            "   embedding=excluded.embedding,\n" +
            "   dims=excluded.dims,\n" +
    ...
    MemoryIndexManager.prototype.pruneEmbeddingCacheIfNeeded = function () {
        ...
        var count = (_a = row === null || row === void 0 ? void 0 : row.c) !== null && _a !== void 0 ? _a : 0;
        if (count <= max)
            return;
        var excess = count - max;
        this.db
            .prepare("DELETE FROM ".concat(EMBEDDING_CACHE_TABLE, "\n") +
            " WHERE rowid IN (\n" +
    ...
    MemoryIndexManager.prototype.embedChunksInBatches = function (chunks) {
        return __awaiter(this, void 0, void 0, function () {
            var cached, embeddings, missing, i, chunk, hit, missingChunks, batches, toCache, cursor, _i, batches_1, batch, batchEmbeddings, i, item, embedding;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (chunks.length === 0)
                            return [2 /*return*/, []];
                        cached = this.loadEmbeddingCache(chunks.map(function (chunk) { return chunk.hash; }));
                        embeddings = Array.from({ length: chunks.length }, function () { return []; });
                        missing = [];
                        for (i = 0; i < chunks.length; i += 1) {
                            chunk = chunks[i];
                            hit = (chunk === null || chunk === void 0 ? void 0 : chunk.hash) ? cached.get(chunk.hash) : undefined;
                            if (hit && hit.length > 0) {
                                embeddings[i] = hit;
                            }
                            else if (chunk) {
                        ...
                        missingChunks = missing.map(function (m) { return m.chunk; });
                    ...
                    case 1:
                        ...
                        batch = batches_1[_i];
                        return [4 /*yield*/, this.embedBatchWithRetry(batch.map(function (chunk) { return chunk.text; }))];
                    case 2:
    ...
    MemoryIndexManager.prototype.computeProviderKey = function () {
        ...
        return (0, internal_js_1.hashText)(JSON.stringify({ provider: this.provider.id, model: this.provider.model }));
    };
    ...
    MemoryIndexManager.prototype.embedChunksWithOpenAiBatch = function (chunks, entry, source) {
        return __awaiter(this, void 0, void 0, function () {
            var openAi, cached, embeddings, missing, i, chunk, hit, requests, mapping, _i, missing_1, item, chunk, customId, batchResult, byCustomId, toCache, _a, _b, _c, customId, embedding, mapped;
            var _this = this;
            var _d, _e;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        ...
                        for (_i = 0, missing_1 = missing; _i < missing_1.length; _i++) {
                            item = missing_1[_i];
                            chunk = item.chunk;
                            customId = (0, internal_js_1.hashText)("".concat(source, ":").concat(entry.path, ":").concat(chunk.startLine, ":").concat(chunk.endLine, ":").concat(chunk.hash, ":").concat(item.index));
                            ...
                            requests.push({
                                ...
                                body: {
                                    model: (_e = (_d = this.openAi) === null || _d === void 0 ? void 0 : _d.model) !== null && _e !== void 0 ? _e : this.provider.model,
                                    input: chunk.text,
                                },
                            });
                        }
                        return [4 /*yield*/, this.runBatchWithFallback({
                                provider: "openai",
                                run: function () { return __awaiter(_this, void 0, void 0, function () {
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0: return [4 /*yield*/, (0, batch_openai_js_1.runOpenAiEmbeddingBatches)({
                                                    openAi: openAi,
                                                    ...
                                                    pollIntervalMs: this.batch.pollIntervalMs,
                                                    timeoutMs: this.batch.timeoutMs,
                                                    debug: function (message, data) { return log.debug(message, __assign(__assign({}, data), { source: source, chunks: chunks.length })); },
                                                })];
                                            case 1: return [2 /*return*/, _a.sent()];
                                        }
                                    });
                                }); },
                                fallback: function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, this.embedChunksInBatches(chunks)];
                                        case 1: return [2 /*return*/, _a.sent()];
                                    }
                                }); }); },
                            })];
    ...
    MemoryIndexManager.prototype.embedChunksWithGeminiBatch = function (chunks, entry, source) {
        return __awaiter(this, void 0, void 0, function () {
            var gemini, cached, embeddings, missing, i, chunk, hit, requests, mapping, _i, missing_2, item, chunk, customId, batchResult, byCustomId, toCache, _a, _b, _c, customId, embedding, mapped;
            var _this = this;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.runBatchWithFallback({
                                ...
                                run: function () { return __awaiter(_this, void 0, void 0, function () {
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0: return [4 /*yield*/, (0, batch_gemini_js_1.runGeminiEmbeddingBatches)({
                                                    gemini: gemini,
                                                    agentId: this.agentId,
                                                    requests: requests,
                                                    wait: this.batch.wait,
                            ...
                            return __generator(this, function (_c) {
                                switch (_c.label) {
                                    case 0:
                                        ...
                                        _b = {};
                                        return [4 /*yield*/, this_1.withTimeout(this_1.provider.embedBatch(texts), timeoutMs, "memory embeddings batch timed out after ".concat(Math.round(timeoutMs / 1000), "s"))];
                                    case 1: return [2 /*return*/, (_b.value = _c.sent(), _b)];
                                    case 2:
                                        err_9 = _c.sent();
                                        message = err_9 instanceof Error ? err_9.message : String(err_9);
                                        if (!this_1.isRetryableEmbeddingError(message) || attempt >= EMBEDDING_RETRY_MAX_ATTEMPTS) {
                                            throw err_9;
                                        }
                                        waitMs_1 = Math.min(EMBEDDING_RETRY_MAX_DELAY_MS, Math.round(delayMs * (1 + Math.random() * 0.2)));
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        log.debug("memory embeddings: query start", { provider: this.provider.id, timeoutMs: timeoutMs });
                        return [4 /*yield*/, this.withTimeout(this.provider.embedQuery(text), timeoutMs, "memory embeddings query timed out after ".concat(Math.round(timeoutMs / 1000), "s"))];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    MemoryIndexManager.prototype.withTimeout = function (promise, timeoutMs, message) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(!Number.isFinite(timeoutMs) || timeoutMs <= 0)) return [3 /*break*/, 2];
                        return [4 /*yield*/, promise];
                    case 1: return [2 /*return*/, _a.sent()];
                    case 2:
                        timer = null;
                        timeoutPromise = new Promise(function (_, reject) {
                            timer = setTimeout(function () { return reject(new Error(message)); }, timeoutMs);
                        });
                        _a.label = 3;
                    case 3:
                        _a.trys.push([3, , 5, 6]);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        next = 0;
                        firstError = null;
                        workers = Array.from({ length: resolvedLimit }, function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    MemoryIndexManager.prototype.resetBatchFailureCount = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.withBatchFailureLock(function () { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (!this.isBatchTimeoutError(message)) return [3 /*break*/, 6];
                        log.warn("memory embeddings: ".concat(params.provider, " batch timed out; retrying once"));
                        _a.label = 3;
                    case 3:
                        _a.trys.push([3, 5, , 6]);
                        return [4 /*yield*/, params.run()];
    ...
    MemoryIndexManager.prototype.runBatchWithFallback = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!!this.batch.enabled) return [3 /*break*/, 2];
                        return [4 /*yield*/, params.fallback()];
                    case 1: return [2 /*return*/, _b.sent()];
                    case 2:
                        _b.trys.push([2, 5, , 8]);
                        return [4 /*yield*/, this.runBatchWithTimeoutRetry({
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, this.recordBatchFailure({
                                provider: params.provider,
                                message: message,
                                attempts: attempts,
                    ...
                    case 6:
                        ...
                        log.warn("memory embeddings: ".concat(params.provider, " batch failed (").concat(failure.count, "/").concat(BATCH_FAILURE_LIMIT, "); ").concat(suffix, "; falling back to non-batch embeddings: ").concat(message));
                        return [4 /*yield*/, params.fallback()];
    ...
    MemoryIndexManager.prototype.indexFile = function (entry, options) {
        return __awaiter(this, void 0, void 0, function () {
            var content, _a, chunks, embeddings, _b, sample, vectorReady, _c, now, i, chunk, embedding, id;
            var _d, _e;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        if (!((_d = options.content) !== null && _d !== void 0)) return [3 /*break*/, 1];
                        _a = _d;
                        return [3 /*break*/, 3];
                    case 1: return [4 /*yield*/, promises_1.default.readFile(entry.absPath, "utf-8")];
                    case 2:
                        _a = (_f.sent());
                        _f.label = 3;
                    case 3:
                        content = _a;
                        chunks = (0, internal_js_1.chunkMarkdown)(content, this.settings.chunking).filter(function (chunk) { return chunk.text.trim().length > 0; });
                        if (!this.batch.enabled) return [3 /*break*/, 5];
                        return [4 /*yield*/, this.embedChunksWithBatch(chunks, entry, options.source)];
                    case 4:
                        _b = _f.sent();
                        return [3 /*break*/, 7];
                    case 5: return [4 /*yield*/, this.embedChunksInBatches(chunks)];
                    case 6:
                        _b = _f.sent();
                        _f.label = 7;
                    case 7:
                        embeddings = _b;
                        sample = embeddings.find(function (embedding) { return embedding.length > 0; });
                        if (!sample) return [3 /*break*/, 9];
                    ...
                    case 10:
                        ...
                        for (i = 0; i < chunks.length; i++) {
                            ...
                            id = (0, internal_js_1.hashText)("".concat(options.source, ":").concat(entry.path, ":").concat(chunk.startLine, ":").concat(chunk.endLine, ":").concat(chunk.hash, ":").concat(this.provider.model));
                            this.db
                            ...
                            if (this.fts.enabled && this.fts.available) {
                                this.db
                                    .prepare("INSERT INTO ".concat(FTS_TABLE, " (text, id, path, source, model, start_line, end_line)\n") +
                                    " VALUES (?, ?, ?, ?, ?, ?, ?)")
