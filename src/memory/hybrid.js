...
function buildFtsQuery(raw) {
    var _a, _b;
    var tokens = (_b = (_a = raw
        .match(/[A-Za-z0-9_]+/g)) === null || _a === void 0 ? void 0 : _a.map(function (t) { return t.trim(); }).filter(Boolean)) !== null && _b !== void 0 ? _b : [];
    if (tokens.length === 0)
        return null;
    var quoted = tokens.map(function (t) { return "\"".concat(t.replaceAll('"', ""), "\""); });
...
function mergeHybridResults(params) {
    ...
    return merged.sort(function (a, b) { return b.score - a.score; });
}
