...
function createGeminiEmbeddingProvider(options) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, resolveGeminiEmbeddingClient(options)];
                case 1:
                    client = _a.sent();
                    ...
                    embedQuery = function (text) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                ...
                                case 2:
                                    payload_1 = _c.sent();
                                    throw new Error("gemini embeddings failed: ".concat(res.status, " ").concat(payload_1));
                                case 3: return [4 /*yield*/, res.json()];
                                case 4:
                                    payload = (_c.sent());
                                    return [2 /*return*/, (_b = (_a = payload.embedding) === null || _a === void 0 ? void 0 : _a.values) !== null && _b !== void 0 ? _b : []];
                            }
                        });
                    }); };
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    if (texts.length === 0)
                                        return [2 /*return*/, []];
                                    requests = texts.map(function (text) { return ({
                                ...
                                case 2:
                                    payload_2 = _a.sent();
                                    throw new Error("gemini embeddings failed: ".concat(res.status, " ").concat(payload_2));
                                case 3: return [4 /*yield*/, res.json()];
                                case 4:
                                    payload = (_a.sent());
                                    embeddings = Array.isArray(payload.embeddings) ? payload.embeddings : [];
                                    return [2 /*return*/, texts.map(function (_, index) { var _a, _b; return (_b = (_a = embeddings[index]) === null || _a === void 0 ? void 0 : _a.values) !== null && _b !== void 0 ? _b : []; })];
                            }
                        });
                    }); };
                    return [2 /*return*/, {
...
function resolveGeminiEmbeddingClient(options) {
    return __awaiter(this, void 0, void 0, function () {
        var remote, remoteApiKey, remoteBaseUrl, apiKey, _a, _b, providerConfig, rawBaseUrl, baseUrl, headerOverrides, headers, model, modelPath;
        var _c, _d, _e, _f;
        return __generator(this, function (_g) {
            switch (_g.label) {
                case 0:
                    remote = options.remote;
                    remoteApiKey = resolveRemoteApiKey(remote === null || remote === void 0 ? void 0 : remote.apiKey);
                    remoteBaseUrl = (_c = remote === null || remote === void 0 ? void 0 : remote.baseUrl) === null || _c === void 0 ? void 0 : _c.trim();
                    if (!remoteApiKey) return [3 /*break*/, 1];
                    _a = remoteApiKey;
                    return [3 /*break*/, 3];
                case 1:
                ...
                case 3:
                    apiKey = _a;
                    providerConfig = (_e = (_d = options.config.models) === null || _d === void 0 ? void 0 : _d.providers) === null || _e === void 0 ? void 0 : _e.google;
                    rawBaseUrl = remoteBaseUrl || ((_f = providerConfig === null || providerConfig === void 0 ? void 0 : providerConfig.baseUrl) === null || _f === void 0 ? void 0 : _f.trim()) || DEFAULT_GEMINI_BASE_URL;
                    baseUrl = normalizeGeminiBaseUrl(rawBaseUrl);
                    headerOverrides = Object.assign({}, providerConfig === null || providerConfig === void 0 ? void 0 : providerConfig.headers, remote === null || remote === void 0 ? void 0 : remote.headers);
                    headers = __assign({ "Content-Type": "application/json", "x-goog-api-key": apiKey }, headerOverrides);
                    ...
                    return [2 /*return*/, { baseUrl: baseUrl, headers: headers, model: model, modelPath: modelPath }];
            }
        });
    });
}
