        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    err_1 = _b.sent();
                    if ((0, globals_js_1.shouldLogVerbose)()) {
                        (0, logger_js_1.logError)((0, globals_js_1.danger)("Command failed: ".concat(command, " ").concat(args.join(" "))));
                    }
                    throw err_1;
...
function runCommandWithTimeout(argv, optionsOrTimeout) {
    return __awaiter(this, void 0, void 0, function () {
        var options, timeoutMs, cwd, input, env, windowsVerbatimArguments, hasInput, shouldSuppressNpmFund, resolvedEnv, stdio, child;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    options = typeof optionsOrTimeout === "number" ? { timeoutMs: optionsOrTimeout } : optionsOrTimeout;
                    timeoutMs = options.timeoutMs, cwd = options.cwd, input = options.input, env = options.env;
                    windowsVerbatimArguments = options.windowsVerbatimArguments;
                    hasInput = input !== undefined;
                    shouldSuppressNpmFund = (function () {
                        var _a, _b;
                        var cmd = node_path_1.default.basename((_a = argv[0]) !== null && _a !== void 0 ? _a : "");
                    ...
                    stdio = (0, spawn_utils_js_1.resolveCommandStdio)({ hasInput: hasInput, preferInherit: true });
                    ...
                    return [4 /*yield*/, new Promise(function (resolve, reject) {
                            ...
                            child.on("close", function (code, signal) {
                                ...
                                settled = true;
                                clearTimeout(timer);
                                resolve({ stdout: stdout, stderr: stderr, code: code, signal: signal, killed: child.killed });
                            });
                        })];
                case 1: 
