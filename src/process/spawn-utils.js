...
function formatSpawnError(err) {
    ...
    if (message)
        parts.push(message);
    if (details.code && !(message === null || message === void 0 ? void 0 : message.includes(details.code)))
...
function spawnWithFallback(params) {
    return __awaiter(this, void 0, void 0, function () {
        var spawnImpl, retryCodes, baseOptions, fallbacks, attempts, lastError, index, attempt, child, err_1, nextFallback;
        var _a, _b, _c, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    spawnImpl = (_a = params.spawnImpl) !== null && _a !== void 0 ? _a : node_child_process_1.spawn;
                    retryCodes = (_b = params.retryCodes) !== null && _b !== void 0 ? _b : DEFAULT_RETRY_CODES;
                    baseOptions = __assign({}, params.options);
                    fallbacks = (_c = params.fallbacks) !== null && _c !== void 0 ? _c : [];
                    attempts = __spreadArray([
                        { options: baseOptions }
                    ], fallbacks.map(function (fallback) { return ({
                    ...
                    _e.label = 1;
                case 1:
                    if (!(index < attempts.length)) return [3 /*break*/, 6];
                ...
                case 4:
                    ...
                    (_d = params.onFallback) === null || _d === void 0 ? void 0 : _d.call(params, err_1, nextFallback);
                    return [3 /*break*/, 5];
                case 5:
                    index += 1;
                    return [3 /*break*/, 1];
