...
function resolveSettings() {
    var _a, _b, _c;
    var cfg = (_a = state_js_1.loggingState.overrideSettings) !== null && _a !== void 0 ? _a : (0, config_js_1.readLoggingConfig)();
    if (!cfg) {
        try {
    ...
    var level = (0, levels_js_1.normalizeLogLevel)(cfg === null || cfg === void 0 ? void 0 : cfg.level, "info");
    var file = (_c = cfg === null || cfg === void 0 ? void 0 : cfg.file) !== null && _c !== void 0 ? _c : defaultRollingPathForToday();
...
function isFileLogLevelEnabled(level) {
    var _a;
    var settings = (_a = state_js_1.loggingState.cachedSettings) !== null && _a !== void 0 ? _a : resolveSettings();
    if (!state_js_1.loggingState.cachedSettings)
        state_js_1.loggingState.cachedSettings = settings;
    if (settings.level === "silent")
        return false;
    return (0, levels_js_1.levelToMinLevel)(level) <= (0, levels_js_1.levelToMinLevel)(settings.level);
}
function buildLogger(settings) {
    ...
    logger.attachTransport(function (logObj) {
        var _a, _b, _c;
        try {
            var time = (_c = (_b = (_a = logObj.date) === null || _a === void 0 ? void 0 : _a.toISOString) === null || _b === void 0 ? void 0 : _b.call(_a)) !== null && _c !== void 0 ? _c : new Date().toISOString();
    ...
    for (var _i = 0, externalTransports_1 = externalTransports; _i < externalTransports_1.length; _i++) {
...
function getChildLogger(bindings, opts) {
    var base = getLogger();
    var minLevel = (opts === null || opts === void 0 ? void 0 : opts.level) ? (0, levels_js_1.levelToMinLevel)(opts.level) : undefined;
...
function toPinoLikeLogger(logger, level) {
    var buildChild = function (bindings) {
        return toPinoLikeLogger(logger.getSubLogger({
...
function defaultRollingPathForToday() {
    ...
    return node_path_1.default.join(exports.DEFAULT_LOG_DIR, "".concat(LOG_PREFIX, "-").concat(today).concat(LOG_SUFFIX));
}
function isRollingPath(file) {
    var base = node_path_1.default.basename(file);
    return (base.startsWith("".concat(LOG_PREFIX, "-")) &&
