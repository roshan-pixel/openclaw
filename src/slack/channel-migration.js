...
function resolveAccountChannels(cfg, accountId) {
    ...
    var matchKey = Object.keys(accounts).find(function (key) { return key.toLowerCase() === normalized.toLowerCase(); });
    return { channels: matchKey ? (_c = accounts[matchKey]) === null || _c === void 0 ? void 0 : _c.channels : undefined };
}
...
function migrateSlackChannelConfig(params) {
    ...
    if (accountChannels) {
        var result = migrateSlackChannelsInPlace(accountChannels, params.oldChannelId, params.newChannelId);
        if (result.migrated) {
            migrated = true;
            scopes.push("account");
        }
    ...
    var globalChannels = (_b = (_a = params.cfg.channels) === null || _a === void 0 ? void 0 : _a.slack) === null || _b === void 0 ? void 0 : _b.channels;
    if (globalChannels) {
        var result = migrateSlackChannelsInPlace(globalChannels, params.oldChannelId, params.newChannelId);
        if (result.migrated) {
            migrated = true;
            scopes.push("global");
        }
