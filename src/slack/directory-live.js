...
function resolveReadToken(params) {
    var _a, _b;
    var account = (0, accounts_js_1.resolveSlackAccount)({ cfg: params.cfg, accountId: params.accountId });
    var userToken = ((_a = account.config.userToken) === null || _a === void 0 ? void 0 : _a.trim()) || undefined;
    return userToken !== null && userToken !== void 0 ? userToken : (_b = account.botToken) === null || _b === void 0 ? void 0 : _b.trim();
}
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    next = (_b = (_a = res.response_metadata) === null || _a === void 0 ? void 0 : _a.next_cursor) === null || _b === void 0 ? void 0 : _b.trim();
                ...
                case 4:
                    filtered = members.filter(function (member) {
                        var _a, _b, _c;
                        var name = ((_a = member.profile) === null || _a === void 0 ? void 0 : _a.display_name) || ((_b = member.profile) === null || _b === void 0 ? void 0 : _b.real_name) || member.real_name;
                        var handle = member.name;
                        var email = (_c = member.profile) === null || _c === void 0 ? void 0 : _c.email;
                        var candidates = [name, handle, email]
                            .map(function (item) { return item === null || item === void 0 ? void 0 : item.trim().toLowerCase(); })
                            .filter(Boolean);
                        if (!query)
                            return true;
                        return candidates.some(function (candidate) { return candidate === null || candidate === void 0 ? void 0 : candidate.includes(query); });
                    });
                    rows = filtered
                        .map(function (member) {
                        ...
                        var display = ((_d = (_c = member.profile) === null || _c === void 0 ? void 0 : _c.display_name) === null || _d === void 0 ? void 0 : _d.trim()) ||
                            ((_f = (_e = member.profile) === null || _e === void 0 ? void 0 : _e.real_name) === null || _f === void 0 ? void 0 : _f.trim()) ||
            ...
            switch (_c.label) {
                ...
                case 4:
                    filtered = channels.filter(function (channel) {
                        var _a;
                        var name = (_a = channel.name) === null || _a === void 0 ? void 0 : _a.trim().toLowerCase();
                        if (!query)
                            return true;
