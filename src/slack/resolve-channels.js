    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_g) {
            switch (_g.label) {
                ...
                case 2:
                    res = (_g.sent());
                    for (_i = 0, _a = (_b = res.channels) !== null && _b !== void 0 ? _b : []; _i < _a.length; _i++) {
                        channel = _a[_i];
                    ...
                    next = (_f = (_e = res.response_metadata) === null || _e === void 0 ? void 0 : _e.next_cursor) === null || _f === void 0 ? void 0 : _f.trim();
...
function resolveByName(name, channels) {
    ...
    if (!target)
        return undefined;
    var matches = channels.filter(function (channel) { return channel.name.toLowerCase() === target; });
    if (matches.length === 0)
        return undefined;
    var active = matches.find(function (channel) { return !channel.archived; });
            ...
            switch (_d.label) {
                ...
                case 1:
                    ...
                    _loop_1 = function (input) {
                        ...
                        if (parsed.id) {
                            var match = channels.find(function (channel) { return channel.id === parsed.id; });
                            results.push({
                                input: input,
                                resolved: true,
                                id: parsed.id,
                                name: (_c = match === null || match === void 0 ? void 0 : match.name) !== null && _c !== void 0 ? _c : parsed.name,
