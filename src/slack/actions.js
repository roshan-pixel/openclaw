...
function resolveToken(explicit, accountId) {
    ...
    var token = (0, token_js_1.resolveSlackBotToken)((_a = explicit !== null && explicit !== void 0 ? explicit : account.botToken) !== null && _a !== void 0 ? _a : undefined);
    if (!token) {
        (0, globals_js_1.logVerbose)("slack actions: missing bot token for account=".concat(account.accountId, " explicit=").concat(Boolean(explicit), " source=").concat((_b = account.botTokenSource) !== null && _b !== void 0 ? _b : "unknown"));
...
function getClient() {
    return __awaiter(this, arguments, void 0, function (opts) {
        ...
        return __generator(this, function (_b) {
            ...
            return [2 /*return*/, (_a = opts.client) !== null && _a !== void 0 ? _a : (0, client_js_1.createSlackWebClient)(token)];
        });
    });
}
...
function reactSlackMessage(channelId_1, messageId_1, emoji_1) {
    return __awaiter(this, arguments, void 0, function (channelId, messageId, emoji, opts) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getClient(opts)];
                case 1:
                    client = _a.sent();
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    reactions = _c.sent();
                    toRemove = new Set();
                    for (_i = 0, _a = reactions !== null && reactions !== void 0 ? reactions : []; _i < _a.length; _i++) {
                        reaction = _a[_i];
                        name_1 = reaction === null || reaction === void 0 ? void 0 : reaction.name;
                        if (!name_1)
                            continue;
                        users = (_b = reaction === null || reaction === void 0 ? void 0 : reaction.users) !== null && _b !== void 0 ? _b : [];
                    ...
                    if (toRemove.size === 0)
                        return [2 /*return*/, []];
                    return [4 /*yield*/, Promise.all(Array.from(toRemove, function (name) {
    ...
    return __awaiter(this, arguments, void 0, function (channelId, messageId, opts) {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    client = _b.sent();
                    return [4 /*yield*/, client.reactions.get({
                            channel: channelId,
                            timestamp: messageId,
                            full: true,
                        })];
                case 2:
                    ...
                    return [2 /*return*/, (_a = message === null || message === void 0 ? void 0 : message.reactions) !== null && _a !== void 0 ? _a : []];
            }
        });
    });
}
function sendSlackMessage(to_1, content_1) {
    return __awaiter(this, arguments, void 0, function (to, content, opts) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, send_js_1.sendMessageSlack)(to, content, {
    ...
    return __awaiter(this, arguments, void 0, function (channelId, opts) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    client = _c.sent();
                    if (!opts.threadId) return [3 /*break*/, 3];
                ...
                case 2:
                    ...
                    return [2 /*return*/, {
                            ...
                            messages: ((_a = result_1.messages) !== null && _a !== void 0 ? _a : []).filter(function (message) { return (message === null || message === void 0 ? void 0 : message.ts) !== opts.threadId; }),
                            hasMore: Boolean(result_1.has_more),
                        }];
                case 3: return [4 /*yield*/, client.conversations.history({
                        channel: channelId,
                        limit: opts.limit,
                        latest: opts.before,
                        oldest: opts.after,
