...
function listConfiguredAccountIds(cfg) {
    var _a, _b;
    var accounts = (_b = (_a = cfg.channels) === null || _a === void 0 ? void 0 : _a.slack) === null || _b === void 0 ? void 0 : _b.accounts;
...
function mergeSlackAccountConfig(cfg, accountId) {
    var _a, _b, _c;
    var _d = ((_b = (_a = cfg.channels) === null || _a === void 0 ? void 0 : _a.slack) !== null && _b !== void 0 ? _b : {}), _ignored = _d.accounts, base = __rest(_d, ["accounts"]);
...
function resolveSlackAccount(params) {
    ...
    var baseEnabled = ((_b = (_a = params.cfg.channels) === null || _a === void 0 ? void 0 : _a.slack) === null || _b === void 0 ? void 0 : _b.enabled) !== false;
    ...
    var envBot = allowEnv ? (0, token_js_1.resolveSlackBotToken)(process.env.SLACK_BOT_TOKEN) : undefined;
    var envApp = allowEnv ? (0, token_js_1.resolveSlackAppToken)(process.env.SLACK_APP_TOKEN) : undefined;
...
function listEnabledSlackAccounts(cfg) {
    return listSlackAccountIds(cfg)
        .map(function (accountId) { return resolveSlackAccount({ cfg: cfg, accountId: accountId }); })
        .filter(function (account) { return account.enabled; });
}
function resolveSlackReplyToMode(account, chatType) {
    var _a, _b, _c, _d;
    var normalized = (0, chat_type_js_1.normalizeChatType)(chatType !== null && chatType !== void 0 ? chatType : undefined);
    if (normalized && ((_a = account.replyToModeByChatType) === null || _a === void 0 ? void 0 : _a[normalized]) !== undefined) {
        return (_b = account.replyToModeByChatType[normalized]) !== null && _b !== void 0 ? _b : "off";
    }
    if (normalized === "direct" && ((_c = account.dm) === null || _c === void 0 ? void 0 : _c.replyToMode) !== undefined) {
