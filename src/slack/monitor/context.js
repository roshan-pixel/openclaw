...
function normalizeSlackChannelType(channelType, channelId) {
    var _a;
    var normalized = channelType === null || channelType === void 0 ? void 0 : channelType.trim().toLowerCase();
    if (normalized === "im" ||
        normalized === "mpim" ||
        normalized === "channel" ||
        normalized === "group") {
...
function createSlackMonitorContext(params) {
    ...
    var defaultRequireMention = (_a = params.defaultRequireMention) !== null && _a !== void 0 ? _a : true;
    ...
    var resolveSlackSystemEventSessionKey = function (p) {
        var _a, _b;
        var channelId = (_b = (_a = p.channelId) === null || _a === void 0 ? void 0 : _a.trim()) !== null && _b !== void 0 ? _b : "";
        if (!channelId)
        ...
        return (0, sessions_js_1.resolveSessionKey)(params.sessionScope, { From: from, ChatType: chatType, Provider: "slack" }, params.mainKey);
    };
    var resolveChannelName = function (channelId) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_g) {
            switch (_g.label) {
                ...
                case 1:
                    _g.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, params.app.client.conversations.info({
                        ...
                        : (channel === null || channel === void 0 ? void 0 : channel.is_mpim)
                            ...
                            : (channel === null || channel === void 0 ? void 0 : channel.is_channel)
                                ...
                                : (channel === null || channel === void 0 ? void 0 : channel.is_group)
                                    ? "group"
                                    : undefined;
                    topic = channel && "topic" in channel ? ((_d = (_c = channel.topic) === null || _c === void 0 ? void 0 : _c.value) !== null && _d !== void 0 ? _d : undefined) : undefined;
                    purpose = channel && "purpose" in channel ? ((_f = (_e = channel.purpose) === null || _e === void 0 ? void 0 : _e.value) !== null && _f !== void 0 ? _f : undefined) : undefined;
    ...
    var resolveUserName = function (userId) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    _d.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, params.app.client.users.info({
                            token: params.botToken,
                            user: userId,
                        })];
                case 2:
                    ...
                    name_2 = (profile === null || profile === void 0 ? void 0 : profile.display_name) || (profile === null || profile === void 0 ? void 0 : profile.real_name) || ((_c = info.user) === null || _c === void 0 ? void 0 : _c.name) || undefined;
                    entry = { name: name_2 };
    ...
    var setSlackThreadStatus = function (p) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    _c.trys.push([1, 6, , 7]);
                    if (!((_b = (_a = client.assistant) === null || _a === void 0 ? void 0 : _a.threads) === null || _b === void 0 ? void 0 : _b.setStatus)) return [3 /*break*/, 3];
                    return [4 /*yield*/, client.assistant.threads.setStatus(payload)];
                case 2:
                    _c.sent();
                    return [2 /*return*/];
                case 3:
                    if (!(typeof client.apiCall === "function")) return [3 /*break*/, 5];
                ...
                case 6:
                    err_1 = _c.sent();
                    (0, globals_js_1.logVerbose)("slack status update failed for channel ".concat(p.channelId, ": ").concat(String(err_1)));
                    return [3 /*break*/, 7];
    ...
    var isChannelAllowed = function (p) {
        ...
        if (isGroupDm && groupDmChannels.length > 0) {
            ...
            var permitted = allowList_1.includes("*") || candidates.some(function (candidate) { return allowList_1.includes(candidate); });
            if (!permitted)
                return false;
        }
        if (isRoom && p.channelId) {
            ...
            var channelAllowed = (channelConfig === null || channelConfig === void 0 ? void 0 : channelConfig.allowed) !== false;
            var channelAllowlistConfigured = Boolean(params.channelsConfig) && Object.keys((_a = params.channelsConfig) !== null && _a !== void 0 ? _a : {}).length > 0;
            if (!(0, policy_js_1.isSlackChannelAllowedByPolicy)({
                ...
                (0, globals_js_1.logVerbose)("slack: drop channel ".concat(p.channelId, " (groupPolicy=").concat(params.groupPolicy, ", ").concat(channelMatchMeta, ")"));
                return false;
            }
            ...
            var hasExplicitConfig = Boolean(channelConfig === null || channelConfig === void 0 ? void 0 : channelConfig.matchSource);
            if (!channelAllowed && (params.groupPolicy !== "open" || hasExplicitConfig)) {
                (0, globals_js_1.logVerbose)("slack: drop channel ".concat(p.channelId, " (").concat(channelMatchMeta, ")"));
                return false;
            }
            (0, globals_js_1.logVerbose)("slack: allow channel ".concat(p.channelId, " (").concat(channelMatchMeta, ")"));
        }
        return true;
    };
    var shouldDropMismatchedSlackEvent = function (body) {
        ...
        if (params.apiAppId && incomingApiAppId && incomingApiAppId !== params.apiAppId) {
            (0, globals_js_1.logVerbose)("slack: drop event with api_app_id=".concat(incomingApiAppId, " (expected ").concat(params.apiAppId, ")"));
            return true;
        }
        if (params.teamId && incomingTeamId && incomingTeamId !== params.teamId) {
            (0, globals_js_1.logVerbose)("slack: drop event with team_id=".concat(incomingTeamId, " (expected ").concat(params.teamId, ")"));
            return true;
        }
        return false;
    };
