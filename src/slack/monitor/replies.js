...
function deliverReplies(params) {
    return __awaiter(this, void 0, void 0, function () {
        var _i, _a, payload, threadTs, mediaList, text, trimmed, first, _b, mediaList_1, mediaUrl, caption;
        var _c, _d, _e, _f, _g;
            ...
            switch (_h.label) {
                ...
                case 1:
                    ...
                    if (!text && mediaList.length === 0)
                        return [3 /*break*/, 8];
                    if (!(mediaList.length === 0)) return [3 /*break*/, 3];
                    trimmed = text.trim();
                    if (!trimmed || (0, tokens_js_1.isSilentReplyText)(trimmed, tokens_js_1.SILENT_REPLY_TOKEN))
                        return [3 /*break*/, 8];
                    return [4 /*yield*/, (0, send_js_1.sendMessageSlack)(params.target, trimmed, {
                            token: params.token,
                            threadTs: threadTs,
                ...
                case 3:
                    ...
                    _h.label = 4;
                case 4:
                    if (!(_b < mediaList_1.length)) return [3 /*break*/, 7];
                    mediaUrl = mediaList_1[_b];
                    caption = first ? text : "";
                    first = false;
                    return [4 /*yield*/, (0, send_js_1.sendMessageSlack)(params.target, caption, {
                            token: params.token,
                            mediaUrl: mediaUrl,
                            threadTs: threadTs,
                            accountId: params.accountId,
                ...
                case 6:
                    ...
                    return [3 /*break*/, 4];
                case 7:
                    (_g = (_f = params.runtime).log) === null || _g === void 0 ? void 0 : _g.call(_f, "delivered reply to ".concat(params.target));
                    _h.label = 8;
                case 8:
                    _i++;
                    return [3 /*break*/, 1];
...
function createSlackReplyDeliveryPlan(params) {
    ...
    return {
        nextThreadTs: function () { return replyReference.use(); },
        markSent: function () {
...
function deliverSlackSlashReplies(params) {
    return __awaiter(this, void 0, void 0, function () {
        var messages, chunkLimit, _i, _a, payload, textRaw, text, mediaList, combined, chunkMode, markdownChunks, chunks, _b, chunks_1, chunk, responseType, _c, messages_1, text;
        var _d, _e, _f, _g;
        return __generator(this, function (_h) {
            switch (_h.label) {
                case 0:
                    ...
                    for (_i = 0, _a = params.replies; _i < _a.length; _i++) {
                        payload = _a[_i];
                        textRaw = (_e = (_d = payload.text) === null || _d === void 0 ? void 0 : _d.trim()) !== null && _e !== void 0 ? _e : "";
                        text = textRaw && !(0, tokens_js_1.isSilentReplyText)(textRaw, tokens_js_1.SILENT_REPLY_TOKEN) ? textRaw : undefined;
                        mediaList = (_f = payload.mediaUrls) !== null && _f !== void 0 ? _f : (payload.mediaUrl ? [payload.mediaUrl] : []);
                        combined = __spreadArray([text !== null && text !== void 0 ? text : ""], mediaList.map(function (url) { return url.trim(); }).filter(Boolean), true).filter(Boolean)
                            .join("\n");
                        if (!combined)
                            continue;
                        ...
                        chunks = markdownChunks.flatMap(function (markdown) {
                            return (0, format_js_1.markdownToSlackMrkdwnChunks)(markdown, chunkLimit, { tableMode: params.tableMode });
                        });
