...
function resolveToken(params) {
    ...
    if (!fallback) {
        (0, globals_js_1.logVerbose)("slack send: missing bot token for account=".concat(params.accountId, " explicit=").concat(Boolean(params.explicit), " source=").concat((_a = params.fallbackSource) !== null && _a !== void 0 ? _a : "unknown"));
        throw new Error("Slack bot token missing for account \"".concat(params.accountId, "\" (set channels.slack.accounts.").concat(params.accountId, ".botToken or SLACK_BOT_TOKEN for default)."));
    }
    return fallback;
}
...
function uploadSlackFile(params) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_m) {
            switch (_m.label) {
                case 0: return [4 /*yield*/, (0, media_js_1.loadWebMedia)(params.mediaUrl, params.maxBytes)];
                case 1:
                    _a = _m.sent(), buffer = _a.buffer, _contentType = _a.contentType, fileName = _a.fileName;
                    basePayload = __assign({ channel_id: params.channelId, file: buffer, filename: fileName }, (params.caption ? { initial_comment: params.caption } : {}));
                    payload = params.threadTs
                        ? __assign(__assign({}, basePayload), { thread_ts: params.threadTs }) : basePayload;
                    return [4 /*yield*/, params.client.files.uploadV2(payload)];
                case 2:
                    response = _m.sent();
                    parsed = response;
                    fileId = (_l = (_j = (_f = (_d = (_c = (_b = parsed.files) === null || _b === void 0 ? void 0 : _b[0]) === null || _c === void 0 ? void 0 : _c.id) !== null && _d !== void 0 ? _d : (_e = parsed.file) === null || _e === void 0 ? void 0 : _e.id) !== null && _f !== void 0 ? _f : (_h = (_g = parsed.files) === null || _g === void 0 ? void 0 : _g[0]) === null || _h === void 0 ? void 0 : _h.name) !== null && _j !== void 0 ? _j : (_k = parsed.file) === null || _k === void 0 ? void 0 : _k.name) !== null && _l !== void 0 ? _l : "unknown";
...
function sendMessageSlack(to_1, message_1) {
    return __awaiter(this, arguments, void 0, function (to, message, opts) {
        var trimmedMessage, cfg, account, token, client, recipient, channelId, textLimit, chunkLimit, tableMode, chunkMode, markdownChunks, chunks, mediaMaxBytes, lastMessageId, firstChunk, rest, _i, rest_1, chunk, response, _a, _b, chunk, response;
        var _c, _d, _e, _f;
        if (opts === void 0) { opts = {}; }
        return __generator(this, function (_g) {
            switch (_g.label) {
                case 0:
                    trimmedMessage = (_c = message === null || message === void 0 ? void 0 : message.trim()) !== null && _c !== void 0 ? _c : "";
                    ...
                    client = (_d = opts.client) !== null && _d !== void 0 ? _d : (0, client_js_1.createSlackWebClient)(token);
                ...
                case 1:
                    ...
                    markdownChunks = chunkMode === "newline"
                    ...
                    chunks = markdownChunks.flatMap(function (markdown) {
                        return (0, format_js_1.markdownToSlackMrkdwnChunks)(markdown, chunkLimit, { tableMode: tableMode });
                    });
                    if (!chunks.length && trimmedMessage)
                        chunks.push(trimmedMessage);
                    mediaMaxBytes = typeof account.config.mediaMaxMb === "number"
                        ? account.config.mediaMaxMb * 1024 * 1024
                        : undefined;
                    lastMessageId = "";
                    if (!opts.mediaUrl) return [3 /*break*/, 7];
                    firstChunk = chunks[0], rest = chunks.slice(1);
                    return [4 /*yield*/, uploadSlackFile({
                            client: client,
                            channelId: channelId,
