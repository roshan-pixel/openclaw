...
function composeThinkingAndContent(params) {
    var _a, _b, _c, _d;
    var thinkingText = (_b = (_a = params.thinkingText) === null || _a === void 0 ? void 0 : _a.trim()) !== null && _b !== void 0 ? _b : "";
    var contentText = (_d = (_c = params.contentText) === null || _c === void 0 ? void 0 : _c.trim()) !== null && _d !== void 0 ? _d : "";
    var parts = [];
...
function extractTextBlocks(content, opts) {
    ...
    for (var _i = 0, content_3 = content; _i < content_3.length; _i++) {
        ...
        if ((opts === null || opts === void 0 ? void 0 : opts.includeThinking) &&
    ...
    return composeThinkingAndContent({
        ...
        showThinking: (_a = opts === null || opts === void 0 ? void 0 : opts.includeThinking) !== null && _a !== void 0 ? _a : false,
    });
}
...
function formatTokens(total, context) {
    ...
    var pct = typeof total === "number" && context > 0
        ? Math.min(999, Math.round((total / context) * 100))
        : null;
    return "tokens ".concat(totalLabel, "/").concat((0, usage_format_js_1.formatTokenCount)(context)).concat(pct !== null ? " (".concat(pct, "%)") : "");
}
function formatContextUsageLine(params) {
    var totalLabel = typeof params.total === "number" ? (0, usage_format_js_1.formatTokenCount)(params.total) : "?";
    var ctxLabel = typeof params.context === "number" ? (0, usage_format_js_1.formatTokenCount)(params.context) : "?";
    var pct = typeof params.percent === "number" ? Math.min(999, Math.round(params.percent)) : null;
    var remainingLabel = typeof params.remaining === "number" ? "".concat((0, usage_format_js_1.formatTokenCount)(params.remaining), " left") : null;
    var pctLabel = pct !== null ? "".concat(pct, "%") : null;
    var extra = [remainingLabel, pctLabel].filter(Boolean).join(", ");
    return "tokens ".concat(totalLabel, "/").concat(ctxLabel).concat(extra ? " (".concat(extra, ")") : "");
}
