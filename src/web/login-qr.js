        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    runtime.log((0, globals_js_1.info)("WhatsApp asked for a restart after pairing (code 515); retrying connection once…"));
                    closeSocket(login.sock);
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, (0, session_js_1.createWaSocket)(false, login.verbose, {
...
function startWebLoginWithQr() {
    return __awaiter(this, arguments, void 0, function (opts) {
        var runtime, cfg, account, hasWeb, selfId, who, existing, resolveQr, rejectQr, qrPromise, qrTimer, sock, pendingQr, err_2, login, qr, err_3, base64;
        var _a, _b, _c, _d;
        if (opts === void 0) { opts = {}; }
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    runtime = (_a = opts.runtime) !== null && _a !== void 0 ? _a : runtime_js_1.defaultRuntime;
                    cfg = (0, config_js_1.loadConfig)();
                    account = (0, accounts_js_1.resolveWhatsAppAccount)({ cfg: cfg, accountId: opts.accountId });
                ...
                case 1:
                    ...
                    if (hasWeb && !opts.force) {
                        who = (_c = (_b = selfId.e164) !== null && _b !== void 0 ? _b : selfId.jid) !== null && _c !== void 0 ? _c : "unknown";
                        return [2 /*return*/, {
                                message: "WhatsApp is already linked (".concat(who, "). Say \u201Crelink\u201D if you want a fresh QR."),
                            }];
                    }
                ...
                case 2:
                    ...
                    qrTimer = setTimeout(function () {
                        rejectQr === null || rejectQr === void 0 ? void 0 : rejectQr(new Error("Timed out waiting for WhatsApp QR"));
                    }, Math.max((_d = opts.timeoutMs) !== null && _d !== void 0 ? _d : 30000, 5000));
                    pendingQr = null;
                    _e.label = 3;
                case 3:
                    _e.trys.push([3, 5, , 7]);
                    return [4 /*yield*/, (0, session_js_1.createWaSocket)(false, Boolean(opts.verbose), {
                ...
                case 12: return [4 /*yield*/, (0, qr_image_js_1.renderQrPngBase64)(qr)];
                case 13:
                    base64 = _e.sent();
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    login = activeLogin;
                    if (!!isLoginFresh(login)) return [3 /*break*/, 2];
                    return [4 /*yield*/, resetActiveLogin(account.accountId)];
                case 1:
                    _c.sent();
                    return [2 /*return*/, {
                            ...
                            switch (_d.label) {
                                case 0:
                                    ...
                                    timeout = new Promise(function (resolve) {
                                        return setTimeout(function () { return resolve("timeout"); }, remaining);
                                    });
                                    return [4 /*yield*/, Promise.race([login.waitPromise.then(function () { return "done"; }), timeout])];
                                case 1:
                                    result = _d.sent();
                                    if (result === "timeout") {
                                        return [2 /*return*/, { value: {
                                    ...
                                    if (!login.error) return [3 /*break*/, 8];
                                    if (!(login.errorStatus === baileys_1.DisconnectReason.loggedOut)) return [3 /*break*/, 4];
                                    return [4 /*yield*/, (0, session_js_1.logoutWeb)({
                                            authDir: login.authDir,
                                ...
                                case 2:
                                    _d.sent();
                                    message_1 = "WhatsApp reported the session is logged out. Cleared cached web session; please scan a new QR.";
                                ...
                                case 4:
                                    if (!(login.errorStatus === 515)) return [3 /*break*/, 6];
                                ...
                                case 8:
                                    if (!login.connected) return [3 /*break*/, 10];
                                ...
                                case 10: return [2 /*return*/, { value: { connected: false, message: "Login ended without a connection." } }];
                            }
                        });
                    };
                    _c.label = 3;
