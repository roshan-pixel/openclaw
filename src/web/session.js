...
exports.webAuthExists = exports.WA_WEB_AUTH_DIR = exports.readWebSelfId = exports.pickWebChannel = exports.logWebSelfId = exports.logoutWeb = exports.getWebAuthAgeMs = void 0;
...
Object.defineProperty(exports, "getWebAuthAgeMs", { enumerable: true, get: function () { return auth_store_js_2.getWebAuthAgeMs; } });
Object.defineProperty(exports, "logoutWeb", { enumerable: true, get: function () { return auth_store_js_2.logoutWeb; } });
Object.defineProperty(exports, "logWebSelfId", { enumerable: true, get: function () { return auth_store_js_2.logWebSelfId; } });
Object.defineProperty(exports, "pickWebChannel", { enumerable: true, get: function () { return auth_store_js_2.pickWebChannel; } });
Object.defineProperty(exports, "readWebSelfId", { enumerable: true, get: function () { return auth_store_js_2.readWebSelfId; } });
Object.defineProperty(exports, "WA_WEB_AUTH_DIR", { enumerable: true, get: function () { return auth_store_js_2.WA_WEB_AUTH_DIR; } });
Object.defineProperty(exports, "webAuthExists", { enumerable: true, get: function () { return auth_store_js_2.webAuthExists; } });
var credsSaveQueue = Promise.resolve();
function enqueueSaveCreds(authDir, saveCreds, logger) {
    credsSaveQueue = credsSaveQueue
        .then(function () { return safeSaveCreds(authDir, saveCreds, logger); })
        .catch(function (err) {
...
function createWaSocket(printQr_1, verbose_1) {
    return __awaiter(this, arguments, void 0, function (printQr, verbose, opts) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    baseLogger = (0, logging_js_1.getChildLogger)({ module: "baileys" }, {
                        level: verbose ? "info" : "silent",
                    });
                    logger = (0, logging_js_1.toPinoLikeLogger)(baseLogger, verbose ? "info" : "silent");
                    authDir = (0, utils_js_1.resolveUserPath)((_b = opts.authDir) !== null && _b !== void 0 ? _b : (0, auth_store_js_1.resolveDefaultWebAuthDir)());
                ...
                case 3:
                    ...
                    sock.ev.on("creds.update", function () { return enqueueSaveCreds(authDir, saveCreds, sessionLogger); });
                    sock.ev.on("connection.update", function (update) {
                        ...
                        try {
                            ...
                            if (connection === "close") {
                                var status_1 = getStatusCode(lastDisconnect === null || lastDisconnect === void 0 ? void 0 : lastDisconnect.error);
                                if (status_1 === baileys_1.DisconnectReason.loggedOut) {
                                    console.error((0, globals_js_1.danger)("WhatsApp session logged out. Run: ".concat((0, command_format_js_1.formatCliCommand)("openclaw channels login"))));
                                }
                            }
            ...
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    ...
                    var handler = function () {
                        ...
                        if (update.connection === "open") {
                            (_b = evWithOff.off) === null || _b === void 0 ? void 0 : _b.call(evWithOff, "connection.update", handler);
                            resolve();
                        }
                        if (update.connection === "close") {
                            (_c = evWithOff.off) === null || _c === void 0 ? void 0 : _c.call(evWithOff, "connection.update", handler);
                            reject((_d = update.lastDisconnect) !== null && _d !== void 0 ? _d : new Error("Connection closed"));
                        }
                    };
...
function safeStringify(value, limit) {
    if (limit === void 0) { limit = 800; }
    try {
        var seen_1 = new WeakSet();
        var raw = JSON.stringify(value, function (_key, v) {
            if (typeof v === "bigint")
                return v.toString();
            if (typeof v === "function") {
                var maybeName = v.name;
                var name_1 = typeof maybeName === "string" && maybeName.length > 0 ? maybeName : "anonymous";
...
function extractBoomDetails(err) {
    ...
    var statusCode = typeof output.statusCode === "number"
        ? output.statusCode
        : typeof (payload === null || payload === void 0 ? void 0 : payload.statusCode) === "number"
            ? payload.statusCode
            : undefined;
    var error = typeof (payload === null || payload === void 0 ? void 0 : payload.error) === "string" ? payload.error : undefined;
    var message = typeof (payload === null || payload === void 0 ? void 0 : payload.message) === "string" ? payload.message : undefined;
...
function formatError(err) {
    ...
    var boom = (_b = (_a = extractBoomDetails(err)) !== null && _a !== void 0 ? _a : extractBoomDetails(err === null || err === void 0 ? void 0 : err.error)) !== null && _b !== void 0 ? _b : extractBoomDetails((_c = err === null || err === void 0 ? void 0 : err.lastDisconnect) === null || _c === void 0 ? void 0 : _c.error);
    var status = (_d = boom === null || boom === void 0 ? void 0 : boom.statusCode) !== null && _d !== void 0 ? _d : getStatusCode(err);
    ...
    var messageCandidates = [
        ...
        typeof (err === null || err === void 0 ? void 0 : err.message) === "string"
            ? err.message
            : undefined,
        typeof ((_e = err === null || err === void 0 ? void 0 : err.error) === null || _e === void 0 ? void 0 : _e.message) === "string"
            ? (_f = err.error) === null || _f === void 0 ? void 0 : _f.message
            : undefined,
    ].filter(function (v) { return Boolean(v && v.trim().length > 0); });
