...
function renderQrPngBase64(input_1) {
    return __awaiter(this, arguments, void 0, function (input, opts) {
        var _a, scale, _b, marginModules, qr, modules, size, buf, row, col, startX, startY, y, pixelY, x, pixelX, png;
        if (opts === void 0) { opts = {}; }
        return __generator(this, function (_c) {
            _a = opts.scale, scale = _a === void 0 ? 6 : _a, _b = opts.marginModules, marginModules = _b === void 0 ? 4 : _b;
