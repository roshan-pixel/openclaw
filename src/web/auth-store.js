...
function resolveDefaultWebAuthDir() {
    return node_path_1.default.join((0, paths_js_1.resolveOAuthDir)(), "whatsapp", session_key_js_1.DEFAULT_ACCOUNT_ID);
}
...
function webAuthExists() {
    return __awaiter(this, arguments, void 0, function (authDir) {
        ...
        if (authDir === void 0) { authDir = resolveDefaultWebAuthDir(); }
...
function clearLegacyBaileysAuthState(authDir) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, promises_1.default.readdir(authDir, { withFileTypes: true })];
                case 1:
                    entries = _a.sent();
                                ...
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        if (!shouldDelete(entry.name))
                                            return [2 /*return*/];
                                        return [4 /*yield*/, promises_1.default.rm(node_path_1.default.join(authDir, entry.name), { force: true })];
                                    case 1:
                                        _a.sent();
                                        return [2 /*return*/];
                                }
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    resolvedAuthDir = (0, utils_js_1.resolveUserPath)((_b = params.authDir) !== null && _b !== void 0 ? _b : resolveDefaultWebAuthDir());
                    return [4 /*yield*/, webAuthExists(resolvedAuthDir)];
                case 1:
                    exists = _c.sent();
                    if (!exists) {
                        runtime.log((0, globals_js_1.info)("No WhatsApp Web session found; nothing to delete."));
                        return [2 /*return*/, false];
                    }
                    if (!params.isLegacyAuthDir) return [3 /*break*/, 3];
                    return [4 /*yield*/, clearLegacyBaileysAuthState(resolvedAuthDir)];
                case 2:
                    _c.sent();
                    return [3 /*break*/, 5];
                case 3: return [4 /*yield*/, promises_1.default.rm(resolvedAuthDir, { recursive: true, force: true })];
                case 4:
                    _c.sent();
                    _c.label = 5;
                case 5:
...
function readWebSelfId(authDir) {
    ...
    try {
        ...
        var jid = (_b = (_a = parsed === null || parsed === void 0 ? void 0 : parsed.me) === null || _a === void 0 ? void 0 : _a.id) !== null && _b !== void 0 ? _b : null;
...
function getWebAuthAgeMs(authDir) {
    if (authDir === void 0) { authDir = resolveDefaultWebAuthDir(); }
    try {
        var stats = node_fs_1.default.statSync(resolveWebCredsPath((0, utils_js_1.resolveUserPath)(authDir)));
...
function logWebSelfId(authDir, runtime, includeChannelPrefix) {
    ...
    if (includeChannelPrefix === void 0) { includeChannelPrefix = false; }
    // Human-friendly log of the currently linked personal web session.
    var _a = readWebSelfId(authDir), e164 = _a.e164, jid = _a.jid;
    var details = e164 || jid ? "".concat(e164 !== null && e164 !== void 0 ? e164 : "unknown").concat(jid ? " (jid ".concat(jid, ")") : "") : "unknown";
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    hasWeb = _a.sent();
                    if (!hasWeb) {
                        throw new Error("No WhatsApp Web session found. Run `".concat((0, command_format_js_1.formatCliCommand)("openclaw channels login --channel whatsapp --verbose"), "` to link."));
                    }
