...
Object.defineProperty(exports, "optimizeImageToPng", { enumerable: true, get: function () { return image_ops_js_1.optimizeImageToPng; } });
...
function formatCapLimit(label, cap, size) {
    return "".concat(label, " exceeds ").concat(formatMb(cap, 0), "MB limit (got ").concat(formatMb(size), "MB)");
}
function formatCapReduce(label, cap, size) {
    return "".concat(label, " could not be reduced below ").concat(formatMb(cap, 0), "MB (got ").concat(formatMb(size), "MB)");
}
...
function toJpegFileName(fileName) {
    ...
    if (!parsed.ext || HEIC_EXT_RE.test(parsed.ext)) {
        return node_path_1.default.format({ dir: parsed.dir, name: parsed.name || trimmed, ext: ".jpg" });
    }
...
function logOptimizedImage(params) {
    ...
    if (params.optimized.format === "png") {
        (0, globals_js_1.logVerbose)("Optimized PNG (preserving alpha) from ".concat(formatMb(params.originalSize), "MB to ").concat(formatMb(params.optimized.optimizedSize), "MB (side\u2264").concat(params.optimized.resizeSide, "px)"));
        return;
    }
    (0, globals_js_1.logVerbose)("Optimized media from ".concat(formatMb(params.originalSize), "MB to ").concat(formatMb(params.optimized.optimizedSize), "MB (side\u2264").concat(params.optimized.resizeSide, "px, q=").concat(params.optimized.quality, ")"));
}
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    isPng = (meta === null || meta === void 0 ? void 0 : meta.contentType) === "image/png" || ((_b = meta === null || meta === void 0 ? void 0 : meta.fileName) === null || _b === void 0 ? void 0 : _b.toLowerCase().endsWith(".png"));
                    _a = isPng;
                ...
                case 3:
                    ...
                    if ((0, globals_js_1.shouldLogVerbose)()) {
                        (0, globals_js_1.logVerbose)("PNG with alpha still exceeds ".concat(formatMb(cap, 0), "MB after optimization; falling back to JPEG"));
                    }
                    _c.label = 4;
                case 4: return [4 /*yield*/, optimizeImageToJpeg(buffer, cap, meta)];
                case 5:
                    optimized = _c.sent();
...
function loadWebMediaInternal(mediaUrl_1) {
    return __awaiter(this, arguments, void 0, function (mediaUrl, options) {
        var maxBytes, _a, optimizeImages, optimizeAndClampImage, clampAndFinalize, fetched, buffer, contentType, fileName_1, kind_1, data, mime, kind, fileName, ext;
        var _this = this;
        if (options === void 0) { options = {}; }
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    maxBytes = options.maxBytes, _a = options.optimizeImages, optimizeImages = _a === void 0 ? true : _a;
                    ...
                    if (mediaUrl.startsWith("file://")) {
                        try {
                            ...
                            throw new Error("Invalid file:// URL: ".concat(mediaUrl));
                        }
                    }
                    optimizeAndClampImage = function (buffer, cap, meta) { return __awaiter(_this, void 0, void 0, function () {
                        var originalSize, optimized, contentType, fileName;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    originalSize = buffer.length;
                                    return [4 /*yield*/, optimizeImageWithFallback({ buffer: buffer, cap: cap, meta: meta })];
                                case 1:
                                    optimized = _a.sent();
                                    ...
                                    fileName = optimized.format === "jpeg" && meta && isHeicSource(meta)
                                        ? toJpegFileName(meta.fileName)
                                        : meta === null || meta === void 0 ? void 0 : meta.fileName;
                                    return [2 /*return*/, {
                    ...
                    clampAndFinalize = function (params) { return __awaiter(_this, void 0, void 0, function () {
                        var cap, isGif, _a;
                        var _b;
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                case 0:
                                    cap = maxBytes !== undefined ? maxBytes : (0, constants_js_1.maxBytesForKind)(params.kind);
                                    if (!(params.kind === "image")) return [3 /*break*/, 2];
                                    ...
                                    _a = [{}];
                                    return [4 /*yield*/, optimizeAndClampImage(params.buffer, cap, {
                                            contentType: params.contentType,
                                            fileName: params.fileName,
                                        })];
                                ...
                                case 2:
                                    ...
                                    return [2 /*return*/, {
                                            buffer: params.buffer,
                                            contentType: (_b = params.contentType) !== null && _b !== void 0 ? _b : undefined,
                                            kind: params.kind,
                                            fileName: params.fileName,
                                        }];
                            }
                ...
                case 1:
                    fetched = _b.sent();
                    buffer = fetched.buffer, contentType = fetched.contentType, fileName_1 = fetched.fileName;
                    kind_1 = (0, constants_js_1.mediaKindFromMime)(contentType);
                    return [4 /*yield*/, clampAndFinalize({ buffer: buffer, contentType: contentType, kind: kind_1, fileName: fileName_1 })];
                ...
                case 5:
                    ...
                    return [4 /*yield*/, clampAndFinalize({
                            buffer: data,
                            contentType: mime,
                            kind: kind,
                            fileName: fileName,
...
function loadWebMedia(mediaUrl, maxBytes) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, loadWebMediaInternal(mediaUrl, {
                        maxBytes: maxBytes,
                        optimizeImages: true,
                    })];
...
function optimizeImageToJpeg(buffer_1, maxBytes_1) {
    return __awaiter(this, arguments, void 0, function (buffer, maxBytes, opts) {
        var source, err_1, sides, qualities, smallest, _i, sides_1, side, _a, qualities_1, quality, out, size, _b;
        if (opts === void 0) { opts = {}; }
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    source = buffer;
                    if (!isHeicSource(opts)) return [3 /*break*/, 4];
                    _c.label = 1;
                case 1:
                    _c.trys.push([1, 3, , 4]);
                ...
                case 4:
                    ...
                    _c.label = 5;
                case 5:
                    if (!(_i < sides_1.length)) return [3 /*break*/, 12];
                    side = sides_1[_i];
                    _a = 0, qualities_1 = qualities;
                    _c.label = 6;
                case 6:
                    if (!(_a < qualities_1.length)) return [3 /*break*/, 11];
                    quality = qualities_1[_a];
                    _c.label = 7;
                case 7:
                    _c.trys.push([7, 9, , 10]);
                    return [4 /*yield*/, (0, image_ops_js_1.resizeToJpeg)({
                            buffer: source,
                            maxSide: side,
                            quality: quality,
