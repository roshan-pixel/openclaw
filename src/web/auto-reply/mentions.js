...
function buildMentionConfig(cfg, agentId) {
    ...
    return { mentionRegexes: mentionRegexes, allowFrom: (_b = (_a = cfg.channels) === null || _a === void 0 ? void 0 : _a.whatsapp) === null || _b === void 0 ? void 0 : _b.allowFrom };
}
function resolveMentionTargets(msg, authDir) {
    ...
    var normalizedMentions = ((_a = msg.mentionedJids) === null || _a === void 0 ? void 0 : _a.length)
        ? msg.mentionedJids.map(function (jid) { var _a; return (_a = (0, utils_js_1.jidToE164)(jid, jidOptions)) !== null && _a !== void 0 ? _a : jid; }).filter(Boolean)
        : [];
    var selfE164 = (_b = msg.selfE164) !== null && _b !== void 0 ? _b : (msg.selfJid ? (0, utils_js_1.jidToE164)(msg.selfJid, jidOptions) : null);
...
function isBotMentionedFromTargets(msg, mentionCfg, targets) {
    ...
    var hasMentions = ((_b = (_a = msg.mentionedJids) === null || _a === void 0 ? void 0 : _a.length) !== null && _b !== void 0 ? _b : 0) > 0;
    ...
    if (mentionCfg.mentionRegexes.some(function (re) { return re.test(bodyClean); }))
        return true;
...
function resolveOwnerList(mentionCfg, selfE164) {
    ...
    var raw = Array.isArray(allowFrom) && allowFrom.length > 0 ? allowFrom : selfE164 ? [selfE164] : [];
    return raw
