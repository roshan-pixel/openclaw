...
function resolveGroupPolicyFor(cfg, conversationId) {
    var _a;
    var groupId = (_a = (0, sessions_js_1.resolveGroupSessionKey)({
        From: conversationId,
        ChatType: "group",
        Provider: "whatsapp",
...
function resolveGroupActivationFor(params) {
    ...
    var defaultActivation = requireMention === false ? "always" : "mention";
    return (_b = (0, group_activation_js_1.normalizeGroupActivation)(entry === null || entry === void 0 ? void 0 : entry.groupActivation)) !== null && _b !== void 0 ? _b : defaultActivation;
}
