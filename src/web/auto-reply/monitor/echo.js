...
function createEchoTracker(params) {
    ...
    var rememberText = function (text, opts) {
        ...
        if (opts.logVerboseMessage) {
            (_a = params.logVerbose) === null || _a === void 0 ? void 0 : _a.call(params, "Added to echo detection set (size now: ".concat(recentlySent.size, "): ").concat(text.substring(0, 50), "..."));
        }
        trim();
    };
    return {
        rememberText: rememberText,
        has: function (key) { return recentlySent.has(key); },
        forget: function (key) {
