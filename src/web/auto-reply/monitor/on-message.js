...
function createWebOnMessageHandler(params) {
    var _this = this;
    var processForRoute = function (msg, route, groupHistoryKey, opts) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, (0, process_message_js_1.processMessage)({
                    cfg: params.cfg,
                    msg: msg,
                    route: route,
                    ...
                    suppressGroupHistoryClear: opts === null || opts === void 0 ? void 0 : opts.suppressGroupHistoryClear,
                })];
        });
    }); };
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    groupHistoryKey = msg.chatType === "group"
                    ...
                    if (msg.from === msg.to) {
                        (0, globals_js_1.logVerbose)("\uD83D\uDCF1 Same-phone mode detected (from === to: ".concat(msg.from, ")"));
                    }
                    // Skip if this is a message we just sent (echo detection)
                    if (params.echoTracker.has(msg.body)) {
                        (0, globals_js_1.logVerbose)("Skipping auto-reply: detected echo (message matches recently sent text)");
                    ...
                    if (msg.chatType === "group") {
                        metaCtx = {
                            ...
                            SenderId: ((_b = msg.senderJid) === null || _b === void 0 ? void 0 : _b.trim()) || msg.senderE164,
                        ...
                        if (!msg.senderE164 && peerId && peerId.startsWith("+")) {
                            msg.senderE164 = (_c = (0, utils_js_1.normalizeE164)(peerId)) !== null && _c !== void 0 ? _c : msg.senderE164;
                        }
                    }
                    return [4 /*yield*/, (0, broadcast_js_1.maybeBroadcastMessage)({
                            cfg: params.cfg,
                            msg: msg,
                            peerId: peerId,
                            route: route,
