...
function formatReplyContext(msg) {
    ...
    return "[Replying to ".concat(sender).concat(idPart, "]\n").concat(msg.replyToBody, "\n[/Replying]");
}
function buildInboundLine(params) {
    var _a, _b, _c, _d, _e, _f, _g;
    var cfg = params.cfg, msg = params.msg, agentId = params.agentId, previousTimestamp = params.previousTimestamp, envelope = params.envelope;
    ...
    var messagePrefix = (0, identity_js_1.resolveMessagePrefix)(cfg, agentId, {
        configured: (_b = (_a = cfg.channels) === null || _a === void 0 ? void 0 : _a.whatsapp) === null || _b === void 0 ? void 0 : _b.messagePrefix,
        hasAllowFrom: ((_f = (_e = (_d = (_c = cfg.channels) === null || _c === void 0 ? void 0 : _c.whatsapp) === null || _d === void 0 ? void 0 : _d.allowFrom) === null || _e === void 0 ? void 0 : _e.length) !== null && _f !== void 0 ? _f : 0) > 0,
    });
    var prefixStr = messagePrefix ? "".concat(messagePrefix, " ") : "";
    var replyContext = formatReplyContext(msg);
    var baseLine = "".concat(prefixStr).concat(msg.body).concat(replyContext ? "\n\n".concat(replyContext) : "");
    // Wrap with standardized envelope for the agent.
    return (0, envelope_js_1.formatInboundEnvelope)({
        channel: "WhatsApp",
        from: msg.chatType === "group" ? msg.from : (_g = msg.from) === null || _g === void 0 ? void 0 : _g.replace(/^whatsapp:/, ""),
