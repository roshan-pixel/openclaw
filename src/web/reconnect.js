...
exports.sleepWithAbort = exports.computeBackoff = exports.DEFAULT_RECONNECT_POLICY = exports.DEFAULT_HEARTBEAT_SECONDS = void 0;
...
Object.defineProperty(exports, "computeBackoff", { enumerable: true, get: function () { return backoff_js_1.computeBackoff; } });
Object.defineProperty(exports, "sleepWithAbort", { enumerable: true, get: function () { return backoff_js_1.sleepWithAbort; } });
...
function resolveHeartbeatSeconds(cfg, overrideSeconds) {
    var _a;
    var candidate = overrideSeconds !== null && overrideSeconds !== void 0 ? overrideSeconds : (_a = cfg.web) === null || _a === void 0 ? void 0 : _a.heartbeatSeconds;
...
function resolveReconnectPolicy(cfg, overrides) {
    var _a, _b;
    var reconnectOverrides = (_b = (_a = cfg.web) === null || _a === void 0 ? void 0 : _a.reconnect) !== null && _b !== void 0 ? _b : {};
    var overrideConfig = overrides !== null && overrides !== void 0 ? overrides : {};
    var merged = __assign(__assign(__assign({}, exports.DEFAULT_RECONNECT_POLICY), reconnectOverrides), overrideConfig);
