"""
WinClaw - AI Agent with MCP Integration
Main entry point
"""
import asyncio
import logging
...
class WinClaw:
    ...
    async def initialize(self):
        ...
        logger.info("="*60)
        logger.info("WINCLAW - AI AGENT STARTING")
        logger.info("="*60)
            ...
            if msg['role'] == 'assistant':
                ...
                if isinstance(content, list):
                    ...
                    if has_tool_result:
                        ...
                        # Skip if no assistant message at all
                    else:
    ...
    async def interactive_mode(self):
        ...
        print("\n" + "="*60)
        print("WINCLAW INTERACTIVE MODE")
        print("="*60)
...
async def main():
    ...
    try:
        ...
        if len(sys.argv) > 1:
            ...
            print(f"{'='*60}\n")
            response = await winclaw.run_task(command, verbose=True)
        else:
            # Interactive mode
            await winclaw.interactive_mode()
